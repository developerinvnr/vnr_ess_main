...
$sqlP0t=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where d.HqId=".$_REQUEST['hq']." AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$Before2YId, $con); $resP0t=mysql_fetch_assoc($sqlP0t);

$sqlP1t=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where d.HqId=".$_REQUEST['hq']." AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$BeforeYId, $con); $resP1t=mysql_fetch_assoc($sqlP1t);

$sqlP2t=mysql_query("select SUM(M1) as tsM1,SUM(M2) as tsM2,SUM(M3) as tsM3,SUM(M4) as tsM4,SUM(M5) as tsM5,SUM(M6) as tsM6,SUM(M7) as tsM7,SUM(M8) as tsM8,SUM(M9) as tsM9,SUM(M10) as tsM10,SUM(M11) as tsM11,SUM(M12) as tsM12 from hrm_sales_sal_details sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where d.HqId=".$_REQUEST['hq']." AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$_REQUEST['y'], $con); $resP2t=mysql_fetch_assoc($sqlP2t);

$sqlP2tch=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where d.HqId=".$_REQUEST['hq']." AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$_REQUEST['y'], $con); $resP2tch=mysql_fetch_assoc($sqlP2tch);

$sqlP3t=mysql_query("select SUM(M1_Proj) as tsM1,SUM(M2_Proj) as tsM2,SUM(M3_Proj) as tsM3,SUM(M4_Proj) as tsM4,SUM(M5_Proj) as tsM5,SUM(M6_Proj) as tsM6,SUM(M7_Proj) as tsM7,SUM(M8_Proj) as tsM8,SUM(M9_Proj) as tsM9,SUM(M10_Proj) as tsM10,SUM(M11_Proj) as tsM11,SUM(M12_Proj) as tsM12 from hrm_sales_sal_details sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where d.HqId=".$_REQUEST['hq']." AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$AfterYId, $con); $resP3t=mysql_fetch_assoc($sqlP3t);
?>
...
<?php 
/////////////////////////////////////////////////
if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){ $sqlDealChk = mysql_query("select count(*) as rtotal from hrm_sales_sal_details sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId where si.ItemId=".$_REQUEST['ii']." AND (YearId=".$Before2YId." OR YearId=".$BeforeYId.") AND YearId!=".$_REQUEST['y']." AND YearId!=".$AfterYId." AND DealerId=".$resDeal['DealerId'], $con); }
elseif($_REQUEST['ii']=='All_1'){$sqlDealChk = mysql_query("select count(*) as rtotal from hrm_sales_sal_details sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId where si.GroupId=1 AND (YearId=".$Before2YId." OR YearId=".$BeforeYId.") AND YearId!=".$_REQUEST['y']." AND YearId!=".$AfterYId." AND DealerId=".$resDeal['DealerId'], $con); }
elseif($_REQUEST['ii']=='All_2'){$sqlDealChk = mysql_query("select count(*) as rtotal from hrm_sales_sal_details sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId where si.GroupId=2 AND (YearId=".$Before2YId." OR YearId=".$BeforeYId.") AND YearId!=".$_REQUEST['y']." AND YearId!=".$AfterYId." AND DealerId=".$resDeal['DealerId'], $con); }
...
$sqlP0d=mysql_query("select M1_Ach,M2_Ach,M3_Ach,M4_Ach,M5_Ach,M6_Ach,M7_Ach,M8_Ach,M9_Ach,M10_Ach,M11_Ach,M12_Ach from hrm_sales_sal_details where YearId=".$Before2YId." AND ProductId=".$res['ProductId']." AND DealerId=".$resDeal['DealerId'], $con); $resP0d=mysql_fetch_assoc($sqlP0d); 
$sqlP1d=mysql_query("select M1_Ach,M2_Ach,M3_Ach,M4_Ach,M5_Ach,M6_Ach,M7_Ach,M8_Ach,M9_Ach,M10_Ach,M11_Ach,M12_Ach from hrm_sales_sal_details where YearId=".$BeforeYId." AND ProductId=".$res['ProductId']." AND DealerId=".$resDeal['DealerId'], $con); $resP1d=mysql_fetch_assoc($sqlP1d);
$sqlP2d=mysql_query("select * from hrm_sales_sal_details where YearId=".$_REQUEST['y']." AND ProductId=".$res['ProductId']." AND DealerId=".$resDeal['DealerId'], $con); $resP2d=mysql_fetch_assoc($sqlP2d);
$sqlP3d=mysql_query("select M1_Proj, M2_Proj, M3_Proj, M4_Proj, M5_Proj, M6_Proj, M7_Proj, M8_Proj, M9_Proj, M10_Proj, M11_Proj, M12_Proj from hrm_sales_sal_details where YearId=".$AfterYId." AND ProductId=".$res['ProductId']." AND DealerId=".$resDeal['DealerId'], $con);  $resP3d=mysql_fetch_assoc($sqlP3d); $DeId=$resDeal['DealerId'];

/////////////////////////////////////////////////
$sqlP0dhq=mysql_query("select * from hrm_sales_sal_details sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where d.HqId=".$_REQUEST['hq']." AND ProductId=".$res['ProductId']." AND YearId=".$Before2YId, $con); 
$sqlP1dhq=mysql_query("select * from hrm_sales_sal_details sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where d.HqId=".$_REQUEST['hq']." AND ProductId=".$res['ProductId']." AND YearId=".$BeforeYId, $con);
$sqlP2dhq=mysql_query("select * from hrm_sales_sal_details sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where d.HqId=".$_REQUEST['hq']." AND ProductId=".$res['ProductId']." AND YearId=".$_REQUEST['y'], $con);
$sqlP3dhq=mysql_query("select * from hrm_sales_sal_details sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where d.HqId=".$_REQUEST['hq']." AND ProductId=".$res['ProductId']." AND YearId=".$AfterYId, $con);  
...
$sqlP2tdch=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId where sd.DealerId=".$resDeal['DealerId']." AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$_REQUEST['y'], $con);
