...
if(isset($_POST['v']) && $_POST['v']!=""){ $sql=mysql_query("update hrm_querylevel_employee set LevelNo=".$_POST['v']." where QLevelId=".$_POST['id'], $con); } ?>

<?php if(isset($_POST['One']) && $_POST['One']!=""){ $qlid=$_POST['qlid']; $dept=$_POST['dept']; $YId=$_POST['YId']; $UId=$_POST['UId']; $CId=$_POST['CId'];
$sql_D1=mysql_query("delete from hrm_querylevel_employee where QLevelId=".$qlid, $con);  ?>
...
<?php if(isset($_POST['Two']) && $_POST['Two']!=""){ $qlid=$_POST['qlid']; $dept=$_POST['dept']; $YId=$_POST['YId']; $UId=$_POST['UId']; $CId=$_POST['CId'];
$sql_D2=mysql_query("delete from hrm_querylevel_employee where QLevelId=".$qlid, $con); ?>
...
<?php if(isset($_POST['Three']) && $_POST['Three']!=""){ $qlid=$_POST['qlid']; $dept=$_POST['dept']; $YId=$_POST['YId']; $UId=$_POST['UId']; $CId=$_POST['CId'];
$sql_D3=mysql_query("delete from hrm_querylevel_employee where QLevelId=".$qlid, $con); ?>
