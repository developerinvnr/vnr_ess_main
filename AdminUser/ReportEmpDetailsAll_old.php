...
function SelectDept(v){ var ComId=document.getElementById("ComId").value; var s=document.getElementById("Sts").value; 
window.location='ReportEmpDetailsAll.php?action=DeptAll&act=resutreports&vcheck=true&yy=23%23%e&truekey=false&ComId='+ComId+'&value='+v+'&s='+s+'&rightn=ee&rr=34&frf=34&yey=5';}

function SelectSts(s){ var ComId=document.getElementById("ComId").value; var v=document.getElementById("Dept").value; 
window.location='ReportEmpDetailsAll.php?action=DeptAll&act=resutreports&vcheck=true&yy=23%23%e&truekey=false&ComId='+ComId+'&value='+v+'&s='+s+'&rightn=ee&rr=34&frf=34&yey=5';}
...
{ var ComId=document.getElementById("ComId").value; var YId=document.getElementById("YId").value; var DeptValue=document.getElementById("DeptValue").value;  
  window.open("PrintEmpDetailsAllReport.php?action=DeptAll&value="+v+"&c="+ComId+"&y="+YId+"&value="+DeptValue+"&s="+s,"PrintForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=1250,height=650");}
  
function CheckTR(v)
{
if(document.getElementById("CHTR_"+v).checked==true){document.getElementById("TR_"+v).style.backgroundColor="#0076EC";}
if(document.getElementById("CHTR_"+v).checked==false){document.getElementById("TR_"+v).style.backgroundColor="#ffffff";}
}  

function ExportReportAll(v,s)
{ var ComId=document.getElementById("ComId").value; var YId=document.getElementById("YId").value;  
  window.open("ExportReportAllCSV.php?action=ExportReportAll&C="+ComId+"&Y="+YId+"&value="+v+"&s="+s,"PrintForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20");} 
</Script>  
</head>
<body class="body">
...
<?php  if($_SESSION['UserType']=='M' OR $_SESSION['UserType']=='S' OR $_SESSION['UserType']=='A' OR $_SESSION['UserType']=='U') { ?>
				   <td>
				    <table border="0">						
                    <tr>
				<td class="td1" style="width:2800px; height:20px; font-size:15px; font-family:Times New Roman; color:#00274F; font-weight:bold;" align="">Department :&nbsp;&nbsp;<select style="font-size:11px; width:148px; height:18px; background-color:#DDFFBB;" name="Dept" id="Dept" onChange="SelectDept(this.value)">
<?php if($_REQUEST['value']=='' OR $_REQUEST['value']==0){?><option value="0" selected>Select Department</option>
<?php }else{ $sqlD=mysql_query("select DepartmentCode from hrm_department where CompanyId=".$CompanyId." AND DepartmentId=".$_REQUEST['value'], $con); $resD=mysql_fetch_array($sqlD); ?><option value="<?php echo $_REQUEST['value']; ?>" selected><?php echo $resD['DepartmentCode']; ?></option><?php } ?><?php $SqlDept=mysql_query("select * from hrm_department where CompanyId=".$CompanyId." AND DepartmentCode!='MANAGEMENT' order by DepartmentName ASC", $con); while($ResDept=mysql_fetch_array($SqlDept)) { ?><option value="<?php echo $ResDept['DepartmentId']; ?>"><?php echo '&nbsp;'.$ResDept['DepartmentCode'];?></option><?php } ?><option value="All">All</option></select>
				&nbsp;&nbsp;
				<?php if($_REQUEST['s']=='A'){$Sts='Active';}elseif($_REQUEST['s']=='D'){$Sts='Deactive';}elseif($_REQUEST['s']=='AD'){$Sts='All';} ?>
				Status:&nbsp;&nbsp;<select style="font-size:11px; width:100px; height:18px; background-color:#DDFFBB;" name="Sts" id="Sts" onChange="SelectSts(this.value)">
				<option value="<?php echo $_REQUEST['s'] ?>" selected><?php echo $Sts; ?></option>
				<?php if($_REQUEST['s']!='A'){?><option value="A">Actives</option><?php } ?>
				<?php if($_REQUEST['s']!='D'){?><option value="D">Deactives</option><?php } ?>
				<?php if($_REQUEST['s']!='AD'){?><option value="AD">&nbsp;All</option><?php } ?>
				</select>
				&nbsp;&nbsp;(Reports All Details)
					   </td>
                     </tr>
...
<?php if($_REQUEST['value']!='All') { $sqlA=mysql_query("select DepartmentName from hrm_department where DepartmentId=".$_REQUEST['value'], $con); $resA=mysql_fetch_assoc($sqlA); } ?>	
	  <td colspan="154" valign="top" style=" background-color:#0069D2; font-size:14px; color:#FFFFFF; font-family:Georgia; font-weight:bold;">&nbsp;Employee All Details :
	  &nbsp;&nbsp;(&nbsp;Department - <?php if($_REQUEST['value']!='All') {echo $resA['DepartmentName']; } else {echo 'All';} ?>&nbsp;)&nbsp;&nbsp;&nbsp;
	  &nbsp;&nbsp;<a href="#" onClick="ExportReportAll('<?php echo $_REQUEST['value']; ?>','<?php echo $_REQUEST['s']; ?>')" style="color:#F9F900; font-size:12px;">Export Excel</a>&nbsp;&nbsp;
	  <a href="#" onClick="PrintDept('<?php echo $_REQUEST['value']; ?>')" style="color:#F9F900; font-size:12px;"></a>
	  <a href="<?php echo $strFileName; ?>" style="color:#F9F900; font-size:12px;"><?php /*Dump Excel*/ ?></a>
	  </td>
	 </tr>
	 <tr bgcolor="#7a6189">
	 <td colspan="23" align="center" style="color:#FFFFFF;font-size:11px;" class="All_100"><b>General</b></td>
	 <td colspan="3" align="center" style="color:#FFFFFF;font-size:11px;" class="All_200"><b>Qualification</b></td>
	 <td colspan="10" align="center" style="color:#FFFFFF;font-size:11px;"><b>Bank</b></td>
	 <td colspan="3" align="center" style="color:#FFFFFF;font-size:11px;"><b></b></td>
	 <td colspan="4" align="center" style="color:#FFFFFF;font-size:11px;"><b>Reporting</b></td>
	 <td colspan="18" align="center" style="color:#FFFFFF;font-size:11px;"><b>Personal</b></td>
	 ...
	 <td colspan="37" align="center" style="color:#FFFFFF;font-size:11px;"><b>Family</b></td>
	 <td colspan="21" align="center" style="color:#FFFFFF;font-size:11px;"><b>Cost To Company</b></td>
	 <td colspan="17" align="center" style="color:#FFFFFF;font-size:11px;"><b>Eligibility</b></td>
         <td align="center" style="color:#FFFFFF;font-size:11px;"><b>Rating</b></td>
	 </tr>
 <tr bgcolor="#7a6189">
   ...
   <td align="center" style="color:#FFFFFF;" class="All_200"><b>Designation</b></td>
	...
	<td align="center" style="color:#FFFFFF;" class="All_70"><b>Resignation</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_70"><b>Sepration</b></td>
	...
	<td align="center" style="color:#FFFFFF;" class="All_200"><b>Main</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_100"><b>Top</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_100"><b>Others</b></td>
	...
	<td align="center" style="color:#FFFFFF;" class="All_150"><b>IFSC</b></td>
	...
	<td align="center" style="color:#FFFFFF;" class="All_70"><b>DOB</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_150"><b>Occupation</b></td>		
   	<td align="center" style="color:#FFFFFF;" class="All_200" bgcolor="#808000"><b>Name_1</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>Relation</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>DOB</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_150"><b>Qualification</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_100"><b>Occupation</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_200" bgcolor="#808000"><b>Name_2</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>Relation</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>DOB</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_150"><b>Qualification</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_100"><b>Occupation</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_200" bgcolor="#808000"><b>Name_3</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>Relation</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>DOB</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_150"><b>Qualification</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_100"><b>Occupation</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_200" bgcolor="#808000"><b>Name_4</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>Relation</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>DOB</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_150"><b>Qualification</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_100"><b>Occupation</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_200" bgcolor="#808000"><b>Name_5</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>Relation</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>DOB</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_150"><b>Qualification</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_100"><b>Occupation</b></td>	
...
?> 
   <tr id="TR_<?php echo $Sno; ?>" style="background-color:#FFFFFF;">
    <td bgcolor="#0076EC"><input type="checkbox" id="CHTR_<?php echo $Sno; ?>" onClick="CheckTR(<?php echo $Sno; ?>)" /></td> 
	<td align="center" style="" class="All_50" valign="top"><?php echo $Sno; ?></td>
	<td align="center" class="All_70" valign="top"><?php echo $res['EmpCode']; ?></td>
	<td align="" class="All_200" valign="top"><?php echo $Ename; ?></td>
    <td align="" class="All_80" valign="top"><?php echo $resDept['DepartmentCode']; ?></td>
    <td align="" class="All_150" valign="top"><?php echo $resDesig['DesigCode']; ?></td>
	<td align="" style="" class="All_200" valign="top"><?php echo $resDesig['DesigName']; ?></td>
	<td align="center" class="All_40" valign="top"><?php echo $resGrade['GradeValue']; ?></td>	
	<td align="center" style="" class="All_60" valign="top"><?php echo $res['FileNo']; ?></td>	
	<td align="center" class="All_70" valign="top"><?php if($res['RetiStatus']=='Y'){echo date("d-M-y", strtotime($res['RetiDate']));}else{ echo date("d-M-y", strtotime($res['DateJoining'])); } ?></td>
	<td align="center" class="All_70" valign="top">
	
	<?php if($res['DateConfirmation']!='1970-01-01' AND $res['DateConfirmation']!='0000-00-00' AND $res['RetiStatus']=='N') { echo date("d-M-y", strtotime($res['DateConfirmation'])); }else {echo '&nbsp;';}?></td>
	<td align="center" class="All_70" valign="top"><?php echo date("d-M-y", strtotime($res['DOB'])); ?></td>
...
?>			
	<td align="center" class="All_70" valign="top"><?php echo $AgeMain; ?></td>
	<td align="center" class="All_50" valign="top"><?php echo $res['EmpStatus']; ?></td>
	<td align="" style="" class="All_100" valign="top"><?php if($res['DateOfResignation']!='0000-00-00' AND $res['DateOfResignation']!='1970-01-01'){ echo date("d-M-y", strtotime($res['DateOfResignation'])); } ?></td>
	<td align="" style="" class="All_100" valign="top"><?php if($res['DateOfSepration']!='0000-00-00' AND $res['DateOfSepration']!='1970-01-01'){ echo date("d-M-y", strtotime($res['DateOfSepration'])); } ?></td>
	...
	<td align="" class="All_80" valign="top"><?php echo $res['MobileNo_Vnr']; ?></td>
	<td align="" class="All_150" valign="top"><?php echo $res['EmailId_Vnr']; ?></td>
...
?>	  
	...
	<td align="center" style="" class="All_80" valign="top"><?php echo $TotalExp; ?></td>
...
?>	
	<td style="background-color:#FFCEE7;" class="All_200" valign="top"><?php $no=1; while($resQuali=mysql_fetch_array($sqlQuali)) { if($no<=2 AND $resQuali['Institute']!=''){echo $resQuali['Qualification'].', '; } if($resQuali['Specialization']!='')if($no==3 OR $no==4){echo $resQuali['Specialization'].', '; } if($no>=5){echo $resQuali['Qualification'].'-'.$resQuali['Specialization'].', '; } $no++;}?></td>	
	<td style="background-color:#FFCEE7;" class="All_100" valign="top"><?php if($resQ4['Specialization']!='' AND $resQ4['Institute']!=''){echo $resQ4['Specialization'];}elseif($resQ3['Specialization']!='' AND $resQ3['Institute']!=''){echo $resQ3['Specialization'];}elseif($resQ2['Institute']!=''){echo '12th';}elseif($resQ1['Institute']!=''){echo '10th';}?></td>
    <td style="background-color:#FFCEE7;" class="All_100" valign="top">&nbsp;<?php if($rowQQ>0){while($resQQ=mysql_fetch_assoc($sqlQQ)){echo $resQQ['Qualification'].'-'.$resQQ['Specialization'].', '; }}?></td>
	...
	<td align="" style="background-color:#95CAFF" class="All_150" valign="top"><?php echo $res['BamkIfscCode']; ?></td>
	...
	<td align="" style="background-color:#95CAFF" class="All_150" valign="top"><?php echo $res['AccountNo2']; ?></td>
	<td align="" style="background-color:#95CAFF" class="All_150" valign="top"><?php echo $res['BamkIfscCode2']; ?></td>
...
<?php if($res['RepEmployeeID']>0){ $sqlRn=mysql_query("select DesigId from hrm_employee_general where EmployeeID=".$res['RepEmployeeID'], $con); $resRn=mysql_fetch_assoc($sqlRn);
	...
	<td align="center" style="" class="All_80" valign="top"><?php echo $res['AadharNo']; ?></td>
	<td align="center" style="" class="All_50" valign="top"><?php echo $res['Categoryy']; ?></td>
	<td align="center" style="" class="All_80" valign="top"><?php echo $res['Religion']; ?></td>
	...
	<td align="center" style="background-color:#FCFAB1;" class="All_70" valign="top"><?php if($res['Married']=='Y') {echo date("d-M", strtotime($res['MarriageDate']));} else {echo '';}?></td>
...
<?php $sqlF=mysql_query("select * from hrm_employee_family2 where EmployeeID=".$res['EmployeeID'], $con); $noF=1; while($resF=mysql_fetch_array($sqlF)) { if($noF<=5){?>	
   	<td align="" style="" class="All_200" bgcolor="#4AA5FF"><b><?php echo $resF['FamilyName']; ?></b></td>
	<td align="" style="" class="All_80" bgcolor="#4AA5FF"><?php echo $resF['FamilyRelation']; ?></td>
	<td align="" style="" class="All_80" bgcolor="#4AA5FF"><?php echo $resF['FamilyDOB']; ?></td>
	<td align="" style="" class="All_150" bgcolor="#4AA5FF"><?php echo $resF['FamilyQualification']; ?></td>
	<td align="" style="" class="All_100" bgcolor="#4AA5FF"><?php echo $resF['FamilyOccupation'];?></td>
<?php $noF++;} } if($noF==1){ ?><td colspan="25">&nbsp;</td><?php } ?>
<?php if($noF==2){ ?><td colspan="20">&nbsp;</td><?php } ?>
<?php if($noF==3){ ?><td colspan="15">&nbsp;</td><?php } ?>
<?php if($noF==4){ ?><td colspan="10">&nbsp;</td><?php } ?>
<?php if($noF==5){ ?><td colspan="5">&nbsp;</td><?php } ?>
<?php if($noF==6){echo ''; }?>
...
<td align="center" valign="top" style="background-color:#FFD2D2;" class="All_80"><?php echo $res['DA_Outside_HqSal']; ?></td>
	...
	<td align="" valign="top" style="background-color:#FFFFBF;" class="All_80"><?php echo 'As per law'; ?></td>
<?php $LY=$YearId-1; $sqlRating=mysql_query("select HR_Rating from hrm_employee_pms where EmployeeID=".$res['EmployeeID']." AND YearId=".$LY, $con); 
	  $resRating=mysql_fetch_array($sqlRating);  ?>	
	<td align="center" valign="top" style="background-color:#FFFFBF;" class="All_80"><?php echo $resRating['HR_Rating']; ?></td>
	</tr>   
	 <?php $Sno++; } ?> 
   </table>
 </td>
