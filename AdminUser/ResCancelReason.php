...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="#D9D1E7">	
    <table style="vertical-align:top;" width="340" align="center" border="0">
	 <tr>
	  <td>
	  <table border="0">
<?php $sql=mysql_query("select Emp_CanReason from hrm_employee_separation where EmpSepId=".$_REQUEST['id'], $con); $res=mysql_fetch_assoc($sql); ?>		   
	   <tr><td colspan="2" width="450" align="center" valign="top" style="font-family:Times New Roman;font-size:16px;"><b>Resignation Cancellation Reason</b></td></tr>
	   <tr><td>&nbsp;</td></tr>
	   ...
	   <?php echo $res['Emp_CanReason']; ?></td></tr>
	 </table>
	  </td>
	</tr>
  </table>
