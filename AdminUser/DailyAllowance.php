...
<table border="0" style="margin-top:0px; width:100%; height:300px;">
 <tr>
  <td align="left" height="20" valign="top" colspan="3">
   <table border="0">
    <tr>
	  <td width="360" class="heading">Daily Allowance</td>
	  <td align="left">
	...
	<tr>
	  <td align="left" width="1200">
		 ...
		 <tr bgcolor="#7a6189">
		   ...
		   <td class="font" style="width:100px;" ><b>OutSide @ HQ (PD)</b></td>
		   <td class="font" style="width:100px;" ><b>OutSide @ HQ (Prod)</b></td>
...
if(isset($_REQUEST['action']) && $_REQUEST['action']=="edit" && $_REQUEST['eid']==$resDailyAllow['DailyAllowId']){ ?>
         ...
         <tr>
		  ...
		  <td><input class="input" name="OutSiteHQ_PD" value="<?php echo $resDailyAllow['OutSiteHQ_PD']; ?>"/></td>
		  <td><input class="input" name="OutSiteHQ_Prod" value="<?php echo $resDailyAllow['OutSiteHQ_Prod']; ?>"/></td>
...
<?php } else { ?>	 
		 <tr bgcolor="#FFFFFF">
		  ...
		  <td class="bbody">&nbsp;<?php echo $resDailyAllow['OutSiteHQ_PD'];?></td>
		  <td class="bbody">&nbsp;<?php echo $resDailyAllow['OutSiteHQ_Prod'];?></td>
