...
{
 $up=mysql_query("update hrm_pms_formb_tgtdefin set Ach='".$_POST['ach']."', LogScr='".$_POST['logscr']."', Scor='".$_POST['scor']."', AppAch='".$_POST['ach2']."', AppLogScr='".$_POST['logscr2']."', AppScor='".$_POST['scor2']."' where TgtFbDefId=".$_POST['id'],$con);
 if($up)
 { 
