...
if($_REQUEST['action']=='Over') {  }
 ...
 elseif($_REQUEST['action']=='Dept')
 { 
  $sqlDe=mysql_query("select DepartmentName from hrm_department where DepartmentId=".$_REQUEST['value'], $con); $resDe=mysql_fetch_assoc($sqlDe); $Action='DEPARTMENT:&nbsp;'.$resDe['DepartmentName'];
