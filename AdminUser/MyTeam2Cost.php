...
<?php if($_REQUEST['YI']>=8){$eu_gross=$UnEmpCtc;}else{$eu_gross=$UnEmpGross;}?>	  			
...
<?php if($_REQUEST['YI']>=8){$au_gross=$UnAppCtc;}else{$au_gross=$UnAppGross;}?>		  			
...
<?php if($_REQUEST['YI']>=8){$ru_gross=$UnRevCtc;}else{$ru_gross=$UnRevGross;}?>	  
