...
<td style="width:5px;" align="center"></td>
 ...
 <tr>
  ...
  <td class="tdd2">: <?php if($ResEligEmp['Lodging_CategoryA']>0){ if($ResEligEmp['DA_Outside_Hq']!='' AND $ResEligEmp['DA_Outside_Hq']=='Actual') {echo '&nbsp;'.$ResEligEmp['DA_Outside_Hq']; } elseif($ResEligEmp['DA_Outside_Hq']!='' AND $ResEligEmp['DA_Outside_Hq']!='Actual') {echo '&nbsp;'.$ResEligEmp['DA_Outside_Hq']; } else {echo '&nbsp;NA';}} else { if($resDaily['OutSiteHQ']!='' AND $resDaily['OutSiteHQ']=='Actual'){ echo '&nbsp;'.$resDaily['OutSiteHQ']; } elseif($resDaily['OutSiteHQ']!='' AND $resDaily['OutSiteHQ']!='Actual'){ echo '&nbsp;'.$resDaily['OutSiteHQ'].'&nbsp;&nbsp;'; }else { echo '&nbsp;NA';}} ?></td>  
 </tr>

<input type="hidden" Name="A1" id="A1" value="<?php echo $resDaily['OutSiteHQ']; ?>"/><input type="hidden" Name="B1" id="B1" value="<?php echo $resDaily['OutSiteHQ_Sales']; ?>"/>
<input type="hidden" Name="MH" id="MH" value="<?php echo $resDaily['MH']; ?>"/><input type="hidden" Name="MRSP" id="MRSP" value="<?php echo $resDaily['MRSP']; ?>"/>
<input type="hidden" Name="MRNS" id="MRNS" value="<?php echo $resDaily['MRNS']; ?>"/><input type="hidden" Name="MCS" id="MCS" value="<?php echo $resDaily['MCS']; ?>"/>
<input type="hidden" Name="MCSSP" id="MCSSP" value="<?php echo $resDaily['MCSSP']; ?>"/>
<?php if($ResE['DepartmentId']==6){?>
 <tr>
  <td class="tdd1"><b>*</b>&nbsp;&nbsp;DA @ H.Q.(Only For Sales Staff) :</td>
  <td class="tdd2">: <?php if($ResEligEmp['Lodging_CategoryA']>0){ if($ResEligEmp['DA_Outside_HqSal']!='' AND $ResEligEmp['DA_Outside_HqSal']=='Actual'){ echo '&nbsp;'.$ResEligEmp['DA_Outside_HqSal'].'&nbsp;&nbsp;Per day';} elseif($ResEligEmp['DA_Outside_HqSal']!='' AND $ResEligEmp['DA_Outside_HqSal']!='Actual'){ echo '&nbsp;'.$ResEligEmp['DA_Outside_HqSal'];} else {echo '&nbsp;NA';} } elseif($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResCtc['DepartmentId']) { if($resDaily['OutSiteHQ_Sales']!='' AND $resDaily['OutSiteHQ_Sales']=='Actual') { echo '&nbsp;'.$resDaily['OutSiteHQ_Sales']; } elseif($resDaily['OutSiteHQ_Sales']!='' AND $resDaily['OutSiteHQ_Sales']!='Actual') { echo '&nbsp;'.$resDaily['OutSiteHQ_Sales']; } else { echo '&nbsp;NA';} } ?></td>  
 </tr>
<?php } if($ResE['DepartmentId']==3){ ?>
 <tr>
  <td class="tdd1"><b>*</b>&nbsp;&nbsp;DA @ H.Q.(Only For PD Staff) in case of day tour involving <br>&nbsp;&nbsp;&nbsp;&nbsp;more than 60 kms. travel :</td>
  <td class="tdd2">: <?php if($ResEligEmp['DA_Outside_HqPD']!='' AND $ResEligEmp['DA_Outside_HqPD']!='NA'){ echo '&nbsp;'.$ResEligEmp['DA_Outside_HqPD'].'&nbsp;&nbsp;'; }else { echo '&nbsp;NA';} ?></td>  
 </tr>
<?php } ?>
 <tr>
