 ...
 <td>
  <table border="0" style="vertical-align:top;width:700px;">
   ...
   <td bgcolor="#FFFFFF">
    <table border="1">
	  <tr>
    <td class="head" style="width:100px;">Title :</td><td style="width:240px;">&nbsp;<?php echo $resT['ConfTitle']; ?></td>
	<td class="head" style="width:100px;">&nbsp;Venue :</td><td style="width:240px;">&nbsp;<?php echo $resT['Location']; ?></td>
   </tr>
   <tr>
    <td class="head" style="width:100px;">Conducted By  :</td><td style="width:240px;">&nbsp;<?php echo $resT['ConductedBy']; ?></td>
	<td class="head" style="width:100px;">&nbsp;</td><td style="width:240px;">&nbsp;<?php //echo $resT['Institute']; ?></td>
   </tr>
    <tr>
    <td class="head" style="width:100px;">Date From :</td>
	<td style="width:240px;" class="head">&nbsp;<?php echo date("d-m-Y",strtotime($resT['ConfFrom'])); ?>
	 <input type="radio" name="FromDay" id="FromHalf" onClick="ClickFrom(this.value)" value="H" <?php if($resT['ConfFrom_HF']=='H'){echo 'checked';} ?> />HalfDay&nbsp;
	 <input type="radio" name="FromDay" id="FromFull" onClick="ClickFrom(this.value)" value="F" <?php if($resT['ConfFrom_HF']=='F'){echo 'checked';} ?> />FullDay</font>
	 </td>
	<td class="head" style="width:100px;">&nbsp;Date To :</td>
	<td style="width:240px;" class="head">&nbsp;<?php echo date("d-m-Y",strtotime($resT['ConfTo'])); ?>
	 <input type="radio" name="ToDay" id="ToHalf" onClick="ClickTo(this.value)" value="H" <?php if($resT['ConfTo_HF']=='H'){echo 'checked';} ?>/>HalfDay&nbsp;
	 <input type="radio" name="ToDay" id="ToFull" onClick="ClickTo(this.value)" value="F" <?php if($resT['ConfTo_HF']=='F'){echo 'checked';} ?>/>FullDay</font>
	 </td>
   </tr>
    <tr>
   ...
   <tr><td>&nbsp;</td></tr>   
   <tr><td class="head" colspan="4">Conference Expenses Cost :&nbsp;&nbsp;</td></tr>
   <tr>
