...
<html>
<head>
<title><?php include_once('../Title.php'); ?>&nbsp;Arrears</title>
...
<?php */ ?>
<?php $sql = mysql_query("SELECT * FROM hrm_emplyee_tds_arrear WHERE EmployeeID=".$_REQUEST['E']." AND YearId=".$_REQUEST['Y'], $con); 
...
<table border="0">
 ...
 <td bgcolor="#D9D1E7">
 <table border="1">
 <tr><td colspan="4" align="center" style="font-family:Times New Roman;font-size:12px;width:400px;background-color:#7a6189;color:#FFFFFF;"><b>Arrears</b></td></tr> 
 <tr>
