...
function ChangeYear(v)
{
 ...
 window.location="Assetreports.php?act=true&mm=sas&ask=false&ww=rightProtect&we=12345&mm=er4e&r=t5t%t5s&yy=eloi&gosto=false&rigt=checkessue&mailto=promt&wew=e%e@er%rdd=012&page=1&chk="+chk+"&allot="+allot+"&reqt="+reqt+"&all="+alla+"&d="+d+"&ast="+ast+"&yer="+yer+"&ss=89&f=0i&wer=true&c="+c+"&chk2="+chk2+"&chk3="+chk3+"&chk4="+chk4+"&Demp="+Demph+"&app="+apph+"&dra="+drah+"&ove="+oveh;
}
...
{ var chk=document.getElementById("chk").value;   var chk2=document.getElementById("chk2").value; 
  ...
  if(v=='R'){window.open("AssetExportrep.php?action=RRtrue&mm=sas&ask=false&ww=rightProtect&we=12345&wew=e%e@er%rdd=012&page=1&chk="+chk+"&allot="+allot+"&reqt="+reqt+"&all="+alla+"&d="+d+"&ast="+ast+"&yer="+yer+"&ss=89&f=0i&wer=true&c="+c+"&chk2="+chk2+"&chk3="+chk3+"&chk4="+chk4+"&Demp="+Demph+"&app="+apph+"&dra="+drah+"&ove="+oveh+"&emp="+emph,"ExportForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20");}
  else if(v=='A'){window.open("AssetExportrep.php?action=AAtrue&mm=sas&ask=false&ww=rightProtect&we=12345&wew=e%e@er%rdd=012&page=1&chk="+chk+"&allot="+allot+"&reqt="+reqt+"&all="+alla+"&d="+d+"&ast="+ast+"&yer="+yer+"&ss=89&f=0i&wer=true&c="+c+"&chk2="+chk2+"&chk3="+chk3+"&chk4="+chk4+"&Demp="+Demph+"&app="+apph+"&dra="+drah+"&ove="+oveh+"&emp="+emph,"ExportForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20");}
}
