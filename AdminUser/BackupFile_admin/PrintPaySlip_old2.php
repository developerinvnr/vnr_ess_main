...
//echo 'kk='.$YId;
$SqlPay=mysql_query("SELECT * FROM ".$PayTable." WHERE EmployeeID=".$EmployeeId." AND Month=".$_REQUEST['m']." AND YEAR=".$YY."", $con); $ResPay=mysql_fetch_assoc($SqlPay); 
...
<tr>
 ...
 <tr>
  <td>
  <table style="width:950px;" border="1" cellspacing="1">
  <tr>
 ...
 <tr>
  ...
  <?php if($ResPay['Bonus_Month']>0 OR $ResPay['Arr_Pf']>0){ ?>  
  <tr>
  <td align="" style='font-family:Times New Roman; width:200px;font-size:13px;'>&nbsp;Bonus</td>
  <td align="right" style='font-family:Times New Roman; width:100px;font-size:14px;'><?php echo intval($ResPay['Bonus_Month']); ?>&nbsp;</td>
...
<?php } if($ResPay['DA']>0 OR $ResDa['Da']>0 OR $ResPay['DeductAdjmt']>0){ ?>  
  <tr>
...
<?php } if($ResPay['LeaveEncash']>0 OR $ResLeEn['LeEn']>0 OR $ResPay['RecConAllow']>0) { ?>  
  <tr>
...
<?php } if($ResPay['Arreares']>0 OR $ResArr['Arr']>0) { ?>    
  <tr>
...
<?php } if($ResPay['Arr_Bonus']>0) { ?>    
  <tr>
  <td align="" style='font-family:Times New Roman; width:200px;font-size:13px;'>&nbsp;ARREAR FOR BONUS</td>
  <td align="right" style='font-family:Times New Roman; width:100px;font-size:14px;'><?php echo intval($ResPay['Arr_Bonus']); ?>&nbsp;</td>
  <td align="" style='font-family:Times New Roman; width:200px;font-size:13px;'>&nbsp;</td>
  <td align="right" style='font-family:Times New Roman; width:100px;font-size:14px;'>&nbsp;</td>
  </tr>
  <?php } if($ResPay['Arr_LTARemb']>0) { ?>    
  <tr>
  <td align="" style='font-family:Times New Roman; width:200px;font-size:13px;'>&nbsp;ARREAR FOR LTA REIMBU.</td>
  <td align="right" style='font-family:Times New Roman; width:100px;font-size:14px;'><?php echo intval($ResPay['Arr_LTARemb']); ?>&nbsp;</td>
  <td align="" style='font-family:Times New Roman; width:200px;font-size:13px;'>&nbsp;</td>
  <td align="right" style='font-family:Times New Roman; width:100px;font-size:14px;'>&nbsp;</td>
  </tr>
  <?php } if($ResPay['Arr_RA']>0) { ?>    
  <tr>
  <td align="" style='font-family:Times New Roman; width:200px;font-size:13px;'>&nbsp;ARREAR FOR RELOCATION ALLOWANCE</td>
  <td align="right" style='font-family:Times New Roman; width:100px;font-size:14px;'><?php echo intval($ResPay['Arr_RA']); ?>&nbsp;</td>
  <td align="" style='font-family:Times New Roman; width:200px;font-size:13px;'>&nbsp;</td>
  <td align="right" style='font-family:Times New Roman; width:100px;font-size:14px;'>&nbsp;</td>
  </tr>
  <?php } if($ResPay['Arr_PP']>0) { ?>    
  <tr>
  <td align="" style='font-family:Times New Roman; width:200px;font-size:13px;'>&nbsp;ARREAR FOR PERFORMANCE PAY</td>
  <td align="right" style='font-family:Times New Roman; width:100px;font-size:14px;'><?php echo intval($ResPay['Arr_PP']); ?>&nbsp;</td>
  <td align="" style='font-family:Times New Roman; width:200px;font-size:13px;'>&nbsp;</td>
  <td align="right" style='font-family:Times New Roman; width:100px;font-size:14px;'>&nbsp;</td>
  </tr>
...
<?php $sqlLV=mysql_query("select * from ".$LeaveTable." where EmployeeID=".$EmployeeId." AND Month=".$_REQUEST['m']." AND Year='".$YY."'", $con); 
