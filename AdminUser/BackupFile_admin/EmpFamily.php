...
{ 
 if(P!='S' && P!='S2'){ if(document.getElementById(N).checked==true){var vv='Y';}else{var vv='N';} }else{vv='Y';} 
...
<?php $sqlG=mysql_query("select Covid_Vaccin,Covid_Vaccin2,Covid_Vaccin_file,Covid_Vaccin2_file  from hrm_employee_general where EmployeeID=".$EMPID,$con);
...
<tr bgcolor="#BCA9D3">
 ...
 <td class="All_150" align="center"><b>Dose-1 Cerificate</b></td>
 <td class="All_150" align="center"><b>Dose-2 Cerificate</b></td>
</tr>
<tr>
