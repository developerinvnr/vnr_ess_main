	 ...
	 <tr>
	  <td style="font-family:Times New Roman;color:#000000; width:785;" align="center">
		...
		<form name="formfile" method="post"><input type="hidden" name="SId" value="<?php echo $_REQUEST['si']; ?>" /> 
		  <tr><td style="width:100px;">&nbsp;</td><td style="width:630px;font-size:18px;font-weight:bold;">To,</td>
		      <td style="width:155px;font-size:18px;"><b>Date :&nbsp;<?php if($resSE['ResigAcceptDate']!='0000-00-00' AND $resSE['ResigAcceptDate']!='1970-01-01'){echo date("d-M-Y",strtotime($resSE['ResigAcceptDate']));} ?></b></td></tr>
       </form>
		...
		<tr><td style="width:50px;">&nbsp;</td><td style="width:600px;font-size:18px;font-weight:bold;"><?php echo ucwords(strtolower($resCity['CityName'])).', '.ucwords(strtolower($resState['StateName'])); ?></td>
		      ...
		      <td style="width:155px;">&nbsp;</td></tr>	 
		  <tr><td>&nbsp;</td></tr>	  
		  <tr><td style="width:50px;">&nbsp;</td><td style="width:630px;font-size:18px;font-weight:bold;">Sub: RESIGNATION ACCEPTANCE</td>
		      <td style="width:155px;">&nbsp;</td></tr>	 
		  <tr><td>&nbsp;</td></tr>	  
		  <tr><td style="width:50px;">&nbsp;</td><td style="width:630px;font-size:18px;font-weight:bold;"><?php echo 'Dear '.$NameE; ?></td>
		      <td style="width:155px;">&nbsp;</td></tr>	  	   
		  <tr><td>&nbsp;</td></tr>
