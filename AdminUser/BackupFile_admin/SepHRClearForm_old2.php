...
{ 
  ...
  $sqlNoc=mysql_query("select NocHRId from hrm_employee_separation_nochr where EmpSepId=".$_POST['si'], $con); $rowNoc=mysql_num_rows($sqlNoc); 
  if($rowNoc>0)
  { $sqlIns=mysql_query("update hrm_employee_separation_nochr set NocSubmitDate='".date("Y-m-d")."', BEP='".$_POST['BEP_YN']."', BEP_Amt='".$_POST['BEP_Amt']."', BEP_Remark='".$BEP_R."', BPP='".$_POST['BPP_YN']."', BPP_Amt='".$_POST['BPP_Amt']."', BPP_Remark='".$BPP_R."', BExP='".$_POST['BExP_YN']."', BExP_Amt='".$_POST['BExP_Amt']."', BExP_Remark='".$BExP_R."', AdminIC='".$_POST['AdminIC_YN']."', AdminIC_Amt='".$_POST['AdminIC_Amt']."', AdminIC_Remark='".$AdminIC_R."', AdminVC='".$_POST['AdminVC_YN']."', AdminVC_Amt='".$_POST['AdminVC_Amt']."', AdminVC_Remark='".$AdminVC_R."', CV='".$_POST['CV_YN']."', CV_Amt='".$_POST['CV_Amt']."', CV_Remark='".$CV_R."', WorkDay=".$_POST['WorkDay'].", NoticeDay=".$_POST['NoticeDay'].", TotWorkDay=".$_POST['TotWorkDay'].", ServedDay=".$_POST['ServedDay'].", RecoveryDay=".$_POST['RecoveryDay'].", TotEL=".$_POST['TotEL'].", EnCashEL=".$_POST['EnCashEL'].", Basic='".$_POST['Basic']."', HRA='".$_POST['HRA']."', CA='".$_POST['CA']."', SA='".$_POST['SA']."', DA='".$_POST['DA']."', Arrear='".$_POST['Arrear']."', Incen='".$_POST['Incen']."', PP='".$_POST['PP']."', VA='".$_POST['VA']."', TA='".$_POST['TA']."', CCA='".$_POST['CCA']."', RA='".$_POST['RA']."', Gross='".$_POST['Gross']."', LTA='".$_POST['LTA']."', MA='".$_POST['MA']."', CEA='".$_POST['CEA']."', LE='".$_POST['LE']."', Bonus='".$_POST['Bonus']."', Gratuity='".$_POST['Gratuity']."', Mediclaim='".$_POST['Mediclaim']."', RTSB='".$_POST['RTSB']."', Exgredia='".$_POST['Exgredia']."', NoticePay='".$_POST['NoticePay']."', TotEar='".$_POST['TotEar']."', PF='".$_POST['PF']."', NPR='".$_POST['NPR']."', NPR_Actual='".$_POST['NPR_Actual']."', ESIC='".$_POST['ESIC']."', ARR_ESIC='".$_POST['ARRESIC']."', VolC='".$_POST['VolC']."', RA_allow='".$_POST['RA_allow']."', HrRemark='".$HrRemark."', TotDeduct='".$_POST['TotAmt']."' where EmpSepId=".$_POST['si'], $con);} 
  else
  { $sqlIns=mysql_query("insert into hrm_employee_separation_nochr(EmpSepId, NocSubmitDate, BEP, BEP_Amt, BEP_Remark, BPP, BPP_Amt, BPP_Remark, BExP, BExP_Amt, BExP_Remark, AdminIC, AdminIC_Amt, AdminIC_Remark, AdminVC, AdminVC_Amt, AdminVC_Remark, CV, CV_Amt, CV_Remark, WorkDay, NoticeDay, TotWorkDay, ServedDay, RecoveryDay, TotEL, EnCashEL, Basic, HRA, CA, SA, DA, Arrear, Incen, PP, VA, TA, CCA, RA, Gross, LTA, MA, CEA, LE, Bonus, Gratuity, Mediclaim, RTSB, Exgredia, NoticePay, TotEar, PF, NPR, NPR_Actual, ESIC, ARR_ESIC, VolC, RA_allow, HrRemark, TotDeduct) values(".$_POST['si'].", '".date("Y-m-d")."', '".$_POST['BEP_YN']."', '".$_POST['BEP_Amt']."', '".$BEP_R."', '".$_POST['BPP_YN']."', '".$_POST['BPP_Amt']."', '".$BPP_R."', '".$_POST['BExP_YN']."', '".$_POST['BExP_Amt']."', '".$BExP_R."', '".$_POST['AdminIC_YN']."', '".$_POST['AdminIC_Amt']."', '".$AdminIC_R."', '".$_POST['AdminVC_YN']."', '".$_POST['AdminVC_Amt']."', '".$AdminVC_R."', '".$_POST['CV_YN']."', '".$_POST['CV_Amt']."', '".$CV_R."', ".$_POST['WorkDay'].", ".$_POST['NoticeDay'].", ".$_POST['TotWorkDay'].", ".$_POST['ServedDay'].", ".$_POST['RecoveryDay'].", ".$_POST['TotEL'].", ".$_POST['EnCashEL'].", '".$_POST['Basic']."', '".$_POST['HRA']."', '".$_POST['CA']."', '".$_POST['SA']."', '".$_POST['DA']."', '".$_POST['Arrear']."', '".$_POST['Incen']."', '".$_POST['PP']."', '".$_POST['VA']."', '".$_POST['TA']."', '".$_POST['CCA']."', '".$_POST['RA']."', '".$_POST['Gross']."', '".$_POST['LTA']."', '".$_POST['MA']."', '".$_POST['CEA']."', '".$_POST['LE']."', '".$_POST['Bonus']."', '".$_POST['Gratuity']."', '".$_POST['Mediclaim']."', '".$_POST['RTSB']."', '".$_POST['Exgredia']."', '".$_POST['NoticePay']."', '".$_POST['TotEar']."', '".$_POST['PF']."', '".$_POST['NPR']."', '".$_POST['NPR_Actual']."', '".$_POST['ESIC']."', '".$_POST['ARRESIC']."', '".$_POST['VolC']."', '".$_POST['RA_allow']."', '".$HrRemark."', '".$_POST['TotAmt']."')", $con); }
...
//Open Calculation  if(HrRowNOC==0)
 ...
 var Gross = document.getElementById("Gross").value=Math.round(Basic+HRA+CA+SA+DA+Arrear+Incen+PP+VA+TA+CCA+RA+CarAmt);
...
function FunEnCash()
{
 ...
 var TotEar = document.getElementById("TotEar").value=Math.round(Gross+LTA+MA+CEA+LE+Bonus+Gratuity+Mediclaim+Exgredia+NoticePay);
...
<td class="Text" align="center"><input class="AIT" id="PP" name="PP" onChange="funCalcyVal()" onBlur="funCalcyVal()" value="<?php if($res['PP']>0){echo intval($res['PP']);}else{echo 0;} ?>" readonly/></td>
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="TA" name="TA" value="<?php if($res['TA']>0){echo intval($res['TA']);}else{echo 0;} ?>" onChange="funCalcyVal()" onBlur="funCalcyVal()" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
