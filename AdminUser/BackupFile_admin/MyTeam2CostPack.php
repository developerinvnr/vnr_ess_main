...
window.location='MyTeam2CostPack.php?action='+VS+'&value='+v+'&YI='+YId;
}
function SelectDept(v)
{ var YId=document.getElementById("YId").value;
  if(v!='Over'){ window.location='MyTeam2CostPack.php?action=Dept&value='+v+'&YI='+YId; }
  else if(v=='Over'){ window.location='MyTeam2CostPack.php?action='+v+'&YI='+YId; }
}
function SelectHod(v){ var YId=document.getElementById("YId").value; window.location='MyTeam2CostPack.php?action=Hod&value='+v+'&YI='+YId;}
...
//var Hod_GS = parseFloat(document.getElementById("HodCtc_"+n).value); //HodGross 
...
var timer = setInterval( function() { if(win.closed) { clearInterval(timer);  window.location="MyTeam2CostPack.php?&action="+VS+"&value="+v+"&YI="+YI; } }, 1000);
}
   ...
   <tr>
    ...
    <?php if($_REQUEST['action']=='Over') { $Action='ORGANIZATION'; }
	 ...
	 <tr bgcolor="#7a6189" style="height:24px;">	
	  ...
	  <td colspan="4" rowspan="2" class="th">PROPOSED</td>
	 </tr>
     <tr bgcolor="#7a6189" style="height:24px;">	
...
if($resH['HodCtc']>0 OR $res2H['HodBasic']>0){$resHCtc=$resH['HodCtc']+$res2H['HodBasic'];}else{$resHCtc=0;} ?>			   			   			
...
$sqlEUn=mysql_query("select SUM(EmpCurrGrossPM)as UnEmpGross, SUM(EmpCurrIncentivePM) as UnEmpInct, SUM(EmpCurrCtc) as UnEmpTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND e.EmpStatus='A' AND p.CtcLimitCross=0 AND p.Dummy_EmpRating=0", $con); $resEUn=mysql_fetch_array($sqlEUn);

$sql2EUn=mysql_query("select SUM(EmpCurrAnnualBasic)as UnEmpBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND e.EmpStatus='A' AND p.CtcLimitCross=1 AND p.Dummy_EmpRating=0", $con); $res2EUn=mysql_fetch_array($sql2EUn);
...
if($resEUn['UnEmpTCtc']>0){$UnEmpCtc=$resEUn['UnEmpTCtc'];}else{$UnEmpCtc=0;}?>	
<input type="hidden" name="E19" id="E19" value="<?php echo $UnEmpGross; ?>" />	   
      <td class="tdc"><?php echo $resNOEUn['NOEUn']; ?></td>
<?php if($_REQUEST['YI']>=8){$eu_gross=$UnEmpCtc+$res2EUn['UnEmpBasic'];}else{$eu_gross=$UnEmpGross;}?>	  			
	  <td class="tdr"><?php echo floatval($eu_gross); //$UnEmpGross; ?>&nbsp;</td>
	  
<?php //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser
$sqlAUn=mysql_query("select SUM(EmpCurrGrossPM)as UnAppGross, SUM(EmpCurrIncentivePM) as UnAppInct, SUM(EmpCurrCtc) as UnAppTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND e.EmpStatus='A' AND p.CtcLimitCross=0 AND p.Dummy_AppRating=0", $con); $resAUn=mysql_fetch_array($sqlAUn);

$sql2AUn=mysql_query("select SUM(EmpCurrAnnualBasic)as UnAppBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND e.EmpStatus='A' AND p.CtcLimitCross=1 AND p.Dummy_AppRating=0", $con); $res2AUn=mysql_fetch_array($sql2AUn);
...
if($resAUn['UnAppTCtc']>0){$UnAppCtc=$resAUn['UnAppTCtc'];}else{$UnAppCtc=0;}?>	
<input type="hidden" name="A19" id="A19" value="<?php echo $UnAppGross; ?>" />	   
      <td class="tdc"><?php echo $resNOAUn['NOAUn']; ?></td>
<?php if($_REQUEST['YI']>=8){$au_gross=$UnAppCtc+$res2AUn['UnAppBasic'];}else{$au_gross=$UnAppGross;}?>		  			
	  <td class="tdr"><?php echo floatval($au_gross); //$UnAppGross; ?>&nbsp;</td>
		
<?php //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer
$sqlRUn=mysql_query("select SUM(EmpCurrGrossPM)as UnRevGross, SUM(EmpCurrIncentivePM) as UnRevInct, SUM(EmpCurrCtc) as UnRevTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND e.EmpStatus='A' AND p.CtcLimitCross=0 AND p.Dummy_RevRating=0", $con); $resRUn=mysql_fetch_array($sqlRUn);

$sql2RUn=mysql_query("select SUM(EmpCurrAnnualBasic)as UnRevBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND e.EmpStatus='A' AND p.CtcLimitCross=1 AND p.Dummy_RevRating=0", $con); $res2RUn=mysql_fetch_array($sql2RUn);
...
if($resRUn['UnRevTCtc']>0){$UnRevCtc=$resRUn['UnRevTCtc'];}else{$UnRevCtc=0;}?>	
<input type="hidden" name="R19" id="R19" value="<?php echo $UnRevGross; ?>" />	   
      <td class="tdc"><?php echo $resNORUn['NORUn']; ?></td>			
<?php if($_REQUEST['YI']>=8){$ru_gross=$UnRevCtc+$res2RUn['UnRevBasic'];}else{$ru_gross=$UnRevGross;}?>	  
	  <td class="tdr"><?php echo floatval($ru_gross); //$UnRevGross; ?>&nbsp;</td>	

<?php //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD
$sqlHUn=mysql_query("select SUM(EmpCurrGrossPM)as UnHodGross, SUM(EmpCurrIncentivePM) as UnHodInct, SUM(EmpCurrCtc) as UnHodTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND e.EmpStatus='A' AND p.CtcLimitCross=0 AND p.Dummy_HodRating=0", $con); $resHUn=mysql_fetch_array($sqlHUn);

$sql2HUn=mysql_query("select SUM(EmpCurrGrossPM)as UnHodGross, SUM(EmpCurrAnnualBasic)as UnHodBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND e.EmpStatus='A' AND p.CtcLimitCross=1 AND p.Dummy_HodRating=0", $con); $res2HUn=mysql_fetch_array($sql2HUn);
...
if($resHUn['UnHodGross']>0){ $UnHodGross=$resHUn['UnHodGross']+$res2HUn['UnHodGross']+$resHUn['UnHodInct'];}else{$UnHodGross=0;} 
if($resHUn['UnHodTCtc']>0){$UnHodCtc=$resHUn['UnHodTCtc']+$res2HUn['UnHodBasic'];}else{$UnHodCtc=0;} ?>	
...
if($_REQUEST['YI']>=8)
{ 
 if($UnHodCtc>0){ $IncpGross=($UnHodCtc*130)/100; $Un_IncS=($UnHodCtc*30)/100; }
      elseif($UnRevCtc>0){ $IncpGross=($UnRevCtc*130)/100; $Un_IncS=($UnRevCtc*30)/100; } 
	  elseif($UnAppCtc>0){ $IncpGross=($UnAppCtc*130)/100; $Un_IncS=($UnAppCtc*30)/100; }
	  elseif($UnEmpCtc>0){ $IncpGross=($UnEmpCtc*130)/100; $Un_IncS=($UnEmpCtc*30)/100; }    
}
else
{ 
 if($UnHodGross>0){ $IncpGross=($UnHodGross*130)/100; $Un_IncS=($UnHodGross*30)/100; }
...
?>		  				
	  ...
	  <?php /*?><td class="tdc"><input class="inpr" style="font-weight:bold;background-color:#C5FF8A;" id="UnE_CtcS" name="UnE_CtcS" value="<?php echo $HUn5I; ?>" readonly/></td><?php */?>
	  
	  <input type="hidden" class="inpr" style="font-weight:bold;background-color:#C5FF8A;" id="UnE_CtcS" name="UnE_CtcS" value="<?php echo $HUn5I; ?>" readonly/>
...
<?php if($_REQUEST['YI']>=8){$et_gross=$ET+$UnEmpCtc;}else{$et_gross=$ET+$UnEmpGross;}?>		 
	 <td class="tdr" style="color:#FFFFFF;"><b><?php echo floatval($et_gross); //$ET+$UnEmpGross ?></b>&nbsp;</td>
...
<?php if($_REQUEST['YI']>=8){$at_gross=$AT+$UnAppCtc;}else{$at_gross=$AT+$UnAppGross;}?>	    			   
	 <td class="tdr" style="color:#FFFFFF;"><b><?php echo floatval($at_gross); //$AT+$UnAppGross ?></b>&nbsp;</td> 
...
<?php if($_REQUEST['YI']>=8){$rt_gross=$RT+$UnRevCtc;}else{$rt_gross=$RT+$UnRevGross;}?>	    			   
	 <td class="tdr" style="color:#FFFFFF;"><b><?php echo floatval($rt_gross); //$RT+$UnRevGross ?></b>&nbsp;</td>
		
<?php //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD 
$sqlHT=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrIncentivePM) as HodInct, SUM(EmpCurrCtc) as HodTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.Dummy_HodRating!=0 AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CtcLimitCross=0 AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0", $con); $resHT=mysql_fetch_array($sqlHT);

$sql2HT=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrAnnualBasic)as HodBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.Dummy_HodRating!=0 AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CtcLimitCross=1 AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0", $con); $res2HT=mysql_fetch_array($sql2HT);

$NOHT=mysql_query("select count(*) as NOHT from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Dummy_HodRating!=0 AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0", $con); $resNOHT=mysql_fetch_array($NOHT); $HT=$resHT['HodGross']+$res2HT['HodGross']+$resHT['HodInct']; ?>	
...
<input type="hidden" name="HodCtcT" id="HodCtcT" value="<?php echo floatval($resHT['HodTCtc']+$UnHodCtc); ?>" />		
	 ...
	 <td class="tdr" style="color:#FFFFFF;"><b><?php echo floatval($resHT['HodTCtc']+$res2HT['HodBasic']+$UnHodCtc); ?></b>&nbsp;</td>	
...
?>
      <td class="tdc"><input class="inpr" style="font-weight:bold;background-color:#0076EC;color:#FFFFFF;" id="PIST" name="PIST" value="<?php echo floatval($TotProsHT); //$HTotPT); ?>" readonly/></td>
