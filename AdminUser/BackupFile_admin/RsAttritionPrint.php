...
<?php if($_REQUEST['y']!=0){ $sY=mysql_query("select * from hrm_year where YearId=".$_REQUEST['y']."", $con); $rY=mysql_fetch_assoc($sY);  
     ...
     <td class="td1" style="font-size:14px;width:2000px;font-family:Times New Roman;" valign="top">&nbsp;&nbsp;<b>Year:</b>&nbsp;<?php echo $PRD; ?></td>
   </tr>
   </table>
  </td>
 </tr>
...
<tr>
 <td align="left">
  ...
  <tr bgcolor="#7a6189">
   <td align="center" class="font" style="width:50px;">Month</td>
