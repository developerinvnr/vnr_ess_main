...
{ var YId=document.getElementById("YId").value; window.location='MyTeamCost.php?action=Hod&value='+v+'&YI='+YId;}

function SelectRev2(v)
{ var YId=document.getElementById("YId").value; window.location='MyTeamCost.php?action=Rev2&value='+v+'&YI='+YId;}

function SelectRev(v)
{ var YId=document.getElementById("YId").value; window.location='MyTeamCost.php?action=Rev&value='+v+'&YI='+YId;}

function SelectApp(v)
{ var YId=document.getElementById("YId").value; window.location='MyTeamCost.php?action=App&value='+v+'&YI='+YId;}
...
<?php if($_REQUEST['YI']>=8){$e_gross=$resE['EmpCtc'];}else{$e_gross=$resEGross;}?>	  		   
...
<?php if($_REQUEST['YI']>=8){$a_gross=$resA['AppCtc'];}else{$a_gross=$resAGross;}?>	 	  			   
...
<?php if($_REQUEST['YI']>=8){$r_gross=$resRe['RevCtc'];}else{$r_gross=$resRGross;}?>	  			   
	  <td class="tdr"><?php echo floatval($r_gross); //$resRGross; ?>&nbsp;</td>
		
<?php //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD
$sqlH=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrIncentivePM) as HodInct, SUM(EmpCurrCtc) as HodCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 ".$query." ".$query_y." AND p.Dummy_HodRating=".$resR['Rating'], $con); 
...
<?php  
//Employee //Employee //Employee //Employee //Employee //Employee //Employee //Employee
$sqlET=mysql_query("select SUM(EmpCurrGrossPM)as EmpGross, SUM(EmpCurrIncentivePM) as EmpInct, SUM(EmpCurrCtc) as EmpTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_EmpRating!=0 AND p.Appraiser_EmployeeID!=0", $con); $resET=mysql_fetch_array($sqlET);
...
<?php if($_REQUEST['YI']>=8){$et_gross=$resET['EmpTCtc'];}else{$et_gross=$ET;}?>	  		
	  <td class="tdr" style="color:#FFFFFF;"><?php echo floatval($et_gross); //$ET ?>&nbsp;</td>

<?php //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser 
$sqlAT=mysql_query("select SUM(EmpCurrGrossPM)as AppGross, SUM(EmpCurrIncentivePM) as AppInct, SUM(EmpCurrCtc) as AppTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_AppRating!=0 AND p.Appraiser_EmployeeID!=0", $con); $resAT=mysql_fetch_array($sqlAT);
...
<?php if($_REQUEST['YI']>=8){$at_gross=$resAT['AppTCtc'];}else{$at_gross=$AT;}?>	     			
	  <td class="tdr" style="color:#FFFFFF;"><?php echo floatval($at_gross); //$AT ?>&nbsp;</td> 


<?php //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer 
$sqlRT=mysql_query("select SUM(EmpCurrGrossPM)as RevGross, SUM(EmpCurrIncentivePM) as RevInct, SUM(EmpCurrCtc) as RevTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_RevRating!=0 AND p.Appraiser_EmployeeID!=0", $con); $resRT=mysql_fetch_array($sqlRT);
...
<?php if($_REQUEST['YI']>=8){$rt_gross=$resRT['RevTCtc'];}else{$rt_gross=$RT;}?>	     			
	  <td class="tdr" style="color:#FFFFFF;"><?php echo floatval($rt_gross); //$RT ?>&nbsp;</td>
		
<?php //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD 
$sqlHT=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrIncentivePM) as HodInct, SUM(EmpCurrCtc) as HodTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_HodRating!=0 AND p.Appraiser_EmployeeID!=0", $con); $resHT=mysql_fetch_array($sqlHT);
$NOHT=mysql_query("select count(*) as NOHT from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_HodRating!=0 AND p.Appraiser_EmployeeID!=0", $con); $resNOHT=mysql_fetch_array($NOHT); $HT=$resHT['HodGross']+$resHT['HodInct']; ?>
...
<input type="hidden" name="HodCtcT" id="HodCtcT" value="<?php echo number_format($resHT['HodTCtc'], 2, '.', ''); ?>" />
	  ...
	  <td class="tdr" style="color:#FFFFFF;"><?php echo floatval($resHT['HodTCtc']); ?>&nbsp;</td>			   
