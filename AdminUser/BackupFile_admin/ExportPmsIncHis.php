...
{  
  if($_REQUEST['value']==0)
  { $sql=mysql_query("select h.*,Fname,Sname,Lname from hrm_pms_appraisal_history h INNER JOIN hrm_employee e ON h.EmpCode=e.EmpCode where h.CompanyId=".$_REQUEST['c']." AND e.CompanyId=".$_REQUEST['c']." order by h.EmpCode ASC, h.SalaryChange_Date ASC", $con); }
    else{ $sql=mysql_query("select h.*,Fname,Sname,Lname from hrm_pms_appraisal_history h INNER JOIN hrm_employee e ON h.EmpCode=e.EmpCode INNER JOIN hrm_employee_pms p ON e.EmployeeID=p.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where h.CompanyId=".$_REQUEST['c']." AND g.DepartmentId=".$_REQUEST['value']." AND p.AssessmentYear=".$_REQUEST['YI']." order by h.EmpCode ASC, h.SalaryChange_Date ASC", $con); }
}
elseif($_REQUEST['ee']=='App')
{ $sql=mysql_query("select h.*,Fname,Sname,Lname from hrm_pms_appraisal_history h INNER JOIN hrm_employee e ON h.EmpCode=e.EmpCode INNER JOIN hrm_employee_pms p ON e.EmployeeID=p.EmployeeID where h.CompanyId=".$_REQUEST['c']." AND p.Appraiser_EmployeeID=".$_REQUEST['value']." AND p.AssessmentYear=".$_REQUEST['YI']." order by h.EmpCode ASC, h.SalaryChange_Date ASC", $con); }
elseif($_REQUEST['ee']=='Rev')
{ $sql=mysql_query("select h.*,Fname,Sname,Lname from hrm_pms_appraisal_history h INNER JOIN hrm_employee e ON h.EmpCode=e.EmpCode INNER JOIN hrm_employee_pms p ON e.EmployeeID=p.EmployeeID where h.CompanyId=".$_REQUEST['c']." AND p.Reviewer_EmployeeID=".$_REQUEST['value']." AND p.AssessmentYear=".$_REQUEST['YI']." order by h.EmpCode ASC, h.SalaryChange_Date ASC", $con); 
}
elseif($_REQUEST['ee']=='Rev2')
{ $sql=mysql_query("select h.*,Fname,Sname,Lname from hrm_pms_appraisal_history h INNER JOIN hrm_employee e ON h.EmpCode=e.EmpCode INNER JOIN hrm_employee_pms p ON e.EmployeeID=p.EmployeeID where h.CompanyId=".$_REQUEST['c']." AND p.Rev2_EmployeeID=".$_REQUEST['value']." AND p.AssessmentYear=".$_REQUEST['YI']." order by h.EmpCode ASC, h.SalaryChange_Date ASC", $con); 
}
elseif($_REQUEST['ee']=='Hod')
{ $sql=mysql_query("select h.*,Fname,Sname,Lname from hrm_pms_appraisal_history h INNER JOIN hrm_employee e ON h.EmpCode=e.EmpCode INNER JOIN hrm_employee_pms p ON e.EmployeeID=p.EmployeeID where h.CompanyId=".$_REQUEST['c']." AND p.HOD_EmployeeID=".$_REQUEST['value']." AND p.AssessmentYear=".$_REQUEST['YI']." order by h.EmpCode ASC, h.SalaryChange_Date ASC", $con); 
}  
