...
if($RowAllow==0){$InsSalary=mysql_query("insert into hrm_emplyee_tds_allowance(EmployeeID, Period, YearId, Month, RA_Amt, RA_TaxFree, Status, CreatedBy, CreatedDate) values(".$_POST['E'].", '".$PRD."', ".$_POST['YI'].", ".$M.", '".$DA."', '".$DAF."', 'A', ".$_POST['U'].", '".date("Y-m-d")."')", $con);}
if($RowAllow>0){$UpSalary=mysql_query("update hrm_emplyee_tds_allowance set YearId=".$_POST['YI'].", RA_Amt='".$DA."', RA_TaxFree='".$DAF."', CreatedBy=".$_POST['U'].", CreatedDate='".date("Y-m-d")."' where EmployeeID=".$_POST['E']." AND Month=".$M." AND Period='".$PRD."'", $con);}
*/
...
if($rowMP>0){ 
$UpSal=mysql_query("update hrm_employee_monthlypayslip set RA='".$DAmt."' where EmployeeID=".$_POST['E']." AND Month=".$M." AND Year=".$_POST['Y']."", $con);}
else{$UpSal=mysql_query("insert into hrm_employee_monthlypayslip(EmployeeID, Month, Year, RA) values(".$_POST['E'].", ".$M.", ".$_POST['Y'].", '".$DAmt."')", $con);}
...
<?php $sql = mysql_query("SELECT * FROM hrm_emplyee_tds_ra WHERE EmployeeID=".$_REQUEST['E']." AND YearId=".$_REQUEST['YI'], $con); 
...
&nbsp;<font color="#800000">EC:</font>&nbsp;<?php echo $EC.'&nbsp;&nbsp;&nbsp;<font color="#800000">Name:</font>&nbsp;'.$Ename; ?>
 ...
 <td bgcolor="#D9D1E7">
 <table border="1">
 <tr><td colspan="4" align="center" style="font-family:Times New Roman;font-size:12px;width:400px;background-color:#7a6189;color:#FFFFFF;"><b>Relocation Allowance</b></td></tr> 
 <tr>
 ...
 <tr bgcolor="#7a6189">
   <td align="right" colspan="4">
    <table>
	 ...
	 <td align="right" style="width:90px;"><input type="button" name="Refresh" id="Refresh" style="width:90px;" value="refresh" onClick="javascript:window.location='EmpEditRA.php?E=<?php echo $_REQUEST['E']; ?>&C=<?php echo $_REQUEST['C']; ?>&YI=<?php echo $_REQUEST['YI']; ?>&U=<?php echo $_REQUEST['U']; ?>&M=<?php echo $_REQUEST['M']; ?>&Y=<?php echo $_REQUEST['Y']; ?>'"/> </td>				   
	</tr>
	</table>
	</td>
	</tr>
