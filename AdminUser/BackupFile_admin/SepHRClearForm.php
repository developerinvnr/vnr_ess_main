...
function funCalcyVal()
{
 ...
 var RTSB = parseFloat(document.getElementById("RTSB").value); var Bonus_Adjustment = parseFloat(document.getElementById("Bonus_Adjustment").value);
 var Exgredia = parseFloat(document.getElementById("Exgredia").value);
 var NoticePay = parseFloat(document.getElementById("NoticePay").value);
 var TotEar = document.getElementById("TotEar").value=Math.round(Gross+LTA+MA+CEA+LE+Bonus+Gratuity+Mediclaim+Exgredia+NoticePay+Bonus_Adjustment);
...
{ 
 ...
 var TotDeductAmt = document.getElementById("TotAmt").value=Math.round((DeductAmt+PF+NPR+ESIC+ARRESIC+VolC+RA_allow+RTSB)*100)/100; 
