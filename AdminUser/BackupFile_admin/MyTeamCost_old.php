...
{ 
 ...
 { 
  ...
  if($row3==0)
  { $sqlU3=mysql_query("insert into hrm_pms_dummy_increment_untot(YearId, CompanyId, TEmpValue, TAppValue, TRevValue, THodValue, TIncGross, TPerInc, TInc, CreatedBy, CreatedDate)values(".$YearId.", ".$CompanyId.", '".$_POST['EmpGrossT']."', '".$_POST['AppGrossT']."', '".$_POST['RevGrossT']."', '".$_POST['HodGrossT']."', '".$_POST['PIST']."', '".$_POST['PerIST']."', '".$_POST['IncST']."', ".$UserId.", '".date("Y-m-d")."')", $con); }
...
<?php 
if($_REQUEST['action']=='Over'){ $query=''; $query_num=''; }
elseif($_REQUEST['action']=='Dept'){ $query='AND g.DepartmentId='.$_REQUEST['value']; }
elseif($_REQUEST['action']=='Hod'){ $query='AND p.HOD_EmployeeID='.$_REQUEST['value']; }
...
<?php /**************************************** Dummy Start *********************************/ ?>
<?php /**************************************** Dummy Start *********************************/ ?>	  
<?php $sql2I=mysql_query("select PerInc from hrm_pms_dummy_increment where YearId=".$_REQUEST['YI']." AND CompanyId=".$CompanyId." AND Rating=".$resR['Rating'], $con);  $res2I=mysql_fetch_array($sql2I); 
...
<?php /**************************************** Dummy Start *********************************/ ?>	
<?php /**************************************** Dummy Start *********************************/ ?>			   
<?php $sql4I=mysql_query("select TIncGross,TPerInc,TInc from hrm_pms_dummy_increment_untot where YearId=".$_REQUEST['YI']." AND CompanyId=".$CompanyId, $con); $res4I=mysql_fetch_array($sql4I);
...
<?php /**************************************** Dummy Start *********************************/ ?>	
<?php /**************************************** Dummy Start *********************************/ ?>			   
<?php $sql3I=mysql_query("select IncGross,PerInc,Inc from hrm_pms_dummy_increment_un where YearId=".$_REQUEST['YI']." AND CompanyId=".$CompanyId, $con);
