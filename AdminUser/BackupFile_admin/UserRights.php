...
<table border="0" style="margin-top:0px; width:100%;">
    ...
    <tr><td align="left" style="height:20px;" valign="top">
	       ...
	       <table border="0"><tr><td><img src="images/userRight.png" border="0" /></td>

		                         <td align="left" valign="middle" class="font1"><b><?php echo '&nbsp;&nbsp;'.$ename.''; ?></b>&nbsp;&nbsp;&nbsp;&nbsp;</td>  

								 <td><input type="button" name="Back" value="Back" onClick="javascript:window.location='<?php if($_SESSION['UserType']=='S') { echo 'MasterUser.php';} elseif($_SESSION['UserType']=='A') { echo 'MasterUser.php';}?>?log=<?php echo $_SESSION['logCheckUser']; ?>'"/></td>&nbsp;&nbsp;&nbsp;&nbsp;
...
<td valign="middle" id="master" style="display:none;" width="100%">
	  ...
	  <table border="0" bgcolor="#FFFFFF">
		...
		<tr>
		   ...
		   <td><select name="Basic">

			   <option value="<?php echo $ResultSubMenu['Mas_ComMaster_Basic']; ?>"><?php if($ResultSubMenu['Mas_ComMaster_Basic']==1) { echo 'Y';} else { echo 'N';} ?></option>

			   <option value="<?php if($ResultSubMenu['Mas_ComMaster_Basic']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_ComMaster_Basic']==1) { echo 'N';} else { echo 'Y';} ?></option>
		  ...
		  <td align="left" class="font2">&nbsp;Statutory Details &nbsp;:&nbsp;</td>
		   ...
		   <td><select name="Statutory">

			   <option value="<?php echo $ResultSubMenu['Mas_ComMaster_Statutory']; ?>"><?php if($ResultSubMenu['Mas_ComMaster_Statutory']==1) { echo 'Y';} else { echo 'N';} ?></option>

			   <option value="<?php if($ResultSubMenu['Mas_ComMaster_Statutory']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_ComMaster_Statutory']==1) { echo 'N';} else { echo 'Y';} ?></option>
		   ...
		   <td><select name="Vendors">
			   ...
			   <option value="<?php echo $ResultSubMenu['Mas_ComMaster_Vendors']; ?>"><?php if($ResultSubMenu['Mas_ComMaster_Vendors']==1) { echo 'Y';} else { echo 'N';} ?></option>

			   <option value="<?php if($ResultSubMenu['Mas_ComMaster_Vendors']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_ComMaster_Vendors']==1) { echo 'N';} else { echo 'Y';} ?></option>
		...
		<tr>
		   ...
		   <td><select name="Dept">
			   ...
			   <option value="<?php echo $ResultSubMenu['Mas_DetailMand_Dept']; ?>"><?php if($ResultSubMenu['Mas_DetailMand_Dept']==1) { echo 'Y';} else { echo 'N';} ?></option>

			   <option value="<?php if($ResultSubMenu['Mas_DetailMand_Dept']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_DetailMand_Dept']==1) { echo 'N';} else { echo 'Y';} ?></option>
		  ...
		  <td align="left" class="font2">&nbsp;HeadQuater &nbsp;:&nbsp;</td>
		   ...
		   <td><select name="HQ">
			   ...
			   <option value="<?php echo $ResultSubMenu['Mas_DetailMand_HQ']; ?>"><?php if($ResultSubMenu['Mas_DetailMand_HQ']==1) { echo 'Y';} else { echo 'N';} ?></option>

			   <option value="<?php if($ResultSubMenu['Mas_DetailMand_HQ']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_DetailMand_HQ']==1) { echo 'N';} else { echo 'Y';} ?></option>
		   ...
		   <td><select name="Grade">
			   ...
			   <option value="<?php echo $ResultSubMenu['Mas_DetailMand_Grade']; ?>"><?php if($ResultSubMenu['Mas_DetailMand_Grade']==1) { echo 'Y';} else { echo 'N';} ?></option>

			   <option value="<?php if($ResultSubMenu['Mas_DetailMand_Grade']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_DetailMand_Grade']==1) { echo 'N';} else { echo 'Y';} ?></option>
		  ...
		  <td align="left" class="font2">&nbsp;Designation &nbsp;:&nbsp;</td>
		   ...
		   <td><select name="Desig">
			   ...
			   <option value="<?php echo $ResultSubMenu['Mas_DetailMand_Desig']; ?>"><?php if($ResultSubMenu['Mas_DetailMand_Desig']==1) { echo 'Y';} else { echo 'N';} ?></option>

			   <option value="<?php if($ResultSubMenu['Mas_DetailMand_Desig']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_DetailMand_Desig']==1) { echo 'N';} else { echo 'Y';} ?></option>
		   ...
		   <td><select name="DeptGradeDesig">

			   <option value="<?php echo $ResultSubMenu['Mas_DetailMand_DeptGradeDesig']; ?>"><?php if($ResultSubMenu['Mas_DetailMand_DeptGradeDesig']==1) { echo 'Y';} else { echo 'N';} ?></option>

			   <option value="<?php if($ResultSubMenu['Mas_DetailMand_DeptGradeDesig']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_DetailMand_DeptGradeDesig']==1) { echo 'N';} else { echo 'Y';} ?></option>
		...
		<tr>
		   ...
		   <td><select name="CityClass">
			   ...
			   <option value="<?php echo $ResultSubMenu['Mas_DetailMand_CityClass']; ?>"><?php if($ResultSubMenu['Mas_DetailMand_CityClass']==1) { echo 'Y';} else { echo 'N';} ?></option>

			   <option value="<?php if($ResultSubMenu['Mas_DetailMand_CityClass']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_DetailMand_CityClass']==1) { echo 'N';} else { echo 'Y';} ?></option>
		  ...
		  <td align="left" class="font2">&nbsp;CostCenter &nbsp;:&nbsp;</td>
		   ...
		   <td><select name="CostCenter">
			   ...
			   <option value="<?php echo $ResultSubMenu['Mas_DetailMand_CostCenter']; ?>"><?php if($ResultSubMenu['Mas_DetailMand_CostCenter']==1) { echo 'Y';} else { echo 'N';} ?></option>

			   <option value="<?php if($ResultSubMenu['Mas_DetailMand_CostCenter']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_DetailMand_CostCenter']==1) { echo 'N';} else { echo 'Y';} ?></option>
		  ...
		  <td><select name="Restructuring">
			   ...
			   <option value="<?php if($ResultSubMenu['Mas_Restructuring']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Mas_Restructuring']==1) { echo 'N';} else { echo 'Y';} ?></option>
		           ...
		           <tr bgcolor="#C8C2E2"><td align="center">
				        ...
				        <table border="0"><tr><td align="center"><input type="button" onClick="javascript:window.location='UserRights.php?uuxiid=<?php echo $_REQUEST['uuxiid']; ?>'" value="Cancel" />&nbsp;&nbsp;<input type="submit" name="SubMenuMaster" id="SubMenuMaster" value="Save" /></td></tr></table>
		   ...
		   <td><select name="CloseMonth">
			   ...
			   <option value="<?php if($ResultSubMenu['Pro_Monthly_CloseMonth']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Pro_Monthly_CloseMonth']==1) { echo 'N';} else { echo 'Y';} ?></option>
		           ...
		           <tr bgcolor="#C8C2E2"><td align="center">
				        ...
				        <table border="0"><tr><td align="center"><input type="button" onClick="javascript:window.location='UserRights.php?uuxiid=<?php echo $_REQUEST['uuxiid']; ?>'" value="Cancel" />&nbsp;&nbsp;<input type="submit" name="SubMenuProcessing" id="SubMenuProcessing" value="Save" /></td></tr></table>
		   ...
		   <td><select name="ConfLetter">
			   ...
			   <option value="<?php if($ResultSubMenu['Util_ConfLetter']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Util_ConfLetter']==1) { echo 'N';} else { echo 'Y';} ?></option>
		           ...
		           <tr bgcolor="#C8C2E2"><td align="center">
				        ...
				        <table border="0"><tr><td align="center"><input type="button" onClick="javascript:window.location='UserRights.php?uuxiid=<?php echo $_REQUEST['uuxiid']; ?>'" value="Cancel" />&nbsp;&nbsp;<input type="submit" name="SubMenuUtility" id="SubMenuUtility" value="Save" /></td></tr></table>
...
<tr><td><table border="1"><tr>
     ...
     <tr bgcolor="#C8C2E2"><td align="center">
     <table border="0"><tr><td align="center"><input type="button" onClick="javascript:window.location='UserRights.php?uuxiid=<?php echo $_REQUEST['uuxiid']; ?>'" value="Cancel" />&nbsp;&nbsp;<input type="submit" name="SubMenuQuery" id="SubMenuQuery" value="Save" /></td></tr>
	 </table>
    </td>
   </tr>
</table>
		   ...
		   <td><select name="EditKRA">
			   ...
			   <option value="<?php if($ResultSubMenu['PMS_EditKRA']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['PMS_EditKRA']==1) { echo 'N';} else { echo 'Y';} ?></option>
		           ...
		           <tr bgcolor="#C8C2E2"><td align="center">
				        ...
				        <table border="0"><tr><td align="center"><input type="button" onClick="javascript:window.location='UserRights.php?uuxiid=<?php echo $_REQUEST['uuxiid']; ?>'" value="Cancel" />&nbsp;&nbsp;<input type="submit" name="SubMenuPMS" id="SubMenuPMS" value="Save" /></td></tr></table>
		   ...
		   <td><select name="ee">
			   ...
			   <option value="<?php if($ResultSubMenu['Recruit_ee']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Recruit_ee']==1) { echo 'N';} else { echo 'Y';} ?></option>
		           ...
		           <tr bgcolor="#C8C2E2"><td align="center">
				        ...
				        <table border="0"><tr><td align="center"><input type="button" onClick="javascript:window.location='UserRights.php?uuxiid=<?php echo $_REQUEST['uuxiid']; ?>'" value="Cancel" />&nbsp;&nbsp;<input type="submit" name="SubMenuRecruit" id="SubMenuRecruit" value="Save" /></td></tr></table>
		   ...
		   <td><select name="Absconding">
			   ...
			   <option value="<?php if($ResultSubMenu['Separ_Absconding']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Separ_Absconding']==1) { echo 'N';} else { echo 'Y';} ?></option>
		           ...
		           <tr bgcolor="#C8C2E2"><td align="center">
				        ...
				        <table border="0"><tr><td align="center"><input type="button" onClick="javascript:window.location='UserRights.php?uuxiid=<?php echo $_REQUEST['uuxiid']; ?>'" value="Cancel" />&nbsp;&nbsp;<input type="submit" name="SubMenuSepar" id="SubMenuSepar" value="Save" /></td></tr></table>
		   ...
		   <td><select name="FullFinal">
			   ...
			   <option value="<?php if($ResultSubMenu['Report_FullFinal']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['Report_FullFinal']==1) { echo 'N';} else { echo 'Y';} ?></option>
		           ...
		           <tr bgcolor="#C8C2E2"><td align="center">
				        ...
				        <table border="0"><tr><td align="center"><input type="button" onClick="javascript:window.location='UserRights.php?uuxiid=<?php echo $_REQUEST['uuxiid']; ?>'" value="Cancel" />&nbsp;&nbsp;<input type="submit" name="SubMenuReport" id="SubMenuReport" value="Save" /></td></tr></table>
		   ...
		   <td><select name="ee">
			   ...
			   <option value="<?php if($ResultSubMenu['TDS_ee']==1){echo '0';} else { echo '1';} ?>"><?php if($ResultSubMenu['TDS_ee']==1) { echo 'N';} else { echo 'Y';} ?></option>
		           ...
		           <tr bgcolor="#C8C2E2"><td align="center">
				        ...
				        <table border="0"><tr><td align="center"><input type="button" onClick="javascript:window.location='UserRights.php?uuxiid=<?php echo $_REQUEST['uuxiid']; ?>'" value="Cancel" />&nbsp;&nbsp;<input type="submit" name="SubMenuTDS" id="SubMenuTDS" value="Save" /></td></tr></table>
