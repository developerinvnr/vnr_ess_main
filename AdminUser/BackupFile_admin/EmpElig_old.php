...
{
 $sqlCode=mysql_query("select EmpCode from hrm_employee where EmployeeID=".$EMPID, $con); $resCode=mysql_fetch_assoc($sqlCode);
 ...
 { 
     ...
     $SqlInsElig = mysql_query("UPDATE hrm_employee_eligibility SET EC=".$resCode['EmpCode'].", Lodging_CategoryA='".$_POST['LodgingCatA']."', Lodging_CategoryB='".$_POST['LodgingCatB']."', Lodging_CategoryC='".$_POST['LodgingCatC']."', DA_Outside_Hq='".$_POST['DaOutSide_HQRs']."', DA_Outside_HqSal='".$_POST['DaOutSide_HQSalesRs']."', DA_Outside_HqPD='".$_POST['DaOutSide_HQPDRs']."', DA_Outside_HqWithNightH='".$_POST['DaOutSide_HQRs_WithNH']."', DA_Outside_HqWithOutNightH='".$_POST['DaOutSide_HQRs_WithOutNH']."', Travel_TwoWeeKM='".$_POST['TwoWheelerKM']."', Travel_FourWeeKM='".$_POST['FourWheelerKM']."', Travel_TwoWeeLimitPerMonth='".$_POST['TwoWRestrict']."', Travel_TwoWeeLimitPerDay='".$_POST['TwoWRestrict_PD']."', Travel_FourWeeLimitPerMonth='".$_POST['FourWRestrict']."', Travel_FourWeeLimitPerDay='".$_POST['FourWRestrict_PD']."', TwoWeeOutSide_Restric='".$_POST['TwoWRestrict_OutSite']."', FourWeeOutSide_Restric='".$_POST['FourWRestrict_OutSite']."', Mode_Travel_Outside_Hq='".$TraMode."', TravelClass_Outside_Hq='".$TraClass."', Mobile_Exp_Rem='".$_POST['MoExpeReim']."', Mobile_Exp_Rem_Rs='".$_POST['MobileExpRs']."', Mobile_Company_Hand='".$_POST['MoComHandSet']."', Mobile_Hand_Elig='".$_POST['MoHandSet']."', Mobile_Hand_Elig_Rs='".$_POST['MobileHandRs']."', Misc_Expenses='".$_POST['MiscExp']."', Health_Insurance='".$_POST['HealthInsu']."', EligCreatedBy=".$UserId.", EligCreatedDate='".date("Y-m-d")."', EligYearId=".$YearId."  WHERE EmployeeId=".$EMPID." AND EligCreatedDate='".date("Y-m-d")."' AND Status='A'", $con);
 }
 if($rowElig==0)
 { 
   $sqlU= mysql_query("UPDATE hrm_employee_eligibility SET Status='D' where EmployeeID=".$EMPID." AND Status='A'", $con);
   $SqlInsElig = mysql_query("insert into hrm_employee_eligibility(EmployeeId, EC, Lodging_CategoryA, Lodging_CategoryB, Lodging_CategoryC, DA_Outside_Hq, DA_Outside_HqSal, DA_Outside_HqPD, DA_Outside_HqWithNightH, DA_Outside_HqWithOutNightH, Travel_TwoWeeKM, Travel_FourWeeKM, Travel_TwoWeeLimitPerMonth, Travel_TwoWeeLimitPerDay, Travel_FourWeeLimitPerMonth, Travel_FourWeeLimitPerDay, TwoWeeOutSide_Restric, FourWeeOutSide_Restric, Mode_Travel_Outside_Hq, TravelClass_Outside_Hq, Mobile_Exp_Rem, Mobile_Exp_Rem_Rs, Mobile_Company_Hand, Mobile_Hand_Elig, Mobile_Hand_Elig_Rs, Misc_Expenses, Health_Insurance, Status, EligCreatedBy, EligCreatedDate, EligYearId) values(".$EMPID.", ".$resCode['EmpCode'].", '".$_POST['LodgingCatA']."', '".$_POST['LodgingCatB']."', '".$_POST['LodgingCatC']."', '".$_POST['DaOutSide_HQRs']."', '".$_POST['DaOutSide_HQSalesRs']."', '".$_POST['DaOutSide_HQPDRs']."', '".$_POST['DaOutSide_HQRs_WithNH']."', '".$_POST['DaOutSide_HQRs_WithOutNH']."', '".$_POST['TwoWheelerKM']."', '".$_POST['FourWheelerKM']."', '".$_POST['TwoWRestrict']."', '".$_POST['TwoWRestrict_PD']."', '".$_POST['FourWRestrict']."', '".$_POST['FourWRestrict_PD']."', '".$_POST['TwoWRestrict_OutSite']."', '".$_POST['FourWRestrict_OutSite']."', '".$TraMode."', '".$TraClass."', '".$_POST['MoExpeReim']."', '".$_POST['MobileExpRs']."', '".$_POST['MoComHandSet']."', '".$_POST['MoHandSet']."', '".$_POST['MobileHandRs']."', '".$_POST['MiscExp']."', '".$_POST['HealthInsu']."', 'A', ".$UserId.", '".date("Y-m-d")."', ".$YearId.")", $con);
 }
...
<body class="body">
<?php $SqlEmp = mysql_query("SELECT EmpCode,Fname,Sname,Lname,EmpAddBenifit_MediInsu_value,GradeValue,DepartmentId FROM hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee_ctc ON hrm_employee.EmployeeID=hrm_employee_ctc.EmployeeID INNER JOIN hrm_grade ON hrm_employee_general.GradeId=hrm_grade.GradeId WHERE hrm_employee_ctc.Status='A' AND hrm_employee.EmployeeID=".$EMPID, $con);  $ResEmp=mysql_fetch_assoc($SqlEmp);
...
$SqlCtc = mysql_query("SELECT ESCI,EmpAddBenifit_MediInsu_value FROM hrm_employee_ctc WHERE EmployeeID=".$EMPID." AND Status='A'", $con); $ResCtc=mysql_fetch_assoc($SqlCtc);

//if($ResEmp['GradeValue']=='L1' OR $ResEmp['GradeValue']=='L2' OR $ResEmp['GradeValue']=='L3' OR $ResEmp['GradeValue']=='L4'){$Cond='(Approval based)';}else{$Cond='';} 
?>
<table class="table">
...
<?php $sqlD2=mysql_query("select DepartmentId from hrm_department where DepartmentName='Sales' AND DepartmentCode='SALES' AND CompanyId=".$CompanyId, $con);  $sqlP2=mysql_query("select DepartmentId from hrm_department where DepartmentName='Production' AND DepartmentCode='PRODUCTION' AND CompanyId=".$CompanyId, $con);
      $resD2=mysql_fetch_assoc($sqlD2); $resP2=mysql_fetch_assoc($sqlP2); 
?>
...
<tr>
 ...
 <table border="0">
  ...
  <tr>
   ...
   <td class="td3" align="right"><select Name="DaOutSide_HQSales" class="td3" style="width:50px;" onChange="DAOutSiteSales(this.value)" disabled><option value="<?php if($ResEligEmp['Lodging_CategoryA']>0){ if($ResEligEmp['DA_Outside_HqSal']!='') echo 'Y'; else echo 'N'; } else { if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'Y'; else echo 'N'; } ?>">&nbsp;<?php if($ResEligEmp['Lodging_CategoryA']>0){ if($ResEligEmp['DA_Outside_HqSal']!='') echo 'Yes'; else echo 'No'; } else { if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'Yes'; else echo 'No'; } ?></option><option value="<?php if($ResEligEmp['Lodging_CategoryA']>0){ if($ResEligEmp['DA_Outside_HqSal']!='') echo 'N'; else echo 'Y'; } else { if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'N'; else echo 'Y'; } ?>">&nbsp;<?php if($ResEligEmp['Lodging_CategoryA']>0){ if($ResEligEmp['DA_Outside_HqSal']!='') echo 'No'; else echo 'Yes'; } else { if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'No'; else echo 'Yes'; } ?></option></select></td>
   <td class="td3">&nbsp;Rs. :&nbsp;<input Name="DaOutSide_HQSalesRs" class="td2" style="width:100px;" value="<?php if($ResEligEmp['Lodging_CategoryA']>0){ echo $ResEligEmp['DA_Outside_HqSal']; } elseif($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) { echo $resDaily['OutSiteHQ_Sales']; } ?>" readonly/></td>
  ...
  <tr>
   ...
   <td class="td3" align="right"><select Name="DaOutSide_HQPD" class="td3" style="width:50px;" onChange="DAOutSitePD(this.value)" disabled><option value="<?php if($ResEligEmp['Lodging_CategoryA']>0){ if($ResEligEmp['DA_Outside_HqPD']!='') echo 'Y'; else echo 'N'; } else { if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'Y'; else echo 'N'; } ?>">&nbsp;<?php if($ResEligEmp['Lodging_CategoryA']>0){ if($ResEligEmp['DA_Outside_HqPD']!='') echo 'Yes'; else echo 'No'; } else { if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'Yes'; else echo 'No'; } ?></option><option value="<?php if($ResEligEmp['Lodging_CategoryA']>0){ if($ResEligEmp['DA_Outside_HqPD']!='') echo 'N'; else echo 'Y'; } else { if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'N'; else echo 'Y'; } ?>">&nbsp;<?php if($ResEligEmp['Lodging_CategoryA']>0){ if($ResEligEmp['DA_Outside_HqPD']!='') echo 'No'; else echo 'Yes'; } else { if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'No'; else echo 'Yes'; } ?></option></select></td>
   <td class="td3">&nbsp;Rs. :&nbsp;<input Name="DaOutSide_HQPDRs" class="td2" style="width:100px;" value="<?php if($ResEligEmp['Lodging_CategoryA']>0){ echo $ResEligEmp['DA_Outside_HqPD']; } elseif($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) { echo $resDaily['OutSiteHQ_Sales']; } ?>" readonly/></td>
...
<tr>
 ...
 <table border="0">
  <tr>
   ...
   <td class="td3" style="width:100px;"><input Name="Rmk" id="Rmk" class="td3" style="width:400px;" value="<?php echo $ResEligEmp['Remark']; ?>"/></td>
  </tr>
 </table>
 </td>
</tr>
...
<tr>
 ...
 <tr>
  <td class="td3">DA @ H.Q.(Only For Sales Staff) :
  <input type="hidden" Name="A1" id="A1" value="<?php echo $resDaily['OutSiteHQ']; ?>"/><input type="hidden" Name="B1" id="B1" value="<?php echo $resDaily['OutSiteHQ_Sales']; ?>"/><input type="hidden" Name="MH" id="MH" value="<?php echo $resDaily['MH']; ?>"/><input type="hidden" Name="MRSP" id="MRSP" value="<?php echo $resDaily['MRSP']; ?>"/><input type="hidden" Name="MRNS" id="MRNS" value="<?php echo $resDaily['MRNS']; ?>"/><input type="hidden" Name="MCS" id="MCS" value="<?php echo $resDaily['MCS']; ?>"/><input type="hidden" Name="MCSSP" id="MCSSP" value="<?php echo $resDaily['MCSSP']; ?>"/></td>
  <td class="td3" align="right"><select Name="DaOutSide_HQSales" id="DaOutSide_HQSales" class="td3" style="width:50px;" onChange="DAOutSiteSales(this.value)" disabled><option value="<?php if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'Y'; else echo 'N';  ?>">&nbsp;<?php if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'Yes'; else echo 'No'; ?></option><option value="<?php if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'N'; else echo 'Y'; ?>">&nbsp;<?php if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'No'; else echo 'Yes';?></option>								    </select></td>
  <td class="td3">&nbsp;Rs. :&nbsp;<input Name="DaOutSide_HQSalesRs" id="DaOutSide_HQSalesRs" class="td2" style="width:100px;" value="<?php if($resDaily['OutSiteHQ_Sales']!='' AND $resD2['DepartmentId']==$ResEmp['DepartmentId']) { echo $resDaily['OutSiteHQ_Sales']; } ?>" readonly/></td>
  <td class="td3">Per Day<input type="hidden" Name="DaOutSide_HQRs_WithNH" id="DaOutSide_HQRs_WithNH" class="All_100" value="0" readonly/><input type="hidden" Name="DaOutSide_HQRs_WithOutNH" id="DaOutSide_HQRs_WithOutNH" class="All_100" value="0" readonly/></td>
 </tr>
 <?php /****** PD ********/ ?>
 <tr>
  <td class="td3">DA @ H.Q.(Only For PD Staff) in case of day tour involving more than 60 kms. travel :</td>
  <td class="td3" align="right"><select Name="DaOutSide_HQPD" id="DaOutSide_HQPD" class="td3" style="width:50px;" onChange="DAOutSitePD(this.value)" disabled><option value="<?php if($resDaily['OutSiteHQ_Sales']!='' AND $resPD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'Y'; else echo 'N'; ?>"  selected>&nbsp;<?php if($resDaily['OutSiteHQ_Sales']!='' AND $resPD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'Yes'; else echo 'No'; ?></option><option value="<?php if($resDaily['OutSiteHQ_Sales']!='' AND $resPD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'N'; else echo 'Y';  ?>">&nbsp;<?php if($resDaily['OutSiteHQ_Sales']!='' AND $resPD2['DepartmentId']==$ResEmp['DepartmentId']) echo 'No'; else echo 'Yes'; ?></option></select></td>
  <td class="td3">&nbsp;Rs. :&nbsp;<input Name="DaOutSide_HQPDRs" id="DaOutSide_HQPDRs" class="td2" style="width:100px;" value="<?php if($resDaily['OutSiteHQ_Sales']!='' AND $resPD2['DepartmentId']==$ResEmp['DepartmentId']) { echo $resDaily['OutSiteHQ_Sales']; } ?>" readonly/></td>
...
<tr>
 ...
 <td>
  ...
  <tr>
   ...
   <td class="td3" style="width:40px;">Maxi :</td>
   <td class="td3" style="width:150px;"><input Name="TwoWRestrict_PD" id="TwoWRestrict_PD" class="td3" style="width:50px;" value="<?php if($resD2['DepartmentId']==$ResEmp['DepartmentId'] AND $resElig['TwoWheeler_Restric_Sales_PD']!=''){ echo $resElig['TwoWheeler_Restric_Sales_PD'];} elseif($resD2['DepartmentId']!=$ResEmp['DepartmentId'] AND $resElig['TwoWheeler_Restric_PD']!=''){echo $resElig['TwoWheeler_Restric_PD'];}?>" readonly/>&nbsp;PD<input Name="TwoWRestrict" id="TwoWRestrict" class="td3" style="width:50px;" value="<?php if($resD2['DepartmentId']==$ResEmp['DepartmentId'] AND $resElig['TwoWheeler_Restric_Sales']!=''){ echo $resElig['TwoWheeler_Restric_Sales'];} elseif($resD2['DepartmentId']!=$ResEmp['DepartmentId'] AND $resElig['TwoWheeler_Restric']!=''){echo $resElig['TwoWheeler_Restric'];}?>" readonly/>&nbsp;PM</td>
   <td class="td3" style="width:80px;">OutSite HQ :</td>
   <td class="td3" style="width:62px;"><input class="td3" style="width:100px;" Name="TwoWRestrict_OutSite" id="TwoWRestrict_OutSite" value="<?php if($resD2['DepartmentId']==$ResEmp['DepartmentId'] AND $resElig['TwoWheeler_Restric_OutSite_Sales']!=''){echo $resElig['TwoWheeler_Restric_OutSite_Sales'].'&nbsp;KM PM';}elseif($resD2['DepartmentId']!=$ResEmp['DepartmentId'] AND $resElig['TwoWheeler_Restric_OutSite']!=''){echo $resElig['TwoWheeler_Restric_OutSite'].'&nbsp;KM PM';} else {echo 'NA';} ?>" readonly/></td>
  </tr>
  <tr>
   <td class="td3" style="width:90px;">FourWheeler:</td>
   <td class="td3" style="width:75px;"><input Name="FourWheelerKM" id="FourWheelerKM" class="td3" style="width:30px;" value="<?php if($ResEligEmp['FourWElig']=='Y'){ echo $ResEligEmp['Travel_FourWeeKM']; }else{ if($ResEmp['DepartmentId']==2 && $resElig['FourWheeler_Restric_Resrch']!=''){ echo $resElig['FourWheeler'];}elseif($ResEmp['DepartmentId']!=2){echo $resElig['FourWheeler']; }else{echo $resElig['FourWheeler'];} }?>" readonly/>&nbsp;Per KM</td>
   <td class="td3" style="width:40px;">Maxi :</td>
   <td class="td3" style="width:150px;"><input Name="FourWRestrict" id="FourWRestrict" class="td3" style="width:50px;" value="<?php if($resD2['DepartmentId']==$ResEmp['DepartmentId'] AND $resElig['FourWheeler_Restric_Sales']!=''){ echo $resElig['FourWheeler_Restric_Sales'];} elseif($resD2['DepartmentId']!=$ResEmp['DepartmentId'] AND $resElig['FourWheeler_Restric']!=''){echo $resElig['FourWheeler_Restric'];}?>" readonly/>&nbsp;PM<input Name="FourWRestrict_PD" id="FourWRestrict_PD" class="td3" style="width:50px;" value="<?php if($resD2['DepartmentId']==$ResEmp['DepartmentId']){if($resElig['FourWheeler_Restric_Sales']!='Actual' AND $resElig['FourWheeler_Restric_Sales']!=''){$PerAnnum=$resElig['FourWheeler_Restric_Sales']*12; echo $PerAnnum;}elseif($resElig['FourWheeler_Restric_Sales']=='Actual'){$PerAnnum='Actual'; echo $PerAnnum;}else{echo 'NA';}}elseif($resD2['DepartmentId']!=$ResEmp['DepartmentId']){if($resElig['FourWheeler_Restric']!='Actual' AND $resElig['FourWheeler_Restric']!=''){$PerAnnum=$resElig['FourWheeler_Restric']*12; echo $PerAnnum;}elseif($resElig['FourWheeler_Restric']=='Actual'){$PerAnnum='Actual'; echo $PerAnnum;}else{echo 'NA';}}?>" readonly/>&nbsp;PA</td>
   <td class="td3" style="width:80px;">OutSite HQ :</td> 
   <td class="td3" style="width:62px;"><input class="td3" style="width:100px;" Name="FourWRestrict_OutSite" id="FourWRestrict_OutSite" value="<?php if($resD2['DepartmentId']==$ResEmp['DepartmentId'] AND $resElig['FourWheeler_Restric_OutSite_Sales']!=''){echo $resElig['FourWheeler_Restric_OutSite_Sales'].'&nbsp;KM PM';}elseif($resD2['DepartmentId']!=$ResEmp['DepartmentId'] AND $resElig['FourWheeler_Restric_OutSite']!=''){echo $resElig['FourWheeler_Restric_OutSite'].'&nbsp;KM PM';} else {echo 'NA';} ?>" readonly/></td>
 </tr>
 <?php /************** Close ********************/  ?>
 </table>
...
//if($resD2['DepartmentId']==$ResEmp['DepartmentId'] OR $resP2['DepartmentId']==$ResEmp['DepartmentId']) $MR=$resDaily['MRSP']; if($resD2['DepartmentId']!=$ResEmp['DepartmentId'] AND $resP2['DepartmentId']!=$ResEmp['DepartmentId']) $MR=$resDaily['MRNS']; ?>
<tr>
 <td class="td3"></td>
 <td>
 <table border="0">
...
<tr>
 ...
 <table border="0">
  <tr>
   <td class="td3" style="width:452px;">Health Insurance(Premium Paid by Company) :</td>
   <td class="td3" style="width:100px;"><input Name="HealthInsu" id="HealthInsu" class="td3" style="width:100px;" value="<?php echo $ResCtc['EmpAddBenifit_MediInsu_value']; //if($resDaily['MCSSP']!='' AND ($resD2['DepartmentId']==$ResEmp['DepartmentId'] OR $resP2['DepartmentId']==$ResEmp['DepartmentId'])){echo intval($resDaily['MCSSP']);}else {echo intval($resDaily['MCS']); }?><?php //echo $ResEligEmp['Health_Insurance']; ?>" readonly/></td>
  </tr>
 </table>
 </td>
</tr>
