...
<style>.font {font-family:Times New Roman;font-size:18px; font-weight:bold;}.font1 {font-family:Times New Roman;font-size:18px;} 
...
<tr><td style="font-family:Times New Roman;color:#000000;font-size:13px;width:999px;;" align="right"></td></tr>
...
<table border="0" bgcolor="#FFFFFF">
 <tr><td align="center" style="font-family:Times New Roman;font-size:15px;width:1000px;">
  ...
  <tr><td align="center" style="font-family:Times New Roman;font-size:15px;width:1000px;"><?php //background-color:#AAAAAA; ?>
      <table border="1">
	   ...
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">(A)</td>
		<td class="font1" id="TdA4" style="width:445px;<?php if($resLL['Initiative']=='A'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['Initiative']=='A'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Always takes the first step. Is proactive and creates opportunities.</td>
		<td class="font" style="width:30px;" align="center" valign="top">(B)</td>
		<td class="font1" id="TdB4" style="width:445px;<?php if($resLL['Initiative']=='B'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['Initiative']=='B'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Alert to opportunities. Takes the first step most of the times.</td>
	   </tr>
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">(C)</td>
		<td class="font1" id="TdC4" style="width:445px;<?php if($resLL['Initiative']=='C'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['Initiative']=='C'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Works on his own. Takes the first step when confident.</td>
		<td class="font" style="width:30px;" align="center" valign="top">(D)</td>
		<td class="font1" id="TdD4" style="width:445px;<?php if($resLL['Initiative']=='D'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['Initiative']=='D'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Does not look for opportunities. Routine worker. Needs goading/persuasion.</td>
	   </tr>
	   <tr><td></td></tr>
	   ...
	   <tr>
		...
		<td class="font" style="width:30px;" align="center" valign="top">(B)</td>
		<td class="font1" id="TdB6" style="width:445px;<?php if($resLL['ProblemSolve']=='B'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['ProblemSolve']=='B'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;In most situations, goes to the core of the problem and makes a correct diagnosis available with limited data. </td>
	   </tr>
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">(C)</td>
	   ...
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">(A)</td>
		<td class="font1" id="TdA7" style="width:445px;<?php if($resLL['Attitude']=='A'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['Attitude']=='A'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Always positive in outlook towards organization/work/authority. Respects authority.</td>
		<td class="font" style="width:30px;" align="center" valign="top">(B)</td>
		<td class="font1" id="TdB7" style="width:445px;<?php if($resLL['Attitude']=='B'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['Attitude']=='B'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Mostly positive in outlook towards organization/work/authority.  </td>
	   </tr>
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">(C)</td>
		<td class="font1" id="TdC7" style="width:445px;<?php if($resLL['Attitude']=='C'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['Attitude']=='C'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Generally positive in outlook towards work/subordinates. </td>
		<td class="font" style="width:30px;" align="center" valign="top">(D)</td>
		<td class="font1" id="TdD7" style="width:445px;<?php if($resLL['Attitude']=='D'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['Attitude']=='D'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Does not have a positive outlook/ approach  to organization/work. Indifferent to authority.</td>
	   </tr>
	   <tr><td></td></tr>
	   ...
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">(C)</td>
		<td class="font1" id="TdC8" style="width:445px;<?php if($resLL['Attendance']=='C'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['Attendance']=='C'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Generally regular in attendance and quite punctual in meeting work norms. </td>
		<td class="font" style="width:30px;" align="center" valign="top">(D)</td>
		<td class="font1" id="TdD8" style="width:445px;<?php if($resLL['Attendance']=='D'){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>" valign="top"><?php if($resLL['Attendance']=='D'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Poor attendance and punctuality. Casual attitude to work.</td>
	   </tr>
	  </table>
     </td>
  </tr>
  ...
  <tr>
   <td>
    <table border="0">
	 ...
	 <tr>
	  <td>
	   <table border="0">
	     ...
	     <td class="font1" style="width:120px;<?php if($resLL['Rating']==1){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>"><b>[1]</b>&nbsp;Unsatisfactory</td>
		 ...
		 <td class="font1" style="width:200px;<?php if($resLL['Rating']==2){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>"><b>[2]</b>&nbsp;Needs Improvement</td>
		 ...
		 <td style="width:40px;" rowspan="2"></td>
		 <td class="font1" style="width:100px;<?php if($resLL['Rating']==2.5){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>"><b>[2.5]</b>&nbsp;Satisfactory</td>
		 ...
		 <td style="width:40px;" rowspan="2"></td>
		 <td class="font1" style="width:90px;<?php if($resLL['Rating']==3){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>"><b>[3]</b>&nbsp;Competent</td>
	 ...
	 <tr>
	     <td style="width:30px;"></td>
	     <td class="font1" style="width:120px;<?php if($resLL['Rating']==3.5){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>"><b>[3.5]</b>&nbsp;Commendable</td>
		 ...
		 <td class="font1" style="width:200px;<?php if($resLL['Rating']==4){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>"><b>[4]</b>&nbsp;Extraordinary</td>
		 ...
		 <td class="font1" style="width:100px;<?php if($resLL['Rating']==4.5){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>"><b>[4.5]</b>&nbsp;Outstanding</td>
		 ...
		 <td class="font1" style="width:90px;<?php if($resLL['Rating']==5){ echo 'font-weight:bold;background-color:#AAAAAA;'; } ?>"><b>[5]</b>&nbsp;Exemplary</td>
   ...
   <td>
    <table border="0">
	 ...
	 <tr>
	     ...
	     <td class="font1" style="width:799px;" valign="middle">&nbsp;<?php if($resLL['Recommendation']==1){ echo '<b style="background-color:#AAAAAA;">'; } ?>Confirmed on due date<?php echo '</b>'; ?>&nbsp;&nbsp;<?php if($resLL['Recommendation']==1){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php if($resLL['Recommendation']==2){ echo '<b style="background-color:#AAAAAA;">'; } ?>Extend Probation<?php echo '</b>'; ?>&nbsp;&nbsp;
...
<?php $sqlG2=mysql_query("select GradeValue from hrm_grade where GradeId=".$resLL['GradeId'], $con); 
	 ...
	 <tr>
	     ...
	     <td class="font" style="width:80px;" align="Right">&nbsp;Current:-</td>
		 <td class="font" style="width:300px;" align="">&nbsp;<?php echo $DesigName; ?></td>
		 <td class="font" style="width:80px;" align="Right">&nbsp;Proposed:-</td>
<?php $sqlDe2=mysql_query("select DesigName from hrm_designation where DesigId=".$resLL['DesigId'], $con); $resDe2=mysql_fetch_assoc($sqlDe2); ?>			 
		 <td class="font" style="width:300px;" align="">&nbsp;<?php echo $resDe2['DesigName']; ?></td>
	 </tr>
