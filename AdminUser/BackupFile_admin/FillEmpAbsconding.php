...
//$email_subjectE = "Your separation due to Absconding is approved by HR.";
//$email_txt = "Your separation due to Absconding is approved by HR.";
//$headersE = "From: ".$email_fromE."\r\n"; 
//$semi_randE = md5(time()); 
//$headersE .= "MIME-Version: 1.0\r\n";
//$headersE .= "Content-Type: text/html; charset=ISO-8859-1\r\n"; 
//$email_messageE .="Your separation due to Absconding is approved by HR, for details kindly log on to ESS. <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>. \n\n";
...
$email_subject3 = "The separation due to Absconding of ".$Ename." has been approved";
$email_txt = "The separation due to Absconding of ".$Ename." has been approved";
$headers = "From: ".$email_from."\r\n"; 
$semi_rand = md5(time()); 
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n"; 
$email_message3 .="The separation due to Absconding of ".$Ename." has been approved. Kindly provide HR clearance (NOC) in ESS for further processing. For details kindly log on to ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>. \n\n";
...
$email_from = 'admin@vnrseeds.co.in';
$email_subject2 = "The separation due to Absconding of ".$Ename." has been approved";
$email_txt = "The separation due to Absconding of ".$Ename." has been approved";
$headers = "From: ".$email_from."\r\n"; 
$semi_rand = md5(time()); 
$headers2.= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
$email_message2 .="The separation due to Absconding of ".$Ename." has been approved. Kindly fill supervisor comment in exit interview form & provide department clearance form(NOC) in ESS for further processing. For details kindly log on to ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>. \n\n";
...
{ $resNoc2=mysql_fetch_assoc($sqlNoc2);
  ...
  $email_from = 'admin@vnrseeds.co.in';
  $email_subject4 = "The separation due to Absconding of ".$Ename." has been approved";
  $email_txt = "The separation due to Absconding of ".$Ename." has been approved";
 $headers = "From: ".$email_from."\r\n"; 
  $semi_rand = md5(time()); 
  $headers .= "MIME-Version: 1.0\r\n";
  $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
  $email_message4 .="The separation due to Absconding of ".$Ename." has been approved. Kindly provide IT clearance (NOC) in ESS for further processing. For details kindly log on to ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>. \n\n";
...
{ $resNoc5=mysql_fetch_assoc($sqlNoc5);
  ...
  $email_from = 'admin@vnrseeds.co.in';
  $email_subject5 = "The separation due to Absconding of ".$Ename." has been approved";
  $email_txt = "The separation due to Absconding of ".$Ename." has been approved";
  $headers = "From: ".$email_from."\r\n"; 
  $semi_rand = md5(time()); 
  $headers .= "MIME-Version: 1.0\r\n";
  $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
  $email_message5 .="The separation due to Absconding of ".$Ename." has been approved. \n\n";
...
$ok = @mail($email_to5, $email_subject5, $email_message5, $headers);
  ...
  $msg="Absconding form save successfully.";
 }
...
{ var filter=/^[a-zA-Z. /]+$/; var Numfilter=/^[0-9. ]+$/;
  ...
  if(Timed1>Timed2){alert('Error : Please check Absconding & Absconding relieving date!'); return false;}	
  ...
  if(Reason.length === 0){ alert("Please type Absconding reason.");  return false; }
  if(Reason.length<10){ alert("Please type minimum 10 character to Absconding reason.");  return false; }
  ...
  var agree=confirm("Are you sure you want to submit Absconding form?");
...
<table border="0" cellspacing="5">
 <tr>
  <td colspan="2" class="heading">Absconding Form&nbsp;&nbsp;</td>
 </tr>
...
<td style="display:<?php if($_REQUEST['a']=='f'){echo 'block';}elseif($_REQUEST['a']=='e' OR $_REQUEST['a']=='c'){echo 'none';}?>;">
 ...
 <tr><td colspan="7" valign="top" style='font-family:Times New Roman; font-size:17px; color:#008800' align="right">
  ...
  <tr>
  <td align="left" class="font2" style="width:120px;">&nbsp;&nbsp;Absconding Date</td><td style="width:10px;"><b>&nbsp;:&nbsp;</b></td>
  ...
  <td colspan="7" align="Right" class="fontButton">
   <table>
	<tr> 
	 ...
	 <td>
	 <input type="button" name="Refrash" value="refresh" onClick="javascript:window.location='FillEmpAbsconding.php?ee=4e&w=234&y=10234&a=f&ee=4e2&e=4e&w=234&y=110022344&retd=ee&wwrew=t%T@sed818&d=101&e=<?php echo $_REQUEST['e']; ?>&DI=<?php echo $_REQUEST['DI']; ?>'" <?php if($rowch>0){echo 'disabled';} ?>/>
     </td>
	</tr>
   </table>
  </td>
