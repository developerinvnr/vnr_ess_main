...
{ $ei = $_POST['ei']; $m = $_POST['m']; $y = $_POST['y']; $yi = $_POST['yi'];
  ...
  $sql=mysql_query("Select MorEveRepId from hrm_employee_moreve_report WHERE EmployeeID=".$ei." AND MorEveDate='".$_POST['RDate']."'", $con); $rows = mysql_num_rows($sql); 
  if($rows>0)
  { $sqlUp = mysql_query("UPDATE hrm_employee_moreve_report SET MorDateTime='".$_POST['MorDate']."', MorReports='".$MorRep."', Att='".$_POST['Att']."', UpAtt='".$_POST['UpAtt']."' WHERE EmployeeID=".$ei." AND MorEveDate='".$_POST['RDate']."'", $con); }
 else
 { $sqlUp = mysql_query("insert into hrm_employee_moreve_report(EmployeeID, MorEveDate, MorDateTime, MorReports, Att, UpAtt) values(".$ei.", '".$_POST['RDate']."', '".$_POST['MorDate']."', '".$MorRep."', '".$_POST['Att']."', '".$_POST['UpAtt']."')", $con); }
