...
if($_REQUEST['YI']<=7)
{ $qry='SUM(EmpCurrGrossPM) as E_GROSS, SUM(EmpCurrIncentivePM) as EINC_GROSS, SUM(HR_ProIncSalary) as H_IS, SUM(HR_ProCorrSalary) as H_SC, SUM(Hod_Incentive) as H_Inc, DepartmentId, HOD_EmployeeID'; }
else
{ $qry='SUM(EmpCurrCtc) as E_GROSS, SUM(HR_ProIncCTC) as H_IS, SUM(HR_ProCorrCTC) as H_SC, DepartmentId, HOD_EmployeeID';} 
