...
$sqlRpt=mysql_query("select * from hrm_employee_moreve_report where EmployeeID=".$res['EmployeeID']." AND MorEveDate='".$_REQUEST['Y']."-".$_REQUEST['m']."-".$_REQUEST['da']."'", $con);
...
<?php } ?>
<tr>
  <td align="left" class="fontButton" style="width:100%;" colspan="16">
    <table border="0">
     <tr>
