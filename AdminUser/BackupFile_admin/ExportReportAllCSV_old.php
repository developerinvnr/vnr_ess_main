...
$csv_output .= '"'.str_replace('"', '""', $res['DA_Outside_HqSal']).'",';
...
$csv_output .= '"'.str_replace('"', '""', 'As per law').'",';
$LY=$_REQUEST['Y']-1; $sqlRating=mysql_query("select HR_Rating from hrm_employee_pms where EmployeeID=".$res['EmployeeID']." AND YearId=".$LY, $con); 
