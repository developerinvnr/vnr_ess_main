...
{ 
 ...
 if(PFGross>=47109 && PFGross<=52525)
 {
 ...
 else if(PFGross>15050 && PFGross<=37500)
 {
 ...
 {
  var Cal_EmpBasic = document.getElementById("EmpBasic").value=Math.round((((PFGross*40)/100)*100)/100,0); //Basic
  <!-- HRA Con Special -->
 ...
 if(Cal_EmpBasic<=Esic_MaxSalEsic)
 {
   var EmpESCI = document.getElementById("EmpESCI").value=Math.ceil((((GMS*Esic_DeducRate)/100)*100)/100,0); 
 ...
 { 
   ...
   else if(D2!=DeId && P2!=DeId)
   {document.getElementById("EmpAddBenifit_MediInsu").value=document.getElementById("MCS").value;}
 }
...
function CtcGrossSalary()
{
 ...
 {
  var CtcEmpBasic = document.getElementById("CtcEmpBasic").value=15050;
 ...
 {
  var CtcEmpBasic = document.getElementById("CtcEmpBasic").value=Math.round((((PFGross*40)/100)*100)/100,0); //Basic
  <!-- HRA Con Special -->
...
{ 
 ...
 if(CtcEmpBasic<=Esic_MaxSalEsic)
 {  
   var EmpESCI = document.getElementById("CtcEmpESCI").value=Math.ceil((((CtcMonthlyGross*Esic_DeducRate)/100)*100)/100,0); 
   function round(n){ n = Math.pow(10,n); return function(num) { return Math.round(num*n)/n; } }
   var round_decimal = round(1); 
 ...
 { var EmpESCI=0; ComESCI=0; 
   ...
   {document.getElementById("CtcEmpAddBenifit_MediInsu").value=document.getElementById("MCS").value;}
 }
...
{ 
 ...
 var EmpESCI = document.getElementById("ESCI").value=Math.ceil((((VGrossSalary*Esic_DeducRate)/100)*100)/100,0); //1.75
 function round(n){ n = Math.pow(10,n); return function(num) { return Math.round(num*n)/n; } }
 var round_decimal = round(1);
...
<table border="1" width="100%" id="TEmp" cellpadding="1" cellspacing="1">
 <tr>
  <td class="td33" style="width:100%;" colspan="4">&nbsp;<b>[A] Monthly Components</b>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <tr>
  <td class="td3" colspan="2" style="width:60%;">&nbsp;</td>
  <td class="td3" style="text-align:center;width:20%;"><b>Old Cal<sup>n</sup></b></td>
  <td class="td3" style="text-align:center;width:20%;"><b>New Cal<sup>n</sup></b></td>
 </tr>
 <tr>
  <td class="td3" style="width:5%;">&nbsp;</td>
  <td class="td3" style="width:55%;">&nbsp;<span id="BasSti"><input type="hidden" value="B" name="Basic"/><?php if($ResCtc['BAS']=='Y' AND $ResCtc['BAS_Value']>0) { echo 'Basic'; } elseif($ResCtc['STIPEND']=='Y' AND $ResCtc['STIPEND_Value']>0) { echo 'Stipend'; }?></span> :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select class="td3" style="width:80px;" name="BasicStipend" id="BasicStipend" onChange="SelectBasSti(this.value)" disabled><option value="B" selected>Basic</option></select>
  
  <?php /*?><option value="S" <?php if($ResCtc['BAS']=='N' AND $ResCtc['STIPEND']=='Y') {echo 'selected';} ?>>Stipend</option><?php */?>
  </td>
  
  <td class="td3" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="EmpBasic" id="EmpBasic" readonly value="<?php if($ResCtc['BAS']=='Y' AND $ResCtc['STIPEND']=='N') { echo $ResCtc['BAS_Value']; } if($ResCtc['BAS']=='N' AND $ResCtc['STIPEND']=='Y') { echo $ResCtc['STIPEND_Value']; }?>" onChange="ChangeBasic()" onKeyUp="ChangeBasic()" onKeyPress="return isNumberKey(event)"></td>
  <td class="td3" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="CtcEmpBasic" id="CtcEmpBasic" readonly value="<?php if($ResCtc['BAS']=='Y' AND $ResCtc['STIPEND']=='N') { echo $ResCtc['BAS_Value']; } if($ResCtc['BAS']=='N' AND $ResCtc['STIPEND']=='Y') { echo $ResCtc['STIPEND_Value']; }?>" onChange="ChangeBasic()" onKeyUp="ChangeBasic()" onKeyPress="return isNumberKey(event)" required></td>
 </tr>
 <tr>
  ...
  <td class="td3" id="hraB" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="EmpHRA" id="EmpHRA" value="<?php echo $ResCtc['HRA_Value']; ?>" onChange="HRCalcu(this.value)" onKeyUp="HRCalcu(this.value)" readonly onKeyPress="return isNumberKey(event)"/></td>
  <td class="td3" id="hraB" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="CtcEmpHRA" id="CtcEmpHRA" value="<?php echo $ResCtc['HRA_Value']; ?>" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="caB" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="EmpConAllow" value="<?php echo $ResCtc['CONV_Value']; ?>" id="EmpConAllow" onChange="ChangeCA()" onKeyUp="ChangeCA()"  readonly onKeyPress="return isNumberKey(event)"/></td>
  <td class="td3" id="caB" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="CtcEmpConAllow" value="<?php echo $ResCtc['CONV_Value']; ?>" id="CtcEmpConAllow" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="caB" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="TA" id="TA" value="<?php echo $ResCtc['TA_Value']; ?>" onChange="ChangeTA()" onKeyDown="ChangeTA()" onKeyUp="ChangeTA()" class="All_100"  readonly onKeyPress="return isNumberKey(event)"/></td>
  <td class="td3" id="caB" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="CtcTA" id="CtcTA" value="<?php echo $ResCtc['TA_Value']; ?>" onChange="ChangeTA()" onKeyDown="ChangeTA()" onKeyUp="ChangeTA()" class="All_100"  readonly onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="caB" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="CAR_ALL_Value" value="<?php echo $ResCtc['CAR_ALL_Value']; ?>" id="CAR_ALL_Value" onChange="ChangeCarAllow()" readonly onKeyPress="return isNumberKey(event)"/></td>
  <td class="td3" id="caB" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="CtcCAR_ALL_Value" value="<?php echo $ResCtc['CAR_ALL_Value']; ?>" id="CtcCAR_ALL_Value" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="caB" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="Bonus_Month" value="<?php echo $ResCtc['Bonus_Month']; ?>" id="Bonus_Month" onChange="ChangeBonusM()" readonly onKeyPress="return isNumberKey(event)"/></td>
  <td class="td3" id="caB" style="text-align:center;"><input class="td3" style="width:90%;text-align:right;" name="CtcBonus_Month" value="<?php echo $ResCtc['Bonus_Month']; ?>" id="CtcBonus_Month" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="saB" style="text-align:center;"><input name="EmpSpeAllow" class="td3" style="width:90%;text-align:right;" value="<?php echo $ResCtc['SPECIAL_ALL_Value']; ?>" id="EmpSpeAllow" readonly onKeyPress="return isNumberKey(event)"/><input type="hidden" name="ESA2" value="<?php echo $ResCtc['SPECIAL_ALL_Value']; ?>" id="ESA2" class="All_100" readonly/></td>
  <td class="td3" id="saB" style="text-align:center;"><input name="CtcEmpSpeAllow" class="td3" style="width:90%;text-align:right;" value="<?php echo $ResCtc['SPECIAL_ALL_Value']; ?>" id="CtcEmpSpeAllow" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  <td class="td3">&nbsp;</td><td class="td3">&nbsp;Gross Monthly Salary :</td>
  <td class="td3" style="text-align:center;"><input name="EmpGrossMonSalary" value="<?php echo $ResCtc['Tot_GrossMonth']; ?>" id="EmpGrossMonSalary" class="td3" onChange="GrossSalary(1)" onKeyUp="GrossSalary(1)" style="width:90%;text-align:right;" readonly onKeyPress="return isNumberKey(event)"/><input type="hidden" name="GrossMonSalary_PAC" value="<?php if($ResCtc['GrossSalary_PostAnualComponent_Value']>0) { echo $ResCtc['GrossSalary_PostAnualComponent_Value']; } else { echo $ResCtc['Tot_GrossMonth']; } ?>" id="GrossMonSalary_PAC" readonly/></td>
  <td class="td3" style="text-align:center;"><input name="CtcEmpGrossMonSalary" value="<?php echo $ResCtc['Tot_GrossMonth']; ?>" id="CtcEmpGrossMonSalary" class="td3" style="width:90%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  <td class="td3">&nbsp;</td><td class="td3">&nbsp;Gross Monthly Salary (Post Annual Components):</td>
  <td class="td3" style="text-align:center;"><input name="GMS_PAC" value="<?php if($ResCtc['GrossSalary_PostAnualComponent_Value']>0) { echo $ResCtc['GrossSalary_PostAnualComponent_Value']; } else { echo $ResCtc['Tot_GrossMonth']; } ?>" id="GMS_PAC" class="td3" style="width:90%;text-align:right;" readonly onKeyPress="return isNumberKey(event)"/></td>
  <td class="td3" style="text-align:center;"><input name="CtcGMS_PAC" value="<?php if($ResCtc['GrossSalary_PostAnualComponent_Value']>0) { echo $ResCtc['GrossSalary_PostAnualComponent_Value']; } else { echo $ResCtc['Tot_GrossMonth']; } ?>" id="CtcGMS_PAC" class="td3" style="width:90%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  ...
  <td class="td3" id="pfB" style="text-align:center;"><input name="EmpProviFund" value="<?php echo $ResCtc['PF_Employee_Contri_Value']; ?>" id="EmpProviFund" class="td3" style="width:90%;text-align:right;" readonly onKeyPress="return isNumberKey(event)"/><input type="hidden" name="Extra_MrLtaCea" value="0" id="Extra_MrLtaCea" readonly/></td>
  <td class="td3" id="pfB" style="text-align:center;"><input name="CtcEmpProviFund" value="<?php echo $ResCtc['PF_Employee_Contri_Value']; ?>" id="CtcEmpProviFund" class="td3" style="width:90%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="pfB" style="text-align:center;"><input name="EmpESCI" value="<?php echo $ResCtc['ESCI']; ?>" id="EmpESCI" class="td3" style="width:90%;text-align:right;" onChange="Fun2CheckESCI()" onBlur="Fun2CheckESCI()" readonly onKeyPress="return isNumberKey(event)"/><input type="hidden" name="ESCI" value="0" id="ESCI" readonly/><input type="hidden" name="ComESCI" value="0" id="ComESCI" readonly/></td>
  <td class="td3" id="pfB" style="text-align:center;"><input name="CtcEmpESCI" value="<?php echo $ResCtc['ESCI']; ?>" id="CtcEmpESCI" class="td3" style="width:90%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <?php /*  ESCI  ESCI  ESCI  ESCI  ESCI  ESCI  ESCI  ESCI  ESCI  ESCI  ESCI  ESCI CLOSE */ ?>

 <tr>
  <td class="td3">&nbsp;</td><td class="td3">&nbsp;Net Monthaly Salary :</td>
  <td class="td3" style="text-align:center;"><input value="<?php echo $ResCtc['NetMonthSalary_Value']; ?>" name="EmpNetMonSalary" id="EmpNetMonSalary" class="td3" style="width:90%;text-align:right;background-color:#DCEEF1;font-weight:bold;" readonly/><input type="hidden" value="<?php echo $ResCtc['NetMonthSalary_Value']; ?>" id="NetMonSalary" readonly/></td>
  <td class="td3" style="text-align:center;"><input value="<?php echo $ResCtc['NetMonthSalary_Value']; ?>" name="CtcEmpNetMonSalary" id="CtcEmpNetMonSalary" class="td3" style="width:90%;text-align:right;background-color:#DCEEF1;font-weight:bold;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr><td class="td33" colspan="4">&nbsp;<b>[B] Annual Components (Tax saving components which shall be reimbursed on production of documents)</b></td></tr>
...
{ 
 ...
 <tr>
  ...
  <td class="td3" id="ltaB" style="text-align:center;"><input name="EmpLeaveTraAllow" value="<?php echo $ResCtc['LTA_Value']; ?>" id="EmpLeaveTraAllow" onChange="return ChangeLTA(this.value)" onKeyUp="return ChangeLTA(this.value)" class="td3" style="width:90%;text-align:right;" readonly onKeyPress="return isNumberKey(event)"/></td>
  <td class="td3" id="ltaB" style="text-align:center;"><input name="CtcEmpLeaveTraAllow" value="<?php echo $ResCtc['LTA_Value']; ?>" id="CtcEmpLeaveTraAllow" class="td3" style="width:90%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  ...
  <td class="td3" id="ceaB" style="text-align:center;"><input name="EmpChildEduAllow" value="<?php echo $ResCtc['CHILD_EDU_ALL_Value']; ?>" id="EmpChildEduAllow" onChange="return ChangeCEA(this.value)" onKeyUp="return ChangeCEA(this.value)" class="td3" style="width:90%;text-align:right;" readonly/></td>
  <td class="td3" id="ceaB" style="text-align:center;"><input name="CtcEmpChildEduAllow" value="<?php echo $ResCtc['CHILD_EDU_ALL_Value']; ?>" id="CtcEmpChildEduAllow" onChange="FunCompaire()" onkeyup="FunCompaire()" class="td3" style="width:90%;text-align:right;" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  <td class="td3">&nbsp;</td><td class="td3">&nbsp;Annual Gross Salary :</td>
  <td class="td3" style="text-align:center;"><input value="<?php echo $ResCtc['Tot_Gross_Annual']; ?>" name="EmpAnnGrossSalary" id="EmpAnnGrossSalary" class="td3" style="width:90%;text-align:right;background-color:#DCEEF1;font-weight:bold;" /></td>
  <td class="td3" style="text-align:center;"><input value="<?php echo $ResCtc['Tot_Gross_Annual']; ?>" name="CtcEmpAnnGrossSalary" id="CtcEmpAnnGrossSalary" class="td3" style="width:90%;text-align:right;background-color:#DCEEF1;font-weight:bold;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr><td class="td33" colspan="4">&nbsp;<b>[C] Other Annual Components (Statutory components)</tr>
 ...
 <tr>
  ...
  <td class="td3" id="gratuityB" style="text-align:center;"><input name="EmpEstiGratuity" value="<?php echo $ResCtc['GRATUITY_Value']; ?>" id="EmpEstiGratuity" class="td3" style="width:90%;text-align:right;" readonly/></td>
  <td class="td3" id="gratuityB" style="text-align:center;"><input name="CtcEmpEstiGratuity" value="<?php echo $ResCtc['GRATUITY_Value']; ?>" id="CtcEmpEstiGratuity" class="td3" style="width:90%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  ...
  <td class="td3" id="pfcontriB" style="text-align:center;"><input name="EmpEmployerPFContri" value="<?php echo $ResCtc['PF_Employer_Contri_Annul']; ?>" id="EmpEmployerPFContri" class="td3" style="width:90%;text-align:right;" readonly/></td>
  <td class="td3" id="pfcontriB" style="text-align:center;"><input name="CtcEmpEmployerPFContri" value="<?php echo $ResCtc['PF_Employer_Contri_Annul']; ?>" id="CtcEmpEmployerPFContri" class="td3" style="width:90%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  <td class="td3">&nbsp;</td>
  <td class="td3" id="mppA">&nbsp;Employer's ESIC Contribution :</td>
  <td class="td3" id="mppB" style="text-align:center;"><input name="AnnualESCI" value="<?php echo $ResCtc['AnnualESCI']; ?>" id="AnnualESCI" class="td3" style="width:90%;text-align:right;" readonly/></td>
  <td class="td3" id="mppB" style="text-align:center;"><input name="CtcAnnualESCI" value="<?php echo $ResCtc['AnnualESCI']; ?>" id="CtcAnnualESCI" class="td3" style="width:90%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  ...
  <td class="td3" id="mppB" style="text-align:center;"><input name="EmpMediPoliPremium" id="EmpMediPoliPremium" onChange="ChangeMPP()" onKeyUp="ChangeMPP()" value="<?php echo $ResCtc['Mediclaim_Policy']; ?>" class="td3" style="width:90%;text-align:right;" readonly/><input type="hidden" id="EMediPP" value="<?php echo $ResStat['MedicalPolicyPremium']; ?>" readonly/></td>
  <td class="td3" id="mppB" style="text-align:center;"><input name="CtcEmpMediPoliPremium" id="CtcEmpMediPoliPremium" onChange="ChangeMPP()" onKeyUp="ChangeMPP()" value="<?php echo $ResCtc['Mediclaim_Policy']; ?>" class="td3" style="width:90%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  <td class="td3">&nbsp;</td><td class="td3">&nbsp;Total Cost to Company :</td>
  <td class="td3" style="text-align:center;"><input id="EmpTotalCtc" name="EmpTotalCtc" value="<?php echo $ResCtc['Tot_CTC']; ?>" class="td3" style="width:90%;text-align:right;background-color:#DCEEF1;font-weight:bold;" readonly/><input type="hidden" id="HideCtc" value="0" /><input type="hidden" value="<?php echo $ResCtc['Tot_CTC']; ?>" id="ETotCtc" readonly onKeyPress="return isNumberKey(event)"/></td>
  <td class="td3" style="text-align:center;"><input id="CtcEmpTotalCtc" name="CtcEmpTotalCtc" value="<?php echo $ResCtc['Tot_CTC']; ?>" class="td3" style="width:90%;text-align:right;background-color:#DCEEF1;font-weight:bold;" readonly onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  <td class="td3">&nbsp;</td>
  <td class="td33" colspan="4">&nbsp;<b>Additional Benifit</b>
 </tr>
 <tr>
  ...
  <td class="td3" id="micB" style="text-align:center;"><input name="EmpAddBenifit_MediInsu" id="EmpAddBenifit_MediInsu" value="<?php if($ResCtc['DepartmentId']==4 OR $ResCtc['DepartmentId']==6){echo $resDaily['MCSSP'];}else{echo $resDaily['MCS'];}//echo $ResCtc['EmpAddBenifit_MediInsu_value']; ?>" class="td3" style="width:90%;text-align:right;" readonly/><input type="hidden" id="EAddBenifit_MI" value="<?php echo $ResCtc['EmpAddBenifit_MediInsu_value']; ?>" readonly/></td>
  <td class="td3" id="micB" style="text-align:center;"><input name="CtcEmpAddBenifit_MediInsu" id="CtcEmpAddBenifit_MediInsu" value="<?php if($ResCtc['DepartmentId']==4 OR $ResCtc['DepartmentId']==6){echo $resDaily['MCSSP'];}else{echo $resDaily['MCS'];}//echo $ResCtc['EmpAddBenifit_MediInsu_value']; ?>" class="td3" style="width:90%;text-align:right;" required/></td>
 </tr>
 <tr>
  ...
  <td class="td3" id="micB" style="text-align:center;"><input name="Car_Entitlement" id="Car_Entitlement" value="<?php echo $ResCtc['Car_Entitlement']; ?>" class="td3" style="width:90%;text-align:right;" readonly/></td>
  <td class="td3" id="micB" style="text-align:center;"><input name="CtcCar_Entitlement" id="CtcCar_Entitlement" value="<?php echo $ResCtc['Car_Entitlement']; ?>" class="td3" style="width:90%;text-align:right;" required/></td>
 </tr>
 <tr>  
  <td class="td3" class="fontButton" colspan="4">
  <table border="0" align="right" class="fontButton">
   <tr>
	...
	<input type="button" name="ChangeCtc" id="ChangeCtc" style="width:90px; display:block;" value="edit" onClick="EditCtc()" <?php if($ResP['HR_PmsStatus']!=2) { echo 'disabled'; } ?>><input type="button" name="EditCtcE" id="EditCtcE" style="width:90px;display:none;" value="save" onClick="return HRSaveCTC(<?php echo $EmpId.', '.$PmsId.', '.$YearId.', '.$ComId.', '.$UId; ?>)" /></td>
   </tr>
  </table>
  </td> 
 </tr>
