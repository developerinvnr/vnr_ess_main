...
<?php if($_REQUEST['value']!=6){ ?><td align="center" style="color:#FFFFFF;" class="All_80"><b>DA InsideHQ</b></td><?php } ?>
<?php if($_REQUEST['value']==6){ ?><td align="center" style="color:#FFFFFF;" class="All_80"><b>DA InsideHQ</b></td><?php } ?>	
<?php if($_REQUEST['value']!=6){ ?><td align="center" style="color:#FFFFFF;" class="All_80"><b>DA OutsideHQ</b></td><?php } ?>
<?php if($_REQUEST['value']==6){ ?><td align="center" style="color:#FFFFFF;" class="All_80"><b>DA OutsideHQ</b></td><?php } ?>
    <td align="center" style="color:#FFFFFF;" class="All_80"><b>DA InsideHQ (Only For PD Staff)</b></td>
...
<?php if($_REQUEST['value']!=6){ ?><td align="center" style="background-color:#FFD2D2;" class="All_80"><?php echo $res['DA_Inside_Hq']; ?></td><?php } ?>
<?php if($_REQUEST['value']==6){ ?><td align="center" style="background-color:#FFD2D2;" class="All_80"><?php echo $res['DA_Inside_HqSal']; ?></td><?php } ?>	
<?php if($_REQUEST['value']!=6){ ?><td align="center" style="background-color:#FFD2D2;" class="All_80"><?php echo $res['DA_Outside_Hq']; ?></td><?php } ?>
<?php if($_REQUEST['value']==6){ ?><td align="center" style="background-color:#FFD2D2;" class="All_80"><?php echo $res['DA_Outside_HqSal']; ?></td><?php } ?>
    <td align="center" style="background-color:#FFD2D2;" class="All_80"><?php echo $res['DA_Outside_HqPD']; ?></td>
