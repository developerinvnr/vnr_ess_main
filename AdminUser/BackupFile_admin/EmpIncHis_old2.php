...
<td class="tdr" bgcolor="#FFB7FF"><?php if($rn_ctc['Tot_GrossMonth']>0){ echo floatval($rn_ctc['Tot_GrossMonth']); } ?></td>
	...
	<td class="tdr"><?php if($res['Industry_Bench_Markinge']>0){ echo floatval($res['Industry_Bench_Markinge']); } ?></td>
	<?php /*?><td class="tdr"><?php echo floatval($res['Current_GrossSalaryPM']); ?></td><?php */?>
	<td class="tdr" bgcolor="#FFFFB3"><?php if($res['Proposed_GrossSalaryPM']>0){ echo floatval($res['Proposed_GrossSalaryPM']); } ?></td>		
	<td class="tdc" bgcolor="#FFFFB3"><?php if($res['Prop_PeInc_GSPM']!=0){ echo $res['Prop_PeInc_GSPM']; } ?></td>
	<td class="tdr" bgcolor="#FFFFB3"><?php if($res['PropSalary_Correction']>0){ echo floatval($res['PropSalary_Correction']); } ?></td>
	<td class="tdr" bgcolor="#FFFFB3"><?php if($res['TotalProp_GSPM']>0){ echo floatval($res['TotalProp_GSPM']); } ?></td>
	<td class="tdc" bgcolor="#FFFFB3"><?php if($res['TotalProp_PerInc_GSPM']==0){ 
    ...
    else { echo $res['TotalProp_PerInc_GSPM']; } ?></td>
	...
	<?php /*?><td class="tdr"><?php echo floatval($rn_ctc['MED_REM_Value']); ?></td><?php */?>
