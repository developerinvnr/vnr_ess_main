...
$sqlEOldReq=mysql_query("select SUM(ApprovalAmt) as AppAmt from hrm_asset_employee_request where EmployeeID=".$_POST['ei']." AND (AssetNId=".$_POST['v']." OR AssetNId=".$SubAssetId." OR AssetNId=".$SubAssetId2.") AND ApprovalStatus=2 AND ReqAmtExpiryDate>='".date("Y-m-d")."'", $con); $rowEOldReq=mysql_num_rows($sqlEOldReq); 
