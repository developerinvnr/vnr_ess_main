...
<tr>
 ...
 <td valign="top"><input name="ABatteryExpiry" id="ABatteryExpiry" class="All_80" value="<?php echo date("d-m-Y",strtotime($res['ABatteryExpiry'])); ?>" readonly/><button id="ABatteryExpiryBtn" class="CalenderButton"></button><script type="text/javascript">  var cal = Calendar.setup({ onSelect:  function(cal) { cal.hide()}, showTime: true }); cal.manageFields("ABatteryExpiryBtn", "ABatteryExpiry", "%d-%m-%Y"); </script></td>
...
<tr>
 ...
 <td colspan="3"><textarea name="AnyOtherRemark" id="AnyOtherRemark" cols="40" rows="2"><?php echo $res['AnyOtherRemark']; ?></textarea></td>
   ...
   <tr>
      ...
      <input type="button" value="refresh" onClick="javascript:window.location='AssetEmpAnyField.php?&ID=<?php echo $_REQUEST['ID']; ?>&Aei=<?php echo $_REQUEST['Aei']; ?>'"/>&nbsp;
     </td></tr></table></td>
   </tr>
  </table>  
</td>
