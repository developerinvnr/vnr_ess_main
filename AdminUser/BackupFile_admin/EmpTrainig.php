...
<?php //**********************************************START*****START*****START******START******START***************************************************************?>
 ...
 <tr>
  <td align="left" height="20" valign="top" colspan="4">
   <table border="0">
    <tr>
	  <td align="right" width="230" class="heading">Taining</td>
	  <td>&nbsp;&nbsp;&nbsp;</td>
...
<form name="formEAssest" method="post" onSubmit="return validate(this)">
<table border="0">
<tr>
 <td>
  <table><tr>
...
<td>
  ...
  <td style="width:200px;font-family:Times New Roman;font-size:14px;font-weight:bold;" align="center" valign="top">Subject</td>
  ...
  <td style="width:150px;font-family:Times New Roman;font-size:14px;font-weight:bold;" align="center" valign="top">Institute</td>
  <td style="width:150px;font-family:Times New Roman;font-size:14px;font-weight:bold;" align="center" valign="top">Trainer</td>
  </tr>
<?php $sqlTr=mysql_query("select * from hrm_company_training_participant INNER JOIN hrm_company_training ON hrm_company_training_participant.TrainingId=hrm_company_training.TrainingId where hrm_company_training_participant.EmployeeID=".$EMPID." order by TraFrom DESC", $con); $sn=1; while($resTr=mysql_fetch_array($sqlTr)) { ?>    
  <tr bgcolor="#FFFFFF">
  <td style="font-family:Times New Roman;font-size:12px;text-transform:uppercase;" align="center" valign="top"><?php echo $sn; ?></td>
  <td style="font-family:Times New Roman;font-size:12px;text-transform:uppercase;" align="" valign="top">&nbsp;<?php echo $resTr['TraTitle']; ?></td>
  <td style="font-family:Times New Roman;font-size:12px;text-transform:uppercase;" align="center" valign="top"><?php echo $resTr['TraYear']; ?></td>
  <td style="font-family:Times New Roman;font-size:12px;text-transform:uppercase;" align="center" valign="top"><?php echo date("d-M-y",strtotime($resTr['TraFrom'])); ?></td>
  <td style="font-family:Times New Roman;font-size:12px;text-transform:uppercase;" align="center" valign="top"><?php echo date("d-M-y",strtotime($resTr['TraTo'])); ?></td>
  <td style="font-family:Times New Roman;font-size:12px;text-transform:uppercase;" align="center" valign="top"><?php echo $resTr['Duration']; ?></td>
  <td style="font-family:Times New Roman;font-size:12px;text-transform:uppercase;" align="" valign="top">&nbsp;<?php echo $resTr['Location']; ?></td>
  <td style="font-family:Times New Roman;font-size:12px;text-transform:uppercase;" align="" valign="top">&nbsp;<?php echo $resTr['Institute']; ?></td>
  <td style="font-family:Times New Roman;font-size:12px;text-transform:uppercase;" align="" valign="top">&nbsp;<?php echo $resTr['TrainerName']; ?></td>
  </tr>
