...
<?php /**************************************** Dummy Start *********************************/ ?>	
<?php /**************************************** Dummy Start *********************************/ ?>	
<?php if($UnHodCtc>0){ $IncpGross=($UnHodCtc*130)/100; $Un_IncS=($UnHodCtc*30)/100; }
...
$OnePerT=(($resHT['HodTCtc']+$UnHodCtc)*1)/100; 
...
?>
      <td class="tdc"><input class="inpr" style="font-weight:bold;background-color:#0076EC;color:#FFFFFF;" id="PIST" name="PIST" value="<?php echo floatval($H555I); //$HTotPT); ?>" readonly/></td>
