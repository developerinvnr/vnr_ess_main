...
{ 
$sql2=mysql_query("select * from hrm_employee_investment_declaration where EmployeeID=".$_POST['E']." AND Period='".$_POST['Period']."' AND YearId=".$_POST['Y']." AND Status='A'", $con);
$row=mysql_num_rows($sql2);
if($row>0){ $sqlUp=mysql_query("update hrm_employee_investment_declaration set FormSubmit='YY', HRA='".$_POST['HRA']."', Medical='".$_POST['Medical']."', LTA='".$_POST['LTA']."', CEA='".$_POST['CEA']."', MIP='".$_POST['MIP']."', MTI='".$_POST['MTI']."', MTS='".$_POST['MTS']."', ROL='".$_POST['ROL']."', Handi='".$_POST['Handi']."', 80G_Per='".$_POST['80GPer']."', DTC='".$_POST['DTC']."', RP='".$_POST['RP']."', DFS='".$_POST['DFS']."', PenFun='".$_POST['PenFun']."', LIP='".$_POST['LIP']."', DA='".$_POST['DA']."', PPF='".$_POST['PPF']."', PostOff='".$_POST['PostOff']."', ULIP='".$_POST['ULIP']."', HL='".$_POST['HL']."', MF='".$_POST['MF']."', IB='".$_POST['IB']."', CTF='".$_POST['CTF']."', NHB='".$_POST['NHB']."', NSC='".$_POST['NSC']."', EPF='".$_POST['EPF']."', Form16='".$_POST['Form16']."', SPE='".$_POST['SPE']."', PT='".$_POST['PT']."', PFD='".$_POST['PFD']."', IT='".$_POST['IT']."', IHL='".$_POST['IHL']."', IL='".$_POST['IL']."', Inv_Date='".date("Y-m-d",strtotime($_POST['Inv_Date']))."',HRSubmittedDate='".date("Y-m-d")."', Place='".$_POST['Place']."' where EmployeeID=".$_POST['E']." AND Period='".$_POST['Period']."' AND YearId=".$_POST['Y']." AND Status='A'", $con); }
if($row==0){ $sqlUp=mysql_query("insert into hrm_employee_investment_declaration(EmployeeID, EC, Period, Status, FormSubmit, HRA, Medical, LTA, CEA, MIP, MTI, MTS, ROL, Handi, 80G_Per, DTC, RP, DFS, PenFun, LIP, DA, PPF, PostOff, ULIP, HL, MF, IB, CTF, NHB, NSC, EPF, Form16, SPE, PT, PFD, IT, IHL, IL, Inv_Date, HRSubmittedDate, Place, YearId) values(".$_POST['E'].", '".$_POST['EC']."', '".$_POST['Period']."', 'A', 'Y', '".$_POST['HRA']."', '".$_POST['Medical']."', '".$_POST['LTA']."', '".$_POST['CEA']."', '".$_POST['MIP']."', '".$_POST['MTI']."', '".$_POST['MTS']."', '".$_POST['ROL']."', '".$_POST['Handi']."', '".$_POST['80GPer']."', '".$_POST['DTC']."', '".$_POST['RP']."', '".$_POST['DFS']."', '".$_POST['PenFun']."', '".$_POST['LIP']."', '".$_POST['DA']."', '".$_POST['PPF']."', '".$_POST['PostOff']."', '".$_POST['ULIP']."', '".$_POST['HL']."', '".$_POST['MF']."', '".$_POST['IB']."', '".$_POST['CTF']."', '".$_POST['NHB']."', '".$_POST['NSC']."', '".$_POST['EPF']."', '".$_POST['Form16']."', '".$_POST['SPE']."', '".$_POST['PT']."', '".$_POST['PFD']."', '".$_POST['IT']."', '".$_POST['IHL']."', '".$_POST['IL']."', '".date("Y-m-d",strtotime($_POST['Inv_Date']))."', '".date("Y-m-d")."', '".$_POST['Place']."', ".$_POST['Y'].")", $con); }

if($sqlUp){echo '<script>alert("Investment Declaration Form Updated Successfully.");</script>';}
}
?>
...
function Edit()
{ document.getElementById("SubmitInvstDec").style.display='block'; document.getElementById("EditInvstDec").style.display='none'; document.getElementById("HRA").readOnly=false; document.getElementById("HRA").style.backgroundColor='#F0F8FF'; document.getElementById("Medical").readOnly=false; document.getElementById("Medical").style.backgroundColor='#F0F8FF'; document.getElementById("LTA").readOnly=false; document.getElementById("LTA").style.backgroundColor='#F0F8FF'; document.getElementById("CEA").readOnly=false; document.getElementById("CEA").style.backgroundColor='#F0F8FF'; document.getElementById("MIP").readOnly=false; document.getElementById("MIP").style.backgroundColor='#F0F8FF'; document.getElementById("MTI").readOnly=false; document.getElementById("MTI").style.backgroundColor='#F0F8FF'; document.getElementById("MTS").readOnly=false; document.getElementById("MTS").style.backgroundColor='#F0F8FF'; document.getElementById("ROL").readOnly=false; document.getElementById("ROL").style.backgroundColor='#F0F8FF'; document.getElementById("Handi").readOnly=false; document.getElementById("Handi").style.backgroundColor='#F0F8FF'; document.getElementById("80GPer").disabled=false; document.getElementById("DTC").readOnly=false; document.getElementById("DTC").style.backgroundColor='#F0F8FF';document.getElementById("RP").readOnly=false; document.getElementById("RP").style.backgroundColor='#F0F8FF';document.getElementById("DFS").readOnly=false; document.getElementById("DFS").style.backgroundColor='#F0F8FF'; document.getElementById("PenFun").readOnly=false; document.getElementById("PenFun").style.backgroundColor='#F0F8FF'; document.getElementById("LIP").readOnly=false; document.getElementById("LIP").style.backgroundColor='#F0F8FF'; document.getElementById("DA").readOnly=false; document.getElementById("DA").style.backgroundColor='#F0F8FF'; document.getElementById("PPF").readOnly=false; document.getElementById("PPF").style.backgroundColor='#F0F8FF'; document.getElementById("PostOff").readOnly=false; document.getElementById("PostOff").style.backgroundColor='#F0F8FF'; document.getElementById("ULIP").readOnly=false; document.getElementById("ULIP").style.backgroundColor='#F0F8FF'; document.getElementById("HL").readOnly=false; document.getElementById("HL").style.backgroundColor='#F0F8FF'; document.getElementById("MF").readOnly=false; document.getElementById("MF").style.backgroundColor='#F0F8FF'; document.getElementById("IB").readOnly=false; document.getElementById("IB").style.backgroundColor='#F0F8FF'; document.getElementById("CTF").readOnly=false; document.getElementById("CTF").style.backgroundColor='#F0F8FF'; document.getElementById("NHB").readOnly=false; document.getElementById("NHB").style.backgroundColor='#F0F8FF'; document.getElementById("NSC").readOnly=false; document.getElementById("NSC").style.backgroundColor='#F0F8FF'; document.getElementById("EPF").readOnly=false; document.getElementById("EPF").style.backgroundColor='#F0F8FF'; document.getElementById("Form16").readOnly=false; document.getElementById("Form16").style.backgroundColor='#F0F8FF'; document.getElementById("SPE").readOnly=false; document.getElementById("SPE").style.backgroundColor='#F0F8FF'; document.getElementById("PT").readOnly=false; document.getElementById("PT").style.backgroundColor='#F0F8FF'; document.getElementById("PFD").readOnly=false; document.getElementById("PFD").style.backgroundColor='#F0F8FF'; document.getElementById("IT").readOnly=false; document.getElementById("IT").style.backgroundColor='#F0F8FF'; document.getElementById("IHL").readOnly=false; document.getElementById("IHL").style.backgroundColor='#F0F8FF'; document.getElementById("IL").readOnly=false; document.getElementById("IL").style.backgroundColor='#F0F8FF'; document.getElementById("Place").readOnly=false; document.getElementById("Place").style.backgroundColor='#F0F8FF'; document.getElementById("f_btn1").disabled=false; }  //document.getElementById("Attach").disabled=false; 
...
<?php $sqlE = mysql_query("SELECT EmpCode,Fname,Sname,Lname,DR,Gender,Married,DesigId,DepartmentId,PanNo FROM hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID WHERE hrm_employee.EmployeeID=".$_REQUEST['E'], $con);  $ResE = mysql_fetch_assoc($sqlE); 
...
<table border="0">
<?php $sql = mysql_query("SELECT * FROM hrm_year WHERE YearId=".$_REQUEST['Y'], $con);  $resY = mysql_fetch_array($sql); 
...
<?php $SqlIvst=mysql_query("select * from hrm_employee_investment_declaration where EmployeeID=".$_REQUEST['E']." AND Period='".$FD."-".$TD."' AND YearId=".$_REQUEST['Y']." AND Status='A'", $con); 
      $rowIvst=mysql_num_rows($SqlIvst); if($rowIvst>0) { $resIvst=mysql_fetch_assoc($SqlIvst); }?> 		 
		    <tr>
			 <td align="center" style="width:740px;">
			 <font color="#106809" style='font-family:Times New Roman;' size="4"><b>Investment Declaration Form 2013-14</b></font></td>
			</tr>
			<tr>
...
<tr>
  <td align="center" style="width:850px;font-size:15px; height:18px;" colspan="5">&nbsp;<b>(To be used to declare investment for income Tax that will be made during the period 2013-2014)</b></td>
</tr>
...
<?php $SqlCom=mysql_query("select CompanyName from hrm_company_basic where CompanyId=".$_REQUEST['C']."", $con); $resCom=mysql_fetch_assoc($SqlCom); ?> 
...
<input type="hidden" id="Period" name="Period" value="<?php echo '2013-2014'; ?>"  readonly/>
<input type="hidden" id="EC" name="EC" value="<?php echo $EC; ?>"  readonly/>
<tr>
...
<?php $SqlHRA=mysql_query("select HRA_Value,BAS_Value from hrm_employee_ctc where EmployeeID=".$_REQUEST['E']." AND Status='A'", $con); $resHRA=mysql_fetch_assoc($SqlHRA);
...
<td align="center" valign="top" style="width:90px;font-size:15px;"><?php echo $LTA; ?></td>
<td align="center" valign="top" style="width:110px;font-size:15px;">
...
<td align="center" valign="top" style="width:90px;font-size:15px;">2400</td>
...
<tr>
<td align="center" valign="top" rowspan="7" style="width:20px;font-size:15px;">8</td>
<td align="Center" valign="middle" rowspan="7" style="width:100px;font-size:15px;">&nbsp;Deductions Under Chapeter VI A </td>
...
<?php //if($resIvst['FormSubmit']!='YY'){ ?><button id="f_btn1" class="CalenderButton" disabled></button> <?php //} ?>
		                       <script type="text/javascript">  var cal = Calendar.setup({ onSelect:  function(cal) { cal.hide()}, showTime: true }); 
                               cal.manageFields("f_btn1", "Inv_Date", "%d-%m-%Y");</script></td>
</tr>
<tr>
...
<td align="left" valign="top" colspan="5" style="width:550px;font-size:15px;">&nbsp;</td>
   ...
   <td align="" class="fontButton" colspan="6"><table border="0" align="right" class="fontButton">
	<tr>
	  <td style="width:450px;color:#FFFFFF;font-weight:bold;font-family:Times New Roman; font-size:15px;"><span id="msg"><?php $msg; ?>&nbsp;</span></td>
	  ...
	  <input type="submit" name="SubmitInvstDec" id="SubmitInvstDec" style="width:90px; display:none;" value="save">
	  <input type="button" name="EditInvstDec" id="EditInvstDec" style="width:90px; display:<?php if($resIvst['FormSubmit']=='YY'){echo 'block';} ?>;" value="edit" onClick="Edit()">
	  </td>
	  <td align="right" style="width:90px;">
	  <input type="button" name="Refresh" id="Refresh" style="width:90px;" value="refresh" onClick="javascript:window.location='EmpEditInvesDecl.php?E=<?php echo $_REQUEST['E']; ?>&C=<?php echo $_REQUEST['C']; ?>&Y=<?php echo $_REQUEST['Y']; ?>&U=<?php echo $_REQUEST['U']; ?>'"/></td>
	</tr></table>  
	</td>
	</tr>
	</table>
