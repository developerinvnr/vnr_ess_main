...
//**********************************
$EMPID=$_REQUEST['ID']; $SqEC=mysql_query("select EmpCode from hrm_employee where EmployeeID=".$EMPID, $con); $ReEC=mysql_fetch_assoc($SqEC);
...
<tr>
 ...
 <td valign="top"><input name="ABatteryExpiry" id="ABatteryExpiry" class="All_80" value="<?php echo date("d-m-Y",strtotime($res['ABatteryExpiry'])); ?>" readonly/></td>
