...
if(isset($_POST['submit'])) {
    ...
    $upload_dir = '../Employee/ESIC_Card'.DIRECTORY_SEPARATOR;
    ...
    if(!empty(array_filter($_FILES['files']['name']))) {
        ...
        foreach ($_FILES['files']['tmp_name'] as $key => $value) {
		   ...
		   window.location="Up_ESICard.php";</script>'; 
...
{ 
  var x="Up_ESICard.php?d="+v; window.location=x; }
...
<table border="1" id="table1" cellspacing="1" style="width:100%;">
 ...
 <tr style="background-color:#FFFFFF;height:22px;"> 
  ...
  <td class="tdc">
  <?php if(file_exists("../Employee/ESIC_Card/".$res['EmpCode'].".pdf")){ ?><a href="<?="../Employee/ESIC_Card/".$res['EmpCode'].".pdf";?>" target="_blank">Uploaded</a><?php } ?>
  </td>
