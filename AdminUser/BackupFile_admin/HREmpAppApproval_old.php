...
/**(3)*************************If Prorata wise New Open Open Open Open Open **************************/
  ...
  {
   echo 'aa='.$TotIncAmt=($TPreGross*$resMaxMin['IncDistriFrom'])/100;
   echo 'bb='.$NewGrossAmt=10*(ceil(($TPreGross+$TotIncAmt)/10)); 
   echo 'cc='.$NewGrossAmt2=$TPreGross+$TotIncAmt;
   $TotInc2=0;
  }	 
