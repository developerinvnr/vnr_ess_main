...
if(isset($_POST['id']) && $_POST['id']!=""){ $id = $_POST['id']; $DeptId = $_POST['DeptId']; ?>
	  ...
	  <select style="font-size:12px; font-family:Georgia; height:20px; width:300px;background-color:#D8FFB0; color:#004F9D;" id="SelectRev" onChange="GetApp(this.value,<?php echo $DeptId; ?>,'E')">
