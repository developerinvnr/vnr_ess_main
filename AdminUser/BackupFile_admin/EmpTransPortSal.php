...
<html>
<head>
<title><?php include_once('../Title.php'); ?>&nbsp;Tranportation Allowance</title>
...
<?php */ ?>
<?php $sql = mysql_query("SELECT * FROM hrm_emplyee_tds_tranallow WHERE EmployeeID=".$_REQUEST['E']." AND Month=".$_REQUEST['M']." AND YearId=".$_REQUEST['Y'], $con); 
...
<table border="0">
 ...
 <td bgcolor="#D9D1E7">
 <table border="1">
 <tr><td colspan="4" align="center" style="font-family:Times New Roman;font-size:12px;width:400px;background-color:#7a6189;color:#FFFFFF;"><b>Transport Allowance For Reaching</b></td></tr> 
 <tr>
