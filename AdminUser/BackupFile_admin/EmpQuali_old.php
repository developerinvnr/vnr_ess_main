...
{  
   ...
   { //$sqlDelete=mysql_query("DELETE FROM hrm_employee_qualification WHERE EmployeeID=".$EMPID, $con);
	...
	{ if($_POST['Quali_'.$i]!='Not' AND $_POST['Quali_'.$i]!='')
      { $SqlInsQuali = mysql_query("INSERT INTO hrm_employee_qualification(EmployeeID, Qualification, Specialization, Institute, Subject, PassOut, Grade_Per, QuaCreatedBy, QuaCreatedDate, QuaYearId) VALUES (".$EMPID.", '".$_POST['Quali_'.$i]."', '".$_POST['Spec_'.$i]."', '".$_POST['InsU_'.$i]."', '".$_POST['Subject_'.$i]."', '".$_POST['PassOut_'.$i]."', '".$_POST['Grade_'.$i]."', ".$UserId.",'".date('Y-m-d')."',".$YearId.")", $con);  
	  }} 	
   ...
   {
    $SqlInsQuali = mysql_query("INSERT INTO hrm_employee_qualification(EmployeeID, Qualification, Specialization, Institute, Subject, PassOut, Grade_Per, QuaCreatedBy, QuaCreatedDate, QuaYearId) VALUES (".$EMPID.", '10th', '".$_POST['Spec_10th']."', '".$_POST['InsU_10th']."', '".$_POST['Subject_10th']."', '".$_POST['PassOut_10th']."', '".$_POST['Grade_10th']."', ".$UserId.",'".date('Y-m-d')."',".$YearId."), (".$EMPID.", '12th', '".$_POST['Spec_12th']."', '".$_POST['InsU_12th']."', '".$_POST['Subject_12th']."', '".$_POST['PassOut_12th']."', '".$_POST['Grade_12th']."', ".$UserId.",'".date('Y-m-d')."',".$YearId."), (".$EMPID.", 'Graduation', '".$_POST['Spec_Graduation']."', '".$_POST['InsU_Graduation']."', '".$_POST['Subject_Graduation']."', '".$_POST['PassOut_Graduation']."', '".$_POST['Grade_Graduation']."', ".$UserId.",'".date('Y-m-d')."',".$YearId."), (".$EMPID.", 'Post_Graduation', '".$_POST['Spec_PG']."', '".$_POST['InsU_PG']."', '".$_POST['Subject_PG']."', '".$_POST['PassOut_PG']."', '".$_POST['Grade_PG']."', ".$UserId.",'".date('Y-m-d')."',".$YearId.")", $con); 

    if($_POST['RowCountQuali']!=0)  
	{ for($i=1; $i<=$_POST['RowCountQuali']; $i++)
	  { if($_POST['Quali'.$i]!='Not' AND $_POST['Quali_'.$i]!='') 
	    { $SqlInsRow = mysql_query("INSERT INTO hrm_employee_qualification (EmployeeID, Qualification, Specialization, Institute, Subject, PassOut, Grade_Per, QuaCreatedBy, QuaCreatedDate, QuaYearId) VALUES (".$EMPID.", '".$_POST['Quali'.$i]."', '".$_POST['Spec'.$i]."', '".$_POST['InsU'.$i]."', '".$_POST['Subject'.$i]."', '".$_POST['PassOut'.$i]."', '".$_POST['Grade'.$i]."', ".$UserId.",'".date('Y-m-d')."',".$YearId.")", $con); 
		}
	  } 
	}
    for($i=1; $i<=5; $i++)
...
<td><table bgcolor="#FFFFFF" border="1"><tr>
  ...
  <input style="text-transform:uppercase;" name="Spec_10th" id="Spec_10th" class="All_120" value="<?php echo $res2['Specialization']; ?>" style=" "/></td>
  <td class="All_200" align="left">
  <input style="text-transform:uppercase;" name="InsU_10th" id="InsU_10th" class="All_200" value="<?php echo $res2['Institute']; ?>"/></td>
  <td class="All_150" align="left">
  <input style="text-transform:uppercase;" name="Subject_10th" id="Subject_10th" class="All_150" value="<?php echo $res2['Subject']; ?>"/></td>
...
<td><table bgcolor="#FFFFFF" border="1"><tr>
  ...
  <input style="text-transform:uppercase;" name="Spec_12th" id="Spec_12th" class="All_120" value="<?php echo $res3['Specialization']; ?>"/></td>
  <td class="All_200" align="left">
  <input style="text-transform:uppercase;" name="InsU_12th" id="InsU_12th" class="All_200" value="<?php echo $res3['Institute']; ?>"/></td>
  <td class="All_150" align="left">
  <input style="text-transform:uppercase;" name="Subject_12th" id="Subject_12th" class="All_150" value="<?php echo $res3['Subject']; ?>"/></td>
...
<td><table bgcolor="#FFFFFF" border="1"><tr>
  ...
  <input style="text-transform:uppercase;" name="Spec_Graduation" id="Spec_Graduation" class="All_120" value="<?php echo $res4['Specialization']; ?>"/></td>
  <td class="All_200" align="left">
  <input style="text-transform:uppercase;" name="InsU_Graduation" id="InsU_Graduation" value="<?php echo $res4['Institute']; ?>" class="All_200"/></td>
  <td class="All_150" align="left">
  <input style="text-transform:uppercase;" name="Subject_Graduation" id="Subject_Graduation" value="<?php echo $res4['Subject']; ?>" class="All_150"/></td>
...
<td><table bgcolor="#FFFFFF" border="1"><tr>
  ...
  <input style="text-transform:uppercase;" name="Spec_PG" id="Spec_PG" class="All_120" value="<?php echo $res5['Specialization']; ?>"/></td>
  <td class="All_200" align="left">
  <input style="text-transform:uppercase;" name="InsU_PG" id="InsU_PG" class="All_200" value="<?php echo $res5['Institute']; ?>"/></td>
  <td class="All_150" align="left">
  <input style="text-transform:uppercase;" name="Subject_PG" id="Subject_PG" class="All_150" value="<?php echo $res5['Subject']; ?>"/></td>
...
<td><table bgcolor="#FFFFFF" border="1"><tr>
  ...
  <input style="text-transform:uppercase;" name="Spec<?php echo $i;?>" id="Spec<?php echo $i;?>" value="<?php echo $resExtQ['Specialization']; ?>" class="All_120"/></td>
  <td class="All_200" align="left">
  <input style="text-transform:uppercase;" name="InsU<?php echo $i;?>" id="InsU<?php echo $i;?>" value="<?php echo $resExtQ['Institute']; ?>" class="All_200"/></td>
  <td class="All_150" align="left">
  <input style="text-transform:uppercase;" name="Subject<?php echo $i;?>" id="Subject<?php echo $i;?>" value="<?php echo $resExtQ['Subject']; ?>" class="All_150"/></td>
...
<td><table style="display:none;" id="Row1" bgcolor="#FFFFFF" border="1"><tr>
  ...
  <td class="All_120" align="left"><input style="text-transform:uppercase;" name="Spec_1" id="Spec_1" class="All_120"/></td>
  <td class="All_200" align="left"><input style="text-transform:uppercase;" name="InsU_1" id="InsU_1" class="All_200" /></td>
  <td class="All_150" align="left"><input style="text-transform:uppercase;" name="Subject_1" id="Subject_1" class="All_150" /></td>
...
<td><table style="display:none;" id="Row2" bgcolor="#FFFFFF" border="1"><tr>
 ...
 <td class="All_120" align="left"><input style="text-transform:uppercase;" name="Spec_2" id="Spec_2" class="All_120"/></td>
  <td class="All_200" align="left"><input style="text-transform:uppercase;" name="InsU_2" id="InsU_2" class="All_200" /></td>
  <td class="All_150" align="left"><input style="text-transform:uppercase;" name="Subject_2" id="Subject_2" class="All_150" /></td>
...
<td><table style="display:none;" id="Row3" bgcolor="#FFFFFF" border="1"><tr>
  ...
  <td class="All_120" align="left"><input style="text-transform:uppercase;" name="Spec_3" id="Spec_3" class="All_120"/></td>
  <td class="All_200" align="left"><input style="text-transform:uppercase;" name="InsU_3" id="InsU_3" class="All_200" /></td>
  <td class="All_150" align="left"><input style="text-transform:uppercase;" name="Subject_3" id="Subject_3" class="All_150" /></td>
...
<td><table style="display:none;" id="Row4" bgcolor="#FFFFFF" border="1"><tr>
  ...
  <td class="All_120" align="left"><input style="text-transform:uppercase;" name="Spec_4" id="Spec_4" class="All_120"/></td>
  <td class="All_200" align="left"><input style="text-transform:uppercase;" name="InsU_4" id="InsU_4" class="All_200" /></td>
  <td class="All_150" align="left"><input style="text-transform:uppercase;" name="Subject_4" id="Subject_4" class="All_150" /></td>
...
<td><table style="display:none;" id="Row5" bgcolor="#FFFFFF" border="1"><tr>
  ...
  <td class="All_120" align="left"><input style="text-transform:uppercase;" name="Spec_5" id="Spec_5" class="All_120"/></td>
  <td class="All_200" align="left"><input style="text-transform:uppercase;" name="InsU_5" id="InsU_5" class="All_200" /></td>
  <td class="All_150" align="left"><input style="text-transform:uppercase;" name="Subject_5" id="Subject_5" class="All_150" /></td>
...
<td><table bgcolor="#FFFFFF" border="1"><tr>
  <td class="All_120" align="left">&nbsp;10th&nbsp;</td>
  <td class="All_120" align="left"><input type="hidden" name="10_Id" value="<?php echo $res2['QualificationId']; ?>">
  <input style="text-transform:uppercase;" name="Spec_10th" id="Spec_10th" class="All_120" value="<?php echo $res2['Specialization']; ?>" readOnly/></td>
  <td class="All_200" align="left">
  <input style="text-transform:uppercase;" name="InsU_10th" id="InsU_10th" class="All_200" value="<?php echo $res2['Institute']; ?>" readOnly/></td>
  <td class="All_150" align="left">
  <input style="text-transform:uppercase;" name="Subject_10th" id="Subject_10th" class="All_150" value="<?php echo $res2['Subject']; ?>" readOnly/></td>
...
<td><table bgcolor="#FFFFFF" border="1"><tr>
  <td class="All_120" align="left">&nbsp;12th &nbsp;</td>
  <td class="All_120" align="left"><input type="hidden" name="12_Id" value="<?php echo $res3['QualificationId']; ?>">
  <input style="text-transform:uppercase;" name="Spec_12th" id="Spec_12th" class="All_120" value="<?php echo $res3['Specialization']; ?>" readOnly/></td>
  <td class="All_200" align="left">
  <input style="text-transform:uppercase;" name="InsU_12th" id="InsU_12th" class="All_200" value="<?php echo $res3['Institute']; ?>" readOnly/></td>
  <td class="All_150" align="left">
  <input style="text-transform:uppercase;" name="Subject_12th" id="Subject_12th" class="All_150" value="<?php echo $res3['Subject']; ?>" readOnly/></td>
...
<td><table bgcolor="#FFFFFF" border="1"><tr>
  <td class="All_120" align="left">&nbsp;Graduation&nbsp;</td>
  <td class="All_120" align="left"><input type="hidden" name="G_Id" value="<?php echo $res4['QualificationId']; ?>">
  <input style="text-transform:uppercase;" name="Spec_Graduation" id="Spec_Graduation" class="All_120" value="<?php echo $res4['Specialization']; ?>" readOnly/></td>
  <td class="All_200" align="left">
  <input style="text-transform:uppercase;" name="InsU_Graduation" id="InsU_Graduation" value="<?php echo $res4['Institute']; ?>" class="All_200" readOnly/></td>
  <td class="All_150" align="left">
  <input style="text-transform:uppercase;" name="Subject_Graduation" id="Subject_Graduation" value="<?php echo $res4['Subject']; ?>" class="All_150" readOnly/></td>
...
<td><table bgcolor="#FFFFFF" border="1"><tr>
  <td class="All_120" align="left">&nbsp;Post Graduation&nbsp;</td>
  <td class="All_120" align="left"><input type="hidden" name="PG_Id" value="<?php echo $res5['QualificationId']; ?>">
  <input style="text-transform:uppercase;" name="Spec_PG" id="Spec_PG" class="All_120" value="<?php echo $res5['Specialization']; ?>" readOnly/></td>
  <td class="All_200" align="left">
  <input style="text-transform:uppercase;" name="InsU_PG" id="InsU_PG" class="All_200" value="<?php echo $res5['Institute']; ?>" readOnly/></td>
  <td class="All_150" align="left">
  <input style="text-transform:uppercase;" name="Subject_PG" id="Subject_PG" class="All_150" value="<?php echo $res5['Subject']; ?>" readOnly/></td>
...
<td><table bgcolor="#FFFFFF" border="1"><tr>
  ...
  <td class="All_120" align="left">
  <input style="text-transform:uppercase;" name="Spec<?php echo $i;?>" id="Spec<?php echo $i;?>" value="<?php echo $resExtQ['Specialization']; ?>" class="All_120" readOnly/></td>
  <td class="All_200" align="left">
  <input style="text-transform:uppercase;" name="InsU<?php echo $i;?>" id="InsU<?php echo $i;?>" value="<?php echo $resExtQ['Institute']; ?>" class="All_200" readOnly/></td>
  <td class="All_150" align="left">
  <input style="text-transform:uppercase;" name="Subject<?php echo $i;?>" id="Subject<?php echo $i;?>" value="<?php echo $resExtQ['Subject']; ?>" class="All_150" readOnly/></td>
...
<td><table style="display:none;" id="Row1" bgcolor="#FFFFFF" border="1"><tr>
  <td class="All_120" align="left"><input style="" name="Quali_1" id="Quali_1" class="All_120" value="Not" readOnly/></td>
   <td class="All_120" align="left"><input style="text-transform:uppercase;" name="Spec_1" id="Spec_1" class="All_120" readOnly/></td>
  <td class="All_200" align="left"><input style="text-transform:uppercase;" name="InsU_1" id="InsU_1" class="All_200" readOnly/></td>
  <td class="All_150" align="left"><input style="text-transform:uppercase;" name="Subject_1" id="Subject_1" class="All_150" readOnly/></td>
...
<td><table style="display:none;" id="Row2" bgcolor="#FFFFFF" border="1"><tr>
 <td class="All_120" align="left"><input style="t" name="Quali_2" id="Quali_2" class="All_120" value="Not" readOnly/></td>
  <td class="All_120" align="left"><input style="text-transform:uppercase;" name="Spec_2" id="Spec_2" class="All_120" readOnly/></td>
  <td class="All_200" align="left"><input style="text-transform:uppercase;" name="InsU_2" id="InsU_2" class="All_200" readOnly/></td>
  <td class="All_150" align="left"><input style="text-transform:uppercase;" name="Subject_2" id="Subject_2" class="All_150" readOnly/></td>
...
<td><table style="display:none;" id="Row3" bgcolor="#FFFFFF" border="1"><tr>
  <td class="All_120" align="left"><input style="" name="Quali_3" id="Quali_3" class="All_120" value="Not" readOnly/></td>
   <td class="All_120" align="left"><input style="text-transform:uppercase;" name="Spec_3" id="Spec_3" class="All_120" readOnly/></td>
  <td class="All_200" align="left"><input style="text-transform:uppercase;" name="InsU_3" id="InsU_3" class="All_200" readOnly/></td>
  <td class="All_150" align="left"><input style="text-transform:uppercase;" name="Subject_3" id="Subject_3" class="All_150" readOnly/></td>
...
<td><table style="display:none;" id="Row4" bgcolor="#FFFFFF" border="1"><tr>
  <td class="All_120" align="left"><input style="" name="Quali_4" id="Quali_4" class="All_120" value="Not" readOnly/></td>
   <td class="All_120" align="left"><input style="text-transform:uppercase;" name="Spec_4" id="Spec_4" class="All_120" readOnly/></td>
  <td class="All_200" align="left"><input style="text-transform:uppercase;" name="InsU_4" id="InsU_4" class="All_200" readOnly/></td>
  <td class="All_150" align="left"><input style="text-transform:uppercase;" name="Subject_4" id="Subject_4" class="All_150" readOnly/></td>
...
<td><table style="display:none;" id="Row5" bgcolor="#FFFFFF" border="1"><tr>
  <td class="All_120" align="left"><input style="" name="Quali_5" id="Quali_5" class="All_120" value="Not" readOnly/></td>
   <td class="All_120" align="left"><input style="text-transform:uppercase;" name="Spec_5" id="Spec_5" class="All_120" readOnly/></td>
  <td class="All_200" align="left"><input style="text-transform:uppercase;" name="InsU_5" id="InsU_5" class="All_200" readOnly/></td>
  <td class="All_150" align="left"><input style="text-transform:uppercase;" name="Subject_5" id="Subject_5" class="All_150" readOnly/></td>
