...
if($ResCtc['DR']=='Y'){$M='Dr.';} if($ResCtc['Gender']=='M'){$M='Mr.';} elseif($ResCtc['Gender']=='F' AND $ResCtc['Married']=='Y'){$M='Mrs.';} elseif($ResCtc['Gender']=='F' AND $ResCtc['Married']=='N'){$M='Miss.';}  
	  ...
	  <td style="font-family:Times New Roman;color:#000000; width:785;" align="center">
	    <table border="0">
		  <tr>
			...
			<td style="width:200px;font-size:18px;font-weight:bold;" align="right">Date:&nbsp;<?php echo date("d F Y", strtotime($_REQUEST['DP'])); ?></td>
			<td style="width:50px;">&nbsp;</td>
		  </tr>
		</table>
	  </td>
...
<tr>  
   <td align="" class="fontButton" colspan="6"><table border="0" align="right" class="fontButton">
	<tr>
	  ...
	  <tr>
     <td>
	   <table><tr><td style="width:50px;">&nbsp;</td><td style="width:685px;font-size:14px;"><b><u>Pls note</u>  :</b>This is a confidential document not to be discussed openly with others. You shall be personally responsible for any leakage of information regarding your compensation .</td></tr></table>
	 </td>
   </tr>		
...
<?php } elseif($_REQUEST['C']==3){ ?>
                   <table><tr>
		   <td style="width:343px;font-size:18px;font-weight:bold;">
		   <?php if($_REQUEST['D']!=98) {echo 'Director'; } //Authorized Signatory ?>
		   </td>
		   <td style="width:342px;font-size:18px;font-weight:bold;" align="right">
		   <?php if($_REQUEST['D']==98 OR $_REQUEST['D']==115 OR $_REQUEST['D']==116 OR $_REQUEST['D']==117) { ?>Director<?php } ?>
		   </td>
