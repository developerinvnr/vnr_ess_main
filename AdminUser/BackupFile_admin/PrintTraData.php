...
<script>function PrintPage() {window.print(); window.close();}</script>
</head>
<body class="body" onLoad="PrintPage()">
 ...
 <tr>
	 <td style="font-family:Times New Roman;font-size:20px;">&nbsp;&nbsp;&nbsp;<b>Training Details :&nbsp;<font color="#000066"><?php if($_REQUEST['v']!='All'){echo 'Year-'.$_REQUEST['v'];} ?></font></b></td>
	</tr>
 <tr>
...
<?php if($_REQUEST['v']!='All'){ $sqlT = mysql_query("SELECT * from hrm_company_training WHERE TraYear=".$_REQUEST['v']." AND CompanyId=".$_REQUEST['C']." order by TraFrom DESC", $con); }
