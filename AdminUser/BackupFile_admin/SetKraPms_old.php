...
if($_REQUEST['action']=='PrsPms' AND $_REQUEST['value']=='true')
{
 ...
 while($res=mysql_fetch_assoc($sql))
 { 
  $sqlCtc=mysql_query("select INCENTIVE_Value,Tot_GrossMonth,Tot_CTC from hrm_employee_ctc where EmployeeID=".$res['EmployeeID']." AND Status='A'", $con); $sqlGd=mysql_query("select GradeId,DesigId,DepartmentId from hrm_employee_general where EmployeeID=".$res['EmployeeID'], $con); $resCtc=mysql_fetch_assoc($sqlCtc); $resGd=mysql_fetch_assoc($sqlGd);
  ...
  */
  ...
  if($row3>0){ $sqlIns=mysql_query("update hrm_employee_pms set EmpCurrGrossPM=".$TotGoss.", EmpCurrCtc=".$TotCtc.", EmpCurrIncentivePM=".$Inctv.", FormAKraAllow_PerOfWeightage=".$KraWeight.", FormBBehaviAllow_PerOfWeightage=".$FormBWeight.", Emp_AchivementSave='N', Emp_KRASave='N', Emp_SkillSave='N', Emp_FeedBackSave='N', Emp_PmsStatus=0, Appraiser_PmsStatus=0, Appraiser_SubmitedDate='0000-00-00', Appraiser_NoOfResend=0, Reviewer_PmsStatus=0, Reviewer_SubmitedDate='0000-00-00', Reviewer_NoOfResend=0, HR_CurrDesigId=".$Desig.", HR_CurrGradeId=".$Grade.", HR_Curr_DepartmentId=".$Dept." where AssessmentYear=".$resSY['CurrY']." AND YearId=".$resSY['CurrY']." AND EmployeeID=".$res['EmployeeID']."", $con); }
  elseif($row3==0){ $sqlIns=mysql_query("insert into hrm_employee_pms(AssessmentYear, CompanyId, EmployeeID, Appraiser_EmployeeID, Reviewer_EmployeeID, HOD_EmployeeID, EmpCurrGrossPM, EmpCurrCtc, EmpCurrIncentivePM, FormAKraAllow_PerOfWeightage, FormBBehaviAllow_PerOfWeightage, Emp_AchivementSave, Emp_KRASave, Emp_SkillSave, Emp_FeedBackSave, Emp_PmsStatus, Appraiser_PmsStatus, Appraiser_SubmitedDate, Appraiser_NoOfResend, Reviewer_PmsStatus, Reviewer_SubmitedDate, Reviewer_NoOfResend, HR_CurrDesigId, HR_CurrGradeId, HR_Curr_DepartmentId, YearId) values(".$resSY['CurrY'].", ".$CompanyId.", ".$res['EmployeeID'].", ".$app.", ".$rev.", ".$hod.", ".$TotGoss.", ".$TotCtc.", ".$Inctv.", ".$KraWeight.", ".$FormBWeight.", 'N', 'N', 'N', 'N', 0, 0, '0000-00-00', 0, 0, '0000-00-00', 0, ".$Desig.", ".$Grade.", ".$Dept.", ".$resSY['CurrY'].")", $con); }
  ...
  <tr>
    <td align="left" style="width:100%;">
	 <table border="1" style="width:100%;" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	  <tr><td colspan="13" class="th" style="font-size:16px;">[1] Setting Process Year</b></td></tr>
	  <tr>
...
<?php } $SNo++;} ?>
  ...
  <tr>
    <td align="left" style="width:100%;">
	 <table border="1" style="width:100%;" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	  <tr><td colspan="23" class="th" style="font-size:16px;">[2] Permission (Open-Close) PMS Menu</b></td></tr>
	  <tr>
 ...
 <?php } $SNo++;} ?>	  
  ...
  <tr>
   <td align="left" style="width:100%;">
	<table border="1" style="width:50%;" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	  <tr><td colspan="13" class="th" style="font-size:16px;">[3] Appraisal Process, Setup KRA & Setup Form-B</b></td></tr>
	  <tr>
	   <td class="th" style="width:3%;">Sn</td>
  ...
  <tr>
   <td align="left" style="width:100%;">
	<table border="1" style="width:50%;" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	  <tr><td colspan="13" class="th" style="font-size:16px;">[4] New KRA Process Setup</b></td></tr>
	  <tr>
	   <td class="th" style="width:3%;">Sn</td>
	   <td class="th" style="width:21%;">Setup Name</td>
