...
{ 
  ...
  if($rowNoc>0)
  { $sqlIns=mysql_query("update hrm_employee_separation_nochr set NocSubmitDate='".date("Y-m-d")."', BEP='".$_POST['BEP_YN']."', BEP_Amt='".$_POST['BEP_Amt']."', BEP_Remark='".$BEP_R."', BPP='".$_POST['BPP_YN']."', BPP_Amt='".$_POST['BPP_Amt']."', BPP_Remark='".$BPP_R."', BExP='".$_POST['BExP_YN']."', BExP_Amt='".$_POST['BExP_Amt']."', BExP_Remark='".$BExP_R."', AdminIC='".$_POST['AdminIC_YN']."', AdminIC_Amt='".$_POST['AdminIC_Amt']."', AdminIC_Remark='".$AdminIC_R."', AdminVC='".$_POST['AdminVC_YN']."', AdminVC_Amt='".$_POST['AdminVC_Amt']."', AdminVC_Remark='".$AdminVC_R."', CV='".$_POST['CV_YN']."', CV_Amt='".$_POST['CV_Amt']."', CV_Remark='".$CV_R."', WorkDay=".$_POST['WorkDay'].", NoticeDay=".$_POST['NoticeDay'].", TotWorkDay=".$_POST['TotWorkDay'].", ServedDay=".$_POST['ServedDay'].", RecoveryDay=".$_POST['RecoveryDay'].", TotEL=".$_POST['TotEL'].", EnCashEL=".$_POST['EnCashEL'].", Basic='".$_POST['Basic']."', HRA='".$_POST['HRA']."', CarAllow='".$_POST['Car']."', CA='".$_POST['CA']."', Bonus_Month='".$_POST['Bonus_Month']."', SA='".$_POST['SA']."', DA='".$_POST['DA']."', Arrear='".$_POST['Arrear']."', Incen='".$_POST['Incen']."', PP='".$_POST['PP']."', VA='".$_POST['VA']."', CCA='".$_POST['CCA']."', RA='".$_POST['RA']."', Gross='".$_POST['Gross']."', LTA='".$_POST['LTA']."', MA='".$_POST['MA']."', TA='".$_POST['TA']."', CEA='".$_POST['CEA']."', LE='".$_POST['LE']."', Bonus='".$_POST['Bonus']."', Bonus_Adjustment='".$_POST['Bonus_Adjustment']."', Gratuity='".$_POST['Gratuity']."', Mediclaim='".$_POST['Mediclaim']."', RTSB='".$_POST['RTSB']."', NPS_Ded='".$_POST['NPS_Ded']."', Exgredia='".$_POST['Exgredia']."', NoticePay='".$_POST['NoticePay']."', TotEar='".$_POST['TotEar']."', PF='".$_POST['PF']."', NPR='".$_POST['NPR']."', NPR_Actual='".$_POST['NPR_Actual']."', PAP='".$_POST['PAP']."', ESIC='".$_POST['ESIC']."', ARR_ESIC='".$_POST['ARRESIC']."', VolC='".$_POST['VolC']."', RA_allow='".$_POST['RA_allow']."', HrRemark='".$HrRemark."', TotDeduct='".$_POST['TotAmt']."' where EmpSepId=".$_POST['si'], $con);}  
  else
  { $sqlIns=mysql_query("insert into hrm_employee_separation_nochr(EmpSepId, NocSubmitDate, BEP, BEP_Amt, BEP_Remark, BPP, BPP_Amt, BPP_Remark, BExP, BExP_Amt, BExP_Remark, AdminIC, AdminIC_Amt, AdminIC_Remark, AdminVC, AdminVC_Amt, AdminVC_Remark, CV, CV_Amt, CV_Remark, WorkDay, NoticeDay, TotWorkDay, ServedDay, RecoveryDay, TotEL, EnCashEL, Basic, HRA, CarAllow, CA, Bonus_Month, SA, DA, Arrear, Incen, PP, VA, TA, CCA, RA, Gross, LTA, MA, CEA, LE, Bonus, Bonus_Adjustment, Gratuity, Mediclaim, RTSB, NPS_Ded, Exgredia, NoticePay, TotEar, PF, NPR, NPR_Actual, PAP, ESIC, ARR_ESIC, VolC, RA_allow, HrRemark, TotDeduct) values(".$_POST['si'].", '".date("Y-m-d")."', '".$_POST['BEP_YN']."', '".$_POST['BEP_Amt']."', '".$BEP_R."', '".$_POST['BPP_YN']."', '".$_POST['BPP_Amt']."', '".$BPP_R."', '".$_POST['BExP_YN']."', '".$_POST['BExP_Amt']."', '".$BExP_R."', '".$_POST['AdminIC_YN']."', '".$_POST['AdminIC_Amt']."', '".$AdminIC_R."', '".$_POST['AdminVC_YN']."', '".$_POST['AdminVC_Amt']."', '".$AdminVC_R."', '".$_POST['CV_YN']."', '".$_POST['CV_Amt']."', '".$CV_R."', ".$_POST['WorkDay'].", ".$_POST['NoticeDay'].", ".$_POST['TotWorkDay'].", ".$_POST['ServedDay'].", ".$_POST['RecoveryDay'].", ".$_POST['TotEL'].", ".$_POST['EnCashEL'].", '".$_POST['Basic']."', '".$_POST['HRA']."', '".$_POST['Car']."', '".$_POST['CA']."', '".$_POST['Bonus_Month']."', '".$_POST['SA']."', '".$_POST['DA']."', '".$_POST['Arrear']."', '".$_POST['Incen']."', '".$_POST['PP']."', '".$_POST['VA']."', '".$_POST['TA']."', '".$_POST['CCA']."', '".$_POST['RA']."', '".$_POST['Gross']."', '".$_POST['LTA']."', '".$_POST['MA']."', '".$_POST['CEA']."', '".$_POST['LE']."', '".$_POST['Bonus']."', '".$_POST['Bonus_Adjustment']."', '".$_POST['Gratuity']."', '".$_POST['Mediclaim']."', '".$_POST['RTSB']."', '".$_POST['NPS_Ded']."', '".$_POST['Exgredia']."', '".$_POST['NoticePay']."', '".$_POST['TotEar']."', '".$_POST['PF']."', '".$_POST['NPR']."', '".$_POST['NPR_Actual']."', '".$_POST['PAP']."', '".$_POST['ESIC']."', '".$_POST['ARRESIC']."', '".$_POST['VolC']."', '".$_POST['RA_allow']."', '".$HrRemark."', '".$_POST['TotAmt']."')", $con); }
...
{ 
  ...
  $sqlNoc=mysql_query("select NocHRId from hrm_employee_separation_nochr where EmpSepId=".$_POST['si'], $con); $rowNoc=mysql_num_rows($sqlNoc); 
  if($rowNoc>0)
  { $sqlIns=mysql_query("update hrm_employee_separation_nochr set NocSubmitDate='".date("Y-m-d")."', BEP='".$_POST['BEP_YN']."', BEP_Amt='".$_POST['BEP_Amt']."', BEP_Remark='".$BEP_R."', BPP='".$_POST['BPP_YN']."', BPP_Amt='".$_POST['BPP_Amt']."', BPP_Remark='".$BPP_R."', BExP='".$_POST['BExP_YN']."', BExP_Amt='".$_POST['BExP_Amt']."', BExP_Remark='".$BExP_R."', AdminIC='".$_POST['AdminIC_YN']."', AdminIC_Amt='".$_POST['AdminIC_Amt']."', AdminIC_Remark='".$AdminIC_R."', AdminVC='".$_POST['AdminVC_YN']."', AdminVC_Amt='".$_POST['AdminVC_Amt']."', AdminVC_Remark='".$AdminVC_R."', CV='".$_POST['CV_YN']."', CV_Amt='".$_POST['CV_Amt']."', CV_Remark='".$CV_R."', WorkDay=".$_POST['WorkDay'].", NoticeDay=".$_POST['NoticeDay'].", TotWorkDay=".$_POST['TotWorkDay'].", ServedDay=".$_POST['ServedDay'].", RecoveryDay=".$_POST['RecoveryDay'].", TotEL=".$_POST['TotEL'].", EnCashEL=".$_POST['EnCashEL'].", Basic='".$_POST['Basic']."', HRA='".$_POST['HRA']."', CA='".$_POST['CA']."', Bonus_Month='".$_POST['Bonus_Month']."', SA='".$_POST['SA']."', DA='".$_POST['DA']."', Arrear='".$_POST['Arrear']."', Incen='".$_POST['Incen']."', PP='".$_POST['PP']."', VA='".$_POST['VA']."', TA='".$_POST['TA']."', CCA='".$_POST['CCA']."', RA='".$_POST['RA']."', Gross='".$_POST['Gross']."', LTA='".$_POST['LTA']."', MA='".$_POST['MA']."', CEA='".$_POST['CEA']."', LE='".$_POST['LE']."', Bonus='".$_POST['Bonus']."', Bonus_Adjustment='".$_POST['Bonus_Adjustment']."', Gratuity='".$_POST['Gratuity']."', Mediclaim='".$_POST['Mediclaim']."', RTSB='".$_POST['RTSB']."', NPS_Ded='".$_POST['NPS_Ded']."', Exgredia='".$_POST['Exgredia']."', NoticePay='".$_POST['NoticePay']."', TotEar='".$_POST['TotEar']."', PF='".$_POST['PF']."', NPR='".$_POST['NPR']."', NPR_Actual='".$_POST['NPR_Actual']."', ESIC='".$_POST['ESIC']."', ARR_ESIC='".$_POST['ARRESIC']."', VolC='".$_POST['VolC']."', RA_allow='".$_POST['RA_allow']."', HrRemark='".$HrRemark."', TotDeduct='".$_POST['TotAmt']."' where EmpSepId=".$_POST['si'], $con);} 
  else
...
if($rowCheck>0 AND $rowNoc>0)
{
    ...
    $subject="NOC clearance by all department";
    $body=$email_message2;
    $email_to=$resE['EmailId_Vnr'];
    require 'vendor/mail_admin.php';
...
document.getElementById("TotEL").readOnly=false; 
 ...
 document.getElementById("Bonus_Adjustment").readOnly=false; document.getElementById("Bonus_Adjustment").style.background='#FFFFFF'; 
 
 
 document.getElementById("Gratuity").style.background='#FFFFFF'; document.getElementById("RTSB").readOnly=false; document.getElementById("NPS_Ded").readOnly=false; document.getElementById("RTSB").style.background='#FFFFFF'; document.getElementById("NPS_Ded").style.background='#FFFFFF';
 ...
 document.getElementById("TA").readOnly=false; document.getElementById("TA").style.background='#FFFFFF';
 ...
 document.getElementById("RA_allow").readOnly=false; document.getElementById("RA_allow").style.background='#FFFFFF';
...
//Open Calculation  if(HrRowNOC==0)
 ...
 var Bonus_Month_R = parseFloat(document.getElementById("Bonus_MonthRate").value);
 ...
 var VA = parseFloat(document.getElementById("VA").value); var TA = parseFloat(document.getElementById("TA").value);
 ...
 if(Bonus_Month_R>0){var OneDay_Bonus=Bonus_Month_R/MonthWD; var Bonus = document.getElementById("Bonus_Month").value=Math.round(OneDay_Bonus*TotWorkDay); }
 else{var Bonus = document.getElementById("Bonus_Month").value=0;}
 ...
 var Gross = document.getElementById("Gross").value=Math.round(Basic+HRA+CA+SA+Bonus+DA+Arrear+Incen+PP+VA+TA+CCA+RA+CarAmt);
 
 var GrossEsic = Math.round(Basic+HRA+CA+SA+Bonus);
 if(GrossEsic>0)
 {
   var EmpESIC=parseFloat(document.getElementById("EmpESIC").value); 
   if(EmpESIC>0)
   {
     var ESIC = document.getElementById("ESIC").value=Math.round((((GrossEsic*0.75)/100)*100)/100,0); 
   }
 }
...
if(HrRowNOC==0)
{
 ...
 var NPS_Ded = parseFloat(document.getElementById("NPS_Ded").value);
if(HrRowNOC==0){ var TotEar = document.getElementById("TotEar").value=Math.round(Gross+CEA_V+MA_V+LTA_V+LE+Bonus+Gratuity+Mediclaim); }
...
{ 
 if(RecoveryDay>0)
 {
  ...
  if(Basic_R>0){var Basic_R = Math.round(OneDay_Basic*RecoveryDay);}else{var Basic_R=0;}
  ...
  if(Bonus_Month_R>0){var Bonus_Month_R = Math.round(OneDay_Bonus*RecoveryDay);}else{var Bonus_Month_R=0;}
  if(SA_R>0){var SA_R = Math.round(OneDay_Spe*RecoveryDay);}else{var SA_R=0;}
  var Gross_R = document.getElementById("NPR").value=Math.round(Basic_R+HRA_R+CA_R+Bonus_Month_R+SA_R); 
  var Gross_RA = document.getElementById("NPR_Actual").value=Math.round(Basic_R+HRA_R+CA_R+Bonus_Month_R+SA_R);
 }
 else{var Gross_R = document.getElementById("NPR").value=0;}
} 
//Close Calculation 
...
var LTA_R = parseFloat(document.getElementById("LTA_R").value); 
 ...
 var Gross = document.getElementById("Gross").value=Math.round(Basic+HRA+CA+Bonus+SA+DA+Arrear+Incen+PP+VA+TA+CCA+RA+CarAmt);
 if(CEA_R>0){var OneDay_CEA = CEA_R/MonthWD; var CEA_V = document.getElementById("CEA").value=Math.round(OneDay_CEA*TotWorkDay);}
 else{var CEA_V = document.getElementById("CEA").value=0;}
 if(MA_R>0){var OneDay_MA=MA_R/MonthWD; var MA_V = document.getElementById("MA").value=Math.round(OneDay_MA*TotWorkDay); }
 else{var MA_V = document.getElementById("MA").value=0;}
...
if(HrRowNOC==0)
{
 ...
 var RTSB = parseFloat(document.getElementById("RTSB").value);
 var NPS_Ded = parseFloat(document.getElementById("NPS_Ded").value);
 var TotEar = document.getElementById("TotEar").value=Math.round(Gross+CEA_V+MA_V+LTA_V+LE+Bonus+Gratuity+Mediclaim);
...
if(HrRowNOC==0)
{
 ...
 var LE = parseFloat(document.getElementById("LE").value); var Bonus = parseFloat(document.getElementById("Bonus").value); 
 var Gratuity = parseFloat(document.getElementById("Gratuity").value); var Bonus_Adjustment = parseFloat(document.getElementById("Bonus_Adjustment").value);
 var Mediclaim = parseFloat(document.getElementById("Mediclaim").value); 
 var RTSB = parseFloat(document.getElementById("RTSB").value);
 var NPS_Ded = parseFloat(document.getElementById("NPS_Ded").value);
 var TotEar = document.getElementById("TotEar").value=Math.round(Gross+CEA_V+MA_V+LTA_V+LE+Bonus+Gratuity+Mediclaim+Bonus_Adjustment);
...
function FunEnCash()
{
 ...
 var Bonus_Adjustment = parseFloat(document.getElementById("Bonus_Adjustment").value);
 var TotEar = document.getElementById("TotEar").value=Math.round(Gross+LTA+MA+CEA+LE+Bonus+Gratuity+Mediclaim+Exgredia+NoticePay+Bonus_Adjustment);
 ...
 if(Gross>0)
 {
   ...
   if(EmpESIC>0)
   {
     var ESIC = document.getElementById("ESIC").value=Math.round((((Gross*0.75)/100)*100)/100,0); 
   }
 }
 */
...
function funCalcyVal()
{
 ...
 var Bonus_Month = parseFloat(document.getElementById("Bonus_Month").value);
 ...
 var VA = parseFloat(document.getElementById("VA").value); var TA = parseFloat(document.getElementById("TA").value);
  var CCA = parseFloat(document.getElementById("CCA").value); var RA = parseFloat(document.getElementById("RA").value);
 var Gross = document.getElementById("Gross").value=Math.round(Basic+HRA+CA+Bonus_Month+SA+DA+Arrear+Incen+PP+VA+TA+CCA+RA+CarAmt); 
...
var Gross = parseFloat(document.getElementById("Gross").value); var LTA = parseFloat(document.getElementById("LTA").value); var MA = parseFloat(document.getElementById("MA").value); var CEA = parseFloat(document.getElementById("CEA").value); var LE = parseFloat(document.getElementById("LE").value); var Bonus = parseFloat(document.getElementById("Bonus").value); var Gratuity = parseFloat(document.getElementById("Gratuity").value); var Mediclaim = parseFloat(document.getElementById("Mediclaim").value); var RTSB = parseFloat(document.getElementById("RTSB").value); 
var NPS_Ded = parseFloat(document.getElementById("NPS_Ded").value);
var Exgredia = parseFloat(document.getElementById("Exgredia").value); var NoticePay = parseFloat(document.getElementById("NoticePay").value);
 var Bonus_Adjustment = parseFloat(document.getElementById("Bonus_Adjustment").value);
 var TotEar = document.getElementById("TotEar").value=Math.round(Gross+LTA+MA+CEA+LE+Bonus+Gratuity+Mediclaim+Exgredia+NoticePay+Bonus_Adjustment);
}
...
{ 
  if(document.getElementById("EmpActPf").value=='Y')
  {
...
{ 
  if(document.getElementById("ActComPFCheck").checked=='Y')
  {
   var bs = parseFloat(document.getElementById("EmpBasic").value);
   var pf = parseFloat(document.getElementById("EmpProviFund").value);
   var sp = parseFloat(document.getElementById("EmpSpeAllow").value);
...
{ 
  if(document.getElementById("BSActPfCheck").checked=='Y')
  {
...
{ 
 ...
 var Bonus_Adjustment = formname.Bonus_Adjustment.value; var test_num7 = Numfilter.test(Bonus_Adjustment);
 if(Bonus_Adjustment==''){alert("please check bonus"); return false;}
 ...
 var NPS_Ded = formname.NPS_Ded.value;
 ...
 var RA_allow=parseFloat(document.getElementById("RA_allow").value);
 ...
 var TotDeductAmt = document.getElementById("TotAmt").value=Math.round((DeductAmt+PF+NPR+ESIC+ARRESIC+VolC+RA_allow+RTSB+NPS_Ded)*100)/100; 
...
$sqlE=mysql_query("select EmpCode,Fname,Sname,Lname,DesigId,DepartmentId,DR,Gender,Married,DateJoining,Bond_Year,DateOfSepration from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID where hrm_employee.EmployeeID=".$resSE['EmployeeID'], $con); $resE=mysql_fetch_assoc($sqlE); 
...
{
$SqlCtc = mysql_query("SELECT * FROM hrm_employee_ctc WHERE EmployeeID=".$resSE['EmployeeID']." AND CtcId=5000", $con);      
}
else
{
$SqlCtc = mysql_query("SELECT * FROM hrm_employee_ctc WHERE EmployeeID=".$resSE['EmployeeID']." AND Status='A'", $con);  
}
...
<input type="hidden" id="BSActPfCheck" name="BSActPfCheck" value="<?php echo $ResCtc['EmpBSActPf']; ?>" />
  ...
  <td colspan="3" valign="top">
   <table border="1">
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="Basic" name="Basic" value="<?php if($res['Basic']>0){echo intval($res['Basic']);}else{echo 0;} ?>" /></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="HRA" name="HRA" value="<?php if($res['HRA']>0){echo intval($res['HRA']);}else{echo 0;} ?>" /></td>
	</tr>
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="Car" name="Car" onChange="FunCar()" value="<?php if($res['CarAllow']>0){echo intval($res['CarAllow']);}else{echo 0;} ?>" /></td>
	</tr>
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="CA" name="CA" value="<?php if($res['CA']>0){echo intval($res['CA']);}else{echo 0;} ?>" /></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="Bonus_Month" name="Bonus_Month" value="<?php if($res['Bonus_Month']>0){echo intval($res['Bonus_Month']);}else{echo 0;} ?>"/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="SA" name="SA" value="<?php if($res['SA']>0){echo intval($res['SA']);}else{echo 0;} ?>" /></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 <td colspan="2" class="Text">&nbsp;Daily Allowance</td>
	 <td class="Text" align="center"><input class="AIT" id="DA" name="DA" onChange="funCalcyVal()" onBlur="funCalcyVal()" value="<?php if($res['DA']>0){echo intval($res['DA']);}else{echo 0;} ?>" /></td>
	</tr>
	<tr bgcolor="#FFFFFF"> 
	 <td colspan="2" class="Text">&nbsp;Arrear</td>
	 <td class="Text" align="center"><input class="AIT" id="Arrear" name="Arrear" onChange="funCalcyVal()" onBlur="funCalcyVal()" value="<?php if($res['Arrear']>0){echo intval($res['Arrear']);}else{echo 0;} ?>"/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 <td colspan="2" class="Text">&nbsp;Incentive</b></td>
	 <td class="Text" align="center"><input class="AIT" id="Incen" name="Incen" onChange="funCalcyVal()" onBlur="funCalcyVal()" value="<?php if($res['Incen']>0){echo intval($res['Incen']);}else{echo 0;} ?>" /></td>
	</tr>
        <tr bgcolor="#FFFFFF" class="Text">
	 <td colspan="2" class="Text">&nbsp;Performance Pay</td>
<td class="Text" align="center"><input class="AIT" id="PP" name="PP" onChange="funCalcyVal()" onBlur="funCalcyVal()" value="<?php if($res['PP']>0){echo intval($res['PP']);}else{echo 0;} ?>" /></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 <td colspan="2" class="Text">&nbsp;Variable Adjustment</td>
	 <td class="Text" align="center"><input class="AIT" id="VA" name="VA" value="<?php if($res['VA']>0){echo intval($res['VA']);}else{echo 0;} ?>" onChange="funCalcyVal()" onBlur="funCalcyVal()" /></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 <td colspan="2" class="Text">&nbsp;Transport Allowance</td>
	 <td class="Text" align="center"><input class="AIT" id="TA" name="TA" value="<?php if($res['TA']>0){echo intval($res['TA']);}else{echo 0;} ?>" onChange="funCalcyVal()" onBlur="funCalcyVal()" /></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 <td colspan="2" class="Text">&nbsp;City Compensatory Allowance</td>
	 <td class="Text" align="center"><input class="AIT" id="CCA" name="CCA" value="<?php if($res['CCA']>0){echo intval($res['CCA']);}else{echo 0;} ?>" onChange="funCalcyVal()" onBlur="funCalcyVal()" /></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 <td colspan="2" class="Text">&nbsp;Relocation Allowance</td>
	 <td class="Text" align="center"><input class="AIT" id="RA" name="RA" value="<?php if($res['RA']>0){echo intval($res['RA']);}else{echo 0;} ?>" onChange="funCalcyVal()" onBlur="funCalcyVal()" /></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF"> 
	 ...
	 <td class="Text" align="center"><input class="AIT" id="Bonus_Adjustment" name="Bonus_Adjustment" value="<?php if($res['Bonus_Adjustment']>0){echo intval($res['Bonus_Adjustment']);}else{echo 0;} ?>" onChange="funBonusAdj()" onBlur="funBonusAdj()" readonly/></td>
	</tr>
  ...
  <td colspan="2" valign="top">
   <table border="1">
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="RTSB" name="RTSB" value="<?php if($res['RTSB']>0){echo intval($res['RTSB']);}else{echo 0;} ?>" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="RA_allow" name="RA_allow" value="<?php if($res['RA_allow']>0){echo intval($res['RA_allow']);}else{echo 0;} ?>" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 <td class="Text">&nbsp;NPS Deduction</td>
	 <td class="Text" align="center"><input class="AIT" id="NPS_Ded" name="NPS_Ded" value="<?php if($res['NPS_Ded']>0){echo intval($res['NPS_Ded']);}else{echo 0;} ?>" readonly/></td>
	</tr>
...
<tr>
  <td style="font-size:14px; width:100%; color:#FF0000;" colspan="2"><b>
   <?php $curY=date("Y"); $PrevY=date("Y")-1; $Prev2Y=date("Y")-2; 
   $sqlSal=mysql_query("select sum(RA) as TotRA, sum(Arr_RA) as a_TotRA from hrm_employee_monthlypayslip where Year=".$curY." AND EmployeeID=".$resSE['EmployeeID'],$con); 
   $sqlSal2=mysql_query("select sum(RA) as TotRA, sum(Arr_RA) as a_TotRA from hrm_employee_monthlypayslip_".$PrevY." where Year=".$PrevY." AND EmployeeID=".$resSE['EmployeeID'],$con); 
   $sqlSal3=mysql_query("select sum(RA) as TotRA, sum(Arr_RA) as a_TotRA from hrm_employee_monthlypayslip_".$Prev2Y." where Year=".$Prev2Y." AND EmployeeID=".$resSE['EmployeeID'],$con); 
   $resSal=mysql_fetch_assoc($sqlSal); $resSal2=mysql_fetch_assoc($sqlSal2); $resSal3=mysql_fetch_assoc($sqlSal3);
   
   $TotalRA=$resSal['TotRA']+$resSal2['TotRA']+$resSal3['TotRA'];
   $TotalRArr=$resSal['a_TotRA']+$resSal2['a_TotRA']+$resSal3['a_TotRA'];
   if($TotalRA>0)
    {
	 echo 'Previous Paid Relocation Allowance: <font color="#000000"> '.$TotalRA.'</font><br>';
	 echo '(Arrear) Relocation Allowance: <font color="#000000"> '.$TotalRArr.'</font>';
    }
   ?>
   </b>
  </td>
 ...
 <tr><td>&nbsp;</td></tr>
  ...
  <td style="font-size:14px; width:100%; color:#FF0000;" colspan="2"><b>
   <?php  
if($resE['Bond_Year']=='1'){$LastBondDate=date('Y-m-d', strtotime("+12 months", strtotime($resE['DateJoining']))); }
elseif($resE['Bond_Year']=='2'){$LastBondDate=date('Y-m-d', strtotime("+24 months", strtotime($resE['DateJoining']))); } 
elseif($resE['Bond_Year']=='3'){$LastBondDate=date('Y-m-d', strtotime("+36 months", strtotime($resE['DateJoining']))); }
elseif($resE['Bond_Year']=='4'){$LastBondDate=date('Y-m-d', strtotime("+48 months", strtotime($resE['DateJoining']))); }
elseif($resE['Bond_Year']=='5'){$LastBondDate=date('Y-m-d', strtotime("+60 months", strtotime($resE['DateJoining']))); }

if($LastBondDate<=date($resE['DateOfSepration']))
{
 echo 'Service Bond: <font color="#000000"> '.$resE['Bond_Year'].' Year</font><br>';
 echo 'Date Of Joining: <font color="#000000"> '.date("d-m-Y",strtotime($resE['DateJoining'])).'</font>';
}
?>
   </b>
  </td>
