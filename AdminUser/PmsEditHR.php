...
?>
     <tr>
      ...
      <table border="1" id="table1" cellspacing="0" style="width:100%;">
       ...
       <thead>
       <tr>
        <td colspan="10" class="td1l" style="background-color:#0069D2;height:25px;">&nbsp;PMS Status <?php echo $sts; ?> Wise :&nbsp;&nbsp;(&nbsp;<?php echo $sts; ?> - <?php if($_REQUEST['value']!='All') {echo $name; }else echo 'All';?>&nbsp;)
...
<?php //if(($res['Emp_PmsStatus']==2 AND $res['Appraiser_PmsStatus']==2 AND $res['Reviewer_PmsStatus']==2) OR ($res['DesigId']==113 OR $res['DesigId']==120 OR $res['DesigId']==147) OR (($res['EmpCode']==14 OR $res['EmpCode']==17 OR $res['EmpCode']==139 OR $res['EmpCode']==50 OR $res['EmpCode']==51) AND $res['HodSubmit_IncStatus']==2)) ?>
    ...
    if($res['Emp_PmsStatus']==2 OR ($res['DesigId']==113 OR $res['DesigId']==120 OR $res['DesigId']==147) OR (($res['EmpCode']==14 OR $res['EmpCode']==17 OR $res['EmpCode']==139 OR $res['EmpCode']==50 OR $res['EmpCode']==51) AND ($res['HodSubmit_IncStatus']==0 OR $res['HodSubmit_IncStatus']==1 OR $res['HodSubmit_IncStatus']==2))){ ?><a href="#"><img src="images/edit.png" border="0" onClick="Click(<?php echo $res['EmpPmsId'].','.$res['EmployeeID'].', '.$YearId.','.$CompanyId.','.$no; ?>)" /></a><?php } else {echo '&nbsp;'; }?></td> <?php //'.$YearId.' ?>
