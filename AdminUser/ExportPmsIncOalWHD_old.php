...
$xls_filename = 'HOD_EmpPMS_OverallRpt_'.$PRD.'-'.$name.'.xls';
...
if($_REQUEST['YI']<=7){ echo "\tNOE\tPREV. GROSS\tPIS\t% PIS\tPSC\t% PSC\tTISPM\t% TISPM\tTPGSPM"; }
else{ echo "\tNOE\tPREV. CTC\tProp. CTC\t% Prop. CTC\tCTC Corr.\t% CTC Corr.\tTotal Inc.\t% Total Inc.\tTotal Prop. CTC"; }
...
if($_REQUEST['ee']=='Dept')
{  
  $sql=mysql_query("select ".$qry." from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where p.EmployeeID!=6 AND p.EmployeeID!=7 AND p.EmployeeID!=51 AND p.EmployeeID!=223 AND p.EmployeeID!=224 AND p.EmployeeID!=461 AND e.EmpStatus='A' AND e.CompanyId=".$_REQUEST['c']." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".$Y."-06-30' AND p.Appraiser_EmployeeID!=0 group by DepartmentId", $con); 
}
elseif($_REQUEST['ee']=='Hod')
{ $sql=mysql_query("select ".$qry." from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where p.EmployeeID!=6 AND p.EmployeeID!=7 AND p.EmployeeID!=51 AND p.EmployeeID!=223 AND p.EmployeeID!=224 AND p.EmployeeID!=461 AND e.EmpStatus='A' AND e.CompanyId=".$_REQUEST['c']." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".$Y."-06-30' AND p.Appraiser_EmployeeID!=0 group by HOD_EmployeeID", $con); 
}
 ...
 if($_REQUEST['ee']=='Dept')
{ $sqlE=mysql_query("select * from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where p.EmployeeID!=6 AND p.EmployeeID!=7 AND p.EmployeeID!=51 AND p.EmployeeID!=223 AND p.EmployeeID!=224 AND p.EmployeeID!=461 AND e.EmpStatus='A' AND e.CompanyId=".$_REQUEST['c']." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".date($FD.'-06-30')."' AND g.DepartmentId=".$res['DepartmentId']." AND p.Appraiser_EmployeeID!=0", $con); $rowNOE=mysql_num_rows($sqlE); $sD=mysql_query("select DepartmentName from hrm_department where DepartmentId=".$res['DepartmentId'], $con); $rD=mysql_fetch_assoc($sD); 
}  
if($_REQUEST['ee']=='Hod'){ $sqlE=mysql_query("select * from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where p.EmployeeID!=6 AND p.EmployeeID!=7 AND p.EmployeeID!=51 AND p.EmployeeID!=223 AND p.EmployeeID!=224 AND p.EmployeeID!=461 AND e.EmpStatus='A' AND e.CompanyId=".$_REQUEST['c']." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".date($FD.'-06-30')."' AND p.HOD_EmployeeID=".$res['HOD_EmployeeID']." AND p.Appraiser_EmployeeID!=0", $con); $rowNOE=mysql_num_rows($sqlE); $sH=mysql_query("select Fname,Sname,Lname from hrm_employee where EmployeeID=".$res['HOD_EmployeeID'], $con); $rH=mysql_fetch_assoc($sH); }	
...
if($_REQUEST['ee']=='Dept')
{  
  $sqlT=mysql_query("select ".$qry." from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where p.EmployeeID!=6 AND p.EmployeeID!=7 AND p.EmployeeID!=51 AND p.EmployeeID!=223 AND p.EmployeeID!=224 AND p.EmployeeID!=461 AND e.EmpStatus='A' AND e.CompanyId=".$_REQUEST['c']." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".$Y."-06-30' AND p.Appraiser_EmployeeID!=0", $con); 
}
elseif($_REQUEST['ee']=='Hod')
{ $sqlT=mysql_query("select ".$qry." from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where p.EmployeeID!=6 AND p.EmployeeID!=7 AND p.EmployeeID!=51 AND p.EmployeeID!=223 AND p.EmployeeID!=224 AND p.EmployeeID!=461 AND e.EmpStatus='A' AND e.CompanyId=".$_REQUEST['c']." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".$Y."-06-30' AND p.Appraiser_EmployeeID!=0", $con); 
}
 ...
 $sqlTE=mysql_query("select * from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where p.EmployeeID!=6 AND p.EmployeeID!=7 AND p.EmployeeID!=51 AND p.EmployeeID!=223 AND p.EmployeeID!=224 AND p.EmployeeID!=461 AND e.EmpStatus='A' AND e.CompanyId=".$_REQUEST['c']." AND g.DateJoining<='".date($FD.'-06-30')."' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID!=0", $con); $rowTNOE=mysql_num_rows($sqlTE); 
