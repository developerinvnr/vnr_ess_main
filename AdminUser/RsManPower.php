...
<Script>
function SelectYear(v){window.location='RsManPower.php?y='+v;}

function PrintManPower(y,c)
{ window.open("RsManPowerPrint.php?action=PrintManPower&y="+y+"&c="+c,"PrintForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=50,height=50");}

function ExportManPower(y,c)
{ window.open("RsManPowerExport.php?action=RsManPowerExport&y="+y+"&c="+c,"ExportForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20");}
...
<a href="#" onClick="PrintManPower(<?php echo $_REQUEST['y'].', '.$CompanyId; ?>)" style="font-size:12px;">Print</a>&nbsp;&nbsp;<a href="#" onClick="ExportManPower(<?php echo $_REQUEST['y'].', '.$CompanyId; ?>)" style="font-size:12px;">Export Excel</a></td>
   </tr>
   </table>
  </td>
 </tr>
