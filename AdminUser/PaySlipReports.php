...
<input type="checkbox" id="I32" onClick="F(32)" <?php if($_REQUEST['NPS']){echo 'checked';}?> /><input type="hidden" id="V32" value="<?php if($_REQUEST['BA']>0){echo 1;}else{echo 0;}?>"/>Bonus_Adjustment &nbsp;
