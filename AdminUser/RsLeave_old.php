	  ...
	  <td width="70%">
	    <table border="0">
		            <tr>
					   ...
					   <input type="hidden" name="Month" id="Month" value="<?php date("m"); ?>" />		   
...
<a href="#"><img src="images/select.png" border="0" alt="Edit" onClick="ReadLVReg(<?php echo $ResEmp['EmployeeID'].', '.date("Y"); ?>)"></a></td>
