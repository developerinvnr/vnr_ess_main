...
{ var D = document.getElementById("Department").value; var Y = document.getElementById("Year").value; var x = 'LeaveAttReports.php?m='+value+'&D='+D+'&Y='+Y; window.location=x;}

function SelectYear(value,m) 
{ var D = document.getElementById("Department").value;  var x = 'LeaveAttReports.php?m='+m+'&D='+D+'&Y='+value; window.location=x;}
								  
function SelectMonthDept(value)
{ var M = document.getElementById("Month").value; var Y = document.getElementById("Year").value;  var x = 'LeaveAttReports.php?m='+M+'&D='+value+'&Y='+Y; window.location=x; }*/
...
function FunClick()  
{
 ...
 else{ window.location='LeaveAttReports.php?m='+document.getElementById("Month").value+'&D='+document.getElementById("Department").value+'&Y='+document.getElementById("Year").value; }
}
...
<table border="0" style="margin-top:0px; width:100%; height:350px;">
 <tr>
  <td align="left" height="20" valign="top" colspan="3">
   <table border="0">
    <tr>
	  <td style="width:300px;" align="right">&nbsp;<font color="#2D002D" style='font-family:Times New Roman;' size="4">
...
<select style="font-size:12px; width:100px; height:20px; background-color:#DDFFBB; display:block;" onChange="SelectMonth(this.value)" id="Month" name="Month">
...
<thead>	   
 <tr style="background-color:#7a6189;">
  <td class="cell" style="width:30px;" rowspan="2"><b>SNo</b></td>		 
  <td class="cell" style="width:30px;" rowspan="2"><b>EC</b></td>
  <td class="cell" style="width:200px;" rowspan="2"><b>Name</b></td>
  <td class="cell" colspan="5"><b>Leave Opening</b></td>
  <?php if($_REQUEST['m']==1){ ?>
...
function Export(c,m,d,y)
{ window.open("LeaveAttReportsExport.php?action=RsAttExport&c="+c+"&m="+m+"&D="+d+"&Y="+y,"ExportForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20");}
</script><a href="#" onClick="Export(<?php echo $CompanyId.','.$_REQUEST['m'];?>,'<?php echo $_REQUEST['D']; ?>',<?php echo $_REQUEST['Y']; ?>)" style="font-size:14px; font-family:Times New Roman;color:#F3F775;">Export Excel</a>


</td>
<td class="cell" colspan="5"><b>Leave Closing</b></td>
  </tr>
  <tr style="background-color:#7a6189;">
  ...
  <?php if($_REQUEST['m']==1){ ?>
   ...
   <td class="cellOpe" align="center" width="35">FL</td> 
  <?php }  ?>
  <?php $id=$_REQUEST['m']; $Y=$_REQUEST['Y']; for($i=1; $i<=date("t",strtotime(date("Y-".$_REQUEST['m']."-d"))); $i++) { ?> 
...
<?php $sqlTotLeave=mysql_query("select * from ".$LeaveTable." where Year=".$Y." AND EmployeeID=".$ResEmp['EmployeeID']." AND Month=".$month."", $con); $resTotLeave=mysql_fetch_assoc($sqlTotLeave); ?>  
  <td class="cellOpe2" align="center" style="background-color:#C6FFC6;" width="35" valign="top"><?php if($resTotLeave['OpeningCL']!=''){ echo floatval($resTotLeave['OpeningCL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#C6FFC6;" width="35" valign="top"><?php if($resTotLeave['OpeningSL']!=''){ echo floatval($resTotLeave['OpeningSL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#C6FFC6;" width="35" valign="top"><?php if($resTotLeave['OpeningPL']!=''){ echo floatval($resTotLeave['OpeningPL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#C6FFC6;" width="35" valign="top"><?php if($resTotLeave['OpeningEL']!=''){ echo floatval($resTotLeave['OpeningEL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#C6FFC6;" width="35" valign="top"><?php if($resTotLeave['OpeningOL']!=''){ echo floatval($resTotLeave['OpeningOL']); } else {echo '&nbsp;';} ?></td>
	   
<?php if($_REQUEST['m']==1){ ?>
  <td class="cellOpe2" align="center" style="background-color:#FFBFFF;" width="35" valign="top"><?php if($resTotLeave['CreditedCL']!=''){ echo floatval($resTotLeave['CreditedCL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#FFBFFF;" width="35" valign="top"><?php if($resTotLeave['CreditedSL']!=''){ echo floatval($resTotLeave['CreditedSL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#FFBFFF;" width="35" valign="top"><?php if($resTotLeave['CreditedPL']!=''){ echo floatval($resTotLeave['CreditedPL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#FFBFFF;" width="35" valign="top"><?php if($resTotLeave['CreditedEL']!=''){ echo floatval($resTotLeave['CreditedEL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#FFBFFF;" width="35" valign="top"><?php if($resTotLeave['CreditedOL']!=''){ echo floatval($resTotLeave['CreditedOL']); } else {echo '&nbsp;';} ?></td>
<?php } ?>	   
...
<?php $SqlEmp2=mysql_query("SELECT * FROM ".$AttReport." WHERE EmployeeID =".$ResEmp['EmployeeID']." AND Year=".$Y." AND Month=".$month, $con); $ResEmp2=mysql_fetch_array($SqlEmp2); for($i=1; $i<=date("t",strtotime(date("Y-".$_REQUEST['m']."-d"))); $i++) { ?>
  ...
  <td class="cellOpe2" align="center" style="background-color:#C6FFC6;" width="35" valign="top"><?php if($resTotLeave['BalanceCL']!=''){ echo floatval($resTotLeave['BalanceCL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#C6FFC6;" width="35" valign="top"><?php if($resTotLeave['BalanceSL']!=''){ echo floatval($resTotLeave['BalanceSL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#C6FFC6;" width="35" valign="top"><?php if($resTotLeave['BalancePL']!=''){ echo floatval($resTotLeave['BalancePL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#C6FFC6;" width="35" valign="top"><?php if($resTotLeave['BalanceEL']!=''){ echo floatval($resTotLeave['BalanceEL']); } else {echo '&nbsp;';} ?></td>
  <td class="cellOpe2" align="center" style="background-color:#C6FFC6;" width="35" valign="top"><?php if($resTotLeave['BalanceOL']!=''){ echo floatval($resTotLeave['BalanceOL']); } else {echo '&nbsp;';} ?></td>
