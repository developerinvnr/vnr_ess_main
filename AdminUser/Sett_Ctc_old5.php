...
{ 
 ...
 <tr>
  <td class="td3">&nbsp;</td>
  <td class="td33" colspan="4">&nbsp;<b>Additional Benefit</b>
 </tr>
 <tr>
  ...
  <td class="td3" id="micB" style="text-align:center;"><input name="EmpAddBenifit_MediInsu" id="EmpAddBenifit_MediInsu" value="<?php echo $ResCtc['EmpAddBenifit_MediInsu_value']; ?>" class="td3" style="width:90%;text-align:right;" readonly/><input type="hidden" id="EAddBenifit_MI" value="<?php if($ResCtc['DepartmentId']==4 OR $ResCtc['DepartmentId']==6){echo $resDaily['MCSSP'];}else{echo $resDaily['MCS'];}//echo $ResCtc['EmpAddBenifit_MediInsu_value']; ?>" readonly/></td>
  <td class="td3" id="micB" style="text-align:center;"><input name="CtcEmpAddBenifit_MediInsu" id="CtcEmpAddBenifit_MediInsu" value="<?php echo $ResCtc['EmpAddBenifit_MediInsu_value']; ?>" class="td3" style="width:90%;text-align:right;" required/></td>
 </tr>
 <tr>
