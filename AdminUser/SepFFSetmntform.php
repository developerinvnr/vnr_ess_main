	  ...
	  <td>
	   <table border="1">
		...
		<tr bgcolor="#FFFFFF">
		  ...
		  <td style="width:20px;" bgcolor="#E0DBE3"></td>
		  <td class="Text" style="width:90px;" align="">&nbsp;<?php if($resSE['TerMination']=='Y'){ echo 'Termination';}else{echo 'Relieving'; } ?> : </td><td class="Text" style="width:140px;">&nbsp;<input name="HR_RelievingDate" id="HR_RelievingDate" maxlength="25" style="font-family:Georgia; font-size:12px;width:80px; height:20px; border-style:hidden;" value="<?php if($resSE['HR_RelievingDate']!='0000-00-00' AND $resSE['HR_RelievingDate']!='1970-01-01'){echo date("d-m-Y",strtotime($resSE['HR_RelievingDate']));} ?>" readonly><button id="f_btn2" class="CalenderButton" disabled></button>
   <script type="text/javascript">  var cal = Calendar.setup({ onSelect:  function(cal) { cal.hide()}, showTime: true }); 
