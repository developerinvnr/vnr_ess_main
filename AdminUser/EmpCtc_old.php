...
if($row>0)
{
  ...
  { $sqlUp= mysql_query("UPDATE hrm_employee_ctc SET INCENTIVE='".$_POST['EmpInctv']."', CHILD_EDU_ALL_Value='".$_POST['EmpChildEduAllow']."', MED_REM_Value='".$_POST['EmpMediReim']."', LTA_Value='".$_POST['EmpLeaveTraAllow']."', CONV_Value='".$_POST['EmpConAllow']."', TA_Value='".$_POST['TA']."', BAS='Y', BAS_Value=".$_POST['EmpBasic'].", STIPEND='N', STIPEND_Value=0.00, HRA_Value='".$_POST['EmpHRA']."', CAR_ALL_Value='".$_POST['CAR_ALL_Value']."', SPECIAL_ALL_Value='".$_POST['EmpSpeAllow']."',  NetMonthSalary_Value='".$_POST['EmpNetMonSalary']."', GrossSalary_PostAnualComponent_Value='".$_POST['GMS_PAC']."', EmpActPf='".$_POST['ActPFCheck']."', EmpComActPf='".$_POST['ActComPFCheck']."', EmpBSActPf='".$_POST['BSActPfCheck']."', BONUS_Value='".$_POST['EmpBonusExg']."', GRATUITY_Value='".$_POST['EmpEstiGratuity']."', Tot_GrossMonth='".$_POST['EmpGrossMonSalary']."', Tot_Gross_Annual='".$_POST['EmpAnnGrossSalary']."', PF_Employee_Contri_Value='".$_POST['EmpProviFund']."', PF_Employee_Contri_Annul='".$_POST['EmpEmployerPFContri']."', PF_Employer_Contri_Value='".$_POST['EmpProviFund']."', PF_Employer_Contri_Annul='".$_POST['EmpEmployerPFContri']."', Mediclaim_Policy='".$_POST['EmpMediPoliPremium']."', Tot_CTC='".$_POST['EmpTotalCtc']."', EmpAddBenifit_MediInsu_value='".$_POST['EmpAddBenifit_MediInsu']."',Car_Entitlement='".$_POST['Car_Entitlement']."', ESCI='".$_POST['EmpESCI']."', AnnualESCI='".$_POST['AnnualESCI']."', CtcCreatedBy=".$UserId.", CtcCreatedDate='".date("Y-m-d",strtotime($_POST['DateCTC']))."', CtcYearId=".$YearId.", SalChangeDate='".date("Y-m-d",strtotime($_POST['DateCTC']))."' WHERE Status='A' AND EmployeeID=".$EMPID, $con); }

  if($_POST['BasicStipend']=='S')
  { $sqlUp= mysql_query("UPDATE hrm_employee_ctc SET INCENTIVE='".$_POST['EmpInctv']."', CHILD_EDU_ALL_Value='".$_POST['EmpChildEduAllow']."', MED_REM_Value='".$_POST['EmpMediReim']."', LTA_Value='".$_POST['EmpLeaveTraAllow']."', CONV_Value='".$_POST['EmpConAllow']."', TA_Value='".$_POST['TA']."', BAS='N', BAS_Value=0.00, STIPEND='Y', STIPEND_Value=".$_POST['EmpBasic'].", HRA_Value='".$_POST['EmpHRA']."', CAR_ALL_Value='".$_POST['CAR_ALL_Value']."', SPECIAL_ALL_Value='".$_POST['EmpSpeAllow']."',  NetMonthSalary_Value='".$_POST['EmpNetMonSalary']."', GrossSalary_PostAnualComponent_Value='".$_POST['GMS_PAC']."', EmpActPf='".$_POST['ActPFCheck']."', EmpComActPf='".$_POST['ActComPFCheck']."', EmpBSActPf='".$_POST['BSActPfCheck']."', BONUS_Value='".$_POST['EmpBonusExg']."', GRATUITY_Value='".$_POST['EmpEstiGratuity']."', Tot_GrossMonth='".$_POST['EmpGrossMonSalary']."', Tot_Gross_Annual='".$_POST['EmpAnnGrossSalary']."', PF_Employee_Contri_Value='".$_POST['EmpProviFund']."', PF_Employee_Contri_Annul='".$_POST['EmpEmployerPFContri']."', PF_Employer_Contri_Value='".$_POST['EmpProviFund']."', PF_Employer_Contri_Annul='".$_POST['EmpEmployerPFContri']."', Mediclaim_Policy='".$_POST['EmpMediPoliPremium']."', Tot_CTC='".$_POST['EmpTotalCtc']."', EmpAddBenifit_MediInsu_value='".$_POST['EmpAddBenifit_MediInsu']."',Car_Entitlement='".$_POST['Car_Entitlement']."', ESCI='".$_POST['EmpESCI']."', AnnualESCI='".$_POST['AnnualESCI']."', CtcCreatedBy=".$UserId.", CtcCreatedDate='".date("Y-m-d",strtotime($_POST['DateCTC']))."', CtcYearId=".$YearId.", SalChangeDate='".date("Y-m-d",strtotime($_POST['DateCTC']))."' WHERE Status='A' AND EmployeeID=".$EMPID, $con); } 
}
if($row==0)
{ 
  ...
  if($row2==0)
  {
   ...
   if($_POST['EmpInctv']==''){$_POST['EmpInctv']='N';}
   if($_POST['BasicStipend']=='B')
   { $sqlUp= mysql_query("insert into hrm_employee_ctc(EmployeeID, EC, INCENTIVE, CHILD_EDU_ALL_Value, MED_REM_Value, LTA_Value, CONV_Value, TA_Value, BAS, BAS_Value, STIPEND, STIPEND_Value, HRA_Value, CAR_ALL_Value, SPECIAL_ALL_Value, NetMonthSalary_Value, GrossSalary_PostAnualComponent_Value, EmpActPf, EmpComActPf, EmpBSActPf, BONUS_Value, GRATUITY_Value, Tot_GrossMonth, Tot_Gross_Annual, PF_Employee_Contri_Value, PF_Employee_Contri_Annul, PF_Employer_Contri_Value, PF_Employer_Contri_Annul, Mediclaim_Policy, Tot_CTC, EmpAddBenifit_MediInsu_value, Car_Entitlement, ESCI, AnnualESCI, CtcCreatedBy, CtcCreatedDate, CtcYearId, SalChangeDate) values(".$EMPID.", ".$_POST['EmpCode'].", '".$_POST['EmpInctv']."', '".$_POST['EmpChildEduAllow']."', '".$_POST['EmpMediReim']."', '".$_POST['EmpLeaveTraAllow']."', '".$_POST['EmpConAllow']."', '".$_POST['TA']."', 'Y', ".$_POST['EmpBasic'].", 'N', 0.00, '".$_POST['EmpHRA']."', '".$_POST['CAR_ALL_Value']."', '".$_POST['EmpSpeAllow']."',  '".$_POST['EmpNetMonSalary']."', '".$_POST['GMS_PAC']."', '".$_POST['ActPFCheck']."', '".$_POST['ActComPFCheck']."', '".$_POST['BSActPfCheck']."', '".$_POST['EmpBonusExg']."', '".$_POST['EmpEstiGratuity']."', '".$_POST['EmpGrossMonSalary']."', '".$_POST['EmpAnnGrossSalary']."', '".$_POST['EmpProviFund']."', '".$_POST['EmpEmployerPFContri']."', '".$_POST['EmpProviFund']."', '".$_POST['EmpEmployerPFContri']."', '".$_POST['EmpMediPoliPremium']."', '".$_POST['EmpTotalCtc']."', '".$_POST['EmpAddBenifit_MediInsu']."','".$_POST['Car_Entitlement']."', '".$_POST['EmpESCI']."', '".$_POST['AnnualESCI']."', ".$UserId.", '".date("Y-m-d",strtotime($_POST['DateCTC']))."', ".$YearId.", '".date("Y-m-d",strtotime($_POST['DateCTC']))."')", $con); }

  if($_POST['BasicStipend']=='S')
  { $sqlUp= mysql_query("insert into hrm_employee_ctc(EmployeeID, EC, INCENTIVE, CHILD_EDU_ALL_Value, MED_REM_Value, LTA_Value, CONV_Value, TA_Value, BAS, BAS_Value, STIPEND, STIPEND_Value, HRA_Value, CAR_ALL_Value, SPECIAL_ALL_Value, NetMonthSalary_Value, GrossSalary_PostAnualComponent_Value, EmpActPf, EmpComActPf, EmpBSActPf, BONUS_Value, GRATUITY_Value, Tot_GrossMonth, Tot_Gross_Annual, PF_Employee_Contri_Value, PF_Employee_Contri_Annul, PF_Employer_Contri_Value, PF_Employer_Contri_Annul, Mediclaim_Policy, Tot_CTC, EmpAddBenifit_MediInsu_value, Car_Entitlement, ESCI, AnnualESCI, CtcCreatedBy, CtcCreatedDate, CtcYearId, SalChangeDate) values(".$EMPID.", ".$_POST['EmpCode'].", '".$_POST['EmpInctv']."', '".$_POST['EmpChildEduAllow']."', '".$_POST['EmpMediReim']."', '".$_POST['EmpLeaveTraAllow']."', '".$_POST['EmpConAllow']."', '".$_POST['TA']."', 'N', 0.00, 'Y', ".$_POST['EmpBasic'].", '".$_POST['EmpHRA']."', '".$_POST['CAR_ALL_Value']."', '".$_POST['EmpSpeAllow']."',  '".$_POST['EmpNetMonSalary']."', '".$_POST['GMS_PAC']."', '".$_POST['ActPFCheck']."', '".$_POST['ActComPFCheck']."', '".$_POST['BSActPfCheck']."', '".$_POST['EmpBonusExg']."', '".$_POST['EmpEstiGratuity']."', '".$_POST['EmpGrossMonSalary']."', '".$_POST['EmpAnnGrossSalary']."', '".$_POST['EmpProviFund']."', '".$_POST['EmpEmployerPFContri']."', '".$_POST['EmpProviFund']."', '".$_POST['EmpEmployerPFContri']."', '".$_POST['EmpMediPoliPremium']."', '".$_POST['EmpTotalCtc']."', '".$_POST['EmpAddBenifit_MediInsu']."','".$_POST['Car_Entitlement']."', '".$_POST['EmpESCI']."', '".$_POST['AnnualESCI']."', ".$UserId.", '".date("Y-m-d",strtotime($_POST['DateCTC']))."', ".$YearId.", '".date("Y-m-d",strtotime($_POST['DateCTC']))."')", $con); }
  }
}
...
{ 
  ...
  $sqlMax = mysql_query("SELECT TotalProp_GSPM FROM hrm_pms_appraisal_history where SalaryChange_Date='".$resHC['SalaryChD']."' AND EmpCode=".$_POST['EmpCode']." AND CompanyId=".$CompanyId, $con); $resMax = mysql_fetch_assoc($sqlMax);
...
var Cal_TotBasHraCon = document.getElementById("TotBasHraCon").value=Math.round((Cal_EmpBasic+Cal_EmpHRA+Cal_EmpConAllow+VTA)*100)/100;
...
<?php
$SqlCtc = mysql_query("SELECT hrm_employee.*,hrm_employee_ctc.*, DepartmentId, GradeId, DesigId FROM hrm_employee INNER JOIN hrm_employee_ctc ON hrm_employee.EmployeeID=hrm_employee_ctc.EmployeeID INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID WHERE hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_ctc.Status='A' AND hrm_employee.EmployeeID=".$EMPID, $con) or die(mysql_error());  $ResCtc=mysql_fetch_assoc($SqlCtc); 
 ...
 <td colspan="2">
  <table>
   <tr>
    ...
    <td class="All_150" valign="top">Allow Incentive&nbsp;:&nbsp;<input type="checkbox" id="EmpInctv" name="EmpInctv" value="" <?php if($ResCtc['INCENTIVE']=='Y') echo 'checked'; ?> disabled onClick="CheckIncentive()"/> </td>
	...
	<br>
	PF Without Adjustment&nbsp;:&nbsp;<input type="checkbox" id="EmpComActPf" name="EmpComActPf" value="" <?php if($ResCtc['EmpComActPf']=='Y') echo 'checked'; ?> disabled onClick="CheckEmpComActPf()"/><input type="hidden" id="ActComPFCheck" name="ActComPFCheck" value="<?php echo $ResCtc['EmpComActPf']; ?>" />
	<br>
...
<tr><td align="left" class="All_10">&nbsp;<input type="checkbox" name="CheckBonus" id="CheckBonus" checked onClick="ClickCheckBonus()" disabled/></td> 
...
<tr><td align="left" class="All_10">&nbsp;</td>
    <td align="left" style="width:650px;font-size:11px; height:18px;" colspan="3">&nbsp;<b>Additional Benifit</b></td>
</tr>
<script>
function FunMIC(d)
{ 
  if(d==4 || d==6){var vale=document.getElementById("MCSSP").value; }else{var vale=document.getElementById("MCS").value;}
...
<tr><td align="left" class="All_10">&nbsp;<input type="checkbox" name="CheckMIC" id="CheckMIC" onClick="FunMIC(<?=$ResCtc['DepartmentId'];?>)" <?php if($ResCtc['EmpAddBenifit_MediInsu_value']>0){echo 'checked';} ?> disabled/></td>
  <td align="left" class="All_300" id="micA">&nbsp;Mediclaim insurance coverage for Employee, Spouse 2 children :
  ...
  <td align="left" class="All_180" id="micB">&nbsp;Rs. &nbsp;<input name="EmpAddBenifit_MediInsu" id="EmpAddBenifit_MediInsu" value="<?php echo $ResCtc['EmpAddBenifit_MediInsu_value']; ?>" class="All_100" readonly/><input type="hidden" id="EAddBenifit_MI" value="<?php echo $ResCtc['EmpAddBenifit_MediInsu_value']; ?>" readonly/></td></tr>
