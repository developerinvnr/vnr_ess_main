...
function SelectDept(v){ window.location='ReportsExp.php?action=DeptExp&value='+v;}
...
{ var ComId=document.getElementById("ComId").value; var YId=document.getElementById("YId").value; var DeptValue=document.getElementById("DeptValue").value;  
  window.open("PrintExpReport.php?action=DeptExp&value="+v+"&c="+ComId+"&y="+YId+"&value="+DeptValue,"PrintForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=850,height=650");}
</Script>  
</head>
<body class="body">
...
<?php //---------------------------------------Display Record----------------------------------------------------------------- ?>
<?php if($_REQUEST['action']=='DeptExp') { ?>
    <tr>
<?php if($_REQUEST['value']!='All') { $sqlA=mysql_query("select DepartmentName from hrm_department where DepartmentId=".$_REQUEST['value'], $con); $resA=mysql_fetch_assoc($sqlA); } ?>	
	 <td valign="top" style=" width:700px;font-size:14px; color:#005BB7; font-family:Georgia; font-weight:bold;">&nbsp;Employee Experience Details :
...
<tr>
 ...
 <tr bgcolor="#7a6189">
	<td align="center" style="color:#FFFFFF;" class="All_200"><b>Company</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_150"><b>Designation</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_70"><b>From</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_70"><b>To</b></td>
	<td align="center" style="color:#FFFFFF;" class="All_80"><b>Duration</b></td>	
	<td align="center" style="color:#FFFFFF;" class="All_150"><b>Remark</b></td>
 </tr>
...
<?php $sqlEx=mysql_query("select * from hrm_employee_experience where EmployeeID=".$res['EmployeeID']." order by ExpFromDate ASC", $con); 
      while($resEx=mysql_fetch_assoc($sqlEx)) { ?>	
<tr bgcolor="#FFFFFF">
<td align="" style="" class="All_200"><?php echo $resEx['ExpComName']; ?></td>
<td align="" style="" class="All_150"><?php echo $resEx['ExpDesignation']; ?></td>	
<td align="center" style="" class="All_70"><?php if($resEx['ExpFromDate']=='0000-00-00' OR $resEx['ExpFromDate']=='1970-01-01') { echo ''; }else {echo date("d-M-y",strtotime($resEx['ExpFromDate'])); } ?></td>	
<td align="center" style="" class="All_70"><?php if($resEx['ExpToDate']=='0000-00-00' OR $resEx['ExpToDate']=='1970-01-01') { echo ''; }else {echo date("d-M-y",strtotime($resEx['ExpToDate'])); }?></td>
<td align="center" style="" class="All_80"><?php if($resEx['ExpTotalYear']==0){echo '';}else { echo $resEx['ExpTotalYear']; } ?></td>	
<td align="" style="" class="All_150"><?php echo $resEx['ExpRemark'];?></td>
</tr>
	 <?php }$Sno++; } ?> 
   </table>
 </td>
