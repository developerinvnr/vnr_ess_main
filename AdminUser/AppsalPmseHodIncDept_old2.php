...
{ var ComId=document.getElementById("ComId").value; var YId=document.getElementById("YId").value;   
  window.open("ExportPmsIncOalWHD.php?action=IncoalExport&value=v&c="+ComId+"&YI="+yi+"&ee="+ee,"ExportForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20");}  
...
<?php 
if($_REQUEST['YI']<=7)
{ $qry='SUM(EmpCurrGrossPM) as E_GROSS, SUM(EmpCurrIncentivePM) as EINC_GROSS, SUM(Hod_ProIncSalary) as H_IS, SUM(Hod_ProCorrSalary) as H_SC, SUM(Hod_Incentive) as H_Inc, DepartmentId, HOD_EmployeeID'; }
else
{ $qry='SUM(EmpCurrCtc) as E_GROSS, SUM(Hod_ProIncCTC) as H_IS, SUM(Hod_ProCorrCTC) as H_SC, DepartmentId, HOD_EmployeeID';} 
?>			 
...
<?php if($_REQUEST['ee']=='Hod'){?><td class="th" style="width:200px;">HOD</td><?php } ?>
		...
		<td class="th" style="width:100px;">PREV. <?php if($_REQUEST['YI']<=7){echo 'GROSS';}else{echo 'CTC';}?></td>
...
<?php if($_REQUEST['ee']=='Dept'){ $sqlE=mysql_query("select * from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".date($FD.'-06-30')."' AND g.DepartmentId=".$res['DepartmentId']." AND p.Appraiser_EmployeeID!=0", $con); $rowNOE=mysql_num_rows($sqlE); $sD=mysql_query("select DepartmentName from hrm_department where DepartmentId=".$res['DepartmentId'], $con); $rD=mysql_fetch_assoc($sD); } ?>
<?php if($_REQUEST['ee']=='Hod'){ $sqlE=mysql_query("select * from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".date($FD.'-06-30')."' AND p.HOD_EmployeeID=".$res['HOD_EmployeeID']." AND p.Appraiser_EmployeeID!=0", $con); $rowNOE=mysql_num_rows($sqlE); $sH=mysql_query("select Fname,Sname,Lname from hrm_employee where EmployeeID=".$res['HOD_EmployeeID'], $con); $rH=mysql_fetch_assoc($sH); } ?>			
...
if($_REQUEST['ee']=='Dept')
{  
  $sqlT=mysql_query("select ".$qry." from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".$YYear."-06-30' AND p.Appraiser_EmployeeID!=0", $con); 
}
elseif($_REQUEST['ee']=='Hod')
{ $sqlT=mysql_query("select ".$qry." from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".$YYear."-06-30' AND p.Appraiser_EmployeeID!=0", $con); 
}
...
<?php $sqlTE=mysql_query("select * from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND g.DateJoining<='".date($FD.'-06-30')."' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID!=0", $con); $rowTNOE=mysql_num_rows($sqlTE); ?>
...
if($_REQUEST['ee']=='Dept')
{  
  $sql=mysql_query("select ".$qry." from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where p.EmployeeID!=6 AND p.EmployeeID!=7 AND p.EmployeeID!=51 AND p.EmployeeID!=223 AND p.EmployeeID!=224 AND p.EmployeeID!=461 AND p.EmployeeID!=52 AND p.EmployeeID!=89 AND e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".$YYear."-06-30' AND p.Appraiser_EmployeeID!=0 group by DepartmentId", $con); 
}
elseif($_REQUEST['ee']=='Hod')
{ $sql=mysql_query("select ".$qry." from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where p.EmployeeID!=6 AND p.EmployeeID!=7 AND p.EmployeeID!=51 AND p.EmployeeID!=223 AND p.EmployeeID!=224 AND p.EmployeeID!=461 AND p.EmployeeID!=52 AND p.EmployeeID!=89 AND e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DateJoining<='".$YYear."-06-30' AND p.Appraiser_EmployeeID!=0 group by HOD_EmployeeID", $con); 
}
