...
{   $Uid=$_POST['Uid'];
    $SqlUpdateMaster = mysql_query("UPDATE hrm_user_menu SET master='".$_POST['MasterCheck']."', processing='".$_POST['ProCheck']."', report='".$_POST['ReportCheck']."', utility='".$_POST['UtilCheck']."', query='".$_POST['QueryCheck']."', pms='".$_POST['PMSCheck']."', recruitment='".$_POST['RecruitCheck']."', separation='".$_POST['SeparCheck']."', tds='".$_POST['TDSCheck']."' WHERE AXAUESRUser_Id=".$_POST['Uid'], $con) or die(mysql_error());  if($SqlUpdateMaster){ $msg = "Menu data has been updated successfully..."; }}


if(isset($_POST['SaveEmpMaster']))
{   $Uid=$_POST['Uid'];
    $SqlUpMaster = mysql_query("UPDATE hrm_user_menu_master SET mas_gene='".$_POST['gene']."', mas_phot='".$_POST['phot']."', mas_pers='".$_POST['pers']."', mas_cont='".$_POST['cont']."', mas_lang='".$_POST['lang']."', mas_qual='".$_POST['qual']."', mas_expe='".$_POST['expe']."', mas_fami='".$_POST['fami']."', mas_leav='".$_POST['leav']."', mas_elig='".$_POST['elig']."', mas_ctc='".$_POST['ctc']."', mas_chec='".$_POST['chec']."', mas_asse='".$_POST['asse']."', mas_trai='".$_POST['trai']."', mas_conf='".$_POST['conf']."' WHERE AXAUESRUser_Id=".$_POST['Uid'], $con) or die(mysql_error());  if($SqlUpMaster){ $msg = "Menu data has been updated successfully..."; }}	


if(isset($_POST['SubMenuMaster']))
{   $Uid=$_POST['Uid'];
    $SqlUpdateMaster = mysql_query("UPDATE hrm_user_submenu SET Mas_ComMaster_Basic='".$_POST['Basic']."', Mas_ComMaster_Statutory='".$_POST['Statutory']."',	Mas_ComMaster_Vendors='".$_POST['Vendors']."', Mas_DetailMand_Dept='".$_POST['Dept']."', Mas_DetailMand_HQ='".$_POST['HQ']."', Mas_DetailMand_Grade='".$_POST['Grade']."',  Mas_DetailMand_Desig='".$_POST['Desig']."', Mas_DetailMand_DeptGradeDesig='".$_POST['DeptGradeDesig']."', Mas_DetailMand_DesigGrade='".$_POST['DesigGrade']."', Mas_DetailMand_CityClass='".$_POST['CityClass']."',	Mas_DetailMand_CostCenter='".$_POST['CostCenter']."', Mas_DetailMice_Category='".$_POST['Category']."', Mas_DetailMice_Section='".$_POST['Section']."', Mas_DetailMice_CounStatCity='".$_POST['CounStatCity']."', Mas_DetailElig_LodEntitle='".$_POST['LodEntitle']."', Mas_DetailElig_TravelEntitle='".$_POST['TravelEntitle']."', Mas_DetailElig_TravelElig='".$_POST['TravelElig']."', Mas_DetailElig_DailyAllow='".$_POST['DailyAllow']."', Mas_PayCompo='".$_POST['PayCompo']."', Mas_Leave='".$_POST['Leave']."', Mas_Holiday='".$_POST['Holiday']."', Mas_EmpMasters='".$_POST['EmpMasters']."', Mas_SalaryMasters='".$_POST['SalaryMasters']."', Mas_Thought='".$_POST['Thought']."', Mas_NewCompany='".$_POST['NewCompany']."', Mas_Restructuring='".$_POST['Restructuring']."' WHERE AXAUESRUser_Id=".$_POST['Uid'], $con) or die(mysql_error());  
	if($SqlUpdateMaster){ $msg = "Master SubMenu has been updated successfully..."; }}
	
	
if(isset($_POST['SubMenuProcessing']))
{   $Uid=$_POST['Uid'];
    $SqlUpdateProcessing = mysql_query("UPDATE hrm_user_submenu SET Pro_AddAttLeave='".$_POST['AddAttLeave']."',  Pro_ApprovedLeave='".$_POST['ApprovedLeave']."', Pro_PendingLeave='".$_POST['PendingLeave']."', Pro_AttReport='".$_POST['AttReport']."', Pro_PaySlipReport='".$_POST['PaySlipReport']."', Pro_Training='".$_POST['Training']."', Pro_Conference='".$_POST['Conference']."', Pro_Monthly_tranDay='".$_POST['tranDay']."', Pro_Monthly_tranLumpsum='".$_POST['tranLumpsum']."', Pro_Monthly_Processing='".$_POST['Processing']."', Pro_Monthly_ArrearsCalcu='".$_POST['ArrearsCalcu']."', Pro_Monthly_CloseMonth='".$_POST['CloseMonth']."' WHERE AXAUESRUser_Id=".$_POST['Uid'], $con) or die(mysql_error());  
	if($SqlUpdateProcessing){ $msg = "Processing SubMenu has been updated successfully..."; }}


if(isset($_POST['SubMenuUtility']))
{   $Uid=$_POST['Uid'];
    $SqlUpdateUtility = mysql_query("UPDATE hrm_user_submenu SET Util_MasterAdmin='".$_POST['MasterAdmin']."', Util_UserRight='".$_POST['UserRight']."', Util_ChangePwd='".$_POST['ChangePwd']."', Util_UpdateNotification='".$_POST['UpdateNotification']."', Util_ImportEmpIncrement='".$_POST['ImportEmpIncrement']."', Util_SendMail_PaySlip='".$_POST['PaySlip']."', Util_SendMail_ReimbPayslip='".$_POST['ReimbPayslip']."', Util_CustomizePayslip='".$_POST['CustomizePayslip']."', Util_AssignEmpState='".$_POST['AssignEmpState']."', Util_AssignEmpPaySlip='".$_POST['AssignEmpPaySlip']."', Util_ReportingLeaveQuery='".$_POST['ReportingLeaveQuery']."', Util_ReportingPmsKra='".$_POST['ReportingPmsKra']."', Util_Backup='".$_POST['Backup']."', Util_EmpProfileStatus='".$_POST['EmpProfileStatus']."', Util_ConfLetter='".$_POST['ConfLetter']."' WHERE AXAUESRUser_Id=".$_POST['Uid'], $con) or die(mysql_error());
	if($SqlUpdateUtility){ $msg = "Utility SubMenu has been updated successfully..."; }}  
	
	
if(isset($_POST['SubMenuQuery']))
{   $Uid=$_POST['Uid'];
    $SqlUpdateUtility = mysql_query("UPDATE hrm_user_submenu SET Query_Sub='".$_POST['QSub']."', Query_Owner='".$_POST['QOwner']."', Query_Assign='".$_POST['QAssign']."', Query_Pending='".$_POST['QPending']."', Query_Answer='".$_POST['QAnswer']."', Query_Closed='".$_POST['QClosed']."', Query_Report='".$_POST['QReport']."', Query_Log='".$_POST['QLog']."', Query_MailTo='".$_POST['QMailTo']."' WHERE AXAUESRUser_Id=".$_POST['Uid'], $con) or die(mysql_error());
	if($SqlUpdateUtility){ $msg = "Query SubMenu has been updated successfully..."; }}	


if(isset($_POST['SubMenuPMS']))
{   $Uid=$_POST['Uid'];
    $SqlUpdatePMS = mysql_query("UPDATE hrm_user_submenu SET PMS_KRA='".$_POST['KRA']."', PMS_DeptKRA='".$_POST['DeptKRA']."', PMS_EditKRA='".$_POST['EditKRA']."', PMS_WeightageForKRA='".$_POST['WeightageForKRA']."', PMS_FormB='".$_POST['FormB']."', PMS_GradeFormB='".$_POST['GradeFormB']."', PMS_FeedBack='".$_POST['FeedBack']."', PMS_SelectAppRev='".$_POST['SelectAppRev']."', PMS_AssAppReviewer='".$_POST['AssAppReviewer']."', PMS_StatusReportDept='".$_POST['StatusReportDept']."', PMS_KRAStatus='".$_POST['KRAStatus']."', PMS_EditHR='".$_POST['EditHR']."', PMS_RatingGraph='".$_POST['RatingGraph']."', PMS_Rating='".$_POST['Rating']."', PMS_NormalRatDistri='".$_POST['NormalRatDistri']."', PMS_IncDistri='".$_POST['IncDistri']."', PMS_Percentage='".$_POST['Percentage']."',  PMS_Schedule='".$_POST['Schedule']."', PMS_OpenCloseMenu='".$_POST['OpenCloseMenu']."', PMS_Report='".$_POST['Report']."' WHERE AXAUESRUser_Id=".$_POST['Uid'], $con) or die(mysql_error());  
