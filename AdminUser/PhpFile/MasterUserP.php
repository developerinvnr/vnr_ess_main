...
{
 $SqlNewInseartUser = mysql_query("INSERT INTO hrm_user(CompanyId,User_name,User_pass,User_MrMrsMiss,User_FirstName,User_SecondName,User_LastName,User_Position,User_type,User_status,User_Permission,Comment,CreatedBy,CreatedDate,YearId) VALUES(".$CompanyId.",'".$_POST['nUname']."','".$_POST['nUname']."','".$_POST['nMrMrsMiss']."','".$_POST['nFname']."','".$_POST['nSname']."','".$_POST['nLname']."','".$_POST['nPosition']."','".$_POST['nUtype']."','".$_POST['nUstatus']."','".$_POST['Uper']."','".$_POST['nComment']."', '".$UserId."','".date("Y-m-d")."','".$YearId."')", $con) or die(mysql_error()); 
