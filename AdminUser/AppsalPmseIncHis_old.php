...
<?php $sqlE=mysql_query("select Fname, Sname, Lname from hrm_employee where EmpCode=".$res['EmpCode']." AND CompanyId=".$CompanyId, $con); $resE=mysql_fetch_assoc($sqlE); ?>			
		...
		<td class="tdr"><?php echo $res['Salary_Basic']; ?></td>
		<td class="tdr"><?php echo $res['Salary_Stipend']; ?></td>
		<td class="tdr"><?php echo $res['Salary_HRA']; ?></td>
		<td class="tdr"><?php echo $res['Salary_CA']; ?></td> 
		<td class="tdr"><?php echo $res['Salary_VA']; ?></td>
		<td class="tdr"><?php echo $res['Salary_SA']; ?></td>
		<td class="tdr"><?php echo $res['Salary_PI']; ?></td> 
		<td class="tdr"><?php echo $res['Industry_Bench_Markinge']; ?></td>
		<td class="tdr"><?php echo $res['Previous_GrossSalaryPM']; ?></td>
		<td class="tdr"><?php echo $res['Current_GrossSalaryPM']; ?></td>
		<td class="tdr"><?php echo $res['Proposed_GrossSalaryPM']; ?></td>		
		<td class="tdr"><?php echo $res['Prop_PeInc_GSPM']; ?></td>
		<td class="tdr"><?php echo $res['PropSalary_Correction']; ?></td>		
        <td class="tdr"><?php echo $res['TotalProp_GSPM']; ?></td>
		<td class="tdc">
...
<?php //echo $res['TotalProp_PerInc_GSPM']; ?>
		...
		<td class="tdr"><?php echo $res['Incentive']; ?></td>
		<td class="tdr"><?php echo $res['BonusAnnual_September']; ?></td>
...
<?php if($resPms['Hod_EmpDesignation']){ $sqlD2=mysql_query("select DesigName from hrm_designation where DesigId=".$resPms['Hod_EmpDesignation'], $con); $resD2=mysql_fetch_assoc($sqlD2); } ?>		
		...
		<td class="tdc"><?php echo '01-Jan-'.$Y2; ?></td>	
		<td class="tdl">&nbsp;</td>
		<td class="tdl">&nbsp;</td>
		<td class="tdl">&nbsp;</td>
		<td class="tdl">&nbsp;</td> 
	...
	<tr> 
	 ...
	 <tr><td colspan="29" style=" background-color:#CAC046;">&nbsp;</td></tr>
	<?php } ?>   	
