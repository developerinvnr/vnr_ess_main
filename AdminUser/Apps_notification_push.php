...
if($id == 1)
{
 ...
 $sEmp=mysql_query("select tokenid from hrm_employee e inner join hrm_employee_general g on e.EmployeeID=g.EmployeeID where g.DepartmentId=9 AND e.EmpStatus='A'",$con);  
 //AND (e.EmployeeID=169 OR e.EmployeeID=1305)
