<style>
.tdd1{width:550px;font-size:14px;height:14px;text-align:left;}
.tdd2{width:205px;font-size:14px;text-align:left;}
</style>
...
<td style="width:5px;" align="center"></td>
 ...
 <tr>
  <td class="tdd1"><b>*</b>&nbsp;&nbsp;<?php if($ResE['DepartmentId']==2){echo 'Fooding Expense (For outside HQ travel with night halt)'; }else{ echo 'DA Outside HQ'; } ?> :</td>
...
<?php if($ResEligEmp['Travel_TwoWeeKM']!='' OR $ResEligEmp['LessKm']=='Y' OR ($ResEligEmp['Travel_FourWeeKM']!='' AND $ResEligEmp['Travel_FourWeeKM']!=' ' AND $ResEligEmp['Travel_FourWeeKM']!='0' AND $ResEligEmp['Travel_FourWeeKM']!='NA' AND $ResEligEmp['Travel_FourWeeKM']!=' NA' AND $ResEligEmp['Travel_FourWeeKM']!='NA Per KM' AND $ResEligEmp['Travel_FourWeeKM']!=' NA Per KM' AND $ResEligEmp['Travel_FourWeeKM']!='NA ' AND $ResEligEmp['Travel_FourWeeKM']!='NA  ' AND $ResEligEmp['Travel_FourWeeKM']!='  NA' AND $ResEligEmp['Travel_FourWeeKM']!=' NA ')){ //22?>
 ...
 <tr>
  <td class="tdd1">&nbsp;&nbsp; 4 Wheeler (<?php if($ResE['DepartmentId']==2 &&($ResEligEmp['VehiclePolicy']>0)){echo 'As per R&D vehicle policy';}else{?><?php if($ResEligEmp['Travel_FourWeeKM']!='' AND $ResEligEmp['Travel_FourWeeKM']!=' ' AND $ResEligEmp['Travel_FourWeeKM']!='0' AND $ResEligEmp['Travel_FourWeeKM']!='NA' AND $ResEligEmp['Travel_FourWeeKM']!=' NA' AND $ResEligEmp['Travel_FourWeeKM']!='NA Per KM' AND $ResEligEmp['Travel_FourWeeKM']!=' NA Per KM' AND $ResEligEmp['Travel_FourWeeKM']!='NA ' AND $ResEligEmp['Travel_FourWeeKM']!='NA  ' AND $ResEligEmp['Travel_FourWeeKM']!='  NA' AND $ResEligEmp['Travel_FourWeeKM']!=' NA '){echo '<b>Rs&nbsp;'.$ResEligEmp['Travel_FourWeeKM'].'/KM';?> 
...
<?php $SeG=mysql_query("select HR_GradeId,HR_CurrGradeId from hrm_employee_pms where EmpPmsId=".$PmsId,$con); 
