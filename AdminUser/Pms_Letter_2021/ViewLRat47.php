We are pleased to inform you that your performance for the year <b><?php echo $AssYear; ?></b> has been rated as <b>"<?php echo $ResR['RatingName']; ?>"</b> with "<b>Rating-4.7</b>".<?php /*?><b>"<?php echo $ResR['RatingName']; ?>"</b> with "<b>Rating-4.7</b>".<?php */?> <p>   
