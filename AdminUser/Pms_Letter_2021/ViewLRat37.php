We are pleased to inform you that your performance for the assessment period <b><?php echo $Ass2Year; ?></b> has been rated as <b>"<?php echo $ResR['RatingName']; ?>"</b> with "<b>Rating-3.7</b>".<?php /*?><b>"<?php echo $ResR['RatingName']; ?>"</b> with "<b>Rating-3.7</b>".<?php */?> <p>   
		   ...
		   <?php if(($_REQUEST['E']==108 OR $_REQUEST['E']==179) AND $_REQUEST['Y']==10){ ?>
		   
		   <?php if($_REQUEST['E']==108 AND $_REQUEST['Y']==10){ ?>
		   Based on your performance, there is an increase in your CTC by <b>Rs. 200679/-</b>.<p> 
		   We are glad to announce that you are eligible for the first milestone of the Utkrisht Reward being given for your consistent performance towards company’s research programs. You are being rewarded by <b>Rs. 1180460/-</b>.  <p>                    
          Your Overall increment is therefore <b>Rs. 1381139/-</b><p>
		   <?php } ?>
		   
		   <?php if($_REQUEST['E']==179 AND $_REQUEST['Y']==10){ ?>
		   Based on your performance, there is an increase in your CTC by <b>Rs. 135901/-</b><p>
		   We are glad to announce that you are eligible for the first milestone of the Utkrisht Reward being given for your consistent performance towards company’s research programs. You are being rewarded by <b>Rs. 849293/-</b>.<p>                      
           Your Overall increment is therefore <b>Rs. 985194/-</b><p>
		   <?php } ?>
