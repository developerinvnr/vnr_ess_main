...
{ 
 ...
 if(VGrossSalary<=42000 && Cal_VEmpBasic<=21000){ var BonusM = Math.round(((BWageId*20)/100)*100)/100; var BonusY = Math.round((BonusM*12)*100)/100; }
 else { var BonusM=0; var BonusY=0; }
 
 var BonusM = document.getElementById("Bonus_Month").value=BonusM;
     
  var Cal_EmpHRA = document.getElementById("EmpHRA").value=Math.round((((Cal_VEmpBasic*40)/100)*100)/100,0);
  var Cal_EmpConAllow = document.getElementById("EmpConAllow").value=Math.round((VConvance)*100)/100;
  var CAR_ALL = parseFloat(document.getElementById("CAR_ALL_Value").value);
  var Cal_TotBasHraCon = document.getElementById("TotBasHraCon").value=Math.round((Cal_VEmpBasic+Cal_EmpHRA+Cal_EmpConAllow+CAR_ALL+BonusM)*100)/100; 
  if(Cal_TotBasHraCon<=VGrossSalary)
  { var Cal_EmpSpeAllow = document.getElementById("EmpSpeAllow").value=Math.round((VGrossSalary-Cal_TotBasHraCon)*100)/100; }
  else{ var Cal_EmpSpeAllow = document.getElementById("EmpSpeAllow").value=0; }
  
  var GrossSalary = document.getElementById("EmpGrossMonSalary").value=Math.round((Cal_VEmpBasic+Cal_EmpHRA+Cal_EmpConAllow+CAR_ALL+BonusM+Cal_EmpSpeAllow)*100)/100;
  var GMS_PAC = document.getElementById("GMS_PAC").value=GrossSalary;
...
{  
 ...
 var Car_Allow=parseFloat(document.getElementById("CAR_ALL_Value").value);
 var NPS_Value = document.getElementById("NPS_Value").value;
...
function FunChkvalMov()
{
 ...
 { 
  ...
  document.getElementById("CtcNPS_Value").value=document.getElementById("NPS_Value").value;
...
<?php /********* NPS NPS NPS **********/ ?>
 <tr>
  <td class="td2"></td>
  <td class="td3" id="pfA">&nbsp;NPS Contribution :</td>
  
  <td class="td3" id="pfB" style="text-align:center;"><input value="<?php echo $ResCtc['NPS_Value']; ?>" class="td3" style="width:95%;text-align:right;background-color:#92D1BD;" disabled/></td>
  <td class="td3" id="pfB" style="text-align:center;"><input name="NPS_Value" value="<?php echo $ResCtc['NPS_Value']; ?>" id="NPS_Value" class="td3" style="width:95%;text-align:right;" onKeyDown="FunNPS_Value()" onChange="FunNPS_Value()" onBlur="FunNPS_Value()" readonly onKeyPress="return isNumberKey(event)"/></td>
  <td class="td3" id="pfB" style="text-align:center;"><input name="CtcNPS_Value" value="<?php echo $ResCtc['NPS_Value']; ?>" id="CtcNPS_Value" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
<?php /********* NPS NOPS NPS **********/?>	 
...
{ 
 ...
 <tr>
  ...
  <td class="td3" id="micB" colspan="3" style="text-align:center;"><input Name="Rmkk" id="Rmkk" style="width:99%;font-family:Times New Roman;font-size:12px;" value="<?php echo 'PMS Activity'; ?>"/></td>
  <?php //if($ResCtc['Remark']!=''){echo $ResCtc['Remark'];}else{echo 'PMS Activity';} ?>
 </tr>
