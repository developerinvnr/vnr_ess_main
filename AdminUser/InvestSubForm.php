...
function Edit()
{ document.getElementById("SubmitInvstDec").style.display='block'; document.getElementById("EditInvstDec").style.display='none';  
...
if(CTF>0){if(CTF2==0){CTFdocument.getElementById("CTF2").value=CTF;}document.getElementById("CTF2").readOnly=false;document.getElementById("CTF2").style.backgroundColor='#F0F8FF';}
...
if(CorNPS>0){if(CorNPS2==0){document.getElementById("CorNPS2").value=NPS;}document.getElementById("CorNPS2").readOnly=false; 
...
if(IL>0){if(IL2==0){document.getElementById("IL2").value=IL;}document.getElementById("IL2").readOnly=false; document.getElementById("IL2").style.backgroundColor='#F0F8FF';}
  ...
  var Medical=parseFloat(document.getElementById("Medical").value); var LTA=parseFloat(document.getElementById("LTA").value);
  var CEA=parseFloat(document.getElementById("CEA").value); 
  var Medical2=parseFloat(document.getElementById("Medical2").value); var LTA2=parseFloat(document.getElementById("LTA2").value);
  var CEA2=parseFloat(document.getElementById("CEA2").value);
...
$sqlEdit=mysql_query("select * from hrm_employee_investment_submission where IvstDecIdSb=".$_REQUEST['ID']." AND EmployeeID=".$_REQUEST['EI'], $con);
...
$sql=mysql_query("select * from hrm_investdecl_setting_limit where CompanyId=".$_REQUEST['CI']." AND Period='".$resIvst2['Period']."' AND Month=".$resIvst2['Month'], $con); 
...
<input type="hidden" id="Period" name="Period" value="<?php echo $resIvst2['Period']; ?>"  readonly/>
<input type="hidden" id="YMonth" name="YMonth" value="<?php echo $resIvst2['Month']; ?>" readonly/>
<tr>
...
<td align="left" valign="top" style="width:550px;font-size:15px;">
<input id="Inv_Date" name="Inv_Date" class="textBox"  value="<?php if($rowEdit==0){echo '';}elseif($rowEdit2>0){if($resIvst3['Inv_Date']!='' AND $resIvst3['Inv_Date']!='0000-00-00' AND $resIvst3['Inv_Date']!='1970-01-01'){echo date("d-M-Y", strtotime($resIvst3['Inv_Date'])); } }?>" readonly/>
...
<td align="left" valign="top" colspan="6" style="width:550px;font-size:15px;">&nbsp;<input type="hidden" name="EmpID" id="EmpID" value="<?php echo $_REQUEST['EI']; ?>" /></td>
   ...
   <td align="" class="fontButton" colspan="6"><table border="0" align="right" class="fontButton">
	<tr>
	  ...
	  <td align="right" style="width:90px;"><input type="submit" name="SubmitInvstDec" id="SubmitInvstDec" style="width:90px; display:none;" value="save">
<input type="button" name="EditInvstDec" id="EditInvstDec" style="width:90px;" value="edit" onClick="Edit()" <?php //if($resIvst2['FormSubmit']=='YY'){echo 'disabled';}?>>
	  ...
	  <input type="button" name="Refresh" id="Refresh" style="width:90px;" value="Refresh" onClick="javascript:window.location='InvestSubForm.php?act=true&mm=sas&ask=false&&yy=eloi&gosto=false&rigt=checkessue&mailto=promt&wew=e%e@er%rdd=012&ID=<?php echo $_REQUEST['ID']; ?>&EI=<?php echo $_REQUEST['EI']; ?>&CI=<?php echo $_REQUEST['CI']; ?>'" /></td>
	</tr></table>  
	</td>
	</tr>
	</table>
