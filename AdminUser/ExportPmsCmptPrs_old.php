...
echo "\tHOD PIS\tHOD % PIS\tHOD PSC\tHOD % PSC\tHOD TISPM\tHOD % TISPM\tHOD TPGSPM";
echo "\tHOD Remark\tHR Score\tHR Rating\tHR Grade\tHR Designation\tHR Department";
...
echo "\tBasic\tHRA\tCA\tSA\tGross\tGross(PAC)\tPF\tNET\tLTA\tMR\tCEA\tAnnual Gross\tPF Contribution\tBonus\tGratuity\tMediclaim\tCTC\tTwo Weel\tFour Weel\tDA IN_HQ\tDA OUT_HQ\tA Grade\tB Grade\tC Grade\tTravel Mode\tTravel Class\tMobile PM\tHandset Elig\tMediclaim INSU\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
print("\n");
...
if($res['HR_GradeId']!=$res['HR_CurrGradeId']){ $sqlGH=mysql_query("select GradeValue from hrm_grade where GradeId=".$res['HR_GradeId']." AND CompanyId=".$_REQUEST['c'], $con); $resGH=mysql_fetch_assoc($sqlGH); $GradeH=$resGH['GradeValue']; }else{$GradeH='';}	  
  ...
  $schema_insert .= $ResC['Travel_TwoWeeKM'].$sep;
  $schema_insert .= $ResC['Travel_FourWeeKM'].$sep;
  $schema_insert .= $ResC['DA_Outside_HqSal'].$sep;
  $schema_insert .= $ResC['DA_Outside_Hq'].$sep;
  $schema_insert .= $ResC['Lodging_CategoryA'].$sep;
  $schema_insert .= $ResC['Lodging_CategoryB'].$sep;
  $schema_insert .= $ResC['Lodging_CategoryC'].$sep;
  $schema_insert .= $ResC['Mode_Travel_Outside_Hq'].$sep;
  $schema_insert .= $ResC['TravelClass_Outside_Hq'].$sep;
  $schema_insert .= $ResC['Mobile_Exp_Rem_Rs'].$sep;
  $schema_insert .= $ResC['Mobile_Hand_Elig_Rs'].$sep;
  $schema_insert .= $ResC['Health_Insurance'].$sep;               
