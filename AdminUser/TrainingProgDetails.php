...
<?php $sqlE=mysql_query("select e.EmployeeID,EmpCode,Fname,Sname,Lname from hrm_employee e INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where g.DepartmentId=".$resD['DepartmentId']." AND e.CompanyId=".$_REQUEST['c']." AND e.EmpStatus='A' order by EmpCode ASC", $con); while($resE=mysql_fetch_array($sqlE)) { 
...
<?php $sqlD=mysql_query("select DepartmentId,DepartmentCode,DepartmentName from hrm_department where DeptStatus='A' AND CompanyId=2 AND DepartmentCode!='MANAGEMENT' order by DepartmentName ASC", $con); 
	...
	<?php /* <input type="checkbox" id="CDept_<?php echo $resD['DepartmentId']; ?>" onClick="ClickDept(<?php echo $resD['DepartmentId']; ?>)" /> */ ?> </td>
     ...
     <tr>
	  <td colspan="2">
	   <table id="TR_<?php echo $resD['DepartmentId']; ?>" style="display:none;" border="1">
<?php $sqlE=mysql_query("select e.EmployeeID,EmpCode,Fname,Sname,Lname from hrm_employee e INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where g.DepartmentId=".$resD['DepartmentId']." AND e.CompanyId=2 AND e.EmpStatus='A' order by e.EmpCode ASC", $con); while($resE=mysql_fetch_array($sqlE)) { 
$sqlc=mysql_query("select TrainingId from hrm_company_training_participant where TrainingId=".$_REQUEST['id']." AND EmployeeID=".$resE['EmployeeID'], $con);
$row=mysql_num_rows($sqlc);
?>	   
	   <tr id=ETR_<?php echo $resE['EmployeeID']; ?> bgcolor="<?php if($row>0){echo '#FFD5BF';}else{echo '#FFFFFF';} ?>">	   
...
<?php $sqlD=mysql_query("select DepartmentId,DepartmentCode,DepartmentName from hrm_department where DeptStatus='A' AND CompanyId=3 AND DepartmentCode!='MANAGEMENT' order by DepartmentName ASC", $con); 
	...
	<?php /* <input type="checkbox" id="CDept_<?php echo $resD['DepartmentId']; ?>" onClick="ClickDept(<?php echo $resD['DepartmentId']; ?>)" /> */ ?> </td>
     ...
     <tr>
	  <td colspan="2">
	   <table id="TR_<?php echo $resD['DepartmentId']; ?>" style="display:none;" border="1">
<?php $sqlE=mysql_query("select e.EmployeeID,EmpCode,Fname,Sname,Lname from hrm_employee e INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where g.DepartmentId=".$resD['DepartmentId']." AND e.CompanyId=3 AND e.EmpStatus='A' order by EmpCode ASC", $con); while($resE=mysql_fetch_array($sqlE)) { 
$sqlc=mysql_query("select TrainingId from hrm_company_training_participant where TrainingId=".$_REQUEST['id']." AND EmployeeID=".$resE['EmployeeID'], $con);
$row=mysql_num_rows($sqlc);
?>	   
	   <tr id=ETR_<?php echo $resE['EmployeeID']; ?> bgcolor="<?php if($row>0){echo '#FFD5BF';}else{echo '#FFFFFF';} ?>">	   
