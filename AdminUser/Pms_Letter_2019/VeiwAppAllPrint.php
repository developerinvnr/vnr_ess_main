...
<?php if($_REQUEST['action']=='All') { $SqlE=mysql_query("SELECT e.*, Gender, DR, Married, DepartmentId, DateJoining FROM hrm_employee e INNER JOIN hrm_employee_personal p ON e.EmployeeID=p.EmployeeID INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID WHERE e.EmployeeID=".$_REQUEST['E']." AND e.CompanyId=".$_REQUEST['C'], $con); $ResE=mysql_fetch_assoc($SqlE); 
    ...
    <tr>
	  <td style="font-family:Times New Roman;color:#000000; width:785;" align="center">
	    <table border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td style="width:50px;">&nbsp;</td><td style="width:685px;font-size:16px;font-weight:bold;">&nbsp;</td><td style="width:50px;">&nbsp;</td></tr>
		</table>
	  </td>
	 </tr>	 	 
   </table>
...
<tr>
 <td style="font-family:Times New Roman;color:#000000;font-size:13px;width:785;" align="right">&nbsp;</td>
</tr>
...
<tr>
 <td style="font-family:Times New Roman;color:#000000;font-size:15px;width:785;" align="right">&nbsp;</td>
</tr>
