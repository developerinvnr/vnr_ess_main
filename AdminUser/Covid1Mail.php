...
mysql_query("SET SESSION sql_mode = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION'");
 ...
 //$qry="select g.EmployeeID,EmailId_Vnr as VEmailId from hrm_employee_general g inner join hrm_employee e on g.EmployeeID=e.EmployeeID where g.EmployeeID=169";
  
 $sql=mysql_query($qry." limit 0,90",$con); //AND (g.DepartmentId=1 OR g.DepartmentId=9)
