...
{ 
 ...
 { $resPms=mysql_fetch_array($sqlPms);
   ...
   if($rowb>0)
   {
    $sqlbUp=mysql_query("update hrm_employee_pms_behavioralformb set EmpPmsId=".$resPms['EmpPmsId'].", EmpStatus='A', AppStatus='A' where EmpId=".$_REQUEST['EI']." AND YearId=".$_REQUEST['YI']."", $con);
