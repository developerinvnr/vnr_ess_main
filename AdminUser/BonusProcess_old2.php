...
<tr style="height:24px;">
 ...
 <td class="tdc"><?php if($_SESSION['User_Permission']=='Edit'){ ?><a href="#"><?php /*?><img src="images/edit.png" border="0" alt="Edit" onClick="edit(<?php echo $resRat['BWageId'].', '.$_REQUEST['ey'].', '.$_REQUEST['ed']; ?>)"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"><img src="images/delete.png" alt="Delete" border="0" onClick="del(<?php echo $resRat['BWageId'].', '.$_REQUEST['ey']; ?>)"></a><?php */?><?php } ?></td>
</tr>
<?php } $SNo++;} ?>
...
<tr><td align="right">
<input type="button" name="NewSave" id="NewSave" value="new" onClick="newsave(<?php echo $_REQUEST['ey']; ?>,<?php echo $_REQUEST['ed']; ?>)" <?php if($_REQUEST['action']=="newsave" OR $_REQUEST['action']=="edit"){ echo "style=display:none;"; }?> disabled/>
