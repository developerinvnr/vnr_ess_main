...
{ $PayTable='hrm_employee_monthlypayslip_'.$_POST['Y']; }
 ...
 if($rowMP>0){ 
 $UpSal=mysql_query("update ".$PayTable." set YCea='".$_POST['YCea']."', YMr='".$_POST['YMr']."', YLta='".$_POST['YLta']."' where EmployeeID=".$_POST['E']." AND Month=".$_POST['M']." AND Year=".$_POST['Y']."", $con);}
 else{$UpSal=mysql_query("insert into ".$PayTable."(EmployeeID, Month, Year, YCea, YMr, YLta) values(".$_POST['E'].", ".$_POST['M'].", ".$_POST['Y'].", '".$_POST['YCea']."', '".$_POST['YMr']."', '".$_POST['YLta']."')", $con);}
...
<html>
<head>
<title><?php include_once('../Title.php'); ?>&nbsp;Tax Saving</title>
<meta http-equiv="Content-Type" content="text/html; charset=windows-1251">
<link type="text/css" href="css/body.css" rel="stylesheet" />
<link type="text/css" href="css/pro_dropdown_3.css" rel="stylesheet"/>
<style>
.Des{font-family:Times New Roman;font-size:14px;width:200px;}.Amt{font-family:Times New Roman;font-size:12px;width:90px;}
...
{document.getElementById("Save").style.display='block'; document.getElementById("Change").style.display='none'; 
 document.getElementById("YCea").readOnly=false; document.getElementById("YCea").style.background='#FFFFFF'; 
 document.getElementById("YMr").readOnly=false; document.getElementById("YMr").style.background='#FFFFFF';
 document.getElementById("YLta").readOnly=false; document.getElementById("YLta").style.background='#FFFFFF';
...
{ $PayTable='hrm_employee_monthlypayslip_'.$_REQUEST['Y']; }
?>
<table style="vertical-align:top;" width="620" align="center" border="0">
...
<table border="1">
 ...
 <tr>
<td colspan="6" style="font-family:Times New Roman;font-size:14px;width:600px;font-weight:bold;background-color:#BCB198;color:#000;">
&nbsp;<font color="#800000">EC:</font>&nbsp;<?php echo $EC.'&nbsp;&nbsp;&nbsp;<font color="#800000">Name:</font>&nbsp;'.$Ename; ?>
</td>
</tr>
 <td bgcolor="#D9D1E7">
 <table border="1">
 <tr><td colspan="6" align="center" style="font-family:Times New Roman;font-size:14px;width:400px;background-color:#7a6189;color:#FFFFFF;"><b>Tax Saving Components</b></td></tr> 
<?php if($_REQUEST['M']==1){$SelM='January';} elseif($_REQUEST['M']==2){$SelM='February';} elseif($_REQUEST['M']==3){$SelM='March';} 
 ...
 <tr>
   ...
   <td align="center" class="Des" style="background-color:#BCB198;">CEA</td>
   <td align="center" class="Des" style="background-color:#BCB198;">MR</td>
   <td align="center" class="Des" style="background-color:#BCB198;">LTA</td>
 </tr>
 <tr id="TRAmt" style="background-color:#DDDDDD;">
   <td class="Des" style="background-color:#FFFFFF;">&nbsp;<b><?php echo $SelM.'/'.$_REQUEST['Y']; ?></b></td>
   <td align="center" class="Amt"><input style="text-align:right;font-family:Times New Roman;font-size:12px;width:150px;border-style:hidden;background-color:#DDDDDD;" id="YCea" name="YCea" value="<?php echo intval($res['YCea']); ?>" readonly maxlength="8"/></td>
   <td align="center" class="Amt"><input style="text-align:right;font-family:Times New Roman;font-size:12px;width:150px;border-style:hidden;background-color:#DDDDDD;" id="YMr" name="YMr" value="<?php echo intval($res['YMr']); ?>" readonly maxlength="8" /></td>
   <td align="center" class="Amt"><input style="text-align:right;font-family:Times New Roman;font-size:12px;width:150px;border-style:hidden;background-color:#DDDDDD;" id="YLta" name="YLta" value="<?php echo intval($res['YLta']); ?>" readonly maxlength="8" /></td>
 ...
 <tr bgcolor="#7a6189">
   <td align="right" colspan="6">
    <table>
	 ...
	 <td align="right" style="width:90px;"><input type="button" name="Refresh" id="Refresh" style="width:90px;" value="refresh" onClick="javascript:window.location='EditSalaryTaxSaving.php?E=<?php echo $_REQUEST['E']; ?>&C=<?php echo $_REQUEST['C']; ?>&YI=<?php echo $_REQUEST['YI']; ?>&U=<?php echo $_REQUEST['U']; ?>&M=<?php echo $_REQUEST['M']; ?>&Y=<?php echo $_REQUEST['Y']; ?>'"/> </td>				   
	</tr>
	</table>
	</td>
	</tr>
