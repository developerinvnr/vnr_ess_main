...
if(isset($_POST['submit'])) {
    ...
    $upload_dir = '../Employee/CoronaKavach1_2020'.DIRECTORY_SEPARATOR;
    ...
    if(!empty(array_filter($_FILES['files']['name']))) {
        ...
        foreach ($_FILES['files']['tmp_name'] as $key => $value) {
		   ...
		   window.location="Up_CovidInsu.php";</script>'; 
...
{ 
  var x="Up_CovidInsu.php?d="+v; window.location=x; }
...
<table border="1" id="table1" cellspacing="1" style="width:100%;">
 ...
 <tr bgcolor="#7a6189">
  ...
  <td class="th" style="width:5%;">Uploaded</td>
 </tr>
 </thead>
 </div> 
 ...
 <tr style="background-color:#FFFFFF;height:22px;"> 
  ...
  <td class="tdc">
   <?php if(file_exists("../Employee/CoronaKavach1_2020/".$res['EmpCode'].".pdf")){ ?><a href="<?="../Employee/CoronaKavach1_2020/".$res['EmpCode'].".pdf";?>" target="_blank">Uploaded</a><?php } ?>
  </td>
  
  <?php /*<td class="tdc" style="color:#FFFFFF;background-color:<?php if(file_exists("../Employee/CoronaKavach1_2020/".$res['EmpCode'].".pdf")){ echo '#004000';}?>;"><?php if(file_exists("../Employee/CoronaKavach1_2020/".$res['EmpCode'].".pdf")){ echo 'Uploaded';}?></td>*/ ?>
 </tr>
 </tbody>
 </div>
<?php $sn++; } ?>
...
<form name="uForm" method="POST" enctype="multipart/form-data" onSubmit="return ValidateNew(uForm)">
 ...
 <tr>
  <td style="text-align:center; height:100px; vertical-align:middle; font-family:Times New Roman; font-size:18px;">
   <b>File Formate:</b> <i style="color:#97004B;">EmployeeCode.pdf</i>
  </td>
 </tr>
</table>   
				 </td>
