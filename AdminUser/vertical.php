...
function ExportVertical(d,c)
{    
  window.open("ExportVertical.php?action=FormVerticalExport&c="+c+"&d="+d,"ExportForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20");}
...
<?php if($_SESSION['login'] = true){ ?>	
 <tr>
  ...
  <?php if($_REQUEST['d']>0){?>
  <a href="#" onClick="ExportVertical(<?php echo $_REQUEST['d'].','.$CompanyId; ?>)" style="color:#003399; font-size:12px;">Export Excel</a><?php } ?>
  &nbsp;&nbsp;&nbsp;<b><?php echo $msg2; ?></b></td>
 </tr>
