...
{ 
$sql=mysql_query("select * from hrm_employee_ctc where EmployeeID=".$EMPID." AND CtcCreatedBy=0 AND Status='A' AND (Tot_CTC=0 OR Tot_CTC=0.00)", $con); 
$row=mysql_num_rows($sql); 


$Vpv=intval(($_POST['EmpAnnGrossSalary']*5)/100); 
$ctcV=$_POST['EmpTotalCtc']+$Vpv; 
...
<tr><td align="left" class="All_10">&nbsp;</td><td align="left" class="All_300">&nbsp;<?php if($CompanyId==1){echo 'Fixed';}else{echo 'Total';} ?> CTC :</td>
...
<tr><td align="left" class="All_10">&nbsp;</td>
    ...
    <td align="left" class="All_180" id="mppB">&nbsp;Rs. &nbsp;<input value="<?php $Vpv=intval(($ResCtc['Tot_Gross_Annual']*5)/100); echo $Vpv.'.00'; ?>"  class="All_100" readonly/></td>
    <?php if($ResCtc['Tot_GrossMonth']>15000 && $ResCtc['EmpActPf']=='N'){ ?>
