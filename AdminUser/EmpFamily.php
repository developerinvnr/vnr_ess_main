...
{ document.getElementById('SpanIDForView').innerHTML = originalRequest.responseText; 
  ...
  var ID=document.getElementById('ChkVID').value; 
   ...
   { 
     ...
     /*if(document.getElementById('ChkVvv').value=='Y'){ document.getElementById("Td"+"_"+P+"_"+ID).style.background='#00FF00'; } 
     else{ document.getElementById("Td"+"_"+P+"_"+ID).style.background='#FFFFFF'; }*/
   }
   else{ alert("Error!"); }
}
...
{ 
 ...
 var timer = setInterval( function() { if(win.closed){ clearInterval(timer); window.location="EmpFamily.php?ID="+E+"&Event=Edit&p=f&ok=true&rslt=y&pp=qw_res##ius"; } }, 1000);
}
...
<table border="0" width="1000" id="TEmp" style="display:block;" cellpadding="0" cellspacing="0">
<tr>
 <td colspan="2">
  <table><tr>
...
<td><table bgcolor="#BCA9D3"><tr>
  ...
  <td class="All_100" align="center">Covid<br>Vaccinat<sup>n</sup></td>
  <td class="All_50">&nbsp;</td>
</tr></table></td>
</tr>
...
<?php if($resF1['Fa_SN']!='') { ?><option style="background-color:#DBD3E2;" value="<?php echo $resF1['Fa_SN']; ?>" selected><?php echo $resF1['Fa_SN']; ?></option><?php } ?>
  ...
  <td class="All_100" align="center" style="background-color:<?php if($resF1['Covid_VaccinF']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidF" name="CovidF" <?php if($resF1['Covid_VaccinF']=='Y'){echo 'checked';} ?> onClick="FunCovid(<?=$EMPID?>,'F','CovidF',<?=$resF1['FamilyId']?>)"/> </td>
</tr></table></td>
</tr>
<tr>
<td align="center"></td>
...
<?php if($resF1['Mo_SN']!='') { ?><option style="background-color:#DBD3E2;" value="<?php echo $resF1['Mo_SN']; ?>" selected><?php echo $resF1['Mo_SN']; ?></option><?php } ?>
  ...
  <td class="All_100" align="center" style="background-color:<?php if($resF1['Covid_VaccinM']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidM" name="CovidM" <?php if($resF1['Covid_VaccinM']=='Y'){echo 'checked';} ?> onClick="FunCovid(<?=$EMPID?>,'M','CovidM',<?=$resF1['FamilyId']?>)"/> </td>
</tr></table></td>
</tr>
...
<?php if($resF1['HW_SN']!='') { ?><option style="background-color:#DBD3E2;" value="<?php echo $resF1['HW_SN']; ?>" selected><?php echo $resF1['HW_SN']; ?></option><?php } ?>
  ...
  <td class="All_100" align="center" style="background-color:<?php if($resF1['Covid_VaccinW']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidW" name="CovidW" <?php if($resF1['Covid_VaccinW']=='Y'){echo 'checked';} ?> onClick="FunCovid(<?=$EMPID?>,'W','CovidW',<?=$resF1['FamilyId']?>)"/> </td>
</tr></table></td>
</tr>
...
<?php if($resFa['Fa2_SN']!='') { ?><option style="background-color:#DBD3E2;" value="<?php echo $resFa['Fa2_SN']; ?>" selected><?php echo $resFa['Fa2_SN']; ?></option><?php } ?>
  ...
  <td class="All_100" align="center" style="background-color:<?php if($resFa['Covid_Vaccin']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidO<?=$i?>" name="CovidO<?=$i?>" <?php if($resFa['Covid_Vaccin']=='Y'){echo 'checked';} ?> onClick="FunCovid(<?=$EMPID?>,'O','CovidO<?=$i?>',<?=$resFa['Family2Id']?>)"/> </td>
...
<tr> 
<td align="left" valign="top">
<table border="0" width="1050" id="TEmp" style="display:block;" cellpadding="0" cellspacing="0">
<tr>
 <td colspan="2">
  <table><tr>
...
<tr>
<td style="width:30px;background-color:#E0DBE3;" align="center"></td>
<td><table bgcolor="#BCA9D3">
 <tr>
  <td rowspan="2" class="All_120" align="center">Relation</td>
  <td rowspan="2" width="50">&nbsp;</td>
  <td rowspan="2" class="All_200" align="center">Name</td>
  <td rowspan="2" class="All_100" align="center">DOB</td>
  <td rowspan="2" class="All_150" align="center">Qualification</td>
  <td rowspan="2" class="All_150" align="center">Occupation</td>
  <td colspan="2" class="All_100" align="center">Covid - 19 Vaccination</td>
 </tr>
 <tr>
  <td class="All_80" align="center">Dose-1</td>
  <td class="All_80" align="center">Dose-2</td>
 </tr>
</table></td>
</tr>
<?php $sqlF1=mysql_query("select * from hrm_employee_family where EmployeeID=".$EMPID, $con); $rowF1=mysql_num_rows($sqlF1);
...
<?php if($resF1['Fa_SN']!='') { ?><option style="background-color:#DBD3E2;" value="<?php echo $resF1['Fa_SN']; ?>" selected><?php echo $resF1['Fa_SN']; ?></option><?php } ?>
  ...
  <td class="All_80" align="center" id="Td_F_<?=$resF1['FamilyId']?>" style="background-color:<?php if($resF1['Covid_VaccinF']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidF" name="CovidF" <?php if($resF1['Covid_VaccinF']=='Y'){echo 'checked';} ?> onClick="FunCovid(1,<?=$EMPID?>,'F','CovidF',<?=$resF1['FamilyId']?>)"/> </td>
  <td class="All_80" align="center" id="Td_F2_<?=$resF1['FamilyId']?>" style="background-color:<?php if($resF1['Covid_VaccinF2']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidF2" name="CovidF2" <?php if($resF1['Covid_VaccinF2']=='Y'){echo 'checked';} ?> onClick="FunCovid(2,<?=$EMPID?>,'F2','CovidF2',<?=$resF1['FamilyId']?>)"/> </td>
...
<?php if($resF1['Mo_SN']!='') { ?><option style="background-color:#DBD3E2;" value="<?php echo $resF1['Mo_SN']; ?>" selected><?php echo $resF1['Mo_SN']; ?></option><?php } ?>
  ...
  <td class="All_80" align="center" id="Td_M_<?=$resF1['FamilyId']?>" style="background-color:<?php if($resF1['Covid_VaccinM']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidM" name="CovidM" <?php if($resF1['Covid_VaccinM']=='Y'){echo 'checked';} ?> onClick="FunCovid(1,<?=$EMPID?>,'M','CovidM',<?=$resF1['FamilyId']?>)"/> </td>
  <td class="All_80" align="center" id="Td_M2_<?=$resF1['FamilyId']?>" style="background-color:<?php if($resF1['Covid_VaccinM2']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidM2" name="CovidM2" <?php if($resF1['Covid_VaccinM2']=='Y'){echo 'checked';} ?> onClick="FunCovid(2,<?=$EMPID?>,'M2','CovidM2',<?=$resF1['FamilyId']?>)"/> </td>
</tr></table></td>
</tr>
<?php $sqlPer=mysql_query("select Married from hrm_employee_personal where EmployeeID=".$EMPID, $con); $resPer=mysql_fetch_assoc($sqlPer); if($resPer['Married']=='Y') {?>
<tr>
...
<?php if($resF1['HW_SN']!='') { ?><option style="background-color:#DBD3E2;" value="<?php echo $resF1['HW_SN']; ?>" selected><?php echo $resF1['HW_SN']; ?></option><?php } ?>
  ...
  <td class="All_80" align="center" id="Td_W_<?=$resF1['FamilyId']?>" style="background-color:<?php if($resF1['Covid_VaccinW']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidW" name="CovidW" <?php if($resF1['Covid_VaccinW']=='Y'){echo 'checked';} ?> onClick="FunCovid(1,<?=$EMPID?>,'W','CovidW',<?=$resF1['FamilyId']?>)"/> </td>
  <td class="All_80" align="center" id="Td_W2_<?=$resF1['FamilyId']?>" style="background-color:<?php if($resF1['Covid_VaccinW2']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidW2" name="CovidW2" <?php if($resF1['Covid_VaccinW2']=='Y'){echo 'checked';} ?> onClick="FunCovid(2,<?=$EMPID?>,'W2','CovidW2',<?=$resF1['FamilyId']?>)"/> </td>
</tr></table></td>
</tr>
<?php } if($resPer['Married']=='N') { ?>
<input type="hidden" name="HusWifeName" id="HusWifeName"  value="" /><input type="hidden" name="HusWifeDob" id="HusWifeDob" value="" />
...
<?php if($resFa['Fa2_SN']!='') { ?><option style="background-color:#DBD3E2;" value="<?php echo $resFa['Fa2_SN']; ?>" selected><?php echo $resFa['Fa2_SN']; ?></option><?php } ?>
  ...
  <td class="All_80" align="center" id="Td_O_<?=$resFa['Family2Id']?>" style="background-color:<?php if($resFa['Covid_Vaccin']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidO<?=$i?>" name="CovidO<?=$i?>" <?php if($resFa['Covid_Vaccin']=='Y'){echo 'checked';} ?> onClick="FunCovid(1,<?=$EMPID?>,'O','CovidO<?=$i?>',<?=$resFa['Family2Id']?>)"/> </td>
  <td class="All_80" align="center" id="Td_O2_<?=$resFa['Family2Id']?>" style="background-color:<?php if($resFa['Covid_Vaccin2']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidO<?=$i?>2" name="CovidO<?=$i?>2" <?php if($resFa['Covid_Vaccin2']=='Y'){echo 'checked';} ?> onClick="FunCovid(2,<?=$EMPID?>,'O2','CovidO<?=$i?>2',<?=$resFa['Family2Id']?>)"/> </td>
...
<?php $sqlG=mysql_query("select Covid_Vaccin, Covid_Vaccin2, Covid_Vaccin_file, Covid_Vaccin2_file, Covid_Vaccin3, Covid_Vaccin3_file from hrm_employee_general where EmployeeID=".$EMPID,$con);
      $resG=mysql_fetch_assoc($sqlG); ?>
<tr>
<td style="width:700px;">
<table style="width:80%;" border="1" cellspacing="1">
<tr bgcolor="#BCA9D3">
 <td rowspan="2" style="text-align:center;width:300px;font-family:Times New Roman; font-size:15px;"><b>Self <br> Vaccination</b></td>
 <td class="All_100" align="center"><b>Dose-1</b></td>
 <td class="All_100" align="center"><b>Dose-2</b></td>
 <td class="All_100" align="center"><b>Precaution Dose</b></td>
 <td class="All_100" align="center"><b>Dose-1 Cerificate</b></td>
 <td class="All_100" align="center"><b>Dose-2 Cerificate</b></td>
 <td class="All_100" align="center"><b>Precaution Dose Cerificate</b></td>
</tr>
<tr>
  <td class="All_80" align="center" id="Td_S_1" style="background-color:<?php if($resG['Covid_Vaccin']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidS1" name="CovidS1" <?php if($resG['Covid_Vaccin']=='Y'){echo 'checked';} ?> onClick="FunCovid(1,<?=$EMPID?>,'S','CovidS1',1)"/> </td>
  <td class="All_80" align="center" id="Td_S2_1" style="background-color:<?php if($resG['Covid_Vaccin2']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidS12" name="CovidS12" <?php if($resG['Covid_Vaccin2']=='Y'){echo 'checked';} ?> onClick="FunCovid(2,<?=$EMPID?>,'S2','CovidS12',1)"/> </td>
  <td class="All_80" align="center" id="Td_S3_1" style="background-color:<?php if($resG['Covid_Vaccin3']=='Y'){echo '#00FF00';} ?>;"><input type="checkbox" id="CovidS13" name="CovidS13" <?php if($resG['Covid_Vaccin3']=='Y'){echo 'checked';} ?> onClick="FunCovid(3,<?=$EMPID?>,'S3','CovidS13',1)"/> </td>
  
  <td align="center" id="Td_SBtn_1" style="vertical-align:middle;font-family:Times New Roman;"><?php if($resG['Covid_Vaccin_file']!=''){echo '<a href="../Employee/CovidCert/'.$resG['Covid_Vaccin_file'].'" target="_blank">Uploaded</a>';  ?> 
    /  <a href="#" onClick="FunCovidFile(1,<?=$EMPID?>,'S','CovidS',1,'R')">Edit</a>
<?php 
  }else{?><input type="button" id="CovidS_btn" onClick="FunCovidFile(1,<?=$EMPID?>,'S','CovidS',1,'R')" value="upload" <?php if($resG['Covid_Vaccin']=='N'){ echo 'style="display:none;"'; } ?>/> <?php } ?></td>
  
  
  <td align="center" id="Td_S2Btn_1" style="vertical-align:middle;font-family:Times New Roman;"><?php if($resG['Covid_Vaccin2_file']!=''){echo '<a href="../Employee/CovidCert/'.$resG['Covid_Vaccin2_file'].'" target="_blank">Uploaded</a>';  ?> 
    /  <a href="#" onClick="FunCovidFile(2,<?=$EMPID?>,'S2','CovidS2',1,'R')">Edit</a>
<?php 
  }else{?><input type="button" id="CovidS2_btn" onClick="FunCovidFile(2,<?=$EMPID?>,'S2','CovidS2',1,'R')" value="upload" <?php if($resG['Covid_Vaccin2']=='N'){ echo 'style="display:none;"'; } ?> /> <?php } ?></td>\
  
  <td align="center" id="Td_S2Btn_1" style="vertical-align:middle;font-family:Times New Roman;"><?php if($resG['Covid_Vaccin3_file']!=''){echo '<a href="../Employee/CovidCert/'.$resG['Covid_Vaccin3_file'].'" target="_blank">Uploaded</a>';  ?> 
    /  <a href="#" onClick="FunCovidFile(3,<?=$EMPID?>,'S3','CovidS3',1,'R')">Edit</a>
<?php 
  }else{?><input type="button" id="CovidS2_btn" onClick="FunCovidFile(3,<?=$EMPID?>,'S3','CovidS3',1,'R')" value="upload" <?php if($resG['Covid_Vaccin3']=='N'){ echo 'style="display:none;"'; } ?> /> <?php } ?></td>
