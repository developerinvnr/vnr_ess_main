...
{ 
 if($_POST['SelType']=='Hod')
 { $ExtQuery='HodId='.$_POST['SelValue']; $HodId=$_POST['SelValue']; $DeptId=0; $Rev2Id=0; $RevId=0; $AppId=0; }
 elseif($_POST['SelType']=='Dept')
 { $ExtQuery='DeptId='.$_POST['SelValue']; $HodId=0; $DeptId=$_POST['SelValue']; $Rev2Id=0; $RevId=0; $AppId=0; }
 elseif($_POST['SelType']=='Rev2')
 { $ExtQuery='Rev2Id='.$_POST['SelValue']; $HodId=0; $DeptId=0; $Rev2Id=$_POST['SelValue']; $RevId=0; $AppId=0; }
 elseif($_POST['SelType']=='Rev')
 { $ExtQuery='RevId='.$_POST['SelValue']; $HodId=0; $DeptId=0; $Rev2Id=0; $RevId=$_POST['SelValue']; $AppId=0; }
 elseif($_POST['SelType']=='App')
 { $ExtQuery='AppId='.$_POST['SelValue']; $HodId=0; $DeptId=0; $Rev2Id=0; $RevId=0; $AppId=$_POST['SelValue']; }
 else{ $ExtQuery='1=1'; $HodId=0; $DeptId=0; $Rev2Id=0; $RevId=0; $AppId=0; }
 ...
 { 
  ...
  if($row==0)
  { $sqlU=mysql_query("insert into hrm_pms_dummy_increment(YearId, CompanyId, HodId, DeptId, Rev2Id, RevId, AppId, Rating, EmpValue, AppValue, RevValue, HodValue, IncGross, PerInc, Inc, CreatedBy, CreatedDate)values(".$YearId.", ".$CompanyId.", ".$HodId.", ".$DeptId.", ".$Rev2Id.", ".$RevId.", ".$AppId.", '".$_POST['Rat_'.$i]."', '".$_POST['EmpGross_'.$i]."', '".$_POST['AppGross_'.$i]."', '".$_POST['RevGross_'.$i]."', '".$_POST['HodGross_'.$i]."', '".$_POST['PIS_'.$i]."', '".$_POST['PerIS_'.$i]."', '".$_POST['IncS_'.$i]."', ".$UserId.", '".date("Y-m-d")."')", $con); }
 }
  ...
  if($row2==0)
  { $sqlU2=mysql_query("insert into hrm_pms_dummy_increment_un(YearId, CompanyId, HodId, DeptId, Rev2Id, RevId, AppId, EmpValue, AppValue, RevValue, HodValue, IncGross, PerInc, Inc, CreatedBy, CreatedDate)values(".$YearId.", ".$CompanyId.", ".$HodId.", ".$DeptId.", ".$Rev2Id.", ".$RevId.", ".$AppId.", '".$_POST['UnEmpGross']."', '".$_POST['UnAppGross']."', '".$_POST['UnRevGross']."', '".$_POST['UnHodGross']."', '".$_POST['UnPIS']."', '".$_POST['UnPerIS']."', '".$_POST['UnIncS']."', ".$UserId.", '".date("Y-m-d")."')", $con); }
  ...
  if($row3==0)
  { $sqlU3=mysql_query("insert into hrm_pms_dummy_increment_untot(YearId, CompanyId, HodId, DeptId, Rev2Id, RevId, AppId, TEmpValue, TAppValue, TRevValue, THodValue, TIncGross, TPerInc, TInc, CreatedBy, CreatedDate)values(".$YearId.", ".$CompanyId.", ".$HodId.", ".$DeptId.", ".$Rev2Id.", ".$RevId.", ".$AppId.", '".$_POST['EmpGrossT']."', '".$_POST['AppGrossT']."', '".$_POST['RevGrossT']."', '".$_POST['HodGrossT']."', '".$_POST['PIST']."', '".$_POST['PerIST']."', '".$_POST['IncST']."', ".$UserId.", '".date("Y-m-d")."')", $con); }
...
window.location='MyTeamCostPack.php?action='+VS+'&value='+v+'&YI='+YId;
}
function SelectDept(v)
{ var YId=document.getElementById("YId").value;
  if(v!='Over'){ window.location='MyTeamCostPack.php?action=Dept&value='+v+'&YI='+YId; }
  else if(v=='Over'){ window.location='MyTeamCostPack.php?action='+v+'&YI='+YId; }
}
function SelectHod(v)
{ var YId=document.getElementById("YId").value; window.location='MyTeamCostPack.php?action=Hod&value='+v+'&YI='+YId;}

function SelectRev2(v)
{ var YId=document.getElementById("YId").value; window.location='MyTeamCostPack.php?action=Rev2&value='+v+'&YI='+YId;}

function SelectRev(v)
{ var YId=document.getElementById("YId").value; window.location='MyTeamCostPack.php?action=Rev&value='+v+'&YI='+YId;}

function SelectApp(v)
{ var YId=document.getElementById("YId").value; window.location='MyTeamCostPack.php?action=App&value='+v+'&YI='+YId;}
...
//var Hod_GS = parseFloat(document.getElementById("HodCtc_"+n).value); //HodGross_
if(YId>=8){ var Hod_GS = parseFloat(document.getElementById("HodCtc_"+n).value);  }
else { var Hod_GS = parseFloat(document.getElementById("HodGross_"+n).value);  }
...
//var TotHod_GS = parseFloat(document.getElementById("HodCtcT").value); //HodGrossT
if(YId>=8){ var TotHod_GS = parseFloat(document.getElementById("HodCtcT").value);  }
else { var TotHod_GS = parseFloat(document.getElementById("HodGrossT").value);  }
...
{ var a=document.getElementById("PISValue_"+i).value=parseFloat(document.getElementById("PIS_"+i).value);
  ...
  var d=document.getElementById("PISValueCtc_"+i).value=parseFloat(document.getElementById("PISCtc_"+i).value);
} 
...
var timer = setInterval( function() { if(win.closed) { clearInterval(timer);  window.location="MyTeamCostPack.php?&action="+VS+"&value="+v+"&YI="+YI; } }, 1000);
}
...
var Hod_GS = parseFloat(document.getElementById("UnHodCtc").value); //UnHodGross
var Hod_NetIncGS = parseFloat(document.getElementById("UnPIS").value); 
var Hod_PerGS = parseFloat(document.getElementById("UnPerIS").value);
var Hod_IncGS = parseFloat(document.getElementById("UnIncS").value);
...
function ExportTCost(a,yi,v)
{ var ComId=document.getElementById("ComId").value;   
  window.open("MyTeamCostExp.php?action=ExportTCost&value="+v+"&YI="+yi+"&action="+a+"&c="+ComId,"ExportForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20");
}


</script>
</head>
<body class="body" onLoad="Cal_OneProInc(1)"> <?php //onLoad="Cal_OneProInc(1)" ?>
...
<input type="hidden" id="PISValueCtc_<?php echo $i; ?>" value="0" />
<?php } ?>
  ...
  <table border="0" style="width:85%;">
   <tr>
	...
	<table border="0" style="width:100%;">
	 <tr>
	  ...
	  <?php if($_REQUEST['YI']!=10){?><option value="10">2021-2022</option><?php } ?>
	  <?php if($_REQUEST['YI']!=9){?><option value="9">2020-2021</option><?php } ?>
	  ...
	  <td class="tdc" style="width:150px;"><select class="sell" name="HodInc" id="HodInc" onChange="SelectHod(this.value)"><option value="" style="margin-left:0px;" <?php if($_REQUEST['action']!='Hod'){echo 'selected';} ?>>Select Management</option><?php $SqlHodI2=mysql_query("SELECT HOD_EmployeeID from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID WHERE p.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_REQUEST['YI']." AND e.EmpStatus='A' GROUP BY p.HOD_EmployeeID", $con); while($ResHodI2=mysql_fetch_array($SqlHodI2)){ $SqlHodI=mysql_query("SELECT Fname,Sname,Lname from hrm_employee WHERE EmployeeID=".$ResHodI2['HOD_EmployeeID'], $con); $ResHodI=mysql_fetch_array($SqlHodI);  $EnameHI=$ResHodI['Fname'].' '.$ResHodI['Sname'].' '.$ResHodI['Lname']; ?><option value="<?php echo $ResHodI2['HOD_EmployeeID']; ?>" <?php if($_REQUEST['action']=='Hod' AND $_REQUEST['value']==$ResHodI2['HOD_EmployeeID']){echo 'selected';} ?>><?php echo '&nbsp;'.$EnameHI; ?></option><?php } ?></select></td>
	  
	  <td class="tdc" style="width:150px;"><select class="sell" name="Rev2Inc" id="Rev2Inc" onChange="SelectRev2(this.value)"><option value="" style="margin-left:0px;" <?php if($_REQUEST['action']!='Rev2'){echo 'selected';} ?>>Select HOD</option><?php $SqlRev2I2=mysql_query("SELECT Rev2_EmployeeID from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID WHERE p.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_REQUEST['YI']." AND e.EmpStatus='A' GROUP BY p.Rev2_EmployeeID", $con); while($ResRev2I2=mysql_fetch_array($SqlRev2I2)){ $SqlRev2I=mysql_query("SELECT Fname,Sname,Lname from hrm_employee WHERE EmployeeID=".$ResRev2I2['Rev2_EmployeeID'], $con); $ResRev2I=mysql_fetch_array($SqlRev2I); $EnameR2I=$ResRev2I['Fname'].' '.$ResRev2I['Sname'].' '.$ResRev2I['Lname']; ?><option value="<?php echo $ResRev2I2['Rev2_EmployeeID']; ?>" <?php if($_REQUEST['action']=='Rev2' AND $_REQUEST['value']==$ResRev2I2['Rev2_EmployeeID']){echo 'selected';} ?>><?php echo '&nbsp;'.$EnameR2I; ?></option><?php } ?></select></td>
	  
	  <td class="tdc" style="width:150px;"><select class="sell" name="RevInc" id="RevInc" onChange="SelectRev(this.value)"><option value="" style="margin-left:0px;" <?php if($_REQUEST['action']!='Rev'){echo 'selected';} ?>>Select Reveiver</option><?php $SqlRevI2=mysql_query("SELECT Reviewer_EmployeeID from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID WHERE p.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_REQUEST['YI']." AND e.EmpStatus='A' GROUP BY p.Reviewer_EmployeeID", $con); while($ResRevI2=mysql_fetch_array($SqlRevI2)){ $SqlRevI=mysql_query("SELECT Fname,Sname,Lname from hrm_employee WHERE EmployeeID=".$ResRevI2['Reviewer_EmployeeID'], $con); $ResRevI=mysql_fetch_array($SqlRevI); $EnameRI=$ResRevI['Fname'].' '.$ResRevI['Sname'].' '.$ResRevI['Lname']; ?><option value="<?php echo $ResRevI2['Reviewer_EmployeeID']; ?>" <?php if($_REQUEST['action']=='Rev' AND $_REQUEST['value']==$ResRevI2['Reviewer_EmployeeID']){echo 'selected';} ?>><?php echo '&nbsp;'.$EnameRI; ?></option><?php } ?></select></td>
	  
	  <td class="tdc" style="width:150px;"><select class="sell" name="AppInc" id="AppInc" onChange="SelectApp(this.value)"><option value="" style="margin-left:0px;" <?php if($_REQUEST['action']!='App'){echo 'selected';} ?>>Select Appraiser</option><?php $SqlAppI2=mysql_query("SELECT Appraiser_EmployeeID from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID WHERE p.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_REQUEST['YI']." AND e.EmpStatus='A' GROUP BY p.Appraiser_EmployeeID", $con); while($ResAppI2=mysql_fetch_array($SqlAppI2)){ $SqlAppI=mysql_query("SELECT Fname,Sname,Lname from hrm_employee WHERE EmployeeID=".$ResAppI2['Appraiser_EmployeeID'], $con); $ResAppI=mysql_fetch_array($SqlAppI); $EnameAI=$ResAppI['Fname'].' '.$ResAppI['Sname'].' '.$ResAppI['Lname']; ?><option value="<?php echo $ResAppI2['Appraiser_EmployeeID']; ?>" <?php if($_REQUEST['action']=='App' AND $_REQUEST['value']==$ResAppI2['Appraiser_EmployeeID']){echo 'selected';} ?>><?php echo '&nbsp;'.$EnameAI; ?></option><?php } ?></select></td>
   ...
   <tr>
    ...
    <?php if($_REQUEST['action']=='Over') { $Action='ORGANIZATION'; }
          ...
          elseif($_REQUEST['action']=='Hod' OR $_REQUEST['action']=='Rev2' OR $_REQUEST['action']=='Rev' OR $_REQUEST['action']=='App'){ $sqlB=mysql_query("select Fname,Sname,Lname,Gender,Married,DR FROM hrm_employee e INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_personal p ON e.EmployeeID=p.EmployeeID WHERE e.EmployeeId=".$_REQUEST['value'], $con); $resB=mysql_fetch_assoc($sqlB); if($resB['DR']=='Y'){$MS='Dr.';} elseif($resB['Gender']=='M'){$MS='Mr.';} elseif($resB['Gender']=='F' AND $resB['Married']=='Y'){$MS='Mrs.';} elseif($resB['Gender']=='F' AND $resB['Married']=='N'){$MS='Miss.';} if($_REQUEST['value']=='Hod'){$titl='MANAGEMENT';}elseif($_REQUEST['value']=='Rev2'){$titl='HOD';}elseif($_REQUEST['value']=='Rev'){$titl='REVIEWER';}elseif($_REQUEST['value']=='App'){$titl='APPRAISER';}  $Action=$titl.':&nbsp;'.$MS.' '.$resB['Fname'].' '.$resB['Sname'].' '.$resB['Lname']; } ?>
		  			  
	 <tr bgcolor="#FF8000" style="height:26px;">	
	  <td colspan="11" class="th2"><b><?php echo $Action.'&nbsp;(Year-'.$PRD.')'; ?></b>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onClick="ExportTCost('<?php echo $_REQUEST['action']; ?>','<?php echo $_REQUEST['YI']; ?>','<?php echo $_REQUEST['value']; ?>')" style="color:#F9F900; font-size:12px;">Export Excel</a>
	  ...
	  <?php                                             //<date('Y-02-01')
	   if(date("Y-m-d")>=date('Y-01-01') AND date("Y-m-d")<date('Y-03-15') AND $_REQUEST['YI']==$YearId){ 
	 ...
	 <tr bgcolor="#7a6189" style="height:24px;">	
	  ...
	  <td colspan="9" class="th">PREVIOUS</td>
	  <td colspan="3" rowspan="2" class="th">PROPOSED</td>
	 </tr>
     <tr bgcolor="#7a6189" style="height:24px;">	
     ...
     <tr bgcolor="#7a6189" style="height:24px;">
      ...
      <td class="th" style="width:6%;">Total<br><?php if($_REQUEST['YI']>=8){echo 'CTC';}else{echo 'Gross';}?></td>
      <td class="th" style="width:4%;">&nbsp;NOE&nbsp;</td>
      <td class="th" style="width:6%;">Total<br><?php if($_REQUEST['YI']>=8){echo 'CTC';}else{echo 'Gross';}?></td>
      <td class="th" style="width:4%;">&nbsp;NOE&nbsp;</td>
      <td class="th" style="width:6%;">Total<br><?php if($_REQUEST['YI']>=8){echo 'CTC';}else{echo 'Gross';}?></td>
      ...
      <td class="th" style="width:6%;">Proposed<br><?php if($_REQUEST['YI']>=8){echo 'CTC';}else{echo 'Gross';}?></td>
	  ...
	  <?php /* if($_REQUEST['YI']!=$YearId){ ?>
      <td class="th" style="width:6%;">Proposed<br>Gross</td>
...
$sqlE=mysql_query("select SUM(EmpCurrGrossPM)as EmpGross, SUM(EmpCurrIncentivePM) as EmpInct, SUM(EmpCurrCtc) as EmpCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=0 ".$query." ".$query_y." AND p.Dummy_EmpRating=".$resR['Rating'], $con); $resE=mysql_fetch_array($sqlE); 

$sql2E=mysql_query("select SUM(EmpCurrAnnualBasic)as EmpBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=1 ".$query." ".$query_y." AND p.Dummy_EmpRating=".$resR['Rating'], $con); $res2E=mysql_fetch_array($sql2E); 
...
<?php if($_REQUEST['YI']>=8){$e_gross=$resE['EmpCtc']+$res2E['EmpBasic'];}else{$e_gross=$resEGross;}?>	  		   
	  <td class="tdr"><?php echo floatval($e_gross); //$resEGross; ?>&nbsp;</td>

<?php //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser
$sqlA=mysql_query("select SUM(EmpCurrGrossPM)as AppGross, SUM(EmpCurrIncentivePM) as AppInct, SUM(EmpCurrCtc) as AppCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=0 ".$query." ".$query_y." AND p.Dummy_AppRating=".$resR['Rating'], $con); $resA=mysql_fetch_array($sqlA);

$sql2A=mysql_query("select SUM(EmpCurrAnnualBasic)as AppBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=1 ".$query." ".$query_y." AND p.Dummy_AppRating=".$resR['Rating'], $con); $res2A=mysql_fetch_array($sql2A);
...
<?php if($_REQUEST['YI']>=8){$a_gross=$resA['AppCtc']+$res2A['AppBasic'];}else{$a_gross=$resAGross;}?>	 	  			   
	  <td class="tdr"><?php echo floatval($a_gross); //$resAGross; ?>&nbsp;</td>

<?php //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer
$sqlRe=mysql_query("select SUM(EmpCurrGrossPM)as RevGross, SUM(EmpCurrIncentivePM) as RevInct, SUM(EmpCurrCtc) as RevCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=0 ".$query." ".$query_y." AND p.Dummy_RevRating=".$resR['Rating'], $con); $resRe=mysql_fetch_array($sqlRe);

$sql2Re=mysql_query("select SUM(EmpCurrAnnualBasic)as RevBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=1 ".$query." ".$query_y." AND p.Dummy_RevRating=".$resR['Rating'], $con); $res2Re=mysql_fetch_array($sql2Re);
...
<?php if($_REQUEST['YI']>=8){$r_gross=$resRe['RevCtc']+$res2Re['RevBasic'];}else{$r_gross=$resRGross;}?>	  			   
	  <td class="tdr"><?php echo floatval($r_gross); //$resRGross; ?>&nbsp;</td>
		
<?php //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD
$sqlH=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrIncentivePM) as HodInct, SUM(EmpCurrCtc) as HodCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=0 ".$query." ".$query_y." AND p.Dummy_HodRating=".$resR['Rating'], $con); 
$resH=mysql_fetch_array($sqlH);

$sql2H=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrAnnualBasic)as HodBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=1 ".$query." ".$query_y." AND p.Dummy_HodRating=".$resR['Rating'], $con); 
$res2H=mysql_fetch_array($sql2H);
...
if($resH['HodGross']>0 OR $res2H['HodGross']>0){$resHGross=$resH['HodGross']+$res2H['HodGross']+$resH['HodInct'];}else{$resHGross=0;}
if($resH['HodCtc']>0 OR $res2H['HodBasic']>0){$resHCtc=round($resH['HodCtc']+$res2H['HodBasic']);}else{$resHCtc=0;} ?>			   			   			
...
<?php if(date("Y-m-d")>=date('Y-01-01') AND date("Y-m-d")<date('Y-03-15') AND $_REQUEST['YI']==$YearId){ 
                                                       //<date('Y-02-01') ?>
...
{ 
$sqlD=mysql_query("select SUM(EmpCurrGrossPM)as DeptTotGross, SUM(EmpCurrIncentivePM) as DeptInct, SUM(EmpCurrCtc) as DeptCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=0 ".$query." ".$query_y." AND p.Dummy_HodRating=".$resR['Rating'], $con); $resD=mysql_fetch_assoc($sqlD); 

$sql2D=mysql_query("select SUM(EmpCurrAnnualBasic)as HodBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=1 ".$query." ".$query_y." AND p.Dummy_HodRating=".$resR['Rating'], $con); $res2D=mysql_fetch_assoc($sql2D);

$Pre_GrossValue=$resD['DeptTotGross']+$res2D['HodBasic']+$resD['DeptInct']; 
$Pre_HodCtc=$resD['DeptCtc']+$res2D['HodBasic']; 
}
...
// $IncD=($Pre_GrossValue*$res2I['PerInc'])/100;   
 ...
 ?>	
	 ...
	 <?php /*?> <td class="tdc" style="background-color:#FFFFB0;"><input class="inpr" style="background-color:#FFFFB0;color:#0080FF;font-weight:bold;" id="PISCtc_<?php echo $sn; ?>" name="PISCtc_<?php echo $sn; ?>" value="<?php echo floatval($H5I); ?>" onKeyPress="return isNumberKey(event)" readonly/></td> <?php */?>
	  
	  <input type="hidden" class="inpr" style="background-color:#FFFFB0;color:#0080FF;font-weight:bold;" id="PISCtc_<?php echo $sn; ?>" name="PISCtc_<?php echo $sn; ?>" value="<?php echo floatval($H5I); ?>" onKeyPress="return isNumberKey(event)" readonly/>
...
<?php /**************************************** Actual Value Start *********************************/ ?>			
<?php $sqlHTotP=mysql_query("select SUM(HR_GrossMonthlySalary)as HodTotP, SUM(HR_IncNetMonthalySalary)as HodTotIncS, SUM(EmpCurrCtc) as HotTotCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=0 ".$query." ".$query_y." AND p.Dummy_HodRating=".$resR['Rating'], $con); $resHTotP=mysql_fetch_array($sqlHTotP);

$sql2HTotP=mysql_query("select SUM(EmpCurrAnnualBasic)as HodBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." AND p.Appraiser_EmployeeID!=0 AND p.CtcLimitCross=1 ".$query." ".$query_y." AND p.Dummy_HodRating=".$resR['Rating'], $con); $res2HTotP=mysql_fetch_array($sql2HTotP);


if($resHTotP['HodTotP']>0){$HTotP=$resHTotP['HodTotP']+$res2HTotP['HodBasic'];}else{$HTotP=0;}
if($resHTotP['HotTotCtc']>0){$HTotCtc=$resHTotP['HotTotCtc']+$res2HTotP['HodBasic'];}else{$HTotCtc=0;}
if($_REQUEST['YI']>=8){ $TotProsHT2=$HTotCtc; }else{ $TotProsHT2=$HTotP; }
if($_REQUEST['YI']>=8){ $Camt2=$resHCtc; }else{ $Camt2=$resHGross; } 
...
?>	
      ...
      <td class="tdc"><input class="inpr" style="color:#0080FF;font-weight:bold;" id="PIS_<?php echo $sn; ?>" name="PIS_<?php echo $sn; ?>" value="<?php echo floatval($TotProsHT2); ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_OneProInc(<?php echo $sn; ?>)" onClick="Cal_OneProInc(<?php echo $sn; ?>)" onChange="Cal_OneProInc(<?php echo $sn; ?>)" <?php } ?> disabled/></td>   
...
<?php /**************************** Without Un assigned Open************************************/?>
    <!--<tr style="height:24px;background-color:#7D7D00;">
	 <td colspan="20" class="th2" style="width:100%;text-align:left;">&nbsp;Total:&nbsp;&nbsp;Without Un assigned</td>
	</tr>-->
    <tr style="height:24px;background-color:#0076EC;">
     <td colspan="2" class="tdl" style="color:#FFFFFF;font-size:14px;">&nbsp;<b>Assig_Total:</b></td>
			   
<?php  
//Employee //Employee //Employee //Employee //Employee //Employee //Employee //Employee
$sqlET=mysql_query("select SUM(EmpCurrGrossPM)as EmpGross, SUM(EmpCurrIncentivePM) as EmpInct, SUM(EmpCurrCtc) as EmpTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_EmpRating!=0 AND p.CtcLimitCross=0 AND p.Appraiser_EmployeeID!=0", $con); $resET=mysql_fetch_array($sqlET);

$sql2ET=mysql_query("select SUM(EmpCurrAnnualBasic)as EmpBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_EmpRating!=0 AND p.CtcLimitCross=1 AND p.Appraiser_EmployeeID!=0", $con); $res2ET=mysql_fetch_array($sql2ET);

$NOET=mysql_query("select count(*) as NOET from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_EmpRating!=0 AND p.Appraiser_EmployeeID!=0", $con); $resNOET=mysql_fetch_array($NOET); $ET=$resET['EmpGross']+$resET['EmpInct']; ?>
<input type="hidden" name="EmpGrossT" id="EmpGrossT" value="<?php echo number_format($ET, 2, '.', ''); ?>" />
      <td class="tdc" style="color:#FFFFFF;"><?php echo $resNOET['NOET']; ?></td>   	
<?php if($_REQUEST['YI']>=8){$et_gross=$resET['EmpTCtc']+$res2ET['EmpBasic'];}else{$et_gross=$ET;}?>	  		
	  <td class="tdr" style="color:#FFFFFF;"><?php echo floatval($et_gross); //$ET ?>&nbsp;</td>

<?php //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser //Appraiser 
$sqlAT=mysql_query("select SUM(EmpCurrGrossPM)as AppGross, SUM(EmpCurrIncentivePM) as AppInct, SUM(EmpCurrCtc) as AppTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_AppRating!=0 AND p.CtcLimitCross=0 AND p.Appraiser_EmployeeID!=0", $con); $resAT=mysql_fetch_array($sqlAT);

$sql2AT=mysql_query("select SUM(EmpCurrAnnualBasic)as AppBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_AppRating!=0 AND p.CtcLimitCross=1 AND p.Appraiser_EmployeeID!=0", $con); $res2AT=mysql_fetch_array($sql2AT);

$NOAT=mysql_query("select count(*) as NOAT from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_AppRating!=0 AND p.Appraiser_EmployeeID!=0", $con); $resNOAT=mysql_fetch_array($NOAT); $AT=$resAT['AppGross']+$resAT['AppInct']; ?>
<input type="hidden" name="AppGrossT" id="AppGrossT" value="<?php echo number_format($AT, 2, '.', ''); ?>" />
      <td class="tdc" style="color:#FFFFFF;"><?php echo $resNOAT['NOAT']; ?></td>
<?php if($_REQUEST['YI']>=8){$at_gross=$resAT['AppTCtc']+$res2AT['AppBasic'];}else{$at_gross=$AT;}?>	     			
	  <td class="tdr" style="color:#FFFFFF;"><?php echo floatval($at_gross); //$AT ?>&nbsp;</td> 


<?php //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer //Reviewer 
$sqlRT=mysql_query("select SUM(EmpCurrGrossPM)as RevGross, SUM(EmpCurrIncentivePM) as RevInct, SUM(EmpCurrCtc) as RevTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_RevRating!=0 AND p.CtcLimitCross=0 AND p.Appraiser_EmployeeID!=0", $con); $resRT=mysql_fetch_array($sqlRT);

$sql2RT=mysql_query("select SUM(EmpCurrAnnualBasic)as RevBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_RevRating!=0 AND p.CtcLimitCross=1 AND p.Appraiser_EmployeeID!=0", $con); $res2RT=mysql_fetch_array($sql2RT);

$NORT=mysql_query("select count(*) as NORT from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_RevRating!=0 AND p.Appraiser_EmployeeID!=0", $con); $resNORT=mysql_fetch_array($NORT); $RT=$resRT['RevGross']+$resRT['RevInct']; ?>
<input type="hidden" name="RevGrossT" id="RevGrossT" value="<?php echo number_format($RT, 2, '.', ''); ?>" />
      <td class="tdc" style="color:#FFFFFF;"><?php echo $resNORT['NORT']; ?></td>
<?php if($_REQUEST['YI']>=8){$rt_gross=$resRT['RevTCtc']+$res2RT['RevBasic'];}else{$rt_gross=$RT;}?>	     			
	  <td class="tdr" style="color:#FFFFFF;"><?php echo floatval($rt_gross); //$RT ?>&nbsp;</td>
		
<?php //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD //HOD 
$sqlHT=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrIncentivePM) as HodInct, SUM(EmpCurrCtc) as HodTCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_HodRating!=0 AND p.CtcLimitCross=0 AND p.Appraiser_EmployeeID!=0", $con); $resHT=mysql_fetch_array($sqlHT);

$sql2HT=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrAnnualBasic)as HodBasic from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_HodRating!=0 AND p.CtcLimitCross=1 AND p.Appraiser_EmployeeID!=0", $con); $res2HT=mysql_fetch_array($sql2HT);

$NOHT=mysql_query("select count(*) as NOHT from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Dummy_HodRating!=0 AND p.Appraiser_EmployeeID!=0", $con); $resNOHT=mysql_fetch_array($NOHT); $HT=$resHT['HodGross']+$res2HT['HodGross']+$resHT['HodInct']; ?>
<input type="hidden" name="HodGrossT" id="HodGrossT" value="<?php echo number_format($HT, 2, '.', ''); ?>" />
<input type="hidden" name="HodCtcT" id="HodCtcT" value="<?php echo number_format($resHT['HodTCtc'], 2, '.', ''); ?>" />
      <td class="tdc" style="color:#FFFFFF;"><?php echo $resNOHT['NOHT']; ?></td>   			
	  <td class="tdr" style="color:#FFFFFF;"><?php echo floatval($HT); ?>&nbsp;</td>
	  <td class="tdr" style="color:#FFFFFF;"><?php echo floatval($resHT['HodTCtc']+$res2HT['HodBasic']); ?>&nbsp;</td>			   
...
<?php $sql4I=mysql_query("select TIncGross,TPerInc,TInc from hrm_pms_dummy_increment_untot where YearId=".$_REQUEST['YI']." AND ".$ExtQuery." AND CompanyId=".$CompanyId, $con); $res4I=mysql_fetch_array($sql4I);
	  $sqlD=mysql_query("select SUM(EmpCurrGrossPM)as DeptTotGross, SUM(EmpCurrIncentivePM) as DeptInct, SUM(EmpCurrCtc) as HotDeptCtc from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND (p.Dummy_EmpRating!=0 AND p.Dummy_AppRating!=0 AND p.Dummy_RevRating!=0 AND p.Dummy_HodRating!=0) AND p.Appraiser_EmployeeID!=0", $con); $resD=mysql_fetch_assoc($sqlD);
...
?>			   	
	  ...
	  <?php /*?><td class="tdc"><input class="inpr" style="font-weight:bold;background-color:#0076EC;color:#FFFFFF;" id="PISCtcT" name="PISCtcT" value="<?php echo floatval($H555I); ?>" readonly/></td><?php */?> 
	  
	  <input type="hidden" class="inpr" style="font-weight:bold;background-color:#0076EC;color:#FFFFFF;" id="PISCtcT" name="PISCtcT" value="<?php echo floatval($H555I); ?>" readonly/>	
...
if($resHTotPT['HotDeptCtc']>0){$HTotPTCtc=$resHTotPT['HotDeptCtc'];}else{$HTotPTCtc=0;}
if($_REQUEST['YI']>=8){ $TotProsHT=$HTotPTCtc; }else{ $TotProsHT=$HTotPTCtc; }
if($_REQUEST['YI']>=8){ $Camt4=$resHT['HodTCtc']; }else{ $Camt4=$HT; }

$OnePerT=($Camt4*1)/100; 
if($resHTotPT['HodTotIncS']>0 AND $OnePerT>0){ $Inc_PerT=$resHTotPT['HodTotIncS']/$OnePerT; }else{ $Inc_PerT=0; }
$round_PerIncT=round($Inc_PerT,2); //echo $round_PerIncT;
...
?>	
      <td class="tdc"><input class="inpr" style="font-weight:bold;background-color:#0076EC;color:#FFFFFF;" id="PIST" name="PIST" value="<?php echo floatval($TotProsHT); ?>" readonly/></td>
	  <td class="tdc"><input class="inpc" style="font-weight:bold;background-color:#0076EC;color:#FFFFFF;" id="PerIST" name="PerIST" value="<?php echo $round_PerIncT; ?>" readonly/></td>
...
<?php /* if($_REQUEST['YI']!=$YearId){ ?> 
<?php /**************************************** HOD Proposed Total Value Start ********************************* ?>		
<?php /**************************************** HOD Proposed Total Value Start ********************************* ?>
...
<?php /**************************************** HOD Proposed Total Value Close ********************************* ?>		
<?php /**************************************** HOD Proposed Total Value Close ********************************* ?>	
<?php } */ ?>     
...
<?php /**************************** Unussed Open ************************************/?>
     <!--<tr style="height:24px;background-color:#7D7D00;">
	  <td colspan="20" class="th2" style="width:100%;text-align:left;">&nbsp;Total:&nbsp;&nbsp;With Un assigned</td>
	 </tr>-->
     <tr style="height:24px;background-color:#0076EC;">
      <td colspan="2" class="tdl" style="color:#FFFFFF;font-size:14px;">&nbsp;<b>Un-assigned:</b></td>
...
if($resEUn['UnEmpGross']>0){$UnEmpGross=$resEUn['UnEmpGross']+$resEUn['UnEmpInct'];}else{$UnEmpGross=0;} ?>
 <input type="hidden" name="UnEmpGross" id="UnEmpGross" value="<?php echo $UnEmpGross; ?>" />
      <td class="tdc" style="color:#FFFFFF;"><?php echo $resNOEUn['NOEUn']; ?></td>
	  <td class="tdr" style="color:#FFFFFF;"><?php echo $UnEmpGross; ?>&nbsp;</td>
...
if($resAUn['UnAppGross']>0){$UnAppGross=$resAUn['UnAppGross']+$resAUn['UnAppInct'];}else{$UnAppGross=0;} ?>
 <input type="hidden" name="UnAppGross" id="UnAppGross" value="<?php echo $UnAppGross; ?>" />
      <td class="tdc" style="color:#FFFFFF;"><?php echo $resNOAUn['NOAUn']; ?></td>
	  <td class="tdr" style="color:#FFFFFF;"><?php echo $UnAppGross; ?>&nbsp;</td>
...
if($resRUn['UnRevGross']>0){$UnRevGross=$resRUn['UnRevGross']+$resRUn['UnRevInct'];}else{$UnRevGross=0;} ?>
 <input type="hidden" name="UnRevGross" id="UnRevGross" value="<?php echo $UnRevGross; ?>" />
      <td class="tdc" style="color:#FFFFFF;"><?php echo $resNORUn['NORUn']; ?></td>
	  <td class="tdr" style="color:#FFFFFF;"><?php echo $UnRevGross; ?>&nbsp;</td>
...
if($resHUn['UnHodTCtc']>0){$UnHodCtc=$resHUn['UnHodTCtc'];}else{$UnHodCtc=0;} ?>
 <input type="hidden" name="UnHodGross" id="UnHodGross" value="<?php echo $UnHodGross; ?>" />
 <input type="hidden" name="UnHodCtc" id="UnHodCtc" value="<?php echo $UnHodCtc; ?>" />
      <td class="tdc" style="color:#FFFFFF;"><?php echo $resNOHUn['NOHUn']; ?></td>
	  <td class="tdr" style="color:#FFFFFF;"><?php echo $UnHodGross; ?>&nbsp;</td>	
	  <td class="tdr" style="color:#FFFFFF;"><?php echo floatval($UnHodCtc); ?>&nbsp;</td>			   
...
<?php /**************************************** Dummy Start *********************************/ ?>	
<?php /**************************************** Dummy Start *********************************/ ?>			   
<?php $sql3I=mysql_query("select IncGross,PerInc,Inc from hrm_pms_dummy_increment_un where YearId=".$_REQUEST['YI']." AND ".$ExtQuery." AND CompanyId=".$CompanyId, $con);
      $sqlCH=mysql_query("select Dummy_HodRating from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND p.Dummy_HodRating=0", $con); $rowCH=mysql_num_rows($sqlCH);

if($rowCH==0){ $Pre_GrossValue=0; } 
else{ $sqlD=mysql_query("select SUM(EmpCurrGrossPM)as DeptTotGross, SUM(EmpCurrIncentivePM) as DeptInct from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND p.Dummy_HodRating=0", $con); $resD=mysql_fetch_assoc($sqlD);
$Pre_GrossValue=$resD['DeptTotGross']+$resD['DeptInct']; }
...
//if($_REQUEST['YI']>=8){ $Camt4=$resHT['HodTCtc']; }else{ $Camt4=$HT; }
      ...
      <td class="tdc"><input class="inpr" style="color:#FFFFFF;font-weight:bold;background-color:#0076EC;" id="UnPIS" name="UnPIS" value="<?php echo '';//$H22I; ?>" onKeyDown="OneUn()" onClick="OneUn()" onChange="OneUn()" disabled /></td>
      <td class="tdc"><input class="inpc" style="color:#FFFFFF;font-weight:bold;background-color:#0076EC;" id="UnPerIS" name="UnPerIS" value="<?php echo '';//$H33I; ?>" onKeyDown="TwoUn()" onChange="TwoUn()" disabled /></td>
	  <td class="tdc"><input class="inpr" style="color:#FFFFFF;font-weight:bold;background-color:#0076EC;" id="UnIncS" name="UnIncS" value="<?php echo '';//$H44I; ?>" onKeyDown="ThreeUn()" onClick="ThreeUn()" onChange="ThreeUn()" disabled /></td>
...
<?php /**************************************** Actual Value Start *********************************/ ?>		
<?php /**************************************** Actual Value Start *********************************/ ?>			   
<?php $sqlUnHTotP=mysql_query("select SUM(HR_GrossMonthlySalary)as UnHodTotP, SUM(HR_IncNetMonthalySalary)as UnHodTotIncS from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND e.EmpStatus='A' AND p.Dummy_HodRating=0",$con); $resUnHTotP=mysql_fetch_array($sqlUnHTotP);
 
if($resUnHTotP['UnHodTotP']>0){$UnHTotP=$resUnHTotP['UnHodTotP'];}else{$UnHTotP=0;} 
$UnOnePer=($UnHodGross*1)/100; 
if($resUnHTotP['UnHodTotIncS']>0 AND $UnOnePer>0){$UnInc_Per=$resUnHTotP['UnHodTotIncS']/$UnOnePer; }else{ $UnInc_Per=0; }
$Unround_PerInc=round($UnInc_Per,2);
if($resUnHTotP['UnHodTotIncS']>0){$UnHTotIncS=$resUnHTotP['UnHodTotIncS'];}else{$UnHTotIncS=0;}	?>					      
      <td class="tdc" colspan="11">&nbsp;</td>
	  
	  <?php /*?><td class="tdc"><input class="inpr" style="color:#FFFFFF;font-weight:bold;background-color:#0076EC;" id="UnPIS" name="UnPIS" value="<?php echo '';//$UnHTotP; ?>" onKeyDown="OneUn()" onClick="OneUn()" onChange="OneUn()" disabled /></td>			
	  <td class="tdc"><input class="inpc" style="color:#FFFFFF;font-weight:bold;background-color:#0076EC;" id="UnPerIS" name="UnPerIS" value="<?php echo '';//$Unround_PerInc; ?>" onKeyDown="TwoUn()" onChange="TwoUn()" disabled /></td>
	  <td class="tdc"><input class="inpr" style="color:#FFFFFF;font-weight:bold;background-color:#0076EC;" id="UnIncS" name="UnIncS" value="<?php echo '';//$UnHTotIncS; ?>" onKeyDown="ThreeUn()" onClick="ThreeUn()" onChange="ThreeUn()" disabled /></td>		
	  <td class="tdc">&nbsp;TTctc</td> <?php */?>  
<?php /**************************************** Actual Value Close *********************************/ ?>
<?php /**************************************** Actual Value Close *********************************/ ?>			
<?php } ?>
...
<?php /**************************************** Un-HOD Actual Total Value Start ********************************* ?>			
<?php $sqlUnHTotP2=mysql_query("select SUM(Hod_GrossMonthlySalary)as UnHodTotP2, SUM(Hod_IncNetMonthalySalary)as UnHodTotIncS2 from hrm_employee_pms p INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where p.AssessmentYear=".$_REQUEST['YI']." AND p.CompanyId=".$CompanyId." ".$query." ".$query_y." AND p.Appraiser_EmployeeID!=0 AND e.EmpStatus='A' AND p.Hod_TotalFinalRating=0", $con); $resUnHTotP2=mysql_fetch_array($sqlUnHTotP2);

if($resUnHTotP2['UnHodTotP2']>0){$UnHTotP2=$resUnHTotP2['UnHodTotP2'];}else{$UnHTotP2=0;}  
$UnOnePer2=($UnHodGross*1)/100; 
if($resUnHTotP2['UnHodTotIncS2']>0 AND $UnOnePer2>0){$UnInc_Per2=$resUnHTotP2['UnHodTotIncS2']/$UnOnePer2;}else{$UnInc_Per2=0;}
$Unround_PerInc2=round($UnInc_Per2,2);
if($resUnHTotP2['UnHodTotIncS2']>0){$UnHTotIncS2=$resUnHTotP2['UnHodTotIncS2'];}else{$UnHTotIncS2=0;} ?>
      <?php /*?><td class="tdr" style="color:#FFFFFF;"><?php echo '';//$UnHTotP2; ?>&nbsp;</td>   
	  <td class="tdc" style="color:#FFFFFF;"><?php echo '';//$Unround_PerInc2; ?></td>
	  <td class="tdr" style="color:#FFFFFF;"><?php echo '';//$UnHTotIncS2; ?>&nbsp;</td>	
	  <td class="tdc" style="color:#FFFFFF;"><?php echo '';//$Unround_PerInc2; ?></td>
	  <td class="tdr" style="color:#FFFFFF;"><?php echo '';//$UnHTotIncS2; ?>&nbsp;</td>	
	  <td class="tdc" style="color:#FFFFFF;"><?php echo '';//$Unround_PerInc2; ?></td>
	  <td class="tdr" style="color:#FFFFFF;"><?php echo '';//$UnHTotIncS2; ?>&nbsp;</td><?php */?>	 
