...
<table border="0" style="margin-top:0px; width:100%; height:300px;">
 <tr>
  <td align="left" height="20" valign="top" colspan="3">
   <table border="0">
    <tr>
	  <td class="heading" valign="top" style="width:800px;">Paid Values of Salary Components&nbsp;&nbsp; 
<?php 
...
<?php for($i=4; $i<=15; $i++){ if($i==4){$mn='APR';}elseif($i==5){$mn='MAY';}elseif($i==6){$mn='JUN';}elseif($i==7){$mn='JUL';}elseif($i==8){$mn='AUG';}elseif($i==9){$mn='SEP';}elseif($i==10){$mn='OCT';}elseif($i==11){$mn='NOV';}elseif($i==12){$mn='DEC';}elseif($i==13){$mn='JAN';}elseif($i==14){$mn='FEB';}elseif($i==15){$mn='MAR';}?>   
   <td align="center" class="font" style="width:100px;"><?php echo $mn; ?></td>
<?php } ?>
   <td align="center" class="font" style="width:100px;">TOTAL</td>
  </tr>
...
<tr id="TR<?php echo '39'; ?>">
   <td align="center" style="width:50px;"><input type="checkbox" id="Chk<?php echo '39'; ?>" onClick="FucChk(<?php echo '39'; ?>)" /></td> 
   <td align="center" style="width:50px;" class="font1">&nbsp;<?php echo '10'; ?>&nbsp;</td>
...
$TotG1=$res1['Bas']+$res1['Hra']+$res1['Con']+$res1['Ta']+$res1['Spe']+$res1['BonusM']+$res1['Da']+$res1['Inc']+$res1['Per']+$res1['Lea']+$res1['Var']+$res_1['VarRemburmnt']+$res1['Cca']+$res1['Ra']+$res1['Bon']+$res1['Ycea']+$res1['Ymr']+$res1['Ylta']+$res1['ArrBas']+$res1['ArrHra']+$res1['ArrCon']+$res1['ArrSpl']+$res1['CarAll']+$res1['ArrLvEncash']+$res1['ArrBonus']+$res1['ArrRA']+$res1['PP_Inc']; 
$TotG2=$res2['Bas']+$res2['Hra']+$res2['Con']+$res2['Ta']+$res2['Spe']+$res2['BonusM']+$res2['Da']+$res2['Inc']+$res2['Per']+$res2['Lea']+$res2['Var']+$res_2['VarRemburmnt']+$res2['Cca']+$res2['Ra']+$res2['Bon']+$res2['Ycea']+$res2['Ymr']+$res2['Ylta']+$res2['ArrBas']+$res2['ArrHra']+$res2['ArrCon']+$res2['ArrSpl']+$res2['CarAll']+$res2['ArrLvEncash']+$res2['ArrBonus']+$res2['ArrRA']+$res1['Bonus_Adjustment']+$res2['PP_Inc']; 
$TotG3=$res3['Bas']+$res3['Hra']+$res3['Con']+$res3['Ta']+$res3['Spe']+$res3['BonusM']+$res3['Da']+$res3['Inc']+$res3['Per']+$res3['Lea']+$res3['Var']+$res_3['VarRemburmnt']+$res3['Cca']+$res3['Ra']+$res3['Bon']+$res3['Ycea']+$res3['Ymr']+$res3['Ylta']+$res3['ArrBas']+$res3['ArrHra']+$res3['ArrCon']+$res3['ArrSpl']+$res3['CarAll']+$res3['ArrLvEncash']+$res3['ArrBonus']+$res3['ArrRA']+$res2['Bonus_Adjustment']+$res3['PP_Inc']; 
?>
