...
<tr>		  
 ...
 <td><select class="InputS" id="Period"><option value="Annual">Annually</option><option value="1/2 Annual">Half Yearly</option>
...
<tr>
 ...
 <td><select class="InputS" id="Period" name="Period"><option value="<?php echo $resPer['Period']; ?>" selected><?php if($resPer['Period']=='Annual'){echo 'Annually';}elseif($resPer['Period']=='1/2 Annual'){echo 'Half Yearly';}elseif($resPer['Period']=='Quarter'){echo 'Quarterly';}elseif($resPer['Period']=='Monthly'){echo 'Monthly';} ?></option><option value="Annual">Annually</option><option value="1/2 Annual">Half Yearly</option>
 <!--<option value="Quarter">Quarterly</option><option value="Monthly">Monthly</option>-->
 </select></td>
...
<?php /* While Open*/ $m=1; while($rSubB=mysql_fetch_assoc($sSubB)){ ?>
  ...
  <td align="center" style="background-color:#CAE4FF;"><select id="Per_a<?php echo $SNo.'_'.$m; ?>" class="Inputa" style="height:20px;"><option value="<?php echo $rSubB['Period']; ?>" selected><?php if($rSubB['Period']=='Annual'){echo 'Annually';}elseif($rSubB['Period']=='1/2 Annual'){echo 'Half Yearly';} ?></option><option value="Annual">Annually</option><option value="1/2 Annual">Half Yearly</option>
  <?php //elseif($rSubB['Period']=='Quarter'){echo 'Quarterly';}elseif($rSubB['Period']=='Monthly'){echo 'Monthly';} ?>
  <!--<option value="Quarter">Quarterly</option><option value="Monthly">Monthly</option>-->
  </select></td>
