...
class PHPlot
{
    ...
    protected $default_colors = array(
        'magenta', 'blue', 'green', 'orange', 'black', 'DarkGreen', 'purple', 'white', 'peru',
        'cyan', 'salmon', 'SlateBlue', 'YellowGreen', 'SkyBlue', 'aquamarine1', 'gold', 'violet'
    );
    ...
    protected $draw_x_data_label_lines = TRUE;
    ...
    protected $line_styles = array('solid', 'solid', 'solid', 'solid', 'solid');   //protected $line_styles = array('solid', 'solid', 'dashed');
...
/////////////////////////////////////////////
    ...
    protected function SetDefaultFonts()
    {
        ...
        return $this->SetFontGD('generic', 2)
            && $this->SetFontGD('title', 3)
            && $this->SetFontGD('legend', 2)
            && $this->SetFontGD('x_label', 2)
            && $this->SetFontGD('y_label', 2)
