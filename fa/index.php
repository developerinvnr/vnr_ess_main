...
date_default_timezone_set('Asia/Kolkata'); $DateTime=date("Y-m-d h:i:s");
  $sql = mysql_query("SELECT * FROM hrm_sales_tlemp WHERE TLUname='".$_POST['username']."' AND Type='FA' AND TLStatus='A'",$con); 
  ...
  { $EncPass=decrypt($row2['TLPwd']);  
    ...
    { $_SESSION['login'] = true; $_SESSION['TLUname']=$row2['TLUname'];  $_SESSION['ID']=$row2['TLEId']; 
	  $_SESSION['s1']=$row2['State1']; $_SESSION['s2']=$row2['State2']; $_SESSION['s3']=$row2['State3'];
	  header('Location:fah/index.php'); }
  }   
...
<table border="0" cellspacing="0" align="center">
 <tr><td align="center" colspan="2" style="height:50px;text-shadow:#DAE40E;color:#00FFFF;font-family:Times New Roman;font-size:22px;text-shadow:2px 2px 3px #24740A;">Sign In</td></tr>
 <tr><td style="font-family:Georgia; font-size:13px;color:#FFFFFF;">User Name &nbsp;:&nbsp;</td><td><input class="text_login" name="username" id="username"  maxlength="10"></td>

</tr><tr><td style="font-family:Georgia; font-size:13px;color:#FFFFFF;">Password &nbsp;:&nbsp;</td><td><input class="text_login" type="password" name="userpass" id="userpass"  maxlength="15"></td></tr>

</tr><tr><td style="font-family:Georgia; font-size:13px;color:#FFFFFF;">Year &nbsp;:&nbsp;</td><td style="font-family:Times New Roman;font-size:16px;color:#FFBB77; font-weight:bold;">
