...
<script>function Funchk(i){if(document.getElementById("m"+i).checked==true){document.getElementById("Chhk"+i).value=1;}else{document.getElementById("Chhk"+i).value=0;}}</script>		
		...
		&nbsp;&nbsp;&nbsp;<span class="tdf">&nbsp;Year&nbsp;&nbsp;</sapn><select style="width:60px;" class="InputSel" id="year" name="year" onChange="funyear(this.value,<?php echo $m.','.$_REQUEST['s'].','.$_REQUEST['hq'].','.$md.','.$rbm.','.$abm; ?>)"><option value="<?php echo $y; ?>" selected="selected"><?php echo $y; ?></option><?php for($j=2020;$j<=date("Y");$j++){ if($j!=$y){ ?><option value="<?php echo $j; ?>"><?php echo $j; ?></option><?php }} ?></select>
