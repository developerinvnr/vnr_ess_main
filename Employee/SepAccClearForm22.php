...
<b><span id="HrSpan"><?php if($resSE['Acc_HrNOC']=='Y'){echo 'HR clearance ok';}elseif($resSE['Acc_HrNOC']=='R'){echo 'Clearance form send it back to HR';} ?></span></b></td>
   <td>&nbsp;</td>
<?php if($resSE['HR_NOC']=='Y' AND $resSE['Acc_HrNOC']=='N'){ // AND date("Y-m-d")<$resSE['HR_Date'] ?> 
  ...
  <td valign="top"><?php //01-Open// ?>
   <table border="1">
	...
	<tr bgcolor="#FFFFFF" style="display:none;">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="VA" name="VA" value="<?php echo ''; ?>" onChange="funVA()" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF" style="display:none;">
	 <td colspan="2" class="Text">&nbsp;Performance Pay</td>
	 <td class="Text" align="center"><input class="AIT" id="PP" name="PP" value="<?php echo ''; ?>" onChange="funPP()" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF" style="display:none;">
	 <td colspan="2" class="Text">&nbsp;City Compensatory Allow.</td>
	 <td class="Text" align="center"><input class="AIT" id="CCC" name="CCA" value="<?php echo ''; ?>" onChange="funCCA()" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF" style="display:none;">
	 <td colspan="2" class="Text">&nbsp;Relocation Allow.</td>
	 <td class="Text" align="center"><input class="AIT" id="RA" name="RA" value="<?php echo ''; ?>" onChange="funRA()" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="RTSB" name="RTSB" value="<?php if($hr['RTSB']>0){echo intval($hr['RTSB']);}else{echo 0;} ?>" onChange="funRtsb()" onBlur="funRtsb()" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
...
<td style="width:50px;" align="center"><input class="DIT" id="EnCashEL" name="EnCashEL" onChange="FunEnCash()" onBlur="FunEnCash()" onClick="FunEnCash()" value="<?php if($hr['EnCashEL']>0){echo $hr['EnCashEL'];}else{echo 0;} ?>" maxlength="2" readonly/></td>
   ...
   <table border="1">
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="TotDeduct" name="TotDeduct" style="font-weight:bold;background-color:#0079F2;color:#FFFFFF;" value="<?php echo $hr['PF']+$hr['NPR']+$hr['CV_Amt']; ?>" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
...
<b><span id="ItSpan"><?php if($resSE['Acc_ItNOC']=='Y'){echo 'IT clearance ok';}elseif($resSE['Acc_ItNOC']=='R'){echo 'Clearance form send it back to IT';} ?></span></b></td>
     <td>&nbsp;</td>
<?php if($resSE['IT_NOC']=='Y' AND $resSE['Acc_ItNOC']=='N'){ // AND date("Y-m-d")<$resSE['HR_Date'] ?> 
...
<?php } ?>   
	...
	<tr bgcolor="#7a6189">
	   ...
	   <td class="Text" style="width:180px;color:#FFFFFF;" align="center"><b>Remark</b></td>
    </tr>
<?php $sqlit=mysql_query("select * from hrm_employee_separation_nocit where EmpSepId=".$_REQUEST['si'], $con); $it=mysql_fetch_assoc($sqlit);?>
	  <tr bgcolor="#FFFFFF">
	   ...
	   <td class="Text" style="width:100px;" align="center">Yes<?php if($it['ItSS']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($it['ItSS']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="ItSS_YN" name="ItSS_YN" value="<?php echo $it['ItSS']; ?>" /></td>
	   ...
	   <td class="Text" style="width:180px;" align="center" valign="top"><input id="ItSS_Remark" name="ItSS_Remark" style="width:178px;" value="<?php echo $it['ItSS_Remark'] ?>" readonly/></td>
     </tr> 
	 <tr bgcolor="#FFFFFF">
       <td class="Text" style="width:30px;" align="center">2</td>
       <td class="Text" style="width:230px;" align="">&nbsp;Company Handset Submitted</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($it['ItCHS']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($it['ItCHS']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="ItCHS_YN" name="ItCHS_YN" value="<?php echo $it['ItCHS']; ?>" /></td>
	   ...
	   <td class="Text" style="width:180px;" align="center" valign="top"><input id="ItCHS_Remark" name="ItCHS_Remark" style="width:178px;" value="<?php echo $it['ItCHS_Remark'] ?>" readonly/></td>
     </tr>
	 <tr bgcolor="#FFFFFF">
       <td class="Text" style="width:30px;" align="center">3</td>
       <td class="Text" style="width:230px;" align="">&nbsp;Laptop/ Desktop Handover</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($it['ItLDH']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($it['ItLDH']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="ItLDH_YN" name="ItLDH_YN" value="<?php echo $it['ItLDH']; ?>" /></td>
	   ...
	   <td class="Text" style="width:180px;" align="center" valign="top"><input id="ItLDH_Remark" name="ItLDH_Remark" style="width:178px;" value="<?php echo $it['ItLDH_Remark'] ?>" readonly/></td>
     </tr> 
	 <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:30px;" align="center">4</td>
       <td class="Text" style="width:230px;" align="">&nbsp;Camera Submitted</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($it['ItCS']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($it['ItCS']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="ItCS_YN" name="ItCS_YN" value="<?php echo $it['ItCS']; ?>" /></td>
	   ...
	   <td class="Text" style="width:180px;" align="center" valign="top"><input id="ItCS_Remark" name="ItCS_Remark" style="width:178px;" value="<?php echo $it['ItCS_Remark'] ?>" readonly/></td>
     </tr>
	  <tr bgcolor="#FFFFFF">
       <td class="Text" style="width:30px;" align="center">5</td>
       <td class="Text" style="width:230px;" align="">&nbsp;Datacard Submitted</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($it['ItDC']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($it['ItDC']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="ItDC_YN" name="ItDC_YN" value="<?php echo $it['ItDC']; ?>" /></td>
	   ...
	   <td class="Text" style="width:180px;" align="center" valign="top"><input id="ItDC_Remark" name="ItDC_Remark" style="width:178px;" value="<?php echo $it['ItDC_Remark'] ?>" readonly/></td>
     </tr>
	  <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:30px;" align="center">6</td>
       <td class="Text" style="width:230px;" align="">&nbsp;Email Account Blocked</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($it['ItEAB']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($it['ItEAB']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="ItEAB_YN" name="ItEAB_YN" value="<?php echo $it['ItEAB']; ?>" /></td>
	   ...
	   <td class="Text" style="width:180px;" align="center" valign="top"><input id="ItEAB_Remark" name="ItEAB_Remark" style="width:178px;" value="<?php echo $it['ItEAB_Remark'] ?>" readonly/></td>
     </tr> 
	  <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:30px;" align="center">7</td>
       <td class="Text" style="width:230px;" align="">&nbsp;Mob. No. Disabled/ Transfered</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($it['ItMND']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($it['ItMND']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="ItMND_YN" name="ItMND_YN" value="<?php echo $it['ItMND']; ?>" /></td>
	   ...
	   <td class="Text" style="width:180px;" align="center" valign="top"><input id="ItMND_Remark" name="ItMND_Remark" style="width:178px;" value="<?php echo $it['ItMND_Remark'] ?>" readonly/></td>
     </tr>
<?php for($i=8; $i<=15; $i++) { if($it['ItAO_Txt'.$i]!=''){ ?>   	 
	  <tr bgcolor="#FFFFFF"> 
	   ...
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($it['ItAO'.$i]=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($it['ItAO'.$i]=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="ItAO_YN<?php echo $i; ?>" name="ItAO_YN<?php echo $i; ?>" value="<?php echo $it['ItAO'.$i]; ?>" /></td>
	   ...
	   <td class="Text" style="width:180px;" align="center" valign="top"><input id="ItAO_Remark<?php echo $i; ?>" name="ItAO_Remark<?php echo $i; ?>" style="width:178px;" value="<?php echo $it['ItAO_Remark'.$i] ?>" readonly/></td>
     </tr>
...
<b><span id="RepSpan"><?php if($resSE['Acc_RepNOC']=='Y'){echo 'Reporting clearance ok';}elseif($resSE['Acc_RepNOC']=='R'){echo 'Clearance form send it back to reporting';} ?></span></b></td>
       <td>&nbsp;</td>
  <?php if($resSE['Rep_NOC']=='Y' AND $resSE['Acc_RepNOC']=='N'){ // AND date("Y-m-d")<$resSE['HR_Date'] ?>
...
<?php $sqlRep=mysql_query("select * from hrm_employee_separation_nocrep where EmpSepId=".$_REQUEST['si'], $con); $rep=mysql_fetch_assoc($sqlRep); ?>
     <tr bgcolor="#FFFFFF">
	   ...
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($rep['DDH']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($rep['DDH']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="DDH_YN" name="DDH_YN" value="<?php echo $rep['DDH']; ?>" /></td>
	  ...
	  <tr bgcolor="#FFFFFF"> 
	   ...
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($rep['TID']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($rep['TID']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="TID_YN" name="TID_YN" value="<?php echo $rep['TID']; ?>" /></td>
	 ...
	 <tr bgcolor="#FFFFFF"> 
	   ...
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($rep['APTC']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($rep['APTC']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="APTC_YN" name="APTC_YN" value="<?php echo $rep['APTC']; ?>" /></td>
	 ...
	 <tr bgcolor="#FFFFFF"> 
	   ...
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($rep['HOAS']=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($rep['HOAS']=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="HOAS_YN" name="HOAS_YN" value="<?php echo $rep['HOAS']; ?>" /> </td>
...
<?php for($i=1; $i<=10; $i++) { if($rep['Prtis'.$i]!=''){ ?>    	 
	  <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:30px;" align="center"><?php echo $i; ?></td>
	   ...
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<?php if($rep['Prtis_'.$i]=='Y'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?>&nbsp;&nbsp;No<?php if($rep['Prtis_'.$i]=='N'){echo '<img src="images/checkbox_UnCheck.png" border="0"/>';}else{echo '<img src="images/checkbox.png" border="0"/>';}?><input type="hidden" id="Prtis_YN<?php echo $i; ?>" name="Prtis_YN<?php echo $i; ?>" value="<?php echo $rep['Prtis_'.$i]; ?>" /></td>
...
{ if(v=='Y'){document.getElementById("AccECP_Y").checked = true;document.getElementById("AccECP_N").checked=false;document.getElementById("AccECP_YN").value='Y'; 
  document.getElementById("AccECP_Amt").readOnly=false; document.getElementById("AccECP_Amt").style.background='#FFFFFF';
  ...
  document.getElementById("AccECP_Amt").readOnly=true;  document.getElementById("AccECP_Amt").style.background='#EAEAEA';
...
{ if(v=='Y'){document.getElementById("AccIPS_Y").checked = true;document.getElementById("AccIPS_N").checked=false;document.getElementById("AccIPS_YN").value='Y';
  document.getElementById("AccIPS_Amt").readOnly=false; document.getElementById("AccIPS_Amt").style.background='#FFFFFF';
  ...
  document.getElementById("AccIPS_Amt").readOnly=true; document.getElementById("AccIPS_Amt").style.background='#EAEAEA';
...
{ if(v=='Y'){document.getElementById("AccAMS_Y").checked = true;document.getElementById("AccAMS_N").checked=false;document.getElementById("AccAMS_YN").value='Y';
  document.getElementById("AccAMS_Amt").readOnly=false; document.getElementById("AccAMS_Amt").style.background='#FFFFFF';
  ...
  document.getElementById("AccAMS_Amt").readOnly=true; document.getElementById("AccAMS_Amt").style.background='#EAEAEA';
...
{ if(v=='Y'){document.getElementById("AccSAR_Y").checked = true;document.getElementById("AccSAR_N").checked=false;document.getElementById("AccSAR_YN").value='Y';
  document.getElementById("AccSAR_Amt").readOnly=false; document.getElementById("AccSAR_Amt").style.background='#FFFFFF';
  ...
  document.getElementById("AccSAR_Amt").readOnly=true; document.getElementById("AccSAR_Amt").style.background='#EAEAEA';
...
{ if(v=='Y'){document.getElementById("AccWGR_Y").checked = true;document.getElementById("AccWGR_N").checked=false;document.getElementById("AccWGR_YN").value='Y';
  document.getElementById("AccWGR_Amt").readOnly=false; document.getElementById("AccWGR_Amt").style.background='#FFFFFF';
  ...
  document.getElementById("AccWGR_Amt").readOnly=true; document.getElementById("AccWGR_Amt").style.background='#EAEAEA';
...
{ if(v=='Y'){document.getElementById("AccSB_Y").checked = true;document.getElementById("AccSB_N").checked=false;document.getElementById("AccSB_YN").value='Y';
  document.getElementById("AccSB_Amt").readOnly=false; document.getElementById("AccSB_Amt").style.background='#FFFFFF';
  ...
  document.getElementById("AccSB_Amt").readOnly=true; document.getElementById("AccSB_Amt").style.background='#EAEAEA';
...
{ if(v=='Y'){document.getElementById("AccTDSA_Y").checked = true;document.getElementById("AccTDSA_N").checked=false;document.getElementById("AccTDSA_YN").value='Y';
  document.getElementById("AccTDSA_Amt").readOnly=false; document.getElementById("AccTDSA_Amt").style.background='#FFFFFF';
  ...
  document.getElementById("AccTDSA_Amt").readOnly=true; document.getElementById("AccTDSA_Amt").style.background='#EAEAEA';
...
{ if(v=='Y'){document.getElementById("AccAO_Y"+i).checked = true;document.getElementById("AccAO_N"+i).checked=false;document.getElementById("AccAO_YN"+i).value='Y';
  document.getElementById("AccAO_Amt"+i).readOnly=false; document.getElementById("AccAO_Amt"+i).style.background='#FFFFFF';
  ...
  document.getElementById("AccAO_Amt"+i).readOnly=true; document.getElementById("AccAO_Amt"+i).style.background='#EAEAEA';
...
<?php $sqlAcc=mysql_query("select * from hrm_employee_separation_nocacc where EmpSepId=".$_REQUEST['si'], $con); 
 ...
 <tr bgcolor="#FFFFDD">
  <td colspan="2">
  <table border="1"><tr><td colspan="2" class="Text" style="width:640px;color:#006200;background-color:#DFFFDF;" align="center"><b>ACCOUNT CLEARANCE FORM</b></td></tr></table>
  </td>
 </tr>
  <tr>	
  <td style="width:20px;"></td>
  <td style="width:620px;">
    <table border="1" style="width:620px;" bgcolor="#FFFFDD">
	  <tr bgcolor="#7a6189">
       <td class="Text" style="width:30px;color:#FFFFFF;" align="center"><b>Sn</b></td>
       <td class="Text" style="width:230px;color:#FFFFFF;" align="center"><b>Particular</b></td>
	   <td class="Text" style="width:100px;color:#FFFFFF;" align="center"><b>Yes/No</b></td>
	   ...
	   <td class="Text" style="width:140px;color:#FFFFFF;" align="center"><b>Remark</b></td>
     </tr>	 
	<tr bgcolor="#FFFFFF">
	   ...
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<input type="checkbox" id="AccECP_Y" onClick="FunECP('Y')" <?php if($acc['AccECP']=='Y'){echo 'Checked';} ?>/>&nbsp;No<input type="checkbox" id="AccECP_N" onClick="FunECP('N')" <?php if($acc['AccECP']=='N'){echo 'Checked';} ?>/><input type="hidden" id="AccECP_YN" name="AccECP_YN" value="<?php echo $acc['AccECP']; ?>" /></td>
	   ...
	   <td class="Text" style="width:140px;" align="center" valign="top">
	    <input id="AccECP_Remark" name="AccECP_Remark" style="width:130px;" value="<?php echo $acc['AccECP_Remark'] ?>" />
	   </td>
     </tr>
	 <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:30px;" align="center">2</td>
       <td class="Text" style="width:230px;" align="">&nbsp;Investment Proofs Submited</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<input type="checkbox" id="AccIPS_Y" onClick="FunIPS('Y')" <?php if($acc['AccIPS']=='Y'){echo 'Checked';} ?>/>&nbsp;No<input type="checkbox" id="AccIPS_N" onClick="FunIPS('N')" <?php if($acc['AccIPS']=='N'){echo 'Checked';} ?>/><input type="hidden" id="AccIPS_YN" name="AccIPS_YN" value="<?php echo $acc['AccIPS']; ?>" /></td>
	   <td class="Text" style="width:70px;" align="center" valign="top">
	   ...
	   <td class="Text" style="width:140px;" align="center" valign="top">
	    <input id="AccIPS_Remark" name="AccIPS_Remark" style="width:130px;" value="<?php echo $acc['AccIPS_Remark'] ?>" />
	   </td>
     </tr>
	 <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:30px;" align="center">3</td>
       <td class="Text" style="width:230px;" align="">&nbsp;Advance Amount Recovery</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<input type="checkbox" id="AccAMS_Y" onClick="FunAMS('Y')" <?php if($acc['AccAMS']=='Y'){echo 'Checked';} ?>/>&nbsp;No<input type="checkbox" id="AccAMS_N" onClick="FunAMS('N')" <?php if($acc['AccAMS']=='N'){echo 'Checked';} ?>/><input type="hidden" id="AccAMS_YN" name="AccAMS_YN" value="<?php echo $acc['AccAMS']; ?>" /></td>
	   <td class="Text" style="width:70px;" align="center" valign="top">
	   ...
	   <td class="Text" style="width:140px;" align="center" valign="top">
	    <input id="AccAMS_Remark" name="AccAMS_Remark" style="width:130px;" value="<?php echo $acc['AccAMS_Remark'] ?>" />
	   </td>
     </tr> 
	  <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:30px;" align="center">4</td>
       <td class="Text" style="width:230px;" align="">&nbsp;Salary Advance Recovery</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<input type="checkbox" id="AccSAR_Y" onClick="FunSAR('Y')" <?php if($acc['AccSAR']=='Y'){echo 'Checked';} ?>/>&nbsp;No<input type="checkbox" id="AccSAR_N" onClick="FunSAR('N')" <?php if($acc['AccSAR']=='N'){echo 'Checked';} ?>/><input type="hidden" id="AccSAR_YN" name="AccSAR_YN" value="<?php echo $acc['AccSAR']; ?>" /></td>
	   <td class="Text" style="width:70px;" align="center" valign="top">
	   ...
	   <td class="Text" style="width:140px;" align="center" valign="top">
	    <input id="AccSAR_Remark" name="AccSAR_Remark" style="width:130px;" value="<?php echo $acc['AccSAR_Remark'] ?>" />
	   </td>
     </tr> 
	 <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:30px;" align="center">5</td>
       <td class="Text" style="width:230px;" align="">&nbsp;White Goods Recovery</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<input type="checkbox" id="AccWGR_Y" onClick="FunWGR('Y')" <?php if($acc['AccWGR']=='Y'){echo 'Checked';} ?>/>&nbsp;No<input type="checkbox" id="AccWGR_N" onClick="FunWGR('N')" <?php if($acc['AccWGR']=='N'){echo 'Checked';} ?>/><input type="hidden" id="AccWGR_YN" name="AccWGR_YN" value="<?php echo $acc['AccWGR']; ?>" /></td>
	   <td class="Text" style="width:70px;" align="center" valign="top">
	   ...
	   <td class="Text" style="width:140px;" align="center" valign="top">
	    <input id="AccWGR_Remark" name="AccWGR_Remark" style="width:130px;" value="<?php echo $acc['AccWGR_Remark'] ?>" />
	   </td>
     </tr> 
	 <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:30px;" align="center">6</td>
       <td class="Text" style="width:230px;" align="">&nbsp;Service Bond</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<input type="checkbox" id="AccSB_Y" onClick="FunSB('Y')" <?php if($acc['AccSB']=='Y'){echo 'Checked';} ?>/>&nbsp;No<input type="checkbox" id="AccSB_N" onClick="FunSB('N')" <?php if($acc['AccSB']=='N'){echo 'Checked';} ?>/><input type="hidden" id="AccSB_YN" name="AccSB_YN" value="<?php echo $acc['AccSB']; ?>" /></td>
	   <td class="Text" style="width:70px;" align="center" valign="top">
	   ...
	   <td class="Text" style="width:140px;" align="center" valign="top">
	    <input id="AccSB_Remark" name="AccSB_Remark" style="width:130px;" value="<?php echo $acc['AccSB_Remark'] ?>" />
	   </td>
     </tr> 
	 <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:30px;" align="center">7</td>
       <td class="Text" style="width:230px;" align="">&nbsp;TDS Adjustment</td>
	   <td class="Text" style="width:100px;" align="center" valign="top">Yes<input type="checkbox" id="AccTDSA_Y" onClick="FunTDSA('Y')" <?php if($acc['AccTDSA']=='Y'){echo 'Checked';} ?>/>&nbsp;No<input type="checkbox" id="AccTDSA_N" onClick="FunTDSA('N')" <?php if($acc['AccTDSA']=='N'){echo 'Checked';} ?>/><input type="hidden" id="AccTDSA_YN" name="AccTDSA_YN" value="<?php echo $acc['AccTDSA']; ?>" /></td>
	   <td class="Text" style="width:70px;" align="center" valign="top">
	   ...
	   <td class="Text" style="width:140px;" align="center" valign="top">
	    <input id="AccTDSA_Remark" name="AccTDSA_Remark" style="width:130px;" value="<?php echo $acc['AccTDSA_Remark'] ?>" />
	   </td>
     </tr> 
...
<?php for($i=8; $i<=15; $i++) { ?>  
  <tr>
   ...
   <td>
    <table style="width:620px;display:none;" id="Row<?php echo $i; ?>" border="1" cellspacing="0" bgcolor="#FFFFDD">
	  <tr bgcolor="#FFFFFF"> 
	   ...
	   <td class="Text" style="width:105px;" align="center" valign="top">Yes<input type="checkbox" id="AccAO_Y<?php echo $i; ?>" onClick="FunAccAO(<?php echo $i; ?>,'Y')" <?php if($acc['AccAO'.$i]=='Y'){echo 'Checked';} ?>/>&nbsp;No<input type="checkbox" id="AccAO_N<?php echo $i; ?>" onClick="FunAccAO(<?php echo $i; ?>,'N')" <?php if($acc['AccAO'.$i]=='N'){echo 'Checked';} ?>/><input type="hidden" id="AccAO_YN<?php echo $i; ?>" name="AccAO_YN<?php echo $i; ?>" value="<?php echo $acc['AccAO'.$i]; ?>" /></td>
	   ...
	   <td class="Text" style="width:140px;" align="center" valign="top">
	    <input id="AccAO_Remark<?php echo $i; ?>" name="AccAO_Remark<?php echo $i; ?>" style="width:130px;" value="<?php echo $acc['AccAO_Remark'.$i] ?>" />
	   </td>
     </tr>
	</table>
   </td>
...
<?php for($i=8; $i<=15; $i++) { if($acc['AccAO_Txt'.$i]!=''){ ?>  
  <tr>
   ...
   <td>
    <table style="width:620px;display:block;" id="Row<?php echo $i; ?>" border="1" cellspacing="0" bgcolor="#FFFFDD">
	  <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:38px;" align="center"><?php echo $i; ?></td>
       <td class="Text" style="width:190px;" align="" valign="top">
	   <input style="width:180px;" id="AccAO_Txt<?php echo $i; ?>" name="AccAO_Txt<?php echo $i; ?>" value="<?php echo $acc['AccAO_Txt'.$i]; ?>"/>
...
<?php } ?>
  <tr>
   ...
   <td>
    <table style="width:620px;" border="1" cellspacing="0" bgcolor="#FFFFDD">
	  <tr bgcolor="#FFFFFF"> 
       <td class="Text" style="width:260px;">&nbsp;<b>Any Other Remark</b></td>
	   <td class="Text" style="width:384px;" align="center" valign="top">
	    <input id="AccOth_Remark" name="AccOth_Remark" style="width:384px;" value="<?php echo $res['AccOth_Remark']; ?>" maxlength="190" />
	   </td> 
     </tr>
	</table>
   </td>
