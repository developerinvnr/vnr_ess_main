...
if(isset($_POST['reqSubmit']))
{
 ...
 $dv = intval(date("d"));
 $s2E=mysql_query("select I".$dv." from hrm_employee_attendance_settime where EmployeeID=".$_POST['EId'],$con); 
 $row2E=mysql_num_rows($s2E); $r2E=mysql_fetch_assoc($s2E);
 if($row2E>0){ $InTime=date("H:i:00",strtotime($r2E['I'.$dv])); } 
 
 $Ins=mysql_query("insert into hrm_employee_attendance_req(EmployeeID, AttDate, InReason, InRemark, OutReason, OutRemark, Reason, Remark, RId, HId, HtId, InR, OutR, ReqDate, ReqTime, CrDate, CrTime) values(".$_POST['EId'].", '".$_POST['AttDate']."', '".$_POST['reasonI']."', '".$RemarkI."', '".$_POST['reasonO']."', '".$RemarkO."', '".$_POST['reason']."', '".$Remark."', ".$RId.", ".$HId.", ".$HtId.", '".$InR."', '".$OutR."', '".date("Y-m-d")."', '".$ReqTime."', '".date("Y-m-d")."', '".$CrTime."')",$con);
 if($Ins)
 { 
...
/******************* Checking Checking Open **********/
if(($_POST['Atct']==1 AND ($_POST['reasonI']=='OD' OR $_POST['reasonI']=='WFH' OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting')) OR ($_POST['Atct']==2 AND ($_POST['reasonO']=='OD' OR $_POST['reasonO']=='WFH' OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting')) OR ($_POST['Atct']==12 AND ($_POST['reasonI']=='OD' OR $_POST['reasonI']=='WFH' OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting') AND ($_POST['reasonO']=='OD' OR $_POST['reasonO']=='WFH' OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting')) OR ($_POST['Atct']==3 AND ($_POST['reason']=='OD' OR $_POST['reason']=='WFH' OR $_POST['reason']=='Tour' OR $_POST['reason']=='Meeting')))
{

 if($_POST['Atct']==1 AND ($_POST['reasonI']=='OD' OR ($_POST['reasonI']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting'))
 { $Up=mysql_query("update hrm_employee_attendance_req set InStatus=2, Status=1 where EmployeeID=".$_POST['EId']." AND AttDate='".$_POST['AttDate']."'",$con); if($Up){ if($_POST['reasonI']=='WFH'){$attv='WFH';}else{$attv='OD';} if($_POST['CountAtt']==1){ $sUp=mysql_query("UPDATE hrm_employee_attendance SET AttValue='".$attv."', InnCnt='N', OuttCnt='N' where AttDate='".$_POST['AttDate']."' AND EmployeeID=".$_POST['EId'], $con);}else{$sUp=mysql_query("insert into hrm_employee_attendance(EmployeeID, AttValue, AttDate) values(".$_POST['EId'].", '".$attv."', '".$_POST['AttDate']."')",$con);} } }

 elseif($_POST['Atct']==2 AND ($_POST['reasonO']=='OD' OR ($_POST['reasonO']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting'))
 { $Up=mysql_query("update hrm_employee_attendance_req set OutStatus=2, Status=1 where EmployeeID=".$_POST['EId']." AND AttDate='".$_POST['AttDate']."'",$con); if($Up){ if($_POST['reasonO']=='WFH'){$attv='WFH';}else{$attv='OD';} if($_POST['CountAtt']==1){ $sUp=mysql_query("UPDATE hrm_employee_attendance SET AttValue='".$attv."', InnCnt='N', OuttCnt='N' where AttDate='".$_POST['AttDate']."' AND EmployeeID=".$_POST['EId'], $con);}else{$sUp=mysql_query("insert into hrm_employee_attendance(EmployeeID, AttValue, AttDate) values(".$_POST['EId'].", '".$attv."', '".$_POST['AttDate']."')",$con);} } }

 elseif($_POST['Atct']==12)
 {
  if($_POST['reasonI']=='OD' OR ($_POST['reasonI']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting'){$InS=2;}else{$InS=0;}
  if($_POST['reasonO']=='OD' OR ($_POST['reasonO']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting'){$OtS=2;}else{$OtS=0;}
  ...
  if($Up AND $InS==2 AND $OtS==2){ if($_POST['reasonI']=='WFH' AND $_POST['reasonO']=='WFH'){$attv='WFH';}else{$attv='OD';} if($_POST['CountAtt']==1){ $sUp=mysql_query("UPDATE hrm_employee_attendance SET AttValue='".$attv."', InnCnt='N', OuttCnt='N' where AttDate='".$_POST['AttDate']."' AND EmployeeID=".$_POST['EId'], $con);}else{$sUp=mysql_query("insert into hrm_employee_attendance(EmployeeID, AttValue, AttDate) values(".$_POST['EId'].", '".$attv."', '".$_POST['AttDate']."')",$con);} } }

 elseif($_POST['Atct']==3 AND ($_POST['reason']=='OD' OR ($_POST['reason']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reason']=='Tour' OR $_POST['reason']=='Meeting'))
 { $Up=mysql_query("update hrm_employee_attendance_req set SStatus=2, Status=1 where EmployeeID=".$_POST['EId']." AND AttDate='".$_POST['AttDate']."'",$con); if($Up){ if($_POST['reason']=='WFH'){$attv='WFH';}else{$attv='OD';} if($_POST['CountAtt']==1){ $sUp=mysql_query("UPDATE hrm_employee_attendance SET AttValue='".$attv."', InnCnt='N', OuttCnt='N' where AttDate='".$_POST['AttDate']."' AND EmployeeID=".$_POST['EId'], $con);}else{$sUp=mysql_query("insert into hrm_employee_attendance(EmployeeID, AttValue, AttDate) values(".$_POST['EId'].", '".$attv."', '".$_POST['AttDate']."')",$con);} } }
 
 elseif(($_POST['Atct']==1 OR $_POST['Atct']==2 OR $_POST['Atct']==12 OR $_POST['Atct']==3) AND $_POST['reason']=='WFH' AND ($_POST['AttDate']!=date("Y-m-d") OR ($_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)>strtotime($InTime))))
 {
...
/************/
	...
	$schk=mysql_query("select Leave_Type from hrm_employee_applyleave where LeaveStatus!=4 AND LeaveStatus!=3 AND EmployeeID=".$_POST['EId']." AND Apply_FromDate='".$i."' AND Apply_ToDate='".$i."' AND (Leave_Type='SH' OR Leave_Type='CH' OR Leave_Type='PH')", $con); $rowchk=mysql_num_rows($schk); $rchk=mysql_fetch_array($schk); //echo 'aa='.$rowchk;
...
/******************* Checking Checking Close **********/ 
  ...
  if($_POST['RId']!=51 AND $_POST['Rname']!='' AND $_POST['Rmail']!='')  //Reporting
  {
   //$eto = $_POST['Rmail'];
   ...
   if(($_POST['Atct']==1 AND ($_POST['reasonI']=='OD' OR ($_POST['reasonI']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting')) OR ($_POST['Atct']==2 AND ($_POST['reasonO']=='OD' OR ($_POST['reasonO']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting')) OR ($_POST['Atct']==12 AND ($_POST['reasonI']=='OD' OR ($_POST['reasonI']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting') AND ($_POST['reasonO']=='OD' OR ($_POST['reasonO']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting')) OR ($_POST['Atct']==3 AND ($_POST['reason']=='OD' OR ($_POST['reason']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reason']=='Tour' OR $_POST['reason']=='Meeting'))){ $emsg="Your team member ".$_POST['Ename']." has applied ".$_POST['reason']." for attendance authorisation for ".date('d-m-Y',strtotime($_POST['AttDate']))." with remark (".$AllRemark.") in ESS. Please login to ESS to review. This is an auto-approval application. You may reject the application if found unauthorised.<br><br>\n\n"; }else{ $emsg .= "Your team member ".$_POST['Ename']." has requested for attendance authorisation for Date ".date("d-m-Y",strtotime($_POST['AttDate']))." with remark (".$AllRemark.") in ESS, Please login to ESS for taking necessary action.<br><br>\n\n"; }
   ...
   $subject=$esub;
   $body=$emsg;
   $email_to=$_POST['Rmail'];
   require 'vendor/mail_admin.php';
   
  }
  
  if($_POST['HId']!=51 AND $_POST['Hname']!='' AND $_POST['Hmail']!='' AND ($_POST['reasonI']=='Other' OR $_POST['reasonO']=='Other' OR $_POST['reason']=='Other'))  //HOD
  {
   //$eto2 = $_POST['Hmail'];
   ...
   if(($_POST['Atct']==1 AND ($_POST['reasonI']=='OD' OR ($_POST['reasonI']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting')) OR ($_POST['Atct']==2 AND ($_POST['reasonO']=='OD' OR ($_POST['reasonO']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting')) OR ($_POST['Atct']==12 AND ($_POST['reasonI']=='OD' OR ($_POST['reasonI']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting') AND ($_POST['reasonO']=='OD' OR ($_POST['reasonO']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting')) OR ($_POST['Atct']==3 AND ($_POST['reason']=='OD' OR ($_POST['reason']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reason']=='Tour' OR $_POST['reason']=='Meeting'))){ $emsg2="Your team member ".$_POST['Ename']." reporting to ".$_POST['Rname']." has applied ".$_POST['reason']." as attendance authorisation for ".date('d-m-Y',strtotime($_POST['AttDate']))." with remark (".$AllRemark.") in ESS. Please login to ESS for more details.<br><br>\n\n"; }else{ $emsg2 .= "Your team member ".$_POST['Ename']." reporting to ".$_POST['Rname']." has requested for attendance authorisation for Date ".date("d-m-Y",strtotime($_POST['AttDate']))." with remark (".$AllRemark.") in ESS, Please login to ESS for more details.<br><br>\n\n"; }
  ...
  if($_POST['HrEname']!='' AND $_POST['HrEmail']!='')  //HrEmp
  {
   ...
   if(($_POST['Atct']==1 AND ($_POST['reasonI']=='OD' OR ($_POST['reasonI']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting')) OR ($_POST['Atct']==2 AND ($_POST['reasonO']=='OD' OR ($_POST['reasonO']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting')) OR ($_POST['Atct']==12 AND ($_POST['reasonI']=='OD' OR ($_POST['reasonI']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting') AND ($_POST['reasonO']=='OD' OR ($_POST['reasonO']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting')) OR ($_POST['Atct']==3 AND ($_POST['reason']=='OD' OR ($_POST['reason']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reason']=='Tour' OR $_POST['reason']=='Meeting'))){ $emsg3=$_POST['Ename']." applied ".$_POST['reason']." for attendance authorisation for ".date("d-m-Y",strtotime($_POST['AttDate']))." with remark (".$AllRemark.") in ESS. This is an auto-approval application. for details, kindly login to ESS.<br><br>\n\n"; }else{ $emsg3 .= $_POST['Ename']." has requested for attendance authorisation for Date ".date("d-m-Y",strtotime($_POST['AttDate']))." with remark (".$AllRemark.") in ESS, for details, kindly login to ESS.<br><br>\n\n"; }
  ...
  /*HR*/                                              //HR
   ...
   if(($_POST['Atct']==1 AND ($_POST['reasonI']=='OD' OR ($_POST['reasonI']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting')) OR ($_POST['Atct']==2 AND ($_POST['reasonO']=='OD' OR ($_POST['reasonO']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting')) OR ($_POST['Atct']==12 AND ($_POST['reasonI']=='OD' OR ($_POST['reasonI']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonI']=='Tour' OR $_POST['reasonI']=='Meeting') AND ($_POST['reasonO']=='OD' OR ($_POST['reasonO']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reasonO']=='Tour' OR $_POST['reasonO']=='Meeting')) OR ($_POST['Atct']==3 AND ($_POST['reason']=='OD' OR ($_POST['reason']=='WFH' AND $_POST['AttDate']==date("Y-m-d") AND $InTime!='00:00:00' AND strtotime($ReqTime)<=strtotime($InTime)) OR $_POST['reason']=='Tour' OR $_POST['reason']=='Meeting')))
   { $emsg4 .= $_POST['Ename']." applied for ".$_POST['reason']." for attendance authorisation for ".date("d-m-Y",strtotime($_POST['AttDate']))." with remark (".$AllRemark.") in ESS. This is an auto-approval application. for details, kindly login to ESS.<br><br>\n\n"; }else{ $emsg4 .= $_POST['Ename']." has requested for attendance authorisation for ".date("d-m-Y",strtotime($_POST['AttDate']))." with remark (".$AllRemark.") in ESS, for details, kindly login to ESS.<br><br>\n\n"; }
 ...
 /* 
  if($_POST['Htname']!='' AND $_POST['Htmail']!='')  //HOD -top level
  {
   ...
   $emsg5 .= "Your team member ".$_POST['Ename']." reporting to ".$_POST['Rname']." has requested for attendance authorisation for Date ".date("d-m-Y",strtotime($_POST['AttDate']))." with remark (".$AllRemark.") in ESS, Please login to ESS for more details.<br><br>\n\n";
...
/**** Leave Update Open ****/
   ...
   $SqlHf=mysql_query("select count(AttValue)as Hf from hrm_employee_attendance where AttValue='HF' AND EmployeeID=".$_POST['EId']." AND AttDate between '".$yy."-".$mm."-01' AND '".$yy."-".$mm."-31'", $con); 
   
   $SqlAch=mysql_query("select count(AttValue)as ACH from hrm_employee_attendance where AttValue='ACH' AND EmployeeID=".$_POST['EId']." AND AttDate between '".$yy."-".$mm."-01' AND '".$yy."-".$mm."-31'", $con);
$SqlAsh=mysql_query("select count(AttValue)as ASH from hrm_employee_attendance where AttValue='ASH' AND EmployeeID=".$_POST['EId']." AND AttDate between '".$yy."-".$mm."-01' AND '".$yy."-".$mm."-31'", $con);
$SqlAph=mysql_query("select count(AttValue)as APH from hrm_employee_attendance where AttValue='APH' AND EmployeeID=".$_POST['EId']." AND AttDate between '".$yy."-".$mm."-01' AND '".$yy."-".$mm."-31'", $con);
   
   $SqlPresent=mysql_query("select count(AttValue)as Present from hrm_employee_attendance where (AttValue='P' OR AttValue='WFH') AND EmployeeID=".$_POST['EId']." AND AttDate between '".$yy."-".$mm."-01' AND '".$yy."-".$mm."-31'", $con);
   
   $SqlAbsent=mysql_query("select count(AttValue)as Absent from hrm_employee_attendance where AttValue='A' AND EmployeeID=".$_POST['EId']." AND AttDate between '".$yy."-".$mm."-01' AND '".$yy."-".$mm."-31'", $con); 
...
<body>
<center>
<?php //echo date("H:i:s"); echo '-'.strtotime(date("H:i:00"));
...
{ 
 ...
 //echo "select * from hrm_employee_attendance_req where EmployeeID=".$_REQUEST['ei']." AND AttDate='".date($y."-".$m."-".$d)."'";
...
<tr><td colspan="3" style="font-family:Times New Roman; font-size:15px; color:#FF0000;text-align:center;">* This option is only for missed attendance or late In-time/early out-time attendance and not for leave application. Do not apply leave here.</td></tr>
