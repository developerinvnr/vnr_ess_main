...
<?php $sqlShow2=mysql_query("select UseKRA from hrm_pms_kra where YearId=".$resSY['CurrY']." AND EmployeeID=".$res['EmployeeID'], $con);  $resShow2=mysql_fetch_assoc($sqlShow2);?>
			<a href="#"><img src="images/edit.png" border="0" onClick="javascript:window.location='RevAddNewKRA.php?e=<?php echo $res['EmployeeID']?>&ee=1&aa=1&rr=0&hh=1&sh=1&hp=1&fr=1&kr=0&fq=1&prt=1&msg=1&pd=1&mt=1&mts=1&scr=1&prom=1&inc=1&incr=1&pmsr=1&rg=1&h=1&fachiv=1&fa=1&fb=1&ffeedb=1&org=1'"/></a>
			<?php if($resShow2['UseKRA']=='R'){ ?>
			&nbsp;&nbsp;&nbsp;
