  ...
  <tr>
   <td class="td14ce" style='width:350px;vertical-align:top;'>
    <table border="1"  style="width:100%;"  cellspacing="0">
	 ...
	 <?php } if($ResPay['Bonus_Adjustment']!=0){ ?>
	 <tr style="height:23px;">
      <td class="td13">&nbsp;BONUS ADJUSTMENT</td>
      <td class="td14r"><?php echo intval($ResPay['Bonus_Adjustment']); ?>&nbsp;</td>
     </tr>
   ...
   <td class="td14ce" style='width:350px;vertical-align:top;'>
    ...
    <?php } if($ResPay['NPS_Value']>0){ ?>  
    <tr style="height:23px;">
     <td class="td13">&nbsp;NPS Contribution</td>
     <td class="td14r"><?php echo intval($ResPay['NPS_Value']); ?>&nbsp;</td>
    </tr>
