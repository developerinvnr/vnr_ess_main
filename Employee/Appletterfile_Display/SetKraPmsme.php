...
<td class="tdc"><a href="#" onClick="OpenFaqfile('faq')"><img src="images/faqbtn.png" border="0"/></a></a></td>
...
<?php  if($EmployeeId!=6 AND $EmployeeId!=7 AND $EmployeeId!=21 AND $EmployeeId!=51 AND $EmployeeId!=223 AND $EmployeeId!=224 AND $EmployeeId!=461){ ?>
...
<?php $SqlP=mysql_query("select Hod_TotalFinalRating,Hod_EmpDesignation,Hod_EmpGrade,HR_CurrDesigId,HR_CurrGradeId from hrm_employee_pms where AssessmentYear=".$_SESSION['PmsYId']." AND EmployeeID=".$EmployeeId." AND EmpPmsId=".$_SESSION['ePmsId'], $con); $ResP=mysql_fetch_assoc($SqlP);
