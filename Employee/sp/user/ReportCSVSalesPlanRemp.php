...
$sqlE=mysql_query("select Fname,Sname,Lname,HqId from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmployeeID=".$_REQUEST['emp'],$con);  $resE=mysql_fetch_assoc($sqlE); $Ename=$resE['Fname'].'_'.$resE['Sname'].'_'.$resE['Lname']; 
$sqlHq = mysql_query("SELECT HqName FROM hrm_headquater WHERE HqId=".$resE['HqId'], $con); $resHq=mysql_fetch_assoc($sqlHq); 

if($_REQUEST['selE']==4){$SetName='Top_Level';}elseif($_REQUEST['selE']==3){$SetName='Zone_Level';}elseif($_REQUEST['selE']==2){$SetName='Region_Level';}elseif($_REQUEST['selE']==1){$SetName='Territory_Level';}

/*************************************************************************************************************/
include("CalYCsv.php");

if($_REQUEST['action']='PlanRempExport') 
{ 
...
{ 
  $sqlP1d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId2." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl d.".$TerrCon."=rl.EmployeeID where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['emp']." OR rl.R1=".$_REQUEST['emp']." OR rl.R2=".$_REQUEST['emp']." OR rl.R3=".$_REQUEST['emp']." OR rl.R4=".$_REQUEST['emp']." OR rl.R5=".$_REQUEST['emp'].") AND sd.YearId=".$BeforeYId2." AND ".$qin."", $con);
}
...
if($_REQUEST['selE']==4 OR $_REQUEST['selE']==3 OR $_REQUEST['selE']==2)
{ 
  $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON d.".$TerrCon."=rl.EmployeeID where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['emp']." OR rl.R1=".$_REQUEST['emp']." OR rl.R2=".$_REQUEST['emp']." OR rl.R3=".$_REQUEST['emp']." OR rl.R4=".$_REQUEST['emp']." OR rl.R5=".$_REQUEST['emp'].") AND sd.YearId=".$BeforeYId." AND ".$qin."", $con);
}
elseif($_REQUEST['selE']==1)
{
...
if($_REQUEST['selE']==4 OR $_REQUEST['selE']==3 OR $_REQUEST['selE']==2)
{ 
  $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON d.".$TerrCon."=rl.EmployeeID where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['emp']." OR rl.R1=".$_REQUEST['emp']." OR rl.R2=".$_REQUEST['emp']." OR rl.R3=".$_REQUEST['emp']." OR rl.R4=".$_REQUEST['emp']." OR rl.R5=".$_REQUEST['emp'].") AND sd.YearId=".$_REQUEST['y']." AND ".$qin."", $con); 
}
elseif($_REQUEST['selE']==1)
{
...
if($_REQUEST['selE']==4 OR $_REQUEST['selE']==3 OR $_REQUEST['selE']==2)
{ 
  $sqlP4d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON d.".$TerrCon."=rl.EmployeeID where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['emp']." OR rl.R1=".$_REQUEST['emp']." OR rl.R2=".$_REQUEST['emp']." OR rl.R3=".$_REQUEST['emp']." OR rl.R4=".$_REQUEST['emp']." OR rl.R5=".$_REQUEST['emp'].") AND sd.YearId=".$AfterYId." AND ".$qin."", $con);
}
elseif($_REQUEST['selE']==1)
{
...
if($_REQUEST['selE']==4 OR $_REQUEST['selE']==3 OR $_REQUEST['selE']==2)
{ 
  $sqlP1d=mysql_query("select SUM(M1_Ach) as tm1,SUM(M2_Ach) as tm2,SUM(M3_Ach) as tm3,SUM(M4_Ach) as tm4,SUM(M5_Ach) as tm5,SUM(M6_Ach) as tm6,SUM(M7_Ach) as tm7,SUM(M8_Ach) as tm8,SUM(M9_Ach) as tm9,SUM(M10_Ach) as tm10,SUM(M11_Ach) as tm11,SUM(M12_Ach) as tm12 from hrm_sales_sal_details_".$BeforeYId2." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON d.".$TerrCon."=rl.EmployeeID where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['emp']." OR rl.R1=".$_REQUEST['emp']." OR rl.R2=".$_REQUEST['emp']." OR rl.R3=".$_REQUEST['emp']." OR rl.R4=".$_REQUEST['emp']." OR rl.R5=".$_REQUEST['emp'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$BeforeYId2, $con);
}
elseif($_REQUEST['selE']==1)
{
  $sqlP1d=mysql_query("select SUM(M1_Ach) as tm1,SUM(M2_Ach) as tm2,SUM(M3_Ach) as tm3,SUM(M4_Ach) as tm4,SUM(M5_Ach) as tm5,SUM(M6_Ach) as tm6,SUM(M7_Ach) as tm7,SUM(M8_Ach) as tm8,SUM(M9_Ach) as tm9,SUM(M10_Ach) as tm10,SUM(M11_Ach) as tm11,SUM(M12_Ach) as tm12 from hrm_sales_sal_details_".$BeforeYId2." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sd.YearId=".$BeforeYId2." AND sd.ProductId=".$res['ProductId']." AND DealerSts='A' AND ".$TerrCon."=".$_REQUEST['emp'], $con);  
}
 $res1=mysql_fetch_assoc($sqlP1d); 
...
if($_REQUEST['selE']==4 OR $_REQUEST['selE']==3 OR $_REQUEST['selE']==2)
{ 
  $sqlP2d=mysql_query("select SUM(M1_Ach) as tm1,SUM(M2_Ach) as tm2,SUM(M3_Ach) as tm3,SUM(M4_Ach) as tm4,SUM(M5_Ach) as tm5,SUM(M6_Ach) as tm6,SUM(M7_Ach) as tm7,SUM(M8_Ach) as tm8,SUM(M9_Ach) as tm9,SUM(M10_Ach) as tm10,SUM(M11_Ach) as tm11,SUM(M12_Ach) as tm12 from hrm_sales_sal_details_".$BeforeYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON d.".$TerrCon."=rl.EmployeeID where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['emp']." OR rl.R1=".$_REQUEST['emp']." OR rl.R2=".$_REQUEST['emp']." OR rl.R3=".$_REQUEST['emp']." OR rl.R4=".$_REQUEST['emp']." OR rl.R5=".$_REQUEST['emp'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$BeforeYId, $con);
}
elseif($_REQUEST['selE']==1)
{
  $sqlP2d=mysql_query("select SUM(M1_Ach) as tm1,SUM(M2_Ach) as tm2,SUM(M3_Ach) as tm3,SUM(M4_Ach) as tm4,SUM(M5_Ach) as tm5,SUM(M6_Ach) as tm6,SUM(M7_Ach) as tm7,SUM(M8_Ach) as tm8,SUM(M9_Ach) as tm9,SUM(M10_Ach) as tm10,SUM(M11_Ach) as tm11,SUM(M12_Ach) as tm12 from hrm_sales_sal_details_".$BeforeYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sd.YearId=".$BeforeYId." AND sd.ProductId=".$res['ProductId']." AND DealerSts='A' AND ".$TerrCon."=".$_REQUEST['emp'], $con);  
}
 $res2=mysql_fetch_assoc($sqlP2d);
...
if($res2['tm1']>0){$mAch1=$res2['tm1'];}else{$mAch1='';}
if($res2['tm2']>0){$mAch2=$res2['tm2'];}else{$mAch2='';}
if($res2['tm3']>0){$mAch3=$res2['tm3'];}else{$mAch3='';}
if($res2['tm4']>0){$mAch4=$res2['tm4'];}else{$mAch4='';}
if($res2['tm5']>0){$mAch5=$res2['tm5'];}else{$mAch5='';}
if($res2['tm6']>0){$mAch6=$res2['tm6'];}else{$mAch6='';}
if($res2['tm7']>0){$mAch7=$res2['tm7'];}else{$mAch7='';}
if($res2['tm8']>0){$mAch8=$res2['tm8'];}else{$mAch8='';}
if($res2['tm9']>0){$mAch9=$res2['tm9'];}else{$mAch9='';}
if($res2['tm10']>0){$mAch10=$res2['tm10'];}else{$mAch10='';}
if($res2['tm11']>0){$mAch11=$res2['tm11'];}else{$mAch11='';}
if($res2['tm12']>0){$mAch12=$res2['tm12'];}else{$mAch12='';}
...
if($_REQUEST['selE']==4 OR $_REQUEST['selE']==3 OR $_REQUEST['selE']==2)
{ 
  $sqlP3d=mysql_query("select SUM(M1) as tm1,SUM(M2) as tm2,SUM(M3) as tm3,SUM(M4) as tm4,SUM(M5) as tm5,SUM(M6) as tm6,SUM(M7) as tm7,SUM(M8) as tm8,SUM(M9) as tm9,SUM(M10) as tm10,SUM(M11) as tm11,SUM(M12) as tm12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON d.".$TerrCon."=rl.EmployeeID where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['emp']." OR rl.R1=".$_REQUEST['emp']." OR rl.R2=".$_REQUEST['emp']." OR rl.R3=".$_REQUEST['emp']." OR rl.R4=".$_REQUEST['emp']." OR rl.R5=".$_REQUEST['emp'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$_REQUEST['y'], $con);
}
elseif($_REQUEST['selE']==1)
{
...
if($res3['tm1']>0){$mAch1=$res3['tm1'];}else{$mAch1='';}
if($res3['tm2']>0){$mAch2=$res3['tm2'];}else{$mAch2='';}
if($res3['tm3']>0){$mAch3=$res3['tm3'];}else{$mAch3='';}
if($res3['tm4']>0){$mAch4=$res3['tm4'];}else{$mAch4='';}
if($res3['tm5']>0){$mAch5=$res3['tm5'];}else{$mAch5='';}
if($res3['tm6']>0){$mAch6=$res3['tm6'];}else{$mAch6='';}
if($res3['tm7']>0){$mAch7=$res3['tm7'];}else{$mAch7='';}
if($res3['tm8']>0){$mAch8=$res3['tm8'];}else{$mAch8='';}
if($res3['tm9']>0){$mAch9=$res3['tm9'];}else{$mAch9='';}
if($res3['tm10']>0){$mAch10=$res3['tm10'];}else{$mAch10='';}
if($res3['tm11']>0){$mAch11=$res3['tm11'];}else{$mAch11='';}
if($res3['tm12']>0){$mAch12=$res3['tm12'];}else{$mAch12='';}
...
if($_REQUEST['selE']==4 OR $_REQUEST['selE']==3 OR $_REQUEST['selE']==2)
{ 
  $sqlP4d=mysql_query("select SUM(M1_Proj) as tm1,SUM(M2_Proj) as tm2,SUM(M3_Proj) as tm3,SUM(M4_Proj) as tm4,SUM(M5_Proj) as tm5,SUM(M6_Proj) as tm6,SUM(M7_Proj) as tm7,SUM(M8_Proj) as tm8,SUM(M9_Proj) as tm9,SUM(M10_Proj) as tm10,SUM(M11_Proj) as tm11,SUM(M12_Proj) as tm12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON d.".$TerrCon."=rl.EmployeeID where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['emp']." OR rl.R1=".$_REQUEST['emp']." OR rl.R2=".$_REQUEST['emp']." OR rl.R3=".$_REQUEST['emp']." OR rl.R4=".$_REQUEST['emp']." OR rl.R5=".$_REQUEST['emp'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$AfterYId, $con);
}
elseif($_REQUEST['selE']==1)
{
  $sqlP4d=mysql_query("select SUM(M1_Proj) as tm1,SUM(M2_Proj) as tm2,SUM(M3_Proj) as tm3,SUM(M4_Proj) as tm4,SUM(M5_Proj) as tm5,SUM(M6_Proj) as tm6,SUM(M7_Proj) as tm7,SUM(M8_Proj) as tm8,SUM(M9_Proj) as tm9,SUM(M10_Proj) as tm10,SUM(M11_Proj) as tm11,SUM(M12_Proj) as tm12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sd.YearId=".$AfterYId." AND sd.ProductId=".$res['ProductId']." AND DealerSts='A' AND ".$TerrCon."=".$_REQUEST['emp'], $con); 
}
 $res4=mysql_fetch_assoc($sqlP4d); 
...
if($res4['tm1']>0){$mAch1=$res4['tm1'];}else{$mAch1='';}
if($res4['tm2']>0){$mAch2=$res4['tm2'];}else{$mAch2='';}
if($res4['tm3']>0){$mAch3=$res4['tm3'];}else{$mAch3='';}
if($res4['tm4']>0){$mAch4=$res4['tm4'];}else{$mAch4='';}
if($res4['tm5']>0){$mAch5=$res4['tm5'];}else{$mAch5='';}
if($res4['tm6']>0){$mAch6=$res4['tm6'];}else{$mAch6='';}
if($res4['tm7']>0){$mAch7=$res4['tm7'];}else{$mAch7='';}
if($res4['tm8']>0){$mAch8=$res4['tm8'];}else{$mAch8='';}
if($res4['tm9']>0){$mAch9=$res4['tm9'];}else{$mAch9='';}
if($res4['tm10']>0){$mAch10=$res4['tm10'];}else{$mAch10='';}
if($res4['tm11']>0){$mAch11=$res4['tm11'];}else{$mAch11='';}
if($res4['tm12']>0){$mAch12=$res4['tm12'];}else{$mAch12='';}
...
if($_REQUEST['selE']==4 OR $_REQUEST['selE']==3 OR $_REQUEST['selE']==2)
{ 
  $sqlP5d=mysql_query("select SUM(M1_Ach) as tm1,SUM(M2_Ach) as tm2,SUM(M3_Ach) as tm3,SUM(M4_Ach) as tm4,SUM(M5_Ach) as tm5,SUM(M6_Ach) as tm6,SUM(M7_Ach) as tm7,SUM(M8_Ach) as tm8,SUM(M9_Ach) as tm9,SUM(M10_Ach) as tm10,SUM(M11_Ach) as tm11,SUM(M12_Ach) as tm12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON d.".$TerrCon."=rl.EmployeeID where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['emp']." OR rl.R1=".$_REQUEST['emp']." OR rl.R2=".$_REQUEST['emp']." OR rl.R3=".$_REQUEST['emp']." OR rl.R4=".$_REQUEST['emp']." OR rl.R5=".$_REQUEST['emp'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$_REQUEST['y'], $con);
}
elseif($_REQUEST['selE']==1)
{
  $sqlP5d=mysql_query("select SUM(M1_Ach) as tm1,SUM(M2_Ach) as tm2,SUM(M3_Ach) as tm3,SUM(M4_Ach) as tm4,SUM(M5_Ach) as tm5,SUM(M6_Ach) as tm6,SUM(M7_Ach) as tm7,SUM(M8_Ach) as tm8,SUM(M9_Ach) as tm9,SUM(M10_Ach) as tm10,SUM(M11_Ach) as tm11,SUM(M12_Ach) as tm12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sd.YearId=".$_REQUEST['y']." AND sd.ProductId=".$res['ProductId']." AND DealerSts='A' AND ".$TerrCon."=".$_REQUEST['emp'], $con); 
}	
$res5=mysql_fetch_assoc($sqlP5d);  
...
if($res5['tm1']>0){$mAch1=$res5['tm1'];}else{$mAch1='';}
if($res5['tm2']>0){$mAch2=$res5['tm2'];}else{$mAch2='';}
if($res5['tm3']>0){$mAch3=$res5['tm3'];}else{$mAch3='';}
if($res5['tm4']>0){$mAch4=$res5['tm4'];}else{$mAch4='';}
if($res5['tm5']>0){$mAch5=$res5['tm5'];}else{$mAch5='';}
if($res5['tm6']>0){$mAch6=$res5['tm6'];}else{$mAch6='';}
if($res5['tm7']>0){$mAch7=$res5['tm7'];}else{$mAch7='';}
if($res5['tm8']>0){$mAch8=$res5['tm8'];}else{$mAch8='';}
if($res5['tm9']>0){$mAch9=$res5['tm9'];}else{$mAch9='';}
if($res5['tm10']>0){$mAch10=$res5['tm10'];}else{$mAch10='';}
if($res5['tm11']>0){$mAch11=$res5['tm11'];}else{$mAch11='';}
if($res5['tm12']>0){$mAch12=$res5['tm12'];}else{$mAch12='';}
...
header("Content-Disposition:attachment;filename=SalesPlan_".ucfirst(strtolower($Ename))."_(".$SetName.").csv");
echo $csv_output;
exit;
}
?>