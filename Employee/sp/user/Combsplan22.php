...
<table border="1" cellpadding="0" cellspacing="0" style="font-family:Times New Roman;font-size:12px;width:350px;vertical-align:top;">
 <tr style="background-color:#D5F1D1;color:#000000;"> 
  ...
  <td colspan="2" align="center" style="width:120px;font-size:14px;"><b>Export</b></td>
 </tr>	
 <tr style="background-color:#D5F1D1;color:#000000;"> 
 ...
 <tr bgcolor="#EEEEEE" style="height:22px;background-color:<?php echo '#E2F3D8'; ?>;"> 
  ...
  <td style="width:60px;font-size:12px;" align="center"><?php if($rows1>0){ ?><a href="#" onClick="ExportTarget(<?php echo $_REQUEST['y']; ?>)"><b>Click</b></a><?php } ?></td>
  <td style="width:60px;font-size:12px;" align="center"><?php if($rows2>0){ ?><a href="#" onClick="ExportSales(<?php echo $_REQUEST['y']; ?>)"><b>Click</b></a><?php } ?></td>
 </tr>  	
</table>	
<?php } ?>
    </td>
