...
function ChangrYear(YearV)
{
  ...
  window.location="SalesPlanRco.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&grp="+CropGrp+"&ii="+ii+"&bp="+bp; 
}
...
{ var YearV=document.getElementById("YearV").value; var CropGrp=document.getElementById("CropGrp").value; //var di=document.getElementById("DealerD").value;
  ...
  var ci=document.getElementById("ComId").value; var ii=document.getElementById("ItemV").value; //var Hq=document.getElementById("Hq").value;
  var bp=document.getElementById('BPrtyCheck').value;
  window.open("SalesPlanRcoPrint.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&grp="+CropGrp+"&ii="+ii+"&bp="+bp,"PrintForm","menubar=no,scrollbars=yes,resizable=no,directories=no,width=100,height=100");
}

function ExportCoPlan(y,g,i,c)
{ var ComId=document.getElementById("ComId").value; var YId=document.getElementById("YId").value;  
  var bp=document.getElementById('BPrtyCheck').value;
  window.open("ReportCSVSalesPlanRCo.php?action=PlanRExport&ComId="+ComId+"&y="+y+"&g="+g+"&i="+i+"&c="+c+"&YId="+y+"&bp="+bp,"PrintForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20"); } 
...
<?php if($_REQUEST['grp']==1){ $sqlItem=mysql_query("select * from hrm_sales_seedsitem where GroupId=1 order by ItemName ASC", $con);}
	  ...
	  <tr>
	    <td style="margin-top:0px;width:100px;" class="heading" align="center"><u>Country-Wise</u></td>
...
<?php /* 1 */ if($i==1){
$sqlP1d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId2." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_headquater hq ON d.".$HqCon."=hq.HqId INNER JOIN hrm_state s ON hq.StateId=s.StateId where ".$subQ." AND sd.YearId=".$BeforeYId2." AND ".$qin." AND s.CountryId=".$_REQUEST['c'], $con); $res1=mysql_fetch_assoc($sqlP1d); 
...
<?php } /* 2 */ if($i==2){ 
$sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_headquater hq ON d.".$HqCon."=hq.HqId INNER JOIN hrm_state s ON hq.StateId=s.StateId where ".$subQ." AND sd.YearId=".$BeforeYId." AND ".$qin." AND s.CountryId=".$_REQUEST['c'], $con); $res2=mysql_fetch_assoc($sqlP2d);
...
<?php } /* 3 */ if($i==3){ 
$sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_headquater hq ON d.".$HqCon."=hq.HqId INNER JOIN hrm_state s ON hq.StateId=s.StateId where ".$subQ." AND sd.YearId=".$_REQUEST['y']." AND ".$qin." AND s.CountryId=".$_REQUEST['c'], $con); $res3=mysql_fetch_assoc($sqlP3d); 
...
<?php } /* 4 */  if($i==4){ 
$sqlP4d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_headquater hq ON d.".$HqCon."=hq.HqId INNER JOIN hrm_state s ON hq.StateId=s.StateId where ".$subQ." AND sd.YearId=".$AfterYId." AND ".$qin." AND s.CountryId=".$_REQUEST['c'], $con); $res4=mysql_fetch_assoc($sqlP4d); 
...
<?php } /* 5 */  $sqlYe=mysql_query("select FromDate,ToDate from hrm_sales_year where YearId=".$_REQUEST['y'], $con); $resYe=mysql_fetch_assoc($sqlYe);
	    ...
	    if($i==5){ 
$sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_headquater hq ON d.".$HqCon."=hq.HqId INNER JOIN hrm_state s ON hq.StateId=s.StateId where ".$subQ." AND sd.YearId=".$_REQUEST['y']." AND ".$qin." AND s.CountryId=".$_REQUEST['c'], $con); $res5=mysql_fetch_assoc($sqlP5d);  
...
<?php ////////////////////////////////////////////////////////// ?>
 ...
 <tr style="background-color:#D5F1D1;color:#000000;">
    <td colspan="5" style="font-size:12px;color:#FFFF00;background-color:#183E83;">&nbsp;<b><?php echo 'Country - '.ucwords(strtolower($resC['CountryName'])); ?></b></td>
...
$Net4=$res5['tM1']*$Nrv4; $Net5=$res5['tM2']*$Nrv5; $Net6=$res5['tM3']*$Nrv6; $Net7=$res5['tM4']*$Nrv7; 
$Net8=$res5['tM5']*$Nrv8; $Net9=$res5['tM6']*$Nrv9; $Net10=$res5['tM7']*$Nrv10; $Net11=$res5['tM8']*$Nrv11; $Net12=$res5['tM9']*$Nrv12; $Net1=$res5['tM10']*$Nrv1; $Net2=$res5['tM11']*$Nrv2; $Net3=$res5['tM12']*$Nrv3; $NetNRV_5=$Net4+$Net5+$Net6+$Net7+$Net8+$Net9+$Net10+$Net11+$Net12+$Net1+$Net2+$Net3; 
$LakhNRV_5=$NetNRV_5/100000;
