...
<?php if($_REQUEST['e']>0){ $result = mysql_query("select sd.*,StateName,StateCode,HqName,DealerName,d.Terr_vc,d.Terr_fc,Hq_vc,Hq_fc from hrm_sales_rcp_collection sd inner join hrm_sales_dealer d on sd.DealerId=d.DealerId inner join hrm_headquater hq on d.HqId=hq.HqId inner join hrm_state s on hq.StateId=s.StateId inner join hrm_sales_reporting_level rl on (d.Terr_vc=rl.EmployeeID OR d.Terr_fc=rl.EmployeeID) where d.DealerSts='A' AND (d.Terr_vc=".$_REQUEST['e']." OR d.Terr_fc=".$_REQUEST['e']." OR rl.R1=".$_REQUEST['e']." OR rl.R2=".$_REQUEST['e']." OR rl.R3=".$_REQUEST['e']." OR rl.R4=".$_REQUEST['e']." OR rl.R5=".$_REQUEST['e'].") AND sd.YearId=".$_REQUEST['y']." group by sd.DealerId order by StateName,HqName,DealerName", $con); }
	  ...
	  $rE=mysql_fetch_assoc($sE); $rTNameV=$rE['Fname'].' '.$rE['Sname'].' '.$rE['Lname'];
	  ...
	  $rE2=mysql_fetch_assoc($sE2); $rTNameF=$rE2['Fname'].' '.$rE2['Sname'].' '.$rE2['Lname'];
...
?>	 
   ...
   <tbody>
    <tr style="background-color:#FFFFFF; height:20px;">
      ...
      <td style="font-size:12px;"><input type="text" value="<?php echo ucwords(strtoupper($r['DealerName'])); ?>" style="border:hidden;font-size:12px; font-family:Times New Roman; width:100%;" /></td>
	  <td style="font-size:12px; text-align:center;"><?php echo $r['DealerId']; ?></td>
      <td align="center" style="font-size:12px;"><input type="text" value="<?php echo ucwords(strtoupper($r['StateCode'])); ?>" style="border:hidden;font-size:12px; font-family:Times New Roman; text-align:center;width:100%;" /></td>
	  
	  <td align="center" style="font-size:12px;"><input type="text" value="<?php echo ucwords(strtoupper($rHqv['HqName'])); ?>" style="border:hidden;font-size:12px; font-family:Times New Roman;width:100%;" /></td>
	  <td align="center" style="font-size:12px;"><input type="text" value="<?php echo ucwords(strtoupper($rHqf['HqName'])); ?>" style="border:hidden;font-size:12px; font-family:Times New Roman;width:100%;" /></td>
	  
      <?php /*?><td style="font-size:12px;"><input type="text" value="<?php echo ucwords(strtoupper($r['HqName'])); ?>" style="border:hidden;font-size:12px; font-family:Times New Roman;width:100%;" /></td><?php */?>
	  <td style="font-size:12px;"><input type="text" value="<?php echo ucwords(strtoupper($rTNameV)); ?>" style="border:hidden;font-size:12px; font-family:Times New Roman;width:100%;" /></td>
	  <td style="font-size:12px;"><input type="text" value="<?php echo ucwords(strtoupper($rTNameF)); ?>" style="border:hidden;font-size:12px; font-family:Times New Roman;width:100%;" /></td>
