...
{
  var CropGrp=document.getElementById("CropGrp").value; var ii=document.getElementById("ItemV").value; //var di=document.getElementById("DealerD").value;
  ...
  var ci=document.getElementById("ComId").value; //var Hq=document.getElementById("Hq").value;
  window.location="SalesPlanRco.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&grp="+CropGrp+"&ii="+ii; 
}
function ClickGrp(CropGrp)
{
  var YearV=document.getElementById("YearV").value; var ii=0; //var di=document.getElementById("DealerD").value;
  var Coutry=document.getElementById("Coutry").value; //var State=document.getElementById("State").value; //var QtrV=document.getElementById("QtrV").value;
  var ci=document.getElementById("ComId").value; //var DealerD=document.getElementById("DealerD").value; var Hq=document.getElementById("Hq").value;
  window.location="SalesPlanRco.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&grp="+CropGrp+"&ii="+ii; 
}
function ChangeII(ii)
{
  var YearV=document.getElementById("YearV").value; var CropGrp=document.getElementById("CropGrp").value; //var di=document.getElementById("DealerD").value;
  var Coutry=document.getElementById("Coutry").value; //var State=document.getElementById("State").value; //var QtrV=document.getElementById("QtrV").value;
  var ci=document.getElementById("ComId").value;  //var Hq=document.getElementById("Hq").value;
  window.location="SalesPlanRco.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&grp="+CropGrp+"&ii="+ii; 
}
function ClickCoutry(Coutry)
{ 
  var YearV=document.getElementById("YearV").value; var CropGrp=document.getElementById("CropGrp").value; //var di=document.getElementById("DealerD").value;
  //var Coutry=document.getElementById("Coutry").value; //var State=document.getElementById("State").value; //var QtrV=document.getElementById("QtrV").value;
  var ci=document.getElementById("ComId").value; var ii=document.getElementById("ItemV").value;  //var Hq=document.getElementById("Hq").value;
  window.location="SalesPlanRco.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&grp="+CropGrp+"&ii="+ii; 
}
...
{ var YearV=document.getElementById("YearV").value; var CropGrp=document.getElementById("CropGrp").value; //var di=document.getElementById("DealerD").value;
  var Coutry=document.getElementById("Coutry").value; //var State=document.getElementById("State").value; //var QtrV=document.getElementById("QtrV").value;
  var ci=document.getElementById("ComId").value; var ii=document.getElementById("ItemV").value; //var Hq=document.getElementById("Hq").value;
  window.open("SalesPlanRcoPrint.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&grp="+CropGrp+"&ii="+ii,"PrintForm","menubar=no,scrollbars=yes,resizable=no,directories=no,width=100,height=100");
}

function ExportCoPlan(y,g,i,c)
{ var ComId=document.getElementById("ComId").value; var YId=document.getElementById("YId").value;   
  window.open("ReportCSVSalesPlanRCo.php?action=PlanRExport&ComId="+ComId+"&y="+y+"&g="+g+"&i="+i+"&c="+c+"&YId="+YId,"PrintForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20"); } 
...
<tr>
 <td valign="top">
  <table border="0">
   <tr>
    <td id="Entry" style="width:950px;" valign="top">
	<span id="TabEntry">
     <table border="0">
      <tr>
	    <td style="margin-top:0px;width:200px;" class="heading" align="center"><u>Reports</u></td>
...
<?php if($_REQUEST['grp']==1){ $sqlItem=mysql_query("select * from hrm_sales_seedsitem where GroupId=1 order by ItemName ASC", $con);}
	  ...
	  <tr>
	    <td style="margin-top:0px;width:200px;" class="heading" align="center"><u>Country-Wise</u></td>
...
<option value="<?php echo $ResCountry['CountryId']; ?>"><?php echo strtoupper($ResCountry['CountryName']); ?></option><?php } ?></select>
		 ...
		 <td>&nbsp;</td>
		 <td colspan="2" style="font-size:11px; height:18px;width:80px;color:#E6E6E6;width:200px;" align="right">
		 <?php if($_REQUEST['c']>0){ ?>
		 <a href="#" onClick="PrintSpRco()" style="color:#FFCE9D;"><b>PRINT</b></a>
		 &nbsp;&nbsp;<a href="#" onClick="ExportCoPlan(<?php echo $_REQUEST['y'].', '.$_REQUEST['grp'].', '.$_REQUEST['ii'].', '.$_REQUEST['c']; ?>)" style="color:#F9F900; font-size:12px;"><b>Export Excel</b></a>
		 <?php } ?>
...
?>	  
<table border="1" cellpadding="0" cellspacing="0" style="font-family:Times New Roman;font-size:14px;width:1410px; vertical-align:top;">
...
<?php ///////////////////////////////////////////////////////////?>
 <tr style="height:22px;">
  ...
  <td bgcolor="#EEEEEE" rowspan="8" align="center" style="width:17px;"><b>&nbsp;</b></td>
 </tr>
...
//if($resNrv['NRV']!=0){$NRV=$resNrv['NRV'];}elseif($resNrva['NRV']!=0){$NRV=$resNrva['NRV'];}else{$NRV=0;} $NetNRV_1=$res1Tot*$NRV; $LakhNRV_1=$NetNRV_1/100000; ?>
	 <td style="width:50px;" align="center"><b><?php echo $y1T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y1; ?></b></td>
	
	 <td colspan="3" align="right" width="60"><?php if($TotQ1!=0){echo $TotQ1;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($TotQ2!=0){echo $TotQ2;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($TotQ3!=0){echo $TotQ3;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($TotQ4!=0){echo $TotQ4;} ?>&nbsp;</td>
...
<?php } /* 2 */ if($i==2){ 
if($_REQUEST['ii']>0){ $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_sal_details.YearId=".$BeforeYId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_state.CountryId=".$_REQUEST['c'], $con); }
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details.YearId=".$BeforeYId." AND hrm_state.CountryId=".$_REQUEST['c'], $con); } if($_REQUEST['grp']==3){ $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_sal_details.YearId=".$BeforeYId." AND hrm_state.CountryId=".$_REQUEST['c'], $con); }
}

//$sqlP2d=mysql_query("select * from hrm_sales_sal_details where YearId=".$BeforeYId." AND DealerId=".$_REQUEST['dil'], $con); 
...
//if($resNrv2['NRV']!=0){$NRV2=$resNrv2['NRV'];}elseif($resNrv2a['NRV']!=0){$NRV2=$resNrv2a['NRV'];}else{$NRV2=0;} $NetNRV_2=$res2Tot*$NRV2; $LakhNRV_2=$NetNRV_2/100000; ?>
     <td style="width:50px;" align="center"><b><?php echo $y2T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y2; ?></b></td>
	 
	 <td colspan="3" align="right" width="60"><?php if($Tot2Q1!=0){echo $Tot2Q1;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot2Q2!=0){echo $Tot2Q2;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot2Q3!=0){echo $Tot2Q3;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot2Q4!=0){echo $Tot2Q4;} ?>&nbsp;</td>
...
<?php } /* 3 */ if($i==3){ 
if($_REQUEST['ii']>0){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_sal_details.YearId=".$_REQUEST['y']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_state.CountryId=".$_REQUEST['c'], $con); }
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details.YearId=".$_REQUEST['y']." AND hrm_state.CountryId=".$_REQUEST['c'], $con); } if($_REQUEST['grp']==3){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_sal_details.YearId=".$_REQUEST['y']." AND hrm_state.CountryId=".$_REQUEST['c'], $con); }
}
//$sqlP3d=mysql_query("select * from hrm_sales_sal_details where YearId=".$_REQUEST['y']." AND DealerId=".$_REQUEST['dil'], $con); 
...
//if($resNrv3['NRV']!=0){$NRV3=$resNrv3['NRV'];}elseif($resNrv3a['NRV']!=0){$NRV3=$resNrv3a['NRV'];}else{$NRV3=0;} $NetNRV_3=$res3Tot*$NRV3; $LakhNRV_3=$NetNRV_3/100000; ?>
	 <td style="width:50px;" align="center"><b><?php echo $y3T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y3; ?></b></td> 
	 
	 <td colspan="3" align="right" width="60"><?php if($Tot3Q1!=0){echo $Tot3Q1;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot3Q2!=0){echo $Tot3Q2;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot3Q3!=0){echo $Tot3Q3;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot3Q4!=0){echo $Tot3Q4;} ?>&nbsp;</td>
...
<?php } /* 4 */  if($i==4){ 
if($_REQUEST['ii']>0){ $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_sal_details.YearId=".$AfterYId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_state.CountryId=".$_REQUEST['c'], $con); }
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details.YearId=".$AfterYId." AND hrm_state.CountryId=".$_REQUEST['c'], $con); } if($_REQUEST['grp']==3){ $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_sal_details.YearId=".$AfterYId." AND hrm_state.CountryId=".$_REQUEST['c'], $con); }
}
//$sqlP4d=mysql_query("select * from hrm_sales_sal_details where YearId=".$AfterYId." AND DealerId=".$_REQUEST['dil'], $con); 
...
//if($resNrv4['NRV']!=0){$NRV4=$resNrv4['NRV'];}elseif($resNrv4a['NRV']!=0){$NRV4=$resNrv4a['NRV'];}else{$NRV4=0;} $NetNRV_4=$res4Tot*$NRV4; $LakhNRV_4=$NetNRV_4/100000; ?>
	 <td style="width:50px;" align="center"><b><?php echo $y4T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y4; ?></b></td> 
	 
	 <td colspan="3" align="right" width="60"><?php if($Tot4Q1!=0){echo $Tot4Q1;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot4Q2!=0){echo $Tot4Q2;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot4Q3!=0){echo $Tot4Q3;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot4Q4!=0){echo $Tot4Q4;} ?>&nbsp;</td>
...
<?php } /* 5 */  $sqlYe=mysql_query("select FromDate,ToDate from hrm_sales_year where YearId=".$YearId, $con); $resYe=mysql_fetch_assoc($sqlYe);
	    ...
	    if($i==5){ 
if($_REQUEST['ii']>0){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_sal_details.YearId=".$YearId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_state.CountryId=".$_REQUEST['c'], $con); }
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details.YearId=".$YearId." AND hrm_state.CountryId=".$_REQUEST['c'], $con); } if($_REQUEST['grp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_sales_sal_details.YearId=".$YearId." AND hrm_state.CountryId=".$_REQUEST['c'], $con); }
}		
//$sqlP5d=mysql_query("select * from hrm_sales_sal_details where YearId=".$YearId." AND DealerId=".$_REQUEST['dil'], $con); 
...
//if($resNrv5['NRV']!=0){$NRV5=$resNrv5['NRV'];}elseif($resNrv5a['NRV']!=0){$NRV5=$resNrv5a['NRV'];}else{$NRV5=0;} $NetNRV_5=$res5Tot*$NRV5; $LakhNRV_5=$NetNRV_5/100000; ?>
	 <td style="width:50px;" align="center"><b><?php echo $yeT; ?></b></td><td style="width:50px;" align="center"><b><?php echo $yeft; ?></b></td> 
	 
	 <td colspan="3" align="right" width="60"><?php if($Tot5Q1!=0){echo $Tot5Q1;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot5Q2!=0){echo $Tot5Q2;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot5Q3!=0){echo $Tot5Q3;} ?>&nbsp;</td>
	 <td colspan="3" align="right" width="60"><?php if($Tot5Q4!=0){echo $Tot5Q4;} ?>&nbsp;</td>
...
<?php ////////////////////////////////////////////////////////// ?>
  ...
  <tr style="background-color:#D5F1D1;color:#000000;">
    <td colspan="5" style="font-size:16px;color:#D7EBFF;background-color:#183E83;width:470px;">&nbsp;<b><?php echo 'Country - '.strtoupper($resC['CountryName']); ?></b></td>
    <td align="center" width="60" rowspan="2"><b>APR-<?php echo $my1;?></b></td><td align="center" width="60" rowspan="2"><b>MAY-<?php echo $my1;?></b></td><td align="center" width="60" rowspan="2"><b>JUN-<?php echo $my1;?></b></td><td align="center" width="60" rowspan="2"><b>JUL-<?php echo $my1;?></b></td><td align="center" width="60" rowspan="2"><b>AUG-<?php echo $my1;?></b></td><td align="center" width="60" rowspan="2"><b>SEP-<?php echo $my1;?></b></td><td align="center" width="60" rowspan="2"><b>OCT-<?php echo $my1;?></b></td><td align="center" width="60" rowspan="2"><b>NOV-<?php echo $my1;?></b></td><td align="center" width="60" rowspan="2"><b>DEC-<?php echo $my1;?></b></td><td align="center" width="60" rowspan="2"><b>JAN-<?php echo $my2;?></b></td><td align="center" width="60" rowspan="2"><b>FEB-<?php echo $my2;?></b></td><td align="center" width="60" rowspan="2"><b>MAR-<?php echo $my2;?></b></td><td align="center" width="80" rowspan="2"><b>TOTAL<br><font color="#E67300">Kg</font></b></td><td align="center" width="80" rowspan="2"><b>VALUE<br><font color="#E67300">Lakh</font></b></td>	   
  </tr>	
   <tr style="background-color:#D5F1D1;color:#000000;">  
...
<table border="1" cellpadding="0" cellspacing="0" style="font-family:Times New Roman;font-size:14px; vertical-align:top;">	
  ...
  <tr bgcolor="#EEEEEE" style="height:22px;background-color:<?php if($i==1){echo '#E2F3D8'; }?>;"> 
     <td bgcolor="<?php if($i==1){echo '#B8E29C';}?>" style="width:120px;">&nbsp;<?php if($i==1){echo $res['ItemName'];} ?></td>	 
     <td bgcolor="<?php if($i==1){echo '#B8E29C';}?>" style="width:200px;">&nbsp;<?php if($i==1){echo $res['ProductName'];} ?></td>
     <td bgcolor="<?php if($i==1){echo '#B8E29C';}?>" align="center" style="width:50px;">&nbsp;<?php if($i==1){echo substr_replace($res['TypeName'],'',2);}?></td>	  
<?php /* 1 */ if($i==1){$sqlP1d=mysql_query("select SUM(M1_Ach) as tm1,SUM(M2_Ach) as tm2,SUM(M3_Ach) as tm3,SUM(M4_Ach) as tm4,SUM(M5_Ach) as tm5,SUM(M6_Ach) as tm6,SUM(M7_Ach) as tm7,SUM(M8_Ach) as tm8,SUM(M9_Ach) as tm9,SUM(M10_Ach) as tm10,SUM(M11_Ach) as tm11,SUM(M12_Ach) as tm12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_state.CountryId=".$_REQUEST['c']." AND hrm_sales_sal_details.YearId=".$BeforeYId2." AND hrm_sales_sal_details.ProductId=".$res['ProductId'], $con); $res1=mysql_fetch_assoc($sqlP1d); 
...
<td style="width:50px;" align="center"><b><?php echo $y1T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y1; ?></b></td>
	 <td align="right" width="60"><?php if($res1['tm1']!=0){echo $res1['tm1'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm2']!=0){echo $res1['tm2'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm3']!=0){echo $res1['tm3'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm4']!=0){echo $res1['tm4'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm5']!=0){echo $res1['tm5'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm6']!=0){echo $res1['tm6'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm7']!=0){echo $res1['tm7'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm8']!=0){echo $res1['tm8'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm9']!=0){echo $res1['tm9'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm10']!=0){echo $res1['tm10'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm11']!=0){echo $res1['tm11'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res1['tm12']!=0){echo $res1['tm12'];} ?>&nbsp;</td><td align="right" width="80"><b><?php if($res1Tot!=0){echo $res1Tot;} ?></b>&nbsp;</td><td align="right" width="80"><b><?php if($LakhNRV_1!=0){echo round($LakhNRV_1,4);} ?></b>&nbsp;
...
<?php } /* 2 */ if($i==2){ $sqlP2d=mysql_query("select SUM(M1_Ach) as tm1,SUM(M2_Ach) as tm2,SUM(M3_Ach) as tm3,SUM(M4_Ach) as tm4,SUM(M5_Ach) as tm5,SUM(M6_Ach) as tm6,SUM(M7_Ach) as tm7,SUM(M8_Ach) as tm8,SUM(M9_Ach) as tm9,SUM(M10_Ach) as tm10,SUM(M11_Ach) as tm11,SUM(M12_Ach) as tm12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_state.CountryId=".$_REQUEST['c']." AND hrm_sales_sal_details.YearId=".$BeforeYId." AND hrm_sales_sal_details.ProductId=".$res['ProductId'], $con); $res2=mysql_fetch_assoc($sqlP2d); 
...
?>
	...
	<td style="width:50px;" align="center"><b><?php echo $y2T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y2; ?></b></td>  
	 <td align="right" width="60"><?php if($res2['tm1']!=0){echo $res2['tm1'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm2']!=0){echo $res2['tm2'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm3']!=0){echo $res2['tm3'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm4']!=0){echo $res2['tm4'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm5']!=0){echo $res2['tm5'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm6']!=0){echo $res2['tm6'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm7']!=0){echo $res2['tm7'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm8']!=0){echo $res2['tm8'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm9']!=0){echo $res2['tm9'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm10']!=0){echo $res2['tm10'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm11']!=0){echo $res2['tm11'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res2['tm12']!=0){echo $res2['tm12'];} ?>&nbsp;</td><td align="right" width="80"><b><?php if($res2Tot!=0){echo $res2Tot;} ?></b>&nbsp;</td><td align="right" width="80"><b><?php if($LakhNRV_2!=0){echo round($LakhNRV_2,4);} ?></b>&nbsp;
...
?>
	 ...
	 <td style="width:50px;" align="center"><b><?php echo $y3T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y3; ?></b></td> 
	 <td align="right" width="60"><?php if($res3['tm1']!=0){echo $res3['tm1'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm2']!=0){echo $res3['tm2'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm3']!=0){echo $res3['tm3'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm4']!=0){echo $res3['tm4'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm5']!=0){echo $res3['tm5'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm6']!=0){echo $res3['tm6'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm7']!=0){echo $res3['tm7'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm8']!=0){echo $res3['tm8'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm9']!=0){echo $res3['tm9'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm10']!=0){echo $res3['tm10'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm11']!=0){echo $res3['tm11'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res3['tm12']!=0){echo $res3['tm12'];} ?>&nbsp;</td><td align="right" width="80"><b><?php if($res3Tot!=0){echo $res3Tot;} ?></b>&nbsp;</td><td align="right" width="80"><b><?php if($LakhNRV_3!=0){echo round($LakhNRV_3,4);} ?></b>&nbsp;
...
<?php } /* 4 */  if($i==4){ $sqlP4d=mysql_query("select SUM(M1) as tm1,SUM(M2) as tm2,SUM(M3) as tm3,SUM(M4) as tm4,SUM(M5) as tm5,SUM(M6) as tm6,SUM(M7) as tm7,SUM(M8) as tm8,SUM(M9) as tm9,SUM(M10) as tm10,SUM(M11) as tm11,SUM(M12) as tm12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_state.CountryId=".$_REQUEST['c']." AND hrm_sales_sal_details.YearId=".$AfterYId." AND hrm_sales_sal_details.ProductId=".$res['ProductId'], $con); $res4=mysql_fetch_assoc($sqlP4d); 
...
?>
	...
	<td style="width:50px;" align="center"><b><?php echo $y4T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y4; ?></b></td> 
	 <td align="right" width="60"><?php if($res4['tm1']!=0){echo $res4['tm1'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm2']!=0){echo $res4['tm2'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm3']!=0){echo $res4['tm3'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm4']!=0){echo $res4['tm4'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm5']!=0){echo $res4['tm5'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm6']!=0){echo $res4['tm6'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm7']!=0){echo $res4['tm7'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm8']!=0){echo $res4['tm8'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm9']!=0){echo $res4['tm9'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm10']!=0){echo $res4['tm10'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm11']!=0){echo $res4['tm11'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res4['tm12']!=0){echo $res4['tm12'];} ?>&nbsp;</td><td align="right" width="80"><b><?php if($res4Tot!=0){echo $res4Tot;} ?></b>&nbsp;</td><td align="right" width="80"><b><?php if($LakhNRV_4!=0){echo round($LakhNRV_4,4);} ?></b>&nbsp;
...
<?php } /* 5 */  $sqlYe=mysql_query("select FromDate,ToDate from hrm_sales_year where YearId=".$YearId, $con); $resYe=mysql_fetch_assoc($sqlYe);
        $yeft=date("y",strtotime($resYe['FromDate'])).'-'.date("y",strtotime($resYe['ToDate'])); $yeT='<font color="#A60053">YTD</font>'; 
	    if($i==5){ $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId INNER JOIN hrm_state ON hrm_headquater.StateId=hrm_state.StateId where hrm_state.CountryId=".$_REQUEST['c']." AND hrm_sales_sal_details.YearId=".$YearId." AND hrm_sales_sal_details.ProductId=".$res['ProductId'], $con); $res5=mysql_fetch_assoc($sqlP5d);  
...
?>
	  <td style="width:50px;" align="center"><b><?php echo $yeT; ?></b></td><td style="width:50px;" align="center"><b><?php echo $yeft; ?></b></td> 
	 <td align="right" width="60"><?php if($res5['tM1']!=0){echo $res5['tM1'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res5['tM2']!=0){echo $res5['tM2'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res5['tM3']!=0){echo $res5['tM3'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res5['tM4']!=0){echo $res5['tM4'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res5['tM5']!=0){echo $res5['tM5'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res5['tM6']!=0){echo $res5['tM6'];} ?>&nbsp;</td> <td align="right" width="60"><?php if($res5['tM7']!=0){echo $res5['tM7'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res5['tM8']!=0){echo $res5['tM8'];} ?>&nbsp;</td> <td align="right" width="60"><?php if($res5['tM9']!=0){echo $res5['tM9'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res5['tM10']!=0){echo $res5['tM10'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res5['tM11']!=0){echo $res5['tM11'];} ?>&nbsp;</td><td align="right" width="60"><?php if($res5['tM12']!=0){echo $res5['tM12'];} ?>&nbsp;</td><td align="right" width="80"><b><?php if($res5Tot!=0){echo $res5Tot;} ?></b>&nbsp;</td><td align="right" width="80"><b><?php if($LakhNRV_5!=0){echo round($LakhNRV_5,4);} ?></b>&nbsp;
