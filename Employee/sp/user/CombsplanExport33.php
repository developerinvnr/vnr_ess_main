...
$AmtTot=$resTot*$rNrv['NRV']; $AmtQ1=$resTot1*$rNrv['NRV']; $AmtQ2=$resTot2*$rNrv['NRV']; $AmtQ3=$resTot3*$rNrv['NRV']; $AmtQ4=$resTot4*$rNrv['NRV'];


if($res['M1']!=0){$M1=floatval($res['M1']);}else{$M1='0';} if($res['M2']!=0){$M2=floatval($res['M2']);}else{$M2='0';}
if($res['M3']!=0){$M3=floatval($res['M3']);}else{$M3='0';} if($res['M4']!=0){$M4=floatval($res['M4']);}else{$M4='0';}
if($res['M5']!=0){$M5=floatval($res['M5']);}else{$M5='0';} if($res['M6']!=0){$M6=floatval($res['M6']);}else{$M6='0';}
if($res['M7']!=0){$M7=floatval($res['M7']);}else{$M7='0';} if($res['M8']!=0){$M8=floatval($res['M8']);}else{$M8='0';}
if($res['M9']!=0){$M9=floatval($res['M9']);}else{$M9='0';} if($res['M10']!=0){$M10=floatval($res['M10']);}else{$M10='0';}
if($res['M11']!=0){$M11=floatval($res['M11']);}else{$M11='0';} if($res['M12']!=0){$M12=floatval($res['M12']);}else{$M12='0';}
...
if($res['M1_Ach']!=0){$M1=floatval($res['M1_Ach']);}else{$M1='0';} if($res['M2_Ach']!=0){$M2=floatval($res['M2_Ach']);}else{$M2='0';}
if($res['M3_Ach']!=0){$M3=floatval($res['M3_Ach']);}else{$M3='0';} if($res['M4_Ach']!=0){$M4=floatval($res['M4_Ach']);}else{$M4='0';}
if($res['M5_Ach']!=0){$M5=floatval($res['M5_Ach']);}else{$M5='0';} if($res['M6_Ach']!=0){$M6=floatval($res['M6_Ach']);}else{$M6='0';}
if($res['M7_Ach']!=0){$M7=floatval($res['M7_Ach']);}else{$M7='0';} if($res['M8_Ach']!=0){$M8=floatval($res['M8_Ach']);}else{$M8='0';}
if($res['M9_Ach']!=0){$M9=floatval($res['M9_Ach']);}else{$M9='0';} if($res['M10_Ach']!=0){$M10=floatval($res['M10_Ach']);}else{$M10='0';}
if($res['M11_Ach']!=0){$M11=floatval($res['M11_Ach']);}else{$M11='0';} if($res['M12_Ach']!=0){$M12=floatval($res['M12_Ach']);}else{$M12='0';}
