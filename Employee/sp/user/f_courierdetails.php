...
<table border="0">
 <tr>
  ...
  <td class="tdf2" style="width:120px;"><b>Docket No</b></td>
...
<?php
$sql_statement = mysql_query("select * from fa_courierdetail", $con);
$total_records = mysql_num_rows($sql_statement);
if(isset($_GET['page']))$page = $_GET['page'];else $page = 1;
$offset = 15;
if ($page){$from = ($page * $offset) - $offset;}else{$from = 0;}
$sql=mysql_query("select * from fa_courierdetail order by Year DESC, Month DESC LIMIT ".$from.",".$offset,$con); 
...
?> 	 
 <tr style="background-color:#FFFFFF;height:24px;"> 
  ...
  <td class="tdf">&nbsp;<?php echo strtoupper($res['Agency']); ?></td>
   <td class="tdf" align="center"><?php if($res['CuImag']!=''){?><a href="../Employee/DocateImg/<?php echo $res['CuImag'];?>" target="_blank">Click</a><?php } ?></td>
