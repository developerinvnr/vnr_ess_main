...
$sqlDis=mysql_query("select DealerId,DealerName,DealerCity from hrm_sales_dealer where (Hq_vc=".$_POST['hqid']." OR Hq_fc=".$_POST['hqid'].") group by DealerId order by DealerName asc",$con); while($resDis=mysql_fetch_assoc($sqlDis)){
...
$sqlDis2=mysql_query("select DealerId,DealerName,DealerCity from hrm_sales_dealer where (Hq_vc=".$_POST['hqid2']." OR Hq_fc=".$_POST['hqid2'].") group by DealerId order by DealerName asc",$con); while($resDis2=mysql_fetch_assoc($sqlDis2)){
