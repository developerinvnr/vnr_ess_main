  ...
  <td style="width:100%;" valign="top">  
   ...
   <tr>
	<td>
	 <table border="0">
		<tr>
	    <td class="htf2" align="left"><u>Salary Claim</u>&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<?php if($_REQUEST['rsts']>0 OR $_REQUEST['rsts']=='All'){ ?>	
	<tr>
	 <td>
      ...
      <td colspan="7" class="htf">&nbsp;General Details&nbsp;&nbsp;&nbsp;&nbsp;(P-present,&nbsp;A-absent)</td>
	  ...
	  <td style="width:50px;" class="htf">Salary</td>
	  <td style="width:50px;" class="htf">Expen.</td>
	  ...
	  <td style="width:70px;" class="htf">Action</td>
...
<td class="tdf2"><input class="InputType" style="width:80px;" id="Hq<?php echo $sn; ?>" value="<?php echo ucfirst(strtolower($rhq['HqName'])); ?>" readonly/></td>
	 ...
	 <td class="tdf2" align="right"><?php echo floatval($res['Expences']); ?>&nbsp;</td>
...
<?php $sn++; } ?>
   <tr>
    ...
    <td colspan="11" style="font-family:Times New Roman;font-size:15px;font-weight:bold;">
     <?php doPages($offset, 'f_claim.php', '', $total_records,$_REQUEST['hq'],$_REQUEST['s'],$_REQUEST['m'],$_REQUEST['y'],$_REQUEST['md'],$_REQUEST['rsts']); ?>
    </td>
   </tr>
<?php } ?> 
