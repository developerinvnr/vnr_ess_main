...
<tr bgcolor="#808000">
 ...
 <td class="font" align="center" style="width:100;"><b>Size Name</b></td>
 <td class="font" align="center" style="width:100;"><b>Size For</b></td>
...
<tr>
 ...
 <td align="center" valign="middle" style="font:Georgia; font-size:12px;"><a href="#"><img src="images/edit.png" border="0" alt="Edit" onClick="edit(<?php echo $res['SizeId']; ?>)"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"><img src="images/delete.png" alt="Delete" border="0" onClick="del(<?php echo $res['SizeId']; ?>)"></a></td>
</tr>
<?php } $SNo++;} ?>
