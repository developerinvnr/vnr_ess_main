...
{ if(document.getElementById("Chk"+sn).checked==true)
  { document.getElementById("TR"+sn).style.background='#9BEF47'; document.getElementById("TD1"+sn).style.background='#9BEF47';
	...
	document.getElementById("TD6"+sn).style.background='#9BEF47'; }
  ...
  { document.getElementById("TR"+sn).style.background='#FFFFFF'; document.getElementById("TD1"+sn).style.background='#FFFFFF';
	...
	document.getElementById("TD6"+sn).style.background='#FFFFFF'; }
}
...
<table border="1" cellpadding="0" cellspacing="0" style="font-family:Times New Roman;font-size:14px;width:<?php if($_REQUEST['m']>0){echo 950;}elseif($_REQUEST['m']=='All'){echo 1400;} ?>px; vertical-align:top;">	
  <tr style="background-color:#D5F1D1;color:#000000;">  
	...
	<td colspan="2" align="center" style="width:150px;font-size:12px;"><b><?php echo $y3; ?></b></td>
	<td colspan="2" align="center" style="width:150px;font-size:12px;"><b><?php echo $y4; ?></b></td>
...
?>	 
	 ...
	 <td align="right" style="background-color:#FFFFB9;" id="TD4<?php echo $Sn; ?>"><?php if($stck>0 AND $Tots>0){ $PerStck=($stck/$Tots)*100; echo round($PerStck,3); }else {echo '';} ?></td>
	 <td align="right" style="background-color:#D5FFAA;" id="TD5<?php echo $Sn; ?>"><?php if($Tot2s!=0){echo $Tot2s;} ?></td>
	 <td align="right" style="background-color:#D5FFAA;" id="TD6<?php echo $Sn; ?>"><?php if($stck>0 AND $Tot2s>0){ $PerStck2=($stck/$Tot2s)*100; echo round($PerStck2,3); }else {echo '';} ?></td>
  </tr>	
<?php $Sn++; } ?>  	  
</table>	   	       
<?php } ?>
