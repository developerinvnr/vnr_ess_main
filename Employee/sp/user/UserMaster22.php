...
{                         					
 $SqlUpdate = mysql_query("UPDATE hrm_sales_useremp SET UserEmpId=".$_POST['username'].", Status='".$_POST['status']."', UserEmpType='".$_POST['type']."', UEAdd='".$_POST['eadd']."', UEEdit='".$_POST['eedit']."', UEView='".$_POST['eview']."', Master='".$_POST['Master']."', CMaster='".$_POST['CMaster']."', SMaster='".$_POST['SMaster']."', PMaster='".$_POST['PMaster']."', UMaster='".$_POST['UMaster']."', Import='".$_POST['Import']."', Logistic='".$_POST['Logistic']."', LogAchi='".$_POST['LogAchi']."', LogTest='".$_POST['LogTest']."', Production='".$_POST['Production']."', ProdStock='".$_POST['ProdStock']."', Reports='".$_POST['Reports']."', ProdRep='".$_POST['ProdRep']."', SalesRep='".$_POST['SalesRep']."' WHERE SUserEmpId=".$_POST['sid'], $con);
if($SqlUpdate){ $msg = "Data has been updated successfully..."; } 
}

if(isset($_POST['NewSaveUser']))
{
 $SqlNewInseartUser = mysql_query("INSERT INTO hrm_sales_useremp(UserEmpId, Status, UserEmpType, UEAdd, UEEdit, UEView, Master, CMaster, SMaster, PMaster, UMaster, Import, Logistic, LogAchi, LogTest, Production, ProdStock, Reports, ProdRep, SalesRep, CDate) VALUES(".$_POST['username'].", '".$_POST['status']."', '".$_POST['type']."', '".$_POST['eadd']."', '".$_POST['eedit']."', '".$_POST['eview']."', '".$_POST['Master']."', '".$_POST['CMaster']."', '".$_POST['SMaster']."', '".$_POST['PMaster']."', '".$_POST['UMaster']."', '".$_POST['Import']."', '".$_POST['Logistic']."', '".$_POST['LogAchi']."', '".$_POST['LogTest']."', '".$_POST['Production']."', '".$_POST['ProdStock']."', '".$_POST['Reports']."', '".$_POST['ProdRep']."', '".$_POST['SalesRep']."', '".date("Y-m-d")."')", $con);
}
			   ...
			   <td> 
			    <table border="1" bgcolor="#FFFFFF" style="width:1570px;">
				  <tr bgcolor="#808000"> 
					...
					<td rowspan="2" align="center" class="font" style="width:200px;"><b>User Name</b></td>
					<td rowspan="2" align="center" class="font" style="width:80px;"><b>Status</b></td>
					<td rowspan="2" align="center" class="font" style="width:80px;"><b>Type</b></td>
					<td colspan="17" align="center" class="font"><b>Permission to Access</b></td>
					<td rowspan="2" align="center" class="font" style="width:100px;"><b>Action</b></td>
 			     </tr>
				 <tr bgcolor="#808000"> 
					<td align="center" class="font" style="width:60px;"><b>Master</b></td> 
					<td align="center" class="font" style="width:60px;"><b>Crop Master</b></td>
					<td align="center" class="font" style="width:60px;"><b>Sales Master</b></td>
					<td align="center" class="font" style="width:60px;"><b>Prod<sup>n</sup> Master</b></td>
					<td align="center" class="font" style="width:60px;"><b>User Master</b></td>
					<td align="center" class="font" style="width:60px;"><b>Import</b></td>
					<td align="center" class="font" style="width:60px;"><b>Logistic</b></td>
					<td align="center" class="font" style="width:60px;"><b>Log<sup>t</sup> Achi</b></td>
					<td align="center" class="font" style="width:60px;"><b>Log<sup>t</sup> Test</b></td>
					<td align="center" class="font" style="width:60px;"><b>Prod<sup>t</sup></b></td>
					<td align="center" class="font" style="width:60px;"><b>Prod<sup>n</sup> Stock</b></b></td>
					<td align="center" class="font" style="width:60px;"><b>Reports</b></td>
					<td align="center" class="font" style="width:60px;"><b>Prod<sup>n</sup> Reports</b></td>
					<td align="center" class="font" style="width:60px;"><b>Sales Reports</b></td>
					<td align="center" class="font" style="width:60px;"><b>Add</b></td>
					<td align="center" class="font" style="width:60px;"><b>Edit</b></td>
					<td align="center" class="font" style="width:60px;"><b>View</b></td>
 			     </tr>
...
<?php $sqlUn=mysql_query("select Fname,Sname,Lname from hrm_employee where EmployeeID=".$ResultUser['UserEmpId'], $con); $resUn=mysql_fetch_assoc($sqlUn); ?>					
					<select class="EditInput" name="username" id="username" style="width:198px;">
					<option value="<?php echo $ResultUser['UserEmpId'];?>"><?php echo $resUn['Fname'].' '.$resUn['Sname'].' '.$resUn['Lname'];?></option>
<?php $sqlUn2=mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND (hrm_employee_general.DepartmentId=7 OR hrm_employee_general.DepartmentId=17 order by Fname ASC", $con); while($resUn2=mysql_fetch_assoc($sqlUn2)){ ?>					
					<option value="<?php echo $resUn2['EmployeeID']; ?>"><?php echo $resUn2['Fname'].' '.$resUn2['Sname'].' '.$resUn2['Lname'];?></option><?php } ?></select></td>
					<td align="center" class="font1"><select class="EditInput" name="status" id="status" style="width:75px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="type" id="type" style="width:75px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="Master" id="Master" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="CMaster" id="CMaster" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="SMaster" id="SMaster" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="PMaster" id="PMaster" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="UMaster" id="UMaster" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="Import" id="Import" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="Logistic" id="Logistic" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="LogAchi" id="LogAchi" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="LogTest" id="LogTest" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="Production" id="Production" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="ProdStock" id="ProdStock" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="Reports" id="Reports" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="ProdRep" id="ProdRep" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="SalesRep" id="SalesRep" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="eadd" id="eadd" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="eedit" id="eedit" style="width:55px;">
					...
					<td align="center" class="font1"><select class="EditInput" name="eview" id="eview" style="width:55px;">
...
<?php $sqlUn=mysql_query("select Fname,Sname,Lname from hrm_employee where EmployeeID=".$ResultUser['UserEmpId'], $con); $resUn=mysql_fetch_assoc($sqlUn); ?>					
					...
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['Master']=='Y'){echo 'Yes';}else{echo 'No';}?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['CMaster']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['SMaster']=='Y'){echo 'Yes';}else{echo 'No';}?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['PMaster']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['UMaster']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['Import']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['Logistic']=='Y'){echo 'Yes';}else{echo 'No';}?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['LogAchi']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['LogTest']=='Y'){echo 'Yes';}else{echo 'No';}?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['Production']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['ProdStock']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['Reports']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['ProdRep']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['SalesRep']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['UEAdd']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['UEEdit']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
					<td align="center" class="font1">&nbsp;<?php if($ResultUser['UEView']=='Y'){echo 'Yes';}else{echo 'No';} ?></td>
				...
				<?php } $Sno++; } ?> 
				<tr><td bgcolor="#B6E9E2" colspan="22"></td></tr>
				<?php //-----------------------------------------Add New User--------------------------------------------------------------- ?>
				...
				<form name="formUserNew" method="post" onSubmit="return validateNew(this)">
				 <tr> 
				  <td align="center" class="font1"><?php echo $Sno; ?></td>
					<td style="color:#ffffff; font-family:Georgia;font-size:11px;">	
					<select class="EditInput" name="username" id="username" style="width:198px;">
<?php $sqlUn2=mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND (hrm_employee_general.DepartmentId=7 OR hrm_employee_general.DepartmentId=17) order by Fname ASC", $con); while($resUn2=mysql_fetch_assoc($sqlUn2)){ ?>					
					<option value="<?php echo $resUn2['EmployeeID']; ?>"><?php echo $resUn2['Fname'].' '.$resUn2['Sname'].' '.$resUn2['Lname'];?></option><?php } ?></select></td>
					<td align="center" class="font1"><select class="EditInput" name="status" id="status" style="width:75px;">
