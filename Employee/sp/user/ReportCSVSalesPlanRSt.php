...
$sqlSt=mysql_query("select StateName from hrm_state where StateId=".$_REQUEST['s'], $con); $resSt=mysql_fetch_assoc($sqlSt);
/*************************************************************************************************************/
include("CalYCsv.php");
...
/* 1 */ if($j==1){
$sqlP1d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId2." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_headquater hq ON d.".$HqCon."=hq.HqId where ".$subQ." AND sd.YearId=".$BeforeYId2." AND ".$qin." AND hq.StateId=".$_REQUEST['s'], $con); 
...
$sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_headquater hq ON d.".$HqCon."=hq.HqId where ".$subQ." AND sd.YearId=".$BeforeYId." AND ".$qin." AND hq.StateId=".$_REQUEST['s'], $con); 
...
$sqlP4d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_headquater hq ON d.".$HqCon."=hq.HqId where ".$subQ." AND sd.YearId=".$AfterYId." AND ".$qin." AND hq.StateId=".$_REQUEST['s'], $con);
...
if($res1['M1']>0){$mAch1=$res1['M1'];}else{$mAch1='';}
if($res1['M2']>0){$mAch2=$res1['M2'];}else{$mAch2='';}
if($res1['M3']>0){$mAch3=$res1['M3'];}else{$mAch3='';}
if($res1['M4']>0){$mAch4=$res1['M4'];}else{$mAch4='';}
if($res1['M5']>0){$mAch5=$res1['M5'];}else{$mAch5='';}
if($res1['M6']>0){$mAch6=$res1['M6'];}else{$mAch6='';}
if($res1['M7']>0){$mAch7=$res1['M7'];}else{$mAch7='';}
if($res1['M8']>0){$mAch8=$res1['M8'];}else{$mAch8='';}
if($res1['M9']>0){$mAch9=$res1['M9'];}else{$mAch9='';}
if($res1['M10']>0){$mAch10=$res1['M10'];}else{$mAch10='';}
if($res1['M11']>0){$mAch11=$res1['M11'];}else{$mAch11='';}
if($res1['M12']>0){$mAch12=$res1['M12'];}else{$mAch12='';}
...
header("Content-Disposition:attachment;filename=SalesPlan_State_".$resSt['StateName'].".csv");
echo $csv_output;
exit;
}
?>