...
$sql1 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=61", $con); 
$res1=mysql_num_rows($sql1); if($res1>0){ $res1 = mysql_fetch_assoc($sql1); $EmpID=$res1['EmployeeID']; }
elseif($res1==0)
{ $sql2 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=62", $con); 
  $res2=mysql_num_rows($sql2); if($res2>0){ $res2 = mysql_fetch_assoc($sql2); $EmpID=$res2['EmployeeID']; }
  elseif($res2==0)
  { $sql3 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=63", $con); 
    $res3=mysql_num_rows($sql3); if($res3>0){ $res3 = mysql_fetch_assoc($sql3); $EmpID=$res3['EmployeeID']; }
	elseif($res3==0)
    { $sql4 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=64", $con); 
      $res4=mysql_num_rows($sql4); if($res4>0){ $res4 = mysql_fetch_assoc($sql4); $EmpID=$res4['EmployeeID']; }
	  elseif($res4==0)
      { $sql5 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=65", $con); 
        $res5=mysql_num_rows($sql5); if($res5>0){ $res5 = mysql_fetch_assoc($sql5); $EmpID=$res5['EmployeeID']; }
		elseif($res5==0)
        { $sql6 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=66", $con); 
          $res6=mysql_num_rows($sql6); if($res6>0){ $res6 = mysql_fetch_assoc($sql6); $EmpID=$res6['EmployeeID']; }
		  elseif($res6==0)
          { $sql7 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=67", $con); 
            $res7=mysql_num_rows($sql7); if($res7>0){ $res7 = mysql_fetch_assoc($sql7); $EmpID=$res7['EmployeeID']; }
			elseif($res7==0)
            { $sql8 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=68", $con); 
              $res8=mysql_num_rows($sql8); if($res8>0){ $res8 = mysql_fetch_assoc($sql8); $EmpID=$res8['EmployeeID']; }
			  elseif($res8==0)
              { $sql9 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=69", $con); 
                $res9=mysql_num_rows($sql9); if($res9>0){ $res9 = mysql_fetch_assoc($sql9); $EmpID=$res9['EmployeeID']; }
				elseif($res9==0)
                { $sql10 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=70", $con); 
                  $res10=mysql_num_rows($sql10); if($res10>0){ $res10 = mysql_fetch_assoc($sql10); $EmpID=$res10['EmployeeID']; }
				  elseif($res10==0)
                  { $sql11 = mysql_query("SELECT EmployeeID FROM hrm_employee_general where DepartmentId=6 AND HqId=".$reshs['HqId']." AND GradeId=71", $con); 
