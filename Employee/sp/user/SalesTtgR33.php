...
{ 
  ...
  var s1=document.getElementById("Inp_1").value; var s2=document.getElementById("Inp_2").value; var s3=document.getElementById("Inp_3").value; var s4=document.getElementById("Inp_4").value;
  var s5=document.getElementById("Inp_5").value; var s6=document.getElementById("Inp_6").value;	var s7=document.getElementById("Inp_7").value; var s8=document.getElementById("Inp_8").value;
     ...
     <table border="0">
	  <tr>
	   ...
	   <td><input type="checkbox" id="FChkk1" onClick="CB1Click()" <?php if($_REQUEST['ta']==1){echo 'checked';} ?>/></td>
		 <td style="font-size:11px; height:18px;width:80px;color:#E6E6E6;"><b>2015-16</b></td>
		 <td ><input type="checkbox" id="FChkk2" onClick="CB2Click()" <?php if($_REQUEST['tb']==1){echo 'checked';} ?> /></td>
		 <td style="font-size:11px; height:18px;width:80px;color:#E6E6E6;"><b>2016-17</b></td>
		 <td ><input type="checkbox" id="FChkk3" onClick="CB3Click()" <?php if($_REQUEST['tc']==1){echo 'checked';} ?> /></td>
		 <td style="font-size:11px; height:18px;width:80px;color:#E6E6E6;"><b>2017-18</b></td>
...
<?php //2013-14->2, 2014-15->3, 2015-16->4  ?>  
  <tr>
...
<?php if($_REQUEST['ta']==1){?><td colspan="2" align="center"><b>2015-2016</b></td><?php } ?>
<?php if($_REQUEST['tb']==1){?>	<td colspan="2" align="center"><b>2016-2017</b></td><?php } ?>
<?php if($_REQUEST['tc']==1){?>	<td colspan="2" align="center"><b>2017-2018</b></td><?php } ?>
...
if($_REQUEST['hq']>0)
{ 
 if($_REQUEST['ta']==1){ $hq1=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_4 INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_4.DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_4.YearId=4 AND hrm_sales_dealer.HqId=".$_REQUEST['hq'], $con); $rhq1=mysql_fetch_assoc($hq1);$TotHq1=$rhq1['sM1']+$rhq1['sM2']+$rhq1['sM3']+$rhq1['sM4']+$rhq1['sM5']+$rhq1['sM6']+$rhq1['sM7']+$rhq1['sM8']+$rhq1['sM9']+$rhq1['sM10']+$rhq1['sM11']+$rhq1['sM12']; $AppHq1=mysql_query("select * from hrm_sales_achive_approved_hq where HqId=".$_REQUEST['hq']." AND YearId=3", $con); $rAppHq1=mysql_num_rows($AppHq1); $resAppHq1=mysql_fetch_assoc($AppHq1); } 
 if($_REQUEST['tb']==1){ $hq2=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_5 INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_5.DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_5.YearId=5 AND hrm_sales_dealer.HqId=".$_REQUEST['hq'], $con); $rhq2=mysql_fetch_assoc($hq2);
$TotHq2=$rhq2['sM1']+$rhq2['sM2']+$rhq2['sM3']+$rhq2['sM4']+$rhq2['sM5']+$rhq2['sM6']+$rhq2['sM7']+$rhq2['sM8']+$rhq2['sM9']+$rhq2['sM10']+$rhq2['sM11']+$rhq2['sM12'];	
$AppHq2=mysql_query("select * from hrm_sales_achive_approved_hq where HqId=".$_REQUEST['hq']." AND YearId=4", $con); $rAppHq2=mysql_num_rows($AppHq2); $resAppHq2=mysql_fetch_assoc($AppHq2); } 
 if($_REQUEST['tc']==1){ $hq3=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_6 INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_6.DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_6.YearId=6 AND hrm_sales_dealer.HqId=".$_REQUEST['hq'], $con); $rhq3=mysql_fetch_assoc($hq3);$TotHq3=$rhq3['sM1']+$rhq3['sM2']+$rhq3['sM3']+$rhq3['sM4']+$rhq3['sM5']+$rhq3['sM6']+$rhq3['sM7']+$rhq3['sM8']+$rhq3['sM9']+$rhq3['sM10']+$rhq3['sM11']+$rhq3['sM12'];
$AppHq3=mysql_query("select * from hrm_sales_achive_approved_hq where HqId=".$_REQUEST['hq']." AND YearId=5", $con); $rAppHq3=mysql_num_rows($AppHq3); $resAppHq3=mysql_fetch_assoc($AppHq3); } 
} 
elseif($_REQUEST['Multihq']>0)
{ 
 if($_REQUEST['ta']==1){ $hq1=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_4 INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_4.DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_4.YearId=4 AND (hrm_sales_dealer.HqId=".$_REQUEST['hq1']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq2']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq3']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq4']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq5']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq6']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq7']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq8']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq9']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq10']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq11']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq12']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq13']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq14']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq15']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq16']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq17']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq18']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq19']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq20']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq21']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq22']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq23']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq24']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq25']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq26']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq27']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq28']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq29']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq30']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq31']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq32']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq33']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq34']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq35'].")", $con); $rhq1=mysql_fetch_assoc($hq1);$TotHq1=$rhq1['sM1']+$rhq1['sM2']+$rhq1['sM3']+$rhq1['sM4']+$rhq1['sM5']+$rhq1['sM6']+$rhq1['sM7']+$rhq1['sM8']+$rhq1['sM9']+$rhq1['sM10']+$rhq1['sM11']+$rhq1['sM12']; if($_REQUEST['act']!='Multihq'){ $AppHq1=mysql_query("select * from hrm_sales_achive_approved_hq where HqId=".$_REQUEST['hq']." AND YearId=4", $con); $rAppHq1=mysql_num_rows($AppHq1); $resAppHq1=mysql_fetch_assoc($AppHq1); } } 
 if($_REQUEST['tb']==1){ $hq2=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_5 INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_5.DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_5.YearId=5 AND (hrm_sales_dealer.HqId=".$_REQUEST['hq1']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq2']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq3']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq4']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq5']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq6']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq7']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq8']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq9']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq10']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq11']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq12']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq13']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq14']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq15']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq16']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq17']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq18']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq19']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq20']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq21']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq22']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq23']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq24']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq25']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq26']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq27']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq28']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq29']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq30']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq31']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq32']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq33']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq34']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq35'].")", $con); $rhq2=mysql_fetch_assoc($hq2);
$TotHq2=$rhq2['sM1']+$rhq2['sM2']+$rhq2['sM3']+$rhq2['sM4']+$rhq2['sM5']+$rhq2['sM6']+$rhq2['sM7']+$rhq2['sM8']+$rhq2['sM9']+$rhq2['sM10']+$rhq2['sM11']+$rhq2['sM12'];	
if($_REQUEST['act']!='Multihq'){$AppHq2=mysql_query("select * from hrm_sales_achive_approved_hq where HqId=".$_REQUEST['hq']." AND YearId=5", $con); $rAppHq2=mysql_num_rows($AppHq2); $resAppHq2=mysql_fetch_assoc($AppHq2); } } 
 if($_REQUEST['tc']==1){ $hq3=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_6 INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_6.DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_6.YearId=6 AND (hrm_sales_dealer.HqId=".$_REQUEST['hq1']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq2']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq3']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq4']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq5']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq6']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq7']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq8']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq9']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq10']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq11']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq12']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq13']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq14']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq15']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq16']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq17']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq18']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq19']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq20']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq21']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq22']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq23']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq24']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq25']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq26']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq27']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq28']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq29']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq30']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq31']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq32']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq33']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq34']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq35'].")", $con); $rhq3=mysql_fetch_assoc($hq3);$TotHq3=$rhq3['sM1']+$rhq3['sM2']+$rhq3['sM3']+$rhq3['sM4']+$rhq3['sM5']+$rhq3['sM6']+$rhq3['sM7']+$rhq3['sM8']+$rhq3['sM9']+$rhq3['sM10']+$rhq3['sM11']+$rhq3['sM12']; if($_REQUEST['act']!='Multihq'){
$AppHq3=mysql_query("select * from hrm_sales_achive_approved_hq where HqId=".$_REQUEST['hq']." AND YearId=6", $con); $rAppHq3=mysql_num_rows($AppHq3); $resAppHq3=mysql_fetch_assoc($AppHq3); } }
} 
elseif($_REQUEST['s']>0)
{
 if($_REQUEST['ta']==1){ $s1=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_4 INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_4.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_sal_details_4.YearId=4 AND hrm_headquater.StateId=".$_REQUEST['s'], $con); $rs1=mysql_fetch_assoc($s1); $TotSt1=$rs1['sM1']+$rs1['sM2']+$rs1['sM3']+$rs1['sM4']+$rs1['sM5']+$rs1['sM6']+$rs1['sM7']+$rs1['sM8']+$rs1['sM9']+$rs1['sM10']+$rs1['sM11']+$rs1['sM12']; $AppSt1=mysql_query("select * from hrm_sales_achive_approved_state where StateId=".$_REQUEST['s']." AND YearId=4", $con); $rAppSt1=mysql_num_rows($AppSt1); $resAppSt1=mysql_fetch_assoc($AppSt1); }
  if($_REQUEST['tb']==1){ $s2=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_5 INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_5.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_sal_details_5.YearId=5 AND hrm_headquater.StateId=".$_REQUEST['s'], $con); $rs2=mysql_fetch_assoc($s2); $TotSt2=$rs2['sM1']+$rs2['sM2']+$rs2['sM3']+$rs2['sM4']+$rs2['sM5']+$rs2['sM6']+$rs2['sM7']+$rs2['sM8']+$rs2['sM9']+$rs2['sM10']+$rs2['sM11']+$rs2['sM12']; $AppSt2=mysql_query("select * from hrm_sales_achive_approved_state where StateId=".$_REQUEST['s']." AND YearId=5", $con); $rAppSt2=mysql_num_rows($AppSt2); $resAppSt2=mysql_fetch_assoc($AppSt2); }
 if($_REQUEST['tc']==1){ $s3=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_6 INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_6.DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_sal_details_6.YearId=6 AND hrm_headquater.StateId=".$_REQUEST['s'], $con); $rs3=mysql_fetch_assoc($s3); $TotSt3=$rs3['sM1']+$rs3['sM2']+$rs3['sM3']+$rs3['sM4']+$rs3['sM5']+$rs3['sM6']+$rs3['sM7']+$rs3['sM8']+$rs3['sM9']+$rs3['sM10']+$rs3['sM11']+$rs3['sM12']; $AppSt3=mysql_query("select * from hrm_sales_achive_approved_state where StateId=".$_REQUEST['s']." AND YearId=6", $con); $rAppSt3=mysql_num_rows($AppSt3); $resAppSt3=mysql_fetch_assoc($AppSt3); }
}
?>  
  <tr style="background-color:#FFFF79;color:#000000;"> 
   <?php if($_REQUEST['hq']>0 OR $_REQUEST['Multihq']>0){?> 
	...
	<td align="center"><?php if($_REQUEST['act']!='Multihq'){ ?><input type="checkbox" id="HqChk2" onClick="FunHqChk(<?php echo '4,'.$_REQUEST['hq'].', 4'; ?>)" <?php if($rAppHq1>0){echo 'disabled'; } ?> <?php if($resAppHq1['Approved']=='Y'){echo 'checked';} ?> /><?php } ?></td>
	<?php } ?>
	<?php if($_REQUEST['tb']==1){  ?>
	<td align="right"><b><?php echo $TotHq2; ?>&nbsp;</b></td>
	<td align="center"><?php if($_REQUEST['act']!='Multihq'){ ?><input type="checkbox" id="HqChk3" onClick="FunHqChk(<?php echo '5,'.$_REQUEST['hq'].', 5'; ?>)" <?php if($rAppHq2>0){echo 'disabled'; } ?> <?php if($resAppHq2['Approved']=='Y'){echo 'checked';} ?> /><?php } ?></td>
	<?php } ?>
	<?php if($_REQUEST['tc']==1){ ?>
	<td align="right"><b><?php echo $TotHq3; ?>&nbsp;</b></td>
	<td align="center"><?php if($_REQUEST['act']!='Multihq'){ ?><input type="checkbox" id="HqChk4" onClick="FunHqChk(<?php echo '6,'.$_REQUEST['hq'].', 6'; ?>)" <?php if($rAppHq3>0){echo 'disabled'; } ?> <?php if($resAppHq3['Approved']=='Y'){echo 'checked';} ?> /><?php } ?></td>
	<?php } ?>
   <?php } elseif($_REQUEST['s']>0){ ?>
   <td colspan="4" align="right"><b>TOTAL :</b>&nbsp;&nbsp;</td>
    <?php if($_REQUEST['ta']==1){  ?>
	<td align="right"><b><?php echo $TotSt1; ?>&nbsp;</b> 
	<td align="center"><input type="checkbox" id="StChk2" onClick="FunStChk(<?php echo '4,'.$_REQUEST['s'].', 4'; ?>)" <?php if($rAppSt1>0){echo 'disabled'; } ?> <?php if($resAppSt1['Approved']=='Y'){echo 'checked';} ?> /></td>
	<?php } ?>
	<?php if($_REQUEST['tb']==1){ 	?>
	<td align="right"><b><?php echo $TotSt2; ?>&nbsp;</b>
	<td align="center"><input type="checkbox" id="StChk3" onClick="FunStChk(<?php echo '5,'.$_REQUEST['s'].', 5'; ?>)" <?php if($rAppSt2>0){echo 'disabled'; } ?> <?php if($resAppSt2['Approved']=='Y'){echo 'checked';} ?> /></td>
	<?php } ?>
	<?php if($_REQUEST['tc']==1){  ?>
	<td align="right"><b><?php echo $TotSt3; ?>&nbsp;</b>
	<td align="center"><input type="checkbox" id="StChk4" onClick="FunStChk(<?php echo '6,'.$_REQUEST['s'].', 6'; ?>)" <?php if($rAppSt3>0){echo 'disabled'; } ?> <?php if($resAppSt3['Approved']=='Y'){echo 'checked';} ?> /></td>
	<?php } ?>
   <?php } ?>			
  </tr>	
<tr>
...
<table border="1" cellpadding="0" cellspacing="0" style="font-family:Times New Roman;font-size:14px;"> 
<?php if($_REQUEST['hq']>0 OR $_REQUEST['Multihq']>0){
 if($_REQUEST['hq']>0){$sqlDeal=mysql_query("select DealerId,DealerName,DealerCity,HqName from hrm_sales_dealer INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_dealer.HqId=".$_REQUEST['hq']." order by hrm_headquater.HqName ASC", $con); }
 if($_REQUEST['Multihq']>0){
$sqlDeal=mysql_query("select DealerId,DealerName,DealerCity,HqName from hrm_sales_dealer INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where (hrm_sales_dealer.HqId=".$_REQUEST['hq1']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq2']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq3']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq4']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq5']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq6']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq7']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq8']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq9']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq10']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq11']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq12']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq13']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq14']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq15']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq16']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq17']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq18']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq19']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq20']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq21']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq22']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq23']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq24']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq25']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq26']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq27']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq28']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq29']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq30']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq31']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq32']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq33']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq34']." OR hrm_sales_dealer.HqId=".$_REQUEST['hq35'].") order by hrm_headquater.HqName ASC", $con); }
...
<form name="FormNrv_<?php echo $sn; ?>" method="POST" enctype="multipart/form-data">
	 ...
	 <?php if($_REQUEST['ta']==1){?>
<?php $sqlP1=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details_4 where DealerId=".$resDeal['DealerId']." AND YearId=4", $con); $resP1=mysql_fetch_assoc($sqlP1); $TotP1=$resP1['tsM1']+$resP1['tsM2']+$resP1['tsM3']+$resP1['tsM4']+$resP1['tsM5']+$resP1['tsM6']+$resP1['tsM7']+$resP1['tsM8']+$resP1['tsM9']+$resP1['tsM10']+$resP1['tsM11']+$resP1['tsM12']; 
$sqlchk2=mysql_query("select * from hrm_sales_achive_approved where DealerId=".$resDeal['DealerId']." AND YearId=4", $con); 
$rowchk2=mysql_num_rows($sqlchk2); $reschk2=mysql_fetch_assoc($sqlchk2); ?>	 
	 <td align="right" valign="top" style="width:80px;">
	 <span class="mousechange" onClick="FunOpenRecrd(4,<?php echo $resDeal['DealerId']; ?>)"><u><?php echo $TotP1; ?></u>&nbsp;</span></td>
	 <td align="center" valign="top" style="width:50px;"><input type="checkbox" id="AppChk2_<?php echo $sn; ?>" onClick="FChkApClick(<?php echo $sn.','.$resDeal['DealerId'].', 4'; ?>)" <?php if($rowchk2>0){echo 'disabled'; } ?> <?php if($reschk2['Approved']=='Y'){echo 'checked';} ?> <?php if($rAppHq1>0){echo 'disabled'; } ?> /></td>
	
	 <?php } if($_REQUEST['tb']==1){?>
<?php $sqlP2=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details_5 where DealerId=".$resDeal['DealerId']." AND YearId=5", $con); $resP2=mysql_fetch_assoc($sqlP2); $TotP2=$resP2['tsM1']+$resP2['tsM2']+$resP2['tsM3']+$resP2['tsM4']+$resP2['tsM5']+$resP2['tsM6']+$resP2['tsM7']+$resP2['tsM8']+$resP2['tsM9']+$resP2['tsM10']+$resP2['tsM11']+$resP2['tsM12']; 
$sqlchk3=mysql_query("select * from hrm_sales_achive_approved where DealerId=".$resDeal['DealerId']." AND YearId=5", $con); 
$rowchk3=mysql_num_rows($sqlchk3); $reschk3=mysql_fetch_assoc($sqlchk3); ?>	 
	 <td align="right" style="width:80px;"><span class="mousechange" onClick="FunOpenRecrd(5,<?php echo $resDeal['DealerId']; ?>)"><u><?php echo $TotP2; ?></u>&nbsp;</span></td>
	 <td align="center" valign="top" style="width:50px;"><input type="checkbox" id="AppChk3_<?php echo $sn; ?>" onClick="FChkApClick(<?php echo $sn.','.$resDeal['DealerId'].', 5'; ?>)" <?php if($rowchk3>0){echo 'disabled'; } ?> <?php if($reschk3['Approved']=='Y'){echo 'checked';} ?> <?php if($rAppHq2>0){echo 'disabled'; } ?> /></td>	
	 <?php } if($_REQUEST['tc']==1){?>
<?php $sqlP3=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details_6 where DealerId=".$resDeal['DealerId']." AND YearId=6", $con); $resP3=mysql_fetch_assoc($sqlP3); $TotP3=$resP3['tsM1']+$resP3['tsM2']+$resP3['tsM3']+$resP3['tsM4']+$resP3['tsM5']+$resP3['tsM6']+$resP3['tsM7']+$resP3['tsM8']+$resP3['tsM9']+$resP3['tsM10']+$resP3['tsM11']+$resP3['tsM12']; 
$sqlchk4=mysql_query("select * from hrm_sales_achive_approved where DealerId=".$resDeal['DealerId']." AND YearId=6", $con); 
$rowchk4=mysql_num_rows($sqlchk4); $reschk4=mysql_fetch_assoc($sqlchk4); ?>	 
	 <td align="right" style="width:80px;"><span class="mousechange" onClick="FunOpenRecrd(6,<?php echo $resDeal['DealerId']; ?>)"><u><?php echo $TotP3; ?></u>&nbsp;</span></td>
	 <td align="center" valign="top" style="width:50px;"><input type="checkbox" id="AppChk4_<?php echo $sn; ?>" onClick="FChkApClick(<?php echo $sn.','.$resDeal['DealerId'].', 6'; ?>)" <?php if($rowchk4>0){echo 'disabled'; } ?> <?php if($reschk4['Approved']=='Y'){echo 'checked';} ?> <?php if($rAppHq3>0){echo 'disabled'; } ?> /></td>
	 <?php } ?> 
</form>	 
 </tr>
...
$rowchk2=mysql_num_rows($sqlchk2); $reschk2=mysql_fetch_assoc($sqlchk2); ?>	 
	 <td align="right" valign="top" style="width:80px;">
	 <span class="mousechange" onClick="FunOpenRecrd(4,<?php echo $resDeal['DealerId']; ?>)"><u><?php echo $TotP1; ?></u>&nbsp;</span></td>
	 <td align="center" valign="top" style="width:50px;"><input type="checkbox" id="AppChk2_<?php echo $sn; ?>" onClick="FChkApClick(<?php echo $sn.','.$resDeal['DealerId'].', 4'; ?>)" <?php if($rowchk2>0){echo 'disabled'; } ?> <?php if($reschk2['Approved']=='Y'){echo 'checked';} ?> <?php if($rAppSt1>0){echo 'disabled'; } ?> /></td>
	 <?php } if($_REQUEST['tb']==1){?>
<?php $sqlP2=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details_5 where DealerId=".$resDeal['DealerId']." AND YearId=5", $con); $resP2=mysql_fetch_assoc($sqlP2); $TotP2=$resP2['tsM1']+$resP2['tsM2']+$resP2['tsM3']+$resP2['tsM4']+$resP2['tsM5']+$resP2['tsM6']+$resP2['tsM7']+$resP2['tsM8']+$resP2['tsM9']+$resP2['tsM10']+$resP2['tsM11']+$resP2['tsM12']; 
$sqlchk3=mysql_query("select * from hrm_sales_achive_approved where DealerId=".$resDeal['DealerId']." AND YearId=5", $con);
$rowchk3=mysql_num_rows($sqlchk3); $reschk3=mysql_fetch_assoc($sqlchk3); ?>	 
	 <td align="right" valign="top" style="width:80px;">
	 <span class="mousechange" onClick="FunOpenRecrd(5,<?php echo $resDeal['DealerId']; ?>)"><u><?php echo $TotP2; ?></u>&nbsp;</span></td>
	 <td align="center" valign="top" style="width:50px;"><input type="checkbox" id="AppChk3_<?php echo $sn; ?>" onClick="FChkApClick(<?php echo $sn.','.$resDeal['DealerId'].', 5'; ?>)" <?php if($rowchk3>0){echo 'disabled'; } ?> <?php if($reschk3['Approved']=='Y'){echo 'checked';} ?> <?php if($rAppSt2>0){echo 'disabled'; } ?> /></td>
	 <?php } if($_REQUEST['tc']==1){?>
<?php $sqlP3=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details_6 where DealerId=".$resDeal['DealerId']." AND YearId=6", $con); $resP3=mysql_fetch_assoc($sqlP3); $TotP3=$resP3['tsM1']+$resP3['tsM2']+$resP3['tsM3']+$resP3['tsM4']+$resP3['tsM5']+$resP3['tsM6']+$resP3['tsM7']+$resP3['tsM8']+$resP3['tsM9']+$resP3['tsM10']+$resP3['tsM11']+$resP3['tsM12']; 
$sqlchk4=mysql_query("select * from hrm_sales_achive_approved where DealerId=".$resDeal['DealerId']." AND YearId=6", $con); 
$rowchk4=mysql_num_rows($sqlchk4); $reschk4=mysql_fetch_assoc($sqlchk4); ?>	 
	 <td align="right" style="width:80px;"><span class="mousechange" onClick="FunOpenRecrd(6,<?php echo $resDeal['DealerId']; ?>)"><u><?php echo $TotP3; ?></u>&nbsp;</span></td>
	 <td align="center" valign="top" style="width:50px;"><input type="checkbox" id="AppChk4_<?php echo $sn; ?>" onClick="FChkApClick(<?php echo $sn.','.$resDeal['DealerId'].', 6'; ?>)" <?php if($rowchk4>0){echo 'disabled'; } ?> <?php if($reschk4['Approved']=='Y'){echo 'checked';} ?> <?php if($rAppSt3>0){echo 'disabled'; } ?> /></td>	
	 <?php } ?>	 
</form>	 
 </tr>
