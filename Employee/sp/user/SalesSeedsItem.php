...
if (agree) { var x = "SalesSeedsItem.php?action=edit&eid="+value;  window.location=x;}}
function del(value) { var agree=confirm("Are you sure you want to delete this record?");
if (agree) { var x = "SalesSeedsItem.php?action=delete&did="+value;  window.location=x;}}
function newsave() { var x = "SalesSeedsItem.php?action=newsave";  window.location=x;}
</Script> 
</head>
<body class="body">
<table class="table">
  ...
  <table width="100%" style="margin-top:0px;" border="0">
   ...
   <tr>
    ...
    <td align="left" id="type" valign="top" style="display:block; width:50%">             
	 ...
	 <tr><td class="heading">&nbsp;Crop Name </td></tr>
	 <tr>
	 <td align="left" width="490">
	 <table border="1" width="490" border="1" bgcolor="#FFFFFF">
<tr bgcolor="#808000">
 ...
 <td class="font" align="center" style="width:150;"><b>Group</b></td>
 <td align="center" style="font:Georgia; font-size:11px; width:100px; color:#FFFFFF"><b>Action</b></td>
</tr>
<?php $sql=mysql_query("select * from hrm_sales_seedsitem", $con); $SNo=1; while($res=mysql_fetch_array($sql)) {
if(isset($_REQUEST['action']) && $_REQUEST['action']=="edit" && $_REQUEST['eid']==$res['ItemId']){ ?>
...
<?php if($res['GroupId']==0){$GroupN='SELECT GROUP';}elseif($res['GroupId']==1){$GroupN='VEGETABLE GROUP';}elseif($res['GroupId']==2){$GroupN='CEREAL GROUP';} ?>
 ...
 <input type="submit" name="SaveEdit"  value="" class="SaveButton"><input type="hidden" name="ItemId" id="ItemId" value="<?php echo $_REQUEST['eid']; ?>"/></td>
</tr>
</form> 
<?php } else { ?>	 
<tr>
...
<input type="button" name="Refrash" value="refresh" onClick="javascript:window.location='SalesSeedsItem.php?ac=4441&ee=4421&der=true3&c=false&d=dreefoultValue&u=UsuuerInfo&trht=FTF%%FTF1221&tt=valuased&desgn=Trern&main=FTrue%False'"/>&nbsp;
     </td>
</tr>
	  </table>
	 </td>
