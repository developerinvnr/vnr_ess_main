...
<?php $sqlStckBef=mysql_query("select Mar from hrm_sales_product_stock_actual where ProductId=".$res['ProductId']." AND YearId=".$BeforeYId." AND CompanyId=".$CompanyId, $con);
	  ...
	  $sqlReq2=mysql_query("select SUM(M1) as tm1,SUM(M2) as tm2,SUM(M3) as tm3,SUM(M4) as tm4,SUM(M5) as tm5,SUM(M6) as tm6,SUM(M7) as tm7,SUM(M8) as tm8,SUM(M9) as tm9 from hrm_sales_sal_details INNER JOIN hrm_state ON hrm_sales_sal_details.StateId=hrm_state.StateId INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId where hrm_state.CountryId=".$_REQUEST['c']." AND hrm_sales_sal_details.YearId=".$AfterYId." AND hrm_sales_seedsproduct.ProductId=".$res['ProductId'], $con);
...
<?php $s1=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=4 AND ActlYear=".$my11, $con); 
	...
	<td align="right" bgcolor="<?php if($resStck['Apr']!=0){if($resReq['tm1']>$resStck['Apr']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resStckBef['Mar']!='' AND $resReq['tm1']>$resStckBef['Mar']){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr1>0){ if($resStck['Apr']!=0){$stck_Apr=$resStck['Apr']+$r1['EstStock'];}elseif($resStckBef['Mar']!=0){$stck_Apr=$resStckBef['Mar']+$r1['EstStock'];}else{$stck_Apr=$r1['EstStock'];} }else{ if($resStck['Apr']!=0){$stck_Apr=$resStck['Apr'];}elseif($resStckBef['Mar']!=0){$stck_Apr=$resStckBef['Mar'];}else{$stck_Apr=0;} } if($stck_Apr>0 OR $stck_Apr<0){echo $stck_Apr;} ?></td>
...
<?php $s2=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=5 AND ActlYear=".$my11, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['May']!=0){if($resReq['tm2']>$resStck['May']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm2']>$c5){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr2>0){ if($resStck['May']!=0){$stck_May=$resStck['May']+$r2['EstStock'];}elseif($c5!=0){$stck_May=$c5+$r2['EstStock'];}else{$stck_May=$r2['EstStock'];} }else{ if($resStck['May']!=0){$stck_May=$resStck['May'];}elseif($c5!=0){$stck_May=$c5;}else{$stck_May=0;} } if($stck_May>0 OR $stck_May<0){echo $stck_May;} ?></td>
...
<?php $s3=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=6 AND ActlYear=".$my11, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['Jun']!=0){if($resReq['tm3']>$resStck['Jun']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm3']>$c6){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr3>0){ if($resStck['Jun']!=0){$stck_Jun=$resStck['Jun']+$r3['EstStock'];}elseif($c6!=0){$stck_Jun=$c6+$r3['EstStock'];}else{$stck_Jun=$r3['EstStock'];} }else{ if($resStck['Jun']!=0){$stck_Jun=$resStck['Jun'];}elseif($c6!=0){$stck_Jun=$c6;}else{$stck_Jun=0;} } if($stck_Jun>0 OR $stck_Jun<0){echo $stck_Jun;} ?></td>
...
<?php $s4=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=7 AND ActlYear=".$my11, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['Jul']!=0){if($resReq['tm4']>$resStck['Jul']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm4']>$c7){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr4>0){ if($resStck['Jul']!=0){$stck_Jul=$resStck['Jul']+$r4['EstStock'];}elseif($c7!=0){$stck_Jul=$c7+$r4['EstStock'];}else{$stck_Jul=$r4['EstStock'];} }else{ if($resStck['Jul']!=0){$stck_Jul=$resStck['Jul'];}elseif($c7!=0){$stck_Jul=$c7;}else{$stck_Jul=0;} } if($stck_Jul>0 OR $stck_Jul<0){echo $stck_Jul;} ?></td>
...
<?php $s5=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=8 AND ActlYear=".$my11, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['Aug']!=0){if($resReq['tm5']>$resStck['Aug']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm5']>$c8){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr5>0){ if($resStck['Aug']!=0){$stck_Aug=$resStck['Aug']+$r5['EstStock'];}elseif($c8!=0){$stck_Aug=$c8+$r5['EstStock'];}else{$stck_Aug=$r5['EstStock'];} }else{ if($resStck['Aug']!=0){$stck_Aug=$resStck['Aug'];}elseif($c8!=0){$stck_Aug=$c8;}else{$stck_Aug=0;} } if($stck_Aug>0 OR $stck_Aug<0){echo $stck_Aug;} ?></td>
...
<?php $s6=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=9 AND ActlYear=".$my11, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['Sep']!=0){if($resReq['tm6']>$resStck['Sep']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm6']>$c9){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php  if($rr6>0){ if($resStck['Sep']!=0){$stck_Sep=$resStck['Sep']+$r6['EstStock'];}elseif($c9!=0){$stck_Sep=$c9+$r6['EstStock'];}else{$stck_Sep=$r6['EstStock'];} }else{ if($resStck['Sep']!=0){$stck_Sep=$resStck['Sep'];}elseif($c9!=0){$stck_Sep=$c9;}else{$stck_Sep=0;} } if($stck_Sep>0 OR $stck_Sep<0){echo $stck_Sep;} ?></td>
...
<?php $s7=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=10 AND ActlYear=".$my11, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['Oct']!=0){if($resReq['tm7']>$resStck['Oct']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm7']>$c10){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr7>0){ if($resStck['Oct']!=0){$stck_Oct=$resStck['Oct']+$r7['EstStock'];}elseif($c10!=0){$stck_Oct=$c10+$r7['EstStock'];}else{$stck_Oct=$r7['EstStock'];} }else{ if($resStck['Oct']!=0){$stck_Oct=$resStck['Oct'];}elseif($c10!=0){$stck_Oct=$c10;}else{$stck_Oct=0;} } if($stck_Oct>0 OR $stck_Oct<0){echo $stck_Oct;} ?></td>
...
<?php $s8=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=11 AND ActlYear=".$my11, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['Nov']!=0){if($resReq['tm8']>$resStck['Nov']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm8']>$c11){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr8>0){ if($resStck['Nov']!=0){$stck_Nov=$resStck['Nov']+$r8['EstStock'];}elseif($c11!=0){$stck_Nov=$c11+$r8['EstStock'];}else{$stck_Nov=$r8['EstStock'];} }else{ if($resStck['Nov']!=0){$stck_Nov=$resStck['Nov'];}elseif($c11!=0){$stck_Nov=$c11;}else{$stck_Nov=0;} } if($stck_Nov>0 OR $stck_Nov<0){echo $stck_Nov;} ?></td>
...
<?php $s9=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=12 AND ActlYear=".$my11, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['Dece']!=0){if($resReq['tm9']>$resStck['Dece']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm9']>$c12){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr9>0){ if($resStck['Dec']!=0){$stck_Dec=$resStck['Dec']+$r9['EstStock'];}elseif($c12!=0){$stck_Dec=$c12+$r9['EstStock'];}else{$stck_Dec=$r9['EstStock'];} }else{ if($resStck['Dec']!=0){$stck_Dec=$resStck['Dec'];}elseif($c12!=0){$stck_Dec=$c12;}else{$stck_Dec=0;} } if($stck_Dec>0 OR $stck_Dec<0){echo $stck_Dec;} ?></td>
...
<?php $s10=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=1 AND ActlYear=".$my22, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['Jan']!=0){if($resReq['tm10']>$resStck['Jan']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm10']>$c1){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr10>0){ if($resStck['Jan']!=0){$stck_Jan=$resStck['Jan']+$r10['EstStock'];}elseif($c1!=0){$stck_Jan=$c1+$r10['EstStock'];}else{$stck_Jan=$r10['EstStock'];} }else{ if($resStck['Jan']!=0){$stck_Jan=$resStck['Jan'];}elseif($c1!=0){$stck_Jan=$c1;}else{$stck_Jan=0;} } if($stck_Jan>0 OR $stck_Jan<0){echo $stck_Jan;} ?></td>
...
<?php $s11=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=2 AND ActlYear=".$my22, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['Feb']!=0){if($resReq['tm11']>$resStck['Feb']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm11']>$c2){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr11>0){ if($resStck['Feb']!=0){$stck_Feb=$resStck['Feb']+$r11['EstStock'];}elseif($c2!=0){$stck_Feb=$c2+$r11['EstStock'];}else{$stck_Feb=$r11['EstStock'];} }else{ if($resStck['Feb']!=0){$stck_Feb=$resStck['Feb'];}elseif($c2!=0){$stck_Feb=$c2;}else{$stck_Feb=0;} } if($stck_Feb>0 OR $stck_Feb<0){echo $stck_Feb;} ?></td>
...
<?php $s12=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=3 AND ActlYear=".$my22, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck['Mar']!=0){if($resReq['tm12']>$resStck['Mar']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq['tm12']>$c3){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr12>0){ if($resStck['Mar']!=0){$stck_Mar=$resStck['Mar']+$r12['EstStock'];}elseif($c3!=0){$stck_Mar=$c3+$r12['EstStock'];}else{$stck_Mar=$r12['EstStock'];} }else{ if($resStck['Mar']!=0){$stck_Mar=$resStck['Mar'];}elseif($c3!=0){$stck_Mar=$c3;}else{$stck_Mar=0;} } if($stck_Mar>0 OR $stck_Mar<0){echo $stck_Mar;} ?></td>
...
<?php $s13=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=4 AND ActlYear=".$my22, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck2['Apr']!=0){if($resReq2['tm1']>$resStck2['Apr']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq2['tm1']>$c4){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr13>0){ if($resStck2['Apr']!=0){$stck_Apr2=$resStck2['Apr']+$r13['EstStock'];}elseif($c4!=0){$stck_Apr2=$c4+$r13['EstStock'];}else{$stck_Apr2=$r13['EstStock'];} }else{ if($resStck2['Apr']!=0){$stck_Apr2=$resStck2['Apr'];}elseif($c4!=0){$stck_Apr2=$c4;}else{$stck_Apr2=0;} } if($stck_Apr2>0 OR $stck_Apr2<0){echo $stck_Apr2;} ?></td>
...
if($stck_Apr2!=0){$cc5=$stck_Apr2-$resReq2['tm1'];}else{$cc5=0;} ?>
	 ...
	 <td align="right" bgcolor="<?php if($resStck2['May']!=0){if($resReq2['tm2']>$resStck2['May']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq2['tm2']>$cc5){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php  if($rr14>0){ if($resStck2['May']!=0){$stck_May2=$resStck2['May']+$r14['EstStock'];}elseif($cc5!=0){$stck_May2=$cc5+$r14['EstStock'];}else{$stck_May2=$r14['EstStock'];} }else{ if($resStck2['May']!=0){$stck_May2=$resStck2['May'];}elseif($cc5!=0){$stck_May2=$cc5;}else{$stck_May2=0;} } if($stck_May2>0 OR $stck_May2<0){echo $stck_May2;} ?></td>
...
if($stck_May2!=0){$cc6=$stck_May2-$resReq2['tm2'];}else{$cc6=0;} ?>
	 ...
	 <?php /*
	 <td align="right" bgcolor="<?php if($resStck2['Jun']!=0){if($resReq2['tm3']>$resStck2['Jun']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq2['tm3']>$cc6){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr15>0){ if($resStck2['Jun']!=0){$stck_Jun2=$resStck2['Jun']+$r15['EstStock'];}elseif($cc6!=0){$stck_Jun2=$cc6+$r15['EstStock'];}else{$stck_Jun2=$r15['EstStock'];} }else{ if($resStck2['Jun']!=0){$stck_Jun2=$resStck2['Jun'];}elseif($cc6!=0){$stck_Jun2=$cc6;}else{$stck_Jun2=0;} } if($stck_Jun2>0 OR $stck_Jun2<0){echo $stck_Jun2;} ?></td> */ ?>
...
if($stck_Jun2!=0){$cc7=$stck_Jun2-$resReq2['tm3'];}else{$cc7=0;} ?>
	 ...
	 <td align="right" bgcolor="<?php if($resStck2['Jul']!=0){if($resReq2['tm4']>$resStck2['Jul']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq2['tm4']>$cc7){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr16>0){ if($resStck2['Jul']!=0){$stck_Jul2=$resStck2['Jul']+$r16['EstStock'];}elseif($cc7!=0){$stck_Jul2=$cc7+$r16['EstStock'];}else{$stck_Jul2=$r16['EstStock'];} }else{ if($resStck2['Jul']!=0){$stck_Jul2=$resStck2['Jul'];}elseif($cc7!=0){$stck_Jul2=$cc7;}else{$stck_Jul2=0;} } if($stck_Jul2>0 OR $stck_Jul2<0){echo $stck_Jul2;} ?></td>
...
if($stck_Jul2!=0){$cc8=$stck_Jul2-$resReq2['tm4'];}else{$cc8=0;} ?>
	 ...
	 <td align="right" bgcolor="<?php if($resStck2['Aug']!=0){if($resReq2['tm5']>$resStck2['Aug']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq2['tm5']>$cc8){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr17>0){ if($resStck2['Aug']!=0){$stck_Aug2=$resStck2['Aug']+$r17['EstStock'];}elseif($cc8!=0){$stck_Aug2=$cc8+$r17['EstStock'];}else{$stck_Aug2=$r17['EstStock'];} }else{ if($resStck2['Aug']!=0){$stck_Aug2=$resStck2['Aug'];}elseif($cc8!=0){$stck_Aug2=$cc8;}else{$stck_Aug2=0;} } if($stck_Aug2>0 OR $stck_Aug2<0){echo $stck_Aug2;} ?></td>
...
if($stck_Aug2!=0){$cc9=$stck_Aug2-$resReq2['tm5'];}else{$cc9=0;} ?>
	 ...
	 <td align="right" bgcolor="<?php if($resStck2['Sep']!=0){if($resReq2['tm6']>$resStck2['Sep']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq2['tm6']>$cc9){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr18>0){ if($resStck2['Sep']!=0){$stck_Sep2=$resStck2['Sep']+$r18['EstStock'];}elseif($cc9!=0){$stck_Sep2=$cc9+$r18['EstStock'];}else{$stck_Sep2=$r18['EstStock'];} }else{ if($resStck2['Sep']!=0){$stck_Sep2=$resStck2['Sep'];}elseif($cc9!=0){$stck_Sep2=$cc9;}else{$stck_Sep2=0;} } if($stck_Sep2>0 OR $stck_Sep2<0){echo $stck_Sep2;} ?></td>
...
<?php $s19=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=10 AND ActlYear=".$my22, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck2['Oct']!=0){if($resReq2['tm7']>$resStck2['Oct']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq2['tm7']>$cc10){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr19>0){ if($resStck2['Oct']!=0){$stck_Oct2=$resStck2['Oct']+$r19['EstStock'];}elseif($cc10!=0){$stck_Oct2=$cc10+$r19['EstStock'];}else{$stck_Oct2=$r19['EstStock'];} }else{ if($resStck2['Oct']!=0){$stck_Oct2=$resStck2['Oct'];}elseif($cc10!=0){$stck_Oct2=$cc10;}else{$stck_Oct2=0;} } if($stck_Oct2>0 OR $stck_Oct2<0){echo $stck_Oct2;} ?></td>
...
<?php $s20=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=11 AND ActlYear=".$my22, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck2['Nov']!=0){if($resReq2['tm8']>$resStck2['Nov']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq2['tm8']>$cc11){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr20>0){ if($resStck2['Nov']!=0){$stck_Nov2=$resStck2['Nov']+$r20['EstStock'];}elseif($cc11!=0){$stck_Nov2=$cc11+$r20['EstStock'];}else{$stck_Nov2=$r20['EstStock'];} }else{ if($resStck2['Nov']!=0){$stck_Nov2=$resStck2['Nov'];}elseif($cc11!=0){$stck_Nov2=$cc11;}else{$stck_Nov2=0;} } if($stck_Nov2>0 OR $stck_Nov2<0){echo $stck_Nov2;} ?></td>
...
<?php $s21=mysql_query("select EstStock from hrm_sales_product_season_stock where ProductId=".$res['ProductId']." AND ActlMonth=12 AND ActlYear=".$my22, $con); 
	 ...
	 <td align="right" bgcolor="<?php if($resStck2['Dec']!=0){if($resReq2['tm9']>$resStck2['Dec']){echo '#FF8282';}else{echo '#FFCEFF';}}else{if($resReq2['tm9']>$cc12){echo '#FF8282';}else{echo '#FFCEFF';}} ?>"><?php if($rr21>0){ if($resStck2['Dec']!=0){$stck_Dec2=$resStck2['Dec']+$r21['EstStock'];}elseif($cc12!=0){$stck_Dec2=$cc12+$r21['EstStock'];}else{$stck_Dec2=$r21['EstStock'];} }else{ if($resStck2['Dec']!=0){$stck_Dec2=$resStck2['Dec'];}elseif($cc12!=0){$stck_Dec2=$cc12;}else{$stck_Dec2=0;} } if($stck_Dec2>0 OR $stck_Dec2<0){echo $stck_Dec2;} ?></td>
