...
{ document.getElementById('SpanResult').innerHTML = originalRequest.responseText; document.getElementById('ProductName').disabled=false; 
  document.getElementById('NRV').disabled=false; document.getElementById('NRVD').disabled=false; document.getElementById('f_btn1').disabled=false; 
  document.getElementById('ProductType').disabled=false; document.getElementById('AddNew').style.display='block'; document.getElementById('Change').style.display='none';
}
...
function ClickNew() 
{
 ...
 var NRV=document.getElementById('NRV').value; var YId=document.getElementById('YearId').value;  var NRVD=document.getElementById('NRVD').value;
 ...
 {
  var ProductName=document.getElementById('ProductName').value; var ProductType=document.getElementById('ProductType').value; 
  var ItemId=document.getElementById('Item').value; if(NRV==''){var VNrv=0;}else{var VNrv=NRV;}
  var url = 'SlctSalesProd.php';	var pars = 'ProductName='+ProductName+'&ItemId='+ItemId+'&ProductType='+ProductType+'&NRV='+VNrv+'&YId='+YId+'&NRVD='+NRVD; var myAjax = new Ajax.Request(
...
function ClickProduct(v,dn,ti,nrv)
{ 
  if(document.getElementById('Check_'+v).checked==true)
  { 
    document.getElementById('ProductName').value=dn; document.getElementById('ProductID').value=v; document.getElementById('ProductType').value=ti; 
	document.getElementById('TypeID').value=ti; document.getElementById('NRV').value=nrv; document.getElementById('R'+ti).checked=true; 
  ...
  { document.getElementById('ProductName').value=''; document.getElementById('ProductID').value=''; document.getElementById('ProductType').value=2; 
	document.getElementById('TypeID').value=2; document.getElementById('NRV').value=''; document.getElementById('R2').checked=true; 
...
function ClickChange()
{
 ...
 { 
  var ProductName=document.getElementById('ProductName').value; var ProductID=document.getElementById('ProductID').value; var NRV=document.getElementById('NRV').value;
  var ProductType=document.getElementById('ProductType').value;var ItemId=document.getElementById('Item').value; if(NRV==''){var VNrv=0;}else{var VNrv=NRV;}
  var YId=document.getElementById('YearId').value;  var NRVD=document.getElementById('NRVD').value;
  var url = 'SlctSalesProd.php';	var pars = 'ChangeProductName='+ProductName+'&ProductId='+ProductID+'&ItemId='+ItemId+'&ProductType='+ProductType+'&NRV='+VNrv+'&YId='+YId+'&NRVD='+NRVD;	
...
{ document.getElementById('SpanResult').innerHTML = originalRequest.responseText; document.getElementById('ProductName').value=''; 
...
function ClickDelProduct(v,dn)
{
 ...
 if(agree)
 {
  var ItemId=document.getElementById('Item').value; var url = 'SlctSalesProd.php';	var pars = 'DeleteProductId='+v+'&ItemId='+ItemId;	var myAjax = new Ajax.Request(
...
<table border="0" style="margin-top:0px; width:100%; height:300px;">
 <tr>
  <td align="left" height="20" valign="top" colspan="3">
   <table border="0">
    <tr><td  style="margin-top:0px;width:100%;" class="heading">&nbsp;Product Name&nbsp;&nbsp;&nbsp;<b><?php echo $msg; ?></b></td></tr>
   </table>
  </td>
 </tr>
<tr>
  ...
  <table>
   <tr>
    <td id="Entry" style="width:480px;" valign="top">
     <table border="0">
      <tr>
	    <td style="font-size:11px;height:18px;color:#FFFFFF;font-weight:bold;">Crop Name :</td>
...
<option value="<?php echo $res['ItemId']; ?>"><?php echo strtoupper($res['ItemName']); ?></option><?php } ?></select>
	   ...
	   <tr>
	    <td style="font-size:11px;height:18px;width:120px;color:#FFFFFF;font-weight:bold;">Product Name :</td>
	    <td>
		...
		<tr>
		<td style="font-size:11px;height:18px;width:120px;color:#FFFFFF;font-weight:bold;">Product Type :</td>
		...
		<tr>
	    <td style="font-size:11px;height:18px;width:120px;color:#FFFFFF;font-weight:bold;">NRV&nbsp;(Per KG) :</td>
	    <td>
		...
		<tr>
	    <td style="font-size:11px;height:18px;width:120px;color:#FFFFFF;font-weight:bold;">From Date&nbsp;:</td>
	    <td>
