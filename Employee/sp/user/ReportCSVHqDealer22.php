...
$s123=mysql_query("select hrm_sales_reporting_level.EmployeeID,R1,R2 from hrm_sales_reporting_level INNER JOIN hrm_sales_hq_temp ON hrm_sales_reporting_level.EmployeeID=hrm_sales_hq_temp.EmployeeID where hrm_sales_hq_temp.HqId=".$resDeal['HqId'],$con); $r123=mysql_fetch_assoc($s123); 
...
$csv_output .= '"'.str_replace('"', '""', $resDeal['DealerId']).'",';
