...
<input type="hidden" id="TotAValueM" value="" /><input type="hidden" id="TotBValueM" value="" />
<input type="hidden" id="TotCValueM" value="" /><input type="hidden" id="DealerId" value="" />
<input type="hidden" id="Sno" value="" /><input type="hidden" id="SelTerr" value="<?php echo $_REQUEST['SelTerr']; ?>" /><input type="hidden" id="myh" value="<?php echo $_REQUEST['myh']; ?>" />
