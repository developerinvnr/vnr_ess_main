...
elseif($_REQUEST['ii']=='All_2')
 ...
 $Sn=1; while($res=mysql_fetch_array($sql)){
 //echo "select * from hrm_sales_sal_details_".$_REQUEST['y']." where YearId=".$_REQUEST['y']." AND ProductId=".$res['ProductId']." AND DealerId=".$resDeal['DealerId'];
