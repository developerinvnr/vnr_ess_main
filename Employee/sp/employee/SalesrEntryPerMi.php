...
{ 
  if($_REQUEST['nn']==1)
  {
   $sqlUp=mysql_query("update hrm_sales_reporting_level set EditPerMi='".$_REQUEST['ynv']."' where EmployeeID=".$_REQUEST['eei'], $con); if($sqlUp AND $_REQUEST['ynv']=='Y'){ $sqlIns=mysql_query("update hrm_sales_emp_action set StatusB=0 where EmployeeID=".$_REQUEST['eei'], $con); }
  }
  elseif($_REQUEST['nn']==2)
  {
   $sqlUp=mysql_query("update hrm_sales_tlemp set EditPerMi='".$_REQUEST['ynv']."' where TLEId=".$_REQUEST['eei'], $con); 
   if($sqlUp AND $_REQUEST['ynv']=='Y'){ $sqlIns=mysql_query("update hrm_sales_emp_action_tle set StatusB=0 where TLEId=".$_REQUEST['eei'], $con); }
  }

/*
$sqlUp=mysql_query("update hrm_sales_reporting_level set EditPerMi='".$_REQUEST['ynv']."' where EmployeeID=".$_REQUEST['eei'], $con); 
  if($sqlUp AND $_REQUEST['ynv']=='Y')
  { $sqlIns=mysql_query("update hrm_sales_emp_action set StatusB=0 where EmployeeID=".$_REQUEST['eei'], $con); }
*/
...
{ 
  ...
  window.location="SalesrEntry.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+v+"&q="+q+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+'&EHq='+EHq+'&myh='+myh+'&myt='+myt; 
}
...
function ChangeTeam(hq,v,gv)
{
  ...
  window.location="SalesrEntryMt.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+v+"&q="+q+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+'&EHq='+EHq+'&myh='+myh+'&myt='+myt; 
...
function ChngeEmpPerMi(v,n,e)
{
  ...
  var q=document.getElementById("q").value; var cc=document.getElementById("cc").value; var di=document.getElementById("di").value;
  var gi=document.getElementById("gi").value; var EHq=document.getElementById("EHq").value; var ii=document.getElementById("ii").value; 
  var fc=document.getElementById("fc").value; var vc=document.getElementById("vc").value; var y=document.getElementById("y").value;
  var myh=document.getElementById("myh").value; var myt=1;
  window.location="SalesrEntryPerMi.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+'&EHq='+EHq+'&myh='+myh+'&myt='+myt+'&nn='+n+'&action=ChangePerMission&eei='+e+'&ynv='+v; 
}
     ...
     <table border="0">
	  <tr>
	   <td>
	    <table border="0">
		 <tr>
<td align="center"><img src="images/PlannerR.png" border="0" style="height:40px;width:150px;"/></td>
...
<?php $stl = mysql_query("SELECT * FROM hrm_sales_tlemp where TLRepId=".$EmployeeId." AND TLStatus='A'", $con);
    ...
    <tr bgcolor="#FFFFFF">
	 ...
	 <td style="font-family:Georgia; font-size:11px; width:200px;" align="">&nbsp;<?php echo strtoupper($restl['TLName']); ?></td>
 	 <td style="font-family:Georgia; font-size:11px; width:250px;" align="">&nbsp;<?php echo 'Teamlease Team'; ?></td>
	 <td style="font-family:Georgia; font-size:11px; width:50px;" align="center"><?php echo ''; ?></td>				 
	 <td style="font-family:Georgia; font-size:11px; width:70px;" align="center" id="ColTD">			 
