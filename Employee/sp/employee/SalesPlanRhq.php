...
function ChangrYear(YearV)
{
  ...
  window.location="SalesPlanRhq.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&s="+State+"&hq="+Hq+"&grp="+CropGrp+"&ii="+ii; 
}
function ClickGrp(CropGrp)
{
  ...
  var Coutry=document.getElementById("Coutry").value; var State=document.getElementById("State").value; //var QtrV=document.getElementById("QtrV").value;
  var Hq=document.getElementById("Hq").value; var ci=document.getElementById("ComId").value; //var DealerD=document.getElementById("DealerD").value;
  window.location="SalesPlanRhq.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&s="+State+"&hq="+Hq+"&grp="+CropGrp+"&ii="+ii; 
}
...
{ var YearV=document.getElementById("YearV").value; var CropGrp=document.getElementById("CropGrp").value; //var di=document.getElementById("DealerD").value;
  var Coutry=document.getElementById("Coutry").value; var State=document.getElementById("State").value; //var QtrV=document.getElementById("QtrV").value;
  var Hq=document.getElementById("Hq").value; var ci=document.getElementById("ComId").value; var ii=document.getElementById("ItemV").value; 
  window.open("SalesPlanRhqPrint.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&s="+State+"&hq="+Hq+"&grp="+CropGrp+"&ii="+ii,"PrintForm","menubar=no,scrollbars=yes,resizable=no,directories=no,width=100,height=100");
}
...
<tr>
 <td valign="top">
  <table border="0">
   <tr>
    <td id="Entry" style="width:900px;" valign="top">
	<span id="TabEntry">
     <table border="0">
      <tr>
...
<?php if($_REQUEST['grp']==1){ $sqlItem=mysql_query("select * from hrm_sales_seedsitem where GroupId=1 order by ItemName ASC", $con);}
	  ...
	  <tr>
	    <td style="margin-top:0px;width:200px;" class="heading2" align="center"><u>HQ-Wise</u></td>
...
<?php if($_REQUEST['s']>0){$sql = mysql_query("SELECT * FROM hrm_headquater where CompanyId=".$CompanyId." AND StateId=".$_REQUEST['s']." AND HQStatus='A' order by HqName ASC", $con);}else{$sql = mysql_query("SELECT * FROM hrm_headquater where CompanyId=".$CompanyId." AND HQStatus='A' order by HqName ASC", $con);} while($res = mysql_fetch_array($sql)){ ?>
         <option value="<?php echo $res['HqId']; ?>"><?php echo strtoupper($res['HqName']); ?></option><?php } ?></select>
		 </span>
		 </td>
		 <td>&nbsp;</td>
		 <td style="font-size:11px; height:18px;width:80px;color:#E6E6E6;" align="center"><a href="#" onClick="PrintSpRhq()" style="color:#FFCE9D;"><b>PRINT</b></a></td>
	  </tr>
	   </table>
      </td>
   </tr>
...
<?php } /* 4 */  if($i==4){ 
if($_REQUEST['ii']>0){ $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_dealer.HqId=".$_REQUEST['hq'], $con); }
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_dealer.HqId=".$_REQUEST['hq'], $con); } if($_REQUEST['grp']==3){ $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId where (hrm_sales_seedsitem.GroupId=1 OR hrm_sales_seedsitem.GroupId=2) AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_dealer.HqId=".$_REQUEST['hq'], $con); }
}
...
<?php } /* 5 */  $sqlYe=mysql_query("select FromDate,ToDate from hrm_sales_year where YearId=".$YearId, $con); $resYe=mysql_fetch_assoc($sqlYe);
	    ...
	    if($i==5){ 
if($_REQUEST['ii']>0){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$YearId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$YearId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$YearId.".DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_".$YearId.".YearId=".$YearId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_dealer.HqId=".$_REQUEST['hq'], $con); }
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$YearId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$YearId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$YearId.".DealerId=hrm_sales_dealer.DealerId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details_".$YearId.".YearId=".$YearId." AND hrm_sales_dealer.HqId=".$_REQUEST['hq'], $con); } if($_REQUEST['grp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$YearId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$YearId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$YearId.".DealerId=hrm_sales_dealer.DealerId where (hrm_sales_seedsitem.GroupId=1 OR hrm_sales_seedsitem.GroupId=2) AND hrm_sales_sal_details_".$YearId.".YearId=".$YearId." AND hrm_sales_dealer.HqId=".$_REQUEST['hq'], $con); }
}		
...
<?php ////////////////////////////////////////////////////////// ?>
  ...
  <tr style="background-color:#D5F1D1;color:#000000;">
    <td colspan="5" style="font-size:16px;color:#D7EBFF;background-color:#183E83;width:470px;">&nbsp;<b><?php echo 'Head Quarter - '.strtoupper($reshq['HqName']); ?></b></td>
