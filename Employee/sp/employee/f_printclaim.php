...
<?php $sal=mysql_query("select * from fa_salary where SalId=".$_REQUEST['si'],$con); $resS=mysql_fetch_assoc($sal);
 $dis=mysql_query("select rd.Sal_DealerId,DealerName from fa_details rd inner join hrm_sales_dealer sd on rd.Sal_DealerId=sd.DealerId where FaId=".$resS['FaId']." order by DealerName ASC",$con); 
...
<tr>
 <td style="width:100%;">
  <table border="0" style="width:95%;">
   ...
   <tr>
    <td class="tdf">
<a href="f_printclaimact.php?si=<?php echo $_REQUEST['si']; ?>&e=<?php echo $_REQUEST['e']; ?>">Print</a><br/><br/>	
