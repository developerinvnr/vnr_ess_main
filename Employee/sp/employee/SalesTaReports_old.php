...
function FChk(v1,v2)
{
 ...
 { 
   ...
   document.getElementById("TD1").style.display='block'; document.getElementById("TD2").style.display='none'; document.getElementById("TD3").style.display='none';
 ...
 {  
   ...
   document.getElementById("TD2").style.display='block'; document.getElementById("TD1").style.display='none'; document.getElementById("TD3").style.display='none';
   var rowSteChk=document.getElementById("rowSteChk").value;
   if(rowSteChk>0){ document.getElementById("SteWC0").style.display='none'; document.getElementById("SteWC1").style.display='block';
   document.getElementById("SteWise").value=0; document.getElementById("TD4").style.display='none'; }
 }
 ...
 {  
   ...
   document.getElementById("TD3").style.display='block'; document.getElementById("TD1").style.display='none'; document.getElementById("TD2").style.display='none';
   var rowSteChk=document.getElementById("rowSteChk").value;
   if(rowSteChk>0){ document.getElementById("SteWC0").style.display='none'; document.getElementById("SteWC1").style.display='block';
   document.getElementById("SteWise").value=0; document.getElementById("TD4").style.display='none'; }
 }
...
<tr>
 ...
 <td id="TD4" style="display:<?php if($_REQUEST['SteWise']==1){echo 'block';}else{echo 'none';} ?>;"><?php /*************** STATE WISE STATE WISE  */ ?>
  <table>
   <tr>
    <td>
...
<?php 
include("Nrv4.php");
$Net4=$res4['tm1']*$Nrv4; $Net5=$res4['tm2']*$Nrv5; $Net6=$res4['tm3']*$Nrv6; $Net7=$res4['tm4']*$Nrv7; 
$Net8=$res4['tm5']*$Nrv8; $Net9=$res4['tm6']*$Nrv9; $Net10=$res4['tm7']*$Nrv10; $Net11=$res4['tm8']*$Nrv11; 
$Net12=$res4['tm9']*$Nrv12; $Net1=$res4['tm10']*$Nrv1; $Net2=$res4['tm11']*$Nrv2; $Net3=$res4['tm12']*$Nrv3; 
$NetNRV_4=$Net4+$Net5+$Net6+$Net7+$Net8+$Net9+$Net10+$Net11+$Net12+$Net1+$Net2+$Net3; $LakhNRV_4=$NetNRV_4/100000;
?>
  <td class="Th40"><b><?php echo $y4T; ?></b></td><td class="Th40"><b><?php echo $y4; ?></b></td> 
