  ...
  <table>
   <tr>
    <td>
     ...
     <?php $sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where g.RepEmployeeID=".$EmployeeId." AND g.DepartmentId=6 AND e.EmpStatus='A' order by Fname ASC", $con);
  ...
  <table>
   ...
   <td style="width:1px;"></td>
    <td>
	 ...
	 <?php if($_REQUEST['rpt']>0){ ?>
<?php $sHqck=mysql_query("select * from hrm_sales_dealer where (Terr_vc=".$_REQUEST['SelCon']." OR Terr_fc=".$_REQUEST['SelCon'].") AND DealerSts='A'",$con); $rowHqck=mysql_num_rows($sHqck);
	 if($rowHqck==0){$sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where g.RepEmployeeID=".$_REQUEST['SelCon']." AND g.DepartmentId=6 AND e.EmpStatus='A' order by Fname ASC", $con); }
	 elseif($rowHqck>0){$sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where (g.EmployeeID=".$_REQUEST['SelCon']." OR g.RepEmployeeID=".$_REQUEST['SelCon'].") AND g.DepartmentId=6 AND e.EmpStatus='A' order by Fname ASC", $con);}
	  while($rName2=mysql_fetch_assoc($sName2)){ 
	 if($rName2['DR']=='Y'){$M='Dr.';} elseif($rName2['Gender']=='M'){$M='Mr.';} elseif($rName2['Gender']=='F' AND $rName2['Married']=='Y'){$M='Mrs.';} elseif($rName2['Gender']=='F' AND $rName2['Married']=='N'){$M='Miss.';} $Ename=$rName2['Fname'].' '.$rName2['Sname'].' '.$rName2['Lname']; ?>
	 <option value="<?php echo $rName2['EmployeeID']; ?>"><?php echo strtoupper($Ename); ?></option><?php } ?>
	 <?php } ?>	 
...
<?php /*************** NAME WISE NAME WISE  */ ?><?php /*************** NAME WISE NAME WISE  */ ?><?php /*************** NAME WISE NAME WISE  */ ?>
  <table>
   ...
   <td style="width:1px;"></td>
	 ...
	 <?php if($_REQUEST['rpt']>0){ ?>
<?php $sZoneck=mysql_query("select * from hrm_sales_dealer where (Terr_vc=".$_REQUEST['SelCon']." OR Terr_fc=".$_REQUEST['SelCon'].") AND DealerSts='A'",$con); $rowZoneck=mysql_num_rows($sZoneck);
	 if($rowZoneck==0){$sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where g.RepEmployeeID=".$_REQUEST['SelCon']." AND g.DepartmentId=6 AND e.EmpStatus='A' order by Fname ASC", $con); }
	 elseif($rowZoneck>0){$sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where (g.EmployeeID=".$_REQUEST['SelCon']." OR g.RepEmployeeID=".$_REQUEST['SelCon'].") AND g.DepartmentId=6 AND e.EmpStatus='A' order by Fname ASC", $con);}
	  while($rName2=mysql_fetch_assoc($sName2)){ 
	 if($rName2['DR']=='Y'){$M='Dr.';} elseif($rName2['Gender']=='M'){$M='Mr.';} elseif($rName2['Gender']=='F' AND $rName2['Married']=='Y'){$M='Mrs.';} elseif($rName2['Gender']=='F' AND $rName2['Married']=='N'){$M='Miss.';} $Ename=$rName2['Fname'].' '.$rName2['Sname'].' '.$rName2['Lname']; ?>
	 <option value="<?php echo $rName2['EmployeeID']; ?>"><?php echo strtoupper($Ename); ?></option><?php } ?>
...
<?php $sqlRptZ=mysql_query("select g.EmployeeID from hrm_employee_general g INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where DepartmentId=6 AND e.EmpStatus='A' AND RepEmployeeID=".$_REQUEST['SelZone'], $con); $rowRptZ=mysql_num_rows($sqlRptZ); ?>	 
     <?php if($rowRptZ==0){ ?>
...
<?php $sNameck=mysql_query("select * from hrm_sales_dealer where (Terr_vc=".$_REQUEST['SelZone']." OR Terr_fc=".$_REQUEST['SelZone'].") AND DealerSts='A'",$con); $rowNameck=mysql_num_rows($sNameck); ?>	 
<?php if($rowNameck==0){$sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where g.RepEmployeeID=".$_REQUEST['SelZone']." AND g.DepartmentId=6 AND e.EmpStatus='A' order by Fname ASC", $con);}
      elseif($rowNameck>0){$sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where (g.EmployeeID=".$_REQUEST['SelZone']." OR g.RepEmployeeID=".$_REQUEST['SelZone'].") AND g.DepartmentId=6 AND e.EmpStatus='A' order by Fname ASC", $con); }
	  while($rName2=mysql_fetch_assoc($sName2)){ 
	 if($rName2['DR']=='Y'){$M='Dr.';} elseif($rName2['Gender']=='M'){$M='Mr.';} elseif($rName2['Gender']=='F' AND $rName2['Married']=='Y'){$M='Mrs.';} elseif($rName2['Gender']=='F' AND $rName2['Married']=='N'){$M='Miss.';} $Ename=$rName2['Fname'].' '.$rName2['Sname'].' '.$rName2['Lname']; ?>
	 <option value="<?php echo $rName2['EmployeeID']; ?>"><?php echo strtoupper($Ename); ?></option><?php } ?>
	 <?php } ?>
...
<?php $sqlRptN=mysql_query("select g.EmployeeID from hrm_employee_general g INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where DepartmentId=6 AND e.EmpStatus='A' AND RepEmployeeID=".$_REQUEST['SelName'], $con); 
...
$sqlGE=mysql_query("select GradeId from hrm_employee_general where DepartmentId=6 AND EmployeeID=".$_REQUEST['SelName'], $con); $resGE=mysql_fetch_assoc($sqlGE); ?>	 
     <?php if($rowRptN==0){ ?>
     <?php $sHq=mysql_query("select Hq_vc as HqId,HqName from hrm_sales_dealer INNER JOIN hrm_headquater hq ON d.Hq_vc=hq.HqId where d.Terr_vc=".$_REQUEST['SelName']." AND d.DealerSts='A' group by Hq_vc order by HqName ASC", $con); while($rHq=mysql_fetch_assoc($sHq)){ ?>
	 <option value="<?php echo $rHq['HqId']; ?>"><?php echo strtoupper($rHq['HqName']); ?></option><?php } ?>
	 <?php $ssHqv=mysql_query("select Hq_vc from hrm_sales_dealer INNER JOIN hrm_headquater hq ON d.Hq_vc=hq.HqId where d.Terr_vc=".$_REQUEST['SelName']." AND d.DealerSts='A' group by Hq_vc order by HqName ASC"); $rowHqv=mysql_num_rows($ssHqv); while($rrHqv=mysql_fetch_array($ssHqv)){ $arr_v[]=$rrHqv['Hq_vc']; } 
 if($rowHqv>0){ $Hqv = implode(',', $arr_v); }else{ $Hqv='99999';}
	 $sHq2=mysql_query("select Hq_fc as HqId,HqName from hrm_sales_dealer INNER JOIN hrm_headquater hq ON d.Hq_fc=hq.HqId where d.Terr_fc=".$_REQUEST['SelName']." AND d.DealerSts='A' AND Hq_fc NOT IN (".$Hqv.") group by Hq_fc order by HqName ASC", $con); while($rHq2=mysql_fetch_assoc($sHq2)){ ?>
...
if($_REQUEST['ConWise']>0)
{
 ...
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['SelCon']." OR rl.R1=".$_REQUEST['SelCon']." OR rl.R2=".$_REQUEST['SelCon']." OR rl.R3=".$_REQUEST['SelCon']." OR rl.R4=".$_REQUEST['SelCon']." OR rl.R5=".$_REQUEST['SelCon'].") AND sp.ProductSts='A' AND sd.YearId=".$yset." AND ".$qin."", $con); 
 }
...
elseif($_REQUEST['ZoneWise']>0)
{
 ...
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['SelZone']." OR rl.R1=".$_REQUEST['SelZone']." OR rl.R2=".$_REQUEST['SelZone']." OR rl.R3=".$_REQUEST['SelZone']." OR rl.R4=".$_REQUEST['SelZone']." OR rl.R5=".$_REQUEST['SelZone'].") AND sp.ProductSts='A' AND sd.YearId=".$yset." AND ".$qin."", $con); 
 }
...
elseif($_REQUEST['HqWise']>0)
{
 if($_REQUEST['SelHq']>0)
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sd.YearId=".$yset." AND sp.ProductSts='A' AND d.DealerSts='A' AND ".$qin." AND ".$HqCon."=".$_REQUEST['SelHq']."", $con);  
 }
 if($_REQUEST['SelHq']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$Gnj." where d.DealerSts='A' AND (".$TerrCon."=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND sd.YearId=".$yset." AND sp.ProductSts='A' AND ".$qin."", $con); 
 }
...
{
 $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId where sd.YearId=".$yset." AND sp.ProductSts='A' AND ".$qin." AND sd.DealerId=".$_REQUEST['SelDis'], $con);
}
/***********************************************************************************/
...
$sql = mysql_query("select sp.ItemId,ProductId,ProductName,ItemName,ItemCode,TypeName from hrm_sales_seedsproduct sp INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_seedtype st ON sp.TypeId=st.TypeId where ".$qin." AND sp.ProductSts='A' order by ItemName ASC, TypeName ASC, ProductName ASC", $con); 
...
{ 
 if($_REQUEST['SelCon']>0)
 {
 $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where DealerSts='A' AND (".$TerrCon."=".$_REQUEST['SelCon']." OR rl.R1=".$_REQUEST['SelCon']." OR rl.R2=".$_REQUEST['SelCon']." OR rl.R3=".$_REQUEST['SelCon']." OR rl.R4=".$_REQUEST['SelCon']." OR rl.R5=".$_REQUEST['SelCon'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con); 
 }
 if($_REQUEST['SelCon']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where DealerSts='A' AND (".$TerrCon."=".$EmployeeId." OR rl.R1=".$EmployeeId." OR rl.R2=".$EmployeeId." OR rl.R3=".$EmployeeId." OR rl.R4=".$EmployeeId." OR rl.R5=".$EmployeeId.") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con);
 }
}
elseif($_REQUEST['ZoneWise']>0)
{ 
 if($_REQUEST['SelZone']>0)
 {
 $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where DealerSts='A' AND (".$TerrCon."=".$_REQUEST['SelZone']." OR rl.R1=".$_REQUEST['SelZone']." OR rl.R2=".$_REQUEST['SelZone']." OR rl.R3=".$_REQUEST['SelZone']." OR rl.R4=".$_REQUEST['SelZone']." OR rl.R5=".$_REQUEST['SelZone'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con); 
 }
 if($_REQUEST['SelZone']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where DealerSts='A' AND (".$TerrCon."=".$EmployeeId." OR rl.R1=".$EmployeeId." OR rl.R2=".$EmployeeId." OR rl.R3=".$EmployeeId." OR rl.R4=".$EmployeeId." OR rl.R5=".$EmployeeId.") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con);
...
{ 
 if($_REQUEST['SelName']>0)
 {
 $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where DealerSts='A' AND (".$TerrCon."=".$_REQUEST['SelName']." OR rl.R1=".$_REQUEST['SelName']." OR rl.R2=".$_REQUEST['SelName']." OR rl.R3=".$_REQUEST['SelName']." OR rl.R4=".$_REQUEST['SelName']." OR rl.R5=".$_REQUEST['SelName'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con); 
 }
 if($_REQUEST['SelName']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where DealerSts='A' AND (".$TerrCon."=".$EmployeeId." OR rl.R1=".$EmployeeId." OR rl.R2=".$EmployeeId." OR rl.R3=".$EmployeeId." OR rl.R4=".$EmployeeId." OR rl.R5=".$EmployeeId.") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con);
...
{ 
 if($_REQUEST['SelHq']>0)
 {
 $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sd.YearId=".$yset." AND sd.ProductId=".$res['ProductId']." AND ".$HqCon."=".$_REQUEST['SelHq']."", $con); 
 }
 if($_REQUEST['SelHq']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$Gnj." where HqTEmpStatus='A' AND (".$TerrCon."=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con);
 }
}
elseif($_REQUEST['DisWise']>0)
