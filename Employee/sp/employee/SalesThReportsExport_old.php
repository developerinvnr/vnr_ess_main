...
{ 
 ...
 { $sqlName1=mysql_query("select Fname,Sname,Lname from hrm_employee where EmployeeID=".$_REQUEST['SelCon'], $con); $resName1=mysql_fetch_assoc($sqlName1); 
   $NVV="SalesReports_TopLevelWise:_".$FD."-".$TD."_".$resName1['Fname'].'_'.$resName1['Sname'].'_'.$resName1['Lname']; }
 if($_REQUEST['SelCon']=='All'){ $NVV='SalesReports_TopLevelWise:'.$FD.'-'.$TD.'_ALL_MY_TEAM'; }
} 
...
elseif($_REQUEST['HqWise']>0)
{
 ...
 if($_REQUEST['crp']==3){ $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_dealer.HqId=".$_REQUEST['SelHq'], $con); }  } 
 }
 if($_REQUEST['SelHq']=='All')
 {
...
if($_REQUEST['ConWise']>0)
{
 if($_REQUEST['SelCon']>0)
 {
 if($_REQUEST['ii']>0){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelCon'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); }
 ...
 if($_REQUEST['crp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelCon'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); }  } 
 }
 if($_REQUEST['SelCon']=='All')
 {
...
{ 
 if($_REQUEST['SelCon']>0)
 {
 $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelCon']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelCon'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); 
 }
 if($_REQUEST['SelCon']=='All')
 {
