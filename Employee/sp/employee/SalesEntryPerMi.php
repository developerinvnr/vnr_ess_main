...
<tr><td><span id="DealerHqSpan"></span></td></tr>
			 ...
			 <td style="width:1200px;font-family:Times New Roman;font-size:20px; color:#FFFFFF;" valign="top">&nbsp;<b><i><u>My Team Edit Plan Permission</u></i></b><font style="font-family:Times New Roman;height:22px;font-size:14px;color:#008000;"><?php echo $Msg; ?></font></td>
			 </tr></table></td>
			</tr>
  <tr>
			...
			<tr bgcolor="#DFFA45">
			 ...
			 <td style="font-family:Georgia; font-size:12px; width:65px;" align="center"><b>Permission</b></td>
...
?> 			
            <tr bgcolor="#FFFFFF">
		     ...
		     <td style="font-family:Georgia; font-size:11px;" align="center"><?php echo $ResRep['EmpCode']; ?></td>
		     <td style="font-family:Georgia; font-size:11px;" align="">&nbsp;<?php echo $EmpName; ?></td>
 		     <td style="font-family:Georgia; font-size:11px;" align="">&nbsp;<?php echo $ResDesig['DesigName']; ?></td>
			 <td style="font-family:Georgia; font-size:11px;" align="center"><?php echo $ResG['GradeValue']; ?></td>				 
			 <td style="font-family:Georgia; font-size:11px;" align="center" id="ColTD">
