...
<td>
 <table border="0" cellpadding="0" cellspacing="4" cellpadding="0">
 <?php $sRpHq = mysql_query("select tl.*,HqName from hrm_sales_tlemp tl INNER JOIN hrm_headquater hq ON tl.TLHq=hq.HqId where tl.TLRepId=".$EmployeeId." AND tl.TLStatus='A' order by tl.TLName ASC limit 0,1", $con); $rowRpHq=mysql_num_rows($sRpHq); 
