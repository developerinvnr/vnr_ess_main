...
function ChangrYear(YearV)
{
  ...
  window.location="SalesPlanRst.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&s="+State+"&grp="+CropGrp+"&ii="+ii; 
}
...
{ var YearV=document.getElementById("YearV").value; var CropGrp=document.getElementById("CropGrp").value; //var di=document.getElementById("DealerD").value;
  var Coutry=document.getElementById("Coutry").value; var State=document.getElementById("State").value; //var QtrV=document.getElementById("QtrV").value;
  var ci=document.getElementById("ComId").value; var ii=document.getElementById("ItemV").value; //var Hq=document.getElementById("Hq").value;
  window.open("SalesPlanRstPrint.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&y="+YearV+"&ci="+ci+"&c="+Coutry+"&s="+State+"&grp="+CropGrp+"&ii="+ii,"PrintForm","menubar=no,scrollbars=yes,resizable=no,directories=no,width=100,height=100");
}
...
<?php if($_REQUEST['grp']==1){ $sqlItem=mysql_query("select * from hrm_sales_seedsitem where GroupId=1 order by ItemName ASC", $con);}
	  ...
	  <tr>
	    <td style="margin-top:0px;width:200px;" class="heading2" align="center"><u>State-Wise</u></td>
...
<?php if($_REQUEST['c']>0){$sql = mysql_query("SELECT * FROM hrm_state where CountryId=".$_REQUEST['c']." order by StateName ASC", $con); }else{$sql = mysql_query("SELECT * FROM hrm_state order by StateName ASC", $con);}while($res = mysql_fetch_array($sql)){ ?>
        <option value="<?php echo $res['StateId']; ?>"><?php echo strtoupper($res['StateName']); ?></option><?php } ?></select>
		 ...
		 <td>&nbsp;</td>
		 <td style="font-size:11px; height:18px;width:80px;color:#E6E6E6;" align="center"><a href="#" onClick="PrintSpRst()" style="color:#FFCE9D;"><b>PRINT</b></a></td>
	  </tr>
	   </table>
      </td>
   </tr>
...
<?php /* 1 */ if($i==1){
if($_REQUEST['ii']>0){ $sqlP1d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId2." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$BeforeYId2.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId2.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_sal_details_".$BeforeYId2.".YearId=".$BeforeYId2." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); } 
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP1d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId2." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$BeforeYId2.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId2.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details_".$BeforeYId2.".YearId=".$BeforeYId2." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); } if($_REQUEST['grp']==3){ $sqlP1d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId2." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$BeforeYId2.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId2.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where (hrm_sales_seedsitem.GroupId=1 OR hrm_sales_seedsitem.GroupId=2) AND hrm_sales_sal_details_".$BeforeYId2.".YearId=".$BeforeYId2." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); }
}
...
<?php } /* 2 */ if($i==2){ 
if($_REQUEST['ii']>0){ $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$BeforeYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_sal_details_".$BeforeYId.".YearId=".$BeforeYId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); }
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$BeforeYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details_".$BeforeYId.".YearId=".$BeforeYId." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); } if($_REQUEST['grp']==3){ $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$BeforeYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where (hrm_sales_seedsitem.GroupId=1 OR hrm_sales_seedsitem.GroupId=2) AND hrm_sales_sal_details_".$BeforeYId.".YearId=".$BeforeYId." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); }
}
...
<?php } /* 3 */ if($i==3){ 
if($_REQUEST['ii']>0){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['y'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['y'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_sal_details_".$_REQUEST['y'].".YearId=".$_REQUEST['y']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); }
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['y'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['y'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details_".$_REQUEST['y'].".YearId=".$_REQUEST['y']." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); } if($_REQUEST['grp']==3){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['y'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['y'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where (hrm_sales_seedsitem.GroupId=1 OR hrm_sales_seedsitem.GroupId=2) AND hrm_sales_sal_details_".$_REQUEST['y'].".YearId=".$_REQUEST['y']." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); }
}
...
<?php } /* 4 */  if($i==4){ 
if($_REQUEST['ii']>0){ $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); }
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); } if($_REQUEST['grp']==3){ $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where (hrm_sales_seedsitem.GroupId=1 OR hrm_sales_seedsitem.GroupId=2) AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); }
}
...
<?php } /* 5 */  $sqlYe=mysql_query("select FromDate,ToDate from hrm_sales_year where YearId=".$YearId, $con); $resYe=mysql_fetch_assoc($sqlYe);
	    ...
	    if($i==5){ 
if($_REQUEST['ii']>0){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$YearId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$YearId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$YearId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_sal_details_".$YearId.".YearId=".$YearId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); }
else
{ if($_REQUEST['grp']==1 OR $_REQUEST['grp']==2){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$YearId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$YearId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$YearId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_seedsitem.GroupId=".$_REQUEST['grp']." AND hrm_sales_sal_details_".$YearId.".YearId=".$YearId." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); } if($_REQUEST['grp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$YearId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$YearId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$YearId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where (hrm_sales_seedsitem.GroupId=1 OR hrm_sales_seedsitem.GroupId=2) AND hrm_sales_sal_details_".$YearId.".YearId=".$YearId." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); }
}		
...
<?php ////////////////////////////////////////////////////////// ?>
  ...
  <tr style="background-color:#D5F1D1;color:#000000;">
    <td colspan="5" style="font-size:16px;color:#D7EBFF;background-color:#183E83;width:470px;">&nbsp;<b><?php echo 'State - '.strtoupper($resS['StateName']); ?></b></td>
...
?>
	 ...
	 <td style="width:50px;" align="center"><b><?php echo $y1T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y1; ?></b></td>
	 <td align="right" width="80"><?php if($res1['tm1']>0){echo $res1['tm1'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm2']>0){echo $res1['tm2'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm3']>0){echo $res1['tm3'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm4']>0){echo $res1['tm4'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm5']>0){echo $res1['tm5'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm6']>0){echo $res1['tm6'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm7']>0){echo $res1['tm7'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm8']>0){echo $res1['tm8'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm9']>0){echo $res1['tm9'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm10']>0){echo $res1['tm10'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm11']>0){echo $res1['tm11'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res1['tm12']>0){echo $res1['tm12'];} ?>&nbsp;</td><td align="right" width="80"><b><?php if($res1Tot>0){echo $res1Tot;} ?></b>&nbsp;</td><td align="right" width="80"><b><?php if($LakhNRV_1>0){echo round($LakhNRV_1,4);} ?></b>&nbsp;
...
?>
	 ...
	 <td style="width:50px;" align="center"><b><?php echo $y2T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y2; ?></b></td>  
	 <td align="right" width="80"><?php if($res2['tm1']>0){echo $res2['tm1'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm2']>0){echo $res2['tm2'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm3']>0){echo $res2['tm3'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm4']>0){echo $res2['tm4'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm5']>0){echo $res2['tm5'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm6']>0){echo $res2['tm6'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm7']>0){echo $res2['tm7'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm8']>0){echo $res2['tm8'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm9']>0){echo $res2['tm9'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm10']>0){echo $res2['tm10'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm11']>0){echo $res2['tm11'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res2['tm12']>0){echo $res2['tm12'];} ?>&nbsp;</td><td align="right" width="80"><b><?php if($res2Tot>0){echo $res2Tot;} ?></b>&nbsp;</td><td align="right" width="80"><b><?php if($LakhNRV_2>0){echo round($LakhNRV_2,4);} ?></b>&nbsp;
...
?>
	 ...
	 <td style="width:50px;" align="center"><b><?php echo $y3T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y3; ?></b></td> 
	 <td align="right" width="80"><?php if($res3['tm1']>0){echo $res3['tm1'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm2']>0){echo $res3['tm2'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm3']>0){echo $res3['tm3'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm4']>0){echo $res3['tm4'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm5']>0){echo $res3['tm5'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm6']>0){echo $res3['tm6'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm7']>0){echo $res3['tm7'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm8']>0){echo $res3['tm8'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm9']>0){echo $res3['tm9'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm10']>0){echo $res3['tm10'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm11']>0){echo $res3['tm11'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res3['tm12']>0){echo $res3['tm12'];} ?>&nbsp;</td><td align="right" width="80"><b><?php if($res3Tot>0){echo $res3Tot;} ?></b>&nbsp;</td><td align="right" width="80"><b><?php if($LakhNRV_3>0){echo round($LakhNRV_3,4);} ?></b>&nbsp;
...
<?php } /* 4 */  if($i==4){ $sqlP4d=mysql_query("select SUM(M1) as tm1,SUM(M2) as tm2,SUM(M3) as tm3,SUM(M4) as tm4,SUM(M5) as tm5,SUM(M6) as tm6,SUM(M7) as tm7,SUM(M8) as tm8,SUM(M9) as tm9,SUM(M10) as tm10,SUM(M11) as tm11,SUM(M12) as tm12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_seedsproduct.ProductId=".$res['ProductId']." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); $res4=mysql_fetch_assoc($sqlP4d); 
...
?>
	 ...
	 <td style="width:50px;" align="center"><b><?php echo $y4T; ?></b></td><td style="width:50px;" align="center"><b><?php echo $y4; ?></b></td> 
	 <td align="right" width="80"><?php if($res4['tm1']>0){echo $res4['tm1'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm2']>0){echo $res4['tm2'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm3']>0){echo $res4['tm3'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm4']>0){echo $res4['tm4'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm5']>0){echo $res4['tm5'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm6']>0){echo $res4['tm6'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm7']>0){echo $res4['tm7'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm8']>0){echo $res4['tm8'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm9']>0){echo $res4['tm9'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm10']>0){echo $res4['tm10'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm11']>0){echo $res4['tm11'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res4['tm12']>0){echo $res4['tm12'];} ?>&nbsp;</td><td align="right" width="80"><b><?php if($res4Tot>0){echo $res4Tot;} ?></b>&nbsp;</td><td align="right" width="80"><b><?php if($LakhNRV_4>0){echo round($LakhNRV_4,4);} ?></b>&nbsp;
...
<?php } /* 5 */  $sqlYe=mysql_query("select FromDate,ToDate from hrm_sales_year where YearId=".$YearId, $con); $resYe=mysql_fetch_assoc($sqlYe);
        $yeft=date("y",strtotime($resYe['FromDate'])).'-'.date("y",strtotime($resYe['ToDate'])); $yeT='<font color="#A60053">YTD</font>'; 
	    if($i==5){ $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details_".$YearId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$YearId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$YearId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_sales_sal_details_".$YearId.".YearId=".$YearId." AND hrm_sales_seedsproduct.ProductId=".$res['ProductId']." AND hrm_headquater.StateId=".$_REQUEST['s'], $con); $res5=mysql_fetch_assoc($sqlP5d);  
...
?>
	 ...
	 <td style="width:50px;" align="center"><b><?php echo $yeT; ?></b></td><td style="width:50px;" align="center"><b><?php echo $yeft; ?></b></td> 
	 <td align="right" width="80"><?php if($res5['tM1']!=''){echo $res5['tM1'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res5['tM2']!=''){echo $res5['tM2'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res5['tM3']!=''){echo $res5['tM3'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res5['tM4']!=''){echo $res5['tM4'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res5['tM5']!=''){echo $res5['tM5'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res5['tM6']!=''){echo $res5['tM6'];} ?>&nbsp;</td> <td align="right" width="80"><?php if($res5['tM7']!=''){echo $res5['tM7'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res5['tM8']!=''){echo $res5['tM8'];} ?>&nbsp;</td> <td align="right" width="80"><?php if($res5['tM9']!=''){echo $res5['tM9'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res5['tM10']!=''){echo $res5['tM10'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res5['tM11']!=''){echo $res5['tM11'];} ?>&nbsp;</td><td align="right" width="80"><?php if($res5['tM12']!=''){echo $res5['tM12'];} ?>&nbsp;</td><td align="right" width="80"><b><?php if($res5Tot!=''){echo $res5Tot;} ?></b>&nbsp;</td><td align="right" width="80"><b><?php if($LakhNRV_5!=''){echo round($LakhNRV_5,4);} ?></b>&nbsp;
