...
var M1B=parseFloat(document.getElementById(d+'M1_Be'+sn).value); 
var M2B=parseFloat(document.getElementById(d+'M2_Be'+sn).value); 
var M3B=parseFloat(document.getElementById(d+'M3_Be'+sn).value); 
var M4B=parseFloat(document.getElementById(d+'M4_Be'+sn).value); 
var M1C=parseFloat(document.getElementById(d+'M1_Ce'+sn).value); 
var M2C=parseFloat(document.getElementById(d+'M2_Ce'+sn).value); 
var M3C=parseFloat(document.getElementById(d+'M3_Ce'+sn).value); 
var M4C=parseFloat(document.getElementById(d+'M4_Ce'+sn).value);
...
var T2=parseFloat(document.getElementById(d+"TotP2d_"+sn).value); 
var T3=parseFloat(document.getElementById(d+"TotP3d_"+sn).value); 
var Ta=parseFloat(document.getElementById(d+"MTota"+sn).value); 
var Tb=parseFloat(document.getElementById(d+"MTotb"+sn).value);
...
{
  var PId=document.getElementById(di+'P_'+sn).value; var EId=document.getElementById('EmpId').value; 
  var ii=document.getElementById('ii').value; var hq=document.getElementById('hq').value; 
  var TerId=0; var StaId=0; var RepTerId=0;
  var M1B=parseFloat(document.getElementById(di+'M1_Be'+sn).value); 
  var M2B=parseFloat(document.getElementById(di+'M2_Be'+sn).value); 
  var M3B=parseFloat(document.getElementById(di+'M3_Be'+sn).value); 
  var M4B=parseFloat(document.getElementById(di+'M4_Be'+sn).value); 
  var M1C=parseFloat(document.getElementById(di+'M1_Ce'+sn).value); 
  var M2C=parseFloat(document.getElementById(di+'M2_Ce'+sn).value); 
  var M3C=parseFloat(document.getElementById(di+'M3_Ce'+sn).value); 
  var M4C=parseFloat(document.getElementById(di+'M4_Ce'+sn).value); 
  ...
  var TotB=Math.round((n1B+n2B+n3B+n4B)*100)/100; 
  var TotC=Math.round((n1C+n2C+n3C+n4C)*100)/100; 
  document.getElementById("TotAValueM").value=0; 
  document.getElementById("TotBValueM").value=TotB; 
  document.getElementById("TotCValueM").value=TotC; 
  document.getElementById("Sno").value=sn; document.getElementById("MainSelHqId").value=di; 
  
  var url = 'SlctSalesProdDealMt.php';  var pars = 'Action=AddMonth&p='+PId+'&e='+EId+'&m1B='+n1B+'&m2B='+n2B+'&m3B='+n3B+'&m4B='+n4B+'&m1C='+n1C+'&m2C='+n2C+'&m3C='+n3C+'&m4C='+n4C+'&TotB='+TotB+'&TotC='+TotC+'&yi='+yi+'&Mhq='+di+'&sn='+sn+'&hi='+hq+'&TerId='+TerId+'&StaId='+StaId+'&RepTerId='+RepTerId+'&q='+q+'&ii='+ii+'&hqe='+hqe;   
...
{ document.getElementById('AddMonthResult').innerHTML = originalRequest.responseText; 
  var Sno=document.getElementById('Sno').value; var di=document.getElementById('MainSelHqId').value; 
  ...
  { 
   document.getElementById(di+'M1_BeT').value=document.getElementById("Tot21").value; 
   document.getElementById(di+'M2_BeT').value=document.getElementById("Tot22").value; 
   document.getElementById(di+'M3_BeT').value=document.getElementById("Tot23").value; 
   document.getElementById(di+'M4_BeT').value=document.getElementById("Tot24").value; 
   document.getElementById(di+'M1_CeT').value=document.getElementById("Tot31").value; 
   document.getElementById(di+'M2_CeT').value=document.getElementById("Tot32").value; 
   document.getElementById(di+'M3_CeT').value=document.getElementById("Tot33").value; 
   document.getElementById(di+'M4_CeT').value=document.getElementById("Tot34").value; 
...
if(va1<va2){alert("Please check product value, your product value equal or more then from reporting values"); return false;}if(vb1<vb2){alert("Please check product value, your product value equal or more then from reporting values"); return false;}
  }
 }
...
<tr>
 <td style="width:100%;">	      
  ...
  <td valign="bottom" style="width:140px;"><?php if($_REQUEST['myt']==0){ ?><a href="#"><img src="images/Myteam.png" border="0" style="height:30px;width:130px;" /></a><?php } elseif($_REQUEST['myt']==1){ ?><a href="#"><img src="images/Myteam1.png" border="0" style="height:30px;width:130px;"/></a><?php } ?></td>
...
?>	   
   ...
   <?php }else{ ?>
   <input type="hidden" id="ItemV" value="0" />
   <?php } ?>
   ...
   <?php }else{ ?>
   <input type="hidden" id="ItemV2" value="0" />
   <?php } ?>	
   <td>&nbsp;</td>
...
<?php $sql = mysql_query("select HqName from hrm_headquater where HqId=".$_REQUEST['hq'], $con);
	  ...
	  $resY0=mysql_fetch_assoc($sqlY0); $resY1=mysql_fetch_assoc($sqlY1);  
	  ...
	  $y0T='<font color="#A60053">Ach.</font>'; $y1T='<font color="#A60053">Ach.</font>'; 
	  $y2T='<font color="#A60053">Tgt.</font>'; $y3T='<font color="#A60053">Proj.</font>';
	  ...
	  $resItem=mysql_fetch_assoc($sqlItem); $ItemN=$resItem['ItemName']; $sqlSubEmp = mysql_query("select * from hrm_sales_emp_action where EmployeeID=".$EmployeeId." AND YearId=".$_REQUEST['y']." AND StatusB=1", $con); 
...
/*if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2' AND $_REQUEST['ii']!=0){$sql = mysql_query("select sp.ItemId,ProductId,ProductName,ItemName,TypeName from hrm_sales_seedsproduct sp INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_seedtype st ON sp.TypeId=st.TypeId where sp.ProductSts='A' AND si.ItemId=".$_REQUEST['ii']." order by ItemName ASC, TypeName ASC, ProductName ASC", $con);}
 ...
 if($_REQUEST['vc']>0){ $joinD="d.Terr_vc=g.EmployeeID"; $suvD="Terr_vc=".$EmployeeId; }
 elseif($_REQUEST['fc']>0){ $joinD="d.Terr_fc=g.EmployeeID"; $suvD="Terr_fc=".$EmployeeId; }
 ...
 //$sqlP0=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_hq_temp hqt ON d.HqId=hqt.HqId INNER JOIN hrm_employee_general g ON hqt.EmployeeID=g.EmployeeID where HqTEmpStatus='A' AND (hqt.EmployeeID=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND d.DealerSts='A' AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$_REQUEST['y'], $con); 
 $sqlP0=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$joinD." where d.DealerSts='A' AND (".$suvD." OR g.RepEmployeeID=".$EmployeeId.") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$_REQUEST['y'], $con);
 $rowP0=mysql_num_rows($sqlP0); $resP0=mysql_fetch_assoc($sqlP0);
 //$sqlP1=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_hq_temp hqt ON d.HqId=hqt.HqId INNER JOIN hrm_employee_general g ON hqt.EmployeeID=g.EmployeeID where HqTEmpStatus='A' AND (hqt.EmployeeID=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND d.DealerSts='A' AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$AfterYId, $con); 
 $sqlP1=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$joinD." where d.DealerSts='A' AND (".$suvD." OR g.RepEmployeeID=".$EmployeeId.") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$AfterYId, $con);
 $rowP1=mysql_num_rows($sqlP1); $resP1=mysql_fetch_assoc($sqlP1);
 ...
 $rowP4=mysql_num_rows($sqlP4); $resP4=mysql_fetch_assoc($sqlP4); 
 $sqlP5=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq where HqRepEmpID=".$EmployeeId." AND ProductId=".$res['ProductId']." AND YearId=".$AfterYId, $con); 
 $rowP5=mysql_num_rows($sqlP5); $resP5=mysql_fetch_assoc($sqlP5);

 $TotAchP2=0; $rowChkP=0;
 /*
 if($rowP0a==0 && $rowP1a==0 && $rowP0==0 && $rowP1==0 && $rowP4==0 && $rowP5==0)
 {
 $sChk=mysql_query("select * from hrm_sales_arrange_prod sap INNER JOIN hrm_headquater hq ON sap.StateId=hq.StateId INNER JOIN hrm_sales_hq_temp hqt ON hq.HqId=hqt.HqId INNER JOIN hrm_employee_general g ON hqt.EmployeeID=g.EmployeeID where ProductId=".$res['ProductId']." AND ArrgStatus='Y' AND HqTEmpStatus='A' AND (hqt.EmployeeID=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.")", $con); $rowChkP=mysql_fetch_assoc($sChk);
 }
 */
 //if($rowChkP>0 OR $P0p1!=0 OR $P0p2!=0 OR $P0p3!=0 OR $P0p4!=0 OR $Pp1!=0 OR $Pp2!=0 OR $Pp3!=0 OR $Pp4!=0 OR $resP4['Qa']!=0 OR $resP4['Qb']!=0 OR $resP4['Qc']!=0 OR $resP4['Qd']!=0 OR $resP5['Qa']!=0 OR $resP5['Qb']!=0 OR $resP5['Qc']!=0 OR $resP5['Qd']!=0){ ?>	
 ...
 <?php } ?>		 
  ...
  <input type="hidden" id="P_<?php echo $Sn; ?>" value="<?php echo $res['ProductId']; ?>" /></td>
  ...
  <td><input class="Input" id="M1_B<?php echo $Sn;?>" value="<?php if($resP4['Qa']!='' && $resP4['Qa']!=0){echo floatval($resP4['Qa']);} ?>" style="background-color:#D3FED7;" readonly/></td>
  <td><input class="Input" id="M1_C<?php echo $Sn;?>" value="<?php if($resP5['Qa']!='' && $resP5['Qa']!=0){echo floatval($resP5['Qa']);} ?>" style="background-color:#D3FED7;" readonly/></td>
  ...
  <td><input class="Input" id="M2_B<?php echo $Sn;?>" value="<?php if($resP4['Qb']!='' && $resP4['Qb']!=0){echo floatval($resP4['Qb']);} ?>" style="background-color:#D3FED7;" readonly/></td>
  <td><input class="Input" id="M2_C<?php echo $Sn;?>" value="<?php if($resP5['Qb']!='' && $resP5['Qb']!=0){echo floatval($resP5['Qb']);} ?>" style="background-color:#D3FED7;" readonly/></td> 
  ...
  <td><input class="Input" id="M3_B<?php echo $Sn;?>" value="<?php if($resP4['Qc']!='' && $resP4['Qc']!=0){echo floatval($resP4['Qc']);}?>" style="background-color:#D3FED7;" readonly/></td>
  <td><input class="Input" id="M3_C<?php echo $Sn;?>" value="<?php if($resP5['Qc']!='' && $resP5['Qc']!=0){echo floatval($resP5['Qc']);} ?>" style="background-color:#D3FED7;" readonly/></td> 
  ...
  <td><input class="Input" id="M4_B<?php echo $Sn;?>" value="<?php if($resP4['Qd']!='' AND $resP4['Qd']!=0){echo floatval($resP4['Qd']);} ?>" style="background-color:#D3FED7;" readonly/></td>
  <td><input class="Input" id="M4_C<?php echo $Sn;?>" value="<?php if($resP5['Qd']!='' AND $resP5['Qd']!=0){echo floatval($resP5['Qd']);} ?>" style="background-color:#D3FED7;" readonly/></td> 

<?php 
$TotP0=$P0p1+$P0p2+$P0p3+$P0p4; $TotP1=$Pp1+$Pp2+$Pp3+$Pp4;
$TotP4=$resP4['Qa']+$resP4['Qb']+$resP4['Qc']+$resP4['Qd']; $TotP5=$resP5['Qa']+$resP5['Qb']+$resP5['Qc']+$resP5['Qd']; 
?> 
  <td style="width:50px;"><input class="InputB" id="TotP0_<?php echo $Sn; ?>" value="<?php if($TotP0!=0 AND $TotP0!=''){echo $TotP0;}else{echo '';} ?>" readonly/></td> 
  <td style="width:50px;"><input class="InputB" id="TotP1_<?php echo $Sn; ?>" value="<?php if($TotP1!=0 AND $TotP1!=''){echo $TotP1;}else{echo '';} ?>" readonly/></td>
  <td style="width:50px;"><input class="InputB" id="TotP2_<?php echo $Sn; ?>" value="<?php if($TotP4!=0 AND $TotP4!=''){echo $TotP4;}else{echo '';} ?>" readonly/></td>
  <td style="width:50px;"><input class="InputB" id="TotP3_<?php echo $Sn; ?>" value="<?php if($TotP5!=0 AND $TotP5!=''){echo $TotP5;}else{echo '';} ?>" readonly/></td>	 

<?php
$SsqlP2=mysql_query("select Q1,Q2,Q3,Q4 from hrm_sales_sal_details_terr where TerrEmpID=".$EmployeeId." AND ProductId=".$res['ProductId']." AND YearId=".$_REQUEST['y'], $con); $SresP2=mysql_fetch_assoc($SsqlP2);
$SsqlP3=mysql_query("select Q1,Q2,Q3,Q4 from hrm_sales_sal_details_terr where TerrEmpID=".$EmployeeId." AND ProductId=".$res['ProductId']." AND YearId=".$AfterYId, $con); $SresP3=mysql_fetch_assoc($SsqlP3);
...
if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2' AND $_REQUEST['ac']!=1){
 ...
 //$sqlP0t=mysql_query("select SUM(M1) as tsM1,SUM(M2) as tsM2,SUM(M3) as tsM3,SUM(M4) as tsM4,SUM(M5) as tsM5,SUM(M6) as tsM6,SUM(M7) as tsM7,SUM(M8) as tsM8,SUM(M9) as tsM9,SUM(M10) as tsM10,SUM(M11) as tsM11,SUM(M12) as tsM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_hq_temp hqt ON d.HqId=hqt.HqId INNER JOIN hrm_employee_general g ON hqt.EmployeeID=g.EmployeeID where sp.ProductSts='A' AND HqTEmpStatus='A' AND (hqt.EmployeeID=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND d.DealerSts='A' AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$_REQUEST['y'], $con); 
 $sqlP0t=mysql_query("select SUM(M1) as tsM1,SUM(M2) as tsM2,SUM(M3) as tsM3,SUM(M4) as tsM4,SUM(M5) as tsM5,SUM(M6) as tsM6,SUM(M7) as tsM7,SUM(M8) as tsM8,SUM(M9) as tsM9,SUM(M10) as tsM10,SUM(M11) as tsM11,SUM(M12) as tsM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$joinD." where sp.ProductSts='A' AND (".$suvD." OR g.RepEmployeeID=".$EmployeeId.") AND d.DealerSts='A' AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$_REQUEST['y'], $con);
 $resP0t=mysql_fetch_assoc($sqlP0t);
 //$sqlP1t=mysql_query("select SUM(M1_Proj) as tsM1,SUM(M2_Proj) as tsM2,SUM(M3_Proj) as tsM3,SUM(M4_Proj) as tsM4,SUM(M5_Proj) as tsM5,SUM(M6_Proj) as tsM6,SUM(M7_Proj) as tsM7,SUM(M8_Proj) as tsM8,SUM(M9_Proj) as tsM9,SUM(M10_Proj) as tsM10,SUM(M11_Proj) as tsM11,SUM(M12_Proj) as tsM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_hq_temp hqt ON d.HqId=hqt.HqId INNER JOIN hrm_employee_general g ON hqt.EmployeeID=g.EmployeeID where sp.ProductSts='A' AND HqTEmpStatus='A' AND (hqt.EmployeeID=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND d.DealerSts='A' AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$AfterYId, $con); 
 $sqlP1t=mysql_query("select SUM(M1_Proj) as tsM1,SUM(M2_Proj) as tsM2,SUM(M3_Proj) as tsM3,SUM(M4_Proj) as tsM4,SUM(M5_Proj) as tsM5,SUM(M6_Proj) as tsM6,SUM(M7_Proj) as tsM7,SUM(M8_Proj) as tsM8,SUM(M9_Proj) as tsM9,SUM(M10_Proj) as tsM10,SUM(M11_Proj) as tsM11,SUM(M12_Proj) as tsM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$joinD." where sp.ProductSts='A' AND (".$suvD." OR g.RepEmployeeID=".$EmployeeId.") AND d.DealerSts='A' AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$AfterYId, $con);
...
$sqlP4t=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_seedsproduct sp ON sdh.ProductId=sp.ProductId where sp.ProductSts='A' AND sdh.HqRepEmpID=".$EmployeeId." AND sp.ItemId=".$_REQUEST['ii']." AND sdh.YearId=".$_REQUEST['y'], $con); $resP4t=mysql_fetch_assoc($sqlP4t);
$sqlP5t=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_seedsproduct sp ON sdh.ProductId=sp.ProductId where sp.ProductSts='A' AND sdh.HqRepEmpID=".$EmployeeId." AND sp.ItemId=".$_REQUEST['ii']." AND sdh.YearId=".$AfterYId, $con); $resP5t=mysql_fetch_assoc($sqlP5t);
...
?>
 <tr style="font-size:14px;color:#000000;background-color:#FFFFA6;height:24px;">
  ...
  <td><input class="TInput" id="TotP1_TB" value="<?php if($resP4t['Qa']!=0){echo floatval($resP4t['Qa']);} ?>" readonly/></td><td><input class="TInput" id="TotP1_TC" value="<?php if($resP5t['Qa']!=0){echo floatval($resP5t['Qa']);} ?>" readonly/></td>	  
  ...
  <td><input class="TInput" id="TotP2_TB" value="<?php if($resP4t['Qb']!=0){echo floatval($resP4t['Qb']);} ?>" readonly/></td><td><input class="TInput" id="TotP2_TC" value="<?php if($resP5t['Qb']!=0){echo floatval($resP5t['Qb']);} ?>" readonly/></td>	 	 
  ...
  <td><input class="TInput" id="TotP3_TB" value="<?php if($resP4t['Qc']!=0){echo floatval($resP4t['Qc']);} ?>" readonly/></td><td><input class="TInput" id="TotP3_TC" value="<?php if($resP5t['Qc']!=0){echo floatval($resP5t['Qc']);} ?>" readonly/></td>	 	 
  ...
  <td><input class="TInput" id="TotP4_TB" value="<?php if($resP4t['Qd']!=0){echo floatval($resP4t['Qd']);} ?>" readonly/></td><td><input class="TInput" id="TotP4_TC" value="<?php if($resP5t['Qd']!=0){echo floatval($resP5t['Qd']);} ?>" readonly/></td>	 	 	 
	 
<?php $TotP0t=$TotP0p1+$TotP0p2+$TotP0p3+$TotP0p4; $TotP1t=$TotPp1+$TotPp2+$TotPp3+$TotPp4; 
      $TotP4t=$resP4t['Qa']+$resP4t['Qb']+$resP4t['Qc']+$resP4t['Qd']; 
	  $TotP5t=$resP5t['Qa']+$resP5t['Qb']+$resP5t['Qc']+$resP5t['Qd']; ?>	  
  ...
  <td><input class="TInput" id="TotM_BeT" value="<?php if($TotP4t!=0){echo $TotP4t;}else{echo '';} ?>" readonly/></td>	 
  <td><input class="TInput" id="TotM_CeT" value="<?php if($TotP5t!=0){echo $TotP5t;}else{echo '';} ?>" readonly/></td>
	  
<?php
$TSsqlP2=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr sdt INNER JOIN hrm_sales_seedsproduct sp ON sdt.ProductId=sp.ProductId where sp.ProductSts='A' AND sdt.TerrEmpID=".$EmployeeId." AND sp.ItemId=".$_REQUEST['ii']." AND sdt.YearId=".$_REQUEST['y'], $con); $TSresP2=mysql_fetch_assoc($TSsqlP2);
$TSsqlP3=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr sdt INNER JOIN hrm_sales_seedsproduct sp ON sdt.ProductId=sp.ProductId where sp.ProductSts='A' AND sdt.TerrEmpID=".$EmployeeId." AND sp.ItemId=".$_REQUEST['ii']." AND sdt.YearId=".$AfterYId, $con); $TSresP3=mysql_fetch_assoc($TSsqlP3);
...
<?php //$sqlRepHq = mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married,hqt.HqId,HqName from hrm_employee_general g INNER JOIN hrm_sales_hq_temp hqt ON g.EmployeeID=hqt.EmployeeID INNER JOIN hrm_headquater hq ON hqt.HqId=hq.HqId INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON hqt.EmployeeID=e.EmployeeID where (hqt.EmployeeID=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND g.DepartmentId=6 AND hqt.HqTEmpStatus='A' group by e.EmployeeID order by g.EmployeeID ASC", $con); 
$sqlRepHq = mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married,".$slqry.",HqName from hrm_employee_general g INNER JOIN hrm_sales_dealer d ON ".$joinD." INNER JOIN hrm_headquater hq ON ".$joinD2." INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON ".$joinD3." where (".$suvD." OR g.RepEmployeeID=".$EmployeeId.") AND e.EmpStatus='A' AND g.DepartmentId=6 AND d.DealerSts='A' group by e.EmployeeID order by g.EmployeeID ASC", $con);

$resRepHqRow=mysql_num_rows($sqlRepHq); 
      $DealRow=$resRepHqRow; echo '<input type="hidden" id="DealRows" value="'.$DealRow.'" />'; $counter=1; 
...
<?php 
if($_REQUEST['vc']>0){ $shqt="Hq_vc"; $sqq="Hq_vc as HqId"; $suuD="Terr_vc=".$HqEmpId; }
 elseif($_REQUEST['fc']>0){ $shqt="Hq_fc"; $sqq="Hq_fc as HqId"; $suuD="Terr_fc=".$HqEmpId; }	

$sHq2=mysql_query("select ".$sqq." from hrm_sales_dealer where ".$suuD." AND DealerSts='A' AND ".$shqt."!=".$HqId." group by ".$shqt." asc", $con); $rowHq2=mysql_num_rows($sHq2); echo '<input type="hidden" id="Rowhq2" value="'.$rowHq2.'" />';
if($rowHq2==1){$resHq2=mysql_fetch_assoc($sHq2); echo '<input type="hidden" id="h1q" value="'.$HqId.'" />';} ?>	   	  
<tr>
 <td style="width:100%;">
 <table border="1" cellpadding="0" cellspacing="0" style="font-family:Times New Roman;font-size:14px;width:100%;">
 <tr>
...
/*if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){$sql = mysql_query("select sp.ItemId,ProductId,ProductName,ItemName,TypeName from hrm_sales_seedsproduct sp INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_seedtype st ON sp.TypeId=st.TypeId where sp.ProductSts='A' AND si.ItemId=".$_REQUEST['ii']." order by ItemName ASC, TypeName ASC, ProductName ASC", $con);}
 ...
 if($_REQUEST['vc']>0){ $shq="d.Hq_vc"; $suuD="d.Terr_vc=".$HqEmpId; }
 elseif($_REQUEST['fc']>0){ $shq="d.Hq_fc"; $suuD="d.Terr_fc=".$HqEmpId; }	  
	  
 $Sn=1; while($res=mysql_fetch_array($sql)){ 
 
//$sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_hq_temp hqt ON d.HqId=hqt.HqId where HqTEmpStatus='A' AND (hqt.EmployeeID=".$HqEmpId." OR d.HqId=".$HqId.") AND d.DealerSts='A' AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$_REQUEST['y'], $con); 
$sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where (".$suuD." OR ".$shq."=".$HqId.") AND d.DealerSts='A' AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$_REQUEST['y'], $con); 

$rowP4d=mysql_num_rows($sqlP4d); $resP4d=mysql_fetch_assoc($sqlP4d);
...
//$sqlP5d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_hq_temp hqt ON d.HqId=hqt.HqId where HqTEmpStatus='A' AND (hqt.EmployeeID=".$HqEmpId." OR d.HqId=".$HqId.") AND d.DealerSts='A' AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$AfterYId,$con);
$sqlP5d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where (".$suuD." OR ".$shq."=".$HqId.") AND d.DealerSts='A' AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$AfterYId, $con);

$rowP5d=mysql_num_rows($sqlP5d); $resP5d=mysql_fetch_assoc($sqlP5d); 
...
$sqlP2d=mysql_query("select * from hrm_sales_sal_details_hq where HqEmpID=".$HqEmpId." AND HqId=".$HqId." AND ProductId=".$res['ProductId']." AND YearId=".$_REQUEST['y'], $con); $rowP2d=mysql_num_rows($sqlP2d); $resP2d=mysql_fetch_assoc($sqlP2d);
$sqlP3d=mysql_query("select * from hrm_sales_sal_details_hq where HqEmpID=".$HqEmpId." AND HqId=".$HqId." AND ProductId=".$res['ProductId']." AND YearId=".$AfterYId, $con); $rowP3d=mysql_num_rows($sqlP3d); $resP3d=mysql_fetch_assoc($sqlP3d);
 
$TotRchk=0; $rowChkP=0;
/*
if($rowP4d==0 OR $rowP5d==0 OR $rowP2d==0 OR $rowP3d==0) 
{
$sChk=mysql_query("select * from hrm_sales_arrange_prod sap INNER JOIN hrm_headquater hq ON sap.StateId=hq.StateId INNER JOIN hrm_sales_hq_temp hqt ON hq.HqId=hqt.HqId where ProductId=".$res['ProductId']." AND ArrgStatus='Y' AND HqTEmpStatus='A' AND hqt.EmployeeID=".$HqEmpId, $con); $rowChkP=mysql_fetch_assoc($sChk);
}
*/
 ...
 <?php } ?>		 
  <td bgcolor="#FFFFFF"><input class="Inputt" style="width:120px;" value="<?php echo $res['ProductName']; ?>" />
  <input type="hidden" id="<?php echo $HqId; ?>P_<?php echo $Sn; ?>" value="<?php echo $res['ProductId']; ?>" /></td>
  <td bgcolor="#FFFFFF" align="center" style="font-size:12px;"><?php echo substr_replace($res['TypeName'], '', 2); ?></td>
  ...
  <td><input class="Input" id="<?php echo $HqId.'M1a'.$Sn; ?>" value="<?php if($Ach4Q1!=0 AND $Ach4Q1!=0){echo $Ach4Q1;} ?>" readonly/></td><td><input class="Input" id="<?php echo $HqId.'M1b'.$Sn; ?>" value="<?php if($Ach5Q1!=0 AND $Ach5Q1!=0){echo $Ach5Q1;} ?>" readonly/></td>
  <td><input class="Input" id="<?php echo $HqId; ?>M1_Be<?php echo $Sn; ?>" value="<?php if($resP2d['Q1']!='' AND $resP2d['Q1']!=0){echo floatval($resP2d['Q1']);} ?>" style="background-color:#D3FED7;"/></td>
  <td><input class="Input" id="<?php echo $HqId; ?>M1_Ce<?php echo $Sn;?>" value="<?php if($resP3d['Q1']!='' AND $resP3d['Q1']!=0){echo floatval($resP3d['Q1']);}?>" style="background-color:#D3FED7;"/></td>	

  <td><input class="Input" id="<?php echo $HqId.'M2a'.$Sn; ?>" value="<?php if($Ach4Q2!='' AND $Ach4Q2!=0){echo $Ach4Q2;} ?>" readonly/></td><td><input class="Input" id="<?php echo $HqId.'M2b'.$Sn; ?>" value="<?php if($Ach5Q2!='' AND $Ach5Q2!=0){echo $Ach5Q2;}?>" readonly/></td>
  <td><input class="Input" id="<?php echo $HqId; ?>M2_Be<?php echo $Sn; ?>" value="<?php if($resP2d['Q2']!='' AND $resP2d['Q2']!=0){echo floatval($resP2d['Q2']);} ?>" style="background-color:#D3FED7;"/></td>
  <td><input class="Input" id="<?php echo $HqId; ?>M2_Ce<?php echo $Sn; ?>" value="<?php if($resP3d['Q2']!='' AND $resP3d['Q2']!=0){echo floatval($resP3d['Q2']);}?>" style="background-color:#D3FED7;"/></td>	 

  <td><input class="Input" id="<?php echo $HqId.'M3a'.$Sn; ?>" value="<?php if($Ach4Q3!='' AND $Ach4Q3!=0){echo $Ach4Q3;} ?>" readonly/></td><td><input class="Input" id="<?php echo $HqId.'M3b'.$Sn; ?>" value="<?php if($Ach5Q3!='' AND $Ach5Q3!=0){echo $Ach5Q3;} ?>" readonly/></td>	
  <td><input class="Input" id="<?php echo $HqId; ?>M3_Be<?php echo $Sn; ?>" value="<?php if($resP2d['Q3']!='' AND $resP2d['Q3']!=0){echo floatval($resP2d['Q3']);} ?>" style="background-color:#D3FED7;"/></td>
  <td><input class="Input" id="<?php echo $HqId; ?>M3_Ce<?php echo $Sn; ?>" value="<?php if($resP3d['Q3']!='' AND $resP3d['Q3']!=0){echo floatval($resP3d['Q3']);}?>" style="background-color:#D3FED7;"/></td>	 

  <td><input class="Input" id="<?php echo $HqId.'M4a'.$Sn; ?>" value="<?php if($Ach4Q4!='' AND $Ach4Q4!=0){echo $Ach4Q4;} ?>" readonly/></td><td><input class="Input" id="<?php echo $HqId.'M4b'.$Sn; ?>" value="<?php if($Ach5Q4!='' AND $Ach5Q4!=0){echo $Ach5Q4;} ?>" readonly/></td>
  <td><input class="Input" id="<?php echo $HqId; ?>M4_Be<?php echo $Sn; ?>" value="<?php if($resP2d['Q4']!='' AND $resP2d['Q4']!=0){echo floatval($resP2d['Q4']);} ?>" style="background-color:#D3FED7;"/></td>
  <td><input class="Input" id="<?php echo $HqId; ?>M4_Ce<?php echo $Sn; ?>" value="<?php if($resP3d['Q4']!='' AND $resP3d['Q4']!=0){echo floatval($resP3d['Q4']);}?>" style="background-color:#D3FED7;"/></td>	 	
<?php  
  $TotP4d=$Ach4Q1+$Ach4Q2+$Ach4Q3+$Ach4Q4;  $TotP5d=$Ach5Q1+$Ach5Q2+$Ach5Q3+$Ach5Q4; 
  $TotP2d=$resP2d['Q1']+$resP2d['Q2']+$resP2d['Q3']+$resP2d['Q4']; 
  $TotP3d=$resP3d['Q1']+$resP3d['Q2']+$resP3d['Q3']+$resP3d['Q4']; ?>	
	  
  <td><input class="InputB" id="<?php echo $HqId.'MTota'.$Sn; ?>" value="<?php if($TotP4d!=0 AND $TotP4d!=''){echo $TotP4d;}else{echo '';} ?>" readonly/></td><td><input class="InputB" id="<?php echo $HqId.'MTotb'.$Sn; ?>" value="<?php if($TotP5d!=0 AND $TotP5d!=''){echo $TotP5d;}else{echo '';} ?>" readonly/></td>	
  <td><input class="InputB" id="<?php echo $HqId; ?>TotP2d_<?php echo $Sn; ?>" value="<?php if($TotP2d!=0 AND $TotP2d!=''){echo $TotP2d;}else{echo '';} ?>" readonly/></td>
  <td><input class="InputB" id="<?php echo $HqId; ?>TotP3d_<?php echo $Sn; ?>" value="<?php if($TotP3d!=0 AND $TotP3d!=''){echo $TotP3d;}else{echo '';} ?>" readonly/></td>	 
 </tr>	
<?php //} //if($rowChkP>0 OR $rowP4d>0 OR $rowP5d>0 OR $rowP2d>0 OR $rowP3d>0)
      $Sn++; }  ?>     
<?php 
...
if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){ 
 //$sqlP4td=mysql_query("select SUM(M1) as tsM1,SUM(M2) as tsM2,SUM(M3) as tsM3,SUM(M4) as tsM4,SUM(M5) as tsM5,SUM(M6) as tsM6,SUM(M7) as tsM7,SUM(M8) as tsM8,SUM(M9) as tsM9,SUM(M10) as tsM10,SUM(M11) as tsM11,SUM(M12) as tsM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_hq_temp hqt ON d.HqId=hqt.HqId where sp.ProductSts='A' AND HqTEmpStatus='A' AND (hqt.EmployeeID=".$HqEmpId." OR d.HqId=".$HqId.") AND d.DealerSts='A' AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$_REQUEST['y'], $con); 
 $sqlP4td=mysql_query("select SUM(M1) as tsM1,SUM(M2) as tsM2,SUM(M3) as tsM3,SUM(M4) as tsM4,SUM(M5) as tsM5,SUM(M6) as tsM6,SUM(M7) as tsM7,SUM(M8) as tsM8,SUM(M9) as tsM9,SUM(M10) as tsM10,SUM(M11) as tsM11,SUM(M12) as tsM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sp.ProductSts='A' AND (".$suuD." OR ".$shq."=".$HqId.") AND d.DealerSts='A' AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$_REQUEST['y'], $con); 
 $resP4td=mysql_fetch_assoc($sqlP4td);
...
$TotP4p3=$resP4td['tsM7']+$resP4td['tsM8']+$resP4td['tsM9']; $TotP4p4=$resP4td['tsM10']+$resP4td['tsM11']+$resP4td['tsM12'];
 ...
 //$sqlP5td=mysql_query("select SUM(M1_Proj) as tsM1,SUM(M2_Proj) as tsM2,SUM(M3_Proj) as tsM3,SUM(M4_Proj) as tsM4,SUM(M5_Proj) as tsM5,SUM(M6_Proj) as tsM6,SUM(M7_Proj) as tsM7,SUM(M8_Proj) as tsM8,SUM(M9_Proj) as tsM9,SUM(M10_Proj) as tsM10,SUM(M11_Proj) as tsM11,SUM(M12_Proj) as tsM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_hq_temp hqt ON d.HqId=hqt.HqId where sp.ProductSts='A' AND HqTEmpStatus='A' AND (hqt.EmployeeID=".$HqEmpId." OR d.HqId=".$HqId.") AND d.DealerSts='A' AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$AfterYId, $con);
 $sqlP5td=mysql_query("select SUM(M1_Proj) as tsM1,SUM(M2_Proj) as tsM2,SUM(M3_Proj) as tsM3,SUM(M4_Proj) as tsM4,SUM(M5_Proj) as tsM5,SUM(M6_Proj) as tsM6,SUM(M7_Proj) as tsM7,SUM(M8_Proj) as tsM8,SUM(M9_Proj) as tsM9,SUM(M10_Proj) as tsM10,SUM(M11_Proj) as tsM11,SUM(M12_Proj) as tsM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sp.ProductSts='A' AND (".$suuD." OR ".$shq."=".$HqId.") AND d.DealerSts='A' AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$AfterYId, $con); 
...
$TotP5p3=$resP5td['tsM7']+$resP5td['tsM8']+$resP5td['tsM9']; $TotP5p4=$resP5td['tsM10']+$resP5td['tsM11']+$resP5td['tsM12'];
 ...
 $sqlP2td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_seedsproduct sp ON sdh.ProductId=sp.ProductId where sp.ProductSts='A' AND sdh.HqEmpID=".$HqEmpId." AND sdh.HqId=".$HqId." AND sp.ItemId=".$_REQUEST['ii']." AND sdh.YearId=".$_REQUEST['y'], $con); $resP2td=mysql_fetch_assoc($sqlP2td); 
 $sqlP3td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_seedsproduct sp ON sdh.ProductId=sp.ProductId where sp.ProductSts='A' AND sdh.HqEmpID=".$HqEmpId." AND sdh.HqId=".$HqId." AND sp.ItemId=".$_REQUEST['ii']." AND sdh.YearId=".$AfterYId, $con); $resP3td=mysql_fetch_assoc($sqlP3td);
 ...
 <tr style="font-size:14px;color:#000000;background-color:#FFFFA6;height:24px;">
  ...
  <td><input class="TInput" id="<?php echo $HqId; ?>M1_BeT" value="<?php if($resP2td['Qa']!=0){echo floatval($resP2td['Qa']);} ?>" /></td><td><input class="TInput" id="<?php echo $HqId; ?>M1_CeT" value="<?php if($resP3td['Qa']!=0){echo floatval($resP3td['Qa']);} ?>" readonly/></td>	 	  
  ...
  <td><input class="TInput" id="<?php echo $HqId; ?>M2_BeT" value="<?php if($resP2td['Qb']!=0){echo floatval($resP2td['Qb']);} ?>" readonly/></td><td><input class="TInput" id="<?php echo $HqId; ?>M2_CeT" value="<?php if($resP3td['Qb']!=0){echo floatval($resP3td['Qb']);} ?>" readonly/></td>	 	 
  ...
  <td><input class="TInput" id="<?php echo $HqId; ?>M3_BeT" value="<?php if($resP2td['Qc']!=0){echo floatval($resP2td['Qc']);} ?>" readonly/></td><td><input class="TInput" id="<?php echo $HqId; ?>M3_CeT" value="<?php if($resP3td['Qc']!=0){echo floatval($resP3td['Qc']);} ?>" readonly/></td>	 	  
  ...
  <td><input class="TInput" id="<?php echo $HqId; ?>M4_BeT" value="<?php if($resP2td['Qd']!=0){echo floatval($resP2td['Qd']);} ?>" readonly/></td><td><input class="TInput" id="<?php echo $HqId; ?>M4_CeT" value="<?php if($resP3td['Qd']!=0){echo floatval($resP3td['Qd']);} ?>" readonly/></td>	 	 

<?php $TotP4td=$TotP4p1+$TotP4p2+$TotP4p3+$TotP4p4; $TotP5td=$TotP5p1+$TotP5p2+$TotP5p3+$TotP5p4; 
      $TotP2td=$resP2td['Qa']+$resP2td['Qb']+$resP2td['Qc']+$resP2td['Qd']; 
      $TotP3td=$resP3td['Qa']+$resP3td['Qb']+$resP3td['Qc']+$resP3td['Qd']; ?>    

  <td><input class="TbInput" value="<?php if($TotP4td!=0 AND $TotP4td!=''){echo $TotP4td;}else{echo '';} ?>" readonly/></td>
  <td><input class="TbInput" value="<?php if($TotP5td!=0 AND $TotP5td!=''){echo $TotP5td;}else{echo '';} ?>" readonly/></td>
  <td><input class="TbInput" id="<?php echo $HqId; ?>TotM_BeT" value="<?php if($TotP2td!=0 AND $TotP2td!=''){echo $TotP2td;}else{echo '';} ?>" readonly/></td><td><input class="TbInput" id="<?php echo $HqId; ?>TotM_CeT" value="<?php if($TotP3td!=0){echo $TotP3td;}else{echo '';} ?>" readonly/></td>	 	  
 </tr>	
...
<?php /*** TeamLease Employee Open TeamLease Employee Open TeamLease Employee Open ***/ ?>
<?php /*** TeamLease Employee Open TeamLease Employee Open TeamLease Employee Open ***/ ?> 
<?php if($rtl>0){ ?>
<tr>
 <td style="width:100%;">
...
/*if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){$sql = mysql_query("select sp.ItemId,ProductId,ProductName,ItemName,TypeName from hrm_sales_seedsproduct sp INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_seedtype st ON sp.TypeId=st.TypeId where si.ItemId=".$_REQUEST['ii']." order by ItemName ASC, TypeName ASC, ProductName ASC", $con);}
 ...
 $sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_tlemp tl ON d.HqId=tl.TLHq where TLStatus='A' AND tl.TLRepId=".$HqEmpId." AND d.DealerSts='A' AND d.HqId=".$HqId." AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$_REQUEST['y'], $con); 
 $rowP4d=mysql_num_rows($sqlP4d); $resP4d=mysql_fetch_assoc($sqlP4d);
$Ach4Q1=$resP4d['sM1']+$resP4d['sM2']+$resP4d['sM3']; $Ach4Q2=$resP4d['sM4']+$resP4d['sM5']+$resP4d['sM6'];
$Ach4Q3=$resP4d['sM7']+$resP4d['sM8']+$resP4d['sM9']; $Ach4Q4=$resP4d['sM10']+$resP4d['sM11']+$resP4d['sM12'];

 $sqlP5d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_tlemp tl ON d.HqId=tl.TLHq where TLStatus='A' AND tl.TLRepId=".$HqEmpId." AND d.DealerSts='A' AND d.HqId=".$HqId." AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$AfterYId, $con);
 $rowP5d=mysql_num_rows($sqlP5d); $resP5d=mysql_fetch_assoc($sqlP5d);
$Ach5Q1=$resP5d['sM1']+$resP5d['sM2']+$resP5d['sM3']; $Ach5Q2=$resP5d['sM4']+$resP5d['sM5']+$resP5d['sM6'];
$Ach5Q3=$resP5d['sM7']+$resP5d['sM8']+$resP5d['sM9']; $Ach5Q4=$resP5d['sM10']+$resP5d['sM11']+$resP5d['sM12'];

$sqlP2d=mysql_query("select * from hrm_sales_sal_details_hq where HqId=".$HqId." AND ProductId=".$res['ProductId']." AND YearId=".$_REQUEST['y'], $con); $rowP2d=mysql_num_rows($sqlP2d); $resP2d=mysql_fetch_assoc($sqlP2d);
$sqlP3d=mysql_query("select * from hrm_sales_sal_details_hq where HqId=".$HqId." AND ProductId=".$res['ProductId']." AND YearId=".$AfterYId, $con); $rowP3d=mysql_num_rows($sqlP3d); $resP3d=mysql_fetch_assoc($sqlP3d);
 
$TotRchk=0;
/*
if($rowP4d==0 OR $rowP5d==0 OR $rowP2d==0 OR $rowP3d==0)
{ 
 $sChk=mysql_query("select * from hrm_sales_arrange_prod sap INNER JOIN hrm_headquater hq ON sap.StateId=hq.StateId INNER JOIN hrm_sales_tlemp tl ON hq.HqId=tl.TLHq where TLStatus='A' AND ProductId=".$res['ProductId']." AND ArrgStatus='Y' AND tl.TLHq=".$HqId, $con); $rowChkP=mysql_num_rows($sChk);
}
*/
//if($rowChkP>0 OR $Ach4Q1!=0 OR $Ach4Q2!=0 OR $Ach4Q3!=0 OR $Ach4Q4!=0 OR $Ach5Q1!=0 OR $Ach5Q2!=0 OR $Ach5Q3!=0 OR $Ach5Q4!=0 OR $resP2d['Q1']!=0 OR $resP2d['Q2']!=0 OR $resP2d['Q3']!=0 OR $resP2d['Q4']!=0 OR $resP3d['Q1']!=0 OR $resP3d['Q2']!=0 OR $resP3d['Q3']!=0 OR $resP3d['Q4']!=0){ ?>	  
 <tr bgcolor="#EEEEEE" style="height:22px;">
  ...
  <td bgcolor="#FFFFFF"><input class="Inputt" style="width:100px;" value="<?php echo $res['ItemName']; ?>"/></td>
  <?php } ?>		 
  <td bgcolor="#FFFFFF"><input class="Inputt" style="width:120px;" value="<?php echo $res['ProductName']; ?>" /><input type="hidden" id="<?php echo $HqId; ?>P_<?php echo $Sn; ?>" value="<?php echo $res['ProductId']; ?>" /></td>
  <td bgcolor="#FFFFFF" align="center" style="font-size:12px;"><?php echo substr_replace($res['TypeName'], '', 2); ?></td>
  <td align="center" valign="middle" bgcolor="#FFFFFF">
  <?php if($_SESSION['EditPerMi']=='Y' AND $EntP=='Y'){ ?>
  <?php if($rowSubEmp==0){ ?>
  ...
  <td><input class="Input" id="<?php echo $HqId.'M3a'.$Sn; ?>" value="<?php if($Ach4Q3!='' AND $Ach4Q3!=0){echo $Ach4Q3;} ?>" readonly/></td>
  <td><input class="Input" id="<?php echo $HqId.'M3b'.$Sn; ?>" value="<?php if($Ach5Q3!='' AND $Ach5Q3!=0){echo $Ach5Q3;} ?>" readonly/></td>	
  <td><input class="Input" id="<?php echo $HqId; ?>M3_Be<?php echo $Sn; ?>" value="<?php if($resP2d['Q3']!='' AND $resP2d['Q3']!=0){echo floatval($resP2d['Q3']);} ?>" style="background-color:#D3FED7;"/></td>
  <td><input class="Input" id="<?php echo $HqId; ?>M3_Ce<?php echo $Sn; ?>" value="<?php if($resP3d['Q3']!='' AND $resP3d['Q3']!=0){echo floatval($resP3d['Q3']);}?>" style="background-color:#D3FED7;"/></td>	 
...
<?php //} //if($rowChkP>0 OR $rowP4d>0 OR $rowP5d>0 OR $rowP2d>0 OR $rowP3d>0) 
      $Sn++; }  ?>     
<?php if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){ 
$sqlP4td=mysql_query("select SUM(M1) as tsM1,SUM(M2) as tsM2,SUM(M3) as tsM3,SUM(M4) as tsM4,SUM(M5) as tsM5,SUM(M6) as tsM6,SUM(M7) as tsM7,SUM(M8) as tsM8,SUM(M9) as tsM9,SUM(M10) as tsM10,SUM(M11) as tsM11,SUM(M12) as tsM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_tlemp tl ON d.HqId=tl.TLHq where sp.ProductSts='A' AND TLStatus='A' AND tl.TLRepId=".$HqEmpId." AND d.HqId=".$HqId." AND d.DealerSts='A' AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$_REQUEST['y'], $con); 
$resP4td=mysql_fetch_assoc($sqlP4td);
$TotP4p1=$resP4td['tsM1']+$resP4td['tsM2']+$resP4td['tsM3']; $TotP4p2=$resP4td['tsM4']+$resP4td['tsM5']+$resP4td['tsM6'];
$TotP4p3=$resP4td['tsM7']+$resP4td['tsM8']+$resP4td['tsM9']; $TotP4p4=$resP4td['tsM10']+$resP4td['tsM11']+$resP4td['tsM12'];

$sqlP5td=mysql_query("select SUM(M1_Proj) as tsM1,SUM(M2_Proj) as tsM2,SUM(M3_Proj) as tsM3,SUM(M4_Proj) as tsM4,SUM(M5_Proj) as tsM5,SUM(M6_Proj) as tsM6,SUM(M7_Proj) as tsM7,SUM(M8_Proj) as tsM8,SUM(M9_Proj) as tsM9,SUM(M10_Proj) as tsM10,SUM(M11_Proj) as tsM11,SUM(M12_Proj) as tsM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_tlemp tl ON d.HqId=tl.TLHq where sp.ProductSts='A' AND TLStatus='A' AND tl.TLRepId=".$HqEmpId." AND d.HqId=".$HqId." AND d.DealerSts='A' AND sp.ItemId=".$_REQUEST['ii']." AND sd.YearId=".$AfterYId, $con); 
$resP5td=mysql_fetch_assoc($sqlP5td);
$TotP5p1=$resP5td['tsM1']+$resP5td['tsM2']+$resP5td['tsM3']; $TotP5p2=$resP5td['tsM4']+$resP5td['tsM5']+$resP5td['tsM6'];
$TotP5p3=$resP5td['tsM7']+$resP5td['tsM8']+$resP5td['tsM9']; $TotP5p4=$resP5td['tsM10']+$resP5td['tsM11']+$resP5td['tsM12'];

$sqlP2td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_seedsproduct sp ON sdh.ProductId=sp.ProductId where sp.ProductSts='A' AND sdh.HqId=".$HqId." AND sp.ItemId=".$_REQUEST['ii']." AND sdh.YearId=".$_REQUEST['y'], $con); $resP2td=mysql_fetch_assoc($sqlP2td); 
$sqlP3td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_seedsproduct sp ON sdh.ProductId=sp.ProductId where sp.ProductSts='A' AND sdh.HqId=".$HqId." AND sp.ItemId=".$_REQUEST['ii']." AND sdh.YearId=".$AfterYId, $con); $resP3td=mysql_fetch_assoc($sqlP3td);
...
<?php } //if($rtl) ?>
<?php /*** TeamLease Employee CLose TeamLease Employee CLose TeamLease Employee CLose ***/ ?> 
<?php /*** TeamLease Employee CLose TeamLease Employee CLose TeamLease Employee CLose ***/ ?> 
