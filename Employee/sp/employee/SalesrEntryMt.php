...
{ var PId=document.getElementById(nhq+'_'+eId+'P_'+sn).value; var EId=document.getElementById('EmpId').value; 
  ...
  var url = 'SlctSalesProdDealRevMt.php';  var pars = 'Action=AddMonth&p='+PId+'&e='+EId+'&m1B='+n1B+'&m2B='+n2B+'&m3B='+n3B+'&m4B='+n4B+'&m1C='+n1C+'&m2C='+n2C+'&m3C='+n3C+'&m4C='+n4C+'&TotA='+TotA+'&TotB='+TotB+'&TotC='+TotC+'&yi='+yi+'&eId='+eId+'&sn='+sn+'&hi='+hq+'&ii='+ii+'&rn='+rn+'&gi='+gi+'&c='+ComId+'&nhq='+nhq;     
...
/*if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2' AND $_REQUEST['ii']!=0){$sql = mysql_query("select sp.ItemId,ProductId,ProductName,ItemName,TypeName from hrm_sales_seedsproduct sp INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_seedtype st ON sp.TypeId=st.TypeId where sp.ProductSts='A' AND si.ItemId=".$_REQUEST['ii']." order by ItemName ASC, TypeName ASC, ProductName ASC", $con);}
 ...
 $TotP2a=$resP2['Qa']+$resP2a['Qa']+$resP2b['Qa']+$resP2c['Qa']+$resP2d['Qa']; 
 $TotP2b=$resP2['Qb']+$resP2a['Qb']+$resP2b['Qb']+$resP2c['Qb']+$resP2d['Qb']; 
 $TotP2c=$resP2['Qc']+$resP2a['Qc']+$resP2b['Qc']+$resP2c['Qc']+$resP2d['Qc']; 
 $TotP2d=$resP2['Qd']+$resP2a['Qd']+$resP2b['Qd']+$resP2c['Qd']+$resP2d['Qd'];
 $TotP3a=$resP3['Qa']+$resP3a['Qa']+$resP3b['Qa']+$resP3c['Qa']+$resP3d['Qa']; 
 $TotP3b=$resP3['Qb']+$resP3a['Qb']+$resP3b['Qb']+$resP3c['Qb']+$resP3d['Qb']; 
 $TotP3c=$resP3['Qc']+$resP3a['Qc']+$resP3b['Qc']+$resP3c['Qc']+$resP3d['Qc']; 
 $TotP3d=$resP3['Qd']+$resP3a['Qd']+$resP3b['Qd']+$resP3c['Qd']+$resP3d['Qd'];
...
<?php if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2' AND $_REQUEST['ac']!=1){ 
 ...
 $TotP2ta=$resP2t['Qa']+$resP2ta['Qa']+$resP2tb['Qa']+$resP2tc['Qa']+$resP2td['Qa']; 
 $TotP2tb=$resP2t['Qb']+$resP2ta['Qb']+$resP2tb['Qb']+$resP2tc['Qb']+$resP2td['Qb']; 
 $TotP2tc=$resP2t['Qc']+$resP2ta['Qc']+$resP2tb['Qc']+$resP2tc['Qc']+$resP2td['Qc']; 
 $TotP2td=$resP2t['Qd']+$resP2ta['Qd']+$resP2tb['Qd']+$resP2tc['Qd']+$resP2td['Qd'];
 $TotP3ta=$resP3t['Qa']+$resP3ta['Qa']+$resP3tb['Qa']+$resP3tc['Qa']+$resP3td['Qa']; 
 $TotP3tb=$resP3t['Qb']+$resP3ta['Qb']+$resP3tb['Qb']+$resP3tc['Qb']+$resP3td['Qb']; 
 $TotP3tc=$resP3t['Qc']+$resP3ta['Qc']+$resP3tb['Qc']+$resP3tc['Qc']+$resP3td['Qc']; 
 $TotP3td=$resP3t['Qd']+$resP3ta['Qd']+$resP3tb['Qd']+$resP3tc['Qd']+$resP3td['Qd'];
...
<?php //$sqlRepHq = mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married,GradeId,hqt.HqId,HqName from hrm_employee_general g INNER JOIN hrm_sales_hq_temp hqt ON g.EmployeeID=hqt.EmployeeID INNER JOIN hrm_headquater hq ON hqt.HqId=hq.HqId INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON hqt.EmployeeID=e.EmployeeID where (hqt.EmployeeID=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND g.DepartmentId=6 AND hqt.HqTEmpStatus='A' group by e.EmployeeID order by g.EmployeeID ASC", $con); 

if($EmployeeId==241){ $sqlRepHq = mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married,GradeId,g.HqId,HqName from hrm_employee_general g INNER JOIN hrm_headquater hq ON g.HqId=hq.HqId INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where g.RepEmployeeID=".$EmployeeId." AND g.DepartmentId=6 AND e.EmpStatus='A' group by e.EmployeeID order by g.EmployeeID ASC", $con); }
else
{ 
    $sqlRepHq = mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married,GradeId,g.HqId,HqName from hrm_employee_general g INNER JOIN hrm_headquater hq ON g.HqId=hq.HqId INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where g.RepEmployeeID=".$EmployeeId." AND g.DepartmentId=6 AND e.EmpStatus='A' group by e.EmployeeID order by g.EmployeeID ASC", $con);
//$sqlRepHq = mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married,GradeId,".$slqry.",HqName from hrm_employee_general g INNER JOIN hrm_sales_dealer d ON ".$joinD." INNER JOIN hrm_headquater hq ON ".$joinD2." INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON ".$joinD3." where (".$suvD." OR g.RepEmployeeID=".$EmployeeId.") AND e.EmpStatus='A' AND g.DepartmentId=6 AND d.DealerSts='A' group by e.EmployeeID order by g.EmployeeID ASC", $con); 
}
...
/*if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){$sql = mysql_query("select sp.ItemId,ProductId,ProductName,ItemName,TypeName from hrm_sales_seedsproduct sp INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_seedtype st ON sp.TypeId=st.TypeId where sp.ProductSts='A' AND si.ItemId=".$_REQUEST['ii']." order by ItemName ASC, TypeName ASC, ProductName ASC", $con);}
 ...
 { 
  ...
  if($rowRpt==0)
  {
      ...
      if($_REQUEST['vc']>0){$Cond="d.Terr_vc=".$HqEmpId;}
      elseif($_REQUEST['fc']>0){$Cond="d.Terr_fc=".$HqEmpId;} 
      
   $sql4ta=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where ".$Cond." AND sd.ProductId=".$res['ProductId']." AND d.DealerSts='A' AND sd.YearId=".$_REQUEST['y'], $con); $res4ta=mysql_fetch_assoc($sql4ta);
   $sql5ta=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where ".$Cond." AND sd.ProductId=".$res['ProductId']." AND d.DealerSts='A' AND sd.YearId=".$AfterYId, $con); 
   ...
   //$sChk=mysql_query("select * from hrm_sales_arrange_prod sap INNER JOIN hrm_headquater hq ON sap.StateId=hq.StateId where ProductId=".$res['ProductId']." AND ArrgStatus='Y' AND AND hq.HqId=".$HqId, $con);
  }
  else
  { 
  $sql4ta=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr where TerrRepEmpID=".$HqEmpId." AND ProductId=".$res['ProductId']." AND YearId=".$_REQUEST['y'], $con); $sql5ta=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr where TerrRepEmpID=".$HqEmpId." AND ProductId=".$res['ProductId']." AND YearId=".$AfterYId, $con); 
 ...
 { 
  ...
  $sql4ta=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where ".$Cond." AND sd.ProductId=".$res['ProductId']." AND d.DealerSts='A' AND sd.YearId=".$_REQUEST['y'], $con); 
  $sql5ta=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where ".$Cond." AND sd.ProductId=".$res['ProductId']." AND d.DealerSts='A' AND sd.YearId=".$AfterYId, $con); 
  $res4ta=mysql_fetch_assoc($sql4ta); $res5ta=mysql_fetch_assoc($sql5ta);
  $Ach4Q1=$res4ta['sM1']+$res4ta['sM2']+$res4ta['sM3']; $Ach4Q2=$res4ta['sM4']+$res4ta['sM5']+$res4ta['sM6'];
  $Ach4Q3=$res4ta['sM7']+$res4ta['sM8']+$res4ta['sM9']; $Ach4Q4=$res4ta['sM10']+$res4ta['sM11']+$res4ta['sM12'];
...
<?php if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){ 
 ...
 { 
  ...
  if($rowRpt==0)
  {
   ...
   $sql4ta2=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sp.ProductSts='A' AND ".$Cond." AND sp.ItemId=".$_REQUEST['ii']." AND d.DealerSts='A' AND sd.YearId=".$_REQUEST['y'], $con); 
   $sql5ta2=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sp.ProductSts='A' AND ".$Cond." AND sp.ItemId=".$_REQUEST['ii']." AND d.DealerSts='A' AND sd.YearId=".$AfterYId, $con); 
   $res4ta2=mysql_fetch_assoc($sql4ta2); $res5ta2=mysql_fetch_assoc($sql5ta2);
 ...
 { 
  ...
  if($_REQUEST['vc']>0){$Cond="d.Terr_vc=".$HqEmpId;}
      elseif($_REQUEST['fc']>0){$Cond="d.Terr_fc=".$HqEmpId;} 
  $sql4ta2=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sp.ProductSts='A' AND ".$Cond." AND sp.ItemId=".$_REQUEST['ii']." AND d.DealerSts='A' AND sd.YearId=".$_REQUEST['y'], $con); $res4ta2=mysql_fetch_assoc($sql4ta2);
  $sql5ta2=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sp.ProductSts='A' AND ".$Cond." AND sp.ItemId=".$_REQUEST['ii']." AND d.DealerSts='A' AND sd.YearId=".$AfterYId, $con); $res5ta2=mysql_fetch_assoc($sql5ta2);
  $Acht4Q1=$res4ta2['sM1']+$res4ta2['sM2']+$res4ta2['sM3']; $Acht4Q2=$res4ta2['sM4']+$res4ta2['sM5']+$res4ta2['sM6'];
  $Acht4Q3=$res4ta2['sM7']+$res4ta2['sM8']+$res4ta2['sM9']; $Acht4Q4=$res4ta2['sM10']+$res4ta2['sM11']+$res4ta2['sM12'];
  $Acht5Q1=$res5ta2['sM1']+$res5ta2['sM2']+$res5ta2['sM3']; $Acht5Q2=$res5ta2['sM4']+$res5ta2['sM5']+$res5ta2['sM6'];
  $Acht5Q3=$res5ta2['sM7']+$res5ta2['sM8']+$res5ta2['sM9']; $Acht5Q4=$res5ta2['sM10']+$res5ta2['sM11']+$res5ta2['sM12'];
...
/*if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){$sql = mysql_query("select sp.ItemId,ProductId,ProductName,ItemName,TypeName from hrm_sales_seedsproduct sp INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_seedtype st ON sp.TypeId=st.TypeId where si.ItemId=".$_REQUEST['ii']." order by ItemName ASC, TypeName ASC, ProductName ASC", $con);}
 ...
 if($resEgr['GradeValue']=='L1' OR $resEgr['GradeValue']=='L2')
 {
  $sqlP2d=mysql_query("select * from hrm_sales_sal_details_terr where TerrRepEmpID=".$EmployeeId." AND TerrEmpID=".$HqEmpId." AND TerrHqID=".$HqId." AND ProductId=".$res['ProductId']." AND YearId=".$_REQUEST['y'], $con); 
  $sqlP3d=mysql_query("select * from hrm_sales_sal_details_terr where TerrRepEmpID=".$EmployeeId." AND TerrEmpID=".$HqEmpId." AND TerrHqID=".$HqId." AND ProductId=".$res['ProductId']." AND YearId=".$AfterYId, $con);     
 }
 else
 {
...
<?php if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){ 
 ...
 if($resEgr['GradeValue']=='L1' OR $resEgr['GradeValue']=='L2')
 {
  $sqlP2td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr z INNER JOIN hrm_sales_seedsproduct sp ON z.ProductId=sp.ProductId where sp.ProductSts='A' AND TerrRepEmpID=".$EmployeeId." AND TerrEmpID=".$HqEmpId." AND TerrHqID=".$HqId." AND sp.ItemId=".$_REQUEST['ii']." AND YearId=".$_REQUEST['y'], $con); 
  $sqlP3td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr z INNER JOIN hrm_sales_seedsproduct sp ON z.ProductId=sp.ProductId where sp.ProductSts='A' AND TerrRepEmpID=".$EmployeeId." AND TerrEmpID=".$HqEmpId." AND TerrHqID=".$HqId." AND sp.ItemId=".$_REQUEST['ii']." AND YearId=".$AfterYId, $con);
 }
 else
 {
