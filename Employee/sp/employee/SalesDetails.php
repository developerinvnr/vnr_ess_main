...
{  
 var ccrp=document.getElementById("CropV").value;
 if(document.getElementById("CropV").value==0){alert("Please Select Crop Value"); return false; }
 else{ var ii=0; 
 if(ccrp==1){var vc=1; var fc=0;}else if(ccrp==2){var vc=0; var fc=1;}
 window.location="SalesDetails.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+document.getElementById("act").value+"&hq="+document.getElementById("hq").value+"&y="+document.getElementById("YearV").value+"&q="+document.getElementById("q").value+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+document.getElementById("cc").value+"&di="+document.getElementById("di").value+"&gi="+document.getElementById("gi").value+'&EHq='+document.getElementById("EHq").value+'&myh='+document.getElementById("myh").value+'&myt='+document.getElementById("myt").value+'&mainv='+v+'&crop='+document.getElementById("CropV").value; }
}
...
{ 
  $Gjoin='d.Terr_vc=g.EmployeeID';  $Wcond='d.Terr_vc='.$_REQUEST['mainv'];
  $Swjoin='Terr_vc='.$_REQUEST['mainv'];
}
elseif($_SESSION['Vertical']==15 || $_SESSION['Hqf']>0)
{
 $Gjoin='d.Terr_fc=g.EmployeeID'; $Wcond='d.Terr_fc='.$_REQUEST['mainv'];
...
else{ if($_REQUEST['crop']==1 OR $_REQUEST['crop']==2){ $qin="si.GroupId=".$_REQUEST['crop']; }else{ $qin='1=1'; } }
...
if($rtl>0)
{ 
  $sqlAta=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_tlemp tl ON d.HqId=tl.TLHq where TLStatus='A' AND tl.TLRepId=".$_REQUEST['mainv']." AND ".$qin." AND sp.ProductSts='A' AND sd.YearId=".$_REQUEST['y'], $con); 
  $resAta=mysql_fetch_assoc($sqlAta);
  $sqlBt=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_tlemp tl ON d.HqId=tl.TLHq where TLStatus='A' AND tl.TLRepId=".$_REQUEST['mainv']." AND sp.ProductSts='A' AND ".$qin." AND sd.YearId=".$AfterYId, $con); $resBta=mysql_fetch_assoc($sqlBta); 
}

$sql4tat=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr sdt INNER JOIN hrm_sales_seedsproduct sp ON sdt.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId where TerrRepEmpID=".$_REQUEST['mainv']." AND sp.ProductSts='A' AND ".$qin." AND YearId=".$_REQUEST['y'], $con); 
$sql5tat=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr sdt INNER JOIN hrm_sales_seedsproduct sp ON sdt.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId where TerrRepEmpID=".$_REQUEST['mainv']." AND sp.ProductSts='A' AND ".$qin." AND YearId=".$AfterYId, $con); 
$res4tat=mysql_fetch_assoc($sql4tat); $res5tat=mysql_fetch_assoc($sql5tat);
$sql4tbt=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_seedsproduct sp ON sdh.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId where HqRepEmpID=".$_REQUEST['mainv']." AND sp.ProductSts='A' AND ".$qin." AND YearId=".$_REQUEST['y'], $con); 
$sql5tbt=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_seedsproduct sp ON sdh.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId where HqRepEmpID=".$_REQUEST['mainv']." AND sp.ProductSts='A' AND ".$qin." AND YearId=".$AfterYId, $con); $res4tbt=mysql_fetch_assoc($sql4tbt); $res5tbt=mysql_fetch_assoc($sql5tbt); 

$sqlAt=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$Gnj." where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['mainv']." OR g.RepEmployeeID=".$_REQUEST['mainv'].") AND ".$qin." AND sp.ProductSts='A' AND sd.YearId=".$_REQUEST['y'], $con); 

$sqlBt=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$Gnj." where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['mainv']." OR g.RepEmployeeID=".$_REQUEST['mainv'].") AND sp.ProductSts='A' AND ".$qin." AND sd.YearId=".$AfterYId, $con); 
...
$sql4tat=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where DealerSts='A' AND ".$TerrCon."=".$_REQUEST['mainv']." AND ".$qin." AND sp.ProductSts='A' AND sd.YearId=".$_REQUEST['y'], $con); 
$sql5tat=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where DealerSts='A' AND ".$TerrCon."=".$_REQUEST['mainv']." AND sp.ProductSts='A' AND ".$qin." AND sd.YearId=".$AfterYId, $con); $res4tat=mysql_fetch_assoc($sql4tat); $res5tat=mysql_fetch_assoc($sql5tat); 

$sqlAt=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where DealerSts='A' AND ".$TerrCon."=".$_REQUEST['mainv']." AND ".$qin." AND sp.ProductSts='A' AND sd.YearId=".$_REQUEST['y'], $con); 
$resAt=mysql_fetch_assoc($sqlAt);
$sqlBt=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where DealerSts='A' AND ".$TerrCon."=".$_REQUEST['mainv']." AND sp.ProductSts='A' AND ".$qin." AND sd.YearId=".$AfterYId, $con); 
...
$sRevAt=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_seedsproduct sp ON sdh.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sdh.HqId=".HqCon." where ".TerrCon."=".$_REQUEST['mainv']." AND ".$qin." AND d.DealerSts='A' AND sp.ProductSts='A' AND YearId=".$_REQUEST['y'], $con); $sRevBt=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_seedsproduct sp ON sdh.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sdh.HqId=".HqCon." where ".TerrCon."=".$_REQUEST['mainv']." AND ".$qin." AND d.DealerSts='A' AND sp.ProductSts='A' AND YearId=".$AfterYId, $con); 
$rRevAt=mysql_fetch_assoc($sRevAt); $rRevBt=mysql_fetch_assoc($sRevBt);
...
$sql4ta=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['y']." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where DealerSts='A' AND ".$TerrCon."=".$_REQUEST['mainv']." AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$_REQUEST['y'], $con); 
$sql5ta=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where DealerSts='A' AND ".$TerrCon."=".$_REQUEST['mainv']." AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$AfterYId, $con); 
...
$sRevA=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_dealer d ON sdh.HqId=".$HqCon." where EmployeeID=".$_REQUEST['mainv']." AND ProductId=".$res['ProductId']." AND d.DealerSts='A' AND YearId=".$_REQUEST['y'], $con); 
$sRevB=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq sdh INNER JOIN hrm_sales_dealer d ON sdh.HqId=".$HqCon." where EmployeeID=".$_REQUEST['mainv']." AND ProductId=".$res['ProductId']." AND d.DealerSts='A' AND YearId=".$AfterYId, $con); 
$rRevA=mysql_fetch_assoc($sRevA); $rRevB=mysql_fetch_assoc($sRevB);
}
}
