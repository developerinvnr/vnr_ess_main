...
<?php /*************** NAME WISE NAME WISE  */ ?><?php /*************** NAME WISE NAME WISE  */ ?><?php /*************** NAME WISE NAME WISE  */ ?>
  <table>
   <tr>
	 ...
	 <?php if($_REQUEST['rpt']>0){ ?>
<?php $sZoneck=mysql_query("select * from hrm_sales_dealer where (Terr_vc=".$EmployeeId." OR Terr_fc=".$EmployeeId.") AND DealerSts='A'",$con); $rowZoneck=mysql_num_rows($sZoneck);
	 if($rowZoneck==0){$sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee ON g.EmployeeID=e.EmployeeID where g.RepEmployeeID=".$EmployeeId." AND g.DepartmentId=6 AND e.EmpStatus='A' order by Fname ASC", $con); }
	 elseif($rowZoneck>0){$sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where (g.EmployeeID=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND g.DepartmentId=6 AND e.EmpStatus='A' order by Fname ASC", $con);}
	  while($rName2=mysql_fetch_assoc($sName2)){ 
	 if($rName2['DR']=='Y'){$M='Dr.';} elseif($rName2['Gender']=='M'){$M='Mr.';} elseif($rName2['Gender']=='F' AND $rName2['Married']=='Y'){$M='Mrs.';} elseif($rName2['Gender']=='F' AND $rName2['Married']=='N'){$M='Miss.';} $Ename=$rName2['Fname'].' '.$rName2['Sname'].' '.$rName2['Lname']; ?>
	 <option value="<?php echo $rName2['EmployeeID']; ?>"><?php echo strtoupper($Ename); ?></option><?php } ?>
...
<?php $sqlRptZ=mysql_query("select g.EmployeeID from hrm_employee_general g INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where DepartmentId=6 AND e.EmpStatus='A' AND RepEmployeeID=".$_REQUEST['SelZone'], $con); $rowRptZ=mysql_num_rows($sqlRptZ); ?>	 
     <?php if($rowRptZ==0){ ?>
     <?php $sName=mysql_query("select Fname,Sname,Lname from hrm_employee e where EmployeeID=".$_REQUEST['SelZone'], $con); while($rName=mysql_fetch_assoc($sName)){ ?>
...
$sqlGE=mysql_query("select GradeId from hrm_employee_general g where DepartmentId=6 AND EmployeeID=".$_REQUEST['SelName'], $con); $resGE=mysql_fetch_assoc($sqlGE); ?>	 
     <?php if($rowRptN==0){ ?>
...
<?php $sZoneck=mysql_query("select * from hrm_sales_dealer where (Terr_vc=".$EmployeeId." OR Terr_fc=".$EmployeeId.") AND DealerSts='A'",$con); $rowZoneck=mysql_num_rows($sZoneck);
	 if($rowZoneck==0){$sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where g.RepEmployeeID=".$EmployeeId." AND g.DepartmentId=6 AND e.EmpStatus='A' order by Fname ASC", $con); }
	 elseif($rowZoneck>0){$sName2=mysql_query("select e.EmployeeID,Fname,Sname,Lname,Gender,DR,Married from hrm_employee_general g INNER JOIN hrm_employee_personal p ON g.EmployeeID=p.EmployeeID INNER JOIN hrm_employee e ON g.EmployeeID=e.EmployeeID where (g.EmployeeID=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND g.DepartmentId=6 AND hrm_employee.EmpStatus='A' order by Fname ASC", $con);}
	  while($rName2=mysql_fetch_assoc($sName2)){ 
	 if($rName2['DR']=='Y'){$M='Dr.';} elseif($rName2['Gender']=='M'){$M='Mr.';} elseif($rName2['Gender']=='F' AND $rName2['Married']=='Y'){$M='Mrs.';} elseif($rName2['Gender']=='F' AND $rName2['Married']=='N'){$M='Miss.';} $Ename=$rName2['Fname'].' '.$rName2['Sname'].' '.$rName2['Lname']; ?>
	 <option value="<?php echo $rName2['EmployeeID']; ?>"><?php echo strtoupper($Ename); ?></option><?php } ?>
...
{
 $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_headquater hq ON ".$Hqj." where hq.StateId=".$_REQUEST['SteName']." AND DealerSts='A' AND sd.YearId=".$yset." AND sp.ProductSts='A' AND ".$qin."", $con); 
}
elseif($_REQUEST['ZoneWise']>0)
{
 if($_REQUEST['SelZone']>0)
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['SelZone']." OR rl.R1=".$_REQUEST['SelZone']." OR rl.R2=".$_REQUEST['SelZone']." OR rl.R3=".$_REQUEST['SelZone']." OR rl.R4=".$_REQUEST['SelZone']." OR rl.R5=".$_REQUEST['SelZone'].") AND sd.YearId=".$yset." AND sp.ProductSts='A' AND ".$qin."", $con); 
 }
...
elseif($_REQUEST['HqWise']>0)
{
 if($_REQUEST['SelHq']>0)
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sd.YearId=".$yset." AND ".$qin." AND d.DealerSts='A' AND sp.ProductSts='A' AND ".$HqCon."=".$_REQUEST['SelHq']." ", $con);  
 }
 if($_REQUEST['SelHq']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$Gnj." where DealerSts='A' AND ".$HqCon."=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND sd.YearId=".$yset." AND sp.ProductSts='A' AND ".$qin."", $con); 
 }
...
{ 
 $sqlP1d=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_headquater hq ON ".$Hqj." where hq.StateId=".$_REQUEST['SteName']." AND sd.ProductId=".$res['ProductId']." AND d.DealerSts='A' AND sd.YearId=".$yset, $con); 
}
elseif($_REQUEST['ZoneWise']>0)
{ 
 if($_REQUEST['SelZone']>0)
 {
 $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['SelZone']." OR rl.R1=".$_REQUEST['SelZone']." OR rl.R2=".$_REQUEST['SelZone']." OR rl.R3=".$_REQUEST['SelZone']." OR rl.R4=".$_REQUEST['SelZone']." OR rl.R5=".$_REQUEST['SelZone'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con); 
 }
 if($_REQUEST['SelZone']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where d.DealerSts='A' AND (".$TerrCon."=".$EmployeeId." OR rl.R1=".$EmployeeId." OR rl.R2=".$EmployeeId." OR rl.R3=".$EmployeeId." OR rl.R4=".$EmployeeId." OR rl.R5=".$EmployeeId.") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con);
 }
}
elseif($_REQUEST['NameWise']>0)
{ 
 if($_REQUEST['SelName']>0)
 {
 $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['SelName']." OR rl.R1=".$_REQUEST['SelName']." OR rl.R2=".$_REQUEST['SelName']." OR rl.R3=".$_REQUEST['SelName']." OR rl.R4=".$_REQUEST['SelName']." OR rl.R5=".$_REQUEST['SelName'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con); 
 }
 if($_REQUEST['SelName']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where d.DealerSts='A' AND (".$TerrCon."=".$EmployeeId." OR rl.R1=".$EmployeeId." OR rl.R2=".$EmployeeId." OR rl.R3=".$EmployeeId." OR rl.R4=".$EmployeeId." OR rl.R5=".$EmployeeId.") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con);
...
{ 
 if($_REQUEST['SelHq']>0)
 {
 $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sd.YearId=".$yset." AND sd.ProductId=".$res['ProductId']." AND d.DealerSts='A' AND ".$HqCon."=".$_REQUEST['SelHq']."", $con); 
 }
 if($_REQUEST['SelHq']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$Gnj." where DealerSts='A' AND (".$TerrCon."=".$EmployeeId." OR g.RepEmployeeID=".$EmployeeId.") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con);
 }
}
elseif($_REQUEST['DisWise']>0)
