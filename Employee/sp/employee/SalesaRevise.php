...
{  
   ...
   window.location="SalesaRevise.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+'&EHq='+EHq+'&myh='+myh+'&myt='+myt+'&mainv='+v+'&crop='+crp+'&findV=AR'; }
}
...
$TotQ=$resA['sM1']+$resA['sM2']+$resA['sM3']; $TotRQ=$resR['M1']+$resR['M2']+$resR['M3']; $MyTot=$resB1['Qa']+$resB2['Qa']+$resB3['Qa'];  }
elseif($_REQUEST['q']==2){$tr1=$resA['sM4']; $tr2=$resA['sM5']; $tr3=$resA['sM6']; $trR1=$resR['M4']; $trR2=$resR['M5']; $trR3=$resR['M6']; 
$TotQ=$resA['sM4']+$resA['sM5']+$resA['sM6']; $TotRQ=$resR['M4']+$resR['M5']+$resR['M6']; $MyTot=$resB1['Qb']+$resB2['Qb']+$resB3['Qb']; }
elseif($_REQUEST['q']==3){$tr1=$resA['sM7']; $tr2=$resA['sM8']; $tr3=$resA['sM9']; $trR1=$resR['M7']; $trR2=$resR['M8']; $trR3=$resR['M9'];
$TotQ=$resA['sM7']+$resA['sM8']+$resA['sM9']; $TotRQ=$resR['M7']+$resR['M8']+$resR['M9']; $MyTot=$resB1['Qc']+$resB2['Qc']+$resB3['Qc']; }
elseif($_REQUEST['q']==4){$tr1=$resA['sM10']; $tr2=$resA['sM11']; $tr3=$resA['sM12']; $trR1=$resR['M10']; $trR2=$resR['M11']; $trR3=$resR['M12'];
$TotQ=$resA['sM10']+$resA['sM11']+$resA['sM12']; $TotRQ=$resR['M10']+$resR['M11']+$resR['M12']; $MyTot=$resB1['Qd']+$resB2['Qd']+$resB3['Qd']; }
...
$resAt=mysql_fetch_assoc($sqlAt); $resB1t=mysql_fetch_assoc($sqlB1t); $resB2t=mysql_fetch_assoc($sqlB2t); $resB3t=mysql_fetch_assoc($sqlB3t); $resRt=mysql_fetch_assoc($sqlRt);
if($_REQUEST['q']==1){$trt1=$resAt['sM1']; $trt2=$resAt['sM2']; $trt3=$resAt['sM3']; $trRt1=$resRt['sM1']; $trRt2=$resRt['sM2']; $trRt3=$resRt['sM3']; 
$TQt=$resAt['sM1']+$resAt['sM2']+$resAt['sM3']; $TQRt=$resRt['sM1']+$resRt['sM2']+$resRt['sM3']; $MyTt=$resB1t['Qa']+$resB2t['Qa']+$resB3t['Qa'];}
elseif($_REQUEST['q']==2){$trt1=$resAt['sM4']; $trt2=$resAt['sM5']; $trt3=$resAt['sM6']; $trRt1=$resRt['sM4']; $trRt2=$resRt['sM5']; $trRt3=$resRt['sM6'];
$TQt=$resAt['sM4']+$resAt['sM5']+$resAt['sM6']; $TQRt=$resRt['sM4']+$resRt['sM5']+$resRt['sM6']; $MyTt=$resB1t['Qb']+$resB2t['Qb']+$resB3t['Qb'];}
elseif($_REQUEST['q']==3){$trt1=$resAt['sM7']; $trt2=$resAt['sM8']; $trt3=$resAt['sM9']; $trRt1=$resRt['sM7']; $trRt2=$resRt['sM8']; $trRt3=$resRt['sM9']; 
$TQt=$resAt['sM7']+$resAt['sM8']+$resAt['sM9']; $TQRt=$resRt['sM7']+$resRt['sM8']+$resRt['sM9']; $MyTt=$resB1t['Qc']+$resB2t['Qc']+$resB3t['Qc'];}
elseif($_REQUEST['q']==4){$trt1=$resAt['sM10']; $trt2=$resAt['sM11']; $trt3=$resAt['sM12']; $trRt1=$resRt['sM10']; $trRt2=$resRt['sM11']; $trRt3=$resRt['sM12'];
$TQt=$resAt['sM10']+$resAt['sM11']+$resAt['sM12']; $TQRt=$resRt['sM10']+$resRt['sM11']+$resRt['sM12']; $MyTt=$resB1t['Qd']+$resB2t['Qd']+$resB3t['Qd'];}
