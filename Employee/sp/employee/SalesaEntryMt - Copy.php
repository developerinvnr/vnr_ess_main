...
function ChangeHq(hq,v,no)
{
  ...
  window.location="SalesaEntry.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+v+"&q="+q+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+'&EHq='+EHq+'&myh='+myh+'&myt='+myt+'&no='+no; 
}
...
else if(ii>0 && v=='vc'){window.location="SalesaEntryMt.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ii="+ii+"&vc=1&fc=0&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt; }
else if(ii>0 && v=='fc'){window.location="SalesaEntryMt.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ii="+ii+"&vc=0&fc=1&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt; }
else if(ii=='All_2' && v=='fc'){window.location="SalesaEntryMt.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ii="+ii+"&vc=0&fc=1&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt; }
}
...
function ClickAllProd(ii,v)
{
 var act=document.getElementById("act").value; var hq=document.getElementById("hq").value; var y=document.getElementById("y").value;
  ...
  var gi=document.getElementById("gi").value; var EHq=document.getElementById("EHq").value; 
  var myh=document.getElementById("myh").value; var myt=document.getElementById("myt").value;
  if(v=='ac'){window.location="SalesaEntryMt.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ac=1&vc=0&fc=0&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt+"&ii="+ii; }
}
...
function ChangePerMi(hq,v)
{
  ...
  window.location="SalesaEntryPerMi.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+v+"&q="+q+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+'&EHq='+EHq+'&myh='+myh+'&myt='+myt; 
}
...
{  
  ...
  var fc=document.getElementById("fc").value; var vc=document.getElementById("vc").value;
  var myh=document.getElementById("myh").value; var myt=document.getElementById("myt").value;
  window.location="SalesaEntryMt.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+v+"&q="+q+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt; 
}
...
{  
  ...
  var fc=document.getElementById("fc").value; var vc=document.getElementById("vc").value;
  var myh=document.getElementById("myh").value; var myt=document.getElementById("myt").value;
   window.location="SalesaEntryMt.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+v+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt;
}

function editD(sn,gi,e,nhq)
{ document.getElementById(nhq+"_"+e+"EditBtn_"+sn).style.display='none'; document.getElementById(nhq+"_"+e+"SaveBtn_"+sn).style.display='block'; 
  document.getElementById(nhq+"_"+e+"TM1_Ae"+sn).style.background='#FFFFFF';  document.getElementById(nhq+"_"+e+"TM1_Be"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M1_Be"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M1_Be"+sn).readOnly=false; document.getElementById(nhq+"_"+e+"TM1_Ce"+sn).style.background='#FFFFFF'; document.getElementById(nhq+"_"+e+"M1_Ce"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M1_Ce"+sn).readOnly=false; document.getElementById(nhq+"_"+e+"TM2_Ae"+sn).style.background='#FFFFFF'; document.getElementById(nhq+"_"+e+"TM2_Be"+sn).style.background='#FFFFFF'; document.getElementById(nhq+"_"+e+"M2_Be"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M2_Be"+sn).readOnly=false; document.getElementById(nhq+"_"+e+"TM2_Ce"+sn).style.background='#FFFFFF'; document.getElementById(nhq+"_"+e+"M2_Ce"+sn).style.background='#FFFFFF'; document.getElementById(nhq+"_"+e+"M2_Ce"+sn).readOnly=false; document.getElementById(nhq+"_"+e+"TM3_Ae"+sn).style.background='#FFFFFF';
  document.getElementById(nhq+"_"+e+"TM3_Be"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M3_Be"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M3_Be"+sn).readOnly=false;document.getElementById(nhq+"_"+e+"TM3_Ce"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M3_Ce"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M3_Ce"+sn).readOnly=false; document.getElementById(nhq+"_"+e+"TM4_Ae"+sn).style.background='#FFFFFF'; document.getElementById(nhq+"_"+e+"TM4_Be"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M4_Be"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M4_Be"+sn).readOnly=false;document.getElementById(nhq+"_"+e+"TM4_Ce"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M4_Ce"+sn).style.background='#FFFFFF';document.getElementById(nhq+"_"+e+"M4_Ce"+sn).readOnly=false; 
    
var M1B=parseFloat(document.getElementById(nhq+'_'+e+'M1_Be'+sn).value); var M2B=parseFloat(document.getElementById(nhq+'_'+e+'M2_Be'+sn).value); 
var M3B=parseFloat(document.getElementById(nhq+'_'+e+'M3_Be'+sn).value); var M4B=parseFloat(document.getElementById(nhq+'_'+e+'M4_Be'+sn).value); 
var M1C=parseFloat(document.getElementById(nhq+'_'+e+'M1_Ce'+sn).value); var M2C=parseFloat(document.getElementById(nhq+'_'+e+'M2_Ce'+sn).value); 
var M3C=parseFloat(document.getElementById(nhq+'_'+e+'M3_Ce'+sn).value); var M4C=parseFloat(document.getElementById(nhq+'_'+e+'M4_Ce'+sn).value);
var a1=parseFloat(document.getElementById(nhq+'_'+e+'M1a'+sn).value); var a2=parseFloat(document.getElementById(nhq+'_'+e+'M2a'+sn).value); 
var a3=parseFloat(document.getElementById(nhq+'_'+e+'M3a'+sn).value); var a4=parseFloat(document.getElementById(nhq+'_'+e+'M4a'+sn).value); 
var b1=parseFloat(document.getElementById(nhq+'_'+e+'M1b'+sn).value); var b2=parseFloat(document.getElementById(nhq+'_'+e+'M2b'+sn).value); 
var b3=parseFloat(document.getElementById(nhq+'_'+e+'M3b'+sn).value); var b4=parseFloat(document.getElementById(nhq+'_'+e+'M4b'+sn).value);
var T2=parseFloat(document.getElementById(nhq+"_"+e+"TotP2d_"+sn).value); var T3=parseFloat(document.getElementById(nhq+"_"+e+"TotP3d_"+sn).value); 
var Ta=parseFloat(document.getElementById(nhq+"_"+e+"MTota"+sn).value); var Tb=parseFloat(document.getElementById(nhq+"_"+e+"MTotb"+sn).value);

if(isNaN(a1)){var a11=0;}else{var a11=a1;} if(isNaN(M1B)){var M1BB=0;}else{var M1BB=M1B;} 
if(M1BB<a11){document.getElementById(nhq+"_"+e+"M1_Be"+sn).value=document.getElementById(nhq+"_"+e+"M1a"+sn).value;} 
if(isNaN(b1)){var b11=0;}else{var b11=b1;} if(isNaN(M1C)){var M1CC=0;}else{var M1CC=M1C;}
if(M1CC<b11){document.getElementById(nhq+"_"+e+"M1_Ce"+sn).value=document.getElementById(nhq+"_"+e+"M1b"+sn).value;}

if(isNaN(a2)){var a22=0;}else{var a22=a2;} if(isNaN(M2B)){var M2BB=0;}else{var M2BB=M2B;} 
if(M2BB<a22){document.getElementById(nhq+"_"+e+"M2_Be"+sn).value=document.getElementById(nhq+"_"+e+"M2a"+sn).value;}
if(isNaN(b2)){var b22=0;}else{var b22=b2;} if(isNaN(M2C)){var M2CC=0;}else{var M2CC=M2C;}
if(M2CC<b22){document.getElementById(nhq+"_"+e+"M2_Ce"+sn).value=document.getElementById(nhq+"_"+e+"M2b"+sn).value;}

if(isNaN(a3)){var a33=0;}else{var a33=a3;} if(isNaN(M3B)){var M3BB=0;}else{var M3BB=M3B;} 
if(M3BB<a33){document.getElementById(nhq+"_"+e+"M3_Be"+sn).value=document.getElementById(nhq+"_"+e+"M3a"+sn).value;}
if(isNaN(b3)){var b33=0;}else{var b33=b3;} if(isNaN(M3C)){var M3CC=0;}else{var M3CC=M3C;}
if(M3CC<b33){document.getElementById(nhq+"_"+e+"M3_Ce"+sn).value=document.getElementById(nhq+"_"+e+"M3b"+sn).value;}

if(isNaN(a4)){var a44=0;}else{var a44=a4;} if(isNaN(M4B)){var M4BB=0;}else{var M4BB=M4B;} 
if(M4BB<a44){document.getElementById(nhq+"_"+e+"M4_Be"+sn).value=document.getElementById(nhq+"_"+e+"M4a"+sn).value;}
if(isNaN(b4)){var b44=0;}else{var b44=b4;} if(isNaN(M4C)){var M4CC=0;}else{var M4CC=M4C;}
if(M4CC<b44){document.getElementById(nhq+"_"+e+"M4_Ce"+sn).value=document.getElementById(nhq+"_"+e+"M4b"+sn).value;}

if(isNaN(Ta)){var Taa=0;}else{var Taa=Ta;} if(isNaN(T2)){var T22=0;}else{var T22=T2;} 
if(T22<Taa){document.getElementById(nhq+"_"+e+"TotP2d_"+sn).value=document.getElementById(nhq+"_"+e+"MTota"+sn).value; }
if(isNaN(Tb)){var Tbb=0;}else{var Tbb=Tb;} if(isNaN(T3)){var T33=0;}else{var T33=T3;}
if(T33<Tbb){document.getElementById(nhq+"_"+e+"TotP3d_"+sn).value=document.getElementById(nhq+"_"+e+"MTotb"+sn).value; }

}


function saveD(sn,yi,gi,eId,rn,nhq)
{ var PId=document.getElementById(nhq+'_'+eId+'P_'+sn).value; var EId=document.getElementById('EmpId').value; var ii=document.getElementById('ii').value; 
  var hq=document.getElementById('hq').value; var ComId=document.getElementById('ComId').value; 
    
  var M1A=parseFloat(document.getElementById(nhq+'_'+eId+'M1_Ae'+sn).value); var M2A=parseFloat(document.getElementById(nhq+'_'+eId+'M2_Ae'+sn).value); 
  var M3A=parseFloat(document.getElementById(nhq+'_'+eId+'M3_Ae'+sn).value); var M4A=parseFloat(document.getElementById(nhq+'_'+eId+'M4_Ae'+sn).value); 
  var M1B=parseFloat(document.getElementById(nhq+'_'+eId+'M1_Be'+sn).value); var M2B=parseFloat(document.getElementById(nhq+'_'+eId+'M2_Be'+sn).value); 
  var M3B=parseFloat(document.getElementById(nhq+'_'+eId+'M3_Be'+sn).value); var M4B=parseFloat(document.getElementById(nhq+'_'+eId+'M4_Be'+sn).value); 
  var M1C=parseFloat(document.getElementById(nhq+'_'+eId+'M1_Ce'+sn).value); var M2C=parseFloat(document.getElementById(nhq+'_'+eId+'M2_Ce'+sn).value); 
  var M3C=parseFloat(document.getElementById(nhq+'_'+eId+'M3_Ce'+sn).value); var M4C=parseFloat(document.getElementById(nhq+'_'+eId+'M4_Ce'+sn).value); 
  var Mn1A=document.getElementById(nhq+'_'+eId+'M1_Ae'+sn).value; var Mn2A=document.getElementById(nhq+'_'+eId+'M2_Ae'+sn).value; 
  var Mn3A=document.getElementById(nhq+'_'+eId+'M3_Ae'+sn).value; var Mn4A=document.getElementById(nhq+'_'+eId+'M4_Ae'+sn).value; 
  var Mn1B=document.getElementById(nhq+'_'+eId+'M1_Be'+sn).value; var Mn2B=document.getElementById(nhq+'_'+eId+'M2_Be'+sn).value; 
  var Mn3B=document.getElementById(nhq+'_'+eId+'M3_Be'+sn).value; var Mn4B=document.getElementById(nhq+'_'+eId+'M4_Be'+sn).value;
  var Mn1C=document.getElementById(nhq+'_'+eId+'M1_Ce'+sn).value; var Mn2C=document.getElementById(nhq+'_'+eId+'M2_Ce'+sn).value; 
  var Mn3C=document.getElementById(nhq+'_'+eId+'M3_Ce'+sn).value; var Mn4C=document.getElementById(nhq+'_'+eId+'M4_Ce'+sn).value;    
  ...
  document.getElementById("Sno").value=sn; document.getElementById("MainSelTerrId").value=eId;  document.getElementById("sgi").value=gi; document.getElementById("nhq").value=nhq; 
...
{ document.getElementById('AddMonthResult').innerHTML = originalRequest.responseText; var Sno=document.getElementById('Sno').value; var ii=document.getElementById('ii').value;
  var eId=document.getElementById('MainSelTerrId').value; var gi=document.getElementById('sgi').value; var nhq=document.getElementById('nhq').value;
  ...
  document.getElementById(nhq+'_'+eId+'TM1_Ae'+Sno).style.background='#E0FFC1'; document.getElementById(nhq+'_'+eId+'TM2_Ae'+Sno).style.background='#E0FFC1'; 
  document.getElementById(nhq+'_'+eId+'TM3_Ae'+Sno).style.background='#E0FFC1'; document.getElementById(nhq+'_'+eId+'TM4_Ae'+Sno).style.background='#E0FFC1'; 
  document.getElementById(nhq+'_'+eId+'TM1_Be'+Sno).style.background='#E0FFC1'; document.getElementById(nhq+'_'+eId+'TM2_Be'+Sno).style.background='#E0FFC1'; 
  document.getElementById(nhq+'_'+eId+'TM3_Be'+Sno).style.background='#E0FFC1'; document.getElementById(nhq+'_'+eId+'TM4_Be'+Sno).style.background='#E0FFC1'; 
  document.getElementById(nhq+'_'+eId+'TM1_Ce'+Sno).style.background='#E0FFC1'; document.getElementById(nhq+'_'+eId+'TM2_Ce'+Sno).style.background='#E0FFC1'; 
  document.getElementById(nhq+'_'+eId+'TM3_Ce'+Sno).style.background='#E0FFC1'; document.getElementById(nhq+'_'+eId+'TM4_Ce'+Sno).style.background='#E0FFC1'; 
  document.getElementById(nhq+'_'+eId+'M1_Be'+Sno).style.background='#E0FFC1'; document.getElementById(nhq+'_'+eId+'M2_Be'+Sno).style.background='#E0FFC1'; 
  document.getElementById(nhq+'_'+eId+'M3_Be'+Sno).style.background='#E0FFC1'; document.getElementById(nhq+'_'+eId+'M4_Be'+Sno).style.background='#E0FFC1'; 
  document.getElementById(nhq+'_'+eId+'M1_Ce'+Sno).style.background='#E0FFC1';  document.getElementById(nhq+'_'+eId+'M2_Ce'+Sno).style.background='#E0FFC1'; 
  document.getElementById(nhq+'_'+eId+'M3_Ce'+Sno).style.background='#E0FFC1'; document.getElementById(nhq+'_'+eId+'M4_Ce'+Sno).style.background='#E0FFC1';
  ...
  document.getElementById(nhq+"_"+eId+"EditBtn_"+Sno).style.display='block';  document.getElementById(nhq+"_"+eId+"SaveBtn_"+Sno).style.display='none'; 
...
{  
   ...
   var timer = setInterval( function() { if(win.closed) { clearInterval(timer);  window.location="SalesaEntryMt.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ii=0&vc=0&fc=0&ac=1&cc="+cc+"&di="+di+"&gi="+gi+'&EHq='+EHq+'&myh='+myh+'&myt='+myt; } }, 1000);
}
</script>  
</head>
<body class="body">   
...
<input type="hidden" id="sgi" value="" /><input type="hidden" id="nhq" value="" />
...
<?php } elseif($rowHq2==1){ $resHq2=mysql_fetch_assoc($sHq2); ?><a href="#" onClick="ChangeHq(<?php echo $resSpP['HqId'].', '.$_REQUEST['y'].',1'; ?>)"><img src="images/My1hq.png" border="0" style="height:30px;width:130px;"  /></a>&nbsp;<a href="#" onClick="ChangeHq(<?php echo $resHq2['HqId'].', '.$_REQUEST['y'].',2'; ?>)"><img src="images/My2hq.png" border="0" style="height:30px;width:130px;"  /></a>
<?php } ?>
</td>
<?php /*
<td align="center" valign="bottom">
...
$SsqlP0=mysql_query("select Q1,Q2,Q3,Q4 from hrm_sales_sal_details_region where RegionEmpID=".$EmployeeId." AND ProductId=".$res['ProductId']." AND YearId=".$Before2YId, $con);
$SsqlP1=mysql_query("select Q1,Q2,Q3,Q4 from hrm_sales_sal_details_region where RegionEmpID=".$EmployeeId." AND ProductId=".$res['ProductId']." AND YearId=".$BeforeYId, $con); 
...
$resP2t=mysql_fetch_assoc($sqlP2t); $resP3t=mysql_fetch_assoc($sqlP3t);
...
$sqlP3ta=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_hq.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_hq.HqRepEmpID=".$EmployeeId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_hq.YearId=".$AfterYId, $con);  
$resP2ta=mysql_fetch_assoc($sqlP2ta); $resP3ta=mysql_fetch_assoc($sqlP3ta);
...
<?php if($resSpEG['GradeValue']=='M2' OR $resSpEG['GradeValue']=='M3'){
$TSsqlP0=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_area INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_area.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_area.AreaEmpID=".$EmployeeId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_area.YearId=".$Before2YId, $con); 
$TSsqlP1=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_area INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_area.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_area.AreaEmpID=".$EmployeeId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_area.YearId=".$BeforeYId, $con); 
$TSsqlP2=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_area INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_area.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_area.AreaEmpID=".$EmployeeId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_area.YearId=".$_REQUEST['y'], $con); 
$TSsqlP3=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_area INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_area.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_area.AreaEmpID=".$EmployeeId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_area.YearId=".$AfterYId, $con); 
} elseif($resSpEG['GradeValue']=='M4' OR $resSpEG['GradeValue']=='M5'){
$TSsqlP0=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_region INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_region.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_region.RegionEmpID=".$EmployeeId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_region.YearId=".$Before2YId, $con); 
$TSsqlP1=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_region INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_region.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_region.RegionEmpID=".$EmployeeId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_region.YearId=".$BeforeYId, $con); 
$TSsqlP2=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_region INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_region.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_region.RegionEmpID=".$EmployeeId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_region.YearId=".$_REQUEST['y'], $con); 
$TSsqlP3=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_region INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_region.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_region.RegionEmpID=".$EmployeeId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_region.YearId=".$AfterYId, $con); 
}
...
$TSTotP2=$TSresP2['Qa']+$TSresP2['Qb']+$TSresP2['Qc']+$TSresP2['Qd']; $TSTotP3=$TSresP3['Qa']+$TSresP3['Qb']+$TSresP3['Qc']+$TSresP3['Qd']; ?>
    <td style="width:70px;font-weight:bold;" align="right"><?php if($TSTotP1!=0 AND $TSTotP0!=''){echo $TSTotP0;}else{echo '';} ?>&nbsp;</td>
...
<?php $sqlRepHq = mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname,Gender,DR,Married,hrm_employee_general.HqId,HqName,GradeId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID INNER JOIN hrm_employee_personal ON hrm_employee_general.EmployeeID=hrm_employee_personal.EmployeeID INNER JOIN hrm_headquater ON hrm_employee_general.HqId=hrm_headquater.HqId where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=6 AND (hrm_employee_general.RepEmployeeID=".$EmployeeId." OR hrm_employee_general.EmployeeID=".$EmployeeId.") order by hrm_employee_general.EmployeeID ASC", $con); $resRepHqRow=mysql_num_rows($sqlRepHq);  
...
$sqlP5d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$HqId." AND  hrm_sales_sal_details.ProductId=".$res['ProductId']." AND hrm_sales_sal_details.YearId=".$AfterYId, $con); $resP4d=mysql_fetch_assoc($sqlP4d); $resP5d=mysql_fetch_assoc($sqlP5d);
...
/*
$sqlP4d=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr where TerrRepEmpID=".$HqEmpId." AND ProductId=".$res['ProductId']." AND YearId=".$_REQUEST['y'], $con); $sqlP5d=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr where TerrRepEmpID=".$HqEmpId." AND ProductId=".$res['ProductId']." AND YearId=".$AfterYId, $con); $resP4d=mysql_fetch_assoc($sqlP4d); $resP5d=mysql_fetch_assoc($sqlP5d);
$Ach4Q1=$resP4d['Qa']; $Ach4Q2=$resP4d['Qb']; $Ach4Q3=$resP4d['Qc']; $Ach4Q4=$resP4d['Qd']; 
$Ach5Q1=$resP5d['Qa']; $Ach5Q2=$resP5d['Qb']; $Ach5Q3=$resP5d['Qc']; $Ach5Q4=$resP5d['Qd'];
*/
...
$sql4ta=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$HqId." AND ProductId=".$res['ProductId']." AND YearId=".$_REQUEST['y'], $con); $sql5ta=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$HqId." AND hrm_sales_sal_details.ProductId=".$res['ProductId']." AND hrm_sales_sal_details.YearId=".$AfterYId, $con); 
...
/*
$sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details where TerId=".$HqEmpId." AND ProductId=".$res['ProductId']." AND YearId=".$_REQUEST['y'], $con); 
$sqlP5d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details where TerId=".$HqEmpId." AND ProductId=".$res['ProductId']." AND YearId=".$AfterYId, $con); 
$resP4d=mysql_fetch_assoc($sqlP4d); $resP5d=mysql_fetch_assoc($sqlP5d);
$Ach4Q1=$resP4d['sM1']+$resP4d['sM2']+$resP4d['sM3']; $Ach4Q2=$resP4d['sM4']+$resP4d['sM5']+$resP4d['sM6'];
$Ach4Q3=$resP4d['sM7']+$resP4d['sM8']+$resP4d['sM9']; $Ach4Q4=$resP4d['sM10']+$resP4d['sM11']+$resP4d['sM12'];
$Ach5Q1=$resP5d['sM1']+$resP5d['sM2']+$resP5d['sM3']; $Ach5Q2=$resP5d['sM4']+$resP5d['sM5']+$resP5d['sM6'];
$Ach5Q3=$resP5d['sM7']+$resP5d['sM8']+$resP5d['sM9']; $Ach5Q4=$resP5d['sM10']+$resP5d['sM11']+$resP5d['sM12'];
...
<?php if($_REQUEST['ii']=='All_1' OR $_REQUEST['ii']=='All_2'){ ?>	  
     <td bgcolor="#FFFFFF">&nbsp;<?php echo $res['ItemName']; ?></td>
<?php } ?>		 
	 <td bgcolor="#FFFFFF">&nbsp;<?php echo $res['ProductName']; ?><input type="hidden" id="<?php echo $HqId.'_'.$HqEmpId; ?>P_<?php echo $Sn; ?>" value="<?php echo $res['ProductId']; ?>" /></td>
	 <td bgcolor="#FFFFFF" align="center">&nbsp;<?php echo substr_replace($res['TypeName'], '', 2); ?></td>
...
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM1_De'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M1_De<?php echo $Sn; ?>" value="<?php if($Ach0Q1!=0 AND $Ach0Q1!=0){echo $Ach0Q1;} ?>" readonly/></td>						
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM1_Ae'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M1_Ae<?php echo $Sn; ?>" value="<?php if($AchQ1!=0 AND $AchQ1!=0){echo $AchQ1;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $HqId.'_'.$HqEmpId.'M1a'.$Sn; ?>" value="<?php if($Ach4Q1!=0 AND $Ach4Q1!=0){echo $Ach4Q1;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $HqId.'_'.$HqEmpId.'M1b'.$Sn; ?>" value="<?php if($Ach5Q1!=0 AND $Ach5Q1!=0){echo $Ach5Q1;} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM1_Be'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M1_Be<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP2d['Q1']!='' AND $resP2d['Q1']!=0){echo $resP2d['Q1'];} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM1_Ce'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M1_Ce<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP3d['Q1']!='' AND $resP3d['Q1']!=0){echo $resP3d['Q1'];} ?>" readonly/></td>

<td id="<?php echo $HqId.'_'.$HqEmpId.'TM2_De'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M2_De<?php echo $Sn; ?>" value="<?php if($Ach0Q2!='' AND $Ach0Q2!=0){echo $Ach0Q2;} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM2_Ae'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M2_Ae<?php echo $Sn; ?>" value="<?php if($AchQ2!='' AND $AchQ2!=0){echo $AchQ2;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $HqId.'_'.$HqEmpId.'M2a'.$Sn; ?>" value="<?php if($Ach4Q2!='' AND $Ach4Q2!=0){echo $Ach4Q2;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $HqId.'_'.$HqEmpId.'M2b'.$Sn; ?>" value="<?php if($Ach5Q2!='' AND $Ach5Q2!=0){echo $Ach5Q2;} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM2_Be'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M2_Be<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP2d['Q2']!='' AND $resP2d['Q2']!=0){echo $resP2d['Q2'];} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM2_Ce'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M2_Ce<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP3d['Q2']!='' AND $resP3d['Q2']!=0){echo $resP3d['Q2'];} ?>" readonly/></td>

<td id="<?php echo $HqId.'_'.$HqEmpId.'TM3_De'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M3_De<?php echo $Sn; ?>" value="<?php if($Ach0Q3!='' AND $Ach0Q3!=0){echo $Ach0Q3;} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM3_Ae'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M3_Ae<?php echo $Sn; ?>" value="<?php if($AchQ3!='' AND $AchQ3!=0){echo $AchQ3;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $HqId.'_'.$HqEmpId.'M3a'.$Sn; ?>" value="<?php if($Ach4Q3!='' AND $Ach4Q3!=0){echo $Ach4Q3;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $HqId.'_'.$HqEmpId.'M3b'.$Sn; ?>" value="<?php if($Ach5Q3!='' AND $Ach5Q3!=0){echo $Ach5Q3;} ?>" readonly/></td>	
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM3_Be'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M3_Be<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP2d['Q3']!='' AND $resP2d['Q3']!=0){echo $resP2d['Q3'];} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM3_Ce'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M3_Ce<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP3d['Q3']!='' AND $resP3d['Q3']!=0){echo $resP3d['Q3'];} ?>" readonly/></td>	
 
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM4_De'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M4_De<?php echo $Sn; ?>" value="<?php if($Ach0Q4!='' AND $Ach0Q4!=0){echo $Ach0Q4;} ?>" readonly/></td> 
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM4_Ae'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M4_Ae<?php echo $Sn; ?>" value="<?php if($AchQ4!='' AND $AchQ4!=0){echo $AchQ4;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $HqId.'_'.$HqEmpId.'M4a'.$Sn; ?>" value="<?php if($Ach4Q4!='' AND $Ach4Q4!=0){echo $Ach4Q4;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $HqId.'_'.$HqEmpId.'M4b'.$Sn; ?>" value="<?php if($Ach5Q4!='' AND $Ach5Q4!=0){echo $Ach5Q4;} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM4_Be'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M4_Be<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP2d['Q4']!='' AND $resP2d['Q4']!=0){echo $resP2d['Q4'];} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TM4_Ce'.$Sn; ?>">
<input class="Input" id="<?php echo $HqId.'_'.$HqEmpId; ?>M4_Ce<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP3d['Q4']!='' AND $resP3d['Q4']!=0){echo $resP3d['Q4'];} ?>" readonly/></td>
<?php 
...
?>	 
<td id="<?php echo $HqId.'_'.$HqEmpId.'TTotP0d_'.$Sn; ?>"><input class="InputB" id="<?php echo $HqId.'_'.$HqEmpId; ?>TotP0d_<?php echo $Sn; ?>" value="<?php if($TotP0d!=0 AND $TotP0d!=''){echo $TotP0d;}else{echo '';} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TTotP1d_'.$Sn; ?>"><input class="InputB" id="<?php echo $HqId.'_'.$HqEmpId; ?>TotP1d_<?php echo $Sn; ?>" value="<?php if($TotP1d!=0 AND $TotP1d!=''){echo $TotP1d;}else{echo '';} ?>" readonly/></td>
<td id=""><input class="InputB" id="<?php echo $HqId.'_'.$HqEmpId.'MTota'.$Sn; ?>" value="<?php if($TotP4d!=0 AND $TotP4d!=''){echo $TotP4d;}else{echo '';} ?>" readonly/></td>
<td id=""><input class="InputB" id="<?php echo $HqId.'_'.$HqEmpId.'MTotb'.$Sn; ?>" value="<?php if($TotP5d!=0 AND $TotP5d!=''){echo $TotP5d;}else{echo '';} ?>" readonly/></td>	
<td id="<?php echo $HqId.'_'.$HqEmpId.'TTotP2d_'.$Sn; ?>"><input class="InputB" id="<?php echo $HqId.'_'.$HqEmpId; ?>TotP2d_<?php echo $Sn; ?>" value="<?php if($TotP2d!=0 AND $TotP2d!=''){echo $TotP2d;}else{echo '';} ?>" readonly/></td>
<td id="<?php echo $HqId.'_'.$HqEmpId.'TTotP3d_'.$Sn; ?>"><input class="InputB" id="<?php echo $HqId.'_'.$HqEmpId; ?>TotP3d_<?php echo $Sn; ?>" value="<?php if($TotP3d!=0 AND $TotP3d!=''){echo $TotP3d;}else{echo '';} ?>" readonly/></td>	
  </tr>	
<?php $Sn++; }  ?>     
<?php if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){ 

//$sqlP1td=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details where TerId=".$HqEmpId." AND ItemId=".$_REQUEST['ii']." AND YearId=".$BeforeYId, $con);  

if($HqEmpId==$EmployeeId){
$sqlP0td=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$HqId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details.YearId=".$Before2YId, $con);
$sqlP1td=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$HqId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details.YearId=".$BeforeYId, $con);

$sqlP4td=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$HqId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details.YearId=".$_REQUEST['y'], $con); 
$sqlP5td=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$HqId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details.YearId=".$AfterYId, $con); 
...
$sqlP2td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_terr.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_terr.TerrEmpID=".$HqEmpId." AND hrm_sales_sal_details_terr.TerrHqID=".$HqId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_terr.YearId=".$_REQUEST['y'], $con); 
...
/*
$sqlP4td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr where TerrRepEmpID=".$HqEmpId." AND ItemId=".$_REQUEST['ii']." AND YearId=".$_REQUEST['y'], $con); $sqlP5td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_terr where TerrRepEmpID=".$HqEmpId." AND ItemId=".$_REQUEST['ii']." AND YearId=".$AfterYId, $con); $resP4td=mysql_fetch_assoc($sqlP4td); $resP5td=mysql_fetch_assoc($sqlP5td);
$Acht4Q1=$resP4td['Qa']; $Acht4Q2=$resP4td['Qb']; $Acht4Q3=$resP4td['Qc']; $Acht4Q4=$resP4td['Qd']; 
$Acht5Q1=$resP5td['Qa']; $Acht5Q2=$resP5td['Qb']; $Acht5Q3=$resP5td['Qc']; $Acht5Q4=$resP5td['Qd'];
*/
...
/*
$sqlP4td=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details where TerId=".$HqEmpId." AND ItemId=".$_REQUEST['ii']." AND YearId=".$_REQUEST['y'], $con); 
$sqlP5td=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details where TerId=".$HqEmpId." AND ItemId=".$_REQUEST['ii']." AND YearId=".$AfterYId, $con); 
$resP4td=mysql_fetch_assoc($sqlP4td); $resP5td=mysql_fetch_assoc($sqlP5td);
$Acht4Q1=$resP4td['sM1']+$resP4td['sM2']+$resP4td['sM3']; $Acht4Q2=$resP4td['sM4']+$resP4td['sM5']+$resP4td['sM6'];
$Acht4Q3=$resP4td['sM7']+$resP4td['sM8']+$resP4td['sM9']; $Acht4Q4=$resP4td['sM10']+$resP4td['sM11']+$resP4td['sM12'];
$Acht5Q1=$resP5td['sM1']+$resP5td['sM2']+$resP5td['sM3']; $Acht5Q2=$resP5td['sM4']+$resP5td['sM5']+$resP5td['sM6'];
...
$sqlP2td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_hq.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_hq.HqId=".$HqId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_hq.YearId=".$_REQUEST['y'], $con); 
$sqlP3td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_hq.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_hq.HqId=".$HqId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_hq.YearId=".$AfterYId, $con); 
}
...
?>
   <tr style="font-size:14px;color:#000000;background-color:#FFFFA6;height:24px;">
	 ...
	 <td><input class="TInput" id="<?php echo $HqId.'_'.$HqEmpId; ?>M1_BeT" value="<?php if($resP2td['Qa']>0){echo $resP2td['Qa'];} ?>" /></td>
	 <td><input class="TInput" id="<?php echo $HqId.'_'.$HqEmpId; ?>M1_CeT" value="<?php if($resP3td['Qa']>0){echo $resP3td['Qa'];} ?>" readonly/></td>
	 ...
	 <td><input class="TInput" id="<?php echo $HqId.'_'.$HqEmpId; ?>M2_BeT" value="<?php if($resP2td['Qb']>0){echo $resP2td['Qb'];} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $HqId.'_'.$HqEmpId; ?>M2_CeT" value="<?php if($resP3td['Qb']>0){echo $resP3td['Qb'];} ?>" readonly/></td>
	 ...
	 <td><input class="TInput" id="<?php echo $HqId.'_'.$HqEmpId; ?>M3_BeT" value="<?php if($resP2td['Qc']>0){echo $resP2td['Qc'];} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $HqId.'_'.$HqEmpId; ?>M3_CeT" value="<?php if($resP3td['Qc']>0){echo $resP3td['Qc'];} ?>" readonly/></td>		
	 ...
	 <td><input class="TInput" id="<?php echo $HqId.'_'.$HqEmpId; ?>M4_BeT" value="<?php if($resP2td['Qd']>0){echo $resP2td['Qd'];} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $HqId.'_'.$HqEmpId; ?>M4_CeT" value="<?php if($resP3td['Qd']>0){echo $resP3td['Qd'];} ?>" readonly/></td>
...
$TotP3td=$resP3td['Qa']+$resP3td['Qb']+$resP3td['Qc']+$resP3td['Qd'];  ?>
	  ...
	  <td><input class="TInput" id="<?php echo $HqId.'_'.$HqEmpId; ?>TotM_CeT" value="<?php if($TotP3td!=0 AND $TotP3td!=''){echo $TotP3td;}else{echo '';} ?>" readonly/></td>
  </tr>	
<?php } ?>  
</table>	       
   </td>  
...
if($HqEmpId==$EmployeeId)
{ $sqlP0d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$resHq2['HqId']." AND hrm_sales_sal_details.ProductId=".$res['ProductId']." AND hrm_sales_sal_details.YearId=".$Before2YId, $con); 
$sqlP1d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$resHq2['HqId']." ANDhrm_sales_sal_details.ProductId=".$res['ProductId']." AND hrm_sales_sal_details.YearId=".$BeforeYId, $con);  
$sqlP4d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$resHq2['HqId']." AND hrm_sales_sal_details.ProductId=".$res['ProductId']." AND hrm_sales_sal_details.YearId=".$_REQUEST['y'], $con); 
$sqlP5d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details where INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$resHq2['HqId']." AND hrm_sales_sal_details.ProductId=".$res['ProductId']." AND hrm_sales_sal_details.YearId=".$AfterYId, $con); $resP4d=mysql_fetch_assoc($sqlP4d); $resP5d=mysql_fetch_assoc($sqlP5d);
$Ach4Q1=$resP4d['sM1']+$resP4d['sM2']+$resP4d['sM3']; $Ach4Q2=$resP4d['sM4']+$resP4d['sM5']+$resP4d['sM6'];
$Ach4Q3=$resP4d['sM7']+$resP4d['sM8']+$resP4d['sM9']; $Ach4Q4=$resP4d['sM10']+$resP4d['sM11']+$resP4d['sM12'];
$Ach5Q1=$resP5d['sM1']+$resP5d['sM2']+$resP5d['sM3']; $Ach5Q2=$resP5d['sM4']+$resP5d['sM5']+$resP5d['sM6'];
$Ach5Q3=$resP5d['sM7']+$resP5d['sM8']+$resP5d['sM9']; $Ach5Q4=$resP5d['sM10']+$resP5d['sM11']+$resP5d['sM12'];
...
$sql4ta=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$resHq2['HqId']." AND hrm_sales_sal_details.ProductId=".$res['ProductId']." AND hrm_sales_sal_details.YearId=".$_REQUEST['y'], $con); $sql5ta=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$resHq2['HqId']." AND hrm_sales_sal_details.ProductId=".$res['ProductId']." AND hrm_sales_sal_details.YearId=".$AfterYId, $con); 
$res4ta=mysql_fetch_assoc($sql4ta); $res5ta=mysql_fetch_assoc($sql5ta);
$Ach4Q1=$res4ta['sM1']+$res4ta['sM2']+$res4ta['sM3']; $Ach4Q2=$res4ta['sM4']+$res4ta['sM5']+$res4ta['sM6'];
$Ach4Q3=$res4ta['sM7']+$res4ta['sM8']+$res4ta['sM9']; $Ach4Q4=$res4ta['sM10']+$res4ta['sM11']+$res4ta['sM12'];
$Ach5Q1=$res5ta['sM1']+$res5ta['sM2']+$res5ta['sM3']; $Ach5Q2=$res5ta['sM4']+$res5ta['sM5']+$res5ta['sM6'];
...
$sqlP2d=mysql_query("select * from hrm_sales_sal_details_hq where HqId=".$resHq2['HqId']." AND ProductId=".$res['ProductId']." AND YearId=".$_REQUEST['y'], $con); 
$sqlP3d=mysql_query("select * from hrm_sales_sal_details_hq where HqId=".$resHq2['HqId']." AND ProductId=".$res['ProductId']." AND YearId=".$AfterYId, $con); 
}
$resP0d=mysql_fetch_assoc($sqlP0d); 
$Ach0Q1=$resP0d['sM1']+$resP0d['sM2']+$resP0d['sM3']; $Ach0Q2=$resP0d['sM4']+$resP0d['sM5']+$resP0d['sM6'];
$Ach0Q3=$resP0d['sM7']+$resP0d['sM8']+$resP0d['sM9']; $Ach0Q4=$resP0d['sM10']+$resP0d['sM11']+$resP0d['sM12'];
...
<?php if($_REQUEST['ii']=='All_1' OR $_REQUEST['ii']=='All_2'){ ?>	  
     <td bgcolor="#FFFFFF">&nbsp;<?php echo $res['ItemName']; ?></td>
<?php } ?>		 
	 <td bgcolor="#FFFFFF">&nbsp;<?php echo $res['ProductName']; ?><input type="hidden" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>P_<?php echo $Sn; ?>" value="<?php echo $res['ProductId']; ?>" /></td>
	 <td bgcolor="#FFFFFF" align="center">&nbsp;<?php echo substr_replace($res['TypeName'], '', 2); ?></td>
	 <td align="center" valign="middle" bgcolor="#FFFFFF">
	   <?php if($resCPerMi['EditPerMi']=='Y'){ ?>
	   <?php if($rowSubEmp==0){ //if($resP2['St_EmployeeID']==0 OR $resP2['St_EmployeeID']==1 OR $resP2['St_R1']==3){ ?>
<img src="images/edit.png" border="0" alt="Edit" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>EditBtn_<?php echo $Sn; ?>" onClick="editD(<?php echo $Sn.', '.$resRepHq['GradeId'].', '.$HqEmpId.','.$resHq2['HqId']; ?>)" style="display:block;">
<img src="images/Floppy-Small-icon.png" border="0" alt="Save" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>SaveBtn_<?php echo $Sn; ?>" onClick="saveD(<?php echo $Sn.', '.$_REQUEST['y'].', '.$resRepHq['GradeId'].', '.$HqEmpId.', '.$rowRpt.','.$resHq2['HqId']; ?>)" style="display:none;">
	   <?php } ?>
	   <?php } else {echo '&nbsp;';}?>
	</td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM1_De'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M1_De<?php echo $Sn; ?>" value="<?php if($Ach0Q1!=0 AND $Ach0Q1!=0){echo $Ach0Q1;} ?>" readonly/></td>						
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM1_Ae'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M1_Ae<?php echo $Sn; ?>" value="<?php if($AchQ1!=0 AND $AchQ1!=0){echo $AchQ1;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'M1a'.$Sn; ?>" value="<?php if($Ach4Q1!=0 AND $Ach4Q1!=0){echo $Ach4Q1;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'M1b'.$Sn; ?>" value="<?php if($Ach5Q1!=0 AND $Ach5Q1!=0){echo $Ach5Q1;} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM1_Be'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M1_Be<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP2d['Q1']!='' AND $resP2d['Q1']!=0){echo $resP2d['Q1'];} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM1_Ce'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M1_Ce<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP3d['Q1']!='' AND $resP3d['Q1']!=0){echo $resP3d['Q1'];} ?>" readonly/></td>

<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM2_De'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M2_De<?php echo $Sn; ?>" value="<?php if($Ach0Q2!='' AND $Ach0Q2!=0){echo $Ach0Q2;} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM2_Ae'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M2_Ae<?php echo $Sn; ?>" value="<?php if($AchQ2!='' AND $AchQ2!=0){echo $AchQ2;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'M2a'.$Sn; ?>" value="<?php if($Ach4Q2!='' AND $Ach4Q2!=0){echo $Ach4Q2;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'M2b'.$Sn; ?>" value="<?php if($Ach5Q2!='' AND $Ach5Q2!=0){echo $Ach5Q2;} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM2_Be'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M2_Be<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP2d['Q2']!='' AND $resP2d['Q2']!=0){echo $resP2d['Q2'];} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM2_Ce'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M2_Ce<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP3d['Q2']!='' AND $resP3d['Q2']!=0){echo $resP3d['Q2'];} ?>" readonly/></td>

<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM3_De'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M3_De<?php echo $Sn; ?>" value="<?php if($Ach0Q3!='' AND $Ach0Q3!=0){echo $Ach0Q3;} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM3_Ae'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M3_Ae<?php echo $Sn; ?>" value="<?php if($AchQ3!='' AND $AchQ3!=0){echo $AchQ3;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'M3a'.$Sn; ?>" value="<?php if($Ach4Q3!='' AND $Ach4Q3!=0){echo $Ach4Q3;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'M3b'.$Sn; ?>" value="<?php if($Ach5Q3!='' AND $Ach5Q3!=0){echo $Ach5Q3;} ?>" readonly/></td>	
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM3_Be'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M3_Be<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP2d['Q3']!='' AND $resP2d['Q3']!=0){echo $resP2d['Q3'];} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM3_Ce'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M3_Ce<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP3d['Q3']!='' AND $resP3d['Q3']!=0){echo $resP3d['Q3'];} ?>" readonly/></td>	
 
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM4_De'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M4_De<?php echo $Sn; ?>" value="<?php if($Ach0Q4!='' AND $Ach0Q4!=0){echo $Ach0Q4;} ?>" readonly/></td> 
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM4_Ae'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M4_Ae<?php echo $Sn; ?>" value="<?php if($AchQ4!='' AND $AchQ4!=0){echo $AchQ4;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'M4a'.$Sn; ?>" value="<?php if($Ach4Q4!='' AND $Ach4Q4!=0){echo $Ach4Q4;} ?>" readonly/></td>
<td id=""><input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'M4b'.$Sn; ?>" value="<?php if($Ach5Q4!='' AND $Ach5Q4!=0){echo $Ach5Q4;} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM4_Be'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M4_Be<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP2d['Q4']!='' AND $resP2d['Q4']!=0){echo $resP2d['Q4'];} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TM4_Ce'.$Sn; ?>">
<input class="Input" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M4_Ce<?php echo $Sn; ?>" style="background-color:#D3FED7;" value="<?php if($resP3d['Q4']!='' AND $resP3d['Q4']!=0){echo $resP3d['Q4'];} ?>" readonly/></td>
<?php 
$TotP0d=$Ach0Q1+$Ach0Q2+$Ach0Q3+$Ach0Q4; $TotP1d=$AchQ1+$AchQ2+$AchQ3+$AchQ4; $TotP4d=$Ach4Q1+$Ach4Q2+$Ach4Q3+$Ach4Q4;  $TotP5d=$Ach5Q1+$Ach5Q2+$Ach5Q3+$Ach5Q4; 
$TotP2d=$resP2d['Q1']+$resP2d['Q2']+$resP2d['Q3']+$resP2d['Q4']; 
$TotP3d=$resP3d['Q1']+$resP3d['Q2']+$resP3d['Q3']+$resP3d['Q4']; 
?>	 
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TTotP0d_'.$Sn; ?>"><input class="InputB" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>TotP0d_<?php echo $Sn; ?>" value="<?php if($TotP0d!=0 AND $TotP0d!=''){echo $TotP0d;}else{echo '';} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TTotP1d_'.$Sn; ?>"><input class="InputB" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>TotP1d_<?php echo $Sn; ?>" value="<?php if($TotP1d!=0 AND $TotP1d!=''){echo $TotP1d;}else{echo '';} ?>" readonly/></td>
<td id=""><input class="InputB" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'MTota'.$Sn; ?>" value="<?php if($TotP4d!=0 AND $TotP4d!=''){echo $TotP4d;}else{echo '';} ?>" readonly/></td>
<td id=""><input class="InputB" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'MTotb'.$Sn; ?>" value="<?php if($TotP5d!=0 AND $TotP5d!=''){echo $TotP5d;}else{echo '';} ?>" readonly/></td>	
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TTotP2d_'.$Sn; ?>"><input class="InputB" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>TotP2d_<?php echo $Sn; ?>" value="<?php if($TotP2d!=0 AND $TotP2d!=''){echo $TotP2d;}else{echo '';} ?>" readonly/></td>
<td id="<?php echo $resHq2['HqId'].'_'.$HqEmpId.'TTotP3d_'.$Sn; ?>"><input class="InputB" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>TotP3d_<?php echo $Sn; ?>" value="<?php if($TotP3d!=0 AND $TotP3d!=''){echo $TotP3d;}else{echo '';} ?>" readonly/></td>	
  </tr>	
<?php $Sn++; }  ?>     
<?php if($_REQUEST['ii']!='All_1' AND $_REQUEST['ii']!='All_2'){ 
...
if($HqEmpId==$EmployeeId){
$sqlP0td=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$resHq2['HqId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details.YearId=".$Before2YId, $con);
$sqlP1td=mysql_query("select SUM(M1_Ach) as tsM1,SUM(M2_Ach) as tsM2,SUM(M3_Ach) as tsM3,SUM(M4_Ach) as tsM4,SUM(M5_Ach) as tsM5,SUM(M6_Ach) as tsM6,SUM(M7_Ach) as tsM7,SUM(M8_Ach) as tsM8,SUM(M9_Ach) as tsM9,SUM(M10_Ach) as tsM10,SUM(M11_Ach) as tsM11,SUM(M12_Ach) as tsM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$resHq2['HqId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details.YearId=".$BeforeYId, $con);

$sqlP4td=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$resHq2['HqId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details.YearId=".$_REQUEST['y'], $con); 
$sqlP5td=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details.ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details.DealerId=hrm_sales_dealer.DealerId where hrm_sales_dealer.HqId=".$resHq2['HqId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details.YearId=".$AfterYId, $con); 
$resP4td=mysql_fetch_assoc($sqlP4td); $resP5td=mysql_fetch_assoc($sqlP5td);
$Acht4Q1=$resP4td['sM1']+$resP4td['sM2']+$resP4td['sM3']; $Acht4Q2=$resP4td['sM4']+$resP4td['sM5']+$resP4td['sM6'];
$Acht4Q3=$resP4td['sM7']+$resP4td['sM8']+$resP4td['sM9']; $Acht4Q4=$resP4td['sM10']+$resP4td['sM11']+$resP4td['sM12'];
$Acht5Q1=$resP5td['sM1']+$resP5td['sM2']+$resP5td['sM3']; $Acht5Q2=$resP5td['sM4']+$resP5td['sM5']+$resP5td['sM6'];
...
$sqlP2td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_hq.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_hq.HqId=".$resHq2['HqId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_hq.YearId=".$_REQUEST['y'], $con); 
$sqlP3td=mysql_query("select SUM(Q1) as Qa,SUM(Q2) as Qb,SUM(Q3) as Qc,SUM(Q4) as Qd from hrm_sales_sal_details_hq INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_hq.ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_hq.HqId=".$resHq2['HqId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_hq.YearId=".$AfterYId, $con); 
}
$resP0td=mysql_fetch_assoc($sqlP0td); 
$TotP0p1=$resP0td['tsM1']+$resP0td['tsM2']+$resP0td['tsM3']; $TotP0p2=$resP0td['tsM4']+$resP0td['tsM5']+$resP0td['tsM6'];
$TotP0p3=$resP0td['tsM7']+$resP0td['tsM8']+$resP0td['tsM9']; $TotP0p4=$resP0td['tsM10']+$resP0td['tsM11']+$resP0td['tsM12'];
...
?>
   <tr style="font-size:14px;color:#000000;background-color:#FFFFA6;height:24px;">
	 <td colspan="3" align="right" style="font-size:16px;"><b>TOTAL:&nbsp;</b></td>
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M1_DeT" value="<?php if($TotP0p1>0){echo $TotP0p1;} ?>" readonly/></td>
     <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M1_AeT" value="<?php if($TotPp1>0){echo $TotPp1;} ?>" readonly/></td>
	 <td><input class="TInput" id="" value="<?php if($Acht4Q1!=0 AND $Acht4Q1!=0){echo $Acht4Q1;} ?>" /></td>
	 <td><input class="TInput" id="" value="<?php if($Acht5Q1!=0 AND $Acht5Q1!=0){echo $Acht5Q1;} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M1_BeT" value="<?php if($resP2td['Qa']>0){echo $resP2td['Qa'];} ?>" /></td>
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M1_CeT" value="<?php if($resP3td['Qa']>0){echo $resP3td['Qa'];} ?>" readonly/></td>
	 
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M2_DeT" value="<?php if($TotP0p2>0){echo $TotP0p2;} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M2_AeT" value="<?php if($TotPp2>0){echo $TotPp2;} ?>" readonly/></td>
	 <td><input class="TInput" id="" value="<?php if($Acht4Q2!=0 AND $Acht4Q2!=0){echo $Acht4Q2;} ?>" readonly/></td>
	 <td><input class="TInput" id="" value="<?php if($Acht5Q2!=0 AND $Acht5Q2!=0){echo $Acht5Q2;} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M2_BeT" value="<?php if($resP2td['Qb']>0){echo $resP2td['Qb'];} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M2_CeT" value="<?php if($resP3td['Qb']>0){echo $resP3td['Qb'];} ?>" readonly/></td>
	 
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M3_DeT" value="<?php if($TotP0p3>0){echo $TotP0p3;} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M3_AeT" value="<?php if($TotPp3>0){echo $TotPp3;} ?>" readonly/></td>
	 <td><input class="TInput" id="" value="<?php if($Acht4Q3!=0 AND $Acht4Q3!=0){echo $Acht4Q3;} ?>" readonly/></td>
	 <td><input class="TInput" id="" value="<?php if($Acht5Q3!=0 AND $Acht5Q3!=0){echo $Acht5Q3;} ?>" readonly/></td>	
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M3_BeT" value="<?php if($resP2td['Qc']>0){echo $resP2td['Qc'];} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M3_CeT" value="<?php if($resP3td['Qc']>0){echo $resP3td['Qc'];} ?>" readonly/></td>		
	 				 							
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M4_DeT" value="<?php if($TotP0p4>0){echo $TotP0p4;} ?>" readonly/></td>											
     <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M4_AeT" value="<?php if($TotPp4>0){echo $TotPp4;} ?>" readonly/></td>
	 <td><input class="TInput" id="" value="<?php if($Acht4Q4!=0 AND $Acht4Q4!=0){echo $Acht4Q4;} ?>" readonly/></td>
	 <td><input class="TInput" id="" value="<?php if($Acht5Q4!=0 AND $Acht5Q4!=0){echo $Acht5Q4;} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M4_BeT" value="<?php if($resP2td['Qd']>0){echo $resP2td['Qd'];} ?>" readonly/></td>
	 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>M4_CeT" value="<?php if($resP3td['Qd']>0){echo $resP3td['Qd'];} ?>" readonly/></td>
...
$TotP2td=$resP2td['Qa']+$resP2td['Qb']+$resP2td['Qc']+$resP2td['Qd']; 
$TotP3td=$resP3td['Qa']+$resP3td['Qb']+$resP3td['Qc']+$resP3td['Qd'];  ?>
 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>TotM_DeT" value="<?php if($TotP0td!=0 AND $TotP0td!=''){echo $TotP0td;}else{echo '';} ?>" readonly/></td>
 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>TotM_AeT" value="<?php if($TotP1td!=0 AND $TotP1td!=''){echo $TotP1td;}else{echo '';} ?>" readonly/></td>
 <td><input class="TInput" id="" value="<?php if($TotP4td!=0 AND $TotP4td!=''){echo $TotP4td;}else{echo '';} ?>" readonly/></td>
 <td><input class="TInput" id="" value="<?php if($TotP5td!=0 AND $TotP5td!=''){echo $TotP5td;}else{echo '';} ?>" readonly/></td>
 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>TotM_BeT" value="<?php if($TotP2td!=0 AND $TotP2td!=''){echo $TotP2td;}else{echo '';} ?>" readonly/></td>
 <td><input class="TInput" id="<?php echo $resHq2['HqId'].'_'.$HqEmpId; ?>TotM_CeT" value="<?php if($TotP3td!=0 AND $TotP3td!=''){echo $TotP3td;}else{echo '';} ?>" readonly/></td>
  </tr>	
<?php } ?>  
</table>	       
   </td>  
