...
{     
  ...
  $sqlB = mysql_query("select * from hrm_sales_sal_details_".$_POST['yi']." where DealerId=".$_POST['di']." AND ProductId=".$_POST['p']." AND YearId=".$_POST['yi'], $con); $rowB=mysql_num_rows($sqlB); 
  if($rowB==0){ $sqlInsB = mysql_query("insert into hrm_sales_sal_details_".$_POST['yi']."(DealerId, ItemId, ProductId, YearId, M1, M2, M3, M4, M5, M6, M7, M8, M9, M10, M11, M12) values(".$_POST['di'].", ".$resI['ItemId'].", ".$_POST['p'].", ".$_POST['yi'].", ".$_POST['m1B'].", ".$_POST['m2B'].", ".$_POST['m3B'].", ".$_POST['m4B'].", ".$_POST['m5B'].", ".$_POST['m6B'].", ".$_POST['m7B'].", ".$_POST['m8B'].", ".$_POST['m9B'].", ".$_POST['m10B'].", ".$_POST['m11B'].", ".$_POST['m12B'].")", $con); }
  else{ $sqlInsB = mysql_query("update hrm_sales_sal_details_".$_POST['yi']." set M1=".$_POST['m1B'].", M2=".$_POST['m2B'].", M3=".$_POST['m3B'].", M4=".$_POST['m4B'].", M5=".$_POST['m5B'].", M6=".$_POST['m6B'].", M7=".$_POST['m7B'].", M8=".$_POST['m8B'].", M9=".$_POST['m9B'].", M10=".$_POST['m10B'].", M11=".$_POST['m11B'].", M12=".$_POST['m12B']." where DealerId=".$_POST['di']." AND ProductId=".$_POST['p']." AND YearId=".$_POST['yi'], $con); } 
	  
  $sqlC = mysql_query("select * from hrm_sales_sal_details_".$AfterYId." where DealerId=".$_POST['di']." AND ProductId=".$_POST['p']." AND YearId=".$AfterYId, $con); $rowC=mysql_num_rows($sqlC); 
  if($rowC==0){ $sqlInsC = mysql_query("insert into hrm_sales_sal_details_".$AfterYId."(DealerId, ItemId, ProductId, YearId, M1_Proj, M2_Proj, M3_Proj, M4_Proj, M5_Proj, M6_Proj, M7_Proj, M8_Proj, M9_Proj, M10_Proj, M11_Proj, M12_Proj) values(".$_POST['di'].", ".$resI['ItemId'].", ".$_POST['p'].", ".$AfterYId.", ".$_POST['m1C'].", ".$_POST['m2C'].", ".$_POST['m3C'].", ".$_POST['m4C'].", ".$_POST['m5C'].", ".$_POST['m6C'].", ".$_POST['m7C'].", ".$_POST['m8C'].", ".$_POST['m9C'].", ".$_POST['m10C'].", ".$_POST['m11C'].", ".$_POST['m12C'].")", $con); }
  else{ $sqlInsC = mysql_query("update hrm_sales_sal_details_".$AfterYId." set M1_Proj=".$_POST['m1C'].", M2_Proj=".$_POST['m2C'].", M3_Proj=".$_POST['m3C'].", M4_Proj=".$_POST['m4C'].", M5_Proj=".$_POST['m5C'].", M6_Proj=".$_POST['m6C'].", M7_Proj=".$_POST['m7C'].", M8_Proj=".$_POST['m8C'].", M9_Proj=".$_POST['m9C'].", M10_Proj=".$_POST['m10C'].", M11_Proj=".$_POST['m11C'].", M12_Proj=".$_POST['m12C']." where DealerId=".$_POST['di']." AND ProductId=".$_POST['p']." AND YearId=".$AfterYId, $con); }
	   	   
	   
  if($_POST['ii']!='All_1' AND $_POST['ii']!='All_2')
  { 
    $sqlP2td=mysql_query("select SUM(M1) as tsM1, SUM(M2) as tsM2, SUM(M3) as tsM3, SUM(M4) as tsM4, SUM(M5) as tsM5, SUM(M6) as tsM6, SUM(M7) as tsM7, SUM(M8) as tsM8, SUM(M9) as tsM9, SUM(M10) as tsM10, SUM(M11) as tsM11, SUM(M12) as tsM12 from hrm_sales_sal_details_".$_POST['yi']." where DealerId=".$_POST['di']." AND ItemId=".$_POST['ii']." AND YearId=".$_POST['yi'], $con); 
    $sqlP3td=mysql_query("select SUM(M1_Proj) as tsM1, SUM(M2_Proj) as tsM2, SUM(M3_Proj) as tsM3, SUM(M4_Proj) as tsM4, SUM(M5_Proj) as tsM5, SUM(M6_Proj) as tsM6, SUM(M7_Proj) as tsM7, SUM(M8_Proj) as tsM8, SUM(M9_Proj) as tsM9, SUM(M10_Proj) as tsM10, SUM(M11_Proj) as tsM11, SUM(M12_Proj) as tsM12 from hrm_sales_sal_details_".$AfterYId." where DealerId=".$_POST['di']." AND ItemId=".$_POST['ii']." AND YearId=".$AfterYId, $con); 
