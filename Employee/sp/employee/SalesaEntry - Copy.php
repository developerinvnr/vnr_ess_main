...
function ChangeTeam(hq,v,gv)
{
  ...
  window.location="SalesaEntryMt.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+v+"&q="+q+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+'&EHq='+EHq+'&myh='+myh+'&myt='+myt+'&no='+no; 
...
function ChangePerMi(hq,v)
{
  ...
  var fc=document.getElementById("fc").value; var vc=document.getElementById("vc").value; var no=document.getElementById("no").value;
  var myh=document.getElementById("myh").value; var myt=1;
  window.location="SalesaEntryPerMi.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+v+"&q="+q+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+'&EHq='+EHq+'&myh='+myh+'&myt='+myt+'&no='+no; 
}
...
{  
  ...
  else if(ii>0 && v=='vc'){window.location="SalesaEntry.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ii="+ii+"&vc=1&fc=0&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt+'&no='+no; }
  else if(ii>0 && v=='fc'){window.location="SalesaEntry.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ii="+ii+"&vc=0&fc=1&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt+'&no='+no; }
  else if(ii=='All_2' && v=='fc'){window.location="SalesaEntry.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ii="+ii+"&vc=0&fc=1&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt+'&no='+no; }
}
...
function ClickAllProd(ii,v)
{
 var act=document.getElementById("act").value; var hq=document.getElementById("hq").value; var y=document.getElementById("y").value;
  ...
  var gi=document.getElementById("gi").value; var EHq=document.getElementById("EHq").value; var no=document.getElementById("no").value;
  var myh=document.getElementById("myh").value; var myt=document.getElementById("myt").value;
 if(v=='ac'){window.location="SalesaEntry.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ac=1&vc=0&fc=0&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt+"&ii="+ii+'&no='+no; }
}
...
{  
  ...
  var fc=document.getElementById("fc").value; var vc=document.getElementById("vc").value;
  var myh=document.getElementById("myh").value; var myt=document.getElementById("myt").value;
   window.location="SalesaEntry.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+v+"&ii="+ii+"&vc="+vc+"&fc="+fc+"&cc="+cc+"&di="+di+"&gi="+gi+"&EHq="+EHq+"&myh="+myh+"&myt="+myt+'&no='+no;
}
...
function ClickFSL1(e,y)
{
  ...
  var timer = setInterval( function() { if(win.closed) { clearInterval(timer);  window.location="SalesaEntry.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq&act="+act+"&hq="+hq+"&y="+y+"&q="+q+"&ii=0&vc=0&fc=0&ac=1&cc="+cc+"&di="+di+"&gi="+gi+'&EHq='+EHq+'&myh='+myh+'&myt='+myt; } }, 1000);
}
...
<input type="hidden" id="myh" value="<?php echo $_REQUEST['myh']; ?>" /><input type="hidden" id="Reporting" value="<?php echo $resSpP['RepEmployeeID']; ?>" />
	  ...
	  <tr>
	   <td>
	    <table border="0">
		 <tr>	 
<?php /*		 
<td align="center"><?php if($_REQUEST['myh']==0){ ?><a href="#"><img src="images/PlannerA1.png" border="0" style="height:30px;width:130px;"/></a><?php } elseif($_REQUEST['myh']==1){ ?><a href="SalesPlan.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&erne=4e&ernw=234&erney=110022344&ernretd=ee&rernr=09drfGe&ernS=eewwqq"><img src="images/PlannerA.png" border="0" style="height:30px;width:130px;"/></a><?php } ?></td> */ ?>
...
<?php if($rowHq2==1 AND $_REQUEST['myh']==0){ $resHq2=mysql_fetch_assoc($sHq2); ?><a href="#" onClick="ChangeHq(<?php echo $resSpP['HqId'].', '.$_REQUEST['y'].',1'; ?>)"><img src="images/My1hq.png" border="0" style="height:30px;width:130px;"  /></a>&nbsp;<a href="#" onClick="ChangeHq(<?php echo $resHq2['HqId'].', '.$_REQUEST['y'].',2'; ?>)"><img src="images/My2hq.png" border="0" style="height:30px;width:130px;"  /></a>
<?php } elseif($rowHq2==1 AND $_REQUEST['myh']==1){ ?>
<?php if($_REQUEST['no']==1){?><img src="images/My1hq1.png" style="height:30px;width:130px;"/><?php }else{?><a href="#" onClick="ChangeHq(<?php echo $resSpP['HqId'].', '.$_REQUEST['y'].',1'; ?>)"><img src="images/My1hq.png" border="0" style="height:30px;width:130px;"  /></a><?php }?>
&nbsp;
<?php if($_REQUEST['no']==2){?><img src="images/My2hq1.png" style="height:30px;width:130px;"/><?php }else{?><a href="#" onClick="ChangeHq(<?php echo $resHq2['HqId'].', '.$_REQUEST['y'].',2'; ?>)"><img src="images/My2hq.png" border="0" style="height:30px;width:130px;"  /></a><?php }?>
<?php } ?>
...
<?php } ?> 
<td>&nbsp;</td>		
<input type="hidden" id="TerId" value="<?php echo $EmployeeId; ?>" /><input type="hidden" id="HqV" value=<?php echo $_REQUEST['hq']; ?> />
<input type="hidden" id="CheckEntry" value="O" />
<?php  $sqlL=mysql_query("select R1,R2,R3,R4,R5 from hrm_sales_reporting_level where EmployeeID=".$EmployeeId, $con); $resL=mysql_fetch_assoc($sqlL);
...
<?php $sql = mysql_query("select HqName from hrm_headquater where HqId=".$_REQUEST['hq'], $con); $res=mysql_fetch_array($sql); 
	  ...
	  else{ $sqlItem = mysql_query("select ItemName from hrm_sales_seedsitem where ItemId=".$_REQUEST['ii'], $con); $resItem=mysql_fetch_assoc($sqlItem); 
	  $ItemN=$resItem['ItemName']; 
...
<table border="1" cellpadding="0" cellspacing="0" style="font-family:Times New Roman;font-size:14px;width:<?php if($_REQUEST['ii']=='All_1' OR $_REQUEST['ii']=='All_2' OR $_REQUEST['ac']==1){ echo '1700px';}else{echo '1600px';}?>;">	
  <tr>
...
<?php } ?>		 
 ...
 <?php if($_REQUEST['q']==1){ ?>	
<td id="<?php echo 'TM1_D'.$Sn; ?>"><input class="Input" id="M1_D<?php echo $Sn; ?>" value="<?php if($resP0['sM1']!='' AND $resP0['sM1']!=0){echo $resP0['sM1'];}?>" readonly/></td><td id="<?php echo 'TM1_A'.$Sn; ?>"><input class="Input" id="M1_A<?php echo $Sn; ?>" value="<?php if($resP1['sM1']!='' AND $resP1['sM1']!=0){echo $resP1['sM1'];}?>" readonly/></td>
...
if($_REQUEST['q']==1){ $STotP0=$SresP0['Q1']; $STotP1=$SresP1['Q1']; $STotP2=$SresP2['Q1']; $STotP3=$SresP3['Q1']; }elseif($_REQUEST['q']==2){ $STotP0=$SresP0['Q2']; $STotP1=$SresP1['Q2']; $STotP2=$SresP2['Q2']; $STotP3=$SresP3['Q2']; }elseif($_REQUEST['q']==3){ $STotP0=$SresP0['Q3']; $STotP1=$SresP1['Q3']; $STotP2=$SresP2['Q3']; $STotP3=$SresP3['Q3']; }elseif($_REQUEST['q']==4){ $STotP0=$SresP0['Q4']; $STotP1=$SresP1['Q4']; $STotP2=$SresP2['Q4']; $STotP3=$SresP3['Q4'];} ?>
...
<tr style="background-color:#CBD7F3;">
 <table border="0"> 
  <tr>
   <td>
<table border="1" cellpadding="0" cellspacing="0" style="font-family:Times New Roman;font-size:14px;width:<?php if($_REQUEST['ii']=='All_1' OR $_REQUEST['ii']=='All_2'){ echo '1400px';}else{echo '1400px';}?>;">	
  <tr style="background-color:#D5F1D1;color:#000000;">
...
<td id="<?php echo $DeId.'TM12_De'.$Sn; ?>"><input class="Input" id="<?php echo $DeId; ?>M12_De<?php echo $Sn; ?>" value="<?php if($resP0d['M12_Ach']!='' AND $resP10d['M12_Ach']!=0){echo $resP0d['M12_Ach'];} ?>" readonly/></td>
