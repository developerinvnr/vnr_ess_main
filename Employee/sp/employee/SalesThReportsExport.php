...
if($_REQUEST['ConWise']>0)
{
 ...
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['EmpId']." OR rl.R1=".$_REQUEST['EmpId']." OR rl.R2=".$_REQUEST['EmpId']." OR rl.R3=".$_REQUEST['EmpId']." OR rl.R4=".$_REQUEST['EmpId']." OR rl.R5=".$_REQUEST['EmpId'].") AND sp.ProductSts='A' AND sd.YearId=".$yset." AND ".$qin."", $con); 
 }
...
elseif($_REQUEST['HqWise']>0)
{
 if($_REQUEST['SelHq']>0)
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sd.YearId=".$yset." AND sp.ProductSts='A' AND DealerSts='A' AND ".$qin." AND ".$HqCon."=".$_REQUEST['SelHq']."", $con); 
 }
 if($_REQUEST['SelHq']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_seedsproduct sp ON sd.ProductId=sp.ProductId INNER JOIN hrm_sales_seedsitem si ON sp.ItemId=si.ItemId INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$Gnj." where d.DealerSts='A' AND (".$TerrCon."=".$_REQUEST['EmpId']." OR g.RepEmployeeID=".$_REQUEST['EmpId'].") AND sd.YearId=".$yset." AND sp.ProductSts='A' AND ".$qin."", $con); 
 }
...
{ 
 ...
 if($_REQUEST['SelCon']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_sales_reporting_level rl ON ".$Rlj." where DealerSts='A' AND (".$TerrCon."=".$_REQUEST['EmpId']." OR rl.R1=".$_REQUEST['EmpId']." OR rl.R2=".$_REQUEST['EmpId']." OR rl.R3=".$_REQUEST['EmpId']." OR rl.R4=".$_REQUEST['EmpId']." OR rl.R5=".$_REQUEST['EmpId'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con);
 }
}
elseif($_REQUEST['ZoneWise']>0)
{ 
...
{ 
 if($_REQUEST['SelHq']>0)
 {
 $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId where sd.YearId=".$yset." AND sd.ProductId=".$res['ProductId']." AND DealerSts='A' AND ".$HqCon."=".$_REQUEST['SelHq']."", $con); 
 }
 if($_REQUEST['SelHq']=='All')
 {
  $sqlPd=mysql_query("select ".$subquery." from hrm_sales_sal_details_".$yset." sd INNER JOIN hrm_sales_dealer d ON sd.DealerId=d.DealerId INNER JOIN hrm_employee_general g ON ".$Gnj." where DealerSts='A' AND (".$TerrCon."=".$EmployeeId." OR g.RepEmployeeID=".$_REQUEST['EmpId'].") AND sd.ProductId=".$res['ProductId']." AND sd.YearId=".$yset, $con);
 }
}
elseif($_REQUEST['DisWise']>0)
