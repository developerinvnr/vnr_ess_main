...
if(isset($_POST['savedocdetails']))
{
 ...
 if($row==0){ $up=mysql_query("insert into fa_courierdetail(EmployeeID, Month, Year, PostDate, DocateNo, Agency) values(".$_POST['e'].", ".$_POST['m'].", ".$_POST['y'].", '".date("Y-m-d",strtotime($_POST['PostDate']))."', '".$_POST['DocateNo']."', '".$_POST['Agency']."')",$con); }else{ $up=mysql_query("update fa_courierdetail set PostDate='".date("Y-m-d",strtotime($_POST['PostDate']))."', DocateNo='".$_POST['DocateNo']."', Agency='".$_POST['Agency']."' where EmployeeID=".$_POST['e']." AND Month=".$_POST['m']." AND Year=".$_POST['y'],$con); }
...
<center>
<table border="0" style="margin-top:150px;width:98%;">
<tr>
   ...
   <tr>
    ...
    <table border="1" cellpadding="0" cellspacing="0">
	 <tr>
	  ...
	  <td class="tdf2" style="width:200px;"><b>Docate No</b></td>
	  <td class="tdf2" style="width:300px;"><b>Agency</b></td>
	  <td class="tdf2" style="width:80px;"><b>Action</b></td>
	 </tr> 
<form name="fn" method="post" onSubmit="return validate(this)" >
...
<input type="hidden" name="y" value="<?php echo $_REQUEST['y']; ?>" />	 
     <tr style="background-color:#FFFFFF;height:24px;">
	  ...
	  <td class="tdf" valign="top"><input name="DocateNo" id="DocateNo" style="font-family:Georgia;font-size:12px;width:200px;"></td>
	  <td class="tdf" valign="top"><input name="Agency" id="Agency" style="font-family:Georgia;font-size:12px;width:300px;"></td>
	  <td class="tdf" valign="top" align="center"><input type="submit" name="savedocdetails" value="save" style="width:60px;" /></td>
	 </tr>	 
</form>	 
	</table>
	</td>
