...
{ 
 ...
 { $sqlName1=mysql_query("select Fname,Sname,Lname from hrm_employee where EmployeeID=".$_REQUEST['SelZone'], $con); $resName1=mysql_fetch_assoc($sqlName1); 
   $NVV="SalesReports_ZoneWise:_".$FD."-".$TD."_".$resName1['Fname'].'_'.$resName1['Sname'].'_'.$resName1['Lname']; }
 if($_REQUEST['SelZone']=='All'){ $NVV='SalesReports_ZoneWise:'.$FD.'-'.$TD.'_ALL_MY_TEAM'; }
} 
...
elseif($_REQUEST['ZoneWise']>0)
{
 ...
 {
 if($_REQUEST['ii']>0){  $sqlP1d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId2." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$BeforeYId2.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId2.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$BeforeYId2.".YearId=".$BeforeYId2." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); } 
...
elseif($_REQUEST['ZoneWise']>0)
{
 ...
 if($_REQUEST['SelZone']=='All')
 {
 if($_REQUEST['ii']>0){  $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$BeforeYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$BeforeYId.".YearId=".$BeforeYId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); } 
...
elseif($_REQUEST['HqWise']>0)
{
 ...
 if($_REQUEST['SelHq']=='All')
 {
 if($_REQUEST['ii']>0){  $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$BeforeYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$BeforeYId.".YearId=".$BeforeYId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); } 
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$BeforeYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$BeforeYId.".YearId=".$BeforeYId." AND hrm_sales_seedsitem.GroupId=".$_REQUEST['crp'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP2d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$BeforeYId." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$BeforeYId.".YearId=".$BeforeYId, $con); }  } 
 }
}
...
if($_REQUEST['SteWise']>0)
{
 ...
 if($_REQUEST['crp']==3){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['yi']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['yi'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_headquater.StateId=".$_REQUEST['SteName']." AND hrm_sales_sal_details_".$_REQUEST['yi'].".YearId=".$_REQUEST['yi'], $con); }  } 
}
elseif($_REQUEST['ZoneWise']>0)
{
 if($_REQUEST['SelZone']>0)
 ...
 if($_REQUEST['SelZone']=='All')
 {
 if($_REQUEST['ii']>0){  $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['yi']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['yi'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['yi'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['yi'].".YearId=".$_REQUEST['yi']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); } 
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['yi']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['yi'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['yi'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['yi'].".YearId=".$_REQUEST['yi']." AND hrm_sales_seedsitem.GroupId=".$_REQUEST['crp'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['yi']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['yi'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['yi'].".YearId=".$_REQUEST['yi'], $con); }  } 
 }
...
elseif($_REQUEST['HqWise']>0)
{
 ...
 if($_REQUEST['SelHq']=='All')
 {
 if($_REQUEST['ii']>0){  $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['yi']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['yi'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['yi'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['yi'].".YearId=".$_REQUEST['yi']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); } 
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['yi']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['yi'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['yi'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['yi'].".YearId=".$_REQUEST['yi']." AND hrm_sales_seedsitem.GroupId=".$_REQUEST['crp'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP3d=mysql_query("select SUM(M1) as sM1,SUM(M2) as sM2,SUM(M3) as sM3,SUM(M4) as sM4,SUM(M5) as sM5,SUM(M6) as sM6,SUM(M7) as sM7,SUM(M8) as sM8,SUM(M9) as sM9,SUM(M10) as sM10,SUM(M11) as sM11,SUM(M12) as sM12 from hrm_sales_sal_details_".$_REQUEST['yi']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['yi'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['yi'].".YearId=".$_REQUEST['yi'], $con); }  } 
 }
}
...
elseif($_REQUEST['ZoneWise']>0)
{
 ...
 if($_REQUEST['SelZone']=='All')
 {
 if($_REQUEST['ii']>0){  $sqlP4d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); } 
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP4d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_seedsitem.GroupId=".$_REQUEST['crp'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP4d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId, $con); }  } 
 }
...
elseif($_REQUEST['HqWise']>0)
{
 ...
 if($_REQUEST['SelHq']=='All')
 {
 if($_REQUEST['ii']>0){  $sqlP4d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); } 
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP4d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$AfterYId.".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_seedsitem.GroupId=".$_REQUEST['crp'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP4d=mysql_query("select SUM(M1_Proj) as sM1,SUM(M2_Proj) as sM2,SUM(M3_Proj) as sM3,SUM(M4_Proj) as sM4,SUM(M5_Proj) as sM5,SUM(M6_Proj) as sM6,SUM(M7_Proj) as sM7,SUM(M8_Proj) as sM8,SUM(M9_Proj) as sM9,SUM(M10_Proj) as sM10,SUM(M11_Proj) as sM11,SUM(M12_Proj) as sM12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId, $con); }  } 
 }
}
...
if($_REQUEST['SteWise']>0)
{
 if($_REQUEST['ii']>0){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_headquater.StateId=".$_REQUEST['SteName']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); }
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_headquater.StateId=".$_REQUEST['SteName']." AND hrm_sales_seedsitem.GroupId=".$_REQUEST['crp']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_headquater.StateId=".$_REQUEST['SteName']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); }  } 
}
elseif($_REQUEST['ZoneWise']>0)
{
 if($_REQUEST['SelZone']>0)
 {
 if($_REQUEST['ii']>0){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelZone'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); }
  
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelZone'].") AND hrm_sales_seedsitem.GroupId=".$_REQUEST['crp']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelZone'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); }  } 
 }
 if($_REQUEST['SelZone']=='All')
 {
 if($_REQUEST['ii']>0){  $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); } 
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsitem.GroupId=".$_REQUEST['crp'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); }  } 
 }
...
elseif($_REQUEST['NameWise']>0)
{
 if($_REQUEST['SelName']>0)
 {
 if($_REQUEST['ii']>0){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelName'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); }
  
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelName'].") AND hrm_sales_seedsitem.GroupId=".$_REQUEST['crp']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelName'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); }  } 
 }
 if($_REQUEST['SelName']=='All')
 {
 if($_REQUEST['ii']>0){  $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); } 
...
elseif($_REQUEST['HqWise']>0)
{
 if($_REQUEST['SelHq']>0)
 {
 if($_REQUEST['ii']>0){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_dealer.HqId=".$_REQUEST['SelHq'], $con); } 
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId where hrm_sales_seedsitem.GroupId=".$_REQUEST['crp']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_dealer.HqId=".$_REQUEST['SelHq'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_dealer.HqId=".$_REQUEST['SelHq'], $con); }  } 
 }
 if($_REQUEST['SelHq']=='All')
 {
 if($_REQUEST['ii']>0){  $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii'], $con); } 
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsitem.GroupId=".$_REQUEST['crp'], $con); } 
 if($_REQUEST['crp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); }  } 
 }
}

elseif($_REQUEST['DisWise']>0)
{
 if($_REQUEST['ii']>0){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId where hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_seedsproduct.ItemId=".$_REQUEST['ii']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=".$_REQUEST['SelDis'], $con); } 
 else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_seedsproduct ON hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=hrm_sales_seedsproduct.ProductId INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId where hrm_sales_seedsitem.GroupId=".$_REQUEST['crp']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=".$_REQUEST['SelDis'], $con); } if($_REQUEST['crp']==3){ $sqlP5d=mysql_query("select SUM(M1_Ach) as sM1,SUM(M2_Ach) as sM2,SUM(M3_Ach) as sM3,SUM(M4_Ach) as sM4,SUM(M5_Ach) as sM5,SUM(M6_Ach) as sM6,SUM(M7_Ach) as sM7,SUM(M8_Ach) as sM8,SUM(M9_Ach) as sM9,SUM(M10_Ach) as sM10,SUM(M11_Ach) as sM11,SUM(M12_Ach) as sM12 from hrm_sales_sal_details_".$_REQUEST['YId']." where YearId=".$_REQUEST['YId']." AND DealerId=".$_REQUEST['SelDis'], $con); } } 
}
...
else{ if($_REQUEST['crp']==1 OR $_REQUEST['crp']==2){$sql = mysql_query("select hrm_sales_seedsproduct.ItemId,ProductId,ProductName,ItemName,TypeName from hrm_sales_seedsproduct INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_seedtype ON hrm_sales_seedsproduct.TypeId=hrm_sales_seedtype.TypeId where hrm_sales_seedsitem.GroupId=".$_REQUEST['crp']." order by ItemName ASC, TypeName ASC, ProductName ASC", $con);} if($_REQUEST['crp']==3){$sql = mysql_query("select hrm_sales_seedsproduct.ItemId,ProductId,ProductName,ItemName,TypeName from hrm_sales_seedsproduct INNER JOIN hrm_sales_seedsitem ON hrm_sales_seedsproduct.ItemId=hrm_sales_seedsitem.ItemId INNER JOIN hrm_sales_seedtype ON hrm_sales_seedsproduct.TypeId=hrm_sales_seedtype.TypeId order by hrm_sales_seedsitem.GroupId ASC, ItemName ASC, TypeName ASC, ProductName ASC", $con); }  }  $Sn=1; 
...
if($res1Tot1!=0){$Q11=$res1Tot1;}else{$Q11='';}
if($res1Tot2!=0){$Q12=$res1Tot2;}else{$Q12='';}
if($res1Tot3!=0){$Q13=$res1Tot3;}else{$Q13='';}
if($res1Tot4!=0){$Q14=$res1Tot4;}else{$Q14='';}
...
{ 
 ...
 if($_REQUEST['SelZone']=='All')
 {
  $sqlP2d=mysql_query("select SUM(M1_Ach) as tm1,SUM(M2_Ach) as tm2,SUM(M3_Ach) as tm3,SUM(M4_Ach) as tm4,SUM(M5_Ach) as tm5,SUM(M6_Ach) as tm6,SUM(M7_Ach) as tm7,SUM(M8_Ach) as tm8,SUM(M9_Ach) as tm9,SUM(M10_Ach) as tm10,SUM(M11_Ach) as tm11,SUM(M12_Ach) as tm12 from hrm_sales_sal_details_".$BeforeYId." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$BeforeYId.".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$BeforeYId.".YearId=".$BeforeYId, $con);
 }
}
elseif($_REQUEST['NameWise']>0)
{ 
...
{ 
 ...
 if($_REQUEST['SelHq']=='All')
 {
  $sqlP2d=mysql_query("select SUM(M1_Ach) as tm1,SUM(M2_Ach) as tm2,SUM(M3_Ach) as tm3,SUM(M4_Ach) as tm4,SUM(M5_Ach) as tm5,SUM(M6_Ach) as tm6,SUM(M7_Ach) as tm7,SUM(M8_Ach) as tm8,SUM(M9_Ach) as tm9,SUM(M10_Ach) as tm10,SUM(M11_Ach) as tm11,SUM(M12_Ach) as tm12 from hrm_sales_sal_details_".$BeforeYId." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$BeforeYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$BeforeYId.".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$BeforeYId.".YearId=".$BeforeYId, $con);
 }
}
elseif($_REQUEST['DisWise']>0)
...
if($res2Tot1!=0){$Q21=$res2Tot1;}else{$Q21='';}
if($res2Tot2!=0){$Q22=$res2Tot2;}else{$Q22='';}
if($res2Tot3!=0){$Q23=$res2Tot3;}else{$Q23='';}
if($res2Tot4!=0){$Q24=$res2Tot4;}else{$Q24='';}
...
{ 
 ...
 if($_REQUEST['SelZone']=='All')
 {
  $sqlP3d=mysql_query("select SUM(M1) as tm1,SUM(M2) as tm2,SUM(M3) as tm3,SUM(M4) as tm4,SUM(M5) as tm5,SUM(M6) as tm6,SUM(M7) as tm7,SUM(M8) as tm8,SUM(M9) as tm9,SUM(M10) as tm10,SUM(M11) as tm11,SUM(M12) as tm12 from hrm_sales_sal_details_".$_REQUEST['yi']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['yi'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['yi'].".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$_REQUEST['yi'].".YearId=".$_REQUEST['yi'], $con);
 }
}
elseif($_REQUEST['NameWise']>0)
{ 
...
{ 
  ...
  if($_REQUEST['SelHq']=='All')
  {
  $sqlP3d=mysql_query("select SUM(M1) as tm1,SUM(M2) as tm2,SUM(M3) as tm3,SUM(M4) as tm4,SUM(M5) as tm5,SUM(M6) as tm6,SUM(M7) as tm7,SUM(M8) as tm8,SUM(M9) as tm9,SUM(M10) as tm10,SUM(M11) as tm11,SUM(M12) as tm12 from hrm_sales_sal_details_".$_REQUEST['yi']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['yi'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['yi'].".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$_REQUEST['yi'].".YearId=".$_REQUEST['yi'], $con);
  }
}
elseif($_REQUEST['DisWise']>0)
...
if($res3Tot1!=0){$Q31=$res3Tot1;}else{$Q31='';}
if($res3Tot2!=0){$Q32=$res3Tot2;}else{$Q32='';}
if($res3Tot3!=0){$Q33=$res3Tot3;}else{$Q33='';}
if($res3Tot4!=0){$Q34=$res3Tot4;}else{$Q34='';}
...
{ 
 ...
 if($_REQUEST['SelZone']=='All')
 {
  $sqlP4d=mysql_query("select SUM(M1_Proj) as tm1,SUM(M2_Proj) as tm2,SUM(M3_Proj) as tm3,SUM(M4_Proj) as tm4,SUM(M5_Proj) as tm5,SUM(M6_Proj) as tm6,SUM(M7_Proj) as tm7,SUM(M8_Proj) as tm8,SUM(M9_Proj) as tm9,SUM(M10_Proj) as tm10,SUM(M11_Proj) as tm11,SUM(M12_Proj) as tm12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$AfterYId.".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId, $con);
 }
}
elseif($_REQUEST['NameWise']>0)
{ 
...
{ 
 ...
 $sqlP4d=mysql_query("select SUM(M1_Proj) as tm1,SUM(M2_Proj) as tm2,SUM(M3_Proj) as tm3,SUM(M4_Proj) as tm4,SUM(M5_Proj) as tm5,SUM(M6_Proj) as tm6,SUM(M7_Proj) as tm7,SUM(M8_Proj) as tm8,SUM(M9_Proj) as tm9,SUM(M10_Proj) as tm10,SUM(M11_Proj) as tm11,SUM(M12_Proj) as tm12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId." AND hrm_sales_sal_details_".$AfterYId.".ProductId=".$res['ProductId']." AND hrm_sales_dealer.HqId=".$_REQUEST['SelHq'], $con); 
  ...
  if($_REQUEST['SelHq']=='All')
  {
  $sqlP4d=mysql_query("select SUM(M1_Proj) as tm1,SUM(M2_Proj) as tm2,SUM(M3_Proj) as tm3,SUM(M4_Proj) as tm4,SUM(M5_Proj) as tm5,SUM(M6_Proj) as tm6,SUM(M7_Proj) as tm7,SUM(M8_Proj) as tm8,SUM(M9_Proj) as tm9,SUM(M10_Proj) as tm10,SUM(M11_Proj) as tm11,SUM(M12_Proj) as tm12 from hrm_sales_sal_details_".$AfterYId." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$AfterYId.".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$AfterYId.".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$AfterYId.".YearId=".$AfterYId, $con);
  }
}
elseif($_REQUEST['DisWise']>0)
...
if($res4Tot1!=0){$Q41=$res4Tot1;}else{$Q41='';}
if($res4Tot2!=0){$Q42=$res4Tot2;}else{$Q42='';}
if($res4Tot3!=0){$Q43=$res4Tot3;}else{$Q43='';}
if($res4Tot4!=0){$Q44=$res4Tot4;}else{$Q44='';}
...
if($_REQUEST['SteWise']>0 AND $_REQUEST['SteName']>0)
{ 
 $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_headquater ON hrm_sales_dealer.HqId=hrm_headquater.HqId where hrm_headquater.StateId=".$_REQUEST['SteName']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); 
}
elseif($_REQUEST['ZoneWise']>0)
{ 
 if($_REQUEST['SelZone']>0)
 {
 $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelZone']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelZone'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); 
 }
 if($_REQUEST['SelZone']=='All')
 {
  $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con);
 }
}
elseif($_REQUEST['NameWise']>0)
{ 
 if($_REQUEST['SelName']>0)
 {
 $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R1=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R2=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R3=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R4=".$_REQUEST['SelName']." OR hrm_sales_reporting_level.R5=".$_REQUEST['SelName'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con); 
 }
 if($_REQUEST['SelName']=='All')
 {
  $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_sales_reporting_level ON hrm_sales_hq_temp.EmployeeID=hrm_sales_reporting_level.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R1=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R2=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R3=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R4=".$_REQUEST['EmpId']." OR hrm_sales_reporting_level.R5=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con);
...
{ 
  if($_REQUEST['SelHq']>0)
  {
  $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId where hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=".$res['ProductId']." AND hrm_sales_dealer.HqId=".$_REQUEST['SelHq'], $con); 
  }
  if($_REQUEST['SelHq']=='All')
  {
  $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details_".$_REQUEST['YId']." INNER JOIN hrm_sales_dealer ON hrm_sales_sal_details_".$_REQUEST['YId'].".DealerId=hrm_sales_dealer.DealerId INNER JOIN hrm_sales_hq_temp ON hrm_sales_dealer.HqId=hrm_sales_hq_temp.HqId INNER JOIN hrm_employee_general ON hrm_sales_hq_temp.EmployeeID=hrm_employee_general.EmployeeID where HqTEmpStatus='A' AND (hrm_sales_hq_temp.EmployeeID=".$_REQUEST['EmpId']." OR hrm_employee_general.RepEmployeeID=".$_REQUEST['EmpId'].") AND hrm_sales_sal_details_".$_REQUEST['YId'].".ProductId=".$res['ProductId']." AND hrm_sales_sal_details_".$_REQUEST['YId'].".YearId=".$_REQUEST['YId'], $con);
  }
}
elseif($_REQUEST['DisWise']>0)
{ $sqlP5d=mysql_query("select SUM(M1_Ach) as tM1,SUM(M2_Ach) as tM2,SUM(M3_Ach) as tM3,SUM(M4_Ach) as tM4,SUM(M5_Ach) as tM5,SUM(M6_Ach) as tM6,SUM(M7_Ach) as tM7,SUM(M8_Ach) as tM8,SUM(M9_Ach) as tM9,SUM(M10_Ach) as tM10,SUM(M11_Ach) as tM11,SUM(M12_Ach) as tM12 from hrm_sales_sal_details_".$_REQUEST['YId']." where YearId=".$_REQUEST['YId']." AND ProductId=".$res['ProductId']." AND DealerId=".$_REQUEST['SelDis'], $con); }
...
if($res5Tot1!=0){$Q51=$res5Tot1;}else{$Q51='';}
if($res5Tot2!=0){$Q52=$res5Tot2;}else{$Q52='';}
if($res5Tot3!=0){$Q53=$res5Tot3;}else{$Q53='';}
if($res5Tot4!=0){$Q54=$res5Tot4;}else{$Q54='';}
