...
function FunRef(m,y,s,hq,md){ window.location="f_rsalarym.php?ac=2441&ee=2421&der=true2&c=false&trht=FTF%%F1&tt=valuased&m="+m+"&y="+y+"&filter=zero&s="+s+"&hq="+hq+"&dis=0&md="+md; }
function funmonth(m,y,s,hq,md)
{ window.location="f_rsalarym.php?ac=2441&ee=2421&der=true2&c=false&trht=FTF%%F1&tt=valuased&m="+m+"&y="+y+"&filter=zero&s="+s+"&hq="+hq+"&dis=0&md="+md; }
function funyear(y,m,s,hq,md)
{ window.location="f_rsalarym.php?ac=2441&ee=2421&der=true2&c=false&trht=FTF%%F1&tt=valuased&m="+m+"&y="+y+"&filter=zero&s="+s+"&hq="+hq+"&dis=0&md="+md;}
function funstate(s,m,y,md)
{ window.location="f_rsalarym.php?ac=2441&ee=2421&der=true2&c=false&trht=FTF%%F1&tt=valuased&m="+m+"&y="+y+"&filter=zero&s="+s+"&hq=0&dis=0&md="+md; }
  ...
  <td style="width:100%;" valign="top">  
   ...
   <tr>
	<td>
	 <table border="0">
		<tr>
	    <td class="htf2" align="left"><u>FA Salary Reports</u>&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<td class="tdf2" align="right"><?php if($resS['ActualSal']>0 OR $resS['ActualExp']){echo floatval($resS['ActualSal']+$resS['ActualExp']);} ?>&nbsp;</td>
...
<?php $sn++; } ?>
   <tr>
    ...
    <td colspan="11" style="font-family:Times New Roman;font-size:15px;font-weight:bold;">
     <?php doPages($offset, 'f_rsalarym.php', '', $total_records,$_REQUEST['hq'],$_REQUEST['s'],$_REQUEST['m'],$_REQUEST['y'],$_REQUEST['md']); ?>
    </td>
   </tr>
<?php } ?> 
