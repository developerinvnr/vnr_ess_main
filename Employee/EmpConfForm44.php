...
{ 
 ...
 { 
  ...
  { 
   ...
   $email_message3 .="Confirmation of ".$_POST['EmpName']." is ".$ssts." by Reporting Mgr(".$_POST['RepName']."), for more details kindly log on to ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>  .\n\n";
...
$sqlL=mysql_query("select * from hrm_employee_confletter where Status='A' and Recommendation=1 AND EmployeeID=".$id, $con);  $rowL=mysql_num_rows($sqlL); if($rowL>0){$resL=mysql_fetch_assoc($sqlL);} 
?>
  <table border="0">
    <tr>
	 ...
	 <tr>
	  <td>
	   <table border="0">
		 ...
		 <td align="center" style="width:45px;" id="TdR1"><input type="radio" name="RAT" id="R1" value="1" <?php if($resL['Rating']==1){echo 'checked';} ?> onClick="FunRAT(this.value)" disabled/></td>
		 ...
		 <td align="center" style="width:45px;" id="TdR2"><input type="radio" name="RAT" id="R2" value="2" <?php if($resL['Rating']==2){echo 'checked';} ?> onClick="FunRAT(this.value)" disabled/></td>
		 <td style="width:40px;" rowspan="2"></td>
		 <td class="font1" style="width:80px;color:<?php if($resL['Rating']==2.5){echo '#FF3300';} ?>;"><b>2.5</b>&nbsp;Satisfactory</td>
		 <td align="center" style="width:45px;" id="TdR3"><input type="radio" name="RAT" id="R3" value="2.5" <?php if($resL['Rating']==2.5){echo 'checked';} ?> onClick="FunRAT(this.value)" disabled/></td>
		 <td style="width:40px;" rowspan="2"></td>
		 <td class="font1" style="width:70px;color:<?php if($resL['Rating']==3){echo '#FF3300';} ?>;"><b>3</b>&nbsp;Competent</td>
		 <td align="center" style="width:45px;" id="TdR4"><input type="radio" name="RAT" id="R4" value="3" <?php if($resL['Rating']==3){echo 'checked';} ?> onClick="FunRAT(this.value)" disabled/></td>
		 <td style="width:240px;"></td>
	 </tr>
	 <tr>
	     <td style="width:30px;"></td>
	     <td class="font1" style="width:110px;color:<?php if($resL['Rating']==3.5){echo '#FF3300';} ?>;"><b>3.5</b>&nbsp;Commendable</td>
		 <td align="center" style="width:45px;" id="TdR5"><input type="radio" name="RAT" id="R5" value="3.5" <?php if($resL['Rating']==3.5){echo 'checked';} ?> onClick="FunRAT(this.value)" disabled/></td>
		 <td class="font1" style="width:140px;color:<?php if($resL['Rating']==4){echo '#FF3300';} ?>;"><b>4</b>&nbsp;Extraordinary</td>
		 <td align="center" style="width:45px;" id="TdR6"><input type="radio" name="RAT" id="R6" value="4" <?php if($resL['Rating']==4){echo 'checked';} ?> onClick="FunRAT(this.value)" disabled/></td>
		 <td class="font1" style="width:80px;color:<?php if($resL['Rating']==4.5){echo '#FF3300';} ?>;"><b>4.5</b>&nbsp;Outstanding</td>
		 <td align="center" style="width:45px;" id="TdR7"><input type="radio" name="RAT" id="R7" value="4.5" <?php if($resL['Rating']==4.5){echo 'checked';} ?> onClick="FunRAT(this.value)" disabled/></td>
		 <td class="font1" style="width:70px;color:<?php if($resL['Rating']==5){echo '#FF3300';} ?>;"><b>5</b>&nbsp;Exemplary</td>
		 <td align="center" style="width:45px;" id="TdR8"><input type="radio" name="RAT" id="R8" value="5" <?php if($resL['Rating']==5){echo 'checked';} ?> onClick="FunRAT(this.value)" disabled/></td>
		 <td style="width:240px;"></td>
	 </tr>
	   </table>
	  </td>
...
<?php if($res['DateConfirmation']=='N'){ if($rowL==0 OR $resL['SubmitStatus']=='N' OR $res['ConfirmHR']=='YY' OR ($rowL>0 AND date("Y-m-d")>=$Before15Day_1 AND $resL['Recommendation']==2 AND $resL['SubmitStatus']=='Y')){ ?>
