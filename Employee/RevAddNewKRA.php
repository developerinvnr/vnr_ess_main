  ...
  $TotalWeight=$_POST['WWeightage_1']+$_POST['WWeightage_2']+$_POST['WWeightage_3']+$_POST['WWeightage_4']+$_POST['WWeightage_5']+$_POST['WWeightage_6']+$_POST['WWeightage_7']+$_POST['WWeightage_8']+$_POST['WWeightage_9']+$_POST['WWeightage_10']+$_POST['WWeightage_11']+$_POST['WWeightage_12']+$_POST['WWeightage_13']+$_POST['WWeightage_14']+$_POST['WWeightage_15'];
      ...
      if($sqlSaveK)
	  {
	   ...
	   if($TotalWeight==100)
       {
	    ...
	    { 
		  $sqlU=mysql_query("update hrm_pms_kra set KRAStatus='A',UseKRA='H',RevStatus='A' where YearId=".$_SESSION['KraYId']." AND EmployeeID=".$_REQUEST['e'], $con); 
...
{ var c=document.getElementById("ComId").value; 
  var win = window.open("setkrarevtgtformb.php?act=setkratgt&n=1&valueins=true&checkalpha=false&d=12&pa=4&y=2&fbid="+fbid+"&prd="+prd+"&yy=t1t&tgt="+tgt+"&e="+e+"&lgc="+lgc+"&wgt="+wgt+"&yid="+yid+"&c="+c, "QForm", "menubar=no,scrollbars=yes,resizable=no,directories=no,width=1200,height=600"); 
}

function FunFormBSubTgt(e,yid,fbid,prd,tgt,wgt,lgc)
{ var c=document.getElementById("ComId").value; 
  var win = window.open("setkrarevtgtformb.php?act=setkratgt&n=2&valueins=true&checkalpha=false&d=12&pa=4&y=2&fbid="+fbid+"&prd="+prd+"&yy=t1t&tgt="+tgt+"&e="+e+"&lgc="+lgc+"&wgt="+wgt+"&yid="+yid+"&c="+c, "QForm", "menubar=no,scrollbars=yes,resizable=no,directories=no,width=1200,height=600"); 
} 
	 ...
	 <td colspan="7" style="width:98%;">
	  <table border="0" style="width:100%;">
	   <tr>
		...
		<input type="button" name="back" id="back" style="width:100%;" value="back" onClick="javascript:window.location='RevCheckNewKRA.php?ee=1&aa=1&rr=0&hh=1&sh=1&hp=1&fr=1&kr=0&fq=1&prt=1&msg=1&pd=1&mt=1&mts=1&scr=1&prom=1&inc=1&incr=1&pmsr=1&rg=1&h=1&fachiv=1&fa=1&fb=1&ffeedb=1&org=1'"/></td>
		...
		<td class="tdr" style="width:130px;"><?php if($row>0){ ?><input type="button" name="EditK" id="EditK" style="width:100%;" value="Edit" <?php if($row2>0){echo 'disabled';} ?> onClick="EditKRAvalue()"/><input type="Submit" name="EditKRA" id="EditKRA" style="width:100%;display:none;" value="save"/><?php } ?></td>
	   </tr>
	  </table>
	 </td>	  
    </tr>
   ...
   <td colspan="8" style="width:98%;">
	...
	<input type="hidden" id="KraIdNo_<?php echo $k; ?>"><input type="hidden" name="KId_<?php echo $k; ?>" value="<?php echo $res['KRAId']; ?>"><input type="hidden" id="SubKraRow_<?php echo $k; ?>" value="<?php echo $rowSubK; ?>">
     <tr bgcolor="#FFFFFF">   
      ...
      <td class="tdc" style="width:80px;"><?php if($rowSubK>0){?><input type="hidden" style="width:100%;" name="Logic_<?php echo $k; ?>" id="Logic_<?php echo $k; ?>" value="" readonly><?php }else{?><select name="Logic_<?php echo $k; ?>" id="Logic_<?php echo $k; ?>" class="Input" style="width:100%;" readonly><option value="<?php echo $res['Logic']; ?>"><?php echo $res['Logic']; ?></option><option value="Logic1">Logic1</option><option value="Logic2">Logic2</option><option value="Logic2a">Logic2a</option><option value="Logic3">Logic3</option><option value="Logic4">Logic4</option><option value="Logic5">Logic5</option><option value="Logic6">Logic6 - Sales</option><option value="Logic7">Logic7 - Sales</option><option value="Logic8a">Logic8a - Production</option><option value="Logic8b">Logic8b - Production</option><option value="Logic8c">Logic8c - Production</option><option value="Logic8d">Logic8d - Production</option><option value="Logic8e">Logic8e - Production</option><option value="Logic9">Logic9 - Production</option><option value="Logic10">Logic10 - Production</option><option value="Logic11">Logic11</option><option value="Logic12">Logic12</option><option value="Logic13a">Logic13a - Production</option><option value="Logic13b">Logic13b - Production</option><option value="Logic14a">Logic14a - Production</option><option value="Logic14b">Logic14b - Production</option><option value="Logic15a">Logic15a - Production</option><option value="Logic15b">Logic15b - Production</option><option value="Logic15c">Logic15c - Production</option><option value="Logic16">Logic16 - Production</option><option value="Logic17">Logic17 - Production</option></select><?php } ?></td>
...
<?php /* While Open*/ $m=1; while($rSubK=mysql_fetch_assoc($sSubK)){ ?>
  ...
  <td align="center" style="background-color:##FFF;"><select id="Log_a<?php echo $k.'_'.$m; ?>" class="Inputa" style="width:100%; height:20px;"><option value="<?php echo $rSubK['Logic']; ?>" selected><?php echo $rSubK['Logic']; ?></option><option value="Logic1">Logic1</option><option value="Logic2">Logic2</option><option value="Logic2a">Logic2a</option><option value="Logic3">Logic3</option><option value="Logic4">Logic4</option><option value="Logic5">Logic5</option><option value="Logic6">Logic6 - Sales</option><option value="Logic7">Logic7 - Sales</option><option value="Logic8a">Logic8a - Production</option><option value="Logic8b">Logic8b - Production</option><option value="Logic8c">Logic8c - Production</option><option value="Logic8d">Logic8d - Production</option><option value="Logic8e">Logic8e - Production</option><option value="Logic9">Logic9 - Production</option><option value="Logic10">Logic10 - Production</option><option value="Logic11">Logic11</option><option value="Logic12">Logic12</option><option value="Logic13a">Logic13a - Production</option><option value="Logic13b">Logic13b - Production</option><option value="Logic14a">Logic14a - Production</option><option value="Logic14b">Logic14b - Production</option><option value="Logic15a">Logic15a - Production</option><option value="Logic15b">Logic15b - Production</option><option value="Logic15c">Logic15c - Production</option><option value="Logic16">Logic16 - Production</option><option value="Logic17">Logic17 - Production</option></select></td>
...
<?php if($row2==0){ for($mm=$m; $mm<=5; $mm++){ ?>
  ...
  <td class="tdc"><select id="Log_a<?php echo $k.'_'.$mm; ?>" class="Inputa" style="width:100%; height:20px;"><option value="Logic1">Logic1</option><option value="Logic2">Logic2</option><option value="Logic2a">Logic2a</option><option value="Logic3">Logic3</option><option value="Logic4">Logic4</option><option value="Logic5">Logic5</option><option value="Logic6">Logic6 - Sales</option><option value="Logic7">Logic7 - Sales</option><option value="Logic8a">Logic8a - Production</option><option value="Logic8b">Logic8b - Production</option><option value="Logic8c">Logic8c - Production</option><option value="Logic8d">Logic8d - Production</option><option value="Logic8e">Logic8e - Production</option><option value="Logic9">Logic9 - Production</option><option value="Logic10">Logic10 - Production</option><option value="Logic11">Logic11</option><option value="Logic12">Logic12</option><option value="Logic13a">Logic13a - Production</option><option value="Logic13b">Logic13b - Production</option><option value="Logic14a">Logic14a - Production</option><option value="Logic14b">Logic14b - Production</option><option value="Logic15a">Logic15a - Production</option><option value="Logic15b">Logic15b - Production</option><option value="Logic15c">Logic15c - Production</option><option value="Logic16">Logic16 - Production</option><option value="Logic17">Logic17 - Production</option></select></td>
  <td class="tdc">
...
<tr id="TR_<?php echo $i; ?>">	
  ...
  <td colspan="8" style="width:98%;">
   <table id="Row_<?php echo $i; ?>" style="width:100%;" bgcolor="#FFFFFF" border="1" cellspacing="0"> 
    <tr bgcolor="#FFFFFF">                                          
     ...
     <td class="tdc" style="width:80px;"><select name="Logic_<?php echo $i; ?>" id="Logic_<?php echo $i; ?>" class="Input" style="width:100%;" onChange="ChangeLogic(<?php echo $i; ?>)"><option value="Logic1">Logic1</option><option value="Logic2">Logic2</option><option value="Logic2a">Logic2a</option><option value="Logic3">Logic3</option><option value="Logic4">Logic4</option><option value="Logic5">Logic5</option><option value="Logic6">Logic6 - Sales</option><option value="Logic7">Logic7 - Sales</option><option value="Logic8a">Logic8a - Production</option><option value="Logic8b">Logic8b - Production</option><option value="Logic8c">Logic8c - Production</option><option value="Logic8d">Logic8d - Production</option><option value="Logic8e">Logic8e - Production</option><option value="Logic9">Logic9 - Production</option><option value="Logic10">Logic10 - Production</option><option value="Logic11">Logic11</option><option value="Logic12">Logic12</option><option value="Logic13a">Logic13a - Production</option><option value="Logic13b">Logic13b - Production</option><option value="Logic14a">Logic14a - Production</option><option value="Logic14b">Logic14b - Production</option><option value="Logic15a">Logic15a - Production</option><option value="Logic15b">Logic15b - Production</option><option value="Logic15c">Logic15c - Production</option><option value="Logic16">Logic16 - Production</option><option value="Logic17">Logic17 - Production</option></select></td>
 ...
 <tr id="TR_<?php echo $i; ?>">
  ...
  <option value="Kg">Kg</option><option value="Ton">Ton</option><option value="MT">MT</option><option value="Kg/Acre">Kg/Acre</option><option value="Number">Number</option><option value="Lakhs">Lakhs</option><option value="Rs.">Rs.</option><option value="MT">MT</option><option value="INR">INR</option><option value="None">None</option></select></td>
     ...
     <td class="tdc" style="width:85px;"><select name="Logic_<?php echo $i; ?>" id="Logic_<?php echo $i; ?>" class="Input" style="width:100%;" onChange="ChangeLogic(<?php echo $i; ?>)"><option value="Logic1">Logic1</option><option value="Logic2">Logic2</option><option value="Logic2a">Logic2a</option><option value="Logic3">Logic3</option><option value="Logic4">Logic4</option><option value="Logic5">Logic5</option><option value="Logic6">Logic6 - Sales</option><option value="Logic7">Logic7 - Sales</option><option value="Logic8a">Logic8a - Production</option><option value="Logic8b">Logic8b - Production</option><option value="Logic8c">Logic8c - Production</option><option value="Logic8d">Logic8d - Production</option><option value="Logic8e">Logic8e - Production</option><option value="Logic9">Logic9 - Production</option><option value="Logic10">Logic10 - Production</option><option value="Logic11">Logic11</option><option value="Logic12">Logic12</option><option value="Logic13a">Logic13a - Production</option><option value="Logic13b">Logic13b - Production</option><option value="Logic14a">Logic14a - Production</option><option value="Logic14b">Logic14b - Production</option><option value="Logic15a">Logic15a - Production</option><option value="Logic15b">Logic15b - Production</option><option value="Logic15c">Logic15c - Production</option><option value="Logic16">Logic16 - Production</option><option value="Logic17">Logic17 - Production</option></select></td>
