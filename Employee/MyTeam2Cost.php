...
<input type="submit" name="SaveValue" id="save" value="Save" style="font-family:Times New Roman;font-size:12px;width:60px;background-color:#88D28C;display:none;" />
		     ...
		     <td colspan="3" rowspan="2" align="center"  valign="middle" style="color:#FFFFFF;font-size:11px; height:20px; "><b>PROPOSED PER MONTH</b></td>
			  ...
			  <tr bgcolor="#7a6189">
			   ...
			   <td align="center" style="color:#FFFFFF;" class="All_120"><b>INCREMENT<br>GROSS</b></td>
...
?>		  				
              <td align="center"><input style="border-style:hidden; border:0;width:100px;text-align:right;font-weight:bold;font-size:11px;background-color:#C5FF8A;" id="UnE_PIS" name="UnE_PIS" value="<?php echo $IncpGross; ?>" readonly/></td>
              <td align="center"><input style="border-style:hidden; border:0;width:58px;text-align:center;font-weight:bold;background-color:#C5FF8A; font-size:11px;" id="UnE_PerPIS" name="UnE_PerPIS" value="<?php echo 30; ?>" readonly/></td>
			  <td align="center"><input style="border-style:hidden; border:0;width:100px;text-align:right;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnE_PerIncS" name="UnE_PerIncS" value="<?php echo $Un_IncS; ?>" readonly/></td>	
<?php /**************************************** Dummy Close *********************************/ ?>
<?php /**************************************** Dummy Close *********************************/ ?>		  		

<?php /******************* Un-HOD Actual Total Value Start *********************************/ ?>		
<?php /********************** Un-HOD Actual Total Value Start *********************************/ ?>			   		
			   <td align="center"><input style="border-style:hidden; border:0;width:100px;text-align:right;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnPISth" name="UnPISth" value="<?php echo '';//$IncpGross; ?>" readonly/></td>
			     
			   <td align="center"></td>
			   <td align="center"><input style="border-style:hidden; border:0;width:100px;text-align:right;;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnIncSth" name="UnIncSth" value="<?php echo '';//$IncpGross; ?>" readonly/></td>	
			   
			   <td align="center"><input style="border-style:hidden; border:0;width:58px;text-align:center;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnPerISth" name="UnPerISth" value="<?php echo '';//30; ?>" readonly/></td>
			   <td align="center"></td>	
			   
			   <td align="center"><input style="border-style:hidden; border:0;width:58px;text-align:center;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnPerISth" name="UnPerISth" value="<?php echo '';//30; ?>" readonly/></td>
			   <td align="center"><input style="border-style:hidden; border:0;width:100px;text-align:right;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnIncSth" name="UnIncSth" value="<?php echo '';//$Un_IncS; ?>" readonly /></td>	
