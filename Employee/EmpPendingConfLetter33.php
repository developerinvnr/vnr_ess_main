...
?> 			
            <tr bgcolor="#FFFFFF">
		     ...
		     <td style="font-family:Georgia; font-size:11px; width:150px;" align="">&nbsp;<?php echo $ResDept['DepartmentCode']; ?></td>
 		     <td style="font-family:Georgia; font-size:11px; width:250px;" align="">&nbsp;<?php echo $ResDesig['DesigName']; ?>
			 <?php echo $rowRec.'-'.$resRec['Recommendation'].'-'.$resRec['SubmitStatus']; ?>
			 </td>
<?php
if(($ResRep['DepartmentId']==6 OR $ResRep['DepartmentId']==19 OR $ResRep['DepartmentId']==3 OR $ResRep['DepartmentId']==4 OR $ResRep['DepartmentId']==21 OR $ResRep['DepartmentId']==25 OR $ResRep['DepartmentId']==24 OR $ResRep['DepartmentId']==12 OR $ResRep['DepartmentId']==2 OR $ResRep['DepartmentId']==11) AND ($ResRep['DesigId']==71 OR $ResRep['DesigId']==137 OR $ResRep['DesigId']==139 OR $ResRep['DesigId']==169 OR $ResRep['DesigId']==174 OR $ResRep['DesigId']==175 OR $ResRep['DesigId']==176 OR $ResRep['DesigId']==177 OR $ResRep['DesigId']==178 OR $ResRep['DesigId']==180 OR $ResRep['DesigId']==182 OR $ResRep['DesigId']==187 OR $ResRep['DesigId']==252 OR $ResRep==286 OR $ResRep['DesigId']==180 OR $ResRep['DesigId']==287 OR $ResRep['DesigId']==296 OR $ResRep['DesigId']==290 OR $ResRep['DesigId']==291 OR $ResRep['DesigId']==300 OR $ResRep['DesigId']==304 OR $ResRep['DesigId']==307 OR $ResRep['DesigId']==308))
...
<?php } else { if($ResRep['EmployeeID']==345){ ?><a href="EmpConfForm.php?e=<?php echo $ResRep['EmployeeID']; ?>&c=1&cd=0000000&d=<?php echo $ResRep['DepartmentId']; ?>"><font color="#3A7500">Delay</font></a><?php } else {echo '<font color="#3A7500">Delay</font>';} } ?></td>
