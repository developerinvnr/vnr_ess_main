...
<td class="font2" valign="top" bgcolor="#8CC6FF"><b>Reporting Action</b></td>
<td class="font2" valign="top">:</td>
<td class="font2"><input id="MyAct" name="MyAct" class="font2" style="border:hidden;width:100px;background-color:#8FFF20;" <?php if($rE['SStatus']==0){$StO='Draft';}elseif($rE['SStatus']==1){$StO='Pending';}elseif($rE['SStatus']==2){$StO='Approved';}elseif($rE['SStatus']==3){$StO='Rejected';}?> value="<?php echo $StO; ?>" /></td>
</tr>
