...
<td style="width:50px;" align="center"><input class="DIT" id="EnCashEL" name="EnCashEL" onChange="FunEnCash()" onBlur="FunEnCash()" onClick="FunEnCash()" value="<?php if($hr['EnCashEL']>0){echo $hr['EnCashEL'];}else{echo 0;} ?>" maxlength="2" readonly/></td>
   ...
   <table border="1">
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="NPS_Ded" name="NPS_Ded" value="<?php if($hr['NPS_Ded']>0){echo intval($hr['NPS_Ded']);}else{echo 0;} ?>" readonly/></td>
	</tr>
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <td class="Text" align="center"><input class="AIT" id="TotDeduct" name="TotDeduct" style="font-weight:bold;background-color:#0079F2;color:#FFFFFF;" value="<?php echo $hr['PF']+$hr['ESIC']+$hr['ARR_ESIC']+$hr['RTSB']+$hr['NPS_Ded']+$hr['NPR']+$hr['VolC']+$hr['RA_allow']+$hr['AdminIC_Amt']+$hr['AdminVC_Amt']+$hr['CV_Amt']; ?>" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
