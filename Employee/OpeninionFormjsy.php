...
{ 
 ...
 else
 {
  ...
  if(agree)
  { 
   var url = 'Opinion.php'; var pars = 'action=resultopnjsy&ei='+ei+'&ci='+ci+'&cast='+document.getElementById("selcast").value+'&iother='+document.getElementById("iother").value+'&sche1='+document.getElementById("sche1").value+'&sche2='+document.getElementById("sche2").value+'&sche3='+document.getElementById("sche3").value+'&sche4='+document.getElementById("sche4").value;
...
<tr>
 <td>
  ...
  &nbsp; <input type="checkbox" id="chk1" onClick="FunCheck(1,'General')"> General<br>
  &nbsp; <input type="checkbox" id="chk2" onClick="FunCheck(2,'OBC')"> OBC<br>
  &nbsp; <input type="checkbox" id="chk3" onClick="FunCheck(3,'SC')"> SC<br>
  &nbsp; <input type="checkbox" id="chk4" onClick="FunCheck(4,'ST')"> ST<br>
  &nbsp; <input type="checkbox" id="chk5" onClick="FunCheck(5,'Any Other')"> Any Other &nbsp;<input type="text" id="iother" style="width:200px;background-color:#FFAEFF;border-left:hidden;border-right:hidden;border-top:hidden; border-bottom-color:#000000;border-bottom-style:solid;" maxlength="15" readonly/>
  <p><br><input type="hidden" id="selcast" value="" />
  ...
  &nbsp; <input type="checkbox" id="ch3" onClick="FunCh(3,'APY')"> Atal Pension Yojna (APY)<br>
  &nbsp; <input type="checkbox" id="ch1" onClick="FunCh(1,'PMJJBY')"> Pradhan Mantri Jeevan Jyoti Bima Yojna (PMJJBY)<br>
  &nbsp; <input type="checkbox" id="ch2" onClick="FunCh(2,'PMSBY')"> Pradhan Mantri Suraksha Bima Yojna (PMSBY)<br>
  &nbsp; <input type="checkbox" id="ch4" onClick="FunCh(4,'NDS')"> Not opted for above Schemes<br>
  <p>
  <input type="hidden" id="sche1" value="" /><input type="hidden" id="sche2" value="" />
  <input type="hidden" id="sche3" value="" /><input type="hidden" id="sche4" value="" />
 </td>
</tr>
