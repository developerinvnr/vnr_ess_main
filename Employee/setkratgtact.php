...
{
 $up=mysql_query("update hrm_pms_kra_tgtdefin set Ach='".$_POST['ach']."', Cmnt='".addslashes($_POST['cmnt'])."', LogScr='".$_POST['logscr']."', Scor='".$_POST['scor']."' where TgtDefId=".$_POST['id'],$con);
 if($up)
 { 
