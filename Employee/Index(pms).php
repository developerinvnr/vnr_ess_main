...
if (agree) { var x = "Index.php?action=submit&log=@4323yy6twecdsayaEay456ad";  window.location=x;}}	
...
function KRAOpenWindow()
{var CI=document.getElementById("ComId").value; var YI=document.getElementById("YId").value;
 window.open("KRASchedule.php?C="+CI+"&Y="+YI,"Schedule","menubar='no',resizable=1,width=850,height=350");}

function OpenHelpfile(value)
{window.open("HelpFile.php?a=open&v="+value,"HelpFile","width=800,height=650"); }

function OpenFaqfile(value)
{window.open("HelpFile.php?a=FaqOpen&v="+value,"HelpFile","width=800,height=650"); }

function OpenKRAHelpfile(value)
{window.open("KRAHelpFile.php?a=open&v="+value,"HelpFile","width=800,height=650"); }

function OpenKRAFaqfile(value)
{window.open("KRAHelpFile.php?a=FaqOpen&v="+value,"HelpFile","width=800,height=650"); }
...
{ window.open ("EmpKraFormPrint.php?YId="+YId+"&EmpId="+EmpId+"&CId="+CId,"KRAForm","menubar=yes,scrollbars=yes,resizable=1,width=1170,height=500");}
...
<?php $sql3=mysql_query("select * from hrm_pms_kra where YearId=2 AND EmployeeID=".$EmployeeId." AND (KRAStatus='A' OR KRAStatus='R') AND (UseKRA='E' OR UseKRA='A' OR UseKRA='R' OR UseKRA='H')", $con); $row3=mysql_num_rows($sql3); 
    ...
    <td width="1200">
	  <table border="0">
	    <tr> 
         ...
         <a href="Index.php?log=<?php echo $_SESSION['logCheckEmp']; ?>"><font color="#FFFFFF">Personal_Details</font></a></td><?php } ?>
		 <?php if($resKey['Schedule']=='Y') { ?>
		 <td align="center" style="font-family:Times New Roman; font-size:14px; font-weight:bold;width:120px;">
         <?php if($resKey['AppraisalForm']=='Y') { ?><a href="javascript:OpenWindow()"><font color="#620000">Schedule</font></a><?php } ?>
		 <?php if($resKey['KRAForm']=='Y') { ?><a href="javascript:KRAOpenWindow()"><font color="#620000">KRA Schedule</font></a><?php } ?>
		 </td>
		 <?php } ?>        			   
		 <?php if($resKey['AppraisalForm']=='Y') { ?><td align="center" style="font-family:Times New Roman; font-size:14px; font-weight:bold;width:100px;">
...
<a href="EmpPmsAppForm.php"><font color="#620000">Appraisal_Form</font></a><?php }?></td><?php } ?>
		 <?php if($resKey['Help_Faq']=='Y') { ?>
		 <td align="center" style="font-family:Times New Roman; font-size:14px; font-weight:bold;width:100px;">	
		 <?php if($resKey['AppraisalForm']=='Y') { ?><a href="#" onClick="OpenHelpfile('help')"><font color="#620000">Help</font></a>&nbsp;/&nbsp;
		 <a href="#" onClick="OpenFaqfile('faq')"><font color="#620000">FAQ</font></a><?php } ?>
		 <?php if($resKey['KRAForm']=='Y') { ?>
		 <?php if($RD['DepartmentId']!=6) { ?><a href="#" onClick="OpenKRAHelpfile('krahelp')"><font color="#620000">Help</font></a><?php } }?>		 	 
		 </td>
		 <?php } ?> 
         ...
         <a href="#" onClick="printpage(<?php echo $resPmsId['EmpPmsId'].','.$EmployeeId; ?>)"/><font color="#004F00">View/ Print My Form</font></a><?php } ?> 
		 </td>
		 <?php } ?>
<?php $sql=mysql_query("select * from hrm_pms_kra where YearId=2 AND CompanyId=".$CompanyId." AND EmployeeID=".$EmployeeId." AND (KRAStatus='R' OR KRAStatus='A') order by KRAId ASC", $con);  $row=mysql_num_rows($sql); if($row>0){$resRe=mysql_fetch_assoc($sql);}
$sqlPm=mysql_query("select ExtraAllowKRA from hrm_employee_pms where EmployeeId=".$EmployeeId." AND AssessmentYear=2", $con); $resPm=mysql_fetch_assoc($sqlPm);
?>			 
		 <?php if($resKey['KRAForm']=='Y') { ?>	  
<?php if(($CuDate>=$resSch['EmpFromDate'] AND $CuDate<=$resSch['EmpToDate'] AND $resSch['EmpDateStatus']=='A') OR ($CuDate>=$resSch['AppFromDate'] AND $CuDate<=$resSch['AppToDate'] AND $resSch['AppDateStatus']=='A' AND $resRe['EmpStatus']=='P' AND $resRe['AppStatus']=='R') OR ($CuDate>=$resSch['RevFromDate'] AND $CuDate<=$resSch['RevToDate'] AND $resSch['RevDateStatus']=='A' AND $resRe['EmpStatus']=='P' AND $resRe['AppStatus']=='R' AND $resRe['RevStatus']=='R') OR ($CuDate>=$resSch['HodFromDate'] AND $CuDate<=$resSch['HodToDate'] AND $resSch['HodDateStatus']=='A' AND $resRe['EmpStatus']=='P' AND $resRe['AppStatus']=='R' AND $resRe['RevStatus']=='R' AND $resRe['HODStatus']=='R') OR $resPm['ExtraAllowKRA']==1){ ?> 			 			
         <td style="font-family:Times New Roman;width:250px; font-size:14px; font-weight:bold;" valign="middle">
<?php if($RD['DepartmentId']!=4) { ?><a href="EmpAddNewKRA.php"/><font color="#004F00">KRA for Assessment Year 2012-13</font></a><?php } ?></td>
<?php }?>

         <td width="10">&nbsp;</td>		 
		 <td style="font-family:Times New Roman;width:180px; font-size:14px; font-weight:bold;" valign="middle">
    <?php if($row>0) { ?><a href="#" onClick="printpageKRA(<?php echo $CompanyId.', 2,'.$EmployeeId; ?>)"/><font color="#004F00">Print/Save KRA</font></a><?php } ?>
		 </td>		 
        <?php } ?>
...
<?php if($_SESSION['EmpType']=='E') {?>
 ...
 <tr bgcolor="#FFFFFF">
	<td style="color:#00376F;font-family:Times New Roman; width:140px; font-size:14px;font-weight:bold;">Name :</td>
	<td style="font-family:Times New Roman; width:250px; font-size:14px;"><?php echo $NameE; ?></td>
	<td style="color:#00376F;font-family:Times New Roman; width:120px; font-size:14px;font-weight:bold; ">EmpCode :</td>
	<td style="font-family:Times New Roman; width:250px; font-size:14px;"><?php echo $EmpCode; ?></td>
	<td style="color:#00376F;font-family:Times New Roman; width:120px; font-size:14px;font-weight:bold; ">Department :</td>
<?php $sqlD=mysql_query("select DepartmentCode from hrm_department where DepartmentId=".$_SESSION['DepartmentId'], $con); $resD=mysql_fetch_assoc($sqlD); ?>	
	<td style="font-family:Times New Roman; width:250px; font-size:14px;"><?php echo $resD['DepartmentCode']; ?></td>
 </tr>
 <tr bgcolor="#FFFFFF">
	<td style="color:#00376F;font-family:Times New Roman; width:140px; font-size:14px;font-weight:bold; ">Designation :</td>
<?php $sqlDe=mysql_query("select DesigName from hrm_designation where DesigId=".$_SESSION['DesigId'], $con); $resDe=mysql_fetch_assoc($sqlDe); ?>		
	<td style="font-family:Times New Roman; width:250px; font-size:14px;"><?php echo $resDe['DesigName']; ?></td>
    <td style="color:#00376F;font-family:Times New Roman; width:120px; font-size:14px;font-weight:bold; ">Grade :</td>
<?php $sqlG=mysql_query("select GradeValue from hrm_grade where GradeId=".$_SESSION['GradeId'], $con); $resG=mysql_fetch_assoc($sqlG); ?>		
	<td style="font-family:Times New Roman; width:250px; font-size:14px;"><?php echo $resG['GradeValue']; ?></td>
	<td style="color:#00376F;font-family:Times New Roman; width:120px; font-size:14px;font-weight:bold; ">Head Quarter :</td>
<?php $sqlH=mysql_query("select HqName from hrm_headquater where HqId=".$_SESSION['HqId'], $con); $resH=mysql_fetch_assoc($sqlH); ?>		
	<td style="font-family:Times New Roman; width:250px; font-size:14px;"><?php echo $resH['HqName']; ?></td>
 </tr>
...
?> 
 <tr bgcolor="#FFFFFF">
	<td style="color:#00376F;font-family:Times New Roman; width:140px; font-size:14px;font-weight:bold; ">Assessment Year :</td>		
	<?php $to=$fromdate-1; ?>
	<td style="font-family:Times New Roman; width:250px; font-size:14px;f"><?php if($CompanyId==2){echo $to.'-'.$fromdate; } elseif($CompanyId==1){echo '2012-2013';} ?></td>
    <td style="color:#00376F;font-family:Times New Roman; width:120px; font-size:14px;font-weight:bold;">DOJ :</td>
<?php $sqlJ=mysql_query("select DateJoining from hrm_employee_general where EmployeeID=".$EmployeeId, $con); $resJ=mysql_fetch_assoc($sqlJ);?> 	
	<td style="font-family:Times New Roman; width:250px; font-size:14px;"><?php echo date("d-m-Y",strtotime($resJ['DateJoining'])); ?></td>
	<td style="color:#00376F;font-family:Times New Roman; width:120px; font-size:14px;font-weight:bold; ">Total VNR Exp. :</td>
	<td style="font-family:Times New Roman; width:250px; font-size:14px;"><?php echo $years.' year - '.$M2.' month'; ?></td>
 </tr>
  <tr bgcolor="#FFFFFF">
    <td style="color:#00376F;font-family:Times New Roman; width:120px; font-size:14px;font-weight:bold;">Appraiser :</td>
<?php if($CompanyId==2){$Y=$YearId;} if($CompanyId==1){$Y=2;}?>	
<?php $sqlA=mysql_query("select Appraiser_EmployeeID,Reviewer_EmployeeID,HOD_EmployeeID,ReviewerType from hrm_employee_pms where AssessmentYear=".$Y." AND EmployeeID=".$EmployeeId, $con); $resA=mysql_fetch_assoc($sqlA); 
$sqlAp=mysql_query("select hrm_employee.*,Gender,Married from hrm_employee INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID where hrm_employee.EmployeeID=".$resA['Appraiser_EmployeeID'], $con); $resAp=mysql_fetch_assoc($sqlAp);  if($resAp['Gender']=='M'){$M='Mr.';} elseif($resAp['Gender']=='F' AND $resAp['Married']=='Y'){$M='Mrs.';} elseif($resAp['Gender']=='F' AND $resAp['Married']=='N'){$M='Miss.';}  $NameAp=$M.' '.$resAp['Fname'].' '.$resAp['Sname'].' '.$resAp['Lname'];   ?>			
    <td style="font-family:Times New Roman;width:250px;font-size:14px;"><?php echo $NameAp; ?></td>
	<td style="color:#00376F;font-family:Times New Roman; width:120px; font-size:14px; font-weight:bold;">Reviewer :</td>	
<?php $sqlRe=mysql_query("select hrm_employee.*,Gender,Married from hrm_employee INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID where hrm_employee.EmployeeID=".$resA['Reviewer_EmployeeID'], $con); $resRe=mysql_fetch_assoc($sqlRe);
	   if($resRe['Gender']=='M'){$M='Mr.';} elseif($resRe['Gender']=='F' AND $resRe['Married']=='Y'){$M='Mrs.';} elseif($resRe['Gender']=='F' AND $resRe['Married']=='N'){$M='Miss.';} 
	   $NameRe=$M.' '.$resRe['Fname'].' '.$resRe['Sname'].' '.$resRe['Lname'];   ?>		
	<td style="font-family:Times New Roman; width:250px; font-size:14px;"><?php echo $NameRe; ?></td>
	<td style="color:#00376F;font-family:Times New Roman; width:120px; font-size:14px; font-weight:bold;">HOD :</td>	
<?php $sqlHo=mysql_query("select hrm_employee.*,Gender,Married from hrm_employee INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID where hrm_employee.EmployeeID=".$resA['HOD_EmployeeID'], $con); $resHo=mysql_fetch_assoc($sqlHo);
	   if($resHo['Gender']=='M'){$M='Mr.';} elseif($resHo['Gender']=='F' AND $resHo['Married']=='Y'){$M='Mrs.';} elseif($resHo['Gender']=='F' AND $resHo['Married']=='N'){$M='Miss.';} 
	   $NameHo=$M.' '.$resHo['Fname'].' '.$resHo['Sname'].' '.$resHo['Lname'];   ?>		
	<td style="font-family:Times New Roman; width:250px; font-size:14px;"><?php echo $NameHo; ?></td>
 </tr>
 <tr><td colspan="8">&nbsp;</td></tr>
 <tr><td align="center"><?php $sqlY=mysql_query("select Emp_AchivementSave,Emp_KRASave,Emp_SkillSave,Emp_FeedBackSave,Emp_PmsStatus,Appraiser_PmsStatus from hrm_employee_pms where EmpPmsId=".$resPmsId['EmpPmsId'], $con); $resY=mysql_fetch_assoc($sqlY); if($resY['Emp_AchivementSave']=='Y' AND $resY['Emp_KRASave']=='Y' AND $resY['Emp_SkillSave']=='Y' AND $resY['Emp_FeedBackSave']=='Y' AND $resY['Emp_PmsStatus']==1 AND ($resY['Appraiser_PmsStatus']==0 OR $resY['Appraiser_PmsStatus']==3)) {?> 
