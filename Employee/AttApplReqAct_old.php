...
{ 
  ...
  elseif($_POST['chk']==1)
  {
   ...
   if($_POST['MyAct']==2){ if($rAttv['AttValue']=='A' OR $rAttv['AttValue']=='OD'){$chkAtt='OD';}else{$chkAtt='P';} }
   elseif($_POST['MyAct']==3)
   { if($rAttv['AttValue']!='P' AND $rAttv['AttValue']!='A' AND $rAttv['AttValue']!='' AND $rAttv['AttValue']!='OD'){$chkAtt=$rAttv['AttValue'];}
     else
	 {
...
<td class="font2" valign="top" bgcolor="#8CC6FF"><b>My Action</b></td>
<td class="font2" valign="top">:</td>
<td class="font2"><select id="MyAct" name="MyAct" class="font2" style="border:hidden;width:100px;background-color:#8FFF20;" ><?php if($rE['SStatus']==0){$St='Select';}elseif($rE['SStatus']==1){$St='Pending';}elseif($rE['SStatus']==2){$St='Approved';}elseif($rE['SStatus']==3){$St='Rejected';}?><option value="<?php echo $rE['SStatus']; ?>" selected><?php echo $St; ?></option>
<?php /* if($rE['SStatus']!=1){?><option value="1">Pending</option><?php } */ ?>
<?php if($rE['SStatus']!=2){?><option value="2">Approve</option><?php } ?>
<?php if($rE['SStatus']!=3){?><option value="3">Reject</option><?php } ?>
</select></td>
</tr>
