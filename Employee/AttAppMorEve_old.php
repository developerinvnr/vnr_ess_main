...
{ var da = document.getElementById("da").value;  var Y = document.getElementById("Year").value; 
  var x = 'AttAppMorEve.php?m='+value+'&Y='+Y+'&da='+da+"&yy=4%rer&uu=true&rr=false&e=4e&w=234&tt=10234&a=f&e=4e2&e=4e&w=234&tt=110022344&retd=ee&wwrew=t%T@sed818&d=101"; window.location=x;}
...
<tr style="background-color:<?php if($rowch>0){echo '#FFFF6C';}else{echo '#FFFFFF';} ?>;">
 ...
 <td class="tdc" bgcolor="#75BAFF"><b><?php echo $ResEmp['EmpCode']; ?></b></td>
