	 ...
	 <table>
	  ...
	  <tr>
	    <td style="font-family:Geneva, Arial, Helvetica, sans-serif;font-size:13px;width:580px;" align="center">
	     <textarea name="RepRemark" id="RepRemark" cols="67" rows="5" style="background-color:#E1FFE1;border-style:groove;" disabled="disabled"><?php echo $resSE['Rep_Remark']; ?></textarea>
	    </td>
	  </tr>
	  <tr>
        <td colspan="4" align="Right" class="fontButton">
         <table><tr>
		  ...
		  <?php } ?>
		  <td><input type="button" name="Refrash" value="refresh" onClick="javascript:window.location='SepResActApp2.php?act=<?php echo $_REQUEST['act']; ?>&e=44e&w=254&y=10234&a=e&e=5e2&e=4e&v=<?php echo $_REQUEST['v']; ?>&i=<?php echo $_REQUEST['i']; ?>&w=234&y=1022344&retd=ee&wwrew=t%T@#+aa+sed818&d=101'"/></td>
	     </tr></table>
        </td>
      </tr> 
