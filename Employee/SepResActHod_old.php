...
if($_POST['SentRes'])
{
  $sqlU=mysql_query("update hrm_employee_separation set NoticeDay=".$_POST['NoticeDay'].", Hod_Approved='".$_POST['SepValue']."', Hod_RelievingDate='".date("Y-m-d",strtotime($_POST['HodDate']))."', Hod_Remark='".$_POST['HodRemark']."', Hod_SaveDate='".date("Y-m-d")."', ResignationStatus=3 where EmpSepId=".$_POST['SepId'], $con);
  if($sqlU)
  {
...
$email_from = 'admin@vnrseeds.co.in';
$email_subject4 = "Resignation is processed by HOD";
$email_txt = "Resignation ".$action;
$headers = "From: ".$email_from."\r\n"; 
$semi_rand = md5(time()); 
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
$email_message4 .="Resignation application of ".$Ename." is processed at the level of HOD.\n\n";
...
$email_from = 'admin@vnrseeds.co.in';
$email_subject5 = "Resignation is processed by HOD";
$email_txt = "Resignation ".$action;
$headers = "From: ".$email_from."\r\n";  
$semi_rand = md5(time()); 
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
$email_message5 .="Resignation application of ".$Ename." is processed at the level of HOD.\n\n";
