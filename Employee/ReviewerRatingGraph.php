  ...
  <tr>
    <td style="width:100%;">
	  <table border="0" style="width:100%;">
	    <tr>
        <?php /****************************************** Form Start **************************/ ?>
<?php $SqlA=mysql_query("select EmpPmsId from hrm_employee_pms INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND AssessmentYear=".$_SESSION['PmsYId']." AND Reviewer_EmployeeID=".$EmployeeId, $con); $RowA=mysql_num_rows($SqlA); ?>
...
<?php 
$Sql1=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=1 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row1=mysql_num_rows($Sql1); $v1=number_format($Row1, 0, '.', ''); 

$Sql2=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=2 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row2=mysql_num_rows($Sql2); $v2=number_format($Row2, 0, '.', '');

$Sql25=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=2.5 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row25=mysql_num_rows($Sql25); $v25=number_format($Row25, 0, '.', '');
$Sql27=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=2.7 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row27=mysql_num_rows($Sql27); $v27=number_format($Row27, 0, '.', '');

$Sql29=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=2.9 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row29=mysql_num_rows($Sql29); $v29=number_format($Row29, 0, '.', ''); 

$Sql3=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=3 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row3=mysql_num_rows($Sql3); $v3=number_format($Row3, 0, '.', '');

$Sql32=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=3.2 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row32=mysql_num_rows($Sql32); $v32=number_format($Row32, 0, '.', ''); 

$Sql34=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=3.4 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row34=mysql_num_rows($Sql34); $v34=number_format($Row34, 0, '.', '');

$Sql35=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=3.5 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row35=mysql_num_rows($Sql35); $v35=number_format($Row35, 0, '.', '');

$Sql37=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=3.7 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row37=mysql_num_rows($Sql37); $v37=number_format($Row37, 0, '.', '');

$Sql39=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=3.9 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row39=mysql_num_rows($Sql39); $v39=number_format($Row39, 0, '.', '');

$Sql4=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=4 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row4=mysql_num_rows($Sql4); $v4=number_format($Row4, 0, '.', '');

$Sql42=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=4.2 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row42=mysql_num_rows($Sql42); $v42=number_format($Row42, 0, '.', '');

$Sql44=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=4.4 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row44=mysql_num_rows($Sql44); $v44=number_format($Row44, 0, '.', '');

$Sql45=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=4.5 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row45=mysql_num_rows($Sql45); $v45=number_format($Row45, 0, '.', '');

$Sql47=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=4.7 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row47=mysql_num_rows($Sql47); $v47=number_format($Row47, 0, '.', '');  

$Sql49=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=4.9 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row49=mysql_num_rows($Sql49); $v49=number_format($Row49, 0, '.', '');

$Sql5=mysql_query("select EmpPmsId from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID where e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.Reviewer_TotalFinalRating=5 AND p.Reviewer_EmployeeID=".$EmployeeId, $con); $Row5=mysql_num_rows($Sql5); $v5=number_format($Row5, 0, '.', ''); 
	  ...
	  <tr>
       ...
       <table>
        <tr>
		 ...
		 <iframe name="Giframe" src="RevRatingGraph.php" style="width:750px; height:300px; border:0; border-style:hidden;"></iframe></td>
	    </tr>
       </table>
       </td>
      </tr> 
