...
{ var agree=confirm("Are you sure you want to resend KRA form to Employee?");
  if (agree) { window.location='AppCheckNewFormB.php?action=r&e='+E+'&y='+y+'&ee=1&aa=0&rr=1&hh=1&sh=1&hp=1&fr=1&kr=0&fq=1&prt=1&msg=1&pd=1&mt=1&mts=1&scr=1&prom=1&inc=1&incr=1&pmsr=1&rg=1&h=1&fachiv=1&fa=1&fb=1&ffeedb=1&org=1'; } 
  else {return false;}
}

function EmpFormB(CId,YId,EmpId) 
{ window.open ("EmpFormBForm.php?YId="+YId+"&EmpId="+EmpId+"&CId="+CId,"KRAForm","menubar=yes,scrollbars=yes,resizable=1,width=1200,height=600");}
...
<tr>
 <td style="width:100%;">
  <table border="0" style="width:100%;" cellspacing="0">
   <tr>
    <td class="formh" style="width:250px;">(<i>My Team Form-B Status</i>) :&nbsp;</td>
    <td class="fhead" style="text-align:right;">
	<img src="images/edit.png" border="0"/>&nbsp;:&nbsp; Edit &nbsp;&nbsp;&nbsp;&nbsp;
    <?php /*<img src="images/go-back-icon.png" border="0"/>&nbsp; Resent&nbsp;&nbsp;&nbsp;&nbsp; */ ?>
    <?php /*<script>function FunLog(){ window.open("viewlogic.php", "F", "menubar=no,scrollbars=yes,resizable=no,directories=no,width=1000,height=500");}</script>	  
 ...
 <table border="1" id="table1" cellpadding="0" cellspacing="0" style="width:100%;">
   ...
   <thead>
    <tr bgcolor="#7a6189" style="height:25px;">
	 ...
	 <td class="th" style="width:5%;">Form-B</td>	
...
$sql3E=mysql_query("select EmpStatus,AppStatus,RevStatus from hrm_employee_pms_behavioralformb where YearId=".$_SESSION['KraYId']." AND EmpId=".$res['EmployeeID'], $con); $row3E=mysql_num_rows($sql3E); 
...
?> 
   ...
   <tr style="height:22px;background-color:#FFFFFF;">
	...
	<td class="tdc"><?php if($row3E>0){?><a href="#" onClick="EmpFormB(<?php echo $CompanyId.', '.$_SESSION['KraYId'].', '.$res['EmployeeID']; ?>)">Click</a><?php } ?></td>

	 <td class="tdc"><a href="#"><img src="images/edit.png" border="0" onClick="javascript:window.location='AppAddNewFormB.php?e=<?php echo $res['EmployeeID']?>&ee=1&aa=0&rr=1&hh=1&sh=1&hp=1&fr=1&kr=1&formb=1&fq=1&prt=1&msg=1&pd=1&mt=1&mts=1&scr=1&prom=1&inc=1&incr=1&pmsr=1&rg=1&h=1&fachiv=0&fa=1&fb=1&ffeedb=1&org=1'"/></a><?php if($res3E['EmpStatus']=='A' AND ($res3E['AppStatus']=='D' OR $res3E['AppStatus']=='P')){?>&nbsp;&nbsp;&nbsp;<a href="#"><img src="images/go-back-icon.png" border="0" onClick="return ResentKRA(<?php echo $res['EmployeeID'].', '.$_SESSION['KraYId'];?>)"/></a><?php } ?></td>
    </tr>
    </tbody>
    </div>
<?php $sno++;} ?>		
