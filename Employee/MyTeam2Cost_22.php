...
if($_REQUEST['action']=='Over'){ $sqlHUn=mysql_query("select SUM(EmpCurrGrossPM)as UnHodGross, SUM(EmpCurrIncentivePM) as UnHodInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NOHUn=mysql_query("select count(*) as NOHUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
	  ...
	  elseif($_REQUEST['action']=='Hod'){ $sqlHUn=mysql_query("select SUM(EmpCurrGrossPM)as UnHodGross, SUM(EmpCurrIncentivePM) as UnHodInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NOHUn=mysql_query("select count(*) as NOHUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
	   $resHUn=mysql_fetch_array($sqlHUn); $resNOHUn=mysql_fetch_assoc($NOHUn); if($resHUn['UnHodGross']>0){$UnHodGross=$resHUn['UnHodGross']+$resHUn['UnHodInct'];}else{$UnHodGross=0;} ?>
               <td align="center" bgcolor="#C5FF8A" class="All_50"><?php echo $resNOHUn['NOHUn']; ?></td>
               <td align="right" bgcolor="#C5FF8A" class="All_100"><?php echo $UnHodGross; ?>&nbsp;
...
?>		  				
              <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;font-weight:bold;font-size:11px;background-color:#C5FF8A;" id="UnE_PIS" name="UnE_PIS" value="<?php echo $IncpGross; ?>" readonly/></td>
              <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;font-weight:bold;background-color:#C5FF8A; font-size:11px;" id="UnE_PerPIS" name="UnE_PerPIS" value="<?php echo 30; ?>" readonly/></td>
			  <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnE_PerIncS" name="UnE_PerIncS" value="<?php echo $Un_IncS; ?>" readonly/></td>	
<?php /**************************************** Dummy Close *********************************/ ?>
<?php /**************************************** Dummy Close *********************************/ ?>		  		

<?php /******************* Un-HOD Actual Total Value Start *********************************/ ?>		
<?php /********************** Un-HOD Actual Total Value Start *********************************/ ?>			   		
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnPISth" name="UnPISth" value="<?php echo '';//$IncpGross; ?>" readonly/></td>
			     
			   <td align="center" style="" class="All_60"></td>
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnIncSth" name="UnIncSth" value="<?php echo '';//$IncpGross; ?>" readonly/></td>	
			   
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnPerISth" name="UnPerISth" value="<?php echo '';//30; ?>" readonly/></td>
			   <td align="center" style="" class="All_60"></td>	
			   
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnPerISth" name="UnPerISth" value="<?php echo '';//30; ?>" readonly/></td>
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;font-weight:bold;background-color:#C5FF8A;font-size:11px;" id="UnIncSth" name="UnIncSth" value="<?php echo '';//$Un_IncS; ?>" readonly /></td>	
...
$resET=mysql_fetch_array($sqlET); if($_REQUEST['YI']>=2){$resNOET=mysql_fetch_array($NOET);} $ET=$resET['EmpGross']+$resET['EmpInct']; //$ET=$resET['EmpGross']+$EuGross; ?>			
             <td align="center" style="" class="All_50"><b style="color:#FFFFFF;"><?php echo $resNOET['NOET']+$resNOEUn['NOEUn']; ?></b></td>   			   
	<td align="right" style="" class="All_100"><b style="color:#FFFFFF;"><?php echo floatval($ET+$UnEmpGross); ?></b>&nbsp;
	<input type="hidden" name="EmpGrossT" id="EmpGrossT" value="<?php echo floatval($ET+$UnEmpGross); ?>" /></td>
...
$resAT=mysql_fetch_array($sqlAT); if($_REQUEST['YI']>=2){$resNOAT=mysql_fetch_array($NOAT);} $AT=$resAT['AppGross']+$resAT['AppInct']; //$AT=$resAT['AppGross']+$AuGross; ?>
               <td align="center" style="" class="All_50"><b style="color:#FFFFFF;"><?php echo $resNOAT['NOAT']+$resNOAUn['NOAUn']; ?></b></td>   							   
	<td align="right" style="" class="All_100"><b style="color:#FFFFFF;"><?php echo floatval($AT+$UnAppGross); ?></b>&nbsp;
<input type="hidden" name="AppGrossT" id="AppGrossT" value="<?php echo floatval($AT+$UnAppGross); ?>" /></td>
...
$resRT=mysql_fetch_array($sqlRT); if($_REQUEST['YI']>=2){$resNORT=mysql_fetch_array($NORT);} $RT=$resRT['RevGross']+$resRT['RevInct']; //$RT=$resRT['RevGross']+$RuGross; ?>	
               <td align="center" style="" class="All_50"><b style="color:#FFFFFF;"><?php echo $resNORT['NORT']+$resNORUn['NORUn']; ?></b></td>
	<td align="right" style="" class="All_100"><b style="color:#FFFFFF;"><?php echo floatval($RT+$UnRevGross); ?></b>&nbsp;
	<input type="hidden" name="RevGrossT" id="RevGrossT" value="<?php echo floatval($RT+$UnRevGross); ?>"/></td>
...
$resHT=mysql_fetch_array($sqlHT); if($_REQUEST['YI']>=2){$resNOHT=mysql_fetch_array($NOHT);} $HT=$resHT['HodGross']+$resHT['HodInct']; //$HT=$resHT['HodGross']+$HuGross; ?>	
               <td align="center" style="" class="All_50"><b style="color:#FFFFFF;"><?php echo $resNOHT['NOHT']+$resNOHUn['NOHUn']; ?></b></td>
	<td align="right" style="" class="All_100"><b style="color:#FFFFFF;"><?php echo floatval($HT+$UnHodGross); ?></b>&nbsp;
<input type="hidden" name="HodGrossT" id="HodGrossT" value="<?php echo floatval($HT+$UnHodGross); ?>" /></td>	
...
/*
if($HT>0){ $TotalIncPropT=$HTotPT2-$HT;  $TotalIncCorrT=$HTotPT22; }
else{$TotalIncPropT=0; $TotalIncCorrT=0;}
$OnePerT2=($HT*1)/100; 
$Inc_Per2PT=$TotalIncPropT/$OnePerT2; $round_PerInc2PT=round($Inc_Per2PT,2);
$Inc_Per2CT=$TotalIncCorrT/$OnePerT2; $round_PerInc2CT=round($Inc_Per2CT,2);
