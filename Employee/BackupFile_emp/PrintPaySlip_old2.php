...
<style>
.td13c{font-family:Times New Roman;font-size:13px;background-color:#D9D1E7;}.td14c{font-family:Times New Roman;font-size:14px;background-color:#D9D1E7;}.td15c{font-family:Times New Roman;font-size:15px;background-color:#D9D1E7;}.td13{font-family:Times New Roman;font-size:13px;}.td14{font-family:Times New Roman;font-size:14px;}.td15{font-family:Times New Roman;font-size:15px;}.td13r{font-family:Times New Roman;font-size:13px;text-align:right;}.td14r{font-family:Times New Roman;font-size:14px;text-align:right;}.td15r{font-family:Times New Roman;font-size:15px;text-align:right;}.td14ce{font-family:Times New Roman;font-size:14px;}.font1 { font-family:Georgia;font-size:12px;height:14px; }.td11 { font-family:Georgia;font-size:11px; text-align:center;color:#FFFFFF; }printLink{display:none;}</style>
...
{ $m=$_REQUEST['m']; $EmployeeId=$_REQUEST['EI']; $YY=$_REQUEST['Y']; 
  $YId=$_REQUEST['YI']; $CompanyId=$_REQUEST['CI']; 
...
<td style="width:100%;">
 ...
 <td style="width:100%;" align="center">
  <table style="width:100%;" border="0" bgcolor="#FFFFFF" align="center">
...
<?php if($ResPay['Convance']>0 OR $ResPay['Arr_Pf']>0 OR $ResPay['TA']>0){ ?>  
  <tr>
...
<?php } if($ResPay['DA']>0 OR $ResPay['VolContrib']>0){ ?>  
  <tr>
...
<?php } if($ResPay['LeaveEncash']>0 OR $ResPay['DeductAdjmt']>0) { ?>  
  <tr>
...
<?php } if($ResPay['Arreares']>0 OR $ResPay['RecConAllow']>0) { ?>    
  <tr>
...
<tr>
 <td class="td14"><b>Message:</b>&nbsp;Computer generated payslip, Hence signature not required.</td>
 </tr>
</table>
</td>
</tr>	
