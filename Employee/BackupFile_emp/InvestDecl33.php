...
if(document.getElementById("Check_LTA").value=='Y'){document.getElementById("LtaCheck").disabled=false;} 
if(document.getElementById("Check_CEA").value=='Y'){document.getElementById("CeaCheck1").disabled=false; document.getElementById("CeaCheck2").disabled=true;}
if(document.getElementById("Check_Medical").value=='Y'){document.getElementById("MedicalCheck").disabled=false;} 
...
?> 		 
		    <tr>
			 ...
			 <td align="right" style="width:110px;"><?php if($rowCheck>0 AND ($resIvst['FormSubmit']=='Y' OR $resIvst['FormSubmit']=='YY')){ ?><a href="#" onClick="PrintInvestDel('<?php echo $PrdCurr; ?>', <?php echo $EmployeeId.', '.$res['C_Month']; ?>)" style="font-size:14px;font-family:Times New Roman;"><b>Print</b></a><?php } ?>
...
&nbsp;&nbsp;<a href="#" onClick="OpenOld('<?php echo $PrdBack; ?>', <?php echo $EmployeeId.', '.$res['B_Month']; ?>)" style="font-size:14px;font-family:Times New Roman;"><b>Invest. Decl. <?php echo $PrdBack.'-'.$Bm; ?></b></a> <?php } } ?>
			 </td>
			 </tr>
			 <tr>
	   ...
	   <b>(d)</b> You are requested to submit the required proofs up to <?php echo date("d.m.Y",strtotime($res['LastDateTime'])); ?>,failing which will be assumed that the employee does not  have any Tax Saving  and income other than salary,and the Income Tax will be recomputed and tax will be deducted accordingly.<br>
	 </td>
</tr> 		
...
<tr>
<td align="center" valign="top" rowspan="5" style="width:20px;font-size:15px;"><?php if($res['LTA']=='N' AND $res['CEA']=='N' AND $res['Medical']=='N'){echo 5;}else {echo 8;} ?></td>
...
<tr>
<td align="center" valign="top" rowspan="14" style="width:20px;font-size:15px;"><?php if($res['LTA']=='N' AND $res['CEA']=='N' AND $res['Medical']=='N'){echo 6;}else {echo 9;} ?></td>
...
<tr>
<td align="center" valign="top" rowspan="5" style="width:20px;font-size:15px;"><?php if($res['LTA']=='N' AND $res['CEA']=='N' AND $res['Medical']=='N'){echo 7;}else {echo 10;} ?></td>
...
<tr>
<td align="center" valign="top" style="width:20px;font-size:15px;"><?php if($res['LTA']=='N' AND $res['CEA']=='N' AND $res['Medical']=='N'){echo 8;}else {echo 11;} ?></td>
...
<tr>
<td align="center" valign="top" rowspan="2" style="width:20px;font-size:15px;"><?php if($res['LTA']=='N' AND $res['CEA']=='N' AND $res['Medical']=='N'){echo 9;}else {echo 12;} ?></td>
...
<?php if($rowEdit==0 OR ($rowEdit>0 AND $resEdit['FormSubmit']=='Y')) { ?>
<input type="button" name="EditInvstDec" id="EditInvstDec" style="width:90px;" value="edit" onClick="Edit()" <?php if(date("Y-m-d H:i:s")>$res['LastDateTime']){echo 'disabled';}?>>
      <?php } ?>
	  </td>
	  <td align="right" style="width:90px;">
	  <input type="button" name="Refresh" id="Refresh" style="width:90px;" value="Refresh" onClick="javascript:window.location='InvestDecl.php'" <?php if(date("Y-m-d H:i:s")>$res['LastDateTime']){echo 'disabled';}?> /></td>
	</tr></table>  
	</td>
	</tr>
	</table>
