   ...
   <table border="1" width="685" bgcolor="#ffffff">
	...
	<?php /***** Start ******/ ?>			
			 <table style="width:685px;" border="0">
			  ...
			  <tr>
			    <td style="width:485px;font-size:16px;height:22px;" align="left"><b>*.&nbsp;&nbsp;</b>&nbsp;<?php if($ResE['DepartmentId']==2){echo 'Fooding Expense'; }else{ echo 'DA Outside HQ'; } ?> :</td>
...
?>			  <?php echo 'aa='.$vehiclaCose; if($vehiclaCose!='' AND $vehiclaCose!=0){ ?> 
	          <tr>
