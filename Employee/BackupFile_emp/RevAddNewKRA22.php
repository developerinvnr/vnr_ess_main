...
for($i=1; $i<=$_POST['EditTNRow']; $i++)
{
  ...
  { $str_KRA = $_POST['KRA_'.$i]; $str_KRADes = $_POST['KRADes_'.$i]; $KRA=str_replace($search, "", $str_KRA); $KRADes=str_replace($search, "", $str_KRADes);
    $sqlSaveK=mysql_query("update hrm_pms_kra set KRA='".$KRA."', KRA_Description='".$KRADes."', Measure='".$_POST['Measure_'.$i]."', Unit='".$_POST['Unit_'.$i]."', Weightage=".$_POST['Weightage_'.$i].", Logic='".$_POST['Logic_'.$i]."', Period='".$_POST['Period_'.$i]."', Target=".$_POST['Target_'.$i].", RevStatus='P', CreatedBy=".$EmployeeId.", CreatedDate='".date("Y-m-d")."' where KRAId=".$_POST['KId_'.$i], $con); 
  }
  ...
  $TotalWeight=$_POST['WWeightage_1']+$_POST['WWeightage_2']+$_POST['WWeightage_3']+$_POST['WWeightage_4']+$_POST['WWeightage_5']+$_POST['WWeightage_6']+$_POST['WWeightage_7']+$_POST['WWeightage_8']+$_POST['WWeightage_9']+$_POST['WWeightage_10']+$_POST['WWeightage_11']+$_POST['WWeightage_12']+$_POST['WWeightage_13']+$_POST['WWeightage_14']+$_POST['WWeightage_15'];
      ...
      if($sqlSaveK)
	  {
	   ...
	   if($TotalWeight==100)
       {
	    ...
	    { 
		  $sqlU=mysql_query("update hrm_pms_kra set KRAStatus='A',UseKRA='H',RevStatus='A' where YearId=".$resSY['CurrY']." AND EmployeeID=".$_REQUEST['e'], $con); 
...
if($_REQUEST['actsubkra']=='OkSubKraEdit' && $_REQUEST['MWei']!='' && $_REQUEST['KId']!='')
{
 ...
 { 
  ...
  if($sU)
  { 
   if($TotalWei==$_REQUEST['MWei']){echo '<script>alert("Sub-KRAs have been saved successfully."); window.location="RevAddNewKRA.php?e='.$_REQUEST['e'].'&DI='.$_REQUEST['DI'].'&ee=1&aa=1&rr=0&hh=1&sh=1&hp=1&fr=1&kr=0&fq=1&prt=1&msg=1&pd=1&mt=1&mts=1&scr=1&prom=1&inc=1&incr=1&pmsr=1&rg=1&h=1&fachiv=1&fa=1&fb=1&ffeedb=1&org=1"; </script>';}
   ...
   echo '<script>alert("Error..Please Check!, Sub-KRAs weightage is not equal to main KRA weightage !");
    window.location="RevAddNewKRA.php?e='.$_REQUEST['e'].'&DI='.$_REQUEST['DI'].'&ee=1&aa=1&rr=0&hh=1&sh=1&hp=1&fr=1&kr=0&fq=1&prt=1&msg=1&pd=1&mt=1&mts=1&scr=1&prom=1&inc=1&incr=1&pmsr=1&rg=1&h=1&fachiv=1&fa=1&fb=1&ffeedb=1&org=1"; </script>';}
  } 	  
}
...
{var K=document.getElementById("KRAGoal"+v).value; var KD=document.getElementById("Des"+v).value; var M=document.getElementById("Mea"+v).value; var U=document.getElementById("Uni"+v).value; var W=document.getElementById("Wei"+v).value; var T=document.getElementById("Tar"+v).value; 
 ...
 { 
   ...
   {  
    if(document.getElementById("KRA_"+i).value=='')
	 {document.getElementById("KRA_"+i).value=K; document.getElementById("KRADes_"+i).value=KD; document.getElementById("Measure_"+i).value=M; document.getElementById("Unit_"+i).value=U; document.getElementById("Weightage_"+i).value=W; document.getElementById("Target_"+i).value=T; document.getElementById("KRA_"+i).readOnly=true; document.getElementById("KRADes_"+i).readOnly=true; document.getElementById("Measure_"+i).readOnly=true; document.getElementById("Unit_"+i).readOnly=true; document.getElementById("Weightage_"+i).readOnly=false; document.getElementById("Target_"+i).readOnly=false; document.getElementById("KraIdNo_"+i).value=v; document.getElementById("TR_"+v).style.backgroundColor='#CAFFCA'; 
 ...
 { 
   ...
   {   
    if(document.getElementById("KraIdNo_"+i).value==v)
	 {document.getElementById("KRA_"+i).value=''; document.getElementById("KRADes_"+i).value=''; document.getElementById("Measure_"+i).value='';  document.getElementById("Unit_"+i).value=''; document.getElementById("Weightage_"+i).value=''; document.getElementById("Target_"+i).value='';  document.getElementById("KRA_"+i).readOnly=false; document.getElementById("KRADes_"+i).readOnly=false; document.getElementById("Measure_"+i).readOnly=false; document.getElementById("Unit_"+i).readOnly=false; document.getElementById("Weightage_"+i).readOnly=false; document.getElementById("Target_"+i).readOnly=false;  document.getElementById("KraIdNo_"+i).value=''; document.getElementById("TR_"+v).style.backgroundColor='#FFFFFF'; 
...
{ var n=document.getElementById("EditTNRow").value; for(var r=1; r<=n; r++){document.getElementById("KRA_"+r).readOnly=false; document.getElementById("KRADes_"+r).readOnly=false; document.getElementById("Measure_"+r).readOnly=false; document.getElementById("Unit_"+r).readOnly=false; document.getElementById("Weightage_"+r).readOnly=false; document.getElementById("Target_"+r).readOnly=false;} document.getElementById("EditKRA").style.display='block'; document.getElementById("EditK").style.display='none';
}
...
<form name="KRAForm" method="post" onSubmit="return ValidationAchive(this)">   
   <td id="Achivement" style="">
     ...
     <tr>
	  <td colspan="8">
	   <table border="0"><tr><td align="" style="font-family:Times New Roman;color:#000084; font-size:14px; font-weight:bold; width:890px;" valign="middle">      
...
<?php $sql=mysql_query("select * from hrm_pms_kra where YearId=".$resSY['CurrY']." AND CompanyId=".$CompanyId." AND EmployeeID=".$_REQUEST['e']." AND (KRAStatus='R' OR KRAStatus='A') order by KRAId ASC", $con);     
	  ...
	  <input type="button" name="back" id="back" style="width:90px;" value="back" onClick="javascript:window.location='RevCheckNewKRA.php?ee=1&aa=1&rr=0&hh=1&sh=1&hp=1&fr=1&kr=0&fq=1&prt=1&msg=1&pd=1&mt=1&mts=1&scr=1&prom=1&inc=1&incr=1&pmsr=1&rg=1&h=1&fachiv=1&fa=1&fb=1&ffeedb=1&org=1'"/>
<?php if($row>0){ ?><input type="Submit" name="SubmitKRA" id="SubmitKRA" value="final submit" style="width:130px;" <?php if($row2>0){echo 'disabled';} ?>/><?php } ?>
      ...
      <?php if($row>0) { ?><input type="button" name="EditK" id="EditK" style="width:130px;" value="Edit" <?php if($row2>0){echo 'disabled';} ?> onClick="EditKRAvalue()"/>
                           <input type="Submit" name="EditKRA" id="EditKRA" style="width:130px; display:none;" value="save"/><?php } ?>
...
<input type="hidden" id="row2" value="<?php echo $row2; ?>" />				   
 ...
 <tr style="height:24px;">	
  ...
  <td colspan="7" style="width:1100px;"><table style="width:100%;border-color:#EEF0AA;" bgcolor="#EEF0AA" border="1"> 
  <tr bgcolor="#EEF0AA">   
...
<?php $sSubK=mysql_query("select * from hrm_pms_krasub where KRAId=".$res['KRAId']." AND KSubStatus='A' order by KRASubId ASC",$con); $rowSubK=mysql_num_rows($sSubK); ?>
  ...
  <table id="Row_<?php echo $k; ?>" style="width:1100px;" bgcolor="#FFFFFF" border="1"> 
  <tr bgcolor="#FFFFFF">   
  ...
  <?php if($rowSubK>0){ ?><input type="" style="width:95px; height:20px;border:hidden;" name="Measure_<?php echo $k; ?>" id="Measure_<?php echo $k; ?>" value="" readonly/><?php } else{ ?><select name="Measure_<?php echo $k; ?>" id="Measure_<?php echo $k; ?>" class="Input" style="width:95px; height:20px;"><option value="<?php echo $res['Measure']; ?>"><?php echo $res['Measure']; ?></option> <option value="Acreage">Acreage</option><option value="Event">Event</option><option value="Program">Program</option> <option value="Process">Process</option><option value="Maintenance">Maintenance</option><option value="Time">Time</option><option value="Yield">Yield</option><option value="None">None</option></select>
  <?php } ?>
  </td>
  <td class="font" align="center" style="width:80px;">
  <?php if($rowSubK>0){ ?><input type="" style="width:78px; height:20px;border:hidden;" name="Unit_<?php echo $k; ?>" id="Unit_<?php echo $k; ?>" value="" readonly/><?php } else{ ?><select name="Unit_<?php echo $k; ?>" id="Unit_<?php echo $k; ?>" class="Input" style="width:78px; height:20px;"><option value="<?php echo $res['Unit']; ?>"><?php echo $res['Unit']; ?></option><option value="%">%</option><option value="Acres">Acres</option><option value="Days">Days</option><option value="Month">Month</option><option value="Hours">Hours</option><option value="Days/Hours">Days/Hours</option><option value="Kg">Kg</option><option value="Ton">Ton</option><option value="Kg/Acre">Kg/Acre</option><option value="Number">Number</option><option value="None">None</option></select>
  <?php } ?>
  </td>
  ...
  <td class="font" align="center" style="width:60px;">
  <?php if($rowSubK>0){ ?><input type="" style="width:68px; text-align:center; border:hidden;" name="Target_<?php echo $k; ?>" id="Target_<?php echo $k; ?>" value="100" readonly/><?php } else{ ?><input name="Target_<?php echo $k; ?>" id="Target_<?php echo $k; ?>" class="Input" style="cursor:<?php if($res['Period']!='Annual' AND $res['Period']!=''){echo 'pointer';} ?>;width:68px; text-align:center;text-decoration:<?php if($res['Period']!='Annual' AND $res['Period']!=''){ echo 'underline'; }?>;color:<?php if($res['Period']!='Annual' AND $res['Period']!=''){ echo '#000099'; }?>;" maxlength="8" <?php if($res['Period']!='Annual' AND $res['Period']!=''){?> onClick="FunTgt(<?php echo $res['KRAId']; ?>,'<?php echo $res['Period']; ?>',<?php echo intval($res['Target']).','.intval($res['Weightage']); ?>,'<?php echo $res['Logic']; ?>')" <?php } ?> onChange="ChangeTarget(<?php echo $k; ?>)" value="<?php echo intval($res['Target']); ?>" readonly/>
...
<?php /* While Open*/ $m=1; while($rSubK=mysql_fetch_assoc($sSubK)){?>
  ...
  <td align="center"><input id="Kra_a<?php echo $k.'_'.$m; ?>" class="Inputa" value="<?php echo $rSubK['KRA']; ?>" style="width:280px;" maxlength="348" /></td>
  <td align="center"><input id="KraDes_a<?php echo $k.'_'.$m; ?>" class="Inputa" value="<?php echo $rSubK['KRA_Description']; ?>" style="width:390px;" maxlength="580"/></td>  
  ...
  <td align="center" style="background-color:#CAE4FF;">
...
<?php if($row2==0){ for($mm=$m; $mm<=5; $mm++){ ?>
  ...
  <td align="center"><input id="Kra_a<?php echo $k.'_'.$mm; ?>" class="Inputa" style="width:280px;" maxlength="348" /></td>
  <td align="center"><input id="KraDes_a<?php echo $k.'_'.$mm; ?>" class="Inputa" style="width:390px;" maxlength="580"/></td>  
  
  <td align="center" style="background-color:#CAE4FF;"><select id="Mea_a<?php echo $k.'_'.$mm; ?>" class="Inputa" style="width:90px; height:20px;"><option value="Acreage">Acreage</option><option value="Event">Event</option><option value="Program">Program</option><option value="Process">Process</option><option value="Maintenance">Maintenance</option><option value="Time">Time</option><option value="Yield">Yield</option><option value="None" selected>None</option></select></td>
  
  <td align="center" style="background-color:#CAE4FF;"><select id="Uni_a<?php echo $k.'_'.$mm; ?>" class="Inputa" style="width:70px; height:20px;"><option value="%">%</option><option value="Acres">Acres</option><option value="Days">Days</option><option value="Month">Month</option><option value="Hours">Hours</option><option value="Kg">Kg</option><option value="Ton">Ton</option><option value="Kg/Acre">Kg/Acre</option><option value="Number">Number</option><option value="None" selected>None</option></select></td>
  ...
  <td align="center" style="background-color:#CAE4FF;"><select id="Log_a<?php echo $k.'_'.$mm; ?>" class="Inputa" style="width:60px; height:20px;"><option value="Logic1">Logic1</option><option value="Logic2">Logic2</option><option value="Logic3">Logic3</option><option value="Logic4">Logic4</option></select></td>
  <td align="center" style="background-color:#CAE4FF;">
...
<tr style="height:22px;" id="TR_<?php echo $i; ?>">	
 ...
 <td colspan="7" style="width:1100px;"><table id="Row_<?php echo $i; ?>" style="width:1100px;" bgcolor="#FFFFFF" border="1">
  ...
  <option value="Process">Process</option><option value="Maintenance">Maintenance</option><option value="Time">Time</option><option value="Yield">Yield</option>
  ...
  <option value="Kg">Kg</option><option value="Ton">Ton</option><option value="Kg/Acre">Kg/Acre</option><option value="Number">Number</option><option value="None">None</option></select></td>
  <td class="font" align="center" style="width:60px;">
  ...
  <td align="center"><select name="Logic_<?php echo $i; ?>" id="Logic_<?php echo $i; ?>" class="Input" style="width:68px; height:20px;" onChange="ChangeLogic(<?php echo $i; ?>)"><option value="Logic1">Logic1</option><option value="Logic2">Logic2</option><option value="Logic3">Logic3</option><option value="Logic4">Logic4</option></select></td>
