 ...
 <td style="width:100%;">
  <table border="0" style="width:100%;" cellspacing="0">
   <tr>
	...
	<font color="#FFFF9D">PGSPM :&nbsp;</font><font color="#004600">Proposed Gross Salary PM,&nbsp;&nbsp;</font>
 ...
 <td style="width:100%;background-color:#FFFF91;">
  <table border="0" style="width:100%;">
   <tr>
	...
	&nbsp;&nbsp;<u>Total Previous GSPM</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" id="MyTTPreGross" value="<?php echo $TotOldGrossPM; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;<u>Total Proposed GSPM</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" id="MyTTProGross" value="<?php echo $TotNewGrossPM; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;<u>Total Increment</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" id="MyTTIncGross" value="<?php echo $Increment; ?>"/>&nbsp;<input class="rinput" style="width:60px;" id="MyTTIncGrossPercent" value="<?php echo $PerInc; ?>"/>&nbsp;%&nbsp;&nbsp;&nbsp;&nbsp;<u>Total SC</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" value="<?php echo $ResCount['H_SC']; ?>"/>&nbsp;<input class="rinput" style="width:60px;" id="MyTTSCPercent" value="<?php echo $TotalTPerPSC; ?>" />&nbsp;%
	&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onClick="ExportReport(<?php echo $EmployeeId.','.$_SESSION['PmsYId'].','.$CompanyId; ?>)">Export_Reports</a>
	</td>
   </tr>
  </table>
 </td>
...
if($res['Hod_EmpGrade']!=0 AND $res['Hod_EmpGrade']>0) {$sqlHG=mysql_query("select GradeValue from hrm_grade where GradeId=".$res['Hod_EmpGrade'], $con); $resHG=mysql_fetch_assoc($sqlHG);} ?>					
     ...
     <td class="tdr"><?php echo floatval($res['Hod_ProIncSalary']); ?></td>
     <td class="tdc"><?php echo $res['Hod_Percent_ProIncSalary']; ?></td>	
     <td class="tdr"><?php echo floatval($res['Hod_ProCorrSalary']); ?></td>
     <td class="tdc"><?php echo $res['Hod_Percent_ProCorrSalary']; ?></td>	
     <td class="tdr"><?php echo floatval($res['Hod_IncNetMonthalySalary']); ?></td>
     <td class="tdc"><?php echo $res['Hod_Percent_IncNetMonthalySalary']; ?></td>	
     <td class="tdr"><?php echo floatval($res['Hod_GrossMonthlySalary']);?></td>
    </tr>
	</tbody>
	</div>
<?php $sno++;} ?>		
