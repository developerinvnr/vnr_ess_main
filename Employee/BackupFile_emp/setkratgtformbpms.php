...
function FunSave(i,id)
{
 ...
 else
 {
  ...
  var url = 'setkratgtformbactpms.php'; var pars = 'ach='+ach+'&cmnt='+cmt+'&id='+id+'&i='+i+'&fn='+fn+'&fbid='+fbid+'&scor='+Scor+'&logscr='+LogScr;
...
function FunLk(i,id)
{
  ...
  if(agree)
  {
   var url = 'setkratgtformbactpms.php'; var pars = 'lockk=OkLock&id='+id+'&i='+i;
...
<div style="position:absolute;top:120px;left:150px;width:80%;background-color: rgba(255, 255, 255, .9);">
<span id="wait_tip" style="text-align:center;display:none;">
 <img src="images/loading.gif" id="loading_img"/><br>
 Please wait ...
	...
	<tr style="background-color:#FFFFFF;height:24px;">
	 ...
	 <td class="d" align="center">
	  <?php 
		...
		<input type="hidden" name="tgt<?php echo $i; ?>" id="tgt<?php echo $i; ?>" value="<?php echo $tgt; ?>"/>
...
<input type="hidden" class="d" style="width:60px;height:40px;border:hidden;text-align:center;background-color:#FFFFC6;" id="tgt_tt<?php echo $i; ?>" name="tgt_tt<?php echo $i; ?>" value="<?php if($res['Tgt']!=''){echo floatval($res['Tgt']);}else{echo floatval($tgt);} ?>" readonly />	 
...
<input type="hidden" id="NtgtN<?php echo $i; ?>" name="NtgtN<?php echo $i; ?>" value="<?php echo $i; ?>"/></td> 
	 ...
	 <td class="d" bgcolor="#D5FFAA" id="TD1<?php echo $i; ?>"><input class="input" name="Ach<?php echo $i; ?>" id="Ach<?php echo $i; ?>" class="d" style="width:60px;border:hidden;background-color:#D5FFAA;text-align:center;" onKeyUp="FunEnterAch(this.value,<?php echo $i; ?>)" onChange="FunEnterAch(this.value,<?php echo $i; ?>)" value="<?php if($res['Cmnt']!='' || $res['Ach']>0){ echo floatval($res['Ach']); }else{ echo ''; } ?>" maxlength="4" onKeyPress="return isNumberKey(event)" readonly/></td>
	 ...
	 <?php if($res['Tital']!='' AND $res['Tgt']!=''){ //AND $_REQUEST['prd']=='Monthly' ?>
	  <span style="cursor:pointer"><img src="images/edit.png" border="0" id="edit_<?php echo $i; ?>" style="display:<?php if($res['lockk']==0){echo 'block';}else{echo 'none';} ?>" onClick="FunEdit(<?php echo $i; ?>)"/></span>
