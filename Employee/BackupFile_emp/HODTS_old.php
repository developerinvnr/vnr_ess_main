...
{ 	 
 ...
 var SSk_1=document.getElementById("RevSoftSkill_1").value; var SSk_2=document.getElementById("RevSoftSkill_2").value;
 var TSk_1=document.getElementById("RevTechSkill_1").value; var TSk_2=document.getElementById("RevTechSkill_2").value;
 ...
 if (agree) { var url = 'HODSetEmpKRAScore.php';	var pars = 'P='+PmsId+'&E='+EId+'&Y='+YId+'&AScoPms='+RevFormAScore+'&BScoPms='+RevFormBScore+'&RevRem='+RevRemark+'&ComId='+ComId+'&S1='+Score_1+'&S2='+Score_2+'&TotS1S2='+TotalScore_12+'&DesigId='+DesigId+'&GradeId='+GradeId+'&Justi='+Justification+'&SSk1='+SSk_1+'&SSk2='+SSk_2+'&TSk1='+TSk_1+'&TSk2='+TSk_2;	
...
{ 	 
  ...
  if (agree) { 
  var url = 'HODSetEmpKRAScore.php';	var pars = 'P2='+PmsId+'&E2='+EId+'&Y2='+YId+'&AScoPms2='+RevFormAScore+'&BScoPms2='+RevFormBScore+'&RevRem2='+RevRemark+'&ComId2='+ComId+'&S1='+Score_1+'&S2='+Score_2+'&TotS1S2='+TotalScore_12+'&DesigId='+DesigId+'&GradeId='+GradeId+'&Justi='+Justification+'&SSk1='+SSk_1+'&SSk2='+SSk_2+'&TSk1='+TSk_1+'&TSk2='+TSk_2;	
...
<?php $sql2=mysql_query("select * from hrm_employee_pms_kraforma where KRAFormAStatus='A' AND EmpPmsId=".$resApp['EmpPmsId']." order by KRAFormAId ASC", $con); $Sno=1; while($res2=mysql_fetch_array($sql2)) { 
     ...
     <tr bgcolor="#FFFFFF" style="height:25px;">
      ...
      <td class="fbodyc"><span style="text-decoration:<?php if($res2['Period']!='Annual' AND $res2['Period']!=''){ echo 'underline'; }else{echo 'none';}?>;color:<?php if($res2['Period']!='Annual' AND $res2['Period']!=''){ echo '#000099'; }else{echo '#000';}?>;cursor:<?php if($res2['Period']!='Annual' AND $res2['Period']!=''){echo 'pointer';} ?>;" maxlength="8" <?php if($res2['Period']!='Annual' AND $res2['Period']!=''){?> onClick="FunTgt(<?php echo $Sno.','.$res2['KRAId']; ?>,'<?php echo $res2['Period']; ?>',<?php echo $res2['Target'].','.intval($res2['Weightage']); ?>,'<?php echo $res2['Logic']; ?>')" <?php } ?> ><?php if($rowSubK>0){echo '';}else{echo $res2['Target'];}?></span></td>
      ...
      <td class="fbodyc"><?php if($_SESSION['eAppform']=='Y'){ if($n==1){echo $rest['tELogScr'];}else{echo $res2['SelfRating'];} }elseif($_SESSION['eMidform']=='Y'){echo $res2['Mid_SelfRating']; } ?></td>
      ...
      <td class="fbodyc"><input type="text" id="AppKRAScore<?php echo $Sno; ?>" name="AppKRAScore<?php echo $Sno; ?>" style="font-family:Times New Roman;font-size:12px;width:100%;height:24px;text-align:center;border:hidden;background-color:#FFFFFF;font-weight:bold;" value="<?php if($n==1){ echo floatval($rest['tScor']); }elseif($_SESSION['eAppform']=='Y'){ echo $res2['AppraiserScore']; }elseif($_SESSION['eMidform']=='Y'){echo $res2['Mid_AppraiserScore']; } ?>"  readonly/>
...
<?php if($m==1){$n='(a)';}elseif($m==2){$n='(b)';}elseif($m==3){$n='(c)';}elseif($m==4){$n='(d)';}elseif($m==5){$n='(e)';} ?>
	 ...
	 <tr style="background-color:#FFFFFF;">  
	  ...
	  <td class="fbodyc"><?php if($_SESSION['eAppform']=='Y'){ if($restt['tELogScr']>0){echo $restt['tELogScr'];}else{echo $rSubK['SelfRating'];} }elseif($_SESSION['eMidform']=='Y'){echo $rSubK['Mid_SelfRating']; } ?></td>
...
<option style="background-color:#FFFFFF;" value="<?php echo $resEx['DesigId']; ?>"><?php echo strtoupper($resEx['DesigName']); ?></option><?php } ?>
 ...
 <tr valign="middle">
  ...
  <table style="width:100%;">
   ...
   <tr><td class="hl"><b>a)&nbsp;Soft Skills Training</b> [Based on Behavioral parameter]</td></tr>
   <tr bgcolor="#FFFFFF">
    <td><input id="RevSoftSkill_1" name="RevSoftSkill_1" value="<?php echo $resApp['Reviewer_SoftSkill_1']; ?>" class="bl" style="width:100%;border:hidden;" maxlength="400" <?php if($resApp['Reviewer_PmsStatus']==2) { echo 'readonly'; } ?> /></td>
   </tr>
   <tr bgcolor="#FFFFFF">
    <td><input id="RevSoftSkill_2" name="RevSoftSkill_2" value="<?php echo $resApp['Reviewer_SoftSkill_2']; ?>" class="bl" style="width:100%;border:hidden;" maxlength="400" <?php if($resApp['Reviewer_PmsStatus']==2) { echo 'readonly'; } ?> /></td>
   </tr>
   <tr><td class="hl"><b>b)&nbsp;Technical Training</b> [Job related]</td></tr>
   <tr bgcolor="#FFFFFF">
    <td><input id="RevTechSkill_1" name="RevTechSkill_1" value="<?php echo $resApp['Reviewer_TechSkill_1']; ?>" class="bl" style="width:100%;border:hidden;" maxlength="400" <?php if($resApp['Reviewer_PmsStatus']==2) { echo 'readonly'; } ?> /></td>
   </tr>
   <tr bgcolor="#FFFFFF">
    <td><input id="RevTechSkill_2" name="RevTechSkill_2" value="<?php echo $resApp['Reviewer_TechSkill_2']; ?>" class="bl" style="width:100%;border:hidden;" maxlength="400" <?php if($resApp['Reviewer_PmsStatus']==2) { echo 'readonly'; } ?> /></td>
   </tr>
   <tr><td class="hl"><b>c)&nbsp;Remark</b></td></tr>
   <tr bgcolor="#FFFFFF" style="height:24px;">
