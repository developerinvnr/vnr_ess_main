...
//**********************************
$EmMPID=$_REQUEST['ID'];
$SqEC=mysql_query("select EmpCode from hrm_employee where EmployeeID=".$EmMPID, $con); $ReEC=mysql_fetch_assoc($SqEC); $resEC=mysql_fetch_assoc($SqEC);
...
<tr>
 ...
 <select name="AssetNId" id="AssetNId" style="height:22px;font-family:Times New Roman;font-size:12px;width:120px;" onChange="FunChgAsset(this.value,<?php echo $EmMPID.','.$resG['GradeId']; ?>)"><option value="<?php echo $res['AssetNId']; ?>"><?php echo $resAn['AssetName']; ?></option>
...
<tr>
 ...
 <td><input name="ReqAmtExpiryDate" id="ReqAmtExpiryDate" style="width:80px;height:22px;font-family:Times New Roman;font-size:12px;text-align:center;" value="<?php if($res['ReqAmtExpiryDate']!='0000-00-00' AND $res['ReqAmtExpiryDate']!='1970-01-01'){ echo date("d-m-Y",strtotime($res['ReqAmtExpiryDate'])); } ?>" readonly/></td>
</tr>
<tr>
 ...
 <td>Request Date</td><td><input name="ReqDate" id="ReqDate" style="width:80px;height:22px;font-family:Times New Roman;font-size:12px;text-align:center;" value="<?php if($res['ReqDate']!='0000-00-00' AND $res['ReqDate']!='1970-01-01'){ echo date("d-m-Y",strtotime($res['ReqDate'])); } ?>" style="text-align:center;" readonly/><button id="ReqDateBtn" class="CalenderButton"></button></td>
</tr>
<tr>
 ...
 <td>Purchase Date</td><td><input name="PurDate" id="PurDate" style="width:80px;height:22px;font-family:Times New Roman;font-size:12px;text-align:center;" value="<?php if($res['PurDate']!='1970-01-01' AND $res['PurDate']!='0000-00-00'){ echo date("d-m-Y",strtotime($res['PurDate'])); } ?>" style="text-align:center;" readonly/><button id="PurDateBtn" class="CalenderButton"></button></td>
</tr>
<tr>
 ...
 <td>Model Expiry Date</td><td><input name="ExpiryDate" id="ExpiryDate" style="width:80px;height:22px;font-family:Times New Roman;font-size:12px;text-align:center;" value="<?php if($res['ExpiryDate']!='1970-01-01' AND $res['ExpiryDate']!='0000-00-00'){ echo date("d-m-Y",strtotime($res['ExpiryDate'])); } ?>" style="text-align:center;" readonly/><button id="ExpiryDateBtn" class="CalenderButton"></button></td>
</tr>
<tr>
...
<tr>
 <td>Battery Expiry</td><td><input name="BatteryExpiry" id="BatteryExpiry" style="width:80px;height:22px;font-family:Times New Roman;font-size:12px;text-align:center;" value="<?php if($res['BatteryExpiry']!='1970-01-01' AND $res['BatteryExpiry']!='0000-00-00'){ echo date("d-m-Y",strtotime($res['BatteryExpiry'])); } ?>"  style="text-align:center;" readonly/><button id="BatteryExpiryBtn" class="CalenderButton"></button><script type="text/javascript">  var cal = Calendar.setup({ onSelect:  function(cal) { cal.hide()}, showTime: true }); cal.manageFields("ReqDateBtn", "ReqDate", "%d-%m-%Y"); </script></td>
