...
<td valign="top" style="width:240px;color:#000;font-size:12px;" align="justify"><?php echo strtoupper($resD['DepartmentCode']); //if($DepartmentId!=4 AND $DepartmentId!=25){} ?></td>
</tr>
<tr style="background-color:#FFFFFF;">
...
<?php if($resEF2['Fa2_SN']!='Late' && $resEF2['FamilyDOB']<=$Before18y){?>
...
<?php $sqlG=mysql_query("select Covid_Vaccin,Covid_Vaccin2 from hrm_employee_general where EmployeeID=".$EmployeeId,$con);
...
<tr bgcolor="#BCA9D3">
 ...
 <td style="text-align:center;width:300px;font-family:Times New Roman; font-size:13px;"><b>Dose-1</b></td>
 <td style="text-align:center;width:300px;font-family:Times New Roman; font-size:13px;"><b>Dose-2</b></td>
</tr>
<tr>
  ...
  <table border="0"><tr><td style="font-family:Times New Roman; font-size:16px; color:#006F00; font-weight:bold; width:800px;" align="">
   ...
   <tr>
		...
		<?php if($resPS['ProfileCertify']=='N') { ?>
		 ...
		 <input type="button" onClick="Change('<?php echo $_REQUEST['C']; ?>')" id="SubChange" style="width:80px; display:none;" value="Submit" /></td></tr> 
		 </table> 
