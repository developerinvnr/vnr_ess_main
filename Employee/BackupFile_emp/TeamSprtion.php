...
function OpenAppWindow(v,id)
{ window.open("SepResActApp2.php?act=actapp&v="+v+"&Tv=RR&ss=vty&cc=it1212&p=value&a=app&true=false&i="+id,"leaveForm","menubar=no,scrollbars=no,resizable=no,directories=no,width=608,height=400");}

function OpenHodWindow(v,id)
{ window.open("SepResActHod2.php?act=acthod&v="+v+"&Tv=HH&ss=vty&cc=it@~t~1212&p=value&a=app&true=false&i="+id+"&cc=it@~t~1111!@1~ere","leaveForm","menubar=no,scrollbars=no,resizable=no,directories=no,width=608,height=400");}
...
{ if(v=='A'){value='Accept';}else if(v=='C'){value='Reject';} 
  ...
  if(agree)
  { var win=window.open("SepResActApp.php?act=actapp&v="+v+"&ss=vty&cc=it@~t~1212&p=value&a=app&true=false&i="+id,"leaveForm","menubar=no,scrollbars=no,resizable=no,directories=no,width=608,height=400");
    var timer = setInterval( function() { if(win.closed) {  clearInterval(timer);  window.location="TeamSprtion.php?e=4e&w=234&y=10234&a=app&e=4e2&e=4e&w=2~3~4&y=110022344&retd=ee&rr=09drfGe&S=ee11qq&wwrew=t%T@s-$~212ed818&d=101"; } }, 1000);
  }
  else{return false;}
}
...
{ if(v=='A'){value='Accept';}else if(v=='C'){value='Reject';}
  ...
  { var win=window.open("SepResActHod.php?act=acthod&v="+v+"&ss=vty&cc=it@~t~1212&p=value&a=app&true=false&i="+id+"&cc=it@~t~1111!@1~ere","leaveForm","menubar=no,scrollbars=no,resizable=no,directories=no,width=608,height=350");
    var timer = setInterval( function() { if(win.closed) {  clearInterval(timer);  window.location="TeamSprtion.php?e=4e&w=234&y=10234&a=hod&e=4e2&e=4e&w=234&y=110022311&retd=ee&rr=09drfGe&S=eewwqq&wwrew=t%T@sed818&d=101"; } }, 1000);
  }
  else{return false;}
}
 
function OpenSepWindow(v,T,id,EId)
{ 
 if(T=='R'){ window.open("SepResActApp2.php?act=actapp&v="+v+"&Tv=R&ss=vty&cc=it1212&p=value&a=app&true=false&i="+id,"leaveForm","menubar=no,scrollbars=no,resizable=no,directories=no,width=608,height=400"); }
 else if(T=='H'){ window.open("SepResActHod2.php?act=acthod&v="+v+"&Tv=H&ss=vty&cc=it@~t~1212&p=value&a=app&true=false&i="+id+"&cc=it@~t~1111!@1~ere","leaveForm","menubar=no,scrollbars=no,resizable=no,directories=no,width=608,height=400"); } 
}
...
<?php //echo "<img width=105px height=125px src=\"show_images.php?id=".$EmployeeId."\">\n";?></td></td></tr>
  ...
  <td valign="top" style="width:90%; text-align:left;">
...
<table border="0" cellspacing="5" style="width:100%;">
 <tr>
  ...
  <?php if($rowApp>0) { ?>
  <td align="center"><img id="Img_RepMgr1" style="display:<?php if($_REQUEST['a']=='app'){echo 'none';}elseif($_REQUEST['a']=='hod'){echo 'block';} ?>;" src="images/RepMgr1.png" border="0" onClick="javascript:window.location='TeamSprtion.php?e=4e&w=234&y=10234&a=app&e=4e2&e=4e&w=2~3~4&y=110022344&retd=ee&rr=09drfGe&S=ee11qq&wwrew=t%T@s-$~212ed818&d=101'"/>
  ...
  <?php } if($rowHod>0) { ?>
  <td align="center"><img id="Img_Hod1" style="display:<?php if($_REQUEST['a']=='app'){echo 'block';}elseif($_REQUEST['a']=='hod'){echo 'none';} ?>;" src="images/RevHod1.png" border="0" onClick="javascript:window.location='TeamSprtion.php?e=4e&w=234&y=10234&a=hod&e=4e2&e=4e&w=234&y=110022311&retd=ee&rr=09drfGe&S=eewwqq&wwrew=t%T@sed818&d=101'"/>
 ...
 <tr>
  ...
  <td style="display:<?php if($_REQUEST['a']=='app'){echo 'block';}elseif($_REQUEST['a']=='hod'){echo 'none';}?>;width:100%;">
   <table style="width:100%;">
     <tr><td height="40" colspan="7" valign="top" style="font-size:18px;font-family:Times New Roman;"><b>Resignation Details (<u><font color="#008000">Reporting Manager</font></u>)</b>&nbsp;&nbsp;
  ...
  <td style="width:100%;">
   <table border="1" cellspacing="1" style="width:100%;">
     <tr bgcolor="#7a6189" style="height:22px;">
	  ...
	  <td width="150" class="TableHead" align="center"><b>Resignation Reason</b></td>
	  <td width="70" class="TableHead" align="center"><b>Employee Details</b></td>
	  <td width="70" class="TableHead" align="center"><b>Separation Detals</b></td>
...
$sql_statement = mysql_query("select * from hrm_employee_separation where Rep_EmployeeID=".$EmployeeId." order by ResignationStatus ASC, Emp_ResignationDate DESC", $con);  // LIMIT " . $from . "," . $offset
...
?>	 
	 <tr bgcolor="#FFFFFF">
	  ...
	  <td width="100" class="TableHead1" align="center"><?php echo date("d-m-Y",strtotime($res['Emp_RelievingDate'])); ?></td>
	  ...
	  <td width="70" class="TableHead1" align="center"><a href="javascript:OpenSepWindow('<?php if($res['Rep_Approved']=='Y'){ echo 'A'; }else{ 'C'; } ?>','R',<?php echo $res['EmpSepId'].', '.$res['EmployeeID'];?>)">CLICK</a></td>
	  
	  <td width="80" class="TableHead1" align="center" style="color:<?php if($res['Rep_Approved']=='N' OR $res['Rep_Approved']=='P'){echo '#0080FF';}elseif($res['Rep_Approved']=='Y'){echo '#006400';}elseif($res['Rep_Approved']=='C'){echo '#804000';} ?>;">
	 
	  <?php if($EmployeeId!=726){ ?>
	 
	  <?php if($res['Rep_Approved']=='N' OR $res['Rep_Approved']=='P'){echo 'PENDING';}
	        elseif($res['Rep_Approved']=='Y'){ ?><a href="javascript:OpenAppWindow('A',<?php echo $res['EmpSepId'];?>)"><font color="#008000">APPROVED</font></a><?php }
			elseif($res['Rep_Approved']=='C'){ ?><a href="javascript:OpenAppWindow('C',<?php echo $res['EmpSepId'];?>)"><font color="#F55F2C">REJECT</font></a><?php } ?>
	  
	  <?php }else{ ?>
	  
	  <?php if($res['Rep_Approved']=='N' OR $res['Rep_Approved']=='P'){echo 'PENDING';}
	        elseif($res['Rep_Approved']=='Y'){ ?><font color="#008000">APPROVED</font><?php }
			elseif($res['Rep_Approved']=='C'){ ?><font color="#F55F2C">REJECT</font><?php } ?>
	  ...
	  <?php if($EmployeeId!=726){ ?>
	   ...
	   <option value="0">Select</option><option value="A">Approval</option><option value="C">Reject</option></select>
	   <?php } else { echo ''; }?>
...
<?PHP //doPages($offset, 'TeamSprtion.php', '', $total_records); ?>
  ...
  <td style="display:<?php if($_REQUEST['a']=='hod'){echo 'block';}elseif($_REQUEST['a']=='app'){echo 'none';}?>;">
   <table>
      <tr><td height="40" colspan="7" valign="top" style="font-size:18px;font-family:Times New Roman;"><b>Resignation Details (<u><font color="#008000">HOD</font></u>)</b>&nbsp;&nbsp;
	  <font color="#014E05" style='font-family:Times New Roman;' size="3"><b><?php echo $msg; ?></b></font>
	</td>
 </tr>
  <tr>
...
<?php $sql_statement = mysql_query("select * from hrm_employee_separation where Hod_EmployeeID =".$EmployeeId, $con); $total_records = mysql_num_rows($sql_statement);
if(isset($_GET['page'])) $page = $_GET['page']; else $page = 1;  $offset = 10;
if ($page){ $from = ($page * $offset) - $offset; }else{ $from = 0;}
$sql_statement = mysql_query("select * from hrm_employee_separation where Hod_EmployeeID=".$EmployeeId." order by ResignationStatus ASC, Emp_ResignationDate DESC", $con); // LIMIT " . $from . "," . $offset
$rowCheck=mysql_num_rows($sql_statement); if($rowCheck>0){ 
if($_REQUEST['page']==1){$sno=1;} elseif($_REQUEST['page']==2){$sno=11;} elseif($_REQUEST['page']==3){$sno=21;} elseif($_REQUEST['page']==4){$sno=31;} elseif($_REQUEST['page']==5){$sno=41;} elseif($_REQUEST['page']==6){$sno=51;} elseif($_REQUEST['page']==7){$sno=61;} elseif($_REQUEST['page']==8){$sno=71;} elseif($_REQUEST['page']==9){$sno=81;} elseif($_REQUEST['page']==10){$sno=91;} elseif($_REQUEST['page']==11){$sno=101;} elseif($_REQUEST['page']==12){$sno=111;} elseif($_REQUEST['page']==13){$sno=121;} else{$sno=1;}
while($res=mysql_fetch_array($sql_statement)){	  
$sqlE=mysql_query("select EmpCode,Fname,Sname,Lname,DesigId,DepartmentId from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmployeeID=".$res['EmployeeID'], $con); $resE=mysql_fetch_assoc($sqlE); $EmpName=$resE['Fname'].' '.$resE['Sname'].' '.$resE['Lname'];
...
?>	 
	 <tr bgcolor="#FFFFFF">
	  ...
	  <td width="150" class="TableHead1">&nbsp;<a href="javascript:OpenWindow(<?php echo $res['EmpSepId'];?>)"><?php echo substr_replace($res['Emp_Reason'], '', 15).'.....';?></a></td>
	  <td width="70" class="TableHead1" align="center"><a href="javascript:OpenEmpWindow(<?php echo $res['EmployeeID'];?>)">CLICK</a></td>
	  <td width="70" class="TableHead1" align="center"><a href="javascript:OpenSepWindow('<?php if($res['Hod_Approved']=='Y'){ echo 'A'; }else{ 'C'; } ?>','H',<?php echo $res['EmpSepId'].', '.$res['EmployeeID'];?>)">CLICK</a></td>
	  
	  <td width="80" class="TableHead1" align="center" style="color:<?php if($res['Rep_Approved']=='N' OR $res['Rep_Approved']=='P'){echo '#0080FF';}elseif($res['Rep_Approved']=='Y'){echo '#006400';}elseif($res['Rep_Approved']=='C'){echo '#804000';} ?>;">
	  <?php if($res['Hod_Approved']=='N'){
	        if($res['Rep_Approved']=='N' OR $res['Rep_Approved']=='P'){echo 'PENDING';}
	        elseif($res['Rep_Approved']=='Y'){ ?><font color="#008000">APPROVED</font><?php }
			elseif($res['Rep_Approved']=='C'){ ?><font color="#F55F2C">REJECT</font><?php } ?>
			<?php } ?>
			</td>
	  <td width="80" class="TableHead1" align="center" style="color:<?php if($res['Hod_Approved']=='N' OR $res['Hod_Approved']=='P'){echo '#0080FF';}elseif($res['Hod_Approved']=='Y'){echo '#006400';}elseif($res['Hod_Approved']=='C'){echo '#804000';} ?>;">
	  
	  <?php if($EmployeeId!=726){ ?>
	  
	  <?php if($res['Rep_Approved']=='N'){
	        if($res['Hod_Approved']=='N' OR $res['Hod_Approved']=='P'){echo 'PENDING';}
	        elseif($res['Hod_Approved']=='Y'){ ?><a href="javascript:OpenHodWindow('A',<?php echo $res['EmpSepId'];?>)"><font color="#008000">APPROVED</font></a><?php }
			elseif($res['Hod_Approved']=='C'){ ?><a href="javascript:OpenHodWindow('C',<?php echo $res['EmpSepId'];?>)"><font color="#F55F2C">REJECT</font></a><?php } ?>
	  <?php } ?>
	  ...
	  <?php if($res['Rep_Approved']=='N'){
	        if($res['Hod_Approved']=='N' OR $res['Hod_Approved']=='P'){echo 'PENDING';}
	        elseif($res['Hod_Approved']=='Y'){ ?><font color="#008000">APPROVED</font><?php }
			elseif($res['Hod_Approved']=='C'){ ?><font color="#F55F2C">REJECT</font><?php } ?>
	  <?php } ?>
