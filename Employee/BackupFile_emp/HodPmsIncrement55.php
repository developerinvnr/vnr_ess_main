...
{ 
 ...
 $sqVer=mysql_query("select Min_Ctc,Max_Ctc from hrm_pms_vertical_increment where DepId=".$res['HR_Curr_DepartmentId']." AND VerticalId=".$res['EmpVertical']." AND ".$res['HR_CurrGradeId'].">=Min_GradeId AND ".$res['HR_CurrGradeId']."<=Max_GradeId",$con); 
  ...
  { 
   ...
   { 
    ...
    { 
      ...
      { 
       $s_r2= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_dislevel WHERE ".$rev2,$con); 
       $r_r2=mysql_num_rows($s_r2);
       if($r_r2>0){ $resMaxMin = mysql_fetch_assoc($s_r2); }
       else
       { 
        $s_r1= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_dislevel WHERE ".$rev1,$con); 
        $r_r1=mysql_num_rows($s_r1);
        if($r_r1>0){ $resMaxMin = mysql_fetch_assoc($s_r1); }
        else
        { 
         $s_r0= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_dislevel WHERE ".$rev0,$con); 
         ...
         { 
		   ...
		   $s_v1= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_dislevel WHERE ".$ver1,$con); 
           $r_v1=mysql_num_rows($s_v1);
           if($r_v1>0){ $resMaxMin = mysql_fetch_assoc($s_v1); }
           else
           {
		    $s_v0= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_dislevel WHERE ".$ver0,$con); 
            ...
            else
            {
			 ...
			 $s_h0= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_dislevel WHERE ".$hod0,$con); 
             ...
             else
             {
			  ...
			  $s_d0= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_dislevel WHERE ".$dep0,$con); 
              ...
              else
              {
			   /*Management*/
			   $mgm0=$suqry;
			   $s_m0= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_dislevel WHERE ".$mgm0,$con); 
