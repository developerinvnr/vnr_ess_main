...
<?php $CFromDate=date("Y-01-01"); $CToDate=date("Y").'-12-31'; 
	  $sqlCheck=mysql_query("select * from hrm_employee_applyleave where Apply_SentToApp=".$EmployeeId." AND LeaveEmpCancelStatus='Y' AND LeaveCancelStatus='N' AND Apply_FromDate>='".$CFromDate."' order by Apply_Date ASC", $con); 
