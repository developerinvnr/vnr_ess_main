...
if($Yi==$LastYId)
{
 $Sql_4=mysql_query("select * from hrm_employee_monthlypayslip where Month=4 AND EmployeeID=".$Ei." AND Year=".$FromY); 
 $Row_4=mysql_num_rows($Sql_4); if($Row_4>0){$Res_4=mysql_fetch_assoc($Sql_4);}
 $Sql_5=mysql_query("select * from hrm_employee_monthlypayslip where Month=5 AND EmployeeID=".$Ei." AND Year=".$FromY); 
 $Row_5=mysql_num_rows($Sql_5); if($Row_5>0){$Res_5=mysql_fetch_assoc($Sql_5);} 
 $Sql_6=mysql_query("select * from hrm_employee_monthlypayslip where Month=6 AND EmployeeID=".$Ei." AND Year=".$FromY); 
 $Row_6=mysql_num_rows($Sql_6); if($Row_6>0){$Res_6=mysql_fetch_assoc($Sql_6);}
 $Sql_7=mysql_query("select * from hrm_employee_monthlypayslip where Month=7 AND EmployeeID=".$Ei." AND Year=".$FromY); 
 $Row_7=mysql_num_rows($Sql_7); if($Row_7>0){$Res_7=mysql_fetch_assoc($Sql_7);}
 $Sql_8=mysql_query("select * from hrm_employee_monthlypayslip where Month=8 AND EmployeeID=".$Ei." AND Year=".$FromY); 
 $Row_8=mysql_num_rows($Sql_8); if($Row_8>0){$Res_8=mysql_fetch_assoc($Sql_8);}
 $Sql_9=mysql_query("select * from hrm_employee_monthlypayslip where Month=9 AND EmployeeID=".$Ei." AND Year=".$FromY); 
 $Row_9=mysql_num_rows($Sql_9); if($Row_9>0){$Res_9=mysql_fetch_assoc($Sql_9);} 
 $Sql_10=mysql_query("select * from hrm_employee_monthlypayslip where Month=10 AND EmployeeID=".$Ei." AND Year=".$FromY); 
 $Row_10=mysql_num_rows($Sql_10); if($Row_10>0){$Res_10=mysql_fetch_assoc($Sql_10);} 
 $Sql_11=mysql_query("select * from hrm_employee_monthlypayslip where Month=11 AND EmployeeID=".$Ei." AND Year=".$FromY); 
 $Row_11=mysql_num_rows($Sql_11); if($Row_11>0){$Res_11=mysql_fetch_assoc($Sql_11);}
 $Sql_12=mysql_query("select * from hrm_employee_monthlypayslip where Month=12 AND EmployeeID=".$Ei." AND Year=".$FromY); 
 $Row_12=mysql_num_rows($Sql_12); if($Row_12>0){$Res_12=mysql_fetch_assoc($Sql_12);} 
 $Sql_1=mysql_query("select * from hrm_employee_monthlypayslip where Month=1 AND EmployeeID=".$Ei." AND Year=".$ToY); 
 $Row_1=mysql_num_rows($Sql_1); if($Row_1>0){$Res_1=mysql_fetch_assoc($Sql_1);} 
 $Sql_2=mysql_query("select * from hrm_employee_monthlypayslip where Month=2 AND EmployeeID=".$Ei." AND Year=".$ToY); 
 $Row_2=mysql_num_rows($Sql_2); if($Row_2>0){$Res_2=mysql_fetch_assoc($Sql_2);} 
 $Sql_3=mysql_query("select * from hrm_employee_monthlypayslip where Month=3 AND EmployeeID=".$Ei." AND Year=".$ToY); 
 $Row_3=mysql_num_rows($Sql_3); if($Row_3>0){$Res_3=mysql_fetch_assoc($Sql_3);} 
}
else
{

 if($resPayM['Apr']=='Y'){ $Sql_4=mysql_query("select * from hrm_employee_monthlypayslip where Month=4 AND EmployeeID=".$Ei." AND Year=".$FromY); $Row_4=mysql_num_rows($Sql_4); if($Row_4>0){$Res_4=mysql_fetch_assoc($Sql_4);}
 
 } if($resPayM['May']=='Y'){ $Sql_5=mysql_query("select * from hrm_employee_monthlypayslip where Month=5 AND EmployeeID=".$Ei." AND Year=".$FromY); $Row_5=mysql_num_rows($Sql_5); if($Row_5>0){$Res_5=mysql_fetch_assoc($Sql_5);} 

 } if($resPayM['Jun']=='Y'){ $Sql_6=mysql_query("select * from hrm_employee_monthlypayslip where Month=6 AND EmployeeID=".$Ei." AND Year=".$FromY); $Row_6=mysql_num_rows($Sql_6); if($Row_6>0){$Res_6=mysql_fetch_assoc($Sql_6);}
 
 } if($resPayM['Jul']=='Y'){ $Sql_7=mysql_query("select * from hrm_employee_monthlypayslip where Month=7 AND EmployeeID=".$Ei." AND Year=".$FromY); $Row_7=mysql_num_rows($Sql_7); if($Row_7>0){$Res_7=mysql_fetch_assoc($Sql_7);}
 
 } if($resPayM['Aug']=='Y'){ $Sql_8=mysql_query("select * from hrm_employee_monthlypayslip where Month=8 AND EmployeeID=".$Ei." AND Year=".$FromY); $Row_8=mysql_num_rows($Sql_8); if($Row_8>0){$Res_8=mysql_fetch_assoc($Sql_8);}
 
 } if($resPayM['Sep']=='Y'){ $Sql_9=mysql_query("select * from hrm_employee_monthlypayslip where Month=9 AND EmployeeID=".$Ei." AND Year=".$FromY); $Row_9=mysql_num_rows($Sql_9); if($Row_9>0){$Res_9=mysql_fetch_assoc($Sql_9);} 

 } if($resPayM['Oct']=='Y'){ $Sql_10=mysql_query("select * from hrm_employee_monthlypayslip where Month=10 AND EmployeeID=".$Ei." AND Year=".$FromY); $Row_10=mysql_num_rows($Sql_10); if($Row_10>0){$Res_10=mysql_fetch_assoc($Sql_10);} 

 } if($resPayM['Nov']=='Y'){ $Sql_11=mysql_query("select * from hrm_employee_monthlypayslip where Month=11 AND EmployeeID=".$Ei." AND Year=".$FromY); $Row_11=mysql_num_rows($Sql_11); if($Row_11>0){$Res_11=mysql_fetch_assoc($Sql_11);}
 
 } if($resPayM['Decm']=='Y'){ $Sql_12=mysql_query("select * from hrm_employee_monthlypayslip where Month=12 AND EmployeeID=".$Ei." AND Year=".$FromY); $Row_12=mysql_num_rows($Sql_12); if($Row_12>0){$Res_12=mysql_fetch_assoc($Sql_12);} 

 } if($resPayM['Jan']=='Y'){ $Sql_1=mysql_query("select * from hrm_employee_monthlypayslip where Month=1 AND EmployeeID=".$Ei." AND Year=".$ToY); $Row_1=mysql_num_rows($Sql_1); if($Row_1>0){$Res_1=mysql_fetch_assoc($Sql_1);} 

 } if($resPayM['Feb']=='Y'){ $Sql_2=mysql_query("select * from hrm_employee_monthlypayslip where Month=2 AND EmployeeID=".$Ei." AND Year=".$ToY); $Row_2=mysql_num_rows($Sql_2); if($Row_2>0){$Res_2=mysql_fetch_assoc($Sql_2);} 

 } if($resPayM['Mar']=='Y'){ $Sql_3=mysql_query("select * from hrm_employee_monthlypayslip where Month=3 AND EmployeeID=".$Ei." AND Year=".$ToY); $Row_3=mysql_num_rows($Sql_3); if($Row_3>0){$Res_3=mysql_fetch_assoc($Sql_3);} 
 }
