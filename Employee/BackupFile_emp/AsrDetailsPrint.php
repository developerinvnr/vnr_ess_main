...
$TotG5=$Res_5['Tot_Gross']+$Res_5['Bonus']+$Res_5['DA']+$Res_5['Arreares']+$Res_5['LeaveEncash']+$Res_5['Incentive']+$Res_5['VariableAdjustment']+$Res_5['VarRemburmnt']+$Res_5['PerformancePay']+$Res_5['CCA']+$Res_5['RA']+$Res_5['Arr_Basic']+$Res_5['Arr_Hra']+$Res_5['Arr_Spl']+$Res_5['Arr_Conv']+$Res_5['YCea']+$Res_5['YMr']+$Res_5['YLta']+$Res_5['Car_Allowance_Arr']+$Res_5['Arr_LvEnCash']+$Res_5['Arr_Bonus']+$Res_5['Arr_LTARemb']+$Res_5['Arr_RA']+$Res_5['Arr_PP']+$Res_5['Bonus_Adjustment'];
...
$TotG7=$Res_7['Tot_Gross']+$Res_7['Bonus']+$Res_7['DA']+$Res_7['Arreares']+$Res_7['LeaveEncash']+$Res_7['Incentive']+$Res_7['VariableAdjustment']+$Res_7['VarRemburmnt']+$Res_7['PerformancePay']+$Res_7['CCA']+$Res_7['RA']+$Res_7['Arr_Basic']+$Res_7['Arr_Hra']+$Res_7['Arr_Spl']+$Res_7['Arr_Conv']+$Res_7['YCea']+$Res_7['YMr']+$Res_7['YLta']+$Res_7['Car_Allowance_Arr']+$Res_7['Arr_LvEnCash']+$Res_7['Arr_Bonus']+$Res_7['Arr_LTARemb']+$Res_7['Arr_RA']+$Res_7['Arr_PP']+$Res_7['Bonus_Adjustment'];
