...
{ var AppKRARow=document.getElementById("EmpKraRow").value; var Sno=document.getElementById("Sno").value; 
 ...
 document.getElementById("TotalScore_12").value=Math.round((Score1+Score_2)*100)/100;
...
{ var EmpFormBRow=document.getElementById("EmpFormBRow").value; var SnoB=document.getElementById("SnoB").value;  
 ...
 document.getElementById("TotalScore_12").value=Math.round((Score_1+Score2)*100)/100;
}		
    ...
    <td width="1200">
	  <table>
	    <tr>
		 ...
		 <td align="center" style="font-family:Times New Roman; font-size:14px; font-weight:bold;width:100px;">
		 <a href="ManagerPms.php"><a href="ManagerPms.php"><font color="#620000">My_Team</font></a></td>    			   
		 <td align="center" style="font-family:Times New Roman; font-size:14px; font-weight:bold;width:100px;">
		 <?php if($CuDate>=$resSch['AppFromDate'] AND $CuDate<=$resSch['AppToDate'] AND $resSch['AppDateStatus']=='A') { ?> 
         <a href="ManagerTeamStatus.php?action=teamS"><font color="#FFFFFF">Team_Status</font></a><?php } ?></td>  			       
	  </table>
	</td>
   </tr>
...
<td align="center" valign="top" style="font-family:Times New Roman; color:#FFFFFF; font-size:12px;">
 <input id="AppKRARating<?php echo $Sno; ?>" style="font-family:Times New Roman; background-color:#FFFFFF; font-size:12px; width:80px; height:22px; text-align:center;" maxlength="5" value="<?php echo $res2['AppraiserRating']; ?>" <?php if($resApp['Appraiser_PmsStatus']==2) { echo 'readonly'; } ?> onChange="EnterAppKra(<?php echo $res2['KRAFormAId'].','.$Sno; ?>)"/></td>
<td align="center" valign="top" style="font-family:Times New Roman; color:#FFFFFF; font-size:12px;">
 <input id="AppKRAScore<?php echo $Sno; ?>" style="font-family:Times New Roman; font-size:12px; background-color:#FFFFFF; width:60px; height:22px; text-align:center;" value="<?php echo $res2['AppraiserScore']; ?>"  readonly/>
</td>
</tr>
...
<tr bgcolor="#FFFFFF">
  <td colspan="9" style="font-family:Times New Roman; font-size:11px; width:800px; font-weight:bold;" align="right"> Final Appraiser KRA Score:&nbsp;</td>
  <td align="right" style="font-family:Times New Roman; color:#FFFFFF; font-size:12px;">
 <input id="AppFormAScore<?php echo $Sno; ?>" style="font-family:Times New Roman;background-color:#9BCDFF;font-weight:bold; font-size:11px; width:60px; height:22px; text-align:center;" value="<?php echo $resApp['AppraiserFormAScore']; ?>"  readonly/>
  </td>
</tr>
  </table>
 </td>
 ...
 <tr>
  <td>
   <table>
      <tr bgcolor="#7a6189" style="height:20px;" valign="middle">
	<td align="center" style="font-family:Times New Roman; color:#FFFFFF; font-size:11px; width:30px;"><b>SNo.</b></td>
	<td align="center" style="font-family:Times New Roman; color:#FFFFFF; font-size:11px; width:400px;"><b>Skill</b></td>
	<td align="center" style="font-family:Times New Roman; color:#FFFFFF; font-size:11px; width:80px;"><b>Weightage</b></td>
...
<td align="center" valign="top" style="font-family:Times New Roman; color:#FFFFFF; font-size:12px;">
 <input id="AppFormBRating<?php echo $SnoB; ?>" style="font-family:Times New Roman; font-size:12px; width:80px;background-color:#FFFFFF; height:22px; text-align:center;" value="<?php echo $res2['AppraiserRating']; ?>" maxlength="5" <?php if($resApp['Appraiser_PmsStatus']==2) { echo 'readonly'; } ?> onChange="EnterAppFormB(<?php echo $res2['BehavioralFormBId'].','.$SnoB; ?>)" /></td>
<td align="center" valign="top" style="font-family:Times New Roman; color:#FFFFFF; font-size:12px;">
 <input id="AppFormBScore<?php echo $SnoB; ?>" style="font-family:Times New Roman; font-size:12px; width:60px;background-color:#FFFFFF; height:22px; text-align:center;" value="<?php echo $res2['AppraiserScore']; ?>"  readonly/>
</td>
</tr>
...
<tr bgcolor="#FFFFFF">
  <td colspan="7" style="font-family:Times New Roman; font-size:12px; width:800px; font-weight:bold;" align="right"> Final Appraiser FormB Score:&nbsp;</td>
  <td align="center" style="font-family:Times New Roman; color:#FFFFFF; font-size:12px;">
 <input id="AppBehaviFormBScore<?php echo $SnoB; ?>" style="font-family:Times New Roman;font-weight:bold; font-size:12px;background-color:#9BCDFF; width:60px; height:22px; text-align:center;" value="<?php echo $resApp['AppraiserFormBScore']; ?>"  readonly/>
  </td>
 </tr>
</table>
</td>
...
<?php /* ?>	  <tr bgcolor="#FFFFFF" style="height:20px;">
	   ...
	   <td bgcolor="#FFFFFF" style="font-family:Times New Roman; font-size:12px; width:100px;" align="center">
	   <input id="Score_1" style="font-family:Times New Roman;background-color:#FFE6E6;border-style:hidden;font-weight:bold; font-size:12px;width:100px; height:22px; text-align:center;" value="<?php echo $resApp['AppraiserFinallyFormA_Score']; ?>"  readonly/>
	   </td>
	   <td bgcolor="#FFFFFF" style="font-family:Times New Roman; font-size:12px; width:100px; " align="center">
	   ...
	   <td bgcolor="#FFFFFF" style="font-family:Times New Roman; font-size:12px; width:150px; " align="center">
	    <input id="Score_2" style="font-family:Times New Roman;background-color:#FFE6E6;border-style:hidden;font-weight:bold; font-size:12px;width:150px; height:22px; text-align:center;" value="<?php echo $resApp['AppraiserFinallyFormB_Score']; ?>"  readonly/>
	   </td>
	   ...
	   <input id="TotalScore_12" style="font-family:Times New Roman;background-color:#F7FCD6;border-style:hidden;font-weight:bold; font-size:12px;width:100px; height:22px; text-align:center;" value="<?php echo $resApp['Appraiser_TotalFinalScore']; ?>"  readonly/>
	   </td>
...
<select style="width:150px; height:20px; background-color:#DDFFBB;font-size:12px;" id="DesigId">
...
<td bgcolor="#FFFFFF" style="font-family:Georgia; font-size:12px; width:150px; font-weight:bold;" align="">
<select style="width:50px; height:20px; background-color:#DDFFBB;font-size:12px;" id="GradeId">
...
<input name="Justification" id="Justification" style="height:20px;font-size:11px;width:800px; border-style:hidden;" value="<?php echo $resApp['Appraiser_Justification']; ?>" maxlength="250"/>
</td>
      </tr>          
   </table>
</td>
...
<input id="AppRemarks" value="<?php echo $resApp['Appraiser_Remark']; ?>" style="font-family:Times New Roman; font-size:11px; width:1100px; height:20px;" maxlength="200" <?php if($resApp['Appraiser_PmsStatus']==2) { echo 'readonly'; } ?> />
</td>
</tr>
   </table>
</td>
 ...
 <input type="button" name="SubmitScore" id="SubmitScore" style="width:120px;" onClick="return AppScore2(<?php echo $resApp['EmpPmsId'].','.$Eid.','.$YearId; ?>)" value="submit form"/></td>
