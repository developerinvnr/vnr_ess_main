...
<?php //echo "<img width=105px height=125px src=\"show_images.php?id=".$EmployeeId."\">\n";?></td>
	     ...
	     <table border="0" width="1000">
		    <tr>
			 ...
			 <?php if($rowApp>0) { ?>
             <td align="center"><a href="AppMyTeam.php"><img id="Img_RepMgr1" style="display:none;" src="images/RepMgr1.png" border="0"/></a>
		     <img id="Img_RepMgr" style="display:block;" src="images/RepMgr.png" border="0"/></td><?php } ?>
			 <?php if($rowHod>0) { ?>
             <td align="center"><a href="HodMyTeam.php"><img id="Img_Hod1" style="display:block;" src="images/RevHod1.png" border="0"/></a>
...
?> 			
 ...
 <td style="font-family:Georgia; font-size:11px; width:50px;" align="center"><?php echo $ResG['GradeValue']; ?></td>
  <?php } ?>
<?php $sqlE=mysql_query("select * from hrm_employee_reporting where AppraiserId=".$ResRep['EmployeeID'], $con); $rowE=mysql_num_rows($sqlE);?>				 
			 <td style="font-family:Georgia; font-size:11px; width:50px;" align="center"><?php if($rowE>0){ ?>
			 <a href="#" onClick="EmpTeam(<?php echo $ResRep['EmployeeID'].', '.$CompanyId; ?>)"><font color="#000099">Team</font></a><?php } else '&nbsp;'; ?></td>

 <?php if($resSetH['Show_Elig']=='Y'){ ?>
 <td style="font-family:Georgia; font-size:11px; width:50px;" align="center"><a href="javascript:ReadElig(<?php echo $ResRep['EmployeeID'].', '.$CompanyId; ?>)">Click</a></td>
 <?php } ?>
<td style="font-family:Georgia; font-size:11px; width:100px;" align="center"><a href="javascript:ReadTra(<?php echo $ResRep['EmployeeID'].', '.$CompanyId; ?>)">Click</a></td>
<?php if($CompanyId==1){ ?>
<td style="font-family:Georgia; font-size:11px; width:50px;" align="center">
		<?php $sqlShow=mysql_query("select UseKRA from hrm_pms_kra where YearId=".$YearId." AND EmployeeID=".$ResRep['EmployeeID'], $con);  $resShow=mysql_fetch_assoc($sqlShow);	   	
              if($resShow['UseKRA']=='A' OR $resShow['UseKRA']=='H' OR $resShow['UseKRA']=='R') {?>
			<a href="#" onClick="EmpKRA(<?php echo $CompanyId.', '.$YearId.','.$ResRep['EmployeeID']; ?>)">Click</a>
<?php } ?></td><?php } ?>
