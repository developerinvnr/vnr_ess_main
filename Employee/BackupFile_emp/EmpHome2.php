...
{ $msg = "Your entered an incorrect password. <a href=EmpHome.php?log=".$_POST['LogId']." style='text-decoration:none;'>Try Again</a>";} 
     ...
     { 
	  $SqlUpdate=mysql_query("UPDATE hrm_employee SET ChangePwd='Y', EmpPass='".$_POST['pass1']."' where EmployeeID=".$EmployeeId, $con); 
     if($SqlUpdate) 
...
<tr><td align="left" class="font2" ><img src="../AdminUser/images/Cpwd.png" border="0" /></td>
    <td><input class="input" type="password" name="currpass" id="currpass" size="25" maxlength="25" value="<?php echo $res['EmpPass']; ?>" readonly></td></tr>
