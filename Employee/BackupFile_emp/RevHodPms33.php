    ...
    <td width="1200">
	  ...
	  <table border="0">
	    ...
	    <tr> 
		 ...
		 <?php if($resKey['TeamStatus']=='Y') { ?><td align="center" style="font-family:Times New Roman; font-size:14px; font-weight:bold;width:90px;">
		 <a href="RevHodPms.php"><img src="images/TeamStatus.png" border="0" /></a></td><?php } ?>    			   
...
<?php $sqlCh = mysql_query("select * from hrm_pms_allow where HOD_EmployeeID=".$EmployeeId." AND CompanyId=".$CompanyId." AND AssesmentYear=".$YearId, $con); 
      $rowCh=mysql_num_rows($sqlCh);	 
		 ...
		 <td align="center" style="font-family:Times New Roman; font-size:14px; font-weight:bold;width:80px;">	
         <a href="HodPmsIncrement.php"><img src="images/Increment1.png" border="0" /></a><?php } ?></td><?php } ?>
		 <?php if($resKey['MyPmsReport']=='Y') { ?><td align="center" style="font-family:Times New Roman; font-size:14px; font-weight:bold;width:100px;">	
         <a href="HodPmsReports.php"><img src="images/pmsreports1.png" border="0" /></a></td><?php } ?> 
         <?php if($resKey['IncrementReport']=='Y') { ?><td align="center" style="font-family:Times New Roman; font-size:14px; font-weight:bold;width:100px;">	
         <a href="HodIncReports.php"><img src="images/IncrementReports1.png" border="0" /></a></td><?php } ?>
         <?php if($resKey['RatingGraph']=='Y') { ?><td align="center" style="font-family:Times New Roman; font-size:14px; font-weight:bold;width:100px;">	
