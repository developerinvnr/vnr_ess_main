...
/****************************** Arreaer Open ******/
var IncSalaryPM = parseFloat(document.getElementById("IncSalaryPM"+Sno).value);
var Dojj = document.getElementById("Doj"+Sno).value;
...
{ document.getElementById("Extra3Month"+Sno).value=Math.round((IncSalaryPM*3)*100)/100; }	
else if(Doj>Sep16 && Doj<=Dec16)
{
  ...
  document.getElementById("Extra3Month"+Sno).value=Math.round(Month_Per2+Day_Per2);
  //alert(Month_Per2+Day_Per2);
   
}
else if(Doj>Dec16){ document.getElementById("Extra3Month"+Sno).value=0; }
...
$TotEGross=$ResCount['Old_GROSS']+$ResCount['Old_Inc']; //Total Old Gross
$One=($TotEGross*1)/100; $OnePerPre=number_format($One, 2, '.', ''); //One Percent from Old Gross
$TotHIS=$ResCount['H_IS']+$ResCount['H_Inc']+$ResCount['H_SC']; //Total Proposed Increment
...
$TotalPerPIS=($ResCount['H_IS']+$ResCount['H_Inc'])/$OnePerPre; $TotalTPerPIS=number_format($TotalPerPIS, 2, '.', '');
...
<input type="hidden" id="PerValue" /><input type="hidden" id="OnePerPre" value="<?php echo $OnePerPre; ?>"/> 
  ...
  <table border="0" style="width:100%;">
   <tr>
	...
	&nbsp;&nbsp;<u>Previous GSPM</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" id="MyTTPreGross" value="<?php echo $TotOldGrossPM; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;<u>Proposed GSPM</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" id="MyTTProGross" value="<?php echo $TotNewGrossPM; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;<u>Increment</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" id="MyTTIncGross" value="<?php echo $Increment; ?>"/>&nbsp;<input class="rinput" style="width:60px;" id="MyTTIncGrossPercent" value="<?php echo $PerInc; ?>"/>&nbsp;%&nbsp;&nbsp;&nbsp;&nbsp;<u>SC</u>&nbsp;:&nbsp;<input class="rinput" style="width:60px;" id="MyTTSCPercent" value="<?php echo $TotalTPerPSC; ?>" />&nbsp;%
    ...
    <u>Previous GSPM</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" id="MyTTPreGross_22" value="<?php echo $TotOldGrossPM; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;<u>Proposed GSPM</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" id="MyTTProGross_22" value="<?php echo $TotNewGrossPM; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;<u>Increment</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" id="MyTTIncGross_22" value="<?php echo $Increment; ?>"/>&nbsp;<input class="rinput" style="width:60px;" id="MyTTIncGrossPercent_22" value="<?php echo $PerInc; ?>"/>&nbsp;%&nbsp;&nbsp;&nbsp;&nbsp;<u>SC</u>&nbsp;:&nbsp;<input class="rinput" style="width:60px;" id="MyTTSCPercent_22" value="<?php echo $TotalTPerPSC; ?>" />&nbsp;%
	</div>
...
{
 $sql=mysql_query("select e.EmployeeID, EmpCode, Fname, Sname, Lname, d.DepartmentId, DateJoining, DepartmentCode, EmpPmsId, Appraiser_EmployeeID, Reviewer_EmployeeID, Reviewer_TotalFinalScore, Reviewer_TotalFinalRating, Hod_TotalFinalScore, Hod_TotalFinalRating, HodSubmit_IncStatus, Hod_EmpDesignation, Hod_EmpGrade, Hod_ProIncSalary, Hod_Percent_ProIncSalary, Hod_ProCorrSalary, Hod_Percent_ProCorrSalary, Hod_IncNetMonthalySalary, Hod_Percent_IncNetMonthalySalary, Hod_GrossMonthlySalary, Hod_GrossAnnualSalary, Hod_Incentive, HodPer_PIS_From_PreMyTGrossPM, HodPer_SC_From_PreMyTGrossPM, HodPer_TISPM_From_PreMyTGrossPM, HR_CurrDesigId, HR_CurrGradeId, HR_Curr_DepartmentId, INCENTIVE from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_ctc c ON p.EmployeeID=c.EmployeeID INNER JOIN hrm_department d ON g.DepartmentId=d.DepartmentId where e.EmpStatus='A' AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.HOD_EmployeeID=".$EmployeeId." AND g.DepartmentId=".$_REQUEST['FilD']." AND c.Status='A' order by EmpCode ASC", $con);
}
elseif($_REQUEST['FilD']>0 AND $_REQUEST['FilS']>0)
{
 $sql=mysql_query("select e.EmployeeID, EmpCode, Fname, Sname, Lname, d.DepartmentId, DateJoining, DepartmentCode, EmpPmsId, Appraiser_EmployeeID, Reviewer_EmployeeID, Reviewer_TotalFinalScore, Reviewer_TotalFinalRating, Hod_TotalFinalScore, Hod_TotalFinalRating, HodSubmit_IncStatus, Hod_EmpDesignation, Hod_EmpGrade, Hod_ProIncSalary, Hod_Percent_ProIncSalary, Hod_ProCorrSalary, Hod_Percent_ProCorrSalary, Hod_IncNetMonthalySalary, Hod_Percent_IncNetMonthalySalary, Hod_GrossMonthlySalary, Hod_GrossAnnualSalary, Hod_Incentive, HodPer_PIS_From_PreMyTGrossPM, HodPer_SC_From_PreMyTGrossPM, HodPer_TISPM_From_PreMyTGrossPM, HR_CurrDesigId, HR_CurrGradeId, HR_Curr_DepartmentId, INCENTIVE from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_ctc c ON p.EmployeeID=c.EmployeeID INNER JOIN hrm_department d ON g.DepartmentId=d.DepartmentId INNER JOIN hrm_headquater hq ON g.HqId=hq.HqId where e.EmpStatus='A' AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.HOD_EmployeeID=".$EmployeeId." AND g.DepartmentId=".$_REQUEST['FilD']." AND hq.StateId=".$_REQUEST['FilS']." AND c.Status='A' order by EmpCode ASC", $con);
}
elseif($_REQUEST['FilD']=='All' AND $_REQUEST['FilS']>0)
{
 $sql=mysql_query("select e.EmployeeID, EmpCode, Fname, Sname, Lname, d.DepartmentId, DateJoining, DepartmentCode, EmpPmsId, Appraiser_EmployeeID, Reviewer_EmployeeID, Reviewer_TotalFinalScore, Reviewer_TotalFinalRating, Hod_TotalFinalScore, Hod_TotalFinalRating, HodSubmit_IncStatus, Hod_EmpDesignation, Hod_EmpGrade, Hod_ProIncSalary, Hod_Percent_ProIncSalary, Hod_ProCorrSalary, Hod_Percent_ProCorrSalary, Hod_IncNetMonthalySalary, Hod_Percent_IncNetMonthalySalary, Hod_GrossMonthlySalary, Hod_GrossAnnualSalary, Hod_Incentive, HodPer_PIS_From_PreMyTGrossPM, HodPer_SC_From_PreMyTGrossPM, HodPer_TISPM_From_PreMyTGrossPM, HR_CurrDesigId, HR_CurrGradeId, HR_Curr_DepartmentId, INCENTIVE from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_ctc c ON p.EmployeeID=c.EmployeeID INNER JOIN hrm_department d ON g.DepartmentId=d.DepartmentId INNER JOIN hrm_headquater hq ON g.HqId=hq.HqId where e.EmpStatus='A' AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.HOD_EmployeeID=".$EmployeeId." AND hq.StateId=".$_REQUEST['FilS']." AND c.Status='A' order by EmpCode ASC", $con);
}
elseif(($_REQUEST['FilD']=='All' AND $_REQUEST['FilS']=='All') OR ($_REQUEST['FilD']=='' AND $_REQUEST['FilS']==''))
{
 $sql=mysql_query("select e.EmployeeID, EmpCode, Fname, Sname, Lname, d.DepartmentId, DateJoining, DepartmentCode, EmpPmsId, Appraiser_EmployeeID, Reviewer_EmployeeID, Reviewer_TotalFinalScore, Reviewer_TotalFinalRating, Hod_TotalFinalScore, Hod_TotalFinalRating, HodSubmit_IncStatus, Hod_EmpDesignation, Hod_EmpGrade, Hod_ProIncSalary, Hod_Percent_ProIncSalary, Hod_ProCorrSalary, Hod_Percent_ProCorrSalary, Hod_IncNetMonthalySalary, Hod_Percent_IncNetMonthalySalary, Hod_GrossMonthlySalary, Hod_GrossAnnualSalary, Hod_Incentive, HodPer_PIS_From_PreMyTGrossPM, HodPer_SC_From_PreMyTGrossPM, HodPer_TISPM_From_PreMyTGrossPM, HR_CurrDesigId, HR_CurrGradeId, HR_Curr_DepartmentId, INCENTIVE from hrm_employee_pms p INNER JOIN hrm_employee e ON p.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON p.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_ctc c ON p.EmployeeID=c.EmployeeID INNER JOIN hrm_department d ON g.DepartmentId=d.DepartmentId INNER JOIN hrm_headquater hq ON g.HqId=hq.HqId where e.EmpStatus='A' AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.HOD_EmployeeID=".$EmployeeId." AND c.Status='A' order by EmpCode ASC", $con);
}	 
$sno=1; while($res=mysql_fetch_array($sql)){

$sqlCount=mysql_query("select SUM(Incentive) as INC from hrm_pms_appraisal_history where EmpCode=".$res['EmpCode']." AND CompanyId=".$CompanyId, $con); while($Count=mysql_fetch_array($sqlCount)){ $TotInEM=$Count['INC']; } ?> 
...
<?php /************** 111111111111111111 Open Open *****************/ ?>		  
	    <td class="tdl" style="font-weight:bold;font-size:14px;width:65%;color:#FFFFFF;">&nbsp;
...
else
{
 ...
 {
  $ss2= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_dishod WHERE Rating=".$RatingHod." AND HodId=".$EmployeeId." AND YearId=".$_SESSION['PmsYId']." AND IncDistriFrom>0 AND CompanyId=".$CompanyId, $con); 
...
<?php /************** 222222222222222222 Close Close *****************/ ?>
		  ...
		  <tr bgcolor="#7a6189">
			 <td class="th" style="width:4%;"><b>Pre. Grade</b></td>
		     <td class="th" style="width:4%;"><b>Pro. Grade</b></td>
		     <td class="th" style="width:18%;"><b>Previouse Designation</b></td>
		     <td class="th" style="width:18%;"><b>Proposed Designation</b></td>
		     <td class="th" style="width:5%;"><b>Change<br>Date</b></td>
		     <td class="th" style="width:4%;"><b>&nbsp;</b></td>		  
		     <td class="th" style="width:5%;"><b>Pre.<br>GSPM</b></td>			  
		     <td class="th" style="width:5%;"><b>PGSPM</b></td>
		     <td class="th" style="width:5%;"><b>% PIS</b></td>
		     <td class="th" style="width:5%;"><b>Salary<br>Correction</b></td>
		     <td class="th" style="width:5%;"><b>Total<br>PGSPM</b></td>
		     <td class="th" style="width:5%;"><b>% Total<br>PGSPM</b></td>
           <?php if($TotInEM>0) { ?>
             <td class="th" style="width:5%;"><b>IN-<br>CENTIVE</b></td>
             <td class="th" style="width:5%;"><b>Total<br>Pay PM</b></td>
           <?php } ?>			  
		     <td class="th" style="width:4%;"><b>Score</b></td>
			...
			<tr bgcolor="#FFFFFF" height="20px;">
		     ...
		     <td class="tdc"><?php echo ''; ?></td>
		     <td class="tdc"><?php echo ''; ?></td>
		     <td class="tdr"><?php echo ''; ?></td> <?php  ?>
	         <td class="tdr"><?php echo $resHistory['Previous_GrossSalaryPM']; //$resHistory['TotalProp_GSPM'];?></td>
           ...
           <?php if($TotInEM>0){ $TotalPay=$resHistory['Previous_GrossSalaryPM']+$resHistory['Incentive']; ?>
             <td class="tdr"><?php echo $resHistory['Incentive']; ?></td>
           ...
           <?php } } ?>	
            ...
            <?php $sqlHistory=mysql_query("select * from hrm_pms_appraisal_history where EmpCode=".$res['EmpCode']." AND CompanyId=".$CompanyId." AND SalaryChange_Date>='".date("2012-01-01")."' AND SalaryChange_Date!='".date("Y-10-01")."' order by SalaryChange_Date ASC", $con); $rowHis=mysql_num_rows($sqlHistory); while($resHistory=mysql_fetch_array($sqlHistory)){ if($resHistory['Previous_GrossSalaryPM']!=$resHistory['TotalProp_GSPM']){ ?>			
			<tr bgcolor="#FFFFFF" height="20px;">
			 <td class="tdc"><?php echo $resHistory['Current_Grade']; ?></td>
		     <td class="tdc"><?php echo $resHistory['Proposed_Grade']; ?></td>
		     <td class="tdl"><?php echo strtoupper($resHistory['Current_Designation']); ?></td>
		     ...
		     <td class="tdc"><?php echo date("d-M-y",strtotime($resHistory['SalaryChange_Date'])); ?></td>
		     <td class="tdc">&nbsp;</td>
		     <td class="tdr" align="right"><?php echo $resHistory['Previous_GrossSalaryPM']; ?></td>			  
		     <td class="tdr" align="right"><?php echo $resHistory['Proposed_GrossSalaryPM']; ?></td>
		     <td class="tdc"><?php echo $resHistory['Prop_PeInc_GSPM']; ?></td>
		     <td class="tdr" align="right"><?php echo $resHistory['PropSalary_Correction']; ?></td>
		     <td class="tdr" align="right"><?php echo $resHistory['TotalProp_GSPM']; ?></td>
...
<?php //$_SESSION['EffDate'] -->Salary Change Date
            ...
            <tr bgcolor="#FFFFFF">						
             ...
             <td class="tdl"><?php echo $resD1['DesigName'];?></td>	
		     <td class="tdl" bgcolor="#B9FFB9"><?php if($res['HR_CurrDesigId']!=$res['Hod_EmpDesignation']){ echo $resD2['DesigName']; } ?></td>
		     <td class="tdcc"><b><?php echo date("d-M-y",strtotime($_SESSION['EffDate'])); //$SalChDate; ?></b></td>
		     <td class="tdc">
			 ...
			 <td class="tdrr"><b><?php echo $TPreGross; ?></b></td>
		     <td class="tdc" bgcolor="#B9FFB9" id="TDD1_<?php echo $sno; ?>"><input id="ProGSPM_<?php echo $sno; ?>" class="tdrr" style="border-style:hidden;border:0;background-color:#B9FFB9;width:100%;text-align:right;" value="<?php echo $res['Hod_ProIncSalary']; ?>" maxlength="15" <?php if($rowChh>0){ echo ''; }else{ echo 'disabled'; echo 'readOnly'; }?> onKeyUp="CalProInc(<?php echo $sno; ?>)" onClick="CalProInc(<?php echo $sno; ?>)" onChange="CalProInc(<?php echo $sno; ?>)"/></td>
		     <td class="tdc" bgcolor="#B9FFB9"><input id="Per_ProGSPM_<?php echo $sno; ?>" class="tdcc" style="border-style:hidden;border:0;background-color:#B9FFB9;width:100%;" value="<?php echo $res['Hod_Percent_ProIncSalary']; ?>" readOnly maxlength="12"/></td>
		     <td class="tdc" bgcolor="#B9FFB9" id="TDD2_<?php echo $sno; ?>"><input id="ProSC_<?php echo $sno; ?>" class="tdrr" style="border-style:hidden;border:0;background-color:#B9FFB9;width:100%;text-align:right;" value="<?php echo $res['Hod_ProCorrSalary']; ?>" <?php if($rowChh>0){ echo ''; }else{ echo 'disabled'; }?>  maxlength="15" onKeyUp="CalProInc(<?php echo $sno; ?>)" onClick="CalProInc(<?php echo $sno; ?>)" onChange="CalProInc(<?php echo $sno; ?>)"/></td>
		     <td class="tdc" bgcolor="#B9FFB9"><input id="TotalProGSPM_<?php echo $sno; ?>" class="tdrr" style="border-style:hidden; border:0; background-color:#B9FFB9;width:100%;text-align:right;" value="<?php echo $res['Hod_GrossMonthlySalary']; ?>" readOnly maxlength="15"/></td>
		     <td class="tdc" bgcolor="#B9FFB9"><input id="Per_TotalProGSPM_<?php echo $sno; ?>" class="tdcc" style="border-style:hidden; border:0; background-color:#B9FFB9;width:100%;" value="<?php echo $res['Hod_Percent_IncNetMonthalySalary']; ?>" readOnly maxlength="15"/>
