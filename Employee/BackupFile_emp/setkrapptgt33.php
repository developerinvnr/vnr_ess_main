 ...
 <tr>
  <td style="width:100%;" valign="top">
   <table align="center" border="0" cellspacing="1">
    ...
    <tr><td>&nbsp;</td></tr>
	<tr><td colspan="10" style="font-size:20px;" align="center"><font color="#000000"><u>Note</u>:</font> <font color="#FF1515">Please enter achievement numbers as per the <u><?php echo $_REQUEST['prd']; ?></u> broken targets and not the complete annual target</font></td></tr>
...
<?php $sql=mysql_query("select * from hrm_pms_kra_tgtdefin where ".$fn."=".$_REQUEST['kid']." AND Tital='".$t."' AND NtgtN='".$i."'",$con); $row=mysql_num_rows($sql); $res=mysql_fetch_assoc($sql); ?>	 
	...
	<td align="center">
	 <?php $Nxt14Day=date("Y-m-d",strtotime('+14 day', strtotime(date("2018-12-14")))); //date("2018-12-14") //$res['Ldate'] ?>
