		   ...
		   <tr>
			 <td>
			  <table border="0">
			   <tr>
             <?php if($rowApp>0) { ?>
             <td align="center"><a href="AppMyTeamPostQuery.php?page=1"><img id="Img_RepMgr1" style="display:none;" src="images/RepMgr1.png" border="0"/></a>
		     <img id="Img_RepMgr" style="display:block;" src="images/RepMgr.png" border="0"/></td><?php } ?>
			 <?php if($rowHod>0) { ?>
             <td align="center"><a href="HodMyTeamPostQuery.php?page=1"><img id="Img_Hod1" style="display:block;" src="images/RevHod1.png" border="0"/></a>
		     <img id="Img_Hod" style="display:none;" src="images/RevHod.png" border="0"/></td><?php } ?>
			 <td>&nbsp;</td>
		<td style="font-family:Times New Roman; color:#004A00; font-size:16px;width:345px;" align=""><b><u>My Teams Query</u></b></td>
		<td align="center" style="font-family:Times New Roman; color:#004A00;width:82px; font-size:15px;"><a href="javascript:window.location='AppMyTeamPostQuery.php?page=1'"><b>Refresh</b></a></td>
			  </tr>
			 </table>
			</td>
		   </tr>	  
			   <tr>
			     <td align="" id="QueryStatusTD" style="display:;width:800px; margin-left:0px;" valign="top">
				    <table border="1">
...
$sql_statement = mysql_query("select * from hrm_employee_queryemp where RepMgrId=".$EmployeeId." AND QueryStatus_Emp!=4 order by QueryDT DESC", $con);
$total_records = mysql_num_rows($sql_statement);
if(isset($_GET['page'])) $page = $_GET['page']; else $page = 1;  
$offset = 10;
if ($page){ $from = ($page * $offset) - $offset; }else{ $from = 0;}

$sql_statement = mysql_query("select * from hrm_employee_queryemp where RepMgrId=".$EmployeeId." AND QueryStatus_Emp!=4 order by QueryDT DESC LIMIT " . $from . "," . $offset, $con);
...
<?php $sqlD=mysql_query("select DepartmentCode from hrm_department where DepartmentId=".$resE['DepartmentId'], $con); $resD=mysql_fetch_assoc($sqlD);?>		   
		   ...
		   <a href="javascript:ReadQuery(<?php echo $resQuery['QueryId'].', '.$resQuery['EmployeeID']; ?>)">Read</a></td>
 		   <td style="font-family:Times New Roman; font-size:12px; width:80px;" align="center" valign="top"><?php if($resQuery['QStatus']==0){echo 'Draft';} elseif($resQuery['QStatus']==1){echo '<font color="#F47A00">In-Process</font';} elseif($resQuery['QStatus']==2){echo '<font color="#007700">Reply</font';}?></td>
		   </tr>	
<?php $Sno++; } } else { ?>
                     <tr>
...
<?PHP doPages($offset, 'AppMyTeamPostQuery.php', '', $total_records); ?>
</td>
</tr>					   
			 </table>
		   </td>
