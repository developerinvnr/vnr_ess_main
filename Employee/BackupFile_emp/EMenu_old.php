...
$Dept=mysql_query("select DepartmentId,Req_DrivLic from hrm_employee_general where EmployeeId=".$EmployeeId, $con); $resDept=mysql_fetch_assoc($Dept); $DepartmentId=$resDept['DepartmentId'];
...
$SD=mysql_query("select DateJoining from hrm_employee_general where EmployeeID=".$EmployeeId,$con); 
...
<?php if($resCer['ProfileCertify']=='Y' OR $EmployeeId==223 OR $EmployeeId==461 OR $EmployeeId==224 OR $EmployeeId==233 OR $EmployeeId==234 OR $EmployeeId==235 OR $EmployeeId==259 OR $EmployeeId==260 OR $CompanyId==2 OR $CompanyId==3 OR $CompanyId==4) {  //********* Check Certify 11 OPEN *********/ ?>
<?php if(($resps2['Open']=='Y' AND $respse['ProfileCertify']=='Y') OR $resps2['Open']=='N' OR $EmployeeId==223 OR $EmployeeId==461 OR $EmployeeId==224 OR $EmployeeId==233 OR $EmployeeId==234 OR $EmployeeId==235 OR $EmployeeId==259 OR $EmployeeId==260 OR $CompanyId==2 OR $CompanyId==3 OR $CompanyId==4) {  //********* Check Profile Certify-BB 11 OPEN *********/ ?>

<?php //if(($resContt['Emg_Contact1']!='' AND $resContt['Emg_Contact1']!=0) OR ($EmployeeId==6 OR $EmployeeId==7 OR $EmployeeId==51 OR $EmployeeId==223 OR $EmployeeId==461 OR $EmployeeId==224 OR $EmployeeId==233 OR $EmployeeId==234 OR $EmployeeId==235 OR $EmployeeId==259 OR $EmployeeId==260 OR $CompanyId==2 OR $CompanyId==3)){ //********* Check Update Emegency Contact Open 11 **********// ?>	

<?php if($RD['DateJoining']<'2020-01-01' OR ($RD['DateJoining']>='2020-01-01' AND date("Y-m-d")<=$After31DayDoJ) OR ($RD['DateJoining']>='2020-01-01' AND date("Y-m-d")>$After31DayDoJ AND $rowkk2>0) OR $DepartmentId==4 OR $DepartmentId==6){ ?>
...
<?php } ?> 
 ...
 <?php if($resReti['RetiStatus']=='N' AND $DepartmentId!=28){	/* Start */?>
 <li class="top"><a href="#nogo22" class="top_link"><span class="down">Salary</span></a>
   <ul class="sub">
       
<?php if($RD['DateJoining']<'2020-01-01' OR ($RD['DateJoining']>='2020-01-01' AND date("Y-m-d")<=$After31DayDoJ) OR ($RD['DateJoining']>='2020-01-01' AND date("Y-m-d")>$After31DayDoJ AND $rowkk2>0) OR $DepartmentId==4 OR $DepartmentId==6){ //Open ?>       
...
<?php if($resCer['ProfileCertify']=='Y' OR $EmployeeId==223 OR $EmployeeId==461 OR $EmployeeId==224 OR $EmployeeId==233 OR $EmployeeId==234 OR $EmployeeId==235 OR $EmployeeId==259 OR $EmployeeId==260) {  /********* Check Certify 22 OPEN *********/ ?>
<?php if(($resps2['Open']=='Y' AND $respse['ProfileCertify']=='Y') OR $rowResig==1 OR $resps2['Open']=='N' OR $EmployeeId==223 OR $EmployeeId==461 OR $EmployeeId==224 OR $EmployeeId==233 OR $EmployeeId==234 OR $EmployeeId==235 OR $EmployeeId==259 OR $EmployeeId==260) {   //********* Check Profile Certify-BB 22 OPEN *********/ ?>
<?php //if(($resContt['Emg_Contact1']!='' AND $resContt['Emg_Contact1']!=0) OR ($EmployeeId==6 OR $EmployeeId==7 OR $EmployeeId==51 OR $EmployeeId==223 OR $EmployeeId==461 OR $EmployeeId==224 OR $EmployeeId==233 OR $EmployeeId==234 OR $EmployeeId==235 OR $EmployeeId==259 OR $EmployeeId==260)){ //********* Check Update Emegency Contact Open 22 **********// ?>	
...
<?php if($resCer['ProfileCertify']=='Y' OR $EmployeeId==223 OR $EmployeeId==461 OR $EmployeeId==224 OR $EmployeeId==233 OR $EmployeeId==234 OR $EmployeeId==235 OR $EmployeeId==259 OR $EmployeeId==260) {  //********* Check Certify 22 OPEN *********/ ?>
<?php if(($resps2['Open']=='Y' AND $respse['ProfileCertify']=='Y') OR $resps2['Open']=='N' OR $EmployeeId==223 OR $EmployeeId==461 OR $EmployeeId==224 OR $EmployeeId==233 OR $EmployeeId==234 OR $EmployeeId==235 OR $EmployeeId==259 OR $EmployeeId==260) {  //********* Check Profile Certify-BB 22 OPEN *********/ ?>
<?php //if(($resContt['Emg_Contact1']!='' AND $resContt['Emg_Contact1']!=0) OR ($EmployeeId==6 OR $EmployeeId==7 OR $EmployeeId==51 OR $EmployeeId==223 OR $EmployeeId==461 OR $EmployeeId==224 OR $EmployeeId==233 OR $EmployeeId==234 OR $EmployeeId==235 OR $EmployeeId==259 OR $EmployeeId==260)){ //********* Check Update Emegency Contact Open 22 **********// ?>


<?php //if($RD['DateJoining']<'2020-01-01' OR ($RD['DateJoining']>='2020-01-01' AND date("Y-m-d")<=$After31DayDoJ) OR ($RD['DateJoining']>='2020-01-01' AND date("Y-m-d")>$After31DayDoJ AND $rowkk2>0)){ ?>
