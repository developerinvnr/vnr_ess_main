...
$sql=mysql_query("select * from hrm_employee_investment_submissiona where EmployeeID=".$_POST['EmpID']." AND Period='".$_POST['Period']."' AND Month=".$_POST['YMonth'], $con);
  $row=mysql_num_rows($sql);
  if($row>0){ $sqlUp=mysql_query("update hrm_employee_investment_submissiona set FormSubmit='YY', HRA='".$_POST['HRA2']."', Curr_Medical='".$_POST['MaxMedical']."', Curr_LTA='".$_POST['MaxLTA']."', Curr_CEA='".$_POST['MaxCEA']."', Medical='".$_POST['Medical2']."', LTA='".$_POST['LTA2']."', CEA='".$_POST['CEA2']."', MIP='".$_POST['MIP2']."', MTI='".$_POST['MTI2']."', MTS='".$_POST['MTS2']."', ROL='".$_POST['ROL2']."', Handi='".$_POST['Handi2']."', 80G_Per='".$_POST['80GPer2']."', DTC='".$_POST['DTC2']."', RP='".$_POST['RP2']."', DFS='".$_POST['DFS2']."', PenFun='".$_POST['PenFun2']."', LIP='".$_POST['LIP2']."', DA='".$_POST['DA2']."', PPF='".$_POST['PPF2']."', PostOff='".$_POST['PostOff2']."', ULIP='".$_POST['ULIP2']."', HL='".$_POST['HL2']."', MF='".$_POST['MF2']."', IB='".$_POST['IB2']."', CTF='".$_POST['CTF2']."', NHB='".$_POST['NHB2']."', NSC='".$_POST['NSC2']."', SukS='".$_POST['SukS2']."', NPS='".$_POST['NPS2']."', CorNPS='".$_POST['CorNPS2']."', EPF='".$_POST['EPF2']."', Form16='".$_POST['Form162']."', SPE='".$_POST['SPE2']."', PT='".$_POST['PT2']."', PFD='".$_POST['PFD2']."', IT='".$_POST['IT2']."', IHL='".$_POST['IHL2']."', IL='".$_POST['IL2']."', Inv_Date='".date("Y-m-d",strtotime($_POST['Inv_Date']))."', SubmittedDate='".date("Y-m-d")."', Place='".$_POST['Place']."' where EmployeeID=".$_POST['EmpID']." AND Period='".$_POST['Period']."' AND Month=".$_POST['YMonth'], $con);}
  if($row==0){ $sqlUp=mysql_query("insert into hrm_employee_investment_submissiona(EmployeeID, EC, Period, Month, FormSubmit, HRA, Curr_Medical, Curr_LTA, Curr_CEA, Medical, LTA, CEA, MIP, MTI, MTS, ROL, Handi, 80G_Per, DTC, RP, DFS, PenFun, LIP, DA, PPF, PostOff, ULIP, HL, MF, IB, CTF, NHB, NSC, SukS, NPS, CorNPS, EPF, Form16, SPE, PT, PFD, IT, IHL, IL, Inv_Date, SubmittedDate, Place, YearId) values(".$_POST['EmpID'].", '".$resE['EmpCode']."', '".$_POST['Period']."', ".$_POST['YMonth'].", 'YY', '".$_POST['HRA2']."', '".$_POST['MaxMedical']."', '".$_POST['MaxLTA']."', '".$_POST['MaxCEA']."', '".$_POST['Medical2']."', '".$_POST['LTA2']."', '".$_POST['CEA2']."', '".$_POST['MIP2']."', '".$_POST['MTI2']."', '".$_POST['MTS2']."', '".$_POST['ROL2']."', '".$_POST['Handi2']."', '".$_POST['80GPer2']."', '".$_POST['DTC2']."', '".$_POST['RP2']."', '".$_POST['DFS2']."', '".$_POST['PenFun2']."', '".$_POST['LIP2']."', '".$_POST['DA2']."', '".$_POST['PPF2']."', '".$_POST['PostOff2']."', '".$_POST['ULIP2']."', '".$_POST['HL2']."', '".$_POST['MF2']."', '".$_POST['IB2']."', '".$_POST['CTF2']."', '".$_POST['NHB2']."', '".$_POST['NSC2']."', '".$_POST['SukS2']."', '".$_POST['NPS2']."', '".$_POST['CorNPS2']."', '".$_POST['EPF2']."', '".$_POST['Form162']."', '".$_POST['SPE2']."', '".$_POST['PT2']."', '".$_POST['PFD2']."', '".$_POST['IT2']."', '".$_POST['IHL2']."', '".$_POST['IL2']."', '".date("Y-m-d",strtotime($_POST['Inv_Date']))."', '".date("Y-m-d")."', '".$_POST['Place']."', ".$YearId.")", $con);}
 
  if($sqlUp)
  { 
   echo '<script>alert("Investment Submission Form Submitted Successfully.");</script>';
  }
  
}
elseif(isset($_POST['BlankDeclEmpSubmit']))
{

$sql=mysql_query("select * from hrm_employee_investment_submissiona where EmployeeID=".$_POST['EmpID']." AND Period='".$_POST['Period']."'", $con);
  $row=mysql_num_rows($sql);
  if($row>0){ $sqlUp=mysql_query("update hrm_employee_investment_submissiona set FormSubmit='YY', HRA='".$_POST['HRA2']."', Curr_Medical='".$_POST['MaxMedical']."', Curr_LTA='".$_POST['MaxLTA']."', Curr_CEA='".$_POST['MaxCEA']."', Medical='".$_POST['Medical2']."', LTA='".$_POST['LTA2']."', CEA='".$_POST['CEA2']."', MIP='".$_POST['MIP2']."', MTI='".$_POST['MTI2']."', MTS='".$_POST['MTS2']."', ROL='".$_POST['ROL2']."', Handi='".$_POST['Handi2']."', 80G_Per='".$_POST['80GPer2']."', DTC='".$_POST['DTC2']."', RP='".$_POST['RP2']."', DFS='".$_POST['DFS2']."', PenFun='".$_POST['PenFun2']."', LIP='".$_POST['LIP2']."', DA='".$_POST['DA2']."', PPF='".$_POST['PPF2']."', PostOff='".$_POST['PostOff2']."', ULIP='".$_POST['ULIP2']."', HL='".$_POST['HL2']."', MF='".$_POST['MF2']."', IB='".$_POST['IB2']."', CTF='".$_POST['CTF2']."', NHB='".$_POST['NHB2']."', NSC='".$_POST['NSC2']."', SukS='".$_POST['SukS2']."', NPS='".$_POST['NPS2']."', CorNPS='".$_POST['CorNPS2']."',  EPF='".$_POST['EPF2']."', Form16='".$_POST['Form162']."', SPE='".$_POST['SPE2']."', PT='".$_POST['PT2']."', PFD='".$_POST['PFD2']."', IT='".$_POST['IT2']."', IHL='".$_POST['IHL2']."', IL='".$_POST['IL2']."', Inv_Date='".date("Y-m-d",strtotime($_POST['Inv_Date']))."', SubmittedDate='".date("Y-m-d")."', Place='".$_POST['Place']."' where EmployeeID=".$_POST['EmpID']." AND Period='".$_POST['Period']."'", $con);}
...
var NSC=parseFloat(document.getElementById("NSC").value); var SukS=parseFloat(document.getElementById("SukS").value); var EPF=parseFloat(document.getElementById("EPF").value);
...
var IL=parseFloat(document.getElementById("IL").value); var NPS=parseFloat(document.getElementById("NPS").value);
var CorNPS=parseFloat(document.getElementById("CorNPS").value);
...
var NSC2=parseFloat(document.getElementById("NSC2").value);var SukS2=parseFloat(document.getElementById("SukS2").value);var EPF2=parseFloat(document.getElementById("EPF2").value);
var Form162=parseFloat(document.getElementById("Form162").value); var SPE2=parseFloat(document.getElementById("SPE2").value); var PT2=parseFloat(document.getElementById("PT2").value); var NPS2=parseFloat(document.getElementById("NPS2").value);
var CorNPS2=parseFloat(document.getElementById("CorNPS2").value);
...
if(PenFun>=0){if(PenFun2==0){document.getElementById("PenFun2").value=PenFun;}document.getElementById("PenFun2").readOnly=false; 
                                                                         document.getElementById("PenFun2").style.backgroundColor='#F0F8FF';} 
...
if(CorNPS>=0){if(CorNPS2==0){document.getElementById("CorNPS2").value=NPS;}document.getElementById("CorNPS2").readOnly=false;document.getElementById("CorNPS2").style.backgroundColor='#F0F8FF';}					   																		 
...
if(IL>=0){if(IL2==0){document.getElementById("IL2").value=IL;}document.getElementById("IL2").readOnly=false; document.getElementById("IL2").style.backgroundColor='#F0F8FF';}
  ...
  var LTA=parseFloat(document.getElementById("LTA").value); var LTA2=parseFloat(document.getElementById("LTA2").value);
  if(LTA>=0){if(LTA2==0){ document.getElementById("LTA2").value=LTA;}document.getElementById("LTA2").readOnly=false;  document.getElementById("LTA2").style.backgroundColor='#F0F8FF';} 
  
  var CEA=parseFloat(document.getElementById("CEA").value); var CEA2=parseFloat(document.getElementById("CEA2").value);
  if(CEA>=0){if(CEA2==0){document.getElementById("CEA2").value=CEA;}document.getElementById("CEA2").readOnly=false; document.getElementById("CEA2").style.backgroundColor='#F0F8FF';} 
...
if(Medical>=0){if(Medical2==0){document.getElementById("Medical2").value=Medical;}document.getElementById("Medical2").readOnly=false; document.getElementById("Medical2").style.backgroundColor='#E0DBE3';} 
...
function PrintInvestSuba(P,EI,M){ window.print(); }

</script>
</head>
<body class="body">
<input type="hidden" id="YearId" value="<?php echo $YearId; ?>" /><input type="hidden" id="ComId" value="<?php echo $_REQUEST['CI']; ?>" />
<table class="table">
<tr>
 <td>
...
<?php //*************************************************************************** ?>	
<?php $sqlInvSb=mysql_query("select OpenYN from hrm_investdecl_setting_submission where CompanyId=".$_REQUEST['CI'], $con); $resInvSb=mysql_fetch_assoc($sqlInvSb);
...
$sqlEdit=mysql_query("select * from hrm_employee_investment_submission where IvstDecIdSb=".$_REQUEST['ID']." AND EmployeeID=".$_REQUEST['EI'], $con); $rowEdit=mysql_num_rows($sqlEdit); $resIvst2=mysql_fetch_assoc($sqlEdit);

if($rowEdit>0)
{
 $Check=mysql_query("select * from hrm_employee_investment_declaration where EmployeeID=".$_REQUEST['EI']." AND Period='". $resIvst2['Period']."' AND Month=".$resIvst2['Month'], $con); $resIvst=mysql_fetch_assoc($Check);
 $sqlEdit2=mysql_query("select * from hrm_employee_investment_submissiona where EmployeeID=".$_REQUEST['EI']." AND Period='". $resIvst2['Period']."' AND Month=".$resIvst2['Month'], $con); $rowEdit2=mysql_num_rows($sqlEdit2); $resIvst3=mysql_fetch_assoc($sqlEdit2);
 $sql=mysql_query("select * from hrm_investdecl_setting_limit where CompanyId=".$_REQUEST['CI']." AND Period='".$resIvst2['Period']."' AND Month=".$resIvst2['Month'], $con); $res=mysql_fetch_array($sql);
 $rPeriod=$resIvst2['Period']; 
 $rMonth=$resIvst2['Month']; 
 $btnSubName='SubmitInvstDec';
}
else
{ 
 $rPeriod=$_REQUEST['PI']; 
 $rMonth=date("m"); 
 $btnSubName='BlankDeclEmpSubmit';
 
 $sqlEdit2=mysql_query("select * from hrm_employee_investment_submissiona where EmployeeID=".$_REQUEST['EI']." AND Period='". $_REQUEST['PI']."'", $con); $rowEdit2=mysql_num_rows($sqlEdit2); $resIvst3=mysql_fetch_assoc($sqlEdit2);
 ...
 <table border="0" id="Activity">
   <tr>			 
    ...
    <table border="0" width="900">
	 ...
	 <table border="0">			 
			 <tr>
			 <td align="right" style="width:200px;"><?php if($rowEdit2>0){ ?>
			 <font style="color:#FF0DFF;font-size:14px;font-family:Times New Roman;"></font><a href="#" onClick="PrintInvestSuba('<?php echo $resIvst2['Period']; ?>', <?php echo $_REQUEST['EI'].', '.$resIvst2['Month']; ?>)" style="font-size:14px;font-family:Times New Roman;"><b>Print</b></a><?php } ?>
			 </td>
			 </tr>		 
			 <tr>
			 <td align="center" style="width:900px;">
			  <font color="#106809" style='font-family:Times New Roman;' size="4"><b>Investment Submission Form <?php echo $resIvst2['Period']; ?></b></font></td>
			 </tr>
			 </table></td>
			</tr>
			<tr>
...
<tr>
  <td align="center" style="width:900px;font-size:15px; height:18px;" colspan="6"><b>(To be used to declare investment for income Tax that will be made during the period <?php echo $PrdCurr; ?>)</b></td>
</tr>
...
<td align="center" valign="top" colspan="3" style="width:100px;font-size:15px;">&nbsp;<?php echo $EC; ?></td>
</tr>
<input type="hidden" id="Period" name="Period" value="<?php echo $rPeriod; ?>"  readonly/>
<input type="hidden" id="YMonth" name="YMonth" value="<?php echo $rMonth; ?>" readonly/>
<tr>
...
<td align="left" valign="top" style="width:200px;font-size:15px;" colspan="4">&nbsp;</td>
</tr>
<tr>
...
<td align="center" valign="top" style="width:200px;font-size:15px;" colspan="4">&nbsp;</td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;color:#FFFFFF;"><b>Admin_Amt</b></td>
</tr>
<tr bgcolor="#CEFFCE">
<td align="left" colspan="6" valign="top" style="width:850px;font-size:15px;">&nbsp;<b>Deduction Under Section 10</b></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['HRA']==''){echo 0;}else { echo $resIvst2['HRA']; }?>
<input type="hidden" id="HRA" name="HRA" value="<?php if($resIvst2['HRA']==''){echo 0;}else { echo $resIvst2['HRA']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="HRA2" name="HRA2" class="textBox" value="<?php if($resIvst3['HRA']==''){echo 0;}else { echo $resIvst3['HRA']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['LTA']==''){echo 0;}else {echo $resIvst2['LTA']; } ?>
<input type="hidden" id="LTA" name="LTA" class="textBox" value="<?php if($resIvst2['LTA']==''){echo 0;}else {echo $resIvst2['LTA']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="LTA2" name="LTA2" class="textBox" value="<?php if($resIvst3['LTA']==''){echo 0;}else {echo $resIvst3['LTA']; } ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['CEA']==''){echo 0;}else {echo $resIvst2['CEA']; } ?>
<input type="hidden" id="MaxCEA" name="MaxCEA" value="2400" readonly=""/>
<input type="hidden" id="CEA" name="CEA" class="textBox" value="<?php if($resIvst2['CEA']==''){echo 0;}else {echo $resIvst2['CEA']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="CEA2" name="CEA2" class="textBox" value="<?php if($resIvst3['CEA']==''){echo 0;}else {echo $resIvst3['CEA']; } ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['Medical']==''){echo 0;}else { echo $resIvst2['Medical']; }?>
<input type="hidden" id="Medical" name="Medical" class="textBox" value="<?php if($resIvst2['Medical']==''){echo 0;}else { echo $resIvst2['Medical']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="Medical2" name="Medical2" class="textBox" value="<?php if($resIvst3['Medical']==''){echo 0;}else { echo $resIvst3['Medical']; }?>" readonly maxlength="8"/></td>
</tr>
<?php } else { echo '<input type="hidden" id="Medical" name="Medical" value="0"/><input type="hidden" id="Medical2" name="Medical2" value="0"/>'; } ?>
<tr bgcolor="#CEFFCE">
<td align="left" colspan="6" valign="top" style="width:850px;font-size:15px;">&nbsp;<b>** If you have opted for the medical reimbursements ( being Medical expenses part of your CTC)</b></td>
</tr>
<tr style="background-color:#0080FF;">
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['MIP']==''){echo 0;}else { echo $resIvst2['MIP']; } ?>
<input type="hidden" id="MIP" name="MIP" class="textBox" value="<?php if($resIvst2['MIP']==''){echo 0;}else { echo $resIvst2['MIP']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="MIP2" name="MIP2" class="textBox" value="<?php if($resIvst3['MIP']==''){echo 0;}else { echo $resIvst3['MIP']; } ?>" readonly maxlength="8"/></td>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['MTI']==''){echo 0;}else { echo $resIvst2['MTI']; } ?>
<input type="hidden" id="MTI" name="MTI" class="textBox" value="<?php if($resIvst2['MTI']==''){echo 0;}else { echo $resIvst2['MTI']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="MTI2" name="MTI2" class="textBox" value="<?php if($resIvst3['MTI']==''){echo 0;}else { echo $resIvst3['MTI']; } ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['MTS']==''){echo 0;}else { echo $resIvst2['MTS']; } ?>
<input type="hidden" id="MTS" name="MTS" class="textBox" value="<?php if($resIvst2['MTS']==''){echo 0;}else { echo $resIvst2['MTS']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="MTS2" name="MTS2" class="textBox" value="<?php if($resIvst3['MTS']==''){echo 0;}else { echo $resIvst3['MTS']; } ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['ROL']==''){echo 0;}else { echo $resIvst2['ROL']; } ?>
<input type="hidden" id="ROL" name="ROL" class="textBox" value="<?php if($resIvst2['ROL']==''){echo 0;}else { echo $resIvst2['ROL']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="ROL2" name="ROL2" class="textBox" value="<?php if($resIvst3['ROL']==''){echo 0;}else { echo $resIvst3['ROL']; } ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['Handi']==''){echo 0;}else { echo $resIvst2['Handi']; }?>
<input type="hidden" id="Handi" name="Handi" class="textBox" value="<?php if($resIvst2['Handi']==''){echo 0;}else { echo $resIvst2['Handi']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="Handi2" name="Handi2" class="textBox" value="<?php if($resIvst3['Handi']==''){echo 0;}else { echo $resIvst3['Handi']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['DTC']==''){echo 0;}else { echo $resIvst2['DTC']; }?>
<input type="hidden" id="DTC" name="DTC" class="textBox" value="<?php if($resIvst2['DTC']==''){echo 0;}else { echo $resIvst2['DTC']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="DTC2" name="DTC2" class="textBox" value="<?php if($resIvst3['DTC']==''){echo 0;}else { echo $resIvst3['DTC']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['DFS']==''){echo 0;}else { echo $resIvst2['DFS']; }?>
<input type="hidden" id="DFS" name="DFS" class="textBox" value="<?php if($resIvst2['DFS']==''){echo 0;}else { echo $resIvst2['DFS']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="DFS2" name="DFS2" class="textBox" value="<?php if($resIvst3['DFS']==''){echo 0;}else { echo $resIvst3['DFS']; }?>" readonly maxlength="8"/></td>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['PenFun']==''){echo 0;}else { echo $resIvst2['PenFun']; } ?>
<input type="hidden" id="PenFun" name="PenFun" class="textBox" value="<?php if($resIvst2['PenFun']==''){echo 0;}else { echo $resIvst2['PenFun']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="PenFun2" name="PenFun2" class="textBox" value="<?php if($resIvst3['PenFun']==''){echo 0;}else { echo $resIvst3['PenFun']; } ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['LIP']==''){echo 0;}else {echo $resIvst2['LIP']; } ?>
<input type="hidden" id="LIP" name="LIP" class="textBox" value="<?php if($resIvst2['LIP']==''){echo 0;}else {echo $resIvst2['LIP']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="LIP2" name="LIP2" class="textBox" value="<?php if($resIvst3['LIP']==''){echo 0;}else {echo $resIvst3['LIP']; } ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['DA']==''){echo 0;}else {echo $resIvst2['DA'];} ?>
<input type="hidden" id="DA" name="DA" class="textBox" value="<?php if($resIvst2['DA']==''){echo 0;}else {echo $resIvst2['DA'];} ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="DA2" name="DA2" class="textBox" value="<?php if($resIvst3['DA']==''){echo 0;}else {echo $resIvst3['DA'];} ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['PPF']==''){echo 0;}else { echo $resIvst2['PPF']; } ?>
<input type="hidden" id="PPF" name="PPF" class="textBox" value="<?php if($resIvst2['PPF']==''){echo 0;}else { echo $resIvst2['PPF']; } ?>"  readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="PPF2" name="PPF2" class="textBox" value="<?php if($resIvst3['PPF']==''){echo 0;}else { echo $resIvst3['PPF']; } ?>"  readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['PostOff']==''){echo 0;}else { echo $resIvst2['PostOff']; } ?>
<input type="hidden" id="PostOff" name="PostOff" class="textBox" value="<?php if($resIvst2['PostOff']==''){echo 0;}else { echo $resIvst2['PostOff']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="PostOff2" name="PostOff2" class="textBox" value="<?php if($resIvst3['PostOff']==''){echo 0;}else { echo $resIvst3['PostOff']; } ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['ULIP']==''){echo 0;}else {echo $resIvst2['ULIP']; }?>
<input type="hidden" id="ULIP" name="ULIP" class="textBox" value="<?php if($resIvst2['ULIP']==''){echo 0;}else {echo $resIvst2['ULIP']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="ULIP2" name="ULIP2" class="textBox" value="<?php if($resIvst3['ULIP']==''){echo 0;}else {echo $resIvst3['ULIP']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['HL']==''){echo 0;}else { echo $resIvst2['HL']; }?>
<input type="hidden" id="HL" name="HL" class="textBox" value="<?php if($resIvst2['HL']==''){echo 0;}else { echo $resIvst2['HL']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="HL2" name="HL2" class="textBox" value="<?php if($resIvst3['HL']==''){echo 0;}else { echo $resIvst3['HL']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['MF']==''){echo 0;}else {echo $resIvst2['MF']; } ?>
<input type="hidden" id="MF" name="MF" class="textBox" value="<?php if($resIvst2['MF']==''){echo 0;}else {echo $resIvst2['MF']; } ?>"  readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="MF2" name="MF2" class="textBox" value="<?php if($resIvst3['MF']==''){echo 0;}else {echo $resIvst3['MF']; } ?>"  readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['IB']==''){echo 0;}else { echo $resIvst2['IB']; } ?>
<input type="hidden" id="IB" name="IB" class="textBox" value="<?php if($resIvst2['IB']==''){echo 0;}else { echo $resIvst2['IB']; } ?>"  readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="IB2" name="IB2" class="textBox" value="<?php if($resIvst3['IB']==''){echo 0;}else { echo $resIvst3['IB']; } ?>"  readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['CTF']==''){echo 0;}else { echo $resIvst2['CTF']; } ?>
<input type="hidden" id="CTF" name="CTF" class="textBox" value="<?php if($resIvst2['CTF']==''){echo 0;}else { echo $resIvst2['CTF']; } ?>"  readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="CTF2" name="CTF2" class="textBox" value="<?php if($resIvst3['CTF']==''){echo 0;}else { echo $resIvst3['CTF']; } ?>"  readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['NHB']==''){echo 0;}else { echo $resIvst2['NHB']; }?>
<input type="hidden" id="NHB" name="NHB" class="textBox" value="<?php if($resIvst2['NHB']==''){echo 0;}else { echo $resIvst2['NHB']; }?>"  readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="NHB2" name="NHB2" class="textBox" value="<?php if($resIvst3['NHB']==''){echo 0;}else { echo $resIvst3['NHB']; }?>"  readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['NSC']==''){echo 0;}else { echo $resIvst2['NSC']; }?>
<input type="hidden" id="NSC" name="NSC" class="textBox"  value="<?php if($resIvst2['NSC']==''){echo 0;}else { echo $resIvst2['NSC']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="NSC2" name="NSC2" class="textBox"  value="<?php if($resIvst3['NSC']==''){echo 0;}else { echo $resIvst3['NSC']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['SukS']==''){echo 0;}else { echo $resIvst2['SukS']; }?>
<input type="hidden" id="SukS" name="SukS" class="textBox"  value="<?php if($resIvst2['SukS']==''){echo 0;}else { echo $resIvst2['SukS']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="SukS2" name="SukS2" class="textBox"  value="<?php if($resIvst3['SukS']==''){echo 0;}else { echo $resIvst3['SukS']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['EPF']==''){echo 0;}else {echo $resIvst2['EPF']; }?>
<input type="hidden" id="EPF" name="EPF" class="textBox" value="<?php if($resIvst2['EPF']==''){echo 0;}else {echo $resIvst2['EPF']; }?>"  readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="EPF2" name="EPF2" class="textBox" value="<?php if($resIvst3['EPF']==''){echo 0;}else {echo $resIvst3['EPF']; }?>"  readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['NPS']==''){echo 0;}else { echo $resIvst2['NPS']; }?>
<input type="hidden" id="NPS" name="NPS" class="textBox" value="<?php if($resIvst2['NPS']==''){echo 0;}else { echo $resIvst2['NPS']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="NPS2" name="NPS2" class="textBox" value="<?php if($resIvst3['NPS']==''){echo 0;}else { echo $resIvst3['NPS']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['CorNPS']==''){echo 0;}else { echo $resIvst2['CorNPS']; }?>
<input type="hidden" id="CorNPS" name="CorNPS" class="textBox" value="<?php if($resIvst2['CorNPS']==''){echo 0;}else { echo $resIvst2['CorNPS']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="CorNPS2" name="CorNPS2" class="textBox" value="<?php if($resIvst3['CorNPS']==''){echo 0;}else { echo $resIvst3['CorNPS']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['Form16']==''){echo 0;}else { echo $resIvst2['Form16']; }?>
<input type="hidden" id="Form16" name="Form16" class="textBox" value="<?php if($resIvst2['Form16']==''){echo 0;}else { echo $resIvst2['Form16']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="Form162" name="Form162" class="textBox" value="<?php if($resIvst3['Form16']==''){echo 0;}else { echo $resIvst3['Form16']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['SPE']==''){echo 0;}else { echo $resIvst2['SPE']; } ?>
<input type="hidden" id="SPE" name="SPE" class="textBox" value="<?php if($resIvst2['SPE']==''){echo 0;}else { echo $resIvst2['SPE']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="SPE2" name="SPE2" class="textBox" value="<?php if($resIvst3['SPE']==''){echo 0;}else { echo $resIvst3['SPE']; } ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['PT']==''){echo 0;}else {echo $resIvst2['PT']; }?>
<input type="hidden" id="PT" name="PT" class="textBox" value="<?php if($resIvst2['PT']==''){echo 0;}else {echo $resIvst2['PT']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="PT2" name="PT2" class="textBox" value="<?php if($resIvst3['PT']==''){echo 0;}else {echo $resIvst3['PT']; }?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['PFD']==''){echo 0;}else { echo $resIvst2['PFD']; } ?>
<input type="hidden" id="PFD" name="PFD" class="textBox" value="<?php if($resIvst2['PFD']==''){echo 0;}else { echo $resIvst2['PFD']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="PFD2" name="PFD2" class="textBox" value="<?php if($resIvst3['PFD']==''){echo 0;}else { echo $resIvst3['PFD']; } ?>" readonly maxlength="8"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['IT']==''){echo 0;}else { echo $resIvst2['IT']; }?>
<input type="hidden" id="IT" name="IT" class="textBox" value="<?php if($resIvst2['IT']==''){echo 0;}else { echo $resIvst2['IT']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="IT2" name="IT2" class="textBox" value="<?php if($resIvst3['IT']==''){echo 0;}else { echo $resIvst3['IT']; }?>" readonly maxlength="8"/></td>
</tr>
<tr>
<td align="left" valign="top" colspan="6" style="width:550px;font-size:15px;">&nbsp;</td>
</tr>
<tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['IHL']==''){echo 0;}else { echo $resIvst2['IHL']; }?>
<input type="hidden" id="IHL" name="IHL" class="textBox" value="<?php if($resIvst2['IHL']==''){echo 0;}else { echo $resIvst2['IHL']; }?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="IHL2" name="IHL2" class="textBox" value="<?php if($resIvst3['IHL']==''){echo 0;}else { echo $resIvst3['IHL']; }?>" readonly maxlength="10"/></td>
</tr>
...
<td align="center" valign="top" style="width:100px;font-size:15px;"><?php if($resIvst2['IL']==''){echo 0;}else { echo $resIvst2['IL']; } ?>
<input type="hidden" id="IL" name="IL" class="textBox" value="<?php if($resIvst2['IL']==''){echo 0;}else { echo $resIvst2['IL']; } ?>" readonly/></td>
<td align="center" valign="top" style="width:100px;font-size:15px;">
<input id="IL2" name="IL2" class="textBox" value="<?php if($resIvst3['IL']==''){echo 0;}else { echo $resIvst3['IL']; } ?>" readonly maxlength="10"/></td>
</tr>

<?php /**********************Total*******/ ?>
<?php $Tot1=$resIvst['HRA']+$resIvst['Medical']+$resIvst['LTA']+$resIvst['CEA']+$resIvst['MIP']+$resIvst['MTI']+$resIvst['MTS']+$resIvst['ROL']+$resIvst['Handi']+$resIvst['DTC']+$resIvst['RP']+$resIvst['DFS']+$resIvst['PenFun']+$resIvst['LIP']+$resIvst['DA']+$resIvst['PPF']+$resIvst['PostOff']+$resIvst['ULIP']+$resIvst['HL']+$resIvst['MF']+$resIvst['IB']+$resIvst['CTF']+$resIvst['NHB']+$resIvst['NSC']+$resIvst['SukS']+$resIvst['NPS']+$resIvst['EPF']+$resIvst['Form16']+$resIvst['SPE']+$resIvst['PT']+$resIvst['PFD']+$resIvst['IT']+$resIvst['IHL']+$resIvst['IL']; 

$Tot2=$resIvst2['HRA']+$resIvst2['Medical']+$resIvst2['LTA']+$resIvst2['CEA']+$resIvst2['MIP']+$resIvst2['MTI']+$resIvst2['MTS']+$resIvst2['ROL']+$resIvst2['Handi']+$resIvst2['DTC']+$resIvst2['RP']+$resIvst2['DFS']+$resIvst2['PenFun']+$resIvst2['LIP']+$resIvst2['DA']+$resIvst2['PPF']+$resIvst2['PostOff']+$resIvst2['ULIP']+$resIvst2['HL']+$resIvst2['MF']+$resIvst2['IB']+$resIvst2['CTF']+$resIvst2['NHB']+$resIvst2['NSC']+$resIvst2['SukS']+$resIvst2['NPS']+$resIvst2['EPF']+$resIvst2['Form16']+$resIvst2['SPE']+$resIvst2['PT']+$resIvst2['PFD']+$resIvst2['IT']+$resIvst2['IHL']+$resIvst2['IL'];

$Tot3=$resIvst3['HRA']+$resIvst3['Medical']+$resIvst3['LTA']+$resIvst3['CEA']+$resIvst3['MIP']+$resIvst3['MTI']+$resIvst3['MTS']+$resIvst3['ROL']+$resIvst3['Handi']+$resIvst3['DTC']+$resIvst3['RP']+$resIvst3['DFS']+$resIvst3['PenFun']+$resIvst3['LIP']+$resIvst3['DA']+$resIvst3['PPF']+$resIvst3['PostOff']+$resIvst3['ULIP']+$resIvst3['HL']+$resIvst3['MF']+$resIvst3['IB']+$resIvst3['CTF']+$resIvst3['NHB']+$resIvst3['NSC']+$resIvst3['SukS']+$resIvst3['NPS']+$resIvst3['EPF']+$resIvst3['Form16']+$resIvst3['SPE']+$resIvst3['PT']+$resIvst3['PFD']+$resIvst3['IT']+$resIvst3['IHL']+$resIvst3['IL'];

?>
<tr>
<td colspan="3" align="right" valign="top"><b>Total :</b>&nbsp;</td>
<td align="center" valign="top" style="width:100px;font-size:15px;background-color:#A9FF53;"><b><?php echo $Tot1; ?></td>
<td align="center" valign="top" style="width:100px;font-size:15px;background-color:#A9FF53;"><b><?php echo $Tot2; ?></td>
<td align="center" valign="top" style="width:100px;font-size:15px;background-color:#A9FF53;"><b><?php echo $Tot3; ?></td>
</tr>
<?php /**********************Total*******/ ?>

<tr bgcolor="#CEFFCE">
<td align="left" colspan="6" valign="top" style="width:850px;font-size:15px;">&nbsp;<b>Note: Form 12C along with the calculation of loss on house property heeds to be attached for considering the above</b></td>
</tr>
<tr><td align="left" colspan="6" valign="top" style="width:850px;font-size:15px;">&nbsp;<b><u>Declaration:</u></b></td></tr>
<tr><td align="left" colspan="6" valign="top" style="width:850px;font-size:15px;">&nbsp;1) I hereby declare that the information given above is correct and true in all respects.</td></tr>
<tr><td align="left" colspan="6" valign="top" style="width:850px;font-size:15px;">&nbsp;2) I also undertake to indemnify the company for any loss/liability that may arise in the event of the above information being incorrect.</td></tr>
<tr>
...
<tr>
*/ ?>
<td align="center" valign="bottom" rowspan="2" colspan="4" style="width:200px;font-size:15px;">&nbsp;</td>
</tr>

<tr>
<td align="" colspan="1" valign="top" style="width:100px;font-size:15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Date :</b> </td>
<td align="left" valign="top" style="width:550px;font-size:15px;">
<input id="Inv_Date" name="Inv_Date" class="textBox"  value="<?php if($rowEdit==0){ if($resIvst3['Inv_Date']!='' AND $resIvst3['Inv_Date']!='0000-00-00' AND $resIvst3['Inv_Date']!='1970-01-01'){echo date("d-M-Y", strtotime($resIvst3['Inv_Date'])); } }elseif($rowEdit2>0){if($resIvst3['Inv_Date']!='' AND $resIvst3['Inv_Date']!='0000-00-00' AND $resIvst3['Inv_Date']!='1970-01-01'){echo date("d-M-Y", strtotime($resIvst3['Inv_Date'])); } }?>" readonly/>
...
<td align="left" valign="top" style="width:550px;font-size:15px;">
<input id="Place" name="Place" style="width:200px;height:21px;background-color:#D6D6D6;" value="<?php echo $resIvst3['Place']; ?>" readonly maxlength="50" /></td>
<td align="center" valign="middle" colspan="4" valign="top" style="width:200px;font-size:15px;"><b>Admin Signature</b></td>
</tr>
<tr>

<td align="left" valign="top" colspan="6" style="width:550px;font-size:15px;">&nbsp;<input type="hidden" name="EmpID" id="EmpID" value="<?php echo $_REQUEST['EI']; ?>" /></td>
</tr>
   <td align="" class="fontButton" colspan="6"><table border="0" align="right" class="fontButton">
	<tr>
	  ...
	  <td align="right" style="width:90px;"><input type="submit" name="<?php echo $btnSubName;?>" id="SubmitInvstDec" style="width:90px; display:none;" value="save">
<input type="button" name="EditInvstDec" id="EditInvstDec" style="width:90px;" value="edit" onClick="Edit()" <?php //if($resIvst2['FormSubmit']=='YY'){echo 'disabled';}?>>
	  </td>
	  <td align="right" style="width:90px;">
	  <input type="button" name="Refresh" id="Refresh" style="width:90px;" value="Refresh" onClick="javascript:window.location='InvestSubForm.php?act=true&mm=sas&ask=false&&yy=eloi&gosto=false&rigt=checkessue&mailto=promt&wew=e%e@er%rdd=012&ID=<?php echo $_REQUEST['ID']; ?>&EI=<?php echo $_REQUEST['EI']; ?>&CI=<?php echo $_REQUEST['CI']; ?>&PI=<?php echo $_REQUEST['PI']; ?>&YI=<?php echo $_REQUEST['YI']; ?>'" /></td>
	</tr></table>  
	</td>
	</tr>
	</table>
