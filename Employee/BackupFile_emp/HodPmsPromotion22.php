...
<?php } if($res['Hod_EmpDesignation']==0 OR $res['Hod_EmpDesignation']!=0) { ?><option style="background-color:#FFFFFF;" value="<?php echo $res['DesigId']; ?>"><?php echo $res2['DesigCode']; ?></option><?php } ?>
