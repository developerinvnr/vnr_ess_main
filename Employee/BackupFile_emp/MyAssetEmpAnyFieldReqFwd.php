...
<tr height="20">
 ...
 <td colspan="3" align=""><textarea name="Remark" id="Remark" style="font-family:Times New Roman;font-size:15px;" cols="57" rows="2"><?php echo $res['AnyOtherRemark']; ?></textarea></td>
</tr>
<tr height="20">
 <td align="left" valign="top" style="font-family:Times New Roman;color:#004993;font-size:16px;"><b>HOD Remark :</b></td>
 <td colspan="3" align=""><textarea name="Remark" id="Remark" style="font-family:Times New Roman;font-size:15px;" cols="57" rows="2"><?php echo $res['HODRemark']; ?></textarea></td>
</tr>
