...
$From=date("Y",strtotime($ResY['FromDate'])); $To=date("Y",strtotime($ResY['ToDate'])); 
 ...
 $sql=mysql_query("select * from hrm_investdecl_setting where CompanyId=".$CI." AND Status='A'", $con); $res=mysql_fetch_array($sql); 
 $sql2=mysql_query("select * from hrm_investdecl_setting_limit where CompanyId=".$CI." AND Period='".$_REQUEST['P']."' AND Month=".$_REQUEST['M'], $con); 
 ...
 <td align="center">
   <?php //*************************************************************************************************************************************************** ?>	   
	     ...
	     <table border="0" width="850">
               <tr>
			 <td colspan="10" align="right" style="font-size:14px;font-family:Times New Roman;"><a href="#" onClick="PrintForm()">Print</a>&nbsp;</td>
			</tr>	 
		    <tr>
             <td colspan="10" align="center" align="center">&nbsp;
			 <font color="#106809" style='font-family:Times New Roman;' size="4"><b>Investment Declaration Form <?php echo $_REQUEST['P']; ?></b></font>
			 </td>
			</tr>
			<tr>
			 <td>
...
<tr>
  <td align="center" style="width:850px;font-size:15px; height:18px;" colspan="4">&nbsp;<b>(To be used to declare investment for income Tax that will be made during the period <?php echo $_REQUEST['P']; ?>)</b></td>
</tr>
...
<?php if($resIvst['LTA']>0){ //$res['LTA']=='Y' ?>
<tr>
...
<?php } if($resIvst['CEA']>0){ //$res['CEA']=='Y' ?>
<tr>
...
<?php } if($resIvst['Medical']>0){ //$res['Medical']=='Y' ?>
<tr>
