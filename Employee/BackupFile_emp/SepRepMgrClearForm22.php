...
{ 
  ...
  $PrtisROth=''; if($_POST['Oth_Remark']!=''){$PrtisROth=str_replace($search, "", $_POST['Oth_Remark']);}
...
{ 
  ...
  if($sqlIns){$sqlUp=mysql_query("update hrm_employee_separation set Rep_NOC='Y', Acc_RepNOC='N' where EmpSepId=".$_POST['si'], $con); }
  if($sqlUp)
  {
    /************************************************ HR ***********************************************/ 
	...
	if($_POST['EDeptId']==6){ $email_message .="The departmental clearance form of ".$_POST['Ename']." has been submitted by reporting manager and forwarded to logistics department for verification. For details kindly log on to ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>. \n\n"; }
	else{ $email_message .="The departmental clearance form of ".$_POST['Ename']." has been submitted by reporting manager. For details kindly log on to ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>. \n\n"; }
...
if($_POST['EDeptId']==6)
 {
	$sqlNoc5=mysql_query("select Log_EmployeeID from hrm_employee_separation where EmpSepId=".$_POST['si'], $con); $rowNoc5=mysql_num_rows($sqlNoc5); 
    if($rowNoc5>0)
    { $resNoc5=mysql_fetch_assoc($sqlNoc5);
      $sqlE5=mysql_query("select EmailId_Vnr from hrm_employee_general where EmployeeID=".$resNoc5['Log_EmployeeID'], $con); $resE5=mysql_fetch_assoc($sqlE5); 
      if($resE5['EmailId_Vnr']!='')
      {
      $email_to5 = $resE5['EmailId_Vnr'];
      $email_from = 'admin@vnrseeds.co.in';
      $email_subject5 = "Resignation approved to HR";
      $email_txt = "Resignation approved to HR";
      $headers = "From: ".$email_from."\r\n";
      $semi_rand = md5(time()); 
      $headers .= "MIME-Version: 1.0\r\n";
      $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
      $email_message5 .= "The departmental clearance form of <b>".$_POST['Ename']."</b> has been submitted by reporting manager ".$_POST['Rname']." for verification of dues. Kindly verify and approve in ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>. \n\n";
...
/*		  
	 ...
	 $email_from = 'admin@vnrseeds.co.in';
	 $email_subject6 = "Department clearance approved by reporting manager";
	 $email_txt = "Department clearance approved by reporting manager";
	 $headers = "From: ".$email_from."\r\n";
	 $semi_rand = md5(time()); 
	 $headers .= "MIME-Version: 1.0\r\n";
	 $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
	 $email_message6 .= "<b>".$_POST['Ename']."</b> department clearance approved by reporting manager.\n\n";
...
function FunDDH(v)
{ if(v=='Y'){document.getElementById("DDH_Y").checked=true;document.getElementById("DDH_N").checked=false;document.getElementById("DDH_YN").value='Y';
  document.getElementById("DDH_Amt").readOnly=true; document.getElementById("DDH_Amt").style.background='#EAEAEA';
  document.getElementById("DDH_Amt").value=0;}
  else if(v=='N'){document.getElementById("DDH_N").checked=true;document.getElementById("DDH_Y").checked=false;document.getElementById("DDH_YN").value='N'; 
  document.getElementById("DDH_Amt").readOnly=false; document.getElementById("DDH_Amt").style.background='#FFFFFF';}
}

function FunTID(v)
{ if(v=='Y'){document.getElementById("TID_Y").checked=true;document.getElementById("TID_N").checked=false;document.getElementById("TID_YN").value='Y';
  document.getElementById("TID_Amt").readOnly=true; document.getElementById("TID_Amt").style.background='#EAEAEA';
  document.getElementById("TID_Amt").value=0;}
  else if(v=='N'){document.getElementById("TID_N").checked=true;document.getElementById("TID_Y").checked=false;document.getElementById("TID_YN").value='N';
  document.getElementById("TID_Amt").readOnly=false; document.getElementById("TID_Amt").style.background='#FFFFFF';}
}

function FunAPTC(v)
{ if(v=='Y'){document.getElementById("APTC_Y").checked=true;document.getElementById("APTC_N").checked=false;document.getElementById("APTC_YN").value='Y';
  document.getElementById("APTC_Amt").readOnly=true; document.getElementById("APTC_Amt").style.background='#EAEAEA';
  document.getElementById("APTC_Amt").value=0;}
  else if(v=='N'){document.getElementById("APTC_N").checked=true;document.getElementById("APTC_Y").checked=false;document.getElementById("APTC_YN").value='N';
  document.getElementById("APTC_Amt").readOnly=false; document.getElementById("APTC_Amt").style.background='#FFFFFF';}
}

function FunHOAS(v)
{ if(v=='Y'){document.getElementById("HOAS_Y").checked=true;document.getElementById("HOAS_N").checked=false;document.getElementById("HOAS_YN").value='Y';
  document.getElementById("HOAS_Amt").readOnly=true; document.getElementById("HOAS_Amt").style.background='#EAEAEA';
  document.getElementById("HOAS_Amt").value=0;}
  else if(v=='N'){document.getElementById("HOAS_N").checked=true;document.getElementById("HOAS_Y").checked=false;document.getElementById("HOAS_YN").value='N';
  document.getElementById("HOAS_Amt").readOnly=false; document.getElementById("HOAS_Amt").style.background='#FFFFFF';}
}


function FunPrtis(i,v)
{ if(v=='Y'){document.getElementById("Prtis_Y"+i).checked=true;document.getElementById("Prtis_N"+i).checked=false;document.getElementById("Prtis_YN"+i).value='Y';
  document.getElementById("Prtis_Amt"+i).readOnly=true; document.getElementById("Prtis_Amt"+i).style.background='#EAEAEA';
  document.getElementById("Prtis_Amt"+i).value=0;}
  else if(v=='N'){document.getElementById("Prtis_N"+i).checked=true;document.getElementById("Prtis_Y"+i).checked=false;document.getElementById("Prtis_YN"+i).value='N';
...
{ if(v==1){var a=v+1; var m=v}
  ...
  document.getElementById("Prtis"+v).value = ""; document.getElementById("Prtis_Y"+v).checked = false; document.getElementById("Prtis_N"+v).checked = false; 
...
<td style="width:790px;"> 
 <table border="0" cellpadding="0">
  ...
  <tr><td>&nbsp;</td><td class="Text2" style="color:#006200;" align="center"><b>DEPARTMENTAL NOC CLEARANCE FORM(REPORTING MANAGER)</b></td></tr>
  <tr>
   ...
   <td style="width:700px;"><table border="1">
        <tr><td class="Text" style="width:760px;background-color:#FFFFFF;" align="">&nbsp;<b>Parties Clearance</b></td></tr>
	   </table>
   </td>
  </tr>
 <tr>
   ...
   <td>
    <table style="width:760px;" id="Row<?php echo $i; ?>" border="1" cellspacing="0">
	  <tr bgcolor="#7a6189"> 
	   ...
	   <td class="Text" style="width:95px;color:#FFFFFF;" align="center" valign="top"><b>Yes/No</b></td>
   ...
   <td>
    <table style="width:760px;display:none;" id="Row<?php echo $i; ?>" border="1" cellspacing="0">
	  <tr bgcolor="#FFFFFF"> 
	   ...
	   <td class="Text" style="width:120px;" align="center" valign="top">
...
<?php } ?>
    ...
    <table style="width:760px;" border="1" cellspacing="0">
	  <tr bgcolor="#FFFFFF"> 
	   ...
	   <td colspan="3" class="Text" style="width:518px;" align="center" valign="top">
	    <input id="Oth_Remark" name="Oth_Remark" style="width:514px;" value="<?php echo $res['Oth_Remark']; ?>" maxlength="190" />
	   </td> 
     </tr>
	</table>
   </td>
  ...
  <td colspan="5" align="Right" class="fontButton">
   ...
   <?php if($resSE['Rep_NOC']=='N' AND date("Y-m-d")<$resSE['HR_Date']) { ?>
   <?php if($rowNoc>0){ ?><input type="submit" id="submitRepNoc" name="submitRepNoc" value="submit"/><?php } ?>
   <input type="submit" id="saveRepNoc" name="saveRepNoc" value="save"/>
   <input type="button" name="Refrash" value="refresh" onClick="javascript:window.location='SepRepMgrClearForm.php?act=act&v=v&ss=vty&cc=it@~t~1212&p=value&a=app&true=false&si=<?php echo $_REQUEST['si']; ?>&st=<?php echo $_REQUEST['st']; ?>&ei=<?php echo $_REQUEST['ei']; ?>'"/>
   <?php } ?>
  </td>
 </tr> 
 </table>
