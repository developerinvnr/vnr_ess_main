...
{$sqlUpRep=mysql_query("update hrm_employee_query set QueryReply='".$_POST['ReplyQText']."',QueryReplyDateTime='".date("Y-m-d h:i:s")."',QueryStatus_Emp=2,QStatus_HOD=2,ReplyAns_HOD='".$_POST['ReplyQText']."',DateTimeReplyAns_HOD='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); 
 if($sqlUpRep){$RepMsg='Reply send successfully!';}
}
...
{ //if(v=='P') {var agree=confirm("Are you sure you want to reply to pending this query...?"); if (agree) { var x="MyTeamDraftQ.php?action=P&Q="+QI; window.location=x; }}
  var x="MyTeamPendingQ.php?action=R&QR="+QI; window.location=x;
}
...
<?php //*******************************************Status********** ?>       
		   ...
		   <tr>
			 <td>
			  <table border="0">
			   <tr>
		<td style="font-family:Times New Roman; color:#004A00; font-size:16px;width:650px;" align=""><b><u>Pending Query</u></b>
		   &nbsp;&nbsp;&nbsp;<font color="#734A37" style='font-family:Times New Roman;' size="3"><b><?php echo $msg;; ?></b></font></td>
		<td align="center" style="font-family:Times New Roman; color:#004A00;width:82px; font-size:15px;"><a href="javascript:window.location='MyTeamPendingQ.php'"><b>Refresh</b></a></td>
			  </tr>
			 </table>
			</td>
		   </tr>
<?php $sqlQ=mysql_query("select * from hrm_employee_query where QueryTo='HOD' AND Id_HOD=".$EmployeeId." AND QueryStatus_Emp=1 AND QStatus_HOD=1 order by QueryDateTime DESC", $con); 
      $rowQ=mysql_num_rows($sqlQ); ?>	  
		   ...
		   <td style="color:#ffffff; font-family:Georgia; font-size:11px; width:50px;" align="center"><b>Query</b></td>
 		   <td style="color:#ffffff; font-family:Georgia; font-size:11px; width:50px;" align="center"><b>Status</b></td>
		   <td style="color:#ffffff; font-family:Georgia; font-size:11px; width:60px;" align="center"><b>Action</b></td>
		             </tr>	
<?php if($rowQ>0) { $Sn=1; while($resQ=mysql_fetch_array($sqlQ)) { ?>
		   ...
		   <td style="font-family:Georgia; font-size:11px; width:120px; overflow:hidden;" valign="top"><?php echo substr_replace($resQ['QuerySubject'], '', 15).'.....'; ?></td>
...
<?php $sqlD=mysql_query("select DepartmentCode from hrm_department where DepartmentId=".$resE['DepartmentId'], $con); $resD=mysql_fetch_assoc($sqlD);?>		   
		   ...
		   <a href="javascript:ReadQuery(<?php echo $resQ['QueryId']; ?>)">Read</a></td>
 		   <td style="font-family:Times New Roman; font-size:12px; width:50px;" align="center" valign="top">
		   <a href="javascript:ReadPending(<?php echo $resQ['QueryId']; ?>)"><font color="#FF8D1C">Pending</font></a>
		   </td>
		   <td style="color:#ffffff; font-family:Georgia; font-size:11px; width:60px;" align="center" valign="top">
		   <a href="#" onClick="HODAction(<?php echo $resQ['QueryId']; ?>)">Reply</a>
		  </td>
		             </tr>	
<?php $Sn++;} } if($rowQ==0) { ?>
                     <tr>
...
<?php if($_REQUEST['action']=='R' AND $_REQUEST['QR']!='')  { ?>	
<?php $sqlQE=mysql_query("select hrm_employee_query.*,Fname,Sname,Lname from hrm_employee_query INNER JOIN hrm_employee ON hrm_employee.EmployeeID=hrm_employee_query.EmployeeID where hrm_employee_query.QueryId=".$_REQUEST['QR'], $con); $resQE=mysql_fetch_assoc($sqlQE);?>	
		  ...
		  <table border="0">
			...
			<tr><td colspan="2" style="font-family:Times New Roman; color:#004A00; font-size:16px;width:310px;" align="">
			<b>Action : </b><font color="#00509F">Reply</font></td>
			</tr>
			<tr height="20">
				<td colspan="2" align="left" valign="top" width="80" style="font-family:Times New Roman;color:#004993; font-size:16px;">
				<textarea name="ReplyQText" id="ReplyQText" cols="38" rows="8">Please type your answer!</textarea>
				<input type="hidden" name="RepQ_ID" value="<?php echo $_REQUEST['QR']; ?>" /></td>
			</tr>
			<tr height="20">
				<td colspan="2" align="Right" class="fontButton">
		          <table border="0" width="310">
			        <tr>
			         ...
			         <td align="right" style="width:70px;"><input type="button" name="Refresh" id="Refresh" style="width:90px;" value="Refresh" onClick="javascript:window.location='MyTeampendingQ.php?action=R&QR=<?php echo $_REQUEST['QR']; ?>'"/></td>
			       </tr>
		        </table>
		      </td>
	      </tr>
