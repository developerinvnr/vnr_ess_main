...
$_SESSION['up']=$_REQUEST['action']; $_SESSION['C']=$_REQUEST['C']; $_SESSION['E']=$_REQUEST['E']; $_SESSION['Y']=$_REQUEST['Y'];
...
<center> 
<table class="table" border="0" width="590">
...
<td>
 ...
 <?php $sqlCheck=mysql_query("select * from hrm_employee_kra_uploadfile where EmployeeID=".$_SESSION['E']." AND YearId=".$_SESSION['Y'], $con); $no=1;while($resCheck=mysql_fetch_array($sqlCheck)) { 
