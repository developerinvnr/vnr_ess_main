...
$ss02= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_disbuc WHERE Rating=".$RatingHod." AND HodId=".$EmployeeId." AND DeptId=".$res['HR_Curr_DepartmentId']." AND BUCId=".$res['EmpVertical']." AND Hod2Id=0 AND RevId=".$res['Reviewer_EmployeeID']." AND YearId=".$_SESSION['PmsYId']." AND IncDistriFrom>0 AND CompanyId=".$CompanyId, $con); $rr02=mysql_num_rows($ss02);
if($rr02>0){ $resMaxMin = mysql_fetch_assoc($ss02); }
else
{ 
/* ppppppppppppppp */
$ss01= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_disbuc WHERE Rating=".$RatingHod." AND HodId=".$EmployeeId." AND DeptId=".$res['HR_Curr_DepartmentId']." AND BUCId=".$res['EmpVertical']." AND Hod2Id=".$res['Rev2_EmployeeID']." AND RevId=0 AND YearId=".$_SESSION['PmsYId']." AND IncDistriFrom>0 AND CompanyId=".$CompanyId, $con); $rr01=mysql_num_rows($ss01);
if($rr01>0){ $resMaxMin = mysql_fetch_assoc($ss01); }
else
{ 
/* oooooooooooooooo */
$ss0= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_disbuc WHERE Rating=".$RatingHod." AND HodId=".$EmployeeId." AND DeptId=".$res['HR_Curr_DepartmentId']." AND BUCId=".$res['EmpVertical']." AND Hod2Id=0 AND RevId=0 AND YearId=".$_SESSION['PmsYId']." AND IncDistriFrom>0 AND CompanyId=".$CompanyId, $con); $rr0=mysql_num_rows($ss0);
if($rr0>0){ $resMaxMin = mysql_fetch_assoc($ss0); }
else
{ 
 $ss= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_disrev WHERE Rating=".$RatingHod." AND HodId=".$EmployeeId." AND DeptId=".$res['HR_Curr_DepartmentId']." AND (RevId=".$res['Appraiser_EmployeeID']." OR RevId=".$res['Reviewer_EmployeeID'].") AND YearId=".$_SESSION['PmsYId']." AND IncDistriFrom>0 AND CompanyId=".$CompanyId, $con); $rr=mysql_num_rows($ss);
 if($rr>0){ $resMaxMin = mysql_fetch_assoc($ss); }
 else
 {
  $ss1= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_dishod2 WHERE Rating=".$RatingHod." AND HodId=".$EmployeeId." AND DeptId=".$res['HR_Curr_DepartmentId']." AND Hod2Id=".$res['Rev2_EmployeeID']." AND YearId=".$_SESSION['PmsYId']." AND IncDistriFrom>0 AND CompanyId=".$CompanyId, $con); $rr1=mysql_num_rows($ss1);
  if($rr1>0){ $resMaxMin = mysql_fetch_assoc($ss1); }
  else
  {
   $ss2= mysql_query("SELECT IncDistriFrom,IncDistriTo FROM hrm_pms_increment_disdept WHERE Rating=".$RatingHod." AND HodId=".$EmployeeId." AND DeptId=".$res['HR_Curr_DepartmentId']." AND YearId=".$_SESSION['PmsYId']." AND IncDistriFrom>0 AND CompanyId=".$CompanyId, $con); 
...
$MainOne=$resMaxMin['IncDistriFrom'];  
$MainTwo='';   
