...
<?php if($rowHod>0) { ?><td align="center"><a href="DisLeaveToHOD.php"><img id="Img_hod1" style="display:none;" src="images/RevHod1.png" border="0"/></a>
...
<?php $CFromDate='2013-04-01'; $CToDate=date("Y").'-12-31'; 
	  $sqlCheck=mysql_query("select * from hrm_employee_applyleave where Apply_SentToHOD=".$EmployeeId." AND LeaveStatus=3 AND LeaveActionHod!=1 AND LeaveActionHod!=2 AND (Apply_Date>='".$CFromDate."' AND Apply_Date<='".$CToDate."') order by Apply_Date ASC", $con); 
