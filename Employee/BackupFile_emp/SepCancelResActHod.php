...
if($_POST['SentCanRes'])
{
  $sqlU=mysql_query("update hrm_employee_separation set HOD_CancelResig='".$_POST['SepValue']."', HOD_CanRemark='".$_POST['HodCanRemark']."', HOD_SaveCanDate='".date("Y-m-d")."' where EmpSepId=".$_POST['SepId'], $con);
  if($sqlU)
  {
...
$email_message6 .="Your cancel resignation application is ".$action." by HOD, for details kindly log on to ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>. \n\n";
...
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
$email_message .=$Ename." cancel resignation application is ".$action." by HOD, for details kindly log on to ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>. \n\n";
...
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
$email_message2 .=$Hname." has ".$action." ".$Ename." cancel resignation application, for more details kindly log on to ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>. \n\n";
...
{ 
  var HodRemark = formname.HodCanRemark.value; var SepValue = formname.SepValue.value;  
  ...
  <table style="width:580px;" border="1">
   ...
   <tr bgcolor="#FFFFFF">
	...
	<td style="font-family:Geneva, Arial, Helvetica, sans-serif;font-size:13px;width:250px;background-color:#51A8FF;color:#FFFFFF;">&nbsp;<b><?php if($_REQUEST['v']=='A'){echo 'Resignation Cancellation Accept';}elseif($_REQUEST['v']=='C'){echo 'Resignation Cancellation Reject';} ?></b></td>
	  ...
	  <tr bgcolor="#FFFFFF">
      <td valign="top" style="font-family:Geneva, Arial, Helvetica, sans-serif;font-size:12px;width:200px;">&nbsp;<b>HOD Remark For Cancellation <?php if($_REQUEST['v']=='A'){echo 'Accept';}elseif($_REQUEST['v']=='C'){echo 'Reject';} ?></b></td>
	  <td valign="top" colspan="3" style="font-family:Geneva, Arial, Helvetica, sans-serif;font-size:13px;"><textarea name="HodCanRemark" id="HodCanRemark" cols="43" rows="4" style="background-color:#E1FFE1;border-style:groove;"><?php echo $resSE['HOD_CanRemark']; ?></textarea></td>
     </tr>
	</table>
	</td>
   </tr>
   ...
   <tr bgcolor="#FFFFFF">
        <td colspan="4" align="Right" class="fontButton">
         <table><tr>
	      ...
	      <td><input type="button" name="Refrash" value="refresh" onClick="javascript:window.location='SepCancelResActHod.php?act=<?php echo $_REQUEST['act']; ?>&e=44e&w=254&y=10234&a=e&e=5e2&e=4e&v=<?php echo $_REQUEST['v']; ?>&i=<?php echo $_REQUEST['i']; ?>&w=234&y=1022344&retd=ee&wwrew=t%T@#+aa+sed818&d=101'"/></td>
	     </tr></table>
        </td>
      </tr> 
  </table>
