...
<tr>
<td align="center" valign="top" rowspan="5" style="width:20px;font-size:15px;"><?php if($res['LTA']=='N' AND $res['CEA']=='N' AND $res['Medical']=='N'){echo 8;}else {echo 10;} ?></td>
...
<tr>
<td align="center" valign="top" style="width:20px;font-size:15px;"><?php if($res['LTA']=='N' AND $res['CEA']=='N' AND $res['Medical']=='N'){echo 9;}else {echo 11;} ?></td>
...
<tr>
<td align="center" valign="top" rowspan="2" style="width:20px;font-size:15px;"><?php if($res['LTA']=='N' AND $res['CEA']=='N' AND $res['Medical']=='N'){echo 10;}else {echo 12;} ?></td>
...
<input type="button" name="EditInvstDec" id="EditInvstDec" style="width:90px;" value="edit" onClick="Edit()" <?php if(date("Y-m-d H:i:s")>$res['LastDateTime']){echo 'disabled';}?>><?php } ?></td>
