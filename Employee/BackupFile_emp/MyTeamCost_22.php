...
function BtnEdit()
{
 var RowNo = document.getElementById("RowNo").value; document.getElementById("edit").style.display='none'; document.getElementById("save").style.display='block';
 for(var i=1; i<=RowNo; i++)
...
<?php //echo "<img width=105px height=125px src=\"show_images.php?id=".$EmployeeId."\">\n";?></td>
				  ...
				  <td align="left" width="1500" valign="top">
			  ...
			  <table border="0">
			   <tr>
				...
				<td class="td1" style="font-size:11px; width:100px;" align="center">
					   ...
					   <option value="<?php echo $_REQUEST['YI']; ?>" style="margin-left:0px;" selected><?php echo $PRD; ?></option>                      <?php if($_REQUEST['YI']!=5){?><option value="5">2016-2017</option><?php } ?>
...
?>			  <tr bgcolor="#FF8000">	
		       <td colspan="10" align="center" style="font-family:Times New Roman;color:#FFFFFF;font-size:15px; height:20px;width:640px;"><b><?php echo $Action.'&nbsp;(Year-'.$PRD.')'; ?></b></td>
			   <td colspan="3" align="center" style="font-family:Times New Roman;color:#FFFFFF;font-size:14px; height:20px;width:120px;">
			    <?php if($_REQUEST['YI']==$YearId){ ?>
				<?php if(date("Y-m-d")>=date('Y-09-02') AND date("Y-m-d")<date('Y-11-02')) { if($_REQUEST['action']!='Dept' AND $_REQUEST['action']!='Hod') {?>
<input type="button" name="edit" id="edit" value="Edit" onClick="BtnEdit()" style="font-family:Times New Roman;font-size:12px;width:60px;background-color:#FFFFFF;display:block;" />
<input type="submit" name="SaveValue" id="save" value="Save" style="font-family:Times New Roman;font-size:12px;width:60px;background-color:#88D28C;display:none;" />
			   ...
			   <td colspan="7" rowspan="3"align="center" style="font-family:Times New Roman;color:#FFFFFF;font-size:14px; height:20px;width:120px;">
			    <b>ACTUAL HOD PROPOSED PER MONTH</b>
			   </td>
	          </tr>		 
			  <tr bgcolor="#7a6189">	
		       <td colspan="2" rowspan="2" align="center"  valign="middle" style="color:#FFFFFF;font-size:11px; height:20px; width:110px;"><?php ?></td>
			   <td colspan="8" align="center" style="color:#FFFFFF;font-size:11px; height:20px;width:600px;"><b>PREVIOUS GROSS PER MONTH</b></td>
		     <td colspan="3" rowspan="2" align="center"  valign="middle" style="color:#FFFFFF;font-size:11px; height:20px; width:250px;"><b>PROPOSED PER MONTH</b></td>
	          </tr>
			  <tr bgcolor="#7a6189">	
			   <td colspan="2" align="center" style="color:#FFFFFF;font-size:11px; height:20px;width:150px;"><b>EMPLOYEE</b></td>
			   <td colspan="2" align="center" style="color:#FFFFFF;font-size:11px; height:20px;width:150px;"><b>APPRAISER</b></td>
			   <td colspan="2" align="center" style="color:#FFFFFF;font-size:11px; height:20px;width:150px;"><b>REVIEWER</b></td>
			   <td colspan="2" align="center" style="color:#FFFFFF;font-size:11px; height:20px;width:150px;"><b>HOD</b></td>
	          </tr>
			  <tr bgcolor="#7a6189">
			   ...
			   <td align="center" style="color:#FFFFFF;" class="All_120"><b>INCREMENT GROSS</b></td>
			   <td align="center" style="color:#FFFFFF;" class="All_60"><b>(%) INC</b></td>
			   <td align="center" style="color:#FFFFFF;" class="All_120"><b>INCREMENT</b></td>
			   	
			   <td align="center" style="color:#FFFFFF;" class="All_120"><b>Praposed GROSS</b></td>
			   <td align="center" style="color:#FFFFFF;" class="All_120"><b>Correction</b></td>
			   <td align="center" style="color:#FFFFFF;" class="All_120"><b>Total Gross</b></td>
			   <td align="center" style="color:#FFFFFF;" class="All_60"><b>(%) Praposed Gross</b></td>
			   <td align="center" style="color:#FFFFFF;" class="All_60"><b>(%) Correction</b></td>
...
<?php if(date("Y-m-d")>=date('Y-09-02') AND date("Y-m-d")<date('Y-11-02') AND $_REQUEST['YI']==$YearId) { ?>
<?php /**************************************** Dummy Start *********************************/ ?>	
<?php /**************************************** Dummy Start *********************************/ ?>			   
...
?>			   	
              <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="PIS_<?php echo $sn; ?>" name="PIS_<?php echo $sn; ?>" value="<?php echo $H2I; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_OneProInc(<?php echo $sn; ?>)" onClick="Cal_OneProInc(<?php echo $sn; ?>)" onChange="Cal_OneProInc(<?php echo $sn; ?>)" <?php } ?> onkeypress="return isNumberKey(event)" disabled /></td>
               <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="PerIS_<?php echo $sn; ?>" name="PerIS_<?php echo $sn; ?>" value="<?php echo $H3I; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_TwoProInc(<?php echo $sn; ?>)" onChange="Cal_TwoProInc(<?php echo $sn; ?>)" <?php } ?> onkeypress="return isNumberKey(event)" disabled /></td>
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="IncS_<?php echo $sn; ?>" name="IncS_<?php echo $sn; ?>" value="<?php echo $H4I; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_ThreeProInc(<?php echo $sn; ?>)" onClick="Cal_ThreeProInc(<?php echo $sn; ?>)" onChange="Cal_ThreeProInc(<?php echo $sn; ?>)" <?php } ?> onkeypress="return isNumberKey(event)" disabled /></td>	
...
<?php $resHTotP=mysql_fetch_array($sqlHTotP);  if($resHTotP['HodTotP']>0){$HTotP=$resHTotP['HodTotP'];}else{$HTotP=0;}?>			   			   
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="PIS_<?php echo $sn; ?>" name="PIS_<?php echo $sn; ?>" value="<?php echo $HTotP; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_OneProInc(<?php echo $sn; ?>)" onClick="Cal_OneProInc(<?php echo $sn; ?>)" onChange="Cal_OneProInc(<?php echo $sn; ?>)" <?php } ?> disabled /></td>
...
?>				   
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="PerIS_<?php echo $sn; ?>" name="PerIS_<?php echo $sn; ?>" value="<?php echo $round_PerInc; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_TwoProInc(<?php echo $sn; ?>)" onChange="Cal_TwoProInc(<?php echo $sn; ?>)" <?php } ?> disabled /></td>
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="IncS_<?php echo $sn; ?>" name="IncS_<?php echo $sn; ?>" value="<?php echo $HTotIncS; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_ThreeProInc(<?php echo $sn; ?>)" onClick="Cal_ThreeProInc(<?php echo $sn; ?>)" onChange="Cal_ThreeProInc(<?php echo $sn; ?>)" <?php } ?> disabled /></td>	
...
<?php $resHTotP2=mysql_fetch_array($sqlHTotP2);  if($resHTotP2['HodTotP2']>0){$HTotP2=$resHTotP2['HodTotP2'];}else{$HTotP2=0;}?>			   			   
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="PISh2_<?php echo $sn; ?>" name="PISh2_<?php echo $sn; ?>" value="<?php echo $HTotP2; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_OneProInch2(<?php echo $sn; ?>)" onClick="Cal_OneProInch2(<?php echo $sn; ?>)" onChange="Cal_OneProInch2(<?php echo $sn; ?>)" <?php } ?> readonly /></td>
...
?>	
 <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="PerIShP_<?php echo $sn; ?>" name="PerIShP_<?php echo $sn; ?>" value="<?php echo $round_PerInc2P; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_TwoProInchP(<?php echo $sn; ?>)" onChange="Cal_TwoProInchP(<?php echo $sn; ?>)" <?php } ?> readonly/></td>
 <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="PerIShC_<?php echo $sn; ?>" name="PerIShC_<?php echo $sn; ?>" value="<?php echo $round_PerInc2C; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_TwoProInchC(<?php echo $sn; ?>)" onChange="Cal_TwoProInchC(<?php echo $sn; ?>)" <?php } ?> readonly/></td>
 <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="PerIShT_<?php echo $sn; ?>" name="PerIShT_<?php echo $sn; ?>" value="<?php echo $round_PerInc2T; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_TwoProInchT(<?php echo $sn; ?>)" onChange="Cal_TwoProInchT(<?php echo $sn; ?>)" <?php } ?> readonly/></td>
...
?>				   
<td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#0080FF;font-weight:bold; background-color:#FFFFFF; font-size:11px;" id="IncSh_<?php echo $sn; ?>" name="IncSh_<?php echo $sn; ?>" value="<?php echo $HTotIncS2; ?>" <?php if($_REQUEST['YI']==$YearId){ ?> onKeyDown="Cal_ThreeProInch(<?php echo $sn; ?>)" onClick="Cal_ThreeProInch(<?php echo $sn; ?>)" onChange="Cal_ThreeProInch(<?php echo $sn; ?>)" <?php } ?> readonly/></td>	
...
<?php /**************************** Without Un assigned Open************************************/?>
		  <tr bgcolor="#0076EC">
		       <td colspan="2" align="right" style="color:#FFFFFF;font-family:Times New Roman;font-size:14px; height:20px; width:130px;"><b>Total:&nbsp;</b></td>
...
{  
  if($_REQUEST['action']=='Over'){ $sqlET=mysql_query("select SUM(EmpCurrGrossPM)as EmpGross, SUM(EmpCurrIncentivePM) as EmpInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NOET=mysql_query("select count(*) as NOET from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Dept'){ $sqlET=mysql_query("select SUM(EmpCurrGrossPM)as EmpGross, SUM(EmpCurrIncentivePM) as EmpInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NOET=mysql_query("select count(*) as NOET from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Hod'){ $sqlET=mysql_query("select SUM(EmpCurrGrossPM)as EmpGross, SUM(EmpCurrIncentivePM) as EmpInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NOET=mysql_query("select count(*) as NOET from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
} 
$resET=mysql_fetch_array($sqlET); if($_REQUEST['YI']>=2){$resNOET=mysql_fetch_array($NOET);} $ET=$resET['EmpGross']+$resET['EmpInct']; //$ET=$resET['EmpGross']+$EuGross; ?>			
               <td align="center" style="" class="All_50"><b style="color:#FFFFFF;"><?php echo $resNOET['NOET']; ?></b></td>   			   
			   <td align="right" style="" class="All_100"><b style="color:#FFFFFF;"><?php echo number_format($ET, 2, '.', ''); ?></b>&nbsp;
...
elseif($_REQUEST['YI']>=2)
{  
  if($_REQUEST['action']=='Over'){ $sqlAT=mysql_query("select SUM(EmpCurrGrossPM)as AppGross, SUM(EmpCurrIncentivePM) as AppInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NOAT=mysql_query("select count(*) as NOAT from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Dept'){ $sqlAT=mysql_query("select SUM(EmpCurrGrossPM)as AppGross, SUM(EmpCurrIncentivePM) as AppInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NOAT=mysql_query("select count(*) as NOAT from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con);  }
  elseif($_REQUEST['action']=='Hod'){ $sqlAT=mysql_query("select SUM(EmpCurrGrossPM)as AppGross, SUM(EmpCurrIncentivePM) as AppInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NOAT=mysql_query("select count(*) as NOAT from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con);}
} 
...
elseif($_REQUEST['YI']>=2)
{  
  if($_REQUEST['action']=='Over'){ $sqlRT=mysql_query("select SUM(EmpCurrGrossPM)as RevGross, SUM(EmpCurrIncentivePM) as RevInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NORT=mysql_query("select count(*) as NORT from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con);}
  elseif($_REQUEST['action']=='Dept'){ $sqlRT=mysql_query("select SUM(EmpCurrGrossPM)as RevGross, SUM(EmpCurrIncentivePM) as RevInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NORT=mysql_query("select count(*) as NORT from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con);  }
  elseif($_REQUEST['action']=='Hod'){ $sqlRT=mysql_query("select SUM(EmpCurrGrossPM)as RevGross, SUM(EmpCurrIncentivePM) as RevInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NORT=mysql_query("select count(*) as NORT from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con);}
} 
...
elseif($_REQUEST['YI']>=2)
{  
  if($_REQUEST['action']=='Over'){ $sqlHT=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrIncentivePM) as HodInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_HodRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NOHT=mysql_query("select count(*) as NOHT from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_HodRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con);}
  elseif($_REQUEST['action']=='Dept'){ $sqlHT=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrIncentivePM) as HodInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_HodRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NOHT=mysql_query("select count(*) as NOHT from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_HodRating!=0 AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Hod'){ $sqlHT=mysql_query("select SUM(EmpCurrGrossPM)as HodGross, SUM(EmpCurrIncentivePM) as HodInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_HodRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); $NOHT=mysql_query("select count(*) as NOHT from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Dummy_HodRating!=0 AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con);}
} 
...
?>			   	
               <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="PIST" name="PIST" value="<?php echo $H222I; ?>" readonly/></td>
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="PerIST" name="PerIST" value="<?php echo $H333I; ?>" readonly/></td>
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="IncST" name="IncST" value="<?php echo $H444I; ?>" readonly/></td>	
...
elseif($_REQUEST['YI']>=2)
{  
  if($_REQUEST['action']=='Over'){ $sqlHTotPT=mysql_query("select SUM(HR_GrossMonthlySalary)as HodTotP from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND (hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_pms.Dummy_HodRating!=0) AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Dept'){ $sqlHTotPT=mysql_query("select SUM(HR_GrossMonthlySalary)as HodTotP from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND (hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_pms.Dummy_HodRating!=0) AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Hod'){ $sqlHTotPT=mysql_query("select SUM(HR_GrossMonthlySalary)as HodTotP from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND (hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_pms.Dummy_HodRating!=0) AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
} 
$resHTotPT=mysql_fetch_array($sqlHTotPT); if($resHTotPT['HodTotP']>0){$HTotPT=$resHTotPT['HodTotP'];}else{$HTotPT=0;}
?>	
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="PIST" name="PIST" value="<?php echo $HTotPT; ?>" readonly/></td>
...
{  
  if($_REQUEST['action']=='Over'){ $sqlHTotIncST=mysql_query("select SUM(HR_IncNetMonthalySalary)as HodTotIncS from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND (hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_pms.Dummy_HodRating!=0) AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Dept'){ $sqlHTotIncST=mysql_query("select SUM(HR_IncNetMonthalySalary)as HodTotIncS from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND (hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_pms.Dummy_HodRating!=0) AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Hod'){ $sqlHTotIncST=mysql_query("select SUM(HR_IncNetMonthalySalary)as HodTotIncS from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND (hrm_employee_pms.Dummy_EmpRating!=0 AND hrm_employee_pms.Dummy_AppRating!=0 AND hrm_employee_pms.Dummy_RevRating!=0 AND hrm_employee_pms.Dummy_HodRating!=0) AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
} 
...
?>				   
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="PerIST" name="PerIST" value="<?php echo $round_PerIncT; ?>" readonly/></td>
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="IncST" name="IncST" value="<?php echo $HTotIncST; ?>" readonly/></td>	
...
{  
  if($_REQUEST['action']=='Over'){ $sqlHTotPT2=mysql_query("select SUM(Hod_ProIncSalary)as HodTotP2 from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Hod_TotalFinalRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Dept'){ $sqlHTotPT2=mysql_query("select SUM(Hod_ProIncSalary)as HodTotP2 from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Hod_TotalFinalRating!=0 AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Hod'){ $sqlHTotPT2=mysql_query("select SUM(Hod_ProIncSalary)as HodTotP2 from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Hod_TotalFinalRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
} 
$resHTotPT2=mysql_fetch_array($sqlHTotPT2); if($resHTotPT2['HodTotP2']>0){$HTotPT2=$resHTotPT2['HodTotP2'];}else{$HTotPT2=0;}
?>	
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="PISTth2" name="PISTth2" value="<?php echo $HTotPT2; ?>" readonly/></td>
...
?>	
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="PISTth22" name="PISTth22" value="<?php echo $HTotPT22; ?>" readonly/></td>
...
?>	
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="PISTth222" name="PISTth222" value="<?php echo $HTotPT222; ?>" readonly/></td>
...
{  
  if($_REQUEST['action']=='Over'){ $sqlHTotIncST2=mysql_query("select SUM(Hod_IncNetMonthalySalary)as HodTotIncS2 from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Hod_TotalFinalRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Dept'){ $sqlHTotIncST2=mysql_query("select SUM(Hod_IncNetMonthalySalary)as HodTotIncS2 from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.Hod_TotalFinalRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
  elseif($_REQUEST['action']=='Hod'){ $sqlHTotIncST2=mysql_query("select SUM(Hod_IncNetMonthalySalary)as HodTotIncS2 from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Hod_TotalFinalRating!=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31' AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0", $con); }
} 
...
?>				   
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="PerISTthPT" name="PerISTthPT" value="<?php echo $round_PerInc2PT; ?>" readonly/></td>
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="PerISTthCT" name="PerISTthCT" value="<?php echo $round_PerInc2CT; ?>" readonly/></td>
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="PerISTthTT" name="PerISTthTT" value="<?php echo $round_PerInc2TT; ?>" readonly/></td>
<?php   
//$resHTotIncST2=mysql_fetch_array($sqlHTotIncST2);
...
?>				   
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#0076EC; font-size:11px;" id="IncSTth" name="IncSTth" value="<?php echo $HTotIncST2; ?>" readonly/></td>	
...
<?php /**************************** Unussed Open ************************************/?> 
<?php /**************************** Unussed Open ************************************/?>
<tr bgcolor="#909090"><td colspan="20" style="height:20px;width:130px;color:#FFFFFF;font-family:Times New Roman;">&nbsp;<b>With Un-assigned</b></td></tr>
...
<?php if($_REQUEST['action']=='Over'){ $sqlAUn=mysql_query("select SUM(EmpCurrGrossPM)as UnAppGross, SUM(EmpCurrIncentivePM) as UnAppInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_AppRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NOAUn=mysql_query("select count(*) as NOAUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_AppRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con);}
	  elseif($_REQUEST['action']=='Dept'){ $sqlAUn=mysql_query("select SUM(EmpCurrGrossPM)as UnAppGross, SUM(EmpCurrIncentivePM) as UnAppInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_AppRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NOAUn=mysql_query("select count(*) as NOAUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_AppRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con);}
	  elseif($_REQUEST['action']=='Hod'){ $sqlAUn=mysql_query("select SUM(EmpCurrGrossPM)as UnAppGross, SUM(EmpCurrIncentivePM) as UnAppInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_AppRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NOAUn=mysql_query("select count(*) as NOAUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_AppRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
...
<?php if($_REQUEST['action']=='Over'){ $sqlRUn=mysql_query("select SUM(EmpCurrGrossPM)as UnRevGross, SUM(EmpCurrIncentivePM) as UnRevInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_RevRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NORUn=mysql_query("select count(*) as NORUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_RevRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
	  elseif($_REQUEST['action']=='Dept'){ $sqlRUn=mysql_query("select SUM(EmpCurrGrossPM)as UnRevGross, SUM(EmpCurrIncentivePM) as UnRevInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_RevRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NORUn=mysql_query("select count(*) as NORUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_RevRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con);}
	  elseif($_REQUEST['action']=='Hod'){ $sqlRUn=mysql_query("select SUM(EmpCurrGrossPM)as UnRevGross, SUM(EmpCurrIncentivePM) as UnRevInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_RevRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NORUn=mysql_query("select count(*) as NORUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_RevRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
...
<?php if($_REQUEST['action']=='Over'){ $sqlHUn=mysql_query("select SUM(EmpCurrGrossPM)as UnHodGross, SUM(EmpCurrIncentivePM) as UnHodInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NOHUn=mysql_query("select count(*) as NOHUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
	  elseif($_REQUEST['action']=='Dept'){ $sqlHUn=mysql_query("select SUM(EmpCurrGrossPM)as UnHodGross, SUM(EmpCurrIncentivePM) as UnHodInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NOHUn=mysql_query("select count(*) as NOHUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con);}
	  elseif($_REQUEST['action']=='Hod'){ $sqlHUn=mysql_query("select SUM(EmpCurrGrossPM)as UnHodGross, SUM(EmpCurrIncentivePM) as UnHodInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $NOHUn=mysql_query("select count(*) as NOHUn from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
...
<?php if($_REQUEST['action']=='Over')
     { $sql3I=mysql_query("select IncGross,PerInc,Inc from hrm_pms_dummy_increment_un where YearId=".$_REQUEST['YI']." AND CompanyId=".$CompanyId, $con);
	   ...
	   $sqlCH=mysql_query("select Dummy_HodRating from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCH=mysql_num_rows($sqlCH);
		$sqlCR=mysql_query("select Dummy_RevRating from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.Dummy_RevRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCR=mysql_num_rows($sqlCR);
		$sqlCA=mysql_query("select Dummy_AppRating from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.Dummy_AppRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCA=mysql_num_rows($sqlCA);
		$sqlCE=mysql_query("select Dummy_EmpRating from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.Dummy_EmpRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCE=mysql_num_rows($sqlCE);
/*		
if($rowCH==0)
{ if($rowCR==0)
  { if($rowCA==0)
...
*/   
if($rowCH==0){ $Pre_GrossValue=0; } 
else { $sqlD=mysql_query("select SUM(EmpCurrGrossPM)as DeptTotGross, SUM(EmpCurrIncentivePM) as DeptInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $resD=mysql_fetch_assoc($sqlD);
 $Pre_GrossValue=$resD['DeptTotGross']+$resD['DeptInct']; }   
	 ...
	 { $sql3I=mysql_query("select PerInc from hrm_pms_dummy_increment_un where YearId=".$_REQUEST['YI']." AND CompanyId=".$CompanyId, $con);
	   $sqlCH=mysql_query("select Dummy_HodRating from hrm_employee_pms INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCH=mysql_num_rows($sqlCH);
	   $sqlCR=mysql_query("select Dummy_RevRating from hrm_employee_pms INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.Dummy_RevRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCR=mysql_num_rows($sqlCR);
	   $sqlCA=mysql_query("select Dummy_AppRating from hrm_employee_pms INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.Dummy_AppRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCA=mysql_num_rows($sqlCA);
...
*/
if($rowCH==0){ $Pre_GrossValue=0; } 
else { $sqlD=mysql_query("select SUM(EmpCurrGrossPM)as DeptTotGross, SUM(EmpCurrIncentivePM) as DeptInct from hrm_employee_pms INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $resD=mysql_fetch_assoc($sqlD);
 $Pre_GrossValue=$resD['DeptTotGross']+$resD['DeptInct']; }    
	 ...
	 elseif($_REQUEST['action']=='Hod')
	 { $sql3I=mysql_query("select PerInc from hrm_pms_dummy_increment_un where YearId=".$_REQUEST['YI']." AND CompanyId=".$CompanyId, $con);
	   $sqlCH=mysql_query("select Dummy_HodRating from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCH=mysql_num_rows($sqlCH);
		$sqlCR=mysql_query("select Dummy_RevRating from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_RevRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCR=mysql_num_rows($sqlCR);
		$sqlCA=mysql_query("select Dummy_AppRating from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_AppRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCA=mysql_num_rows($sqlCA);
		$sqlCE=mysql_query("select Dummy_EmpRating from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_EmpRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $rowCE=mysql_num_rows($sqlCE);
/*		
if($rowCH==0)
{ if($rowCR==0)
...
*/
if($rowCH==0){ $Pre_GrossValue=0; } 
else {  $sqlD=mysql_query("select SUM(EmpCurrGrossPM)as DeptTotGross, SUM(EmpCurrIncentivePM) as DeptInct from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); $resD=mysql_fetch_assoc($sqlD);
 $Pre_GrossValue=$resD['DeptTotGross']+$resD['DeptInct']; }
...
?>			   	
              <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnPIS" name="UnPIS" value="<?php echo ''//$H22I; ?>" onKeyDown="OneUn()" onClick="OneUn()" onChange="OneUn()" disabled /></td>
              <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnPerIS" name="UnPerIS" value="<?php echo ''//$H33I; ?>" onKeyDown="TwoUn()" onChange="TwoUn()" disabled /></td>
			  <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnIncS" name="UnIncS" value="<?php echo ''//$H44I; ?>" onKeyDown="ThreeUn()" onClick="ThreeUn()" onChange="ThreeUn()" disabled /></td>	
<?php /**************************************** Dummy Close *********************************/ ?>
<?php /**************************************** Dummy Close *********************************/ ?>		  		   
<?php } else { ?>
<?php /**************************************** Actual Value Start *********************************/ ?>		
...
<?php if($_REQUEST['action']=='Over'){ $sqlUnHTotP=mysql_query("select SUM(HR_GrossMonthlySalary)as UnHodTotP from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
	  ...
	  elseif($_REQUEST['action']=='Hod'){ $sqlUnHTotP=mysql_query("select SUM(HR_GrossMonthlySalary)as UnHodTotP from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Dummy_HodRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
	   $resUnHTotP=mysql_fetch_array($sqlUnHTotP); if($resUnHTotP['UnHodTotP']>0){$UnHTotP=$resUnHTotP['UnHodTotP'];}else{$UnHTotP=0;} ?>					      
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnPIS" name="UnPIS" value="<?php echo ''//$UnHTotP; ?>" onKeyDown="OneUn()" onClick="OneUn()" onChange="OneUn()" disabled /></td>
...
?>			      
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnPerIS" name="UnPerIS" value="<?php echo ''//$Unround_PerInc; ?>" onKeyDown="TwoUn()" onChange="TwoUn()" disabled /></td>
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnIncS" name="UnIncS" value="<?php echo ''//$UnHTotIncS; ?>" onKeyDown="ThreeUn()" onClick="ThreeUn()" onChange="ThreeUn()" disabled /></td>	
...
<?php if($_REQUEST['action']=='Over'){ $sqlUnHTotP2=mysql_query("select SUM(Hod_GrossMonthlySalary)as UnHodTotP2 from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Hod_TotalFinalRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
	  ...
	  elseif($_REQUEST['action']=='Hod'){ $sqlUnHTotP2=mysql_query("select SUM(Hod_GrossMonthlySalary)as UnHodTotP2 from hrm_employee_pms INNER JOIN hrm_employee_general ON hrm_employee_pms.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee ON hrm_employee_pms.EmployeeID=hrm_employee.EmployeeID where hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.CompanyId=".$CompanyId." AND hrm_employee_pms.Appraiser_EmployeeID!=0 AND hrm_employee_pms.HOD_EmployeeID=".$_REQUEST['value']." AND hrm_employee.EmpStatus='A' AND hrm_employee_pms.Hod_TotalFinalRating=0 AND hrm_employee_general.DateJoining<='".$Y."-03-31'", $con); }
	   $resUnHTotP2=mysql_fetch_array($sqlUnHTotP2); if($resUnHTotP2['UnHodTotP2']>0){$UnHTotP2=$resUnHTotP2['UnHodTotP2'];}else{$UnHTotP2=0;} ?>					
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnPISth" name="UnPISth" value="<?php echo ''//$UnHTotP2; ?>" onKeyDown="OneUnth()" onClick="OneUnth()" onChange="OneUnth()" readonly /></td>
...
?>			      
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnPerISth" name="UnPerISth" value="<?php echo ''//$Unround_PerInc2; ?>" onKeyDown="TwoUnth()" onChange="TwoUnth()" readonly /></td>
			   <td align="center" style="" class="All_120"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnIncSth" name="UnIncSth" value="<?php echo ''//$UnHTotIncS2; ?>" onKeyDown="ThreeUnth()" onClick="ThreeUnth()" onChange="ThreeUnth()" readonly /></td>	
			   
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:58px;text-align:center;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnPerISth" name="UnPerISth" value="<?php echo ''//$Unround_PerInc2; ?>" onKeyDown="TwoUnth()" onChange="TwoUnth()" readonly /></td>
			   <td align="center" style="" class="All_60"><input style="border-style:hidden; border:0;width:118px;text-align:right;color:#FFFFFF;font-weight:bold; background-color:#909090; font-size:11px;" id="UnIncSth" name="UnIncSth" value="<?php echo ''//$UnHTotIncS2; ?>" onKeyDown="ThreeUnth()" onClick="ThreeUnth()" onChange="ThreeUnth()" readonly /></td>	
