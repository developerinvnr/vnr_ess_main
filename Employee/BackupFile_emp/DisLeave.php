...
<?php if($rowHod>0 OR $rowRev>0) { ?><td align="center"><a href="DisLeaveToHOD.php"><img id="Img_hod1" style="display:block;" src="images/RevHod1.png" border="0"/></a>
...
<?php $CFromDate=date("Y-01-01"); $CToDate=date("Y").'-12-31'; 
	  $sqlCheck=mysql_query("select * from hrm_employee_applyleave where Apply_SentToApp=".$EmployeeId." AND LeaveStatus=3 AND LeaveActionApp!=1 AND LeaveActionApp!=2 AND Apply_FromDate>='".$CFromDate."' order by Apply_Date ASC", $con); 
