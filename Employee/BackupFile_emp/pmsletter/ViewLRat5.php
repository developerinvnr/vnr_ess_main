We are pleased to inform you that your performance for the assessment period <b><?php echo $Ass2Year; ?></b> has been rated as <b>"<?php echo $ResR['RatingName']; ?>"</b> with "<b>Rating-5</b>".<?php /*?><b>"<?php echo $ResR['RatingName']; ?>"</b> with "<b>Rating-5</b>".<?php */?> <p>   

           You are a role model for all in the organization! Your performance surpasses the expectations of your seniors by leaps and bounds. We appreciate your dedication and efforts that displays such fantabulous performance. We expect you to continue performing with similar zeal & enthusiasm. <p>
