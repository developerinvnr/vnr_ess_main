We are pleased to inform you that your performance for the assessment period <b><?php echo $Ass2Year; ?></b> has been rated as <b>"<?php echo $ResR['RatingName']; ?>"</b> with "<b>Rating-3.4</b>".<?php /*?><b>"<?php echo $ResR['RatingName']; ?>"</b> with "<b>Rating-3.4</b>".<?php */?> <p>   

           Your performance indicates that with focused approach and efforts you can improve your level of performance and attain better position amongst your peers. <p>
