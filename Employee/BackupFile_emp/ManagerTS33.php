...

{
  ...
  $sqlUpPms=mysql_query("update hrm_employee_pms set Appraiser_Remark='".$_POST['AppRemarks']."', Appraiser_PmsStatus=1, Appraiser_SubmitedDate='".date("Y-m-d")."', AppraiserFormAScore=".$_POST['AppFormAScore'.$NoK].", AppraiserFormBScore=".$_POST['AppBehaviFormBScore'.$NoB].", AppraiserFinallyFormA_Score=".$_POST['Score_1'].", AppraiserFinallyFormB_Score=".$_POST['Score_2'].", Appraiser_TotalFinalScore=".$_POST['TotalScore_12'].", Appraiser_TotalFinalRating=".$App_Rating.", Appraiser_EmpDesignation=".$_POST['DesigId'].", Appraiser_EmpGrade=".$_POST['GradeId'].", Appraiser_Justification='".$_POST['Justification']."' where EmpPmsId=".$_POST['PmsId']." AND EmployeeID=".$_POST['EmpId'], $con);
...
for($i=1; $i<=$_POST['EmpKraRow']; $i++)
  ...
  $sqlUpPms=mysql_query("update hrm_employee_pms set Appraiser_Remark='".$_POST['AppRemarks']."', Appraiser_PmsStatus=2, Appraiser_SubmitedDate='".date("Y-m-d")."', AppraiserFormAScore=".$_POST['AppFormAScore'.$NoK].", AppraiserFormBScore=".$_POST['AppBehaviFormBScore'.$NoB].", AppraiserFinallyFormA_Score=".$_POST['Score_1'].", AppraiserFinallyFormB_Score=".$_POST['Score_2'].", Appraiser_TotalFinalScore=".$_POST['TotalScore_12'].", Appraiser_TotalFinalRating=".$App_Rating.", Appraiser_EmpDesignation=".$_POST['DesigId'].", Appraiser_EmpGrade=".$_POST['GradeId'].", Appraiser_Justification='".$_POST['Justification']."' where EmpPmsId=".$_POST['PmsId']." AND EmployeeID=".$_POST['EmpId'], $con);
