		 ...
		 <td valign="top" align="right">
		   ...
		   <table border="1" bgcolor="#FFFFFF">
			...
			<tr>
			  ...
			  <td class="head" style="width:100px;" valign="top">&nbsp;<?php if($resSetH['Show_GradeDesig']=='Y'){ echo 'Designation'; } ?></td>

			  <td class="data" style="width:250px;text-transform:uppercase;" valign="top">&nbsp;<?php if($resSetH['Show_GradeDesig']=='Y'){ echo $resDe['DesigName']; } ?></td>
