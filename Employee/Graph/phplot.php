...
class PHPlot
{
    ...
    protected $default_colors = array(
        'magenta', 'blue', 'green', 'orange', 'red', 'DarkGreen', 'purple', 'white', 'peru',
    ...
    protected $line_styles = array('solid', 'solid', 'solid', 'solid');   //protected $line_styles = array('solid', 'solid', 'dashed');
