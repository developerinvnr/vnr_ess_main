  ...
  <table border="0" style="width:100%;">
   ...
   <span id="MyTeamInc">
    ...
    <tr bgcolor="#7a6189">
     ...
     <td class="th" style="width:4%;border-left:hidden;">Rating</td>
	 <td class="th" style="width:4%;border-left:hidden;">Confirm<sup>t</sup><br>Rating</td>
	 <td class="th" style="width:15%;border-right:hidden;">Name</td>
     <td class="th" style="width:4%;border-left:hidden;border-right:hidden;">Score</td>
	 <td class="th" style="width:4%;border-left:hidden;">Rating</td>
	 ...
	 <td class="th" style="width:12%;border-left:hidden;border-right:hidden;">Text</td>
...
$sql=mysql_query("select e.EmployeeID, EmpCode, Fname, Sname, Lname, g.DateJoining, g.DateConfirmationYN, EmpPmsId, Appraiser_EmployeeID, Reviewer_EmployeeID, Rev2_EmployeeID, Emp_TotalFinalScore, Emp_TotalFinalRating, Appraiser_TotalFinalScore, Appraiser_TotalFinalRating, Appraiser_EmpDesignation, Appraiser_EmpGrade, Reviewer_TotalFinalScore, Reviewer_TotalFinalRating, Reviewer_EmpDesignation, Reviewer_EmpGrade, HodSubmit_IncStatus, Hod_TotalFinalScore, Hod_TotalFinalRating, Hod_EmpDesignation, HR_CurrDesigId, HR_Curr_DepartmentId, Hod_EmpGrade from hrm_employee e INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_pms p ON e.EmployeeID=p.EmployeeID where e.EmpStatus='A' AND g.DateJoining<='".$_SESSION['AllowDoj']."' AND e.CompanyId=".$CompanyId." AND p.AssessmentYear=".$_SESSION['PmsYId']." AND p.HOD_EmployeeID=".$EmployeeId." order by e.EmpCode ASC", $con); $sno=1; while($res=mysql_fetch_array($sql)){ 
...
?>
    ...
    <tr style="height:24px;background-color:#FFFFFF;">
     ...
     <td class="tdc" style="background-color:#D2FFA6;"><?php echo $res['Emp_TotalFinalRating'];?></td>
	 ...
	 <td class="tdc" style="background-color:#D2FFA6;"><?php echo $res['Appraiser_TotalFinalRating'];?></td>
