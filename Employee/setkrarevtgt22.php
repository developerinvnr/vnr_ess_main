...
<?php $sql=mysql_query("select * from hrm_pms_kra_tgtdefin where ".$fn."=".$_REQUEST['kid']." AND Tital='".$t."' AND NtgtN='".$i."'",$con); $row=mysql_num_rows($sql); $res=mysql_fetch_assoc($sql); ?>  
	 ...
	 <td class="d" align="center"><?php if($res['LogScr']!=''){ echo $res['LogScr'];}else{echo 0;} ?></td>
	 ...
	 <td class="d" align="center"><?php if($res['AppLogScr']!=''){ echo $res['AppLogScr'];}else{echo 0;} ?></td>
	...
	<td align="center">
	 <?php if($res['Tital']!='' AND $res['Tgt']!==''){ ?>
	  <span style="cursor:pointer"><img src="images/edit.png" border="0" id="edit_<?php echo $i; ?>" style="display:<?php if($res['Revlockk']==0){echo 'block';}else{echo 'none';} ?>" onClick="FunEdit(<?php echo $i; ?>)"/></span>
	 ...
	 <td align="center">
	  ...
	  <span style="cursor:pointer"><img src="images/sub.png" border="0" id="lockk_<?php echo $i; ?>" style="display:<?php if($res['RevCmnt']!=='' AND $res['Revlockk']==0){echo 'block';}else{echo 'none';} ?>;" onClick="FunLk(<?php echo $i.','.$res['TgtDefId']; ?>)"/></span>
	 </td>
...
<td class="d" align="center" bgcolor="#FFFFFF"><b><?php if($rest['tLogScr']>0){echo floatval($rest['tLogScr']);}?></b></td>	 	<td class="d" align="center" bgcolor="#FFFFFF"><b><?php if($rest['tScor']>0){echo floatval($rest['tScor']);} ?></b></td>
	 ...
	 <td class="d" align="" bgcolor="#FFFFFF"></td>	 
	 <td class="d" align="center" bgcolor="#FFFFFF"><b><?php if($rest['tAppLogScr']>0){echo floatval($rest['tAppLogScr']);} ?></b></td>	 	 
