...
<?php //*************************************************************************************************************************************************** ?>	   
	     ...
	     <table border="0" width="1000">
		    <tr>
		     ...
		     <img id="Img_ctc" style="display:block;" src="images/ctc.png" border="0"/></td>
             <td align="center"><a href="MyElig.php"><img id="Img_elig1" style="display:block;" src="images/elig1.png" border="0"/></a>
		     <img id="Img_elig" style="display:none;" src="images/elig.png" border="0"/></td>
			 <td>&nbsp;</td>
...
?> 		
<?php //if($DepartmentId!=4 AND $DepartmentId!=25) { ?>	
<tr>
...
<?php if($CompanyId==1 OR $CompanyId==2) { ?>
<tr>
