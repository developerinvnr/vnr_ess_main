...
if(isset($_POST['ReplyQuery']))
{
 ...
 { if($_POST['NOfT']==1)
   { $sqlUpRep=mysql_query("update hrm_employee_queryemp set QueryReply='".$_POST['ReplyQText']."', QReplyDT='".date("Y-m-d h:i:s")."', QStatus=2, Level_2QStatus=2, Level_2ReplyAns='".$_POST['ReplyQText']."', Level_2DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==2)
   { $sqlUpRep=mysql_query("update hrm_employee_queryemp set Query2Reply='".$_POST['ReplyQText']."', QReply2DT='".date("Y-m-d h:i:s")."', QStatus=2, Level_2QStatus=2, Level_2ReplyAns='".$_POST['ReplyQText']."', Level_2DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==3)
   { $sqlUpRep=mysql_query("update hrm_employee_queryemp set Query3Reply='".$_POST['ReplyQText']."', QReply3DT='".date("Y-m-d h:i:s")."', QStatus=2, Level_2QStatus=2, Level_2ReplyAns='".$_POST['ReplyQText']."', Level_2DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==4)
   { $sqlUpRep=mysql_query("update hrm_employee_queryemp set Query4Reply='".$_POST['ReplyQText']."', QReply4DT='".date("Y-m-d h:i:s")."', QStatus=2, Level_2QStatus=2, Level_2ReplyAns='".$_POST['ReplyQText']."', Level_2DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==5)
   { $sqlUpRep=mysql_query("update hrm_employee_queryemp set Query5Reply='".$_POST['ReplyQText']."', QReply5DT='".date("Y-m-d h:i:s")."', QStatus=2, Level_2QStatus=2, Level_2ReplyAns='".$_POST['ReplyQText']."', Level_2DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
 ...
 { if($_POST['NOfT']==1)
   {$sqlUpRep=mysql_query("update hrm_employee_queryemp set QueryReply='".$_POST['ReplyQText']."', QReplyDT='".date("Y-m-d h:i:s")."', QStatus=1, Level_2QStatus=1, Level_2ReplyAns='".$_POST['ReplyQText']."', Level_2DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==2)
   {$sqlUpRep=mysql_query("update hrm_employee_queryemp set Query2Reply='".$_POST['ReplyQText']."', QReply2DT='".date("Y-m-d h:i:s")."', QStatus=1, Level_2QStatus=1, Level_2ReplyAns='".$_POST['ReplyQText']."', Level_2DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==3)
   {$sqlUpRep=mysql_query("update hrm_employee_queryemp set Query3Reply='".$_POST['ReplyQText']."', QReply3DT='".date("Y-m-d h:i:s")."', QStatus=1, Level_2QStatus=1, Level_2ReplyAns='".$_POST['ReplyQText']."', Level_2DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==4)
   {$sqlUpRep=mysql_query("update hrm_employee_queryemp set Query4Reply='".$_POST['ReplyQText']."', QReply4DT='".date("Y-m-d h:i:s")."', QStatus=1, Level_2QStatus=1, Level_2ReplyAns='".$_POST['ReplyQText']."', Level_2DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==5)
   {$sqlUpRep=mysql_query("update hrm_employee_queryemp set Query5Reply='".$_POST['ReplyQText']."', QReply5DT='".date("Y-m-d h:i:s")."', QStatus=1, Level_2QStatus=1, Level_2ReplyAns='".$_POST['ReplyQText']."', Level_2DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
...
{
  $sqlR=mysql_query("select Level_2ID,Level_2QFwdNoOfTime from hrm_employee_queryemp where QueryId=".$_POST['RepQ_ID'], $con); $resR=mysql_fetch_assoc($sqlR);
  if($_POST['ReaForward']==1){$Res=$_POST['Reason_1'];}elseif($_POST['ReaForward']==3){$Res=$_POST['OtherReason'];}
  
  if($resR['Level_2QFwdNoOfTime']==0 AND $_POST['RepQ_Value']=='F')
  {$sqlUp=mysql_query("update hrm_employee_queryemp set QStatus=1, Level_2ID=".$_POST['ActionEmp'].", Level_2QFwd='Y', Level_2QFwdNoOfTime=1, Level_2QFwdEmpId=".$resR['Level_2ID'].", Level_2QFwdReason='".$Res."', Level_2QFwdDT='".date("Y-m-d h:i:s")."', Level_2QStatus=1 where QueryId=".$_POST['RepQ_ID'], $con); }
  elseif($resR['Level_2QFwdNoOfTime']==1 AND $_POST['RepQ_Value']=='F')
  {$sqlUp=mysql_query("update hrm_employee_queryemp set QStatus=1, Level_2ID=".$_POST['ActionEmp'].", Level_2QFwd='Y', Level_2QFwdNoOfTime=2, Level_2QFwdEmpId2=".$resR['Level_2ID'].", Level_2QFwdReason2='".$Res."', Level_2QFwdDT2='".date("Y-m-d h:i:s")."', Level_2QStatus=1 where QueryId=".$_POST['RepQ_ID'], $con); }
  elseif($resR['Level_2QFwdNoOfTime']==2 AND $_POST['RepQ_Value']=='F')
  {$sqlUp=mysql_query("update hrm_employee_queryemp set QStatus=1, Level_2ID=".$_POST['ActionEmp'].", Level_2QFwd='Y', Level_2QFwdNoOfTime=3, Level_2QFwdEmpId3=".$resR['Level_2ID'].", Level_2QFwdReason3='".$Res."', Level_2QFwdDT3='".date("Y-m-d h:i:s")."', Level_2QStatus=1 where QueryId=".$_POST['RepQ_ID'], $con); }
				...
				<td colspan="2" align="Right" class="fontButton">
		          <table border="0" width="400">
			        <tr>
			         ...
			         <td align="right" style="width:70px;"><input type="button" name="Refresh" id="Refresh" style="width:90px;" value="Refresh" onClick="javascript:window.location='ReplyQueryApp.php?action=<?php echo $_REQUEST['action']; ?>&QR=<?php echo $_REQUEST['QR']; ?>&NOfT=<?php echo $_REQUEST['NOfT']; ?>'"/></td>
			       </tr>
		        </table>
		      </td>
	      </tr>
