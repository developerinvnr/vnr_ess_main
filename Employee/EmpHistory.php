...
<?php $sqlSetH=mysql_query("select * from hrm_pms_setting where CompanyId=".$resE['CompanyId']." AND Process='PMS' ", $con);  
	  ...
	  <td valign="top" align="right" style="width:85%;">
	   <table border="1" bgcolor="#FFFFFF" cellspacing="0" style="width:100%;">
		...
		<tr style="height:25px;">
		  ...
		  <td class="data" style="text-transform:uppercase;">&nbsp;<?php if($resSetH['Show_GradeDesig']=='Y'){ echo $resE['DesigName']; } ?></td>
		  <td class="head">&nbsp;Function</td>
		  <td class="data" style="text-transform:uppercase;">&nbsp;<?php echo $resE['FunName']; ?></td>
		</tr>
		<tr style="height:25px;">
...
?>			
    ...
    <?php if($resSetH['Show_Ctc']=='Y' && $resSetH['Show_GradeDesig']=='Y'){ ?>
    <tr><td>&nbsp;</td></tr>
     ...
     <td style="vertical-align:top;width:100%;" valign="top">
	  <table border="1" cellspacing="0" style="width:100%;">
	   <tr style="height:25px;color:#FFFFFF;background-color:#7a6189;">
		...
		<td class="headc" style="width:30%;">Designation</td>
		...
		<td class="headc" style="width:10%;">CTC</td>
		<td class="headc" style="width:10%;">%<br>Increment</td>
        <td class="headc" style="width:10%;">Rating</td>	
	   </tr>
<?php $sqlHi2=mysql_query("select SalaryChange_Date, Previous_GrossSalaryPM, Proposed_Designation, Proposed_Grade, TotalProp_GSPM, Proposed_GrossSalaryPM, TotalProp_PerInc_GSPM, Rating from hrm_pms_appraisal_history where EmpCode=".$resE['EmpCode']." AND CompanyId=".$resE['CompanyId']." AND SalaryChange_Date>='".date('2012-01-01')."' order by SalaryChange_Date DESC", $con); 
	  ...
	  ?>
       <tr style="height:22px;background-color:#FFFFFF;">
		...
		<td class="datar"><?php echo floatval($resHi2['Previous_GrossSalaryPM']); ?>&nbsp;</td>
		<td class="datar"><?php if($resHi2['TotalProp_GSPM']<$resHi2['Previous_GrossSalaryPM']){echo floatval($resHi2['Proposed_GrossSalaryPM']);}else{echo floatval($resHi2['TotalProp_GSPM']); } ?>&nbsp;</td>
		
		<td class="datar"><?php echo floatval($rctc['Tot_CTC']); ?>&nbsp;</td>
...
<?php 
      ...
      //echo $resHi2['TotalProp_PerInc_GSPM']; 
      } ?>
		</td>
