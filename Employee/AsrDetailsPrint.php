...
$Ei=$_REQUEST['ei']; $Yi=$_REQUEST['yi']; $LastYId=$_REQUEST['yearid']-1;
...
<?php //************************************************************************************** ?>	
<?php $sqlE=mysql_query("select Fname,Sname,Lname,EmpCode,DesigId,DepartmentId,Gender,DR,Married from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID where hrm_employee.EmployeeID=".$Ei, $con); $resE=mysql_fetch_assoc($sqlE); 
...
<table>
<tr>
 <td style="font-family:Times New Roman;font-size:20px;"><b>&nbsp;Anuual Salary&nbsp;[<?php echo $FromY.'-'.$ToY; ?>]</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <?php echo $EC.' - '.$Ename; ?>
 </td>
</tr>
<?php $sqlPayM=mysql_query("select * from hrm_employee_key_paymonth where CompanyId=".$_REQUEST['ci'], $con); $SNo=1; $resPayM=mysql_fetch_array($sqlPayM); ?>
<tr>
 <td>
...
<?php if($Res_4['Convance']!=0 OR $Res_5['Convance']!=0 OR $Res_6['Convance']!=0 OR $Res_7['Convance']!=0 OR $Res_8['Convance']!=0 OR $Res_9['Convance']!=0 OR $Res_10['Convance']!=0 OR $Res_11['Convance']!=0 OR $Res_12['Convance']!=0 OR $Res_1['Convance']!=0 OR $Res_2['Convance']!=0 OR $Res_3['Convance']!=0){ ?>
<tr bgcolor="#FFFFFF">
...
<?php } if($Res_4['TA']>0 OR $Res_5['TA']>0 OR $Res_6['TA']>0 OR $Res_7['TA']>0 OR $Res_8['TA']>0 OR $Res_9['TA']>0 OR $Res_10['TA']>0 OR $Res_11['TA']>0 OR $Res_12['TA']>0 OR $Res_1['TA']>0 OR $Res_2['TA']>0 OR $Res_3['TA']>0){ ?>
<tr bgcolor="#FFFFFF">
...
<?php } if($Res_4['Car_Allowance']>0 OR $Res_5['Car_Allowance']>0 OR $Res_6['Car_Allowance']>0 OR $Res_7['Car_Allowance']>0 OR $Res_8['Car_Allowance']>0 OR $Res_9['Car_Allowance']>0 OR $Res_10['Car_Allowance']>0 OR $Res_11['Car_Allowance']>0 OR $Res_12['Car_Allowance']>0 OR $Res_1['Car_Allowance']>0 OR $Res_2['Car_Allowance']>0 OR $Res_3['Car_Allowance']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Car Allowance</td>
<td class="All_80"><?php echo intval($Res_4['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['Car_Allowance']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['Car_Allowance']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['Car_Allowance']+$Res_5['Car_Allowance']+$Res_6['Car_Allowance']+$Res_7['Car_Allowance']+$Res_8['Car_Allowance']+$Res_9['Car_Allowance']+$Res_10['Car_Allowance']+$Res_11['Car_Allowance']+$Res_12['Car_Allowance']+$Res_1['Car_Allowance']+$Res_2['Car_Allowance']+$Res_3['Car_Allowance']); ?></b>&nbsp;</td>
</tr>
...
<?php } if($Res_4['VarRemburmnt']>0 OR $Res_5['VarRemburmnt']>0 OR $Res_6['VarRemburmnt']>0 OR $Res_7['VarRemburmnt']>0 OR $Res_8['VarRemburmnt']>0 OR $Res_9['VarRemburmnt']>0 OR $Res_10['VarRemburmnt']>0 OR $Res_11['VarRemburmnt']>0 OR $Res_12['VarRemburmnt']>0 OR $Res_1['VarRemburmnt']>0 OR $Res_2['VarRemburmnt']>0 OR $Res_3['VarRemburmnt']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Variable Adjustment</td>
<td class="All_80"><?php echo intval($Res_4['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['VarRemburmnt']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['VarRemburmnt']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['VarRemburmnt']+$Res_5['VarRemburmnt']+$Res_6['VarRemburmnt']+$Res_7['VarRemburmnt']+$Res_8['VarRemburmnt']+$Res_9['VarRemburmnt']+$Res_10['VarRemburmnt']+$Res_11['VarRemburmnt']+$Res_12['VarRemburmnt']+$Res_1['VarRemburmnt']+$Res_2['VarRemburmnt']+$Res_3['VarRemburmnt']); ?></b>&nbsp;</td>
</tr>
...
<?php } if($Res_4['PP_Inc']>0 OR $Res_5['PP_Inc']>0 OR $Res_6['PP_Inc']>0 OR $Res_7['PP_Inc']>0 OR $Res_8['PP_Inc']>0 OR $Res_9['PP_Inc']>0 OR $Res_10['PP_Inc']>0 OR $Res_11['PP_Inc']>0 OR $Res_12['PP_Inc']>0 OR $Res_1['PP_Inc']>0 OR $Res_2['PP_Inc']>0 OR $Res_3['PP_Inc']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Performance Incentive</td>
<td class="All_80"><?php echo intval($Res_4['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['PP_Inc']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['PP_Inc']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['PP_Inc']+$Res_5['PP_Inc']+$Res_6['PP_Inc']+$Res_7['PP_Inc']+$Res_8['PP_Inc']+$Res_9['PP_Inc']+$Res_10['PP_Inc']+$Res_11['PP_Inc']+$Res_12['PP_Inc']+$Res_1['PP_Inc']+$Res_2['PP_Inc']+$Res_3['PP_Inc']); ?></b>&nbsp;</td>
</tr>
...
<?php } if($Res_4['Bonus_Month']>0 OR $Res_5['Bonus_Month']>0 OR $Res_6['Bonus_Month']>0 OR $Res_7['Bonus_Month']>0 OR $Res_8['Bonus_Month']>0 OR $Res_9['Bonus_Month']>0 OR $Res_10['Bonus_Month']>0 OR $Res_11['Bonus_Month']>0 OR $Res_12['Bonus_Month']>0 OR $Res_1['Bonus_Month']>0 OR $Res_2['Bonus_Month']>0 OR $Res_3['Bonus_Month']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Bonus</td>
<td class="All_80"><?php echo intval($Res_4['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['Bonus_Month']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['Bonus_Month']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['Bonus_Month']+$Res_5['Bonus_Month']+$Res_6['Bonus_Month']+$Res_7['Bonus_Month']+$Res_8['Bonus_Month']+$Res_9['Bonus_Month']+$Res_10['Bonus_Month']+$Res_11['Bonus_Month']+$Res_12['Bonus_Month']+$Res_1['Bonus_Month']+$Res_2['Bonus_Month']+$Res_3['Bonus_Month']); ?></b>&nbsp;</td>
</tr>

<?php } if($Res_4['Car_Allowance_Arr']>0 OR $Res_5['Car_Allowance_Arr']>0 OR $Res_6['Car_Allowance_Arr']>0 OR $Res_7['Car_Allowance_Arr']>0 OR $Res_8['Car_Allowance_Arr']>0 OR $Res_9['Car_Allowance_Arr']>0 OR $Res_10['Car_Allowance_Arr']>0 OR $Res_11['Car_Allowance_Arr']>0 OR $Res_12['Car_Allowance_Arr']>0 OR $Res_1['Car_Allowance_Arr']>0 OR $Res_2['Car_Allowance_Arr']>0 OR $Res_3['Car_Allowance_Arr']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Arrear Car Allowance</td>
<td class="All_80"><?php echo intval($Res_4['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['Car_Allowance_Arr']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['Car_Allowance_Arr']+$Res_5['Car_Allowance_Arr']+$Res_6['Car_Allowance_Arr']+$Res_7['Car_Allowance_Arr']+$Res_8['Car_Allowance_Arr']+$Res_9['Car_Allowance_Arr']+$Res_10['Car_Allowance_Arr']+$Res_11['Car_Allowance_Arr']+$Res_12['Car_Allowance_Arr']+$Res_1['Car_Allowance_Arr']+$Res_2['Car_Allowance_Arr']+$Res_3['Car_Allowance_Arr']); ?></b>&nbsp;</td>
</tr>

<?php } if($Res_4['Arr_LvEnCash']>0 OR $Res_5['Arr_LvEnCash']>0 OR $Res_6['Arr_LvEnCash']>0 OR $Res_7['Arr_LvEnCash']>0 OR $Res_8['Arr_LvEnCash']>0 OR $Res_9['Arr_LvEnCash']>0 OR $Res_10['Arr_LvEnCash']>0 OR $Res_11['Arr_LvEnCash']>0 OR $Res_12['Arr_LvEnCash']>0 OR $Res_1['Arr_LvEnCash']>0 OR $Res_2['Arr_LvEnCash']>0 OR $Res_3['Arr_LvEnCash']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Arrear Leave Encash</td>
<td class="All_80"><?php echo intval($Res_4['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['Arr_LvEnCash']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['Arr_LvEnCash']+$Res_5['Arr_LvEnCash']+$Res_6['Arr_LvEnCash']+$Res_7['Arr_LvEnCash']+$Res_8['Arr_LvEnCash']+$Res_9['Arr_LvEnCash']+$Res_10['Arr_LvEnCash']+$Res_11['Arr_LvEnCash']+$Res_12['Arr_LvEnCash']+$Res_1['Arr_LvEnCash']+$Res_2['Arr_LvEnCash']+$Res_3['Arr_LvEnCash']); ?></b>&nbsp;</td>
</tr>

<?php } if($Res_4['Arr_Bonus']>0 OR $Res_5['Arr_Bonus']>0 OR $Res_6['Arr_Bonus']>0 OR $Res_7['Arr_Bonus']>0 OR $Res_8['Arr_Bonus']>0 OR $Res_9['Arr_Bonus']>0 OR $Res_10['Arr_Bonus']>0 OR $Res_11['Arr_Bonus']>0 OR $Res_12['Arr_Bonus']>0 OR $Res_1['Arr_Bonus']>0 OR $Res_2['Arr_Bonus']>0 OR $Res_3['Arr_Bonus']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Arrear Bonus</td>
<td class="All_80"><?php echo intval($Res_4['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['Arr_Bonus']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['Arr_Bonus']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['Arr_Bonus']+$Res_5['Arr_Bonus']+$Res_6['Arr_Bonus']+$Res_7['Arr_Bonus']+$Res_8['Arr_Bonus']+$Res_9['Arr_Bonus']+$Res_10['Arr_Bonus']+$Res_11['Arr_Bonus']+$Res_12['Arr_Bonus']+$Res_1['Arr_Bonus']+$Res_2['Arr_Bonus']+$Res_3['Arr_Bonus']); ?></b>&nbsp;</td>
</tr>

<?php } if($Res_4['Arr_LTARemb']>0 OR $Res_5['Arr_LTARemb']>0 OR $Res_6['Arr_LTARemb']>0 OR $Res_7['Arr_LTARemb']>0 OR $Res_8['Arr_LTARemb']>0 OR $Res_9['Arr_LTARemb']>0 OR $Res_10['Arr_LTARemb']>0 OR $Res_11['Arr_LTARemb']>0 OR $Res_12['Arr_LTARemb']>0 OR $Res_1['Arr_LTARemb']>0 OR $Res_2['Arr_LTARemb']>0 OR $Res_3['Arr_LTARemb']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Arrear LTA Remb.</td>
<td class="All_80"><?php echo intval($Res_4['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['Arr_LTARemb']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['Arr_LTARemb']+$Res_5['Arr_LTARemb']+$Res_6['Arr_LTARemb']+$Res_7['Arr_LTARemb']+$Res_8['Arr_LTARemb']+$Res_9['Arr_LTARemb']+$Res_10['Arr_LTARemb']+$Res_11['Arr_LTARemb']+$Res_12['Arr_LTARemb']+$Res_1['Arr_LTARemb']+$Res_2['Arr_LTARemb']+$Res_3['Arr_LTARemb']); ?></b>&nbsp;</td>
</tr>

<?php } if($Res_4['Arr_RA']>0 OR $Res_5['Arr_RA']>0 OR $Res_6['Arr_RA']>0 OR $Res_7['Arr_RA']>0 OR $Res_8['Arr_RA']>0 OR $Res_9['Arr_RA']>0 OR $Res_10['Arr_RA']>0 OR $Res_11['Arr_RA']>0 OR $Res_12['Arr_RA']>0 OR $Res_1['Arr_RA']>0 OR $Res_2['Arr_RA']>0 OR $Res_3['Arr_RA']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Arrear RA</td>
<td class="All_80"><?php echo intval($Res_4['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['Arr_RA']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['Arr_RA']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['Arr_RA']+$Res_5['Arr_RA']+$Res_6['Arr_RA']+$Res_7['Arr_RA']+$Res_8['Arr_RA']+$Res_9['Arr_RA']+$Res_10['Arr_RA']+$Res_11['Arr_RA']+$Res_12['Arr_RA']+$Res_1['Arr_RA']+$Res_2['Arr_RA']+$Res_3['Arr_RA']); ?></b>&nbsp;</td>
</tr>

<?php } if($Res_4['Arr_PP']>0 OR $Res_5['Arr_PP']>0 OR $Res_6['Arr_PP']>0 OR $Res_7['Arr_PP']>0 OR $Res_8['Arr_PP']>0 OR $Res_9['Arr_PP']>0 OR $Res_10['Arr_PP']>0 OR $Res_11['Arr_PP']>0 OR $Res_12['Arr_PP']>0 OR $Res_1['Arr_PP']>0 OR $Res_2['Arr_PP']>0 OR $Res_3['Arr_PP']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Arrear PP</td>
<td class="All_80"><?php echo intval($Res_4['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['Arr_PP']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['Arr_PP']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['Arr_PP']+$Res_5['Arr_PP']+$Res_6['Arr_PP']+$Res_7['Arr_PP']+$Res_8['Arr_PP']+$Res_9['Arr_PP']+$Res_10['Arr_PP']+$Res_11['Arr_PP']+$Res_12['Arr_PP']+$Res_1['Arr_PP']+$Res_2['Arr_PP']+$Res_3['Arr_PP']); ?></b>&nbsp;</td>
</tr>

<?php } if($Res_4['Bonus_Adjustment']>0 OR $Res_5['Bonus_Adjustment']>0 OR $Res_6['Bonus_Adjustment']>0 OR $Res_7['Bonus_Adjustment']>0 OR $Res_8['Bonus_Adjustment']>0 OR $Res_9['Bonus_Adjustment']>0 OR $Res_10['Bonus_Adjustment']>0 OR $Res_11['Bonus_Adjustment']>0 OR $Res_12['Bonus_Adjustment']>0 OR $Res_1['Bonus_Adjustment']>0 OR $Res_2['Bonus_Adjustment']>0 OR $Res_3['Bonus_Adjustment']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Bonus Adjustment</td>
<td class="All_80"><?php echo intval($Res_4['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['Bonus_Adjustment']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['Bonus_Adjustment']+$Res_5['Bonus_Adjustment']+$Res_6['Bonus_Adjustment']+$Res_7['Bonus_Adjustment']+$Res_8['Bonus_Adjustment']+$Res_9['Bonus_Adjustment']+$Res_10['Bonus_Adjustment']+$Res_11['Bonus_Adjustment']+$Res_12['Bonus_Adjustment']+$Res_1['Bonus_Adjustment']+$Res_2['Bonus_Adjustment']+$Res_3['Bonus_Adjustment']); ?></b>&nbsp;</td>
</tr>
...
<?php } ?>
<?php $TotG4=$Res_4['Tot_Gross']+$Res_4['Bonus']+$Res_4['DA']+$Res_4['Arreares']+$Res_4['LeaveEncash']+$Res_4['Incentive']+$Res_4['VariableAdjustment']+$Res_4['VarRemburmnt']+$Res_4['PerformancePay']+$Res_4['CCA']+$Res_4['RA']+$Res_4['Arr_Basic']+$Res_4['Arr_Hra']+$Res_4['Arr_Spl']+$Res_4['Arr_Conv']+$Res_4['YCea']+$Res_4['YMr']+$Res_4['YLta']+$Res_4['Car_Allowance_Arr']+$Res_4['Arr_LvEnCash']+$Res_4['Arr_Bonus']+$Res_4['Arr_LTARemb']+$Res_4['Arr_RA']+$Res_4['Arr_PP']+$Res_4['Bonus_Adjustment']+$Res_4['PP_Inc'];
$TotG5=$Res_5['Tot_Gross']+$Res_5['Bonus']+$Res_5['DA']+$Res_5['Arreares']+$Res_5['LeaveEncash']+$Res_5['Incentive']+$Res_5['VariableAdjustment']+$Res_5['VarRemburmnt']+$Res_5['PerformancePay']+$Res_5['CCA']+$Res_5['RA']+$Res_5['Arr_Basic']+$Res_5['Arr_Hra']+$Res_5['Arr_Spl']+$Res_5['Arr_Conv']+$Res_5['YCea']+$Res_5['YMr']+$Res_5['YLta']+$Res_5['Car_Allowance_Arr']+$Res_5['Arr_LvEnCash']+$Res_5['Arr_Bonus']+$Res_5['Arr_LTARemb']+$Res_5['Arr_RA']+$Res_5['Arr_PP']+$Res_5['Bonus_Adjustment']+$Res_5['PP_Inc'];
$TotG6=$Res_6['Tot_Gross']+$Res_6['Bonus']+$Res_6['DA']+$Res_6['Arreares']+$Res_6['LeaveEncash']+$Res_6['Incentive']+$Res_6['VariableAdjustment']+$Res_6['VarRemburmnt']+$Res_6['PerformancePay']+$Res_6['CCA']+$Res_6['RA']+$Res_6['Arr_Basic']+$Res_6['Arr_Hra']+$Res_6['Arr_Spl']+$Res_6['Arr_Conv']+$Res_6['YCea']+$Res_6['YMr']+$Res_6['YLta']+$Res_6['Car_Allowance_Arr']+$Res_6['Arr_LvEnCash']+$Res_6['Arr_Bonus']+$Res_6['Arr_LTARemb']+$Res_6['Arr_RA']+$Res_6['Arr_PP']+$Res_6['Bonus_Adjustment']+$Res_6['PP_Inc'];


$TotG7=$Res_7['Tot_Gross']+$Res_7['Bonus']+$Res_7['DA']+$Res_7['Arreares']+$Res_7['LeaveEncash']+$Res_7['Incentive']+$Res_7['VariableAdjustment']+$Res_7['VarRemburmnt']+$Res_7['PerformancePay']+$Res_7['CCA']+$Res_7['RA']+$Res_7['Arr_Basic']+$Res_7['Arr_Hra']+$Res_7['Arr_Spl']+$Res_7['Arr_Conv']+$Res_7['YCea']+$Res_7['YMr']+$Res_7['YLta']+$Res_7['Car_Allowance_Arr']+$Res_7['Arr_LvEnCash']+$Res_7['Arr_Bonus']+$Res_7['Arr_LTARemb']+$Res_7['Arr_RA']+$Res_7['Arr_PP']+$Res_7['Bonus_Adjustment']+$Res_7['PP_Inc'];

//echo $Res_7['Tot_Gross']."+".$Res_7['Bonus']."+".$Res_7['DA']."+".$Res_7['Arreares']."+".$Res_7['LeaveEncash']."+".$Res_7['Incentive']."+".$Res_7['VariableAdjustment']."+".$Res_7['VarRemburmnt']."+".$Res_7['PerformancePay']."+".$Res_7['CCA']."+".$Res_7['RA']."+".$Res_7['Arr_Basic']."+".$Res_7['Arr_Hra']."+".$Res_7['Arr_Spl']."+".$Res_7['Arr_Conv']."+".$Res_7['YCea']."+".$Res_7['YMr']."+".$Res_7['YLta']."+".$Res_7['Car_Allowance_Arr']."+".$Res_7['Arr_LvEnCash']."+".$Res_7['Arr_Bonus']."+".$Res_7['Arr_LTARemb']."+".$Res_7['Arr_RA']."+".$Res_7['Arr_PP'];

$TotG8=$Res_8['Tot_Gross']+$Res_8['Bonus']+$Res_8['DA']+$Res_8['Arreares']+$Res_8['LeaveEncash']+$Res_8['Incentive']+$Res_8['VariableAdjustment']+$Res_8['VarRemburmnt']+$Res_8['PerformancePay']+$Res_8['CCA']+$Res_8['RA']+$Res_8['Arr_Basic']+$Res_8['Arr_Hra']+$Res_8['Arr_Spl']+$Res_8['Arr_Conv']+$Res_8['YCea']+$Res_8['YMr']+$Res_8['YLta']+$Res_8['Car_Allowance_Arr']+$Res_8['Arr_LvEnCash']+$Res_8['Arr_Bonus']+$Res_8['Arr_LTARemb']+$Res_8['Arr_RA']+$Res_8['Arr_PP']+$Res_8['Bonus_Adjustment']+$Res_8['PP_Inc'];
$TotG9=$Res_9['Tot_Gross']+$Res_9['Bonus']+$Res_9['DA']+$Res_9['Arreares']+$Res_9['LeaveEncash']+$Res_9['Incentive']+$Res_9['VariableAdjustment']+$Res_9['VarRemburmnt']+$Res_9['PerformancePay']+$Res_9['CCA']+$Res_9['RA']+$Res_9['Arr_Basic']+$Res_9['Arr_Hra']+$Res_9['Arr_Spl']+$Res_9['Arr_Conv']+$Res_9['YCea']+$Res_9['YMr']+$Res_9['YLta']+$Res_9['Car_Allowance_Arr']+$Res_9['Arr_LvEnCash']+$Res_9['Arr_Bonus']+$Res_9['Arr_LTARemb']+$Res_9['Arr_RA']+$Res_9['Arr_PP']+$Res_9['Bonus_Adjustment']+$Res_9['PP_Inc'];
$TotG10=$Res_10['Tot_Gross']+$Res_10['Bonus']+$Res_10['DA']+$Res_10['Arreares']+$Res_10['LeaveEncash']+$Res_10['Incentive']+$Res_10['VariableAdjustment']+$Res_10['VarRemburmnt']+$Res_10['PerformancePay']+$Res_10['CCA']+$Res_10['RA']+$Res_10['Arr_Basic']+$Res_10['Arr_Hra']+$Res_10['Arr_Spl']+$Res_10['Arr_Conv']+$Res_10['YCea']+$Res_10['YMr']+$Res_10['YLta']+$Res_10['Car_Allowance_Arr']+$Res_10['Arr_LvEnCash']+$Res_10['Arr_Bonus']+$Res_10['Arr_LTARemb']+$Res_10['Arr_RA']+$Res_10['Arr_PP']+$Res_10['Bonus_Adjustment']+$Res_10['PP_Inc'];
$TotG11=$Res_11['Tot_Gross']+$Res_11['Bonus']+$Res_11['DA']+$Res_11['Arreares']+$Res_11['LeaveEncash']+$Res_11['Incentive']+$Res_11['VariableAdjustment']+$Res_11['VarRemburmnt']+$Res_11['PerformancePay']+$Res_11['CCA']+$Res_11['RA']+$Res_11['Arr_Basic']+$Res_11['Arr_Hra']+$Res_11['Arr_Spl']+$Res_11['Arr_Conv']+$Res_11['YCea']+$Res_11['YMr']+$Res_11['YLta']+$Res_11['Car_Allowance_Arr']+$Res_11['Arr_LvEnCash']+$Res_11['Arr_Bonus']+$Res_11['Arr_LTARemb']+$Res_11['Arr_RA']+$Res_11['Arr_PP']+$Res_11['Bonus_Adjustment']+$Res_11['PP_Inc'];
$TotG12=$Res_12['Tot_Gross']+$Res_12['Bonus']+$Res_12['DA']+$Res_12['Arreares']+$Res_12['LeaveEncash']+$Res_12['Incentive']+$Res_12['VariableAdjustment']+$Res_12['VarRemburmnt']+$Res_12['PerformancePay']+$Res_12['CCA']+$Res_12['RA']+$Res_12['Arr_Basic']+$Res_12['Arr_Hra']+$Res_12['Arr_Spl']+$Res_12['Arr_Conv']+$Res_12['YCea']+$Res_12['YMr']+$Res_12['YLta']+$Res_12['Car_Allowance_Arr']+$Res_12['Arr_LvEnCash']+$Res_12['Arr_Bonus']+$Res_12['Arr_LTARemb']+$Res_12['Arr_RA']+$Res_12['Arr_PP']+$Res_12['Bonus_Adjustment']+$Res_12['PP_Inc'];
$TotG1=$Res_1['Tot_Gross']+$Res_1['Bonus']+$Res_1['DA']+$Res_1['Arreares']+$Res_1['LeaveEncash']+$Res_1['Incentive']+$Res_1['VariableAdjustment']+$Res_1['VarRemburmnt']+$Res_1['PerformancePay']+$Res_1['CCA']+$Res_1['RA']+$Res_1['Arr_Basic']+$Res_1['Arr_Hra']+$Res_1['Arr_Spl']+$Res_1['Arr_Conv']+$Res_1['YCea']+$Res_1['YMr']+$Res_1['YLta']+$Res_1['Car_Allowance_Arr']+$Res_1['Arr_LvEnCash']+$Res_1['Arr_Bonus']+$Res_1['Arr_LTARemb']+$Res_1['Arr_RA']+$Res_1['Arr_PP']+$Res_1['Bonus_Adjustment']+$Res_1['PP_Inc'];
$TotG2=$Res_2['Tot_Gross']+$Res_2['Bonus']+$Res_2['DA']+$Res_2['Arreares']+$Res_2['LeaveEncash']+$Res_2['Incentive']+$Res_2['VariableAdjustment']+$Res_2['VarRemburmnt']+$Res_2['PerformancePay']+$Res_2['CCA']+$Res_2['RA']+$Res_2['Arr_Basic']+$Res_2['Arr_Hra']+$Res_2['Arr_Spl']+$Res_2['Arr_Conv']+$Res_2['YCea']+$Res_2['YMr']+$Res_2['YLta']+$Res_2['Car_Allowance_Arr']+$Res_2['Arr_LvEnCash']+$Res_2['Arr_Bonus']+$Res_2['Arr_LTARemb']+$Res_2['Arr_RA']+$Res_2['Arr_PP']+$Res_2['Bonus_Adjustment']+$Res_2['PP_Inc'];
$TotG3=$Res_3['Tot_Gross']+$Res_3['Bonus']+$Res_3['DA']+$Res_3['Arreares']+$Res_3['LeaveEncash']+$Res_3['Incentive']+$Res_3['VariableAdjustment']+$Res_3['VarRemburmnt']+$Res_3['PerformancePay']+$Res_3['CCA']+$Res_3['RA']+$Res_3['Arr_Basic']+$Res_3['Arr_Hra']+$Res_3['Arr_Spl']+$Res_3['Arr_Conv']+$Res_3['YCea']+$Res_3['YMr']+$Res_3['YLta']+$Res_3['Car_Allowance_Arr']+$Res_3['Arr_LvEnCash']+$Res_3['Arr_Bonus']+$Res_3['Arr_LTARemb']+$Res_3['Arr_RA']+$Res_3['Arr_PP']+$Res_3['Bonus_Adjustment']+$Res_3['PP_Inc'];
?>
...
<?php } if($Res_4['NPS_Value']>0 OR $Res_5['NPS_Value']>0 OR $Res_6['NPS_Value']>0 OR $Res_7['NPS_Value']>0 OR $Res_8['NPS_Value']>0 OR $Res_9['NPS_Value']>0 OR $Res_10['NPS_Value']>0 OR $Res_11['NPS_Value']>0 OR $Res_12['NPS_Value']>0 OR $Res_1['NPS_Value']>0 OR $Res_2['NPS_Value']>0 OR $Res_3['NPS_Value']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;NPS Contribution</td>
<td class="All_80"><?php echo intval($Res_4['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['NPS_Value']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['NPS_Value']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['NPS_Value']+$Res_5['NPS_Value']+$Res_6['NPS_Value']+$Res_7['NPS_Value']+$Res_8['NPS_Value']+$Res_9['NPS_Value']+$Res_10['NPS_Value']+$Res_11['NPS_Value']+$Res_12['NPS_Value']+$Res_1['NPS_Value']+$Res_2['NPS_Value']+$Res_3['NPS_Value']); ?></b>&nbsp;</td>
</tr>
