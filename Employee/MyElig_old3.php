	...
	<?php /***** Start ******/ ?>			
			 <table style="width:685px;" border="0">
			  ...
			  <tr>
			   ...
			   <tr>
			    <td style="width:485px;font-size:16px;height:22px;" align="left"><b>3.&nbsp;&nbsp;</b>&nbsp;DA @ H.Q. <?php if($ResE['DepartmentId']==3){ echo 'In case of day tour involving more than 40 kms. travel'; }elseif($ResE['DepartmentId']==4){ echo 'If the work needs touring for more than 6 hours in a day & as per the applicability of the seasons'; }elseif($ResE['DepartmentId']==6){ echo '(Only For Sales Staff)'; }elseif($ResE['DepartmentId']==24 OR $ResE['DepartmentId']==25){ echo 'If the work needs touring for more than 6 hours in a day'; } ?> :</td>
				<td style="width:200px;">: <?php if($ResEligEmp['DA_Inside_Hq']!='' AND $ResEligEmp['DA_Inside_Hq']!=' '){ echo $ResEligEmp['DA_Inside_Hq'].'&nbsp;&nbsp;Per day';}else{echo 'NA';} ?></td>
			  </tr>
...
<?php $sE=mysql_query("select CompanyId,DepartmentId,GradeId from hrm_employee e inner join hrm_employee_general g on e.EmployeeID=g.EmployeeID where e.EmployeeID=".$EmployeeId,$con); $rE=mysql_fetch_assoc($sE);
 $sqlGp=mysql_query("select Mobile_WithGPS from hrm_master_eligibility where DepartmentId=".$rE['DepartmentId']." AND CompanyId=".$rE['CompanyId']." AND GradeId=".$rE['GradeId']."",$con); $resGp=mysql_fetch_assoc($sqlGp); ?>				  
			  
			   <tr>
			    <td style="width:485px;font-size:16px;height:22px;" align="left"><b>9.&nbsp;&nbsp;</b>&nbsp;Mobile Handset Eligibility (<?php if($resGp['Mobile_WithGPS']==$ResEligEmp['Mobile_Hand_Elig_Rs']){echo 'Once in 2 yrs';}else{echo 'Once in 3 yrs';}?>)</td>
...
<?php } ?>			  
              ...
              <tr>
			   <td style="width:485px;font-size:16px;height:22px;" align="left"><b><?php if($ResE['ESCI']>0){ echo 11; } else {echo 12;} ?>.</b>&nbsp;Executive Health Check-up (Once in 2 yrs)</td>
...
<?php } //if($ResEligEmp['VehiclePolicy']>0)?>			  
			  ...
			  <?php /*
			  <tr>
			   <td style="width:485px;font-size:16px;height:22px;" align="left"><b><?php if($ResE['ESCI']>0){ echo 11; } else {echo 12;} ?>.</b>&nbsp;Bonus/Exgretia(yearly)</td>
				<td style="width:200px;">: As Per Law</td>
			  </tr>
			  */ ?>
			  <tr>
			    <td style="width:485px;font-size:16px;height:22px;" align="left"><b><?php if($ResE['ESCI']>0){ echo 12; } else {echo 13;} ?>.</b>&nbsp;Gratuity </td>
				<td style="width:200px;">: As Per Law</td>
			  </tr>
			  <tr>
			    <td style="width:485px;font-size:16px;height:22px;" align="left"><b><?php if($ResE['ESCI']>0){ echo 13; } else {echo 14;} ?>.</b>&nbsp;Deduction</td>
				<td style="width:200px;">&nbsp;</td>
			  </tr>
			  <tr>
