	  ...
	  <td style="font-family:Times New Roman;color:#000000; width:785;" align="center">
	    <table border="0">
		  ...
		  <td style="width:685px;font-size:18px;text-align:justify;">
		   With reference to your appointment letter dated <b><?php echo date("d/m/Y",strtotime($res['DateJoining'])); ?></b> we hereby confirm your services upon successful completion of the probation period.<p> 
