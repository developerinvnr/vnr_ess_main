...
<?php if($_REQUEST['a']==0){$query="select * from hrm_employee_attendance_req where RId=".$EmployeeId; }elseif($_REQUEST['a']==1){$query="select * from hrm_employee_attendance_req where Status=0 AND RId=".$EmployeeId; }elseif($_REQUEST['a']==2){$query="select * from hrm_employee_attendance_req where Status=1 AND RId=".$EmployeeId;}
