...
<?php $Y=date("Y");
 if(date("m")==01 OR date("m")==03 OR date("m")==05 OR date("m")==07 OR date("m")==08 OR date("m")==10 OR date("m")==12){$day=31;}elseif(date("m")==02){if($Y==2012 OR $Y==2016 OR $Y==2020 OR $Y==2024 OR $Y==2028 OR $Y==2032 OR $Y==2036 OR $Y==2040) { $day=29; } else { $day=28;} }
...
if($RS7['DR']=='Y'){$M='Dr.';}elseif($RS7['Gender']=='M'){$M='Mr.';} elseif($RS7['Gender']=='F' AND $RS7['Married']=='Y'){$M='Mrs.';} elseif($RS7['Gender']=='F' AND $RS7['Married']=='N'){$M='Miss.';} $EmpName=$M.' '.$RS7['Fname'].' '.$RS7['Sname'].' '.$RS7['Lname']; ?>    
   <tr>
    ...
    <td class="s100" valign="top">&nbsp;<?php echo $RS7['DepartmentCode']; ?></td>
    <td class="s200" valign="top">&nbsp;<?php echo $RS7['DesigName']; ?></td>
    <td class="s150" valign="top">&nbsp;<?php echo $RS7['HqName']; ?></td>
   </tr>
<?php } } ?>   
   </table>
  </td>
...
if($RS5['DR']=='Y'){$M='Dr.';}elseif($RS5['Gender']=='M'){$M='Mr.';} elseif($RS5['Gender']=='F' AND $RS5['Married']=='Y'){$M='Mrs.';} elseif($RS5['Gender']=='F' AND $RS5['Married']=='N'){$M='Miss.';} $EmpName=$M.' '.$RS5['Fname'].' '.$RS5['Sname'].' '.$RS5['Lname']; ?>	    
   <tr>
    ...
    <td class="s300" valign="top">&nbsp;<?php echo $EmpName; ?></td>
    <td class="s100" valign="top">&nbsp;<?php echo $RS5['DepartmentCode']; ?></td>
    <td class="s200" valign="top">&nbsp;<?php echo $RS5['DesigName']; ?></td>
    <td class="s150" valign="top">&nbsp;<?php echo $RS5['HqName']; ?></td>
   </tr>
<?php } } ?>   
   </table>
  </td>
...
if($RS3['DR']=='Y'){$M='Dr.';}elseif($RS3['Gender']=='M'){$M='Mr.';} elseif($RS3['Gender']=='F' AND $RS3['Married']=='Y'){$M='Mrs.';} elseif($RS3['Gender']=='F' AND $RS3['Married']=='N'){$M='Miss.';} $EmpName=$M.' '.$RS3['Fname'].' '.$RS3['Sname'].' '.$RS3['Lname']; ?>    
   <tr>
    ...
    <td class="s300" valign="top">&nbsp;<?php echo $EmpName; ?></td>
    <td class="s100" valign="top">&nbsp;<?php echo $RS3['DepartmentCode']; ?></td>
    <td class="s200" valign="top">&nbsp;<?php echo $RS3['DesigName']; ?></td>
    <td class="s150" valign="top">&nbsp;<?php echo $RS3['HqName']; ?></td>
   </tr>
<?php } } ?>   
   </table>
  </td>
...
if($RS1['DR']=='Y'){$M='Dr.';}elseif($RS1['Gender']=='M'){$M='Mr.';} elseif($RS1['Gender']=='F' AND $RS1['Married']=='Y'){$M='Mrs.';} elseif($RS1['Gender']=='F' AND $RS1['Married']=='N'){$M='Miss.';} $EmpName=$M.' '.$RS1['Fname'].' '.$RS1['Sname'].' '.$RS1['Lname']; ?>	   
   <tr>
    ...
    <td class="s300" valign="top">&nbsp;<?php echo $EmpName; ?></td>
    <td class="s100" valign="top">&nbsp;<?php echo $RS1['DepartmentCode']; ?></td>
    <td class="s200" valign="top">&nbsp;<?php echo $RS1['DesigName']; ?></td>
    <td class="s150" valign="top">&nbsp;<?php echo $RS1['HqName']; ?></td>
   </tr>
<?php } } ?>   
   </table>
  </td>
