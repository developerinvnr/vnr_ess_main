...
<tr>  
 ...
 <table border="0" cellpadding="0" cellspacing="0" style="width:100%;"> 
  <tr>
   ...
   <table border="0" style="width:100%;">
    <tr>
	 <td class="fhead" style="color:#000084;width:100%;font-weight:bold;" valign="middle">Your Old KRA for Assessment Year&nbsp;<?php if($CompanyId==1){ echo $FromOld; }else{ $OF=$FromOld-1; $OT=$FromOld; echo $OF.'-'.$OT; } ?>&nbsp;&nbsp;<a href="#" onClick="CloseOldKra()"/><font color="#620000">Hide</font></a>
