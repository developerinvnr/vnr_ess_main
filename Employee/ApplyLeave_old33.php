...
<td style='width:113px;'><input name="FromDate" id="FromDate" class="InputText" style="width:85px;text-align:center;height:22px;" readonly><button id="f_btn1" class="CalenderButton"></button>
...
<td style='width:113px;'><input name="ToDate" id="ToDate" class="InputText" style="width:85px;text-align:center;height:22px;" readonly><button id="f_btn2" class="CalenderButton"></button>
<script type="text/javascript">  var cal = Calendar.setup({ onSelect:  function(cal) { cal.hide()}, showTime: true }); 
...
<?php 
if(date("m")==1 OR date("m")==3 OR date("m")==5 OR date("m")==7 OR date("m")==8 OR date("m")==10 OR date("m")==12){$date=30; $date2=31;}
elseif(date("m")==4 OR date("m")==6 OR date("m")==9 OR date("m")==11){$date=29; $date2=30;}
elseif(date("m")==2)
{
  if(date("Y")==2012 OR date("Y")==2016 OR date("Y")==2020 OR date("Y")==2024 OR date("Y")==2028 OR date("Y")==2032 OR date("Y")==2036 OR date("Y")==2040){$date=28; $date2=29;}
  else{$date=27; $date2=28;}
}
