...
{ 
   ...
   */
   ...
   var Per75=Math.round(((KRATarget*75)/100)*100)/100; var PerAct=Math.round(((KRATarget*AppKRARating)/100)*100)/100; 
   var ScoAct=Math.round((KRATarget-PerAct)*100)/100;   
   if(AppKRARating<=10){var EScore=document.getElementById("EmpKRALogic"+n).value=Per150;}
   else if(AppKRARating>10 && AppKRARating<=15){var EScore=document.getElementById("AppKRALogic"+n).value=Per125;}
   else if(AppKRARating>15 && AppKRARating<=20){var EScore=document.getElementById("AppKRALogic"+n).value=Per100;}
   else if(AppKRARating>20 && AppKRARating<=25){var EScore=document.getElementById("AppKRALogic"+n).value=Per75;}
   else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
   var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
   var Score=document.getElementById("KraScore"+n).value=MScore;
   ...
   */
   ...
   var PerAct=Math.round(((KRATarget*AppKRARating)/100)*100)/100; var ScoAct=Math.round((KRATarget-PerAct)*100)/100;  
   if(AppKRARating==0){var EScore=document.getElementById("AppKRALogic"+n).value=Per150;}
   else if(AppKRARating>0 && AppKRARating<=2){var EScore=document.getElementById("AppKRALogic"+n).value=Per100;}
   else if(AppKRARating>2 && AppKRARating<=5){var EScore=document.getElementById("AppKRALogic"+n).value=Per90;}
   else if(AppKRARating>5 && AppKRARating<=10){var EScore=document.getElementById("AppKRALogic"+n).value=Per75;}
   else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
   var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
   var Score=document.getElementById("KraScore"+n).value=MScore;
 ...
 else if(lgc=='Logic12')
 {
  var Per10=Math.round(((KRATarget*10)/100)*100)/100; var Per90=Math.round((KRATarget-Per10)*100)/100;
  if(AppKRARating<Per90){var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  else if(AppKRARating>=Per90){var EScore=document.getElementById("AppKRALogic"+n).value=AppKRARating;}
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
 else if(lgc=='Logic13a')
 {
  ...
  if(AppKRARating<=Per80){var EScore=document.getElementById("AppKRALogic"+n).value=Per80;}
  else if(AppKRARating>=Per81 && AppKRARating<=Per90){var EScore=document.getElementById("AppKRALogic"+n).value=Per90;}
  else if(AppKRARating>=Per91 && AppKRARating<=Per110){var EScore=document.getElementById("AppKRALogic"+n).value=KRATarget;}
  else if(AppKRARating>=Per111 && AppKRARating<=Per120){var EScore=document.getElementById("AppKRALogic"+n).value=Per80;}
  else if(AppKRARating>=Per121){var EScore=document.getElementById("AppKRALogic"+n).value=Per70;}
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
 else if(lgc=='Logic13b')
 {
  ...
  var Per10=Math.round(((KRATarget*10)/100)*100)/100; var Per90=Math.round((KRATarget-Per10)*100)/100;  
  if(AppKRARating<=Per70){var EScore=document.getElementById("AppKRALogic"+n).value=Per70;}
  else if(AppKRARating>=Per71 && AppKRARating<=Per80){var EScore=document.getElementById("AppKRALogic"+n).value=Per90;}
  else if(AppKRARating>=Per81 && AppKRARating<=Per120){var EScore=document.getElementById("AppKRALogic"+n).value=KRATarget;}
  else if(AppKRARating>=Per121 && AppKRARating<=Per130){var EScore=document.getElementById("AppKRALogic"+n).value=Per80;}
  else if(AppKRARating>=Per131){var EScore=document.getElementById("AppKRALogic"+n).value=Per70;}
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
 else if(lgc=='Logic14a')
 {
  ...
  var Per110=Math.round((KRATarget+Per10)*100)/100;  
  if(AppKRARating<=Per75){var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  else if(AppKRARating>=Per76 && AppKRARating<=Per80){var EScore=document.getElementById("AppKRALogic"+n).value=Per80;}
  else if(AppKRARating>=Per81 && AppKRARating<=Per85){var EScore=document.getElementById("AppKRALogic"+n).value=Per90;}
  else if(AppKRARating>=Per86 && AppKRARating<=Per90){var EScore=document.getElementById("AppKRALogic"+n).value=KRATarget;}
  else if(AppKRARating>=Per91){var EScore=document.getElementById("AppKRALogic"+n).value=Per110;}
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
 else if(lgc=='Logic14b')
 {
  ...
  if(AppKRARating<=Per80){var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  else if(AppKRARating>=Per81 && AppKRARating<=Per85){var EScore=document.getElementById("AppKRALogic"+n).value=Per60;}
  else if(AppKRARating>=Per86 && AppKRARating<=Per90){var EScore=document.getElementById("AppKRALogic"+n).value=Per90;}
  else if(AppKRARating>=Per91 && AppKRARating<=Per95){var EScore=document.getElementById("AppKRALogic"+n).value=KRATarget;}
  else if(AppKRARating>=Per96){var EScore=document.getElementById("AppKRALogic"+n).value=Per110;}
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
 else if(lgc=='Logic15a')
 {
  ...
  var Per40=Math.round(((KRATarget*40)/100)*100)/100; var Per60=Math.round((KRATarget-Per40)*100)/100;
  var Per10=Math.round(((KRATarget*10)/100)*100)/100; var Per90=Math.round((KRATarget-Per10)*100)/100;  
  if(AppKRARating<Per96){var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  else if(AppKRARating>=Per96 && AppKRARating<Per97){var EScore=document.getElementById("AppKRALogic"+n).value=Per50;}
  else if(AppKRARating>=Per97 && AppKRARating<Per98){var EScore=document.getElementById("AppKRALogic"+n).value=Per60;}
  else if(AppKRARating>=Per98 && AppKRARating<Per99){var EScore=document.getElementById("AppKRALogic"+n).value=Per90;}
  else if(AppKRARating>=Per99){var EScore=document.getElementById("AppKRALogic"+n).value=KRATarget;}
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
 else if(lgc=='Logic15b')
 {
  ...
  var Per10=Math.round(((KRATarget*10)/100)*100)/100; var Per90=Math.round((KRATarget-Per10)*100)/100;
  var Per110=Math.round((KRATarget+Per10)*100)/100;  
  if(AppKRARating<Per97){var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  else if(AppKRARating>=Per97 && AppKRARating<Per98){var EScore=document.getElementById("AppKRALogic"+n).value=Per70;}
  else if(AppKRARating>=Per98 && AppKRARating<Per99){var EScore=document.getElementById("AppKRALogic"+n).value=Per90;}
  else if(AppKRARating>=Per99 && AppKRARating<Per995){var EScore=document.getElementById("AppKRALogic"+n).value=KRATarget;}
  else if(AppKRARating>=Per995){var EScore=document.getElementById("AppKRALogic"+n).value=Per110;}
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
 else if(lgc=='Logic15c')
 {
  ...
  var Per10=Math.round(((KRATarget*10)/100)*100)/100; var Per110=Math.round((KRATarget+Per10)*100)/100;  
  if(AppKRARating<Per96){var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  else if(AppKRARating>=Per96 && AppKRARating<Per97){var EScore=document.getElementById("AppKRALogic"+n).value=Per60;}
  else if(AppKRARating>=Per97 && AppKRARating<Per98){var EScore=document.getElementById("AppKRALogic"+n).value=Per80;}
  else if(AppKRARating>=Per98 && AppKRARating<Per99){var EScore=document.getElementById("AppKRALogic"+n).value=KRATarget;}
  else if(AppKRARating>=Per99){var EScore=document.getElementById("AppKRALogic"+n).value=Per110;}
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
 else if(lgc=='Logic16')
 {
  ...
  if(AppKRARating>=Per90 && AppKRARating<=Per94){var EScore=document.getElementById("AppKRALogic"+n).value=Per110;}
  else if(AppKRARating>=Per95 && AppKRARating<=Per99){var EScore=document.getElementById("AppKRALogic"+n).value=Per105;}
  else if(AppKRARating>=KRATarget && AppKRARating<=Per105){var EScore=document.getElementById("AppKRALogic"+n).value=KRATarget;}
  else if(AppKRARating>=Per106 && AppKRARating<=Per110){var EScore=document.getElementById("AppKRALogic"+n).value=Per95;}
  else if(AppKRARating>=Per111){var EScore=document.getElementById("AppKRALogic"+n).value=Per90;}
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
 else if(lgc=='Logic17')
 {
  ...
  if(AppKRARating<=Per15){var EScore=document.getElementById("AppKRALogic"+n).value=KRATarget;}
  else if(AppKRARating>=Per16 && AppKRARating<=Per22){var EScore=document.getElementById("AppKRALogic"+n).value=Per90;}
  else if(AppKRARating>=Per23 && AppKRARating<=Per29){var EScore=document.getElementById("AppKRALogic"+n).value=Per80;}
  else if(AppKRARating>=Per30 && AppKRARating<=Per36){var EScore=document.getElementById("AppKRALogic"+n).value=Per75;}
  else if(AppKRARating>=Per37 && AppKRARating<=Per42){var EScore=document.getElementById("AppKRALogic"+n).value=Per50;}  
  else if(AppKRARating>Per42){var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
...
{ 
  ...
  */	 
   ...
   var ScoAct=Math.round((Target-PerAct)*100)/100;   
   if(Rating<=10){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per150;}
   else if(Rating>10 && Rating<=15){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per125;}
   else if(Rating>15 && Rating<=20){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per100;}
   else if(Rating>20 && Rating<=25){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per75;}
   else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
   var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((EScore/Target)*Weight)*100)/100;
   if(MScore>0){ document.getElementById("AppKRAScore"+i+"_"+j).value=MScore; document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;}else{document.getElementById("AppKRAScore"+i+"_"+j).value=0;}	 
  ...
  */
  ...
  if(Rating==0){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per150;}
  else if(Rating>0 && Rating<=2){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per100;}
  else if(Rating>2 && Rating<=5){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per90;}
  else if(Rating>5 && Rating<=10){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per75;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((EScore/Target)*Weight)*100)/100;
  if(MScore>0){document.getElementById("AppKRAScore"+i+"_"+j).value=MScore; document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;}else{document.getElementById("AppKRAScore"+i+"_"+j).value=0;}
 ...
 else if(lgc=='Logic12')
 {
  var Per10=Math.round(((Target*10)/100)*100)/100; var Per90=Math.round((Target-Per10)*100)/100;
  if(Rating<Per90){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  else if(Rating>=Per90){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Rating;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((Target/EScore)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
 else if(lgc=='Logic13a')
 {
  ...
  if(Rating<=Per80){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per80;}
  else if(Rating>=Per81 && Rating<=Per90){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per90;}
  else if(Rating>=Per91 && Rating<=Per110){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Target;}
  else if(Rating>=Per111 && Rating<=Per120){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per80;}
  else if(Rating>=Per121){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per70;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((Target/EScore)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
 else if(lgc=='Logic13b')
 {
  ...
  var Per10=Math.round(((Target*10)/100)*100)/100; var Per90=Math.round((Target-Per10)*100)/100;  
  if(Rating<=Per70){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per70;}
  else if(Rating>=Per71 && Rating<=Per80){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per90;}
  else if(Rating>=Per81 && Rating<=Per120){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Target;}
  else if(Rating>=Per121 && Rating<=Per130){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per80;}
  else if(Rating>=Per131){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per70;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((Target/EScore)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
 else if(lgc=='Logic14a')
 {
  ...
  var Per110=Math.round((Target+Per10)*100)/100;  
  if(Rating<=Per75){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  else if(Rating>=Per76 && Rating<=Per80){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per80;}
  else if(Rating>=Per81 && Rating<=Per85){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per90;}
  else if(Rating>=Per86 && Rating<=Per90){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Target;}
  else if(Rating>=Per91){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per110;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((Target/EScore)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
 else if(lgc=='Logic14b')
 {
  ...
  if(Rating<=Per80){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  else if(Rating>=Per81 && Rating<=Per85){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per60;}
  else if(Rating>=Per86 && Rating<=Per90){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per90;}
  else if(Rating>=Per91 && Rating<=Per95){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Target;}
  else if(Rating>=Per96){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per110;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((Target/EScore)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
 else if(lgc=='Logic15a')
 {
  ...
  var Per40=Math.round(((Target*40)/100)*100)/100; var Per60=Math.round((Target-Per40)*100)/100;
  var Per10=Math.round(((Target*10)/100)*100)/100; var Per90=Math.round((Target-Per10)*100)/100;  
  if(Rating<Per96){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  else if(Rating>=Per96 && Rating<Per97){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per50;}
  else if(Rating>=Per97 && Rating<Per98){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per60;}
  else if(Rating>=Per98 && Rating<Per99){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per90;}
  else if(Rating>=Per99){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Target;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((Target/EScore)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
 else if(lgc=='Logic15b')
 {
  ...
  var Per10=Math.round(((Target*10)/100)*100)/100; var Per90=Math.round((Target-Per10)*100)/100;
  var Per110=Math.round((Target+Per10)*100)/100;  
  if(Rating<Per97){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  else if(Rating>=Per97 && Rating<Per98){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per70;}
  else if(Rating>=Per98 && Rating<Per99){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per90;}
  else if(Rating>=Per99 && Rating<Per995){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Target;}
  else if(Rating>=Per995){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per110;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((Target/EScore)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
 else if(lgc=='Logic15c')
 {
  ...
  var Per10=Math.round(((Target*10)/100)*100)/100; var Per110=Math.round((Target+Per10)*100)/100;  
  if(Rating<Per96){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  else if(Rating>=Per96 && Rating<Per97){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per60;}
  else if(Rating>=Per97 && Rating<Per98){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per80;}
  else if(Rating>=Per98 && Rating<Per99){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Target;}
  else if(Rating>=Per99){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per110;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((Target/EScore)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
 else if(lgc=='Logic16')
 {
  ...
  if(Rating>=Per90 && Rating<=Per94){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per110;}
  else if(Rating>=Per95 && Rating<=Per99){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per105;}
  else if(Rating>=Target && Rating<=Per105){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Target;}
  else if(Rating>=Per106 && Rating<=Per110){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per95;}
  else if(Rating>=Per111){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per90;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((Target/EScore)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
 else if(lgc=='Logic17')
 {
  ...
  if(Rating<=Per15){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Target;}
  else if(Rating>=Per16 && Rating<=Per22){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per90;}
  else if(Rating>=Per23 && Rating<=Per29){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per80;}
  else if(Rating>=Per30 && Rating<=Per36){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per75;}
  else if(Rating>=Per37 && Rating<=Per42){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Per50;}  
  else if(Rating>Per42){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((Target/EScore)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
