...
{ 
  ...
  if($sqlIns){$sqlUp=mysql_query("update hrm_employee_separation set Admin_NOC='Y', Acc_AdminNOC='N' where EmpSepId=".$_POST['si'], $con);}
  if($sqlUp)
  {
   $sqlChk=mysql_query("select EmpSepId from hrm_employee_separation where Admin_NOC='Y' AND IT_NOC='Y' AND Rep_NOC='Y' AND EmpSepId=".$_POST['si'], $con); $rowChk=mysql_num_rows($sqlChk);
   if($rowChk>0)
   {
    /************************************************ HR ***********************************************/ 
	...
	$email_message .="Department of Admin, IT & Reporting manager has submitted employee ".$_POST['Ename']." clearance form, please fill employee NOC form in HR level for further process. for details kindly log on to ESS <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>.\n\n";
...
{ if(v=='Y'){document.getElementById("AdminIC_Y").checked=true;document.getElementById("AdminIC_N").checked=false;document.getElementById("AdminIC_YN").value='Y';
  ...
  document.getElementById("AdminIC_Amt").value=0;}
...
{ if(v=='Y'){document.getElementById("AdminVC_Y").checked=true;document.getElementById("AdminVC_N").checked=false;document.getElementById("AdminVC_YN").value='Y';
  ...
  document.getElementById("AdminVC_Amt").value=0;}
...
{ if(v=='Y'){document.getElementById("AdminAO_Y"+i).checked=true;document.getElementById("AdminAO_N"+i).checked=false;document.getElementById("AdminAO_YN"+i).value='Y';
  ...
  document.getElementById("AdminAO_Amt"+i).value=0;}
...
{ 
 ...
 //if(AdminIC_YN=='N' && test_num==false){alert('Please enter only number in ID card amount field'); return false; }	
...
// if(AdminVC_YN!='' && AdminVC_YN=='N' && AdminVC_Amt==''){alert("please enter visiting cards recovery amount"); return false;}
 //if(AdminVC_YN=='N' && test_num2==false){alert('Please enter only number in visiting cards amount field'); return false; }	
 ...
 // if(AdminAO_YN3!='' && AdminAO_YN3=='N' && AdminAO_Amt3=='' && AdminAO_Remark3==''){alert("please enter particular 3 recovery amount & remark"); return false;}
  ...
  //if(AdminAO_YN3=='N' && AdminAO_num3==false){alert('Please enter only number in particular 3 amount field'); return false; }	
 ...
 //if(AdminAO_YN4!='' && AdminAO_YN4=='N' && AdminAO_Amt4==''){alert("please enter particular 4 recovery amount"); return false;}
  //if(AdminAO_YN4=='N' && AdminAO_num4==false){alert('Please enter only number in particular 4 amount field'); return false; }	
 ...
 if(AdminAO_Txt5!='' || AdminAO_YN5!='')
 {
  ...
  //if(AdminAO_YN5=='N' && AdminAO_num5==false){alert('Please enter only number in particular 5 amount field'); return false; }	
 ...
 if(AdminAO_Txt6!='' || AdminAO_YN6!='')
 {
  ...
  //if(AdminAO_YN6=='N' && AdminAO_num6==false){alert('Please enter only number in particular 6 amount field'); return false; }	
 ...
 if(AdminAO_Txt7!='' || AdminAO_YN7!='')
 {
  ...
  //if(AdminAO_YN7=='N' && AdminAO_num7==false){alert('Please enter only number in particular 7 amount field'); return false; }	
 ...
 if(AdminAO_Txt8!='' || AdminAO_YN8!='')
 {
  ...
  //if(AdminAO_YN8=='N' && AdminAO_num8==false){alert('Please enter only number in particular 8 amount field'); return false; }	
 ...
 if(AdminAO_Txt9!='' || AdminAO_YN9!='')
 {
  ...
  //if(AdminAO_YN9=='N' && AdminAO_num9==false){alert('Please enter only number in particular 9 amount field'); return false; }	
 ...
 if(AdminAO_Txt10!='' || AdminAO_YN10!='')
 {
  ...
  //if(AdminAO_YN10=='N' && AdminAO_num10==false){alert('Please enter only number in particular 10 amount field'); return false; }	
    ...
    <table border="1" style="width:760px; ">
	 ...
	 <tr bgcolor="#FFFFFF">
	   ...
	   <td class="Text" style="width:80px;" align="center" valign="top">
	    <input style="width:78px;background-color:#EAEAEA;text-align:right;" id="AdminIC_Amt" name="AdminIC_Amt" value="<?php if($res['AdminIC_Amt']>0){echo intval($res['AdminIC_Amt']);}else{echo 0;} ?>" readonly/>
	   </td>
	  ...
	  <tr bgcolor="#FFFFFF"> 
	   ...
	   <td class="Text" style="width:80px;" align="center" valign="top">
	    <input style="width:78px;background-color:#EAEAEA;text-align:right;" id="AdminVC_Amt" name="AdminVC_Amt" value="<?php if($res['AdminVC_Amt']>0){echo intval($res['AdminVC_Amt']);}else{echo 0;} ?>" readonly/>
	   </td>
	   <td class="Text" style="width:320px;" align="center" valign="top">
...
<?php if($resSE['Admin_NOC']=='N') { ?>
<?php for($i=3; $i<=10; $i++) { ?>  
  <tr>
   <td style="width:30px;display:<?php if($i==3){echo 'block';}else{echo 'none';}?>;" id="img<?php echo $i; ?>" align="center" align="center">
   <img src="images/Addnew.png" border="0" id="addImg<?php echo $i; ?>" style="display:<?php if($i==3){echo 'block';}else{echo 'none';}?>;" id="img<?php echo $i; ?>" onClick="ShowRowAdmin(<?php echo $i; ?>)"/>
   ...
   <td>
    <table style="width:760px;display:none;" id="Row<?php echo $i; ?>" border="1" cellspacing="0">
	  <tr bgcolor="#FFFFFF"> 
	   ...
	   <td class="Text" style="width:80px;" align="center" valign="top">
	    <input style="width:80px;background-color:#EAEAEA;text-align:right;" id="AdminAO_Amt<?php echo $i; ?>" name="AdminAO_Amt<?php echo $i; ?>" value="<?php if($res['AdminAO_Amt'.$i]>0){echo intval($res['AdminAO_Amt'.$i]); }else{echo 0;} ?>" readonly/>
	   </td>
...
<?php } ?> 
<?php } elseif($resSE['Admin_NOC']=='Y') { ?>
<?php for($i=3; $i<=10; $i++) { if($res['AdminAO_Txt'.$i]!=''){ ?>  
  <tr>
...
<?php } ?>
  ...
  <td colspan="5" align="Right" class="fontButton">
   ...
   <?php if($resSE['Admin_NOC']=='N') { ?>
   <?php if($rowNoc>0){ ?><input type="submit" id="submitAdminNoc" name="submitAdminNoc" value="submit"/><?php } ?>
   <input type="submit" id="saveAdminNoc" name="saveAdminNoc" value="save"/>
   <input type="button" name="Refrash" value="refresh" onClick="javascript:window.location='SepAdminClearForm.php?act=act&v=v&ss=vty&cc=it@~t~1212&p=value&a=app&true=false&si=<?php echo $_REQUEST['si']; ?>&ei=<?php echo $_REQUEST['ei']; ?>'"/>
   <?php } ?>
  </td>
 </tr> 
 </table>
