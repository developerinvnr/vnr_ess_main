...
<?php //*************************************************************************************************************************************************** ?>	   
	     ...
	     <table border="0" width="1000">
		    <tr>
			 ...
			 <?php if($rowApp>0) { ?>
             <td align="center"><a href="AppMyTeamConfLetter.php"><img id="Img_RepMgr1" style="display:block;" src="images/RepMgr1.png" border="0"/></a>
		     <img id="Img_RepMgr" style="display:none;" src="images/RepMgr.png" border="0"/></td><?php } ?>
			 <?php if($rowHod>0) { ?>
             <td align="center"><a href="HodMyTeamConfLetter.php"><img id="Img_Hod1" style="display:none;" src="images/RevHod1.png" border="0"/></a>
...
$SqlCheck=mysql_query("select ConfLetterId from hrm_employee_confletter where EmployeeID=".$ResHod['EmployeeID'], $con); $RowCheck=mysql_num_rows($SqlCheck);
if($RowCheck>0) { 
?> 			
            <tr bgcolor="#FFFFFF">
...
<?php $sqlE=mysql_query("select * from hrm_employee_reporting where AppraiserId=".$ResHod['EmployeeID'], $con); $rowE=mysql_num_rows($sqlE);?>			 
			 <td style="font-family:Georgia; font-size:11px; width:60px;" align="center"><a href="#" onClick="ConfFormClick(<?php echo $ResHod['EmployeeID']; ?>)">Click</a></td>
		    </tr>
<?php } } ?>				
	        </table>
		   </tr>
