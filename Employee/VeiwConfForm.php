...
function PrintForm(E,C) 
{window.open("VeiwConfFormPrint.php?action=Form&E="+E+"&C="+C,"AppLetter","location=no,scrollbars=no,resizable=no,menubar=no,width=50,height=50");}
</script>
</head>
<body>
<center>
...
$sqlLL=mysql_query("select * from hrm_employee_confletter where Status='A' AND EmployeeID=".$_REQUEST['E'], $con); $rowLL=mysql_num_rows($sqlLL); 
 ...
 <tr><td align="center" style="font-family:Times New Roman;font-size:15px;width:1000px;">
      <table border="1">
	   ...
	   <tr>
		...
		<td style="width:350px;" align="">&nbsp;<?php echo date("d-m-Y", strtotime($res['DateConfirmation'])); ?></td>
	   </tr>
	  </table>
     </td>
  </tr>
