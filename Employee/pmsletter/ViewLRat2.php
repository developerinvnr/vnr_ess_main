...
<?php /* if($ResE['DepartmentId']==3 AND $resGr2['GradeValue']!='S1' AND $resGr2['GradeValue']!='S2' AND $resGr2['GradeValue']!='J1'){ ?>Due to restructuring, your designation is revised to <b><?php echo $resD['DesigName']; ?></b> at same grade. <p><?php } */?>

    There is no increase in your CTC and it remains the same.<p> 
    
    Please find your revised Entitlements in Annexure-B as an enclosure with this letter. <p>
