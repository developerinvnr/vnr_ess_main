...
if($_POST['SentRes'])
{ 
  $sqlU=mysql_query("update hrm_employee_separation set NoticeDay=".$_POST['NoticeDay'].", Rep_Approved='".$_POST['SepValue']."', Rep_RelievingDate='".date("Y-m-d",strtotime($_POST['RepDate']))."', Rep_Remark='".$_POST['RepRemark']."', Rep_SaveDate='".date("Y-m-d")."', ResignationStatus=2 where EmpSepId=".$_POST['SepId'], $con);
  if($sqlU)
  {
   ...
   if($_POST['SepValue']=='Y'){$action='being processed';}elseif($_POST['SepValue']=='C'){$action='rejected';}
...
$email_from = 'admin@vnrseeds.co.in';
$email_subject4 = "Resignation is processed by Reporting Manager";
$email_txt = "Resignation ".$action." from reporting manager";
$headers = "From: ".$email_from."\r\n"; 
$semi_rand = md5(time()); 
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
$email_message4 .="Resignation application of ".$Ename." is processed at the level of Reporting Manager.\n\n\n";
...
$email_from = 'admin@vnrseeds.co.in';
$email_subject5 = "Resignation is processed by Reporting Manager";
$email_txt = "Resignation ".$action." from reporting manager";
$headers = "From: ".$email_from."\r\n";  
$semi_rand = md5(time()); 
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
$email_message5 .="Resignation application of ".$Ename." is processed at the level of Reporting Manager.\n\n\n";
