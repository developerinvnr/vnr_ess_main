...
if(isset($_POST['ReplyQuery']))
{
 ...
 { if($_POST['NOfT']==1)
   { $sqlUpRep=mysql_query("update hrm_employee_queryemp set QueryReply='".$_POST['ReplyQText']."', QReplyDT='".date("Y-m-d h:i:s")."', QStatus=2, Mngmt_QStatus=2, Mngmt_ReplyAns='".$_POST['ReplyQText']."', Mngmt_DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==2)
   { $sqlUpRep=mysql_query("update hrm_employee_queryemp set Query2Reply='".$_POST['ReplyQText']."', QReply2DT='".date("Y-m-d h:i:s")."', QStatus=2, Mngmt_QStatus=2, Mngmt_ReplyAns='".$_POST['ReplyQText']."', Mngmt_DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==3)
   { $sqlUpRep=mysql_query("update hrm_employee_queryemp set Query3Reply='".$_POST['ReplyQText']."', QReply3DT='".date("Y-m-d h:i:s")."', QStatus=2, Mngmt_QStatus=2, Mngmt_ReplyAns='".$_POST['ReplyQText']."', Mngmt_DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==4)
   { $sqlUpRep=mysql_query("update hrm_employee_queryemp set Query4Reply='".$_POST['ReplyQText']."', QReply4DT='".date("Y-m-d h:i:s")."', QStatus=2, Mngmt_QStatus=2, Mngmt_ReplyAns='".$_POST['ReplyQText']."', Mngmt_DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==5)
   { $sqlUpRep=mysql_query("update hrm_employee_queryemp set Query5Reply='".$_POST['ReplyQText']."', QReply5DT='".date("Y-m-d h:i:s")."', QStatus=2, Mngmt_QStatus=2, Mngmt_ReplyAns='".$_POST['ReplyQText']."', Mngmt_DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
 ...
 { if($_POST['NOfT']==1)
   {$sqlUpRep=mysql_query("update hrm_employee_queryemp set QueryReply='".$_POST['ReplyQText']."', QReplyDT='".date("Y-m-d h:i:s")."', QStatus=1, Mngmt_QStatus=1, Mngmt_ReplyAns='".$_POST['ReplyQText']."', Mngmt_DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==2)
   {$sqlUpRep=mysql_query("update hrm_employee_queryemp set Query2Reply='".$_POST['ReplyQText']."', QReply2DT='".date("Y-m-d h:i:s")."', QStatus=1, Mngmt_QStatus=1, Mngmt_ReplyAns='".$_POST['ReplyQText']."', Mngmt_DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==3)
   {$sqlUpRep=mysql_query("update hrm_employee_queryemp set Query3Reply='".$_POST['ReplyQText']."', QReply3DT='".date("Y-m-d h:i:s")."', QStatus=1, Mngmt_QStatus=1, Mngmt_ReplyAns='".$_POST['ReplyQText']."', Mngmt_DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==4)
   {$sqlUpRep=mysql_query("update hrm_employee_queryemp set Query4Reply='".$_POST['ReplyQText']."', QReply4DT='".date("Y-m-d h:i:s")."', QStatus=1, Mngmt_QStatus=1, Mngmt_ReplyAns='".$_POST['ReplyQText']."', Mngmt_DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
   if($_POST['NOfT']==5)
   {$sqlUpRep=mysql_query("update hrm_employee_queryemp set Query5Reply='".$_POST['ReplyQText']."', QReply5DT='".date("Y-m-d h:i:s")."', QStatus=1, Mngmt_QStatus=1, Mngmt_ReplyAns='".$_POST['ReplyQText']."', Mngmt_DTReplyAns='".date("Y-m-d h:i:s")."' where QueryId=".$_POST['RepQ_ID'], $con); }
...
{
  $sqlR=mysql_query("select Mngmt_ID,Mngmt_QFwdNoOfTime from hrm_employee_queryemp where QueryId=".$_POST['RepQ_ID'], $con); $resR=mysql_fetch_assoc($sqlR);
  if($_POST['ReaForward']==1){$Res=$_POST['Reason_1'];}elseif($_POST['ReaForward']==3){$Res=$_POST['OtherReason'];}
  
  if($resR['Mngmt_QFwdNoOfTime']==0 AND $_POST['RepQ_Value']=='F')
  {$sqlUp=mysql_query("update hrm_employee_queryemp set QStatus=1, Mngmt_ID=".$_POST['ActionEmp'].", Mngmt_QFwd='Y', Mngmt_QFwdNoOfTime=1, Mngmt_QFwdEmpId=".$resR['Mngmt_ID'].", Mngmt_QFwdReason='".$Res."', Mngmt_QFwdDT='".date("Y-m-d h:i:s")."', Mngmt_QStatus=1 where QueryId=".$_POST['RepQ_ID'], $con); }
  elseif($resR['Mngmt_QFwdNoOfTime']==1 AND $_POST['RepQ_Value']=='F')
  {$sqlUp=mysql_query("update hrm_employee_queryemp set QStatus=1, Mngmt_ID=".$_POST['ActionEmp'].", Mngmt_QFwd='Y', Mngmt_QFwdNoOfTime=2, Mngmt_QFwdEmpId2=".$resR['Mngmt_ID'].", Mngmt_QFwdReason2='".$Res."', Mngmt_QFwdDT2='".date("Y-m-d h:i:s")."', Mngmt_QStatus=1 where QueryId=".$_POST['RepQ_ID'], $con); }
  elseif($resR['Mngmt_QFwdNoOfTime']==2 AND $_POST['RepQ_Value']=='F')
  {$sqlUp=mysql_query("update hrm_employee_queryemp set QStatus=1, Mngmt_ID=".$_POST['ActionEmp'].", Mngmt_QFwd='Y', Mngmt_QFwdNoOfTime=3, Mngmt_QFwdEmpId3=".$resR['Mngmt_ID'].", Mngmt_QFwdReason3='".$Res."', Mngmt_QFwdDT3='".date("Y-m-d h:i:s")."', Mngmt_QStatus=1 where QueryId=".$_POST['RepQ_ID'], $con); }
  if($sqlUp){echo '<script>alert("Query forwarded successfully..!"); window.close(); </script>';}
} 
?>
				...
				<td colspan="2" align="Right" class="fontButton">
		          <table border="0" width="400">
			        <tr>
			         ...
			         <td align="right" style="width:70px;"><input type="button" name="Refresh" id="Refresh" style="width:90px;" value="Refresh" onClick="javascript:window.location='ReplyQueryMngmt.php?action=<?php echo $_REQUEST['action']; ?>&QR=<?php echo $_REQUEST['QR']; ?>&NOfT=<?php echo $_REQUEST['NOfT']; ?>'"/></td>
			       </tr>
		        </table>
		      </td>
	      </tr>
...
<?php $sqlQE=mysql_query("select hrm_employee_queryemp.*,Fname,Sname,Lname from hrm_employee_queryemp INNER JOIN hrm_employee ON hrm_employee.EmployeeID=hrm_employee_queryemp.EmployeeID where hrm_employee_queryemp.QueryId=".$_REQUEST['QR'], $con); $resQE=mysql_fetch_assoc($sqlQE);?>	
		  ...
		  <table border="0">
			<tr><td colspan="2" style="font-family:Times New Roman; color:#004A00; font-size:16px;width:400px;" align="">
			<b>Query Subject : </b><font color="#00509F"><?php if($resQE['QuerySubject']=='N'){echo substr_replace($resQE['OtherSubject'], '', 40).' ...';} else{echo substr_replace($resQE['QuerySubject'], '', 40).' ...'; }?></font></td>
			</tr>
			<tr><td colspan="2" style="font-family:Times New Roman; color:#004A00; font-size:16px;width:400px;" align="">
			<b>Query : </b><font color="#00509F"><?php if($_REQUEST['NOfT']==1){echo $resQE['QueryValue'];} elseif($_REQUEST['NOfT']==2){echo $resQE['Query2Value'];} elseif($_REQUEST['NOfT']==3){echo $resQE['Query3Value'];} elseif($_REQUEST['NOfT']==4){echo $resQE['Query4Value'];} elseif($_REQUEST['NOfT']==5){echo $resQE['Query5Value'];}?></font></td>
			</tr>
			...
			<tr><td colspan="2" style="font-family:Times New Roman; color:#004A00; font-size:16px;width:400px;" align="">
			<b>Employee : </b><font color="#00509F"><select name="ActionEmp" id="ActionEmp" style="padding:1px;font-size:12px;height:21px;font-family:Times New Roman;width:297px;" class="All_200"><option value="0">&nbsp;Select </option><option value="1">&nbsp;Mr. J.S. LAL</option><option value="6">&nbsp;Mr. S. RUDRA PRAKASH</option><option value="7">&nbsp;Dr. KRISHAN CHANDRA UPADHYAY</option><option value="51">&nbsp;Mr. ATUL SAH</option><option value="97">&nbsp;Mr. PRADEEP TIWARI</option><option value="52">&nbsp;Mr. RAJKUMAR KUNDU</option><option value="142">&nbsp;Mrs. PARUL PARMAR</option><option value="110">&nbsp;Mr. ASHISH BAJPAI</option><option value="28">&nbsp;Mr. NANDKISHORE SHARMA</option><option value="101">&nbsp;Mr. VINOD KUMAR YADAV</option><option value="19">&nbsp;Mr. HARENDRA KUMAR</option></select></font></td>
			</tr>
			<tr height="20">
				<td colspan="2" align="left" valign="top" width="80" style="font-family:Times New Roman;color:#004993; font-size:16px;">
				<input type="hidden" name="RepQ_ID" value="<?php echo $_REQUEST['QR']; ?>" />
