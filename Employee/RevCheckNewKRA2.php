...
{ var agree=confirm("Are you sure you want to resend KRA form to Appraiser?");
  if (agree) { window.location='RevCheckNewKRA.php?action=r&e='+E+'&y=3'; } 
  else {return false;}
}
...
<?php } ?>		
		 ...
		 <td style="width:300px;"><font color="#014E05" style='font-family:Times New Roman; font-weight:bold;' size="3"><span id="MsgSpan">&nbsp;<b><?php echo $msg; ?></b></span></font></td>	   
	  </table>
	</td>
   </tr>
    ...
    <td width="1200">
	  <table>
	    <tr> 
		 ...
		 <a href="HodPms.php"><img src="images/MyTeam1.png" border="0" /></a></td><?php } ?>    			   
...
<?php $sqlCh = mysql_query("select * from hrm_pms_allow where Reviewer_EmployeeID=".$EmployeeId." AND CompanyId=".$CompanyId." AND AssesmentYear=".$resSYP['CurrY'], $con);
      ...
      if(($CuDate>=$resSch['RevFromDate'] AND $CuDate<=$resSch['RevToDate'] AND $resSch['RevDateStatus']=='A') OR $rowCh>0 OR ($CuDate>$resSch['RevToDate'] AND $rowCh2>0)) { ?> 	
         ...
         <a href="RevCheckNewKRA.php"/><img src="images/KraYearMyTeam.png" border="0"/></a> </td><?php } ?> 
...
<form name="AppraisalForm" method="post" onSubmit="Validation(this)">	
 ...
 <tr>
  <td>
   <table border="0">
	<tr>
 <td colspan="6" style="font-family:Times New Roman; font-size:18px; font-weight:bold;"><font color="#00468C">(<i>My Team KRA Status</i>)</font><br></td>
...
<table>
  ...
  <form method="post" name="formResend" />
    ...
    <tr>
	  <?php //************************************************ Start ******************************// ?>
	   <td style="width:1180px;" id="EmpkraStatus" style="display:block;">
	   ...
	   <span id="MyTeamStatus">
		<table border="">
		 <tr bgcolor="#7a6189" style="height:20px;" valign="middle">
	        ...
	        <td align="center" style="font:Georgia; color:#FFFFFF; font-size:12px; width:250px;"><b>Name</b></td>
			...
			<td align="center" style="font:Georgia; color:#FFFFFF; font-size:12px; width:150px;"><b>HQ</b></td>
			<td align="center" style="font:Georgia; color:#FFFFFF; font-size:12px; width:120px;"><b>State</b></td>
	        <td align="center" style="font:Georgia; color:#FFFFFF; font-size:12px; width:90px;"><b>Employee</b></td>
			<td align="center" style="font:Georgia; color:#FFFFFF; font-size:12px; width:90px;"><b>Appraiser</b></td>
			<td align="center" style="font:Georgia; color:#FFFFFF; font-size:12px; width:90px;"><b>Reviewer</b></td>
...
<?php $sqlShow2=mysql_query("select UseKRA from hrm_pms_kra where YearId=".$resSY['CurrY']." AND EmployeeID=".$res['EmployeeID'], $con);  $resShow2=mysql_fetch_assoc($sqlShow2);	   	
      if($resShow2['UseKRA']=='R') {?>
			<a href="#"><img src="images/edit.png" border="0" onClick="javascript:window.location='RevAddNewKRA.php?e=<?php echo $res['EmployeeID']?>'"/></a>
			&nbsp;&nbsp;&nbsp;
