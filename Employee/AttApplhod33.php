...
//AttDate>='".$_REQUEST['Y']."-01-01' AND AttDate<='".$_REQUEST['Y']."-12-31' AND 
if($_REQUEST['a']==0){$query="select * from hrm_employee_attendance_req where (HId=".$EmployeeId." OR HtId=".$EmployeeId.")"; }elseif($_REQUEST['a']==1){$query="select * from hrm_employee_attendance_req where Status=0 AND (HId=".$EmployeeId." OR HtId=".$EmployeeId.")"; }elseif($_REQUEST['a']==2){$query="select * from hrm_employee_attendance_req where Status=1 AND HId=".$EmployeeId;}
