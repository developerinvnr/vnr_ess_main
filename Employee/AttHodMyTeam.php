...
function SelMonth(v){ var x = "AttHodMyTeam.php?m="+v;  window.location=x;}
</script>
</head>
<body class="body">
<table class="table">
...
<?php //*************************************************************************************************************************************************** ?>	   
	     ...
	     <table border="0" width="1000">
		    <tr>
			 ...
			 <?php if($rowApp>0) { ?>
             <td align="center"><a href="AttMyTeam.php?m=<?php echo date("m"); ?>&Y=<?php echo date("Y"); ?>"><img id="Img_RepMgr1" style="display:block;" src="images/RepMgr1.png" border="0"/></a>
		     <img id="Img_RepMgr" style="display:none;" src="images/RepMgr.png" border="0"/></td><?php } ?>
			 <?php if($rowHod>0) { ?>
             <td align="center"><a href="AttHodMyTeam.php?m=<?php echo date("m"); ?>&Y=<?php echo date("Y"); ?>"><img id="Img_Hod1" style="display:none;" src="images/RevHod1.png" border="0"/></a>
...
<td style="background-color:#7a6189;color:#FFFFFF;font-family:Times New Roman; width:100px; font-size:13px;" align="center"><b>Department</b></td>
<?php /*
...
<?php /*
<td style="background-color:#7a6189;color:#FFF;font-family:Times New Roman; width:200px; font-size:13px;"align="center">&nbsp;</td>	 
*/?>
...
<?php if($id==8){ for($i=1; $i<=31; $i++) {?>
      <td align="center" class="cell" style="background-color:<?php if(date("w",strtotime(date($Y.'-'.$id.'-'.$i)))==0){echo '#009100';}else{echo '#7a6189';}?>;color:#FFF;" width="20"><?php echo $i; ?></td><?php } } ?>	  
...
<td style="color:#000;font-family:Times New Roman; width:100px;font-size:12px;height:20px;" align="" valign="top">&nbsp;<?php echo $ResDept['DepartmentCode']; ?></td>
<?php /*
