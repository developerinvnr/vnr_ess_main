...
function SelMonth(v){ var x = "MyAtt.php?m="+v;  window.location=x;}
...
<font color="#006200" style='font-family:Times New Roman;' size="4"><b><?php echo $SelM; ?></b></font>
...
elseif($m==3){ $day=31;} elseif($m==4){ $day=30;} elseif($m==5){ $day=31;} elseif($m==6){ $day=30;} 
elseif($m==7){ $day=31;} elseif($m==8){ $day=31;} elseif($m==9){ $day=30;} elseif($m==10){ $day=31;} 
elseif($m==11){ $day=30;} elseif($m==12){ $day=31;}
...
<?php 
      ...
      $SqlFull=mysql_query("select count(AttValue)as FullDayLeave from hrm_employee_attendance where (AttValue='CL' OR AttValue='SL' OR AttValue='PL' OR AttValue='EL') AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
      $SqlHalf=mysql_query("select count(AttValue)as HalfDayLeave from hrm_employee_attendance where (AttValue='CH' OR AttValue='SH' OR AttValue='PH') AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con);
	  $SqlHf=mysql_query("select count(AttValue)as Hf from hrm_employee_attendance where AttValue='HF' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con);
	  $SqlPresent=mysql_query("select count(AttValue)as Present from hrm_employee_attendance where AttValue='P' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con);
	  $SqlAbsent=mysql_query("select count(AttValue)as Absent from hrm_employee_attendance where AttValue='A' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con);
	  $SqlOnDuties=mysql_query("select count(AttValue)as OnDuties from hrm_employee_attendance where AttValue='OD' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con);
	  $SqlHoliday=mysql_query("select count(AttValue)as Holiday from hrm_employee_attendance where AttValue='HO' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); } 
	 
	  elseif($m==2){ if($Y==2012 OR $Y==2016 OR $Y==2020 OR $Y==2024 OR $Y==2028 OR $Y==2032 OR $Y==2036 OR $Y==2040) { $day=29; } else { $day=28;}
      $SqlFull=mysql_query("select count(AttValue)as FullDayLeave from hrm_employee_attendance where (AttValue='CL' OR AttValue='SL' OR AttValue='PL' OR AttValue='EL') AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); 
      $SqlHalf=mysql_query("select count(AttValue)as HalfDayLeave from hrm_employee_attendance where (AttValue='CH' OR AttValue='SH' OR AttValue='PH') AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con);
	  $SqlHf=mysql_query("select count(AttValue)as Hf from hrm_employee_attendance where AttValue='HF' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con);
	  $SqlPresent=mysql_query("select count(AttValue)as Present from hrm_employee_attendance where AttValue='P' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')");
	  $SqlAbsent=mysql_query("select count(AttValue)as Absent from hrm_employee_attendance where AttValue='A' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con);
	  $SqlOnDuties=mysql_query("select count(AttValue)as OnDuties from hrm_employee_attendance where AttValue='OD' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con);
	  $SqlHoliday=mysql_query("select count(AttValue)as Holiday from hrm_employee_attendance where AttValue='HO' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); } 
	  
	  elseif($m==4 OR $m==6 OR $m==9 OR $m==11){ 
      $SqlFull=mysql_query("select count(AttValue)as FullDayLeave from hrm_employee_attendance where (AttValue='CL' OR AttValue='SL' OR AttValue='PL' OR AttValue='EL') AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-30")."')", $con); 
      $SqlHalf=mysql_query("select count(AttValue)as HalfDayLeave from hrm_employee_attendance where (AttValue='CH' OR AttValue='SH' OR AttValue='PH') AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-30")."')", $con);
	  $SqlHf=mysql_query("select count(AttValue)as Hf from hrm_employee_attendance where AttValue='HF' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-30")."')", $con);
	  $SqlPresent=mysql_query("select count(AttValue)as Present from hrm_employee_attendance where AttValue='P' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-30")."')", $con);
	  $SqlAbsent=mysql_query("select count(AttValue)as Absent from hrm_employee_attendance where AttValue='A' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-30")."')", $con);
	  $SqlOnDuties=mysql_query("select count(AttValue)as OnDuties from hrm_employee_attendance where AttValue='OD' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-30")."')", $con);
	  $SqlHoliday=mysql_query("select count(AttValue)as Holiday from hrm_employee_attendance where AttValue='HO' AND EmployeeID=".$EmployeeId." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-30")."')", $con); }
...
$ResAbsent=mysql_fetch_array($SqlAbsent); $ResOnDuties=mysql_fetch_array($SqlOnDuties); $ResHoliday=mysql_fetch_array($SqlHoliday); 
  ...
  $CountHf=$ResHf['Hf']/2;  $TotalAbsent=$ResAbsent['Absent']+$CountHf;  $TotalLeaveFull=$ResFull['FullDayLeave'];
  $TotalLeaveHalf=$ResHalf['HalfDayLeave']/2;  $TotalPR=$ResPresent['Present']+$CountHf+$TotalLeaveHalf; 
  $TotalLeaveCount=$TotalLeaveFull+$TotalLeaveHalf; $TotalOnDuties=$ResOnDuties['OnDuties'];
