...
{
 $up=mysql_query("update hrm_pms_kra_tgtdefin set AppAch='".$_POST['ach']."', AppCmnt='".addslashes($_POST['cmnt'])."', AppLogScr='".$_POST['logscr']."', AppScor='".$_POST['scor']."' where TgtDefId=".$_POST['id'],$con);
 if($up)
 { 
